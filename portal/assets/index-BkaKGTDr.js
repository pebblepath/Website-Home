var vt=Object.defineProperty;var yt=(p,e,t)=>e in p?vt(p,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):p[e]=t;var y=(p,e,t)=>yt(p,typeof e!="symbol"?e+"":e,t);import{i as A,a as I,b as o,o as xt}from"./lit-dM6tPkba.js";import{f as wt,h as _t,j as kt,G as Ve,O as $t,k as Ct,s as Pt,l as at,m as St,n as At,o as It,q as Mt,t as _,v as C,w,x as zt,y as D,z as G,A as z,B as Y,D as H,E as B,H as j,I as Z}from"./firebase-core-DEm61vaB.js";import{g as Dt,h as ie}from"./firebase-functions-ID3qFl3p.js";import{g as Et,a as W,r as q,u as J}from"./firebase-storage-BqMFCgVD.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const a of r)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(r){const a={};return r.integrity&&(a.integrity=r.integrity),r.referrerPolicy&&(a.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?a.credentials="include":r.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(r){if(r.ep)return;r.ep=!0;const a=t(r);fetch(r.href,a)}})();class ue extends A{constructor(){super(),this.variant="default",this.lifted=!1,this.padding="md"}render(){const e=["panel",this.variant==="strong"?"strong":"",this.lifted?"lifted":"",`pad-${this.padding}`].filter(Boolean).join(" ");return o`
      <div class=${e}>
        <div class="content"><slot></slot></div>
      </div>
    `}}y(ue,"properties",{variant:{type:String},lifted:{type:Boolean},padding:{type:String}}),y(ue,"styles",I`
    :host {
      display: block;
    }
    :host([stretch]) {
  ...
  `);customElements.define("glass-panel",ue);class be extends A{constructor(){super(),this.variant="primary",this.size="md",this.full=!1,this.disabled=!1}render(){const e=[this.variant,`size-${this.size}`,this.full?"full":""].filter(Boolean).join(" ");return o`
    ...
    `}}y(be,"properties",{variant:{type:String},size:{type:String},full:{type:Boolean},disabled:{type:Boolean,reflect:!0}}),y(be,"styles",I`
    * {
      box-sizing: border-box;
    }
    :host {
  ...
  `);customElements.define("glass-button",be);class me extends A{constructor(){super(),this.size=44}render(){const e=this.size;return o`
    ...
    `}}y(me,"properties",{size:{type:Number}}),y(me,"styles",I`
    :host {
      display: inline-block;
      line-height: 0;
    }
  ...
  `);customElements.define("cairn-mark",me);class st extends A{constructor(){super(),this.size=24,this.color="currentColor",this.mode="production"}render(){const e=Number(this.size)||24,t=this.color||"currentColor",i=this.mode==="template"?{fill:t,opacity:.25}:{fill:"white",opacity:.33};return o`
    ...
    `}}y(st,"properties",{size:{type:Number},color:{type:String},mode:{type:String}});customElements.define("pebble-icon",st);const Tt="modulepreload",Ft=function(p){return"/portal/"+p},He={},K=function(e,t,i){let r=Promise.resolve();if(t&&t.length>0){let s=function(l){return Promise.all(l.map(g=>Promise.resolve(g).then(c=>({status:"fulfilled",value:c}),c=>({status:"rejected",reason:c}))))};document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),d=(n==null?void 0:n.nonce)||(n==null?void 0:n.getAttribute("nonce"));r=s(t.map(l=>{if(l=Ft(l),l in He)return;He[l]=!0;const g=l.endsWith(".css"),c=g?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${c}`))return;const h=document.createElement("link");if(h.rel=g?"stylesheet":Tt,g||(h.as="script"),h.crossOrigin="",h.href=l,d&&h.setAttribute("nonce",d),document.head.appendChild(h),g)return new Promise((f,x)=>{h.addEventListener("load",f),h.addEventListener("error",()=>x(new Error(`Unable to preload CSS for ${l}`)))})}))}function a(s){const n=new Event("vite:preloadError",{cancelable:!0});if(n.payload=s,window.dispatchEvent(n),!n.defaultPrevented)throw s}return r.then(s=>{for(const n of s||[])n.status==="rejected"&&a(n.reason);return e().catch(a)})},fe={apiKey:"AIzaSyA6NKZNLVBeeLrXcLJSXus5M832AxpI2wk",authDomain:"pebblepath-992b6.firebaseapp.com",projectId:"pebblepath-992b6",storageBucket:"pebblepath-992b6.firebasestorage.app",messagingSenderId:"497141667291",appId:"1:497141667291:web:ee84c186db54389d10c3fe"},T=!!(fe.apiKey&&fe.projectId),ee=T?wt(fe):null,v=T?_t(ee):null,u=T?kt(ee):null,U=T?Dt(ee,"us-central1"):null,E=T?Et(ee):null,ve=T?new Ve:null;ve&&ve.setCustomParameters({prompt:"select_account"});const le=T?new Ve:null;le&&le.addScope("https://www.googleapis.com/auth/calendar.readonly");let ne=null,ye=0;async function ot(){if(!v||!le)throw new Error("Firebase not configured.");if(ne&&Date.now()<ye-6e4)return ne;const p=v.currentUser;if(!p)throw new Error("Please sign in before importing your calendar.");if(!(p.providerData??[]).some(a=>a.providerId==="google.com")){const a=new Error("Calendar import needs a Google account. You're signed in another way, so Cairn can't read your Google Calendar here yet — add events manually for now.");throw a.code="calendar/needs-google-account",a}let t;try{t=await Ct(p,le)}catch(a){if((a==null?void 0:a.code)==="auth/user-mismatch"){const s=new Error("Please choose the same Google account you use to sign in to Cairn.");throw s.code=a.code,s}if((a==null?void 0:a.code)==="auth/popup-closed-by-user"||(a==null?void 0:a.code)==="auth/cancelled-popup-request"){const s=new Error("Calendar connection cancelled.");throw s.code=a.code,s}throw a}const i=Ve.credentialFromResult(t),r=i==null?void 0:i.accessToken;if(!r)throw new Error("Couldn't get a Calendar access token — try again.");return ne=r,ye=Date.now()+3600*1e3,r}function Nt(){ne=null,ye=0}function de(){if(!v)throw new Error("Firebase not configured — fill in .env first.");return at(v,ve)}const re=T?new $t("apple.com"):null;re&&(re.addScope("email"),re.addScope("name"));function xe(){if(!v||!re)throw new Error("Firebase not configured — fill in .env first.");return at(v,re)}function nt(p,e){if(!v)throw new Error("Firebase not configured.");return It(v,p,e)}async function lt(p,e,t){if(!v)throw new Error("Firebase not configured.");const i=await St(v,p,e);if(t&&t.trim())try{await At(i.user,{displayName:t.trim()})}catch{}return i}function dt(p){if(!v)throw new Error("Firebase not configured.");return Mt(v,p)}function ct(){return v?Pt(v):Promise.resolve()}function pt(p){return v?zt(v,p):(p(null),()=>{})}const Rt=Object.freeze(Object.defineProperty({__proto__:null,addDoc:j,app:ee,auth:v,clearCalendarToken:Nt,collection:z,connectGoogleCalendar:ot,db:u,deleteDoc:Z,doc:_,firebaseApp:ee,functions:U,getDocs:H,getDownloadURL:W,httpsCallable:ie,isConfigured:T,onAuth:pt,onSnapshot:D,query:G,sendPasswordReset:dt,serverTimestamp:w,setDoc:B,signIn:de,signInWithApple:xe,signInWithEmail:nt,signOutUser:ct,signUpWithEmail:lt,storage:E,storageRef:q,updateDoc:C,uploadBytes:J,where:Y},Symbol.toStringTag,{value:"Module"})),Ot={"united states":"US","united states of america":"US",usa:"US",us:"US","united kingdom":"GB",uk:"GB","great britain":"GB",england:"GB",scotland:"GB",wales:"GB","northern ireland":"GB",canada:"CA",australia:"AU",ireland:"IE",france:"FR",germany:"DE",spain:"ES",italy:"IT",netherlands:"NL","the netherlands":"NL",belgium:"BE",switzerland:"CH",austria:"AT",portugal:"PT",sweden:"SE",norway:"NO",denmark:"DK",finland:"FI","new zealand":"NZ",mexico:"MX",brazil:"BR","south africa":"ZA",india:"IN",japan:"JP",singapore:"SG",poland:"PL"};class Bt extends EventTarget{constructor(){super(),this.state={user:null,family:null,children:[],trips:[],events:[],holidays:[],ppFamily:null,ppIsMember:!1,ppIsChildViewer:!1,myChildAccessRequest:null,incomingChildRequests:[],ppChildren:[],selectedChildId:null,childMilestones:[],childInsights:[],childDailyCard:null,childPebbleMessages:[],childPebbleSessions:[]},this._uid=null,this._unsubUser=null,this._unsubFamily=null,this._unsubChildren=null,this._unsubTrips=null,this._unsubEvents=null,this._currentFamilyId=null,this._inviteCodeMigratedFamilyId=null,this._holidayKey=null,this._ppFamilyId=null,this._selectedChildId=null,this._unsubPpFamily=null,this._unsubPpChildren=null,this._unsubChildMs=null,this._unsubChildIns=null,this._unsubChildDaily=null,this._unsubChildPebble=null,this._unsubChildSessions=null,this._ppReadOnly=!1,this._unsubIncomingReq=null,this._unsubMyReq=null,this.userDocResolved=!1}get familyId(){return this._currentFamilyId}start(e){!u||!e||this._uid!==e&&(this.stop(),this._uid=e,this._unsubUser=D(_(u,"users",e),t=>{var a,s,n,d,l,g,c;this.userDocResolved=!0,this.state.user=t.exists()?{id:t.id,...t.data()}:null;const i=((a=this.state.user)==null?void 0:a.cairnFamilyId)??((s=this.state.user)==null?void 0:s.familyId)??null;!i&&this.state.user&&this._healFamilyPointer(e),i!==this._currentFamilyId&&(this._currentFamilyId=i,(n=this._unsubFamily)==null||n.call(this),(d=this._unsubChildren)==null||d.call(this),(l=this._unsubTrips)==null||l.call(this),(g=this._unsubEvents)==null||g.call(this),this._unsubFamily=null,this._unsubChildren=null,this._unsubTrips=null,this._unsubEvents=null,this.state.family=null,this.state.children=[],this.state.trips=[],this.state.events=[],i&&this._subscribeFamily(i));const r=((c=this.state.user)==null?void 0:c.familyId)??null;r!==this._ppFamilyId&&(this._ppFamilyId=r,this._teardownPpFamily(),r&&this._subscribePpFamily(r)),this._emit()}))}async _healFamilyPointer(e){if(!this._healing){this._healing=!0;try{const t=G(z(u,"families"),Y("cairnMemberIds","array-contains",e)),i=await H(t);if(!i.empty){await B(_(u,"users",e),{cairnFamilyId:i.docs[0].id,updatedAt:w()},{merge:!0});return}const r=G(z(u,"families"),Y("memberIds","array-contains",e)),a=await H(r);a.empty||await B(_(u,"users",e),{familyId:a.docs[0].id,updatedAt:w()},{merge:!0})}catch(t){console.warn("[Cairn] auto-heal family pointer failed:",t==null?void 0:t.code,t==null?void 0:t.message)}finally{this._healing=!1}}}async _loadHolidays(){var s,n;const e=(n=(s=this.state.family)==null?void 0:s.homeLocation)==null?void 0:n.country,t=Ot[String(e??"").trim().toLowerCase()]??null;if(!t){this.state.holidays.length&&(this.state.holidays=[],this._holidayKey=null,this._emit());return}const i=new Date().getFullYear(),r=[i,i+1],a=`${t}:${r.join(",")}`;if(this._holidayKey!==a){this._holidayKey=a;try{const d=[];for(const g of r){const c=`pp_hol_${t}_${g}`;let h=null;try{const f=JSON.parse(localStorage.getItem(c)||"null");f&&Date.now()-f.t<720*3600*1e3&&(h=f.h)}catch{}if(!h){const f=await fetch(`https://date.nager.at/api/v3/PublicHolidays/${g}/${t}`);if(!f.ok)continue;const x=await f.json();h=(Array.isArray(x)?x:[]).map(P=>({date:P.date,name:P.name||P.localName||"Holiday"}));try{localStorage.setItem(c,JSON.stringify({t:Date.now(),h}))}catch{}}for(const f of h)d.push({id:`hol-${t}-${f.date}-${f.name}`,title:f.name,date:f.date,source:"holiday"})}const l=new Set;this.state.holidays=d.filter(g=>{const c=`${g.date}|${g.title}`;return l.has(c)?!1:(l.add(c),!0)}),this._emit()}catch{this._holidayKey=null}}}_subscribeFamily(e){var t;this._unsubFamily=D(_(u,"families",e),i=>{this.state.family=i.exists()?{id:i.id,...i.data()}:null,this._reconcileChildViewer(),this._loadHolidays(),this._maybeMigrateInviteCodeFormat(),this._emit()}),(t=this._unsubMyReq)==null||t.call(this),this._unsubMyReq=D(_(u,"families",e,"childAccessRequests",this._uid),i=>{this.state.myChildAccessRequest=i.exists()?{id:i.id,...i.data()}:null,this._emit()},i=>console.warn("[Portal] childAccessRequest (mine) error:",i.code,i.message)),this._unsubChildren=D(z(u,"families",e,"children"),i=>{this.state.children=i.docs.map(r=>{var s,n;const a=r.data();return{id:r.id,...a,dateOfBirth:((n=(s=a.dateOfBirth)==null?void 0:s.toDate)==null?void 0:n.call(s))??(a.dateOfBirth?new Date(a.dateOfBirth):null)}}),this._emit()}),this._unsubTrips=D(G(z(u,"families",e,"trips"),Y("visibleTo","array-contains",this._uid)),i=>{this.state.trips=i.docs.map(r=>{var s,n,d,l;const a=r.data();return{id:r.id,...a,start:a.start??"",end:a.end??"",createdAt:((n=(s=a.createdAt)==null?void 0:s.toDate)==null?void 0:n.call(s))??null,updatedAt:((l=(d=a.updatedAt)==null?void 0:d.toDate)==null?void 0:l.call(d))??null}}).sort((r,a)=>String(r.start).localeCompare(String(a.start))),this._backfillVisibleTo("trips",i.docs),this._emit()},i=>{console.warn("[Cairn] trips subscription error:",i.code,i.message)}),this._unsubEvents=D(G(z(u,"families",e,"familyEvents"),Y("visibleTo","array-contains",this._uid)),i=>{this.state.events=i.docs.map(r=>{var s,n,d,l;const a=r.data();return{id:r.id,...a,date:a.date??"",createdAt:((n=(s=a.createdAt)==null?void 0:s.toDate)==null?void 0:n.call(s))??null,updatedAt:((l=(d=a.updatedAt)==null?void 0:d.toDate)==null?void 0:l.call(d))??null}}),this._backfillVisibleTo("familyEvents",i.docs),this._emit()},i=>{console.warn("[Cairn] familyEvents subscription error:",i.code,i.message)})}_reconcileChildViewer(){var a;if((a=this.state.user)!=null&&a.familyId)return;const e=this.state.family,t=this._uid,r=!!(e&&Array.isArray(e.childViewers)&&e.childViewers.includes(t)&&!(Array.isArray(e.memberIds)&&e.memberIds.includes(t)))?e.id:null;r!==this._ppFamilyId&&(this._ppFamilyId=r,this._ppReadOnly=!!r,this._teardownPpFamily(),r&&this._subscribePpFamily(r),this._emit())}_subscribePpFamily(e){this._unsubPpFamily=D(_(u,"families",e),t=>{var a;const i=t.exists()?{id:t.id,...t.data()}:null;this.state.ppFamily=i;const r=!!(i&&Array.isArray(i.memberIds)&&i.memberIds.includes(this._uid));this.state.ppIsMember=r,this.state.ppIsChildViewer=!!(!r&&i&&Array.isArray(i.childViewers)&&i.childViewers.includes(this._uid)),r&&this._subscribeIncomingRequests(e),(a=this.state.user)!=null&&a.familyId||this._reconcileChildViewer(),this._emit()},t=>{console.warn("[Portal] ppFamily subscription error:",t.code,t.message)}),this._unsubPpChildren=D(z(u,"families",e,"children"),t=>{var s;const i=t.docs.map(n=>{var l,g;const d=n.data();return{id:n.id,...d,dateOfBirth:((g=(l=d.dateOfBirth)==null?void 0:l.toDate)==null?void 0:g.call(l))??(d.dateOfBirth?new Date(d.dateOfBirth):null)}}).sort((n,d)=>{var l,g,c,h;return(((g=(l=n.createdAt)==null?void 0:l.toMillis)==null?void 0:g.call(l))??0)-(((h=(c=d.createdAt)==null?void 0:c.toMillis)==null?void 0:h.call(c))??0)});this.state.ppChildren=i,this._resolveChildPhotos(e,i);const a=this._selectedChildId&&i.some(n=>n.id===this._selectedChildId)?this._selectedChildId:((s=i[0])==null?void 0:s.id)??null;a!==this._selectedChildId?this._subscribeChild(a):a||this._teardownChild(),this._emit()},t=>{console.warn("[Portal] ppChildren subscription error:",t.code,t.message)})}_subscribeIncomingRequests(e){var t;(t=this._unsubIncomingReq)==null||t.call(this),this._unsubIncomingReq=D(z(u,"families",e,"childAccessRequests"),i=>{this.state.incomingChildRequests=i.docs.map(r=>({id:r.id,...r.data()})).filter(r=>r.status==="pending").sort((r,a)=>{var s,n,d,l;return(((n=(s=r.requestedAt)==null?void 0:s.toMillis)==null?void 0:n.call(s))??0)-(((l=(d=a.requestedAt)==null?void 0:d.toMillis)==null?void 0:l.call(d))??0)}),this._emit()},i=>console.warn("[Portal] childAccessRequests error:",i.code,i.message))}_subscribeChild(e){if(this._teardownChild(),this._selectedChildId=e,this.state.selectedChildId=e,!e||!this._ppFamilyId){this.state.childMilestones=[],this.state.childInsights=[],this.state.childDailyCard=null,this.state.childPebbleMessages=[],this.state.childPebbleSessions=[];return}const t=["families",this._ppFamilyId,"children",e];this._unsubChildMs=D(z(u,...t,"milestones"),i=>{this.state.childMilestones=i.docs.map(r=>({id:r.id,...r.data()})).sort((r,a)=>(r.ageRangeStartMonths??0)-(a.ageRangeStartMonths??0)),this._emit()},i=>console.warn("[Portal] milestones error:",i.code,i.message)),this._unsubChildIns=D(z(u,...t,"insights"),i=>{this.state.childInsights=i.docs.map(r=>({id:r.id,...r.data()})).sort((r,a)=>(a.relevanceScore??0)-(r.relevanceScore??0)),this._emit()},i=>console.warn("[Portal] insights error:",i.code,i.message)),this._ppReadOnly||(this._unsubChildDaily=D(z(u,...t,"dailyCards"),i=>{const r=i.docs.map(a=>({id:a.id,...a.data()}));r.sort((a,s)=>String(s.id).localeCompare(String(a.id))),this.state.childDailyCard=r[0]??null,this._emit()},i=>console.warn("[Portal] dailyCards error:",i.code,i.message))),this._unsubChildPebble=D(z(u,...t,"pebbleMessages"),i=>{this.state.childPebbleMessages=i.docs.map(r=>({id:r.id,...r.data()})).filter(r=>!(r.isPrivate===!0&&r.senderUid!==this._uid)).sort((r,a)=>{var s,n,d,l;return(((n=(s=r.timestamp)==null?void 0:s.toMillis)==null?void 0:n.call(s))??0)-(((l=(d=a.timestamp)==null?void 0:d.toMillis)==null?void 0:l.call(d))??0)}),this._emit()},i=>console.warn("[Portal] pebbleMessages error:",i.code,i.message)),this._unsubChildSessions=D(z(u,...t,"pebbleSessions"),i=>{this.state.childPebbleSessions=i.docs.map(r=>({id:r.id,...r.data()})).filter(r=>r.archived!==!0).filter(r=>!(r.isPrivate===!0&&r.createdBy!==this._uid)).sort((r,a)=>{var s,n,d,l,g,c,h,f;return(((n=(s=a.lastMessageAt)==null?void 0:s.toMillis)==null?void 0:n.call(s))??((l=(d=a.createdAt)==null?void 0:d.toMillis)==null?void 0:l.call(d))??0)-(((c=(g=r.lastMessageAt)==null?void 0:g.toMillis)==null?void 0:c.call(g))??((f=(h=r.createdAt)==null?void 0:h.toMillis)==null?void 0:f.call(h))??0)}),this._emit()},i=>console.warn("[Portal] pebbleSessions error:",i.code,i.message))}_resolveChildPhotos(e,t){if(E){this._photoTried||(this._photoTried=new Set);for(const i of t){const r=i.profilePhotoURL;if(typeof r=="string"&&/^https?:\/\//i.test(r))continue;const a=e+"/"+i.id;this._photoTried.has(a)||(this._photoTried.add(a),W(q(E,"families/"+e+"/avatars/children/"+i.id)).then(s=>{const n=this.state.ppChildren||[],d=n.findIndex(l=>l.id===i.id);d>=0&&(n[d]={...n[d],profilePhotoURL:s},this.state.ppChildren=[...n],this._emit())}).catch(()=>{this._photoTried.delete(a)}))}}}selectChild(e){!e||e===this._selectedChildId||this.state.ppChildren.some(t=>t.id===e)&&(this._subscribeChild(e),this._emit())}async askPebbleAboutChild(e,t,i=[],r=!1,a=""){if(!U)throw new Error("Firebase functions not configured.");if(!this._ppFamilyId)throw new Error("No PebblePath family.");if(!e)throw new Error("No child selected.");return(await ie(U,"askPebbleAboutChild")({familyId:this._ppFamilyId,childId:e,question:t,history:i,isPrivate:r===!0,sessionId:a||""})).data}_childPebbleBase(e){return["families",this._ppFamilyId,"children",e,"pebbleSessions"]}async createPebbleSession(e,{title:t,isPrivate:i}={}){if(!u||!this._ppFamilyId||!e)throw new Error("No child selected.");return(await j(z(u,...this._childPebbleBase(e)),{title:(t||"New chat").trim()||"New chat",isPrivate:i===!0,archived:!1,createdBy:this._uid??"",createdAt:w(),lastMessageAt:w()})).id}async renamePebbleSession(e,t,i){!u||!this._ppFamilyId||!e||!t||await C(_(u,...this._childPebbleBase(e),t),{title:(i||"").trim()||"Untitled chat"})}async setPebbleSessionPrivacy(e,t,i){!u||!this._ppFamilyId||!e||!t||await C(_(u,...this._childPebbleBase(e),t),{isPrivate:i===!0})}async archivePebbleSession(e,t){!u||!this._ppFamilyId||!e||!t||await C(_(u,...this._childPebbleBase(e),t),{archived:!0})}async touchPebbleSession(e,t){if(!(!u||!this._ppFamilyId||!e||!t))try{await C(_(u,...this._childPebbleBase(e),t),{lastMessageAt:w()})}catch{}}_teardownChild(){var e,t,i,r,a;(e=this._unsubChildMs)==null||e.call(this),(t=this._unsubChildIns)==null||t.call(this),(i=this._unsubChildDaily)==null||i.call(this),(r=this._unsubChildPebble)==null||r.call(this),(a=this._unsubChildSessions)==null||a.call(this),this._unsubChildMs=this._unsubChildIns=this._unsubChildDaily=this._unsubChildPebble=this._unsubChildSessions=null}_teardownPpFamily(){var e,t,i;this._teardownChild(),(e=this._unsubPpFamily)==null||e.call(this),(t=this._unsubPpChildren)==null||t.call(this),(i=this._unsubIncomingReq)==null||i.call(this),this._unsubPpFamily=null,this._unsubPpChildren=null,this._unsubIncomingReq=null,this._selectedChildId=null,this.state.ppFamily=null,this.state.ppIsMember=!1,this.state.ppIsChildViewer=!1,this.state.incomingChildRequests=[],this.state.ppChildren=[],this.state.selectedChildId=null,this.state.childMilestones=[],this.state.childInsights=[],this.state.childDailyCard=null,this.state.childPebbleMessages=[],this.state.childPebbleSessions=[]}async requestChildAccess(){var t;const e=this._currentFamilyId;if(!e)throw new Error("No family to request access from.");await B(_(u,"families",e,"childAccessRequests",this._uid),{uid:this._uid,displayName:((t=this.state.user)==null?void 0:t.displayName)??"Family member",requestedAt:w(),status:"pending"})}async withdrawChildAccessRequest(){const e=this._currentFamilyId;e&&await Z(_(u,"families",e,"childAccessRequests",this._uid))}async setMemberLabel(e,t){!this._uid||!e||await C(_(u,"users",this._uid),{[`memberLabels.${e}`]:(t??"").trim()})}async approveChildAccess(e){var r;const t=this._ppFamilyId;if(!t||!this.state.ppIsMember)throw new Error("Only a parent can approve access.");const i=Array.isArray((r=this.state.ppFamily)==null?void 0:r.childViewers)?this.state.ppFamily.childViewers:[];i.includes(e)||await C(_(u,"families",t),{childViewers:[...i,e],updatedAt:w()}),await C(_(u,"families",t,"childAccessRequests",e),{status:"approved",actionedBy:this._uid,actionedAt:w()})}async declineChildAccess(e){const t=this._ppFamilyId;if(!t||!this.state.ppIsMember)throw new Error("Only a parent can decline access.");await C(_(u,"families",t,"childAccessRequests",e),{status:"declined",actionedBy:this._uid,actionedAt:w()})}async grantChildViewerDirectly(e){var r;const t=this._ppFamilyId;if(!t||!this.state.ppIsMember)throw new Error("Only a parent can grant access.");const i=Array.isArray((r=this.state.ppFamily)==null?void 0:r.childViewers)?this.state.ppFamily.childViewers:[];i.includes(e)||await C(_(u,"families",t),{childViewers:[...i,e],updatedAt:w()})}async grantParentAccessForOwnChildren(e){const t=this._ppFamilyId;if(!t||!this.state.ppIsMember)throw new Error("Only a parent can grant access.");const i=this._uid;if(!i)throw new Error("Not signed in.");const a=(Array.isArray(this.state.ppChildren)?this.state.ppChildren:[]).filter(n=>(n==null?void 0:n.id)&&Array.isArray(n.parentIds)&&n.parentIds.includes(i));if(a.length===0)return[];const s=[];for(const n of a){const d=Array.isArray(n.parentIds)?n.parentIds:[];if(d.includes(e)){s.push(n.name??"your child");continue}await C(_(u,"families",t,"children",n.id),{parentIds:[...d,e],updatedAt:w()}),s.push(n.name??"your child")}return s}async revokeChildViewer(e){var a;const t=this._ppFamilyId;if(!t||!this.state.ppIsMember)throw new Error("Only a parent can revoke access.");const i=Array.isArray((a=this.state.ppFamily)==null?void 0:a.childViewers)?this.state.ppFamily.childViewers:[],r=i.filter(s=>s!==e);r.length!==i.length&&await C(_(u,"families",t),{childViewers:r,updatedAt:w()});try{await C(_(u,"families",t,"childAccessRequests",e),{status:"declined",actionedBy:this._uid,actionedAt:w()})}catch{}}_backfillVisibleTo(e,t){if(!u||!this._currentFamilyId)return;const i=this.state.family;if(i){this._vtBackfilled||(this._vtBackfilled=new Set);for(const r of t){const a=r.data();if(Array.isArray(a.visibleTo))continue;const s=`${e}/${r.id}`;this._vtBackfilled.has(s)||(this._vtBackfilled.add(s),C(_(u,"families",this._currentFamilyId,e,r.id),{visibleTo:ce(a.visibility??"family",i,a.createdBy,Array.isArray(a.attendees)?a.attendees:[])}).catch(n=>{this._vtBackfilled.delete(s),console.warn(`[Cairn] visibleTo backfill failed (${s}):`,n==null?void 0:n.code,n==null?void 0:n.message)}))}}}async _visibleToFor(e,t,i){const r=(e==null?void 0:e.visibility)??"family",a=Array.isArray(e==null?void 0:e.attendees)?e.attendees:[],s=r==="extended"?await Lt(t):[];return ce(r,t,i,a,s)}async saveTrip(e){var l;if(!u||!this._currentFamilyId)throw new Error("No family yet.");const t=(l=v==null?void 0:v.currentUser)==null?void 0:l.uid;if(!t)throw new Error("Not signed in.");const{id:i,createdAt:r,updatedAt:a,...s}=e,n={...s,updatedAt:w()};return n.visibleTo=await this._visibleToFor(s,this.state.family,s.createdBy??t),i?(await C(_(u,"families",this._currentFamilyId,"trips",i),n),i):(n.createdBy=t,n.createdAt=w(),(await j(z(u,"families",this._currentFamilyId,"trips"),n)).id)}async deleteTrip(e){if(!u||!this._currentFamilyId)throw new Error("No family yet.");await Z(_(u,"families",this._currentFamilyId,"trips",e))}planItemsListener(e,t){return!u||!this._currentFamilyId||!e?()=>{}:D(z(u,"families",this._currentFamilyId,"trips",e,"planItems"),i=>{const r=i.docs.map(a=>({id:a.id,...a.data()})).sort((a,s)=>{var l,g,c,h;const n=String(a.day??"").localeCompare(String(s.day??""));if(n!==0)return n;const d=String(a.time??"").localeCompare(String(s.time??""));return d!==0?d:(((g=(l=a.createdAt)==null?void 0:l.toMillis)==null?void 0:g.call(l))??0)-(((h=(c=s.createdAt)==null?void 0:c.toMillis)==null?void 0:h.call(c))??0)});t(r)},i=>{console.warn("[Portal] planItems subscription error:",i.code,i.message),t([])})}async addPlanItem(e,t){var n;if(!u||!this._currentFamilyId)throw new Error("No family yet.");const i=(n=v==null?void 0:v.currentUser)==null?void 0:n.uid;if(!i)throw new Error("Not signed in.");const r=String((t==null?void 0:t.title)??"").trim();if(!r)throw new Error("Add a title.");const a=String((t==null?void 0:t.url)??"").trim();return(await j(z(u,"families",this._currentFamilyId,"trips",e,"planItems"),{title:r,type:(t==null?void 0:t.type)??"note",day:(t==null?void 0:t.day)??"",time:(t==null?void 0:t.time)??"",durationMins:Number.isFinite(t==null?void 0:t.durationMins)?t.durationMins:60,.../^https?:\/\//i.test(a)?{url:a}:{},addedBy:i,createdAt:w()})).id}async updatePlanItem(e,t,i){if(!u||!this._currentFamilyId)throw new Error("No family yet.");await C(_(u,"families",this._currentFamilyId,"trips",e,"planItems",t),i)}async uploadPlanAttachment(e,t,i){if(!E||!this._currentFamilyId)throw new Error("Storage unavailable.");const r=`families/${this._currentFamilyId}/planAttachments/${e}__${t}`,a=q(E,r);return await J(a,i,{contentType:i.type||"application/octet-stream"}),W(a)}async deletePlanItem(e,t){if(!u||!this._currentFamilyId)throw new Error("No family yet.");await Z(_(u,"families",this._currentFamilyId,"trips",e,"planItems",t))}async saveEvent(e){var l;if(!u||!this._currentFamilyId)throw new Error("No family yet.");const t=(l=v==null?void 0:v.currentUser)==null?void 0:l.uid;if(!t)throw new Error("Not signed in.");const{id:i,createdAt:r,updatedAt:a,...s}=e,n={...s,updatedAt:w()};return n.visibleTo=await this._visibleToFor(s,this.state.family,s.createdBy??t),i?(await C(_(u,"families",this._currentFamilyId,"familyEvents",i),n),i):(n.createdBy=t,n.createdAt=w(),(await j(z(u,"families",this._currentFamilyId,"familyEvents"),n)).id)}async deleteEvent(e){if(!u||!this._currentFamilyId)throw new Error("No family yet.");await Z(_(u,"families",this._currentFamilyId,"familyEvents",e))}async uploadSchoolCalendar(e){if(!E||!this._currentFamilyId)throw new Error("Storage unavailable.");const t=e.type||"",i=/pdf/.test(t)?"pdf":/^image\//.test(t)?"image":/word|officedocument|msword/.test(t)?"docx":"pdf",r=`families/${this._currentFamilyId}/schoolCalendarUploads/${Date.now()}`;return await J(q(E,r),e,{contentType:t||"application/octet-stream"}),{storagePath:r,fileType:i}}async uploadTripPreview(e){var a;if(!E||!this._currentFamilyId)throw new Error("Storage unavailable.");if(!/^image\//.test(e.type||""))throw new Error("Preview image must be an image file.");const t=((a=crypto==null?void 0:crypto.randomUUID)==null?void 0:a.call(crypto))||`${Date.now()}-${Math.random().toString(36).slice(2)}`,i=`families/${this._currentFamilyId}/trip-previews/${t}`,r=q(E,i);return await J(r,e,{contentType:e.type}),await W(r)}async extractSchoolCalendarEvents(e,t){var s;if(!U||!this._currentFamilyId)throw new Error("No family yet.");const r=await ie(U,"extractSchoolCalendar")({familyId:this._currentFamilyId,storagePath:e,fileType:t}),a=(s=r==null?void 0:r.data)==null?void 0:s.events;return Array.isArray(a)?a:[]}async importSchoolEvents(e){var c;if(!u||!this._currentFamilyId)throw new Error("No family yet.");const t=(c=v==null?void 0:v.currentUser)==null?void 0:c.uid;if(!t)throw new Error("Not signed in.");const i=this.state.family??{},r=Array.isArray(i.memberIds)?i.memberIds:[],a=Array.isArray(i.cairnMemberIds)?i.cairnMemberIds:[],s=[...new Set([...r,...a,t])],n=ce("extended",i,t),d=z(u,"families",this._currentFamilyId,"familyEvents"),l=(e??[]).filter(h=>h&&/^\d{4}-\d{2}-\d{2}$/.test(String(h.date??""))&&String(h.title??"").trim()).slice(0,250);let g=0;return await Promise.all(l.map(async h=>{await j(d,{title:String(h.title).trim().slice(0,120),date:h.date,type:h.type||"other",source:"school-import",personIds:s,visibility:"extended",visibleTo:n,createdBy:t,createdAt:w(),updatedAt:w()}),g+=1})),g}async previewUrl(e){if(!e||typeof e!="string"||!/^https?:\/\//i.test(e.trim()))return null;if(!U)throw new Error("Firebase functions not configured.");return(await ie(U,"previewUrl")({url:e.trim()})).data}async askPebble(e,t=[]){if(!U)throw new Error("Firebase functions not configured.");if(!this._currentFamilyId)throw new Error("No family yet.");return(await ie(U,"askPebbleAboutActivities")({question:e,familyId:this._currentFamilyId,history:t})).data}async updateChildBirthday(e,t){if(!u||!this._currentFamilyId)throw new Error("No family yet.");await C(_(u,"families",this._currentFamilyId,"children",e),{dateOfBirth:t,updatedAt:w()})}async findFamilyByCairnCode(e){if(!u)throw new Error("Firebase not configured.");const t=G(z(u,"families"),Y("cairnInviteCode","==",e)),i=await H(t);if(i.empty)return null;const r=i.docs[0];return{id:r.id,...r.data()}}async findFamilyByConnectCode(e){if(!u)throw new Error("Firebase not configured.");const t=await H(G(z(u,"families"),Y("cairnInviteCode","==",e)));if(!t.empty){const r=t.docs[0];return{id:r.id,...r.data(),_matchedCodeKind:"cairn"}}const i=await H(G(z(u,"families"),Y("inviteCode","==",e)));if(!i.empty){const r=i.docs[0];return{id:r.id,...r.data(),_matchedCodeKind:"pp"}}return null}async _applyCairnJoin(e){var l;const t=(l=v==null?void 0:v.currentUser)==null?void 0:l.uid;if(!t)throw new Error("Not signed in.");const i=e.cairnMemberIds??[],r=e.memberIds??[],a=v.currentUser;if(i.includes(t)||r.includes(t))return await B(_(u,"users",t),{email:a.email??"",displayName:a.displayName??"",profilePhotoURL:a.photoURL??null,cairnFamilyId:e.id,updatedAt:w()},{merge:!0}),await this._recordMutualConnection(e.id,t),e.id;const s=e.cairnMaxMembers??20;if(i.length>=s){const g=new Error("This family's connection ring is full.");throw g.code="full",g}const n=new Date,d={displayName:a.displayName??"",profilePhotoURL:a.photoURL??null,role:"member",joinedAt:n,updatedAt:n};return await C(_(u,"families",e.id),{cairnMemberIds:[...i,t],[`memberProfiles.${t}`]:d,updatedAt:w()}),await B(_(u,"users",t),{email:a.email??"",displayName:a.displayName??"",profilePhotoURL:a.photoURL??null,cairnFamilyId:e.id,role:"member",notificationPreferences:{milestoneReminders:!0,tipNotifications:!0,schoolDeadlines:!0},createdAt:w(),updatedAt:w()},{merge:!0}),await this._recordMutualConnection(e.id,t),e.id}async redeemConnectCode(e){var s,n;if(!u)throw new Error("Firebase not configured.");if(!((s=v==null?void 0:v.currentUser)==null?void 0:s.uid))throw new Error("Not signed in.");const i=await this.findFamilyByConnectCode(e);if(!i){const d=new Error("Invite code not found.");throw d.code="not-found",d}const r=i._matchedCodeKind==="pp"?i.inviteCodeExpiresAt:i.cairnInviteCodeExpiresAt,a=((n=r==null?void 0:r.toDate)==null?void 0:n.call(r))??(r?new Date(r):null);if(!a||a<new Date){const d=new Error("This invite code has expired.");throw d.code="expired",d}return this._applyCairnJoin(i)}async _recordMutualConnection(e,t){var i;try{const{getDoc:r,arrayUnion:a}=await K(async()=>{const{getDoc:d,arrayUnion:l}=await import("./firebase-core-DEm61vaB.js").then(g=>g.J);return{getDoc:d,arrayUnion:l}},[]),s=await r(_(u,"users",t)),n=s.exists()?(i=s.data())==null?void 0:i.familyId:null;if(!n||n===e)return;await C(_(u,"families",e),{connectedFamilyIds:a(n),updatedAt:w()}),await C(_(u,"families",n),{connectedFamilyIds:a(e),updatedAt:w()})}catch(r){console.warn("[connect] mutual connection record skipped (non-fatal):",r)}}async saveSubGroup({id:e,name:t,memberIds:i}){if(!u||!this._currentFamilyId)throw new Error("No family yet.");const r=e??`g_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,6)}`;return await C(_(u,"families",this._currentFamilyId),{[`subGroups.${r}`]:{name:t.trim(),memberIds:Array.isArray(i)?[...i]:[],updatedAt:w()},updatedAt:w()}),r}async deleteSubGroup(e){if(!u||!this._currentFamilyId)throw new Error("No family yet.");const{deleteField:t}=await K(async()=>{const{deleteField:i}=await import("./firebase-core-DEm61vaB.js").then(r=>r.J);return{deleteField:i}},[]);await C(_(u,"families",this._currentFamilyId),{[`subGroups.${e}`]:t(),updatedAt:w()})}async setCairnMemberSubGroup(e,t){var a;if(!u||!this._currentFamilyId)throw new Error("No family yet.");if(!e)throw new Error("uid is required.");const i=((a=this.state.family)==null?void 0:a.subGroups)??{},r={};for(const[s,n]of Object.entries(i)){const d=Array.isArray(n.memberIds)?n.memberIds:[];s===t?d.includes(e)||(r[`subGroups.${s}.memberIds`]=[...d,e]):d.includes(e)&&(r[`subGroups.${s}.memberIds`]=d.filter(l=>l!==e))}Object.keys(r).length!==0&&(r.updatedAt=w(),await C(_(u,"families",this._currentFamilyId),r))}async removeCairnMember(e){if(!u||!this._currentFamilyId)throw new Error("No family yet.");if(!e)throw new Error("uid is required.");const t=this.state.family??{};if((Array.isArray(t.memberIds)?t.memberIds:[]).includes(e))throw new Error("parents can’t be removed from the ring here.");const{deleteField:r}=await K(async()=>{const{deleteField:l}=await import("./firebase-core-DEm61vaB.js").then(g=>g.J);return{deleteField:l}},[]),a={updatedAt:w()},s=Array.isArray(t.cairnMemberIds)?t.cairnMemberIds:[];s.includes(e)&&(a.cairnMemberIds=s.filter(l=>l!==e)),t.memberProfiles&&t.memberProfiles[e]&&(a[`memberProfiles.${e}`]=r());const n=Array.isArray(t.childViewers)?t.childViewers:[];n.includes(e)&&(a.childViewers=n.filter(l=>l!==e));const d=t.subGroups??{};for(const[l,g]of Object.entries(d)){const c=Array.isArray(g.memberIds)?g.memberIds:[];c.includes(e)&&(a[`subGroups.${l}.memberIds`]=c.filter(h=>h!==e))}await C(_(u,"families",this._currentFamilyId),a);try{await Z(_(u,"families",this._currentFamilyId,"childAccessRequests",e))}catch{}}async createCairnOnlyFamily(e){if(!u)throw new Error("Firebase not configured.");const t=v==null?void 0:v.currentUser,i=t==null?void 0:t.uid;if(!i)throw new Error("Not signed in.");const r=(e??"").trim();if(!r)throw new Error("Family name is required.");const a=new Date,s=pe(),n=new Date(Date.now()+720*60*60*1e3),d={displayName:t.displayName??"",profilePhotoURL:t.photoURL??null,role:"admin",joinedAt:a,updatedAt:a},l={name:r,createdBy:i,createdInApp:"cairn",memberIds:[],cairnMemberIds:[i],connectedFamilyIds:[],cairnMaxMembers:20,cairnInviteCode:s,cairnInviteCodeExpiresAt:n,memberProfiles:{[i]:d},createdAt:w(),updatedAt:w()},g=await j(z(u,"families"),l);return await B(_(u,"users",i),{email:t.email??"",displayName:t.displayName??"",profilePhotoURL:t.photoURL??null,cairnFamilyId:g.id,role:"admin",notificationPreferences:{milestoneReminders:!1,tipNotifications:!1,schoolDeadlines:!1},createdAt:w(),updatedAt:w()},{merge:!0}),g.id}async createPebblePathFamily(e){if(!u)throw new Error("Firebase not configured.");const t=v==null?void 0:v.currentUser,i=t==null?void 0:t.uid;if(!i)throw new Error("Not signed in.");const r=(e??"").trim();if(!r)throw new Error("Family name is required.");const a=new Date,s=pe(),n=new Date(Date.now()+720*60*60*1e3),d={displayName:t.displayName??"",profilePhotoURL:t.photoURL??null,role:"admin",joinedAt:a,updatedAt:a},l={name:r,createdBy:i,memberIds:[i],cairnMemberIds:[i],connectedFamilyIds:[],cairnMaxMembers:20,inviteCode:s,inviteCodeExpiresAt:n,cairnInviteCode:s,cairnInviteCodeExpiresAt:n,memberProfiles:{[i]:d},createdAt:w(),updatedAt:w()},g=await j(z(u,"families"),l);return await B(_(u,"users",i),{email:t.email??"",displayName:t.displayName??"",profilePhotoURL:t.photoURL??null,familyId:g.id,role:"owner",notificationPreferences:{milestoneReminders:!1,tipNotifications:!1,schoolDeadlines:!1},createdAt:w(),updatedAt:w()},{merge:!0}),g.id}async createChild(e,t){var c,h;if(!u)throw new Error("Firebase not configured.");const i=(c=v==null?void 0:v.currentUser)==null?void 0:c.uid;if(!i)throw new Error("Not signed in.");if(!e)throw new Error("No family.");const r=((t==null?void 0:t.name)??"").trim();if(!r)throw new Error("Child's name is required.");if(!((t==null?void 0:t.dateOfBirth)instanceof Date))throw new Error("Child's date of birth is required.");const{getDoc:a}=await K(async()=>{const{getDoc:f}=await import("./firebase-core-DEm61vaB.js").then(x=>x.J);return{getDoc:f}},[]),s=await a(_(u,"families",e)),n=s.exists()?Array.isArray((h=s.data())==null?void 0:h.memberIds)?s.data().memberIds:[]:[],d=n.length?n:[i],l={name:r,dateOfBirth:t.dateOfBirth,profilePhotoURL:null,developmentalFlags:Array.isArray(t==null?void 0:t.developmentalFlags)?t.developmentalFlags:[],pediatricianNotes:null,region:(t==null?void 0:t.region)??null,parentIds:d,needsServerSeed:!0,createdAt:w(),updatedAt:w()};return(await j(z(u,"families",e,"children"),l)).id}async uploadChildAvatar(e,t,i){if(!u||!E)throw new Error("Firebase not configured.");if(!e||!t)throw new Error("Missing family/child id.");if(!i)throw new Error("No image.");const r=i.type&&i.type.startsWith("image/")?i.type:"image/jpeg",a=q(E,`families/${e}/avatars/children/${t}`);await J(a,i,{contentType:r});const s=await W(a);return await C(_(u,"families",e,"children",t),{profilePhotoURL:s,updatedAt:w()}),s}async uploadUserAvatar(e,t){var n;if(!u||!E)throw new Error("Firebase not configured.");const i=(n=v==null?void 0:v.currentUser)==null?void 0:n.uid;if(!i)throw new Error("Not signed in.");if(!e)throw new Error("No family.");if(!t)throw new Error("No image.");const r=t.type&&t.type.startsWith("image/")?t.type:"image/jpeg",a=q(E,`families/${e}/avatars/users/${i}`);await J(a,t,{contentType:r});const s=await W(a);await C(_(u,"users",i),{profilePhotoURL:s,updatedAt:w()});try{await C(_(u,"families",e),{[`memberProfiles.${i}.profilePhotoURL`]:s,[`memberProfiles.${i}.updatedAt`]:w(),updatedAt:w()})}catch(d){console.warn("memberProfiles photo fan-out failed:",d)}return s}async requestToBeCoParent(e){var a,s,n,d,l;if(!u)throw new Error("Firebase not configured.");const t=(a=v==null?void 0:v.currentUser)==null?void 0:a.uid;if(!t)throw new Error("Not signed in.");const i=this._currentFamilyId??((s=this.state.user)==null?void 0:s.cairnFamilyId)??((n=this.state.user)==null?void 0:n.familyId)??null;if(!i)throw new Error("No family.");if(!e)throw new Error("No child.");const r=((d=this.state.user)==null?void 0:d.displayName)??((l=v==null?void 0:v.currentUser)==null?void 0:l.displayName)??"";await B(_(u,"families",i,"children",e,"coParentRequests",t),{uid:t,displayName:r,status:"pending",requestedAt:w()})}async fetchFamilyChildren(e){if(!u||!e)return[];try{return(await H(z(u,"families",e,"children"))).docs.map(i=>({id:i.id,...i.data()}))}catch(t){return console.warn("[parent-prompt] fetchFamilyChildren skipped (non-fatal):",t),[]}}async regenerateCairnInviteCode(){if(!u||!this._currentFamilyId)throw new Error("No family yet.");const e=pe(),t=new Date(Date.now()+720*60*60*1e3);return await C(_(u,"families",this._currentFamilyId),{cairnInviteCode:e,cairnInviteCodeExpiresAt:t,updatedAt:w()}),{code:e,expiresAt:t}}_maybeMigrateInviteCodeFormat(){const e=this.state.family;if(!e||!this._uid||this._inviteCodeMigratedFamilyId===e.id)return;const t=e.cairnInviteCode;if(!t||typeof t!="string")return;if(!t.includes("-")){this._inviteCodeMigratedFamilyId=e.id;return}(Array.isArray(e.memberIds)?e.memberIds:[]).includes(this._uid)&&(this._inviteCodeMigratedFamilyId=e.id,this.regenerateCairnInviteCode().catch(r=>{console.debug("invite-code format migration deferred:",(r==null?void 0:r.code)??(r==null?void 0:r.message)??r)}))}stop(){var e,t,i,r,a;(e=this._unsubUser)==null||e.call(this),(t=this._unsubFamily)==null||t.call(this),(i=this._unsubChildren)==null||i.call(this),(r=this._unsubTrips)==null||r.call(this),(a=this._unsubEvents)==null||a.call(this),this._unsubUser=this._unsubFamily=this._unsubChildren=this._unsubTrips=this._unsubEvents=null,this._teardownPpFamily(),this._uid=null,this._currentFamilyId=null,this._inviteCodeMigratedFamilyId=null,this._holidayKey=null,this._ppFamilyId=null,this.userDocResolved=!1,this.state={user:null,family:null,children:[],trips:[],events:[],holidays:[],ppFamily:null,ppIsMember:!1,ppChildren:[],selectedChildId:null,childMilestones:[],childInsights:[],childDailyCard:null,childPebbleMessages:[],childPebbleSessions:[]}}_emit(){this.dispatchEvent(new Event("change"))}}const b=new Bt;function ht(p,e){const t=e==null?void 0:e.profilePhotoURL;return typeof t=="string"&&/^https?:\/\//i.test(t)?t:p!=null&&p.photoURL?p.photoURL:null}function jt(p,e,t=[]){if(!e)return[];const i=e.memberIds??[],r=e.cairnMemberIds??e.memberIds??[],a=e.memberProfiles??{},s=i.includes(p),n=s?r:Array.from(new Set([...r,...i])),d=[];let l=280;for(const g of n){if(g===p||s&&i.includes(g))continue;const c=a[g],h=c==null?void 0:c.profilePhotoURL,f=i.includes(g);d.push({uid:g,displayName:(c==null?void 0:c.displayName)??"Family",photoURL:typeof h=="string"&&/^https?:\/\//i.test(h)?h:null,role:f?"co-parent":"extended",circles:["extended"],hue:l}),l=(l+47)%360}return d}async function Ut(p,e){var n,d;const t=Array.isArray(e==null?void 0:e.connectedFamilyIds)?e.connectedFamilyIds:[];if(t.length===0||!u)return[];const{getDoc:i}=await K(async()=>{const{getDoc:l}=await import("./firebase-core-DEm61vaB.js").then(g=>g.J);return{getDoc:l}},[]),r=[],a=new Set(p?[p]:[]);let s=150;for(const l of t)try{const g=await i(_(u,"families",l));if(!g.exists())continue;const c=g.data()??{},h=c.memberProfiles??{},f=c.name??"Connection";for(const x of c.memberIds??[]){if(a.has(x))continue;a.add(x);const P=(n=h[x])==null?void 0:n.profilePhotoURL;r.push({uid:x,displayName:((d=h[x])==null?void 0:d.displayName)??"Connection",photoURL:typeof P=="string"&&/^https?:\/\//i.test(P)?P:null,role:"connection",circles:["connection"],familyName:f,hue:s}),s=(s+53)%360}}catch{}return r}function ce(p,e,t,i=[],r=[]){const a=(e==null?void 0:e.memberIds)??[],s=(e==null?void 0:e.cairnMemberIds)??[],n=t?[t]:[],d=Array.isArray(i)?i:[],l=Array.isArray(r)?r:[];return p==="personal"?[...new Set(n)]:p==="extended"?[...new Set([...a,...s,...n,...d,...l])]:[...new Set([...a,...n,...d])]}async function Lt(p){var r;const e=Array.isArray(p==null?void 0:p.connectedFamilyIds)?p.connectedFamilyIds:[];if(e.length===0||!u)return[];const{getDoc:t}=await K(async()=>{const{getDoc:a}=await import("./firebase-core-DEm61vaB.js").then(s=>s.J);return{getDoc:a}},[]),i=new Set;for(const a of e)try{const s=await t(_(u,"families",a));if(!s.exists())continue;for(const n of((r=s.data())==null?void 0:r.memberIds)??[])i.add(n)}catch{}return[...i]}function pe(){const p="ABCDEFGHJKMNPQRSTUVWXYZ23456789";let e="";for(let t=0;t<6;t++)e+=p[Math.floor(Math.random()*p.length)];return e}function Gt(p,e,t,i,r){const a=[],s=new Set((i==null?void 0:i.memberIds)??[]),n=s.has(p);if(a.push({uid:p,displayName:(e==null?void 0:e.displayName)??(t==null?void 0:t.displayName)??"You",photoURL:ht(e,t),role:n?"self":"self-extended",circles:["immediate"],hue:198}),!n)return a;const d=(i==null?void 0:i.memberProfiles)??{};for(const[g,c]of Object.entries(d)){if(g===p||!s.has(g))continue;const h=c.profilePhotoURL;a.push({uid:g,displayName:c.displayName??"Co-parent",photoURL:typeof h=="string"&&/^https?:\/\//i.test(h)?h:null,role:"co-parent",circles:["immediate"],hue:8})}let l=142;for(const g of r??[]){const c=g.profilePhotoURL;a.push({uid:`child:${g.id}`,displayName:g.name,photoURL:typeof c=="string"&&/^https?:\/\//i.test(c)?c:null,role:"child",circles:["immediate"],hue:l,dateOfBirth:g.dateOfBirth}),l=(l+58)%360}return a}function Yt(p){const e=[];for(const t of p??[]){if(!t.dateOfBirth)continue;const i=t.dateOfBirth,r=i.getUTCFullYear(),a=String(i.getUTCMonth()+1).padStart(2,"0"),s=String(i.getUTCDate()).padStart(2,"0");e.push({id:`bday:${t.id}`,type:"birthday",date:`${r}-${a}-${s}`,personIds:[`child:${t.id}`],title:`${t.name}'s birthday`,_childId:t.id,_childName:t.name,recurring:!0})}return e}function qt(p,e=new Date){if(!(p!=null&&p.date))return{date:null,yearsElapsed:0};const t=$(p.date);if(!t||Number.isNaN(t.getTime()))return{date:null,yearsElapsed:0};if(!p.recurring)return{date:t,yearsElapsed:0};const i=new Date(e.getFullYear(),t.getMonth(),t.getDate()),r=i<new Date(e.getFullYear(),e.getMonth(),e.getDate())?new Date(e.getFullYear()+1,t.getMonth(),t.getDate()):i,a=r.getFullYear()-t.getFullYear();return{date:r,yearsElapsed:a}}const We=["linear-gradient(135deg, #6b9ac4 0%, #c98a8a 60%, #d4a843 100%)","linear-gradient(135deg, #7a9e7e 0%, #4a6754 70%, #2c4439 100%)","linear-gradient(135deg, #c67b5c 0%, #d4a843 50%, #c98a8a 100%)","linear-gradient(135deg, #3d9b8f 0%, #1f5c54 100%)","linear-gradient(135deg, #d4a843 0%, #c67b5c 55%, #c98a8a 100%)","linear-gradient(135deg, #8b7bb5 0%, #c98a8a 60%, #d4a843 100%)","linear-gradient(135deg, #6b9ac4 0%, #3d9b8f 100%)"];function $(p){if(!p)return null;if(p instanceof Date)return p;const e=String(p).match(/^(\d{4})-(\d{2})-(\d{2})/);return e?new Date(Number(e[1]),Number(e[2])-1,Number(e[3])):new Date(p)}function Vt(p){if(!p)return null;const e=p.getFullYear(),t=String(p.getMonth()+1).padStart(2,"0"),i=String(p.getDate()).padStart(2,"0");return`${e}-${t}-${i}`}async function Ht(p,e=90,t=100){const i=new Date,r=new Date(i.getTime()+e*24*60*60*1e3),a=new URL("https://www.googleapis.com/calendar/v3/calendars/primary/events");a.searchParams.set("timeMin",i.toISOString()),a.searchParams.set("timeMax",r.toISOString()),a.searchParams.set("maxResults",String(t)),a.searchParams.set("singleEvents","true"),a.searchParams.set("orderBy","startTime");const s=await fetch(a.toString(),{headers:{Authorization:`Bearer ${p}`}});if(!s.ok){const d=await s.text();throw s.status===401?new Error("Your Google session expired — connect your calendar again."):s.status===403&&/accessNotConfigured|SERVICE_DISABLED|PERMISSION_DENIED|insufficient/i.test(d)?new Error("Google Calendar access isn’t configured for this project yet. (Admin: enable the Google Calendar API and add the calendar.readonly scope to the OAuth consent screen in Google Cloud Console.)"):new Error(`Google Calendar: ${s.status} ${d.slice(0,160)}`)}return((await s.json()).items??[]).filter(d=>{var l,g;return d.status!=="cancelled"&&(((l=d.start)==null?void 0:l.date)||((g=d.start)==null?void 0:g.dateTime))})}function Wt(p,e){var r,a,s,n,d,l,g,c;const t=((r=p.start)==null?void 0:r.date)??((s=(a=p.start)==null?void 0:a.dateTime)==null?void 0:s.slice(0,10))??"";let i=((n=p.end)==null?void 0:n.date)??((l=(d=p.end)==null?void 0:d.dateTime)==null?void 0:l.slice(0,10))??t;if((g=p.start)!=null&&g.date&&((c=p.end)!=null&&c.date)){const h=new Date(i);h.setDate(h.getDate()-1),i=h.toISOString().slice(0,10)}return{title:p.summary||"(untitled)",location:p.location??"",start:t,end:i,attendees:e?[e]:[],viewers:[],visibility:"family",notes:(p.description??"").slice(0,1e3),gcalEventId:p.id,gcalEventLink:p.htmlLink??null}}function Jt(p){if(p!=null&&p.coverGradient)return p.coverGradient;const e=((p==null?void 0:p.title)??(p==null?void 0:p.id)??"")+((p==null?void 0:p.location)??"");let t=0;for(let i=0;i<e.length;i++)t=t*31+e.charCodeAt(i)>>>0;return We[t%We.length]}class we extends A{constructor(){super(),this.year=new Date().getFullYear(),this.tripDays=new Map,this.trips=[],this.events=[],this.holidays=[],this.today=new Date,this._activeDay=null}_isLeap(e){return e%4===0&&e%100!==0||e%400===0}_daysInMonth(e,t){return[31,this._isLeap(e)?29:28,31,30,31,30,31,31,30,31,30,31][t]}_labelsForMonth(e){var a;const t=this.year,i=new Map,r=(s,n)=>{const d=i.get(s);i.set(s,d?`${d} · ${n}`:n)};for(const s of this.trips??[]){if(!s.start||!s.end)continue;const n=$(s.start),d=$(s.end);if(!n||!d||n.getFullYear()>t||d.getFullYear()<t)continue;const l=new Date(t,e,1),g=new Date(t,e+1,0);if(d<l||n>g)continue;const c=n.getMonth()===e&&n.getFullYear()===t?n.getDate():1,h=d.getMonth()===e&&d.getFullYear()===t?d.getDate():g.getDate(),f=(a=s.location)!=null&&a.trim()?`${s.title} (${s.location.trim()})`:s.title;for(let x=c;x<=h;x++)r(x,f)}for(const s of this.events??[]){const n=$(s.date);n&&n.getFullYear()===t&&n.getMonth()===e&&r(n.getDate(),s.title??"Event")}for(const s of this.holidays??[]){const n=$(s.date);n&&n.getFullYear()===t&&n.getMonth()===e&&r(n.getDate(),s.title??"Public holiday")}return i}_renderMonth(e){var l,g;const t=this.year,r=(new Date(t,e,1).getDay()+6)%7,a=this._daysInMonth(t,e),s=this._labelsForMonth(e),n=[];for(let c=0;c<r;c++)n.push(o`<div class="cell empty"></div>`);const d=this.today;for(let c=1;c<=a;c++){const h=`${String(e+1).padStart(2,"0")}-${String(c).padStart(2,"0")}`,f=this.tripDays.get(h)??0,x=d.getFullYear()===t&&d.getMonth()===e&&d.getDate()===c,P=s.get(c),M=(this.events??[]).some(O=>{const F=$(O.date);return F&&F.getFullYear()===t&&F.getMonth()===e&&F.getDate()===c}),k=(this.holidays??[]).some(O=>{const F=$(O.date);return F&&F.getFullYear()===t&&F.getMonth()===e&&F.getDate()===c}),S=((l=this._activeDay)==null?void 0:l.month)===e&&((g=this._activeDay)==null?void 0:g.day)===c,R=["cell",x?"today":"",k?"holiday":"",f>0?"trip":"",f>.6?"dense":"",M?"event":"",P?"labelled":"",S?"active":""].filter(Boolean).join(" ");n.push(o`<div
        class=${R}
      ...
      ${this._activeDay?o`
          ...
          `:""}
    `}}y(we,"properties",{year:{type:Number},tripDays:{type:Object},trips:{type:Array},events:{type:Array},holidays:{type:Array},today:{type:Object},_activeDay:{state:!0}}),y(we,"styles",I`
    :host {
      display: block;
    }
  ...
  `);customElements.define("yearly-view",we);class _e extends A{constructor(){super(),this.name="",this.hue=200,this.photo="",this.size=36,this.showName=!1}_initials(){return this.name.split(/\s+/).map(e=>e[0]).filter(Boolean).slice(0,2).join("").toUpperCase()}render(){const e=`linear-gradient(135deg, hsl(${this.hue}, 55%, 62%) 0%, hsl(${(this.hue+40)%360}, 50%, 42%) 100%)`,t=`width:${this.size}px;height:${this.size}px;background:${e};font-size:${this.size*.38}px;`;return o`
    ...
    `}}y(_e,"properties",{name:{type:String},hue:{type:Number},photo:{type:String},size:{type:Number},showName:{type:Boolean,attribute:"show-name"}}),y(_e,"styles",I`
    :host {
      display: inline-flex;
      align-items: center;
      gap: 8px;
  ...
  `);customElements.define("member-chip",_e);class ke extends A{constructor(){super(),this.start="",this.end="",this._displayMonth=null,this._hoverDate=null}willUpdate(e){if(e.has("start")||this._displayMonth===null){const t=this.start?$(this.start):new Date;this._displayMonth=new Date(t.getFullYear(),t.getMonth(),1)}}_isoFor(e,t,i){return`${e}-${String(t+1).padStart(2,"0")}-${String(i).padStart(2,"0")}`}_emit(e,t){this.start=e,this.end=t,this._hoverDate=null,this.dispatchEvent(new CustomEvent("range-change",{detail:{start:e,end:t},bubbles:!0,composed:!0}))}_onDayClick(e){if(!this.start||this.start&&this.end){this._emit(e,"");return}e<this.start?this._emit(e,this.start):this._emit(this.start,e)}_onDayHover(e){this.start&&!this.end&&(this._hoverDate=e)}_onLeave(){this._hoverDate=null}_shiftMonth(e){const t=this._displayMonth;this._displayMonth=new Date(t.getFullYear(),t.getMonth()+e,1)}_isToday(e,t,i){const r=new Date;return r.getFullYear()===e&&r.getMonth()===t&&r.getDate()===i}_inSelectedRange(e){return!this.start||!this.end?!1:e>this.start&&e<this.end}_inHoverRange(e){if(!this.start||this.end||!this._hoverDate)return!1;const t=this._hoverDate<this.start?this._hoverDate:this.start,i=this._hoverDate<this.start?this.start:this._hoverDate;return e>t&&e<i}_summary(){if(!this.start&&!this.end)return"Pick a start date";const e=t=>{const i=$(t);return i?i.toLocaleString("en-GB",{day:"numeric",month:"short",year:"numeric"}):""};return this.start&&!this.end?`From ${e(this.start)} — pick an end date`:this.start===this.end?e(this.start):`${e(this.start)} – ${e(this.end)}`}_renderGrid(){const e=this._displayMonth.getFullYear(),t=this._displayMonth.getMonth(),r=(new Date(e,t,1).getDay()+6)%7,a=new Date(e,t+1,0).getDate(),s=[];for(let n=0;n<r;n++)s.push(o`<div class="empty"></div>`);for(let n=1;n<=a;n++){const d=this._isoFor(e,t,n),l=d===this.start,g=d===this.end&&d!==this.start,c=this._inSelectedRange(d),h=this._inHoverRange(d),f=this._isToday(e,t,n),x=["day",l?"start":"",g?"end":"",c?"in-range":"",h?"hover-range":"",f&&!l&&!g?"today":""].filter(Boolean).join(" ");s.push(o`
    ...
    `}}y(ke,"properties",{start:{type:String},end:{type:String},_displayMonth:{state:!0},_hoverDate:{state:!0}}),y(ke,"styles",I`
    * { box-sizing: border-box; }
    :host {
      display: block;
    }
  ...
  `);customElements.define("trip-form",$e);class Ce extends A{constructor(){super(),this.open=!1,this.event=null,this.members=[],this.familyId="",this.busy=!1,this._draft=this._blankDraft(),this._error=""}willUpdate(e){(e.has("event")||e.has("open"))&&(this.open&&(this._draft=this._draftFromEvent(this.event)),this._error="")}_blankDraft(){return{id:null,type:"birthday",title:"",date:new Date().toISOString().slice(0,10),personIds:[],recurring:!0,subtitle:"",notes:"",visibility:"family"}}_draftFromEvent(e){return e?{id:e.id??null,type:e.type??"birthday",title:e.title??"",date:e.date??new Date().toISOString().slice(0,10),personIds:Array.isArray(e.personIds)?[...e.personIds]:[],recurring:e.recurring??!0,subtitle:e.subtitle??"",notes:e.notes??"",visibility:e.visibility??"family"}:this._blankDraft()}_set(e,t){this._draft={...this._draft,[e]:t}}_toggleType(e){this._set("type",e)}_togglePerson(e){const t=this._draft.personIds.includes(e);this._set("personIds",t?this._draft.personIds.filter(i=>i!==e):[...this._draft.personIds,e])}_onSave(){const e=this._draft;if(!e.title.trim()){this._error="Give it a title.";return}if(!e.date){this._error="Pick a date.";return}if(!this.familyId){this._error="No family yet.";return}this._error="",this.dispatchEvent(new CustomEvent("save",{detail:{...e,title:e.title.trim(),subtitle:e.subtitle.trim(),notes:e.notes.trim()}}))}_onDelete(){this._draft.id&&confirm("Delete this event? This can't be undone.")&&this.dispatchEvent(new CustomEvent("remove",{detail:{id:this._draft.id}}))}_onCancel(){this.dispatchEvent(new Event("cancel"))}render(){if(!this.open)return o``;const e=this._draft,t=!!e.id;return o`
    ...
    `}_monthDay(e){if(!e)return"";const t=$(e);return!t||Number.isNaN(t.getTime())?"":t.toLocaleString("en-GB",{day:"numeric",month:"long"})}}y(Ce,"properties",{open:{type:Boolean,reflect:!0},event:{type:Object},members:{type:Array},familyId:{type:String},busy:{type:Boolean},_draft:{state:!0},_error:{state:!0}}),y(Ce,"styles",I`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("event-form",Ce);class Pe extends A{constructor(){super(),this.immediate=[],this.extended=[]}_self(){return(this.immediate??[]).find(e=>e.role==="self"||e.role==="self-extended")}_family(){return(this.immediate??[]).filter(e=>e.role==="co-parent"||e.role==="child")}_connections(){return this.extended??[]}_pos(e,t,i,r){if(t<=0)return"left:50%;top:50%;";const a=(r+e/t*360)*(Math.PI/180),s=50+i*Math.cos(a),n=50+i*Math.sin(a);return`left:${s}%;top:${n}%;`}_node(e,t,i){const r=(e.displayName??"").split(/\s+/)[0]||e.displayName||"";return o`
    ...
    `}}y(Pe,"properties",{immediate:{type:Array},extended:{type:Array}}),y(Pe,"styles",I`
    * {
      box-sizing: border-box;
    }
    :host {
...
`)}class Ae extends A{constructor(){super(),this.trip=null,this.members=[],this._resizeObs=null}connectedCallback(){super.connectedCallback(),typeof ResizeObserver<"u"&&(this._resizeObs=new ResizeObserver(()=>this._fitTitle()))}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._resizeObs)==null||e.disconnect()}updated(){if(this._resizeObs&&this.renderRoot){const e=this.renderRoot.querySelector("article");e&&!e._observed&&(this._resizeObs.observe(e),e._observed=!0)}this._fitTitle()}_fitTitle(){if(!this.renderRoot)return;const e=this.renderRoot.querySelector("h3");if(!e)return;e.style.fontSize="";let t=19;for(e.style.fontSize=`${t}px`;e.scrollWidth>e.clientWidth+1&&t>13;)t-=.5,e.style.fontSize=`${t}px`}_fmtDates(e,t){const i=$(e),r=$(t);if(!i||!r)return"";const a=i.toLocaleString("en-GB",{month:"short"}),s=r.toLocaleString("en-GB",{month:"short"});return a===s&&i.getFullYear()===r.getFullYear()?`${i.getDate()} – ${r.getDate()} ${a}`:`${i.getDate()} ${a} – ${r.getDate()} ${s}`}async _onShare(e,t,i){i.stopPropagation();const r=Zt(e,t);if(navigator.share)try{await navigator.share({title:`Portal — ${e.title??"activity"}`,text:r})}catch{}else try{await navigator.clipboard.writeText(r),m("Itinerary copied to clipboard.")}catch{m("Could not copy — try again from a browser tab.")}}render(){const e=this.trip;if(!e)return o``;const t=e.previewImage&&String(e.previewImage).trim()||e.coverImage,i=t?`background-image: url("${t}");`:`background: ${Jt(e)};`,r=t?"cover has-image":"cover",a=new Map(this.members.map(l=>[l.uid,l])),s=(e.attendees??[]).map(l=>a.get(l)).filter(Boolean),n=s.slice(0,4),d=Math.max(0,s.length-n.length);return o`
    ...
    `}}y(Ae,"properties",{trip:{type:Object},members:{type:Array}}),y(Ae,"styles",I`
    :host {
      display: block;
    }
    article {
  ...
  `);customElements.define("trip-card",Ae);class Ie extends A{constructor(){super(),this.open=!1,this.trips=[],this.members=[]}_onCancel(){this.dispatchEvent(new Event("cancel"))}_groupByYear(e){const t=[...e].sort((a,s)=>String(a.start).localeCompare(String(s.start))),i=new Date;i.setHours(0,0,0,0);const r=new Map;for(const a of t){if(!a.start)continue;const s=$(a.start),n=$(a.end);if(!s)continue;const d=s.getFullYear();r.has(d)||r.set(d,[]);const l=n?n<i:!1;r.get(d).push({trip:a,isPast:l})}return r}render(){var r;if(!this.open)return o``;const e=this._groupByYear(this.trips??[]),t=((r=this.trips)==null?void 0:r.length)??0,i=new Date().getFullYear();return o`
      <div class="backdrop" @click=${this._onCancel}></div>
      <div class="sheet">
        <glass-panel padding="lg" variant="strong" lifted>
          <div class="header">
    ...
    `}}y(Ie,"properties",{open:{type:Boolean,reflect:!0},trips:{type:Array},members:{type:Array}}),y(Ie,"styles",I`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("all-trips-modal",Ie);class Me extends A{constructor(){super(),this.open=!1,this._events=[],this._selected=new Set,this._loading=!1,this._error="",this._importing=!1,this._started=!1,this._mode=null,this._targetTripId="",this._skippedOutOfRange=0,this._addedCount=0}willUpdate(e){e.has("open")&&this.open&&(this._started=!1,this._error="",this._mode=null,this._targetTripId="",this._skippedOutOfRange=0,this._addedCount=0)}_eligibleTrips(){const e=new Date().toISOString().slice(0,10);return(Array.isArray(b.state.trips)?b.state.trips:[]).filter(i=>i&&i.end&&String(i.end)>=e).sort((i,r)=>String(i.start||"").localeCompare(String(r.start||"")))}_pickMode(e){this._mode=e}_pickTrip(e){this._targetTripId=e}_start(){this._loading||(this._started=!0,this._load())}async _load(){var e,t,i,r,a,s;this._loading=!0,this._error="";try{const n=await ot(),d=await Ht(n,90),l=new Set((b.state.trips??[]).filter(c=>c.gcalEventId).map(c=>c.gcalEventId));this._events=d.map(c=>({...c,_alreadyImported:l.has(c.id)}));const g=new Set;for(const c of this._events){if(c._alreadyImported)continue;const h=((e=c.start)==null?void 0:e.date)??((i=(t=c.start)==null?void 0:t.dateTime)==null?void 0:i.slice(0,10)),f=((r=c.end)==null?void 0:r.date)??((s=(a=c.end)==null?void 0:a.dateTime)==null?void 0:s.slice(0,10));h&&f&&f!==h&&g.add(c.id)}this._selected=g}catch(n){console.error(n),this._error=(n==null?void 0:n.message)??"Could not load calendar events."}finally{this._loading=!1}}_toggle(e){const t=new Set(this._selected);t.has(e)?t.delete(e):t.add(e),this._selected=t}_toggleAll(){const e=this._events.filter(t=>!t._alreadyImported);this._selected.size===e.length?this._selected=new Set:this._selected=new Set(e.map(t=>t.id))}async _import(){var s,n,d,l;if(this._importing||this._selected.size===0)return;this._importing=!0;const e=(s=v==null?void 0:v.currentUser)==null?void 0:s.uid,t=this._events.filter(g=>this._selected.has(g.id));let i=0,r=0,a=0;if(this._mode==="addToTrip"){const g=this._eligibleTrips().find(c=>c.id===this._targetTripId);if(!g){this._importing=!1,m("Couldn’t find that activity. Try again.",{duration:4e3});return}for(const c of t){const h=((n=c.start)==null?void 0:n.date)??((l=(d=c.start)==null?void 0:d.dateTime)==null?void 0:l.slice(0,10));if(!h){a++;continue}if(h<g.start||h>g.end){a++;continue}const f=this._calendarEventToPlanItem(c,h);try{await b.addPlanItem(g.id,f),i++}catch(x){console.error("addPlanItem failed for event",c.id,x),r++}}this._importing=!1,this._skippedOutOfRange=a,this._addedCount=i;return}for(const g of t){const c=Wt(g,e);try{await b.saveTrip(c),i++}catch(h){console.error("Import failed for event",g.id,h),r++}}this._importing=!1,r===0?m(`Imported ${i} ${i===1?"activity":"activities"}.`):m(`Imported ${i}, ${r} failed.`,{duration:5e3}),this._events=[],this._selected=new Set,this.dispatchEvent(new Event("cancel"))}_calendarEventToPlanItem(e,t){var n,d;const i=`${e.summary??""} ${e.description??""}`.toLowerCase();let r="visit";/(lunch|dinner|breakfast|brunch|coffee|restaurant|caf[eé])/i.test(i)?r="meal":/(flight|airline|airport|drive|train|taxi|uber|lyft|transfer)/i.test(i)&&(r="travel");let a="",s;if((n=e.start)!=null&&n.dateTime&&((d=e.end)!=null&&d.dateTime)){const l=new Date(e.start.dateTime),g=new Date(e.end.dateTime),c=String(l.getHours()).padStart(2,"0"),h=String(l.getMinutes()).padStart(2,"0");a=`${c}:${h}`;const f=Math.round((g-l)/6e4);f>0&&(s=Math.min(f,600))}return{title:(e.summary||"(untitled)").trim(),type:r,day:t,time:a,durationMins:s}}_openPlannerForTarget(){this._targetTripId&&(this.dispatchEvent(new CustomEvent("open-trip-planner",{detail:{tripId:this._targetTripId},bubbles:!0,composed:!0})),this._closeAndReset())}_closeAndReset(){this._events=[],this._selected=new Set,this._mode=null,this._targetTripId="",this._skippedOutOfRange=0,this._addedCount=0,this._started=!1,this.dispatchEvent(new Event("cancel"))}_onCancel(){this.dispatchEvent(new Event("cancel"))}_fmtRange(e){var g,c,h,f,x,P,M,k;const t=((g=e.start)==null?void 0:g.date)??((h=(c=e.start)==null?void 0:c.dateTime)==null?void 0:h.slice(0,10)),i=((f=e.end)==null?void 0:f.date)??((P=(x=e.end)==null?void 0:x.dateTime)==null?void 0:P.slice(0,10));if(!t)return"";const r=new Date(t);if(!i||i===t)return r.toLocaleString("en-GB",{day:"numeric",month:"short",year:"numeric"});let a=new Date(i);(M=e.start)!=null&&M.date&&((k=e.end)!=null&&k.date)&&a.setDate(a.getDate()-1);const s=r.getMonth()===a.getMonth()&&r.getFullYear()===a.getFullYear(),n=r.getFullYear()===a.getFullYear();if(s)return`${r.getDate()}–${a.getDate()} ${r.toLocaleString("en-GB",{month:"short",year:"numeric"})}`;const d=r.toLocaleString("en-GB",{day:"numeric",month:"short"}),l=a.toLocaleString("en-GB",{day:"numeric",month:"short",year:"numeric"});return n?`${d} – ${l}`:`${r.toLocaleDateString()} – ${a.toLocaleDateString()}`}render(){if(!this.open)return o``;const e=this._events.filter(s=>!s._alreadyImported),t=e.length>0&&this._selected.size===e.length,i=this._mode===null,r=this._mode==="addToTrip"&&!this._targetTripId,a=this._mode==="addToTrip"&&this._addedCount>0&&!this._importing;return o`
      <div class="backdrop" @click=${this._onCancel}></div>
      <div class="sheet">
        <glass-panel padding="lg" variant="strong" lifted>
          <div class="header">
    ...
    `}_renderLoadAndList(e,t){return o`
      ...
      ${this._started?this._loading?o`<div class="loading">Loading your calendar…</div>`:this._error?o`
              ...
              `}
    `}}y(Me,"properties",{open:{type:Boolean,reflect:!0},_events:{state:!0},_selected:{state:!0},_loading:{state:!0},_error:{state:!0},_importing:{state:!0},_started:{state:!0},_mode:{state:!0},_targetTripId:{state:!0},_skippedOutOfRange:{state:!0},_addedCount:{state:!0}}),y(Me,"styles",I`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("import-calendar-modal",Me);class ze extends A{constructor(){super(),this.open=!1,this.user=null,this.pebbleUser=null,this._name="",this._savingName=!1,this._uploadingPhoto=!1}willUpdate(e){var t;e.has("open")&&this.open&&(this._name=((t=this.user)==null?void 0:t.displayName)??"")}_onCancel(){this.dispatchEvent(new Event("cancel"))}async _saveName(){var i,r;const e=this._name.trim();if(!e||e===(((i=this.user)==null?void 0:i.displayName)??""))return;const t=(r=v==null?void 0:v.currentUser)==null?void 0:r.uid;if(!(!t||!u)){this._savingName=!0;try{await C(_(u,"users",t),{displayName:e,updatedAt:w()});const a=b.familyId;if(a)try{await C(_(u,"families",a),{[`memberProfiles.${t}.displayName`]:e,[`memberProfiles.${t}.updatedAt`]:w(),updatedAt:w()})}catch(s){console.warn("memberProfiles fan-out failed:",s)}m("Display name updated.")}catch(a){console.error(a),m(`Couldn't save: ${a.code??a.message}`,{duration:5e3})}finally{this._savingName=!1}}}async _signOut(){confirm("Sign out of PebblePath?")&&(this.dispatchEvent(new Event("cancel")),await ct())}_triggerPhotoPicker(){var e;(e=this.renderRoot.querySelector("#photo-file"))==null||e.click()}async _onPhotoChosen(e){var a,s;const t=(a=e.target.files)==null?void 0:a[0];if(e.target.value="",!t)return;if(!t.type.startsWith("image/")){m("Pick an image file (JPG, PNG, etc.).");return}if(t.size>5*1024*1024){m("Photo is too big — keep it under 5 MB.");return}const i=(s=v==null?void 0:v.currentUser)==null?void 0:s.uid,r=b.familyId;if(!i||!r||!E){m("Can't upload yet — you need to be in a family first.");return}this._uploadingPhoto=!0;try{const n=q(E,`families/${r}/avatars/users/${i}`);await J(n,t,{contentType:t.type});const d=await W(n);await C(_(u,"users",i),{profilePhotoURL:d,updatedAt:w()});try{await C(_(u,"families",r),{[`memberProfiles.${i}.profilePhotoURL`]:d,[`memberProfiles.${i}.updatedAt`]:w(),updatedAt:w()})}catch(l){console.warn("memberProfiles photo fan-out failed:",l)}m("Photo updated.")}catch(n){console.error("Photo upload failed",n),m(`Upload failed: ${n.code??n.message}`,{duration:5e3})}finally{this._uploadingPhoto=!1}}render(){if(!this.open)return o``;const e=this.user,t=this._name.trim()&&this._name.trim()!==((e==null?void 0:e.displayName)??"");return o`
      <div class="backdrop" @click=${this._onCancel}></div>
      <div class="sheet">
        <glass-panel padding="lg" variant="strong" lifted>
          <div class="header">
    ...
    `}}y(ze,"properties",{open:{type:Boolean,reflect:!0},user:{type:Object},pebbleUser:{type:Object},_name:{state:!0},_savingName:{state:!0},_uploadingPhoto:{state:!0}}),y(ze,"styles",I`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("profile-sheet",ze);const ae=class ae extends A{constructor(){super(),this.open=!1}static get OPTIONS(){return[{type:"activity",tone:"sage",icon:o`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    `:o``}};y(ae,"properties",{open:{type:Boolean,reflect:!0}}),y(ae,"styles",I`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);let De=ae;customElements.define("activity-type-picker",De);class Ee extends A{constructor(){super(),this.open=!1,this.floating=!1,this.family=null,this.trips=[],this._messages=[],this._input="",this._loading=!1,this._error="",this._followUps=[]}willUpdate(e){var t;e.has("_messages")&&(this.floating=(((t=this._messages)==null?void 0:t.length)??0)>0)}_onCancel(){this.dispatchEvent(new Event("cancel"))}_suggestions(){const e=[],t=(this.trips??[]).filter(i=>i.start&&new Date(i.start)>=new Date).sort((i,r)=>String(i.start).localeCompare(String(r.start)))[0];return t&&(e.push(`What should we do in ${t.location||t.title}?`),e.push(`What should we pack for ${t.title}?`)),e.push("Plan a family activity for this weekend"),e.push("Gift ideas for an upcoming birthday"),e.slice(0,4)}async _send(e){const t=(e??this._input).trim();if(!(!t||this._loading)){this._error="",this._input="",this._followUps=[],this._messages=[...this._messages,{role:"user",content:t}],this._loading=!0,this.updateComplete.then(()=>this._scrollToBottom());try{const i=this._messages.slice(0,-1).map(a=>({role:a.role,content:a.content})),r=await b.askPebble(t,i);this._messages=[...this._messages,{role:"assistant",content:r.answer}],this._followUps=Array.isArray(r.followUps)?r.followUps:[]}catch(i){console.error(i),(i==null?void 0:i.code)==="functions/unauthenticated"?this._error="Pebble needs you to be signed in.":(i==null?void 0:i.code)==="functions/permission-denied"?this._error="You're not in this family yet.":(i==null?void 0:i.code)==="functions/not-found"||(i==null?void 0:i.code)==="functions/internal"?this._error="Pebble isn't available right now — the Cloud Function may not be deployed yet.":this._error=(i==null?void 0:i.message)??"Pebble could not answer right now."}finally{this._loading=!1,this.updateComplete.then(()=>this._scrollToBottom())}}}_scrollToBottom(){const e=this.renderRoot.querySelector(".thread");e&&(e.scrollTop=e.scrollHeight)}_renderPebbleIcon(){return o`<pebble-icon color="#fff"></pebble-icon>`}render(){if(!this.open)return o``;const e=this._suggestions();return o`
    ...
    `}}y(Ee,"properties",{open:{type:Boolean,reflect:!0},floating:{type:Boolean,reflect:!0},family:{type:Object},trips:{type:Array},_messages:{state:!0},_input:{state:!0},_loading:{state:!0},_error:{state:!0},_followUps:{state:!0}}),y(Ee,"styles",I`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("pebble-chat",Ee);class ut extends A{render(){return o`
  ...
  `);customElements.define("discover-pebblepath",ut);class Te extends A{constructor(){super(),this.code="",this._family=null,this._loading=!0,this._joining=!1,this._error="",this._step="join",this._children=[],this._claiming=!1,this._claimedName=null,this._joinedFamilyId=null}willUpdate(e){e.has("code")&&this.code&&this._lookup()}async _lookup(){var e;this._loading=!0,this._error="";try{const t=await b.findFamilyByConnectCode(this.code);if(!t)this._error="Invite code not found. Check it was typed correctly.",this._family=null;else{const i=t._matchedCodeKind==="pp"?t.inviteCodeExpiresAt:t.cairnInviteCodeExpiresAt,r=((e=i==null?void 0:i.toDate)==null?void 0:e.call(i))??(i?new Date(i):null);!r||r<new Date?(this._error="This invite code has expired. Ask the family for a fresh one.",this._family=null):this._family=t}}catch(t){console.error(t),this._error=(t==null?void 0:t.message)??"Couldn't look up the invite."}finally{this._loading=!1}}async _join(){var e;if(!this._joining){this._joining=!0,this._error="";try{const t=await b.redeemConnectCode(this.code);m(`Welcome to ${((e=this._family)==null?void 0:e.name)??"the family"}.`),this._joinedFamilyId=t;const i=await b.fetchFamilyChildren(t);Array.isArray(i)&&i.length?(this._children=i,this._step="parent"):this.dispatchEvent(new CustomEvent("joined",{detail:{familyId:t}}))}catch(t){console.error(t),this._error=(t==null?void 0:t.message)??"Could not join."}finally{this._joining=!1}}}async _claimChild(e){if(!(this._claiming||!(e!=null&&e.id))){this._claiming=!0,this._error="";try{await b.requestToBeCoParent(e.id),this._claimedName=e.name??"your child"}catch(t){console.error(t),this._error=(t==null?void 0:t.message)??"Couldn't send the request."}finally{this._claiming=!1}}}_notAParent(){this._finishJoin()}_finishJoin(){this.dispatchEvent(new CustomEvent("joined",{detail:{familyId:this._joinedFamilyId}}))}_cancel(){this.dispatchEvent(new Event("cancel"))}_inviterFromFamily(e){var r;if(!e)return null;const t=(r=e.memberProfiles)==null?void 0:r[e.createdBy];if(!t)return null;const i=t.profilePhotoURL;return{displayName:t.displayName??"A family member",photoURL:typeof i=="string"&&/^https?:\/\//i.test(i)?i:null}}_renderParentPrompt(){var t;const e=((t=this._family)==null?void 0:t.name)??"this family";return o`
    ...
    `}}y(Te,"properties",{code:{type:String},_family:{state:!0},_loading:{state:!0},_joining:{state:!0},_error:{state:!0},_step:{state:!0},_children:{state:!0},_claiming:{state:!0},_claimedName:{state:!0}}),y(Te,"styles",I`
    * { box-sizing: border-box; }
    :host {
      display: flex;
      align-items: center;
  ...
  `);customElements.define("join-family-screen",Te);class Fe extends A{constructor(){super(),this.error="",this.busy=!1,this.joinCode="",this._codeInputOpen=!1,this._code=""}async _handleSignIn(){if(this.busy)return;const e=(this._code??"").trim().toUpperCase();if(this._codeInputOpen&&e){const t=e.startsWith("CAIRN-")?e:`CAIRN-${e.replace(/^CAIRN-?/i,"")}`;try{localStorage.setItem("cairn:pendingJoinCode",t)}catch{}}this.busy=!0,this.error="";try{await de()}catch(t){this.error=(t==null?void 0:t.message)??"Sign-in failed."}finally{this.busy=!1}}_toggleCode(){this._codeInputOpen=!this._codeInputOpen,this._codeInputOpen&&requestAnimationFrame(()=>{var e;(e=this.renderRoot.querySelector(".code-input"))==null||e.focus()})}_renderGoogleIcon(){return o`
    ...
    `}}y(Fe,"properties",{error:{state:!0},busy:{state:!0},joinCode:{type:String},_codeInputOpen:{state:!0},_code:{state:!0}}),y(Fe,"styles",I`
    * {
      box-sizing: border-box;
    }
    :host {
  ...
  `);customElements.define("sign-in-screen",Fe);const Qt="cairn:pendingJoinCode",Ke="cairn:pendingLoginIntent";class Ne extends A{constructor(){super(),this.error="",this.busy=!1,this.joinCode="",this._step="welcome",this._email="",this._password="",this._displayName="",this._consent=!1,this._code="",this._resetSent=!1,this._invited=!1}willUpdate(e){if(e.has("joinCode")&&this.joinCode&&!this._invited){try{localStorage.setItem(Qt,(this.joinCode??"").trim().toUpperCase())}catch{}this._invited=!0}}_iconGoogle(){return o`<svg viewBox="0 0 48 48" aria-hidden="true">
    ...
    `}}y(Ne,"properties",{error:{state:!0},busy:{state:!0},joinCode:{type:String},_step:{state:!0},_email:{state:!0},_password:{state:!0},_displayName:{state:!0},_consent:{state:!0},_code:{state:!0},_resetSent:{state:!0},_invited:{state:!0}}),y(Ne,"styles",I`
    * { box-sizing: border-box; }
    :host {
      display: flex;
      align-items: center;
  ...
  `);customElements.define("register-screen",Ne);const Q=class Q extends A{constructor(){super(),this.value="family"}_select(e){e!==this.value&&(this.value=e,this.dispatchEvent(new CustomEvent("circle-change",{detail:{value:e},bubbles:!0,composed:!0})))}render(){return o`
    ...
    `}};y(Q,"properties",{value:{type:String,reflect:!0}}),y(Q,"OPTIONS",[{value:"personal",label:"Just me"},{value:"family",label:"Family"},{value:"extended",label:"Extended"}]),y(Q,"styles",I`
    * {
      box-sizing: border-box;
    }
    :host {
  ...
  `);let Re=Q;customElements.define("circle-switcher",Re);class Oe extends A{constructor(){super(),this.event=null,this.members=[]}_icon(e){return e==="birthday"?o`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
    ...
    `}}y(Oe,"properties",{event:{type:Object},members:{type:Array}}),y(Oe,"styles",I`
    :host {
      display: block;
    }
    .row {
  ...
  `);customElements.define("event-row",Oe);class Be extends A{constructor(){super();y(this,"_accept","application/pdf,image/*,application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/msword");this.open=!1,this._reset()}_reset(){this._phase="pick",this._events=[],this._err="",this._count=0}willUpdate(t){t.has("open")&&this.open&&this._reset()}_cancel(){this.dispatchEvent(new Event("cancel"))}async _onFile(t){var r;const i=(r=t.target.files)==null?void 0:r[0];if(t.target.value="",!!i){this._phase="working",this._err="";try{const{storagePath:a,fileType:s}=await b.uploadSchoolCalendar(i),n=await b.extractSchoolCalendarEvents(a,s);if(!n.length){this._phase="error",this._err="Couldn't find any dated events in that file. Try a clearer PDF or a screenshot of the calendar.";return}this._events=n.map(d=>({...d,_sel:!0})).sort((d,l)=>String(d.date).localeCompare(String(l.date))),this._phase="review"}catch(a){console.error("school import failed:",a),this._phase="error",this._err=(a==null?void 0:a.code)==="functions/permission-denied"?"You're not a member of this family.":(a==null?void 0:a.code)==="storage/unauthorized"?"The upload rule needs publishing — ask the team to deploy storage.rules.":(a==null?void 0:a.code)==="functions/not-found"||(a==null?void 0:a.code)==="functions/internal"?"The importer isn't available right now — try again in a moment.":(a==null?void 0:a.message)??"Something went wrong — try again."}}}_patch(t,i,r){const a=this._events.slice();a[t]={...a[t],[i]:r},this._events=a}get _selected(){return this._events.filter(t=>t._sel&&/^\d{4}-\d{2}-\d{2}$/.test(t.date)&&t.title.trim())}async _confirm(){const t=this._selected;if(t.length){this._phase="working";try{const i=await b.importSchoolEvents(t.map(r=>({date:r.date,title:r.title.trim(),type:r.type})));this._count=i,this._phase="done",m(`Added ${i} event${i===1?"":"s"} to the calendar.`),this.dispatchEvent(new CustomEvent("added",{detail:i}))}catch(i){console.error("importSchoolEvents failed:",i),this._phase="error",this._err=(i==null?void 0:i.code)==="permission-denied"?"Couldn't save — you may not have permission.":(i==null?void 0:i.message)??"Couldn't save the events — try again."}}}render(){return this.open?o`
    ...
    `:o``}}y(Be,"properties",{open:{type:Boolean,reflect:!0},_phase:{state:!0},_events:{state:!0},_err:{state:!0},_count:{state:!0}}),y(Be,"styles",I`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("school-import-modal",Be);const Xe=[{vb:"0 0 100 70",d:"M 8 38 C 6 18, 26 6, 48 8 C 72 10, 94 18, 94 38 C 94 58, 72 66, 48 64 C 22 62, 10 58, 8 38 Z"},{vb:"0 0 80 90",d:"M 38 6 C 56 8, 70 24, 72 46 C 74 70, 58 84, 38 84 C 16 84, 6 66, 8 44 C 10 22, 22 4, 38 6 Z"},{vb:"0 0 90 80",d:"M 14 26 C 18 10, 38 4, 56 8 C 78 14, 86 32, 82 50 C 76 70, 54 78, 32 72 C 12 66, 10 42, 14 26 Z"},{vb:"0 0 70 60",d:"M 8 30 C 8 14, 22 6, 38 8 C 54 10, 64 22, 62 36 C 60 52, 44 56, 28 54 C 14 52, 8 44, 8 30 Z"},{vb:"0 0 110 75",d:"M 8 38 C 6 18, 30 8, 56 10 C 84 12, 104 22, 104 40 C 102 58, 80 68, 52 66 C 24 64, 10 56, 8 38 Z"},{vb:"0 0 95 75",d:"M 14 24 C 18 10, 40 6, 56 12 C 70 18, 80 18, 86 30 C 90 44, 80 56, 64 60 C 48 64, 28 60, 18 50 C 10 42, 10 32, 14 24 Z"},{vb:"0 0 80 80",d:"M 14 20 C 20 10, 36 6, 52 10 C 68 16, 76 30, 72 48 C 66 64, 50 72, 32 66 C 16 60, 8 44, 10 30 C 12 24, 12 22, 14 20 Z"}];function ei(p){let e=5381;const t=String(p??"");for(let i=0;i<t.length;i+=1)e=e*33^t.charCodeAt(i);return Xe[Math.abs(e)%Xe.length]}const Ze={motor:{cls:"fam-motor",fill:"#6b9ac4",dom:"Motor"},language:{cls:"fam-language",fill:"#d4a843",dom:"Language"},socialEmotional:{cls:"fam-social",fill:"#c98a8a",dom:"Social-Emotional"},cognitive:{cls:"fam-cognitive",fill:"#8b7bb5",dom:"Cognitive"},cross:{cls:"fam-cross",fill:"#3d9b8f",dom:""}},Qe={strength:{label:"Strength",svg:o`<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M12 2.5l2.94 5.96 6.58.96-4.76 4.64 1.12 6.55L12 17.6l-5.88 3.01 1.12-6.55-4.76-4.64 6.58-.96L12 2.5z"/></svg>`},watching:{label:"Watching",svg:o`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M1.5 12S5 5 12 5s10.5 7 10.5 7-3.5 7-10.5 7S1.5 12 1.5 12z"/><circle cx="12" cy="12" r="3.2"/></svg>`},connection:{label:"Connection",svg:o`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M10 13a5 5 0 0 0 7.07.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71M14 11a5 5 0 0 0-7.07-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>`},nudge:{label:"Try this",svg:o`<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M9 21c0 .55.45 1 1 1h4c.55 0 1-.45 1-1v-1H9v1zm3-19C8.14 2 5 5.14 5 9c0 2.38 1.19 4.47 3 5.74V17c0 .55.45 1 1 1h6c.55 0 1-.45 1-1v-2.26c1.81-1.27 3-3.36 3-5.74 0-3.86-3.14-7-7-7z"/></svg>`}};class je extends A{constructor(){super(),this.type="nudge",this.domain="cross",this.title="",this.body=""}render(){const e=Ze[this.domain]??Ze.cross,t=Qe[this.type]??Qe.nudge,i=ei(`${this.title}${this.type}`);return o`
    ...
    `}}y(je,"properties",{type:{type:String},domain:{type:String},title:{type:String},body:{type:String}}),y(je,"styles",I`
  ...
  `);customElements.define("insight-card",je);const se=[{key:"motor",label:"Motor",color:"#6b9ac4",svg:o`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><circle cx="13.5" cy="5.5" r="2"/><path d="M9.8 8.9 7 23h2.1l1.8-8 2.1 2v6h2v-7.5l-2.1-2 .6-3c1.3 1.5 3.3 2.5 5.5 2.5v-2c-1.9 0-3.5-1-4.3-2.4l-1-1.6c-.4-.6-1-1-1.7-1-.3 0-.5 0-.8.1L6 7.6V12h2V8.9l1.8-.7z"/></svg>`},{key:"language",label:"Language",color:"#d4a843",svg:o`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M20 2H4a2 2 0 0 0-2 2v18l4-4h14a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2z"/></svg>`},{key:"socialEmotional",label:"Social-Emotional",color:"#c98a8a",svg:o`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg>`},{key:"cognitive",label:"Cognitive",color:"#8b7bb5",svg:o`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M11 4.2A2.7 2.7 0 0 0 6.4 5.9a2.6 2.6 0 0 0-2.5 2.6c0 .5.1.9.3 1.3A2.7 2.7 0 0 0 3 12.2a2.7 2.7 0 0 0 1.2 2.2 2.6 2.6 0 0 0-.2 1c0 1.5 1.2 2.7 2.7 2.7.2 0 .4 0 .6-.1A2.7 2.7 0 0 0 11 20V4.2zm2 0v15.8a2.7 2.7 0 0 0 3.7-1.9c.2 0 .4.1.6.1 1.5 0 2.7-1.2 2.7-2.7 0-.4-.1-.7-.2-1A2.7 2.7 0 0 0 21 12.2a2.7 2.7 0 0 0-1.2-2.4c.2-.4.3-.8.3-1.3a2.6 2.6 0 0 0-2.5-2.6A2.7 2.7 0 0 0 13 4.2z"/></svg>`}];function te(p){return p==="selfCare"?"motor":p}function ti(p){var s;if(!p||Number.isNaN(((s=p.getTime)==null?void 0:s.call(p))??NaN))return"";const e=new Date;let t=(e.getFullYear()-p.getFullYear())*12+(e.getMonth()-p.getMonth());e.getDate()<p.getDate()&&(t-=1),t=Math.max(0,t);const i=Math.floor(t/12),r=t%12;if(i===0)return`${r} month${r===1?"":"s"}`;const a=r?`, ${r} month${r===1?"":"s"}`:"";return`${i} year${i===1?"":"s"}${a}`}class Ue extends A{constructor(){super(),this.child=null,this.children=[],this.milestones=[],this.insights=[],this.dailyCard=null,this.readonly=!1}_domainStats(e){const t=(this.milestones??[]).filter(a=>te(a.category)===e),i=t.filter(a=>a.status==="achieved").length,r=t.length;return{achieved:i,total:r,pct:r?Math.round(i/r*100):0}}_pebbleIcon(){return o`<pebble-icon></pebble-icon>`}_ageMonths(e){var r;if(!e||Number.isNaN(((r=e.getTime)==null?void 0:r.call(e))??NaN))return 0;const t=new Date;let i=(t.getFullYear()-e.getFullYear())*12+(t.getMonth()-e.getMonth());return t.getDate()<e.getDate()&&(i-=1),Math.max(0,i)}_timelineModel(){var g;const e=this.milestones??[],t=this._ageMonths((g=this.child)==null?void 0:g.dateOfBirth),i=e.reduce((c,h)=>h.status==="achieved"?Math.max(c,h.ageRangeEndMonths??h.ageRangeStartMonths??0):c,0);let r=Math.max(i+12,t+6,18);r=Math.ceil(r/6)*6;const a=c=>Math.min(98,Math.max(2,(c??0)/r*100)),s=[{key:"motor",cls:"motor",name:"Motor"},{key:"language",cls:"language",name:"Language"},{key:"socialEmotional",cls:"social",name:"Social-Emo."},{key:"cognitive",cls:"cognitive",name:"Cognitive"}].map(c=>{const h=e.filter(k=>te(k.category)===c.key),f=h.filter(k=>k.status==="achieved").sort((k,S)=>(k.ageRangeStartMonths??0)-(S.ageRangeStartMonths??0));let x=f;f.length>7&&(x=Array.from({length:7},(k,S)=>f[Math.round(S*(f.length-1)/6)]));const P=x.map(k=>({left:a(k.ageRangeStartMonths),future:!1})),M=h.filter(k=>k.status!=="achieved").sort((k,S)=>(k.ageRangeStartMonths??0)-(S.ageRangeStartMonths??0))[0];return M&&P.push({left:a(M.ageRangeStartMonths),future:!0}),{...c,dots:P}}),n=c=>c<=0?"birth":c<24?`${c} mo`:c%12===0?`${c/12} yr`:`${(c/12).toFixed(1).replace(/\.0$/,"")} yr`,d=Array.from({length:7},(c,h)=>n(Math.round(h*r/6))),l=Math.min(1,Math.max(0,t/r));return{lanes:s,axis:d,ageM:t,nowFrac:l}}render(){const e=this.child;if(!e)return o`<div class="panel empty">No child selected yet.</div>`;const t=this.milestones??[],i=t.filter(h=>h.status==="achieved"),r=t.length?Math.round(i.length/t.length*100):0,a=i.slice().sort((h,f)=>(f.ageRangeStartMonths??0)-(h.ageRangeStartMonths??0)).slice(0,4),s=t.filter(h=>h.status!=="achieved").slice(0,5),n=e.themeColorHex||"var(--teal-pebble)",d=this.insights??[],l=this._timelineModel(),g=h=>h==="achieved"?"done":h==="emerging"?"emerging":"up",c=h=>h==="achieved"?"Achieved":h==="emerging"?"Emerging":"Upcoming";return o`
          ...
          <div>
            ...
            <div class="panel">
              ${s.length===0?o`<div class="empty">
                  ...
                  </div>`:s.map(h=>{var x,P;const f=((x=se.find(M=>M.key===te(h.category)))==null?void 0:x.color)??"#6b9ac4";return o`<div class="ms-row">
                      <span class="ms-dot" style="background:${f}"></span>
                      <div class="t">
                        ${h.title}
                        <small
                          >${((P=se.find(M=>M.key===te(h.category)))==null?void 0:P.label)??""}
            ...
            <div class="panel">
              ${a.length===0?o`<div class="empty">
                  ...
                  </div>`:a.map(h=>{var x;const f=((x=se.find(P=>P.key===te(h.category)))==null?void 0:x.color)??"#6b9ac4";return o`<div class="ms-row">
                      <span class="ms-dot" style="background:${f}"></span>
    ...
    `}}y(Ue,"properties",{child:{type:Object},children:{type:Array},milestones:{type:Array},insights:{type:Array},dailyCard:{type:Object},readonly:{type:Boolean,reflect:!0}}),y(Ue,"styles",I`
    *, *::before, *::after { box-sizing: border-box; }
    :host { display: block; }
  ...
  `);customElements.define("child-pebble",Le);const he=[{key:"visit",label:"Visit"},{key:"meal",label:"Meal"},{key:"travel",label:"Travel"},{key:"note",label:"Note"}],ii=[{m:30,label:"30 min"},{m:60,label:"1 h"},{m:90,label:"1½ h"},{m:120,label:"2 h"},{m:180,label:"3 h"},{m:240,label:"4 h"},{m:480,label:"All day"}],N=40;function et(p){const e=String(p??"").match(/^(\d{4})-(\d{2})-(\d{2})/);return e?new Date(Number(e[1]),Number(e[2])-1,Number(e[3])):null}function ri(p){const e=p.getFullYear(),t=String(p.getMonth()+1).padStart(2,"0"),i=String(p.getDate()).padStart(2,"0");return`${e}-${t}-${i}`}function oe(p){const e=String(p??"").match(/^(\d{1,2}):?(\d{2})?/);return e?Number(e[1])+(e[2]?Number(e[2])/60:0):null}function ge(p){const e=Math.floor(p),t=Math.round((p-e)*60);return`${String(e).padStart(2,"0")}:${String(t).padStart(2,"0")}`}class Ge extends A{constructor(){super(),this.open=!1,this.trip=null,this.members=[],this.currentUid="",this._items=[],this._dayKey=null,this._title="",this._time="12:00",this._type="visit",this._dur=60,this._url="",this._file=null,this._fileName="",this._busy=!1,this._view="day",this._weekStart=0,this._sel=null,this._dragCtx=null,this._onGridMove=this._gridMove.bind(this),this._onGridUp=this._gridUp.bind(this),this._unsub=null,this._subId=null}_weekDays(){const e=this._days();if(e.length<=7)return e;const t=Math.min(Math.max(0,this._weekStart),Math.max(0,e.length-7));return e.slice(t,t+7)}_minFromPointer(e,t,i,r){const a=t.getBoundingClientRect(),s=Math.max(0,Math.min(e-a.top,a.height)),n=i*60+s/N*60,d=Math.round(n/15)*15;return Math.max(i*60,Math.min(r*60,d))}_gridDown(e,t,i,r){if(e.button!=null&&e.button!==0||e.target.closest&&e.target.closest(".evt, .wk-evt, button, a"))return;const a=e.currentTarget,s=this._minFromPointer(e.clientY,a,i,r);this._dragCtx={dayKey:t,lo:i,hi:r,el:a},this._sel={dayKey:t,aMin:s,bMin:s},window.addEventListener("pointermove",this._onGridMove),window.addEventListener("pointerup",this._onGridUp),e.preventDefault()}_gridMove(e){if(!this._dragCtx||!this._sel)return;const{el:t,lo:i,hi:r}=this._dragCtx;this._sel={...this._sel,bMin:this._minFromPointer(e.clientY,t,i,r)}}_gridUp(){window.removeEventListener("pointermove",this._onGridMove),window.removeEventListener("pointerup",this._onGridUp);const e=this._sel,t=this._dragCtx;if(this._sel=null,this._dragCtx=null,!e||!t)return;let i=Math.min(e.aMin,e.bMin),a=Math.max(e.aMin,e.bMin)-i;a<15&&(a=this._dur&&this._dur>=15?this._dur:60);const s=String(Math.floor(i/60)).padStart(2,"0"),n=String(i%60).padStart(2,"0");this._dayKey=e.dayKey,this._time=`${s}:${n}`,this._dur=a,this.updateComplete.then(()=>{const d=this.renderRoot.querySelector(".add-row input.t");d&&d.focus()})}_selGhost(e,t){const i=this._sel;if(!i||i.dayKey!==e)return"";const r=Math.min(i.aMin,i.bMin),a=Math.max(i.aMin,i.bMin),s=(r-t*60)/60*N,n=Math.max(3,(a-r)/60*N),d=`${String(Math.floor(r/60)).padStart(2,"0")}:${String(r%60).padStart(2,"0")}`;return o`<div
    ...
    >
      ...
      <div class="wk">
        ...
        <div class="wk-body" style="--cols:${t};">
          ...
          ${e.map(l=>{const g=r.filter(c=>String(c.day??"")===String(l.key));return o`<div
              class="wk-col"
              style="height:${d}px;"
              @pointerdown=${c=>this._gridDown(c,l.key,a,s)}
            >
              ${this._selGhost(l.key,a)}
              ${g.map(c=>{const h=oe(c.time);if(h==null)return"";const f=Math.max(.5,(Number(c.durationMins)||60)/60),x=(h-a)*N+2,P=Math.max(26,f*N-4),M=he.some(k=>k.key===c.type)?c.type:"note";return o`<div
                  class="wk-evt ${M}"
    ...
    `}}y(Ge,"properties",{open:{type:Boolean,reflect:!0},trip:{type:Object},members:{type:Array},currentUid:{type:String},_items:{state:!0},_dayKey:{state:!0},_title:{state:!0},_time:{state:!0},_type:{state:!0},_dur:{state:!0},_url:{state:!0},_fileName:{state:!0},_busy:{state:!0},_view:{state:!0},_weekStart:{state:!0},_sel:{state:!0}}),y(Ge,"styles",I`
    *, *::before, *::after { box-sizing: border-box; }
    :host { display: block; }
  ...
  `);customElements.define("trip-planner",Ge);const ai={uid:"preview-user",displayName:"Thomas Paris",email:"thomas@example.com",photoURL:null},tt=[{uid:"thomas",displayName:"Thomas",circles:["immediate"],hue:198},{uid:"partner",displayName:"Élise",circles:["immediate"],hue:8},{uid:"kid1",displayName:"Oscar",circles:["immediate"],hue:142},{uid:"kid2",displayName:"Mila",circles:["immediate"],hue:44},{uid:"mum",displayName:"Mum",circles:["extended"],hue:320},{uid:"dad",displayName:"Dad",circles:["extended"],hue:28},{uid:"sister",displayName:"Camille",circles:["extended"],hue:280},{uid:"bro-in-law",displayName:"Sam",circles:["extended"],hue:175},{uid:"niece",displayName:"Léa",circles:["extended"],hue:100}],si=[{id:"t1",title:"Côte d’Azur, summer",location:"Antibes, France",start:"2026-07-12",end:"2026-07-21",coverGradient:"linear-gradient(135deg, #6b9ac4 0%, #c98a8a 60%, #d4a843 100%)",lodgingHost:"Airbnb",lodgingTitle:"Villa near Cap d’Antibes",attendees:["thomas","partner","kid1","kid2","mum","dad"],notes:"Mum + Dad arrive day 2. Dinner reservations at La Guérite booked.",visibility:"extended"},{id:"t2",title:"Half-term in the Alps",location:"Chamonix, France",start:"2026-10-24",end:"2026-10-31",coverGradient:"linear-gradient(135deg, #7a9e7e 0%, #4a6754 70%, #2c4439 100%)",lodgingHost:"Booking.com",lodgingTitle:"Chalet Les Drus",attendees:["thomas","partner","kid1","kid2"],notes:"Need ski school for the kids — book by September.",visibility:"immediate"},{id:"t3",title:"Camille’s 40th",location:"Lisbon, Portugal",start:"2026-09-05",end:"2026-09-08",coverGradient:"linear-gradient(135deg, #c67b5c 0%, #d4a843 50%, #c98a8a 100%)",lodgingHost:"Airbnb",lodgingTitle:"Alfama rooftop apartment",attendees:["thomas","partner","sister","bro-in-law"],notes:"Surprise. Don’t mention to Camille.",visibility:"family"}],oi=[{id:"e1",type:"birthday",date:"2026-05-24",personIds:["mum"],title:"Mum’s birthday"},{id:"e2",type:"anniversary",date:"2026-05-28",personIds:["mum","dad"],title:"Mum & Dad’s anniversary",subtitle:"38 years"},{id:"e3",type:"birthday",date:"2026-06-11",personIds:["kid1"],title:"Oscar turns 7"},{id:"e4",type:"birthday",date:"2026-06-30",personIds:["niece"],title:"Léa’s birthday"}],bt={id:"preview-felix",name:"Felix",dateOfBirth:new Date("2023-11-15"),profilePhotoURL:null,pronouns:"he",themeColorHex:"#3D9B8F",developmentalFlags:["speech and language"]},ni=[bt],li=[{id:"m1",category:"motor",title:"Kicks a ball forward",status:"achieved",ageRangeStartMonths:18,ageRangeEndMonths:24},{id:"m2",category:"motor",title:"Walks up stairs holding on",status:"achieved",ageRangeStartMonths:18,ageRangeEndMonths:24},{id:"m3",category:"motor",title:"Jumps with both feet off the ground",status:"emerging",ageRangeStartMonths:24,ageRangeEndMonths:30},{id:"m4",category:"motor",title:"Pedals a tricycle",status:"notStarted",ageRangeStartMonths:30,ageRangeEndMonths:36},{id:"m5",category:"language",title:"Uses two-word phrases",status:"achieved",ageRangeStartMonths:18,ageRangeEndMonths:24},{id:"m6",category:"language",title:"Says first name when asked",status:"emerging",ageRangeStartMonths:24,ageRangeEndMonths:30},{id:"m7",category:"language",title:"Names six body parts",status:"notStarted",ageRangeStartMonths:24,ageRangeEndMonths:30},{id:"m8",category:"language",title:"Uses three-word sentences",status:"notStarted",ageRangeStartMonths:30,ageRangeEndMonths:36},{id:"m9",category:"socialEmotional",title:"Shows affection unprompted",status:"achieved",ageRangeStartMonths:18,ageRangeEndMonths:24},{id:"m10",category:"socialEmotional",title:"Plays alongside other children",status:"emerging",ageRangeStartMonths:24,ageRangeEndMonths:36},{id:"m11",category:"socialEmotional",title:"Takes turns in simple games",status:"notStarted",ageRangeStartMonths:30,ageRangeEndMonths:42},{id:"m12",category:"cognitive",title:"Follows a two-step instruction",status:"achieved",ageRangeStartMonths:18,ageRangeEndMonths:24},{id:"m13",category:"cognitive",title:"Sorts objects by shape or colour",status:"emerging",ageRangeStartMonths:30,ageRangeEndMonths:36},{id:"m14",category:"cognitive",title:"Completes a 4-piece puzzle",status:"notStarted",ageRangeStartMonths:30,ageRangeEndMonths:36}],di=[{id:"i1",type:"strength",domain:"language",title:"Language is tracking ahead",body:"Felix is combining words earlier than the typical 24–30 month window — keep the back-and-forth conversations going.",relevanceScore:.95},{id:"i2",type:"connection",domain:"cross",title:"Fine-motor + sorting → pre-literacy",body:"A strong pincer grip alongside early sorting is a classic pre-literacy signal. Picture books with pointing build on both at once.",relevanceScore:.82},{id:"i3",type:"nudge",domain:"language",title:"Narrate your daily routine",body:'"Now we are washing hands… water on… soap…" — Felix is ready for longer sentence models during everyday moments.',relevanceScore:.7}],ci={id:"2026-05-16",title:"Felix is stringing two words together",body:'You have logged "more milk" and "Daddy go" this week — early two-word speech, right on the edge of the 24–30 month window. Narrating your routine out loud is the single best way to grow sentence length from here.',topicForChat:"How can I support Felix's two-word speech?"},pi=[{id:"p1",role:"user",content:"Felix isn't saying many words yet — should I be worried at 2.5?",senderUid:"partner"},{id:"p2",role:"assistant",content:"At 2½, every child's pace differs. From your logs Felix **uses two-word phrases** and follows two-step instructions — both strong signs. A few practical things to try, and a clear marker for when to mention it at his check-up."},{id:"p3",role:"user",content:"Any toddler-friendly ideas for a rainy weekend?",senderUid:"thomas"},{id:"p4",role:"assistant",content:"Rainy days are great for the kind of close-up play that grows language fastest at this stage. A few ideas matched to where Felix is right now."}];class Ye extends A{constructor(){super(),this.user=ai,this.pebbleUser=null,this.family=null,this.children=[],this.trips=[],this.events=[],this.holidays=[],this._connectionMembers=[],this._connKey="",this.ppFamily=null,this.ppIsMember=!1,this.ppChildren=[],this.selectedChildId=null,this.childMilestones=[],this.childInsights=[],this.childDailyCard=null,this.childPebbleMessages=[],this.childPebbleSessions=[],this.ppIsChildViewer=!1,this.incomingChildRequests=[],this.myChildAccessRequest=null,this._claimingChildId=null,this._claimedChildName=null,this._joinAnotherCode="",this._joinAnotherBusy=!1,this._joinAnotherError="",this._joinAnotherSuccessName="",this._pebblePrefill="",this._plannerOpen=!1,this._plannerTrip=null,this.preview=!1,this.circle="extended",this._activeTab="today",this._formOpen=!1,this._formTrip=null,this._formBusy=!1,this._membersOpen=!1,this._eventFormOpen=!1,this._eventFormEvent=null,this._eventFormBusy=!1,this._allTripsOpen=!1,this._editingFamilyName=!1,this._importOpen=!1,this._schoolImportOpen=!1,this._profileOpen=!1,this._typePickerOpen=!1,this._formMode="trip",this._pebbleFabOpen=!1,this._themeLight=typeof document<"u"&&document.documentElement.classList.contains("theme-light"),this._dragOverTarget=null;const e=new Date;this._displayMonth=new Date(e.getFullYear(),e.getMonth(),1)}_onJoinAnotherCodeInput(e){var r;const t=(((r=e.target)==null?void 0:r.value)??"").toString(),i=t.toUpperCase().replace(/[^A-Z0-9]/g,"").slice(0,6);i!==t&&(e.target.value=i),this._joinAnotherCode=i,this._joinAnotherError&&(this._joinAnotherError="")}async _attemptJoinAnotherFamily(){var t;const e=(this._joinAnotherCode??"").trim();if(!(e.length!==6||this._joinAnotherBusy)){this._joinAnotherBusy=!0,this._joinAnotherError="",this._joinAnotherSuccessName="";try{const i=await b.findFamilyByConnectCode(e);if(!i){this._joinAnotherError="Couldn't find that family. Double-check the code with whoever invited you.";return}const r=i.name||"the family";await b.redeemConnectCode(e),this._joinAnotherSuccessName=r,m(`Joined ${r}.`),this._joinAnotherCode=""}catch(i){console.error("Join another family failed:",i),this._joinAnotherError=((t=i==null?void 0:i.message)==null?void 0:t.replace(/^Error:\s*/,""))??"Couldn't join — double-check the code with whoever invited you."}finally{this._joinAnotherBusy=!1}}}async _saveFamilyName(e){var a,s;const i=(e.target.value??"").trim(),r=((a=this.family)==null?void 0:a.name)??"";if(i&&i!==r&&((s=this.family)!=null&&s.id))try{const{db:n,doc:d,updateDoc:l,serverTimestamp:g}=await K(async()=>{const{db:c,doc:h,updateDoc:f,serverTimestamp:x}=await Promise.resolve().then(()=>Rt);return{db:c,doc:h,updateDoc:f,serverTimestamp:x}},void 0);await l(d(n,"families",this.family.id),{name:i,updatedAt:g()}),m("Family name updated.")}catch(n){console.error("Update family name failed:",n),m(`Couldn't save: ${n.code??n.message}`,{duration:5e3})}this._editingFamilyName=!1}_liveImmediate(){var e;return this.preview||!((e=this.user)!=null&&e.uid)?tt.filter(t=>t.circles.includes("immediate")):Gt(this.user.uid,this.user,this.pebbleUser,this.family,this.children)}_liveExtended(){var e;return this.preview?tt.filter(t=>t.circles.includes("extended")):jt((e=this.user)==null?void 0:e.uid,this.family,this.children)}_liveConnections(){return this.preview?[]:this._connectionMembers??[]}async _refreshConnectionMembers(){var e;if(this.preview||!this.family){this._connectionMembers=[];return}try{this._connectionMembers=await Ut((e=this.user)==null?void 0:e.uid,this.family)}catch{this._connectionMembers=[]}}updated(e){var t,i;if(e.has("family")){const r=Array.isArray((t=this.family)==null?void 0:t.connectedFamilyIds)?this.family.connectedFamilyIds:[],a=`${((i=this.family)==null?void 0:i.id)??""}|${[...r].sort().join(",")}`;a!==this._connKey&&(this._connKey=a,this._refreshConnectionMembers())}e.has("_activeTab")&&this._positionTabSlider({animate:!0})}_liveTrips(){return this.preview?si:this.trips??[]}_liveEvents(){if(this.preview)return oi;const e=r=>{const{date:a,yearsElapsed:s}=qt(r);return{...r,date:a?Vt(a):r.date,_yearsElapsed:s,_originalDate:r.date}},t=Yt(this.children).map(e),i=(this.events??[]).map(e);return[...t,...i].sort((r,a)=>String(r.date).localeCompare(String(a.date)))}_filteredMembers(){const e=this._liveImmediate(),t=this._liveExtended();return this.circle==="personal"?e.filter(i=>{var r;return i.uid===((r=this.user)==null?void 0:r.uid)}):this.circle==="family"?e:[...e,...t]}_circleTrips(){var s;const e=this._liveTrips(),t=((s=this.user)==null?void 0:s.uid)??"thomas";let i;this.circle==="personal"?i=e.filter(n=>{var d;return(d=n.attendees)==null?void 0:d.includes(t)}):this.circle==="family"?i=e.filter(n=>n.visibility!=="extended"&&this._userCanSeeTrip(n)):i=e.filter(n=>this._userCanSeeTrip(n));const r=new Set,a=[];for(const n of i){const d=n.id??`${n.title}|${n.start}|${n.end}`;r.has(d)||(r.add(d),a.push(n))}return a}_filteredTrips(){const e=new Date;return e.setHours(0,0,0,0),this._circleTrips().filter(t=>t.end?$(t.end)>=e:!0)}_userCanSeeTrip(e){var d,l,g,c,h,f;const t=(d=this.user)==null?void 0:d.uid;if(!t)return!1;if((l=e.attendees)!=null&&l.includes(t)||(g=e.viewers)!=null&&g.includes(t))return!0;const i=((c=this.family)==null?void 0:c.memberIds)??[],r=((h=this.family)==null?void 0:h.cairnMemberIds)??i,a=i.includes(t),s=r.includes(t);if(a)return!0;if(!s)return!1;const n=e.visibility||"family";if(n==="personal")return!1;if(n==="family")return!0;if(n==="extended"){const x=e.targetSubGroups??[];if(x.length===0)return!0;const P=Object.entries(((f=this.family)==null?void 0:f.subGroups)??{}).filter(([,M])=>(M.memberIds??[]).includes(t)).map(([M])=>M);return x.some(M=>P.includes(M))}return!1}_filteredEvents(){const e=new Set(this._filteredMembers().map(t=>t.uid));return this._liveEvents().filter(t=>(Array.isArray(t==null?void 0:t.personIds)?t.personIds:[]).some(r=>e.has(r)))}_smartCallout(){var n,d;const e=new Date,t=new Date(e.getFullYear(),e.getMonth(),e.getDate()),i=1440*60*1e3,r=l=>Math.round((l-t)/i);for(const l of this._circleTrips()){if(!l.start||!l.end)continue;const g=$(l.start),c=$(l.end);if(g.setHours(0,0,0,0),c.setHours(0,0,0,0),g<=t&&t<=c){const h=r(g)+1,f=r(c)-r(g)+1,x=((n=l.location)==null?void 0:n.trim())||l.title;return`Day ${h} of ${f} in ${x}.`}}let a=null,s=1/0;for(const l of this._circleTrips()){if(!l.start)continue;const g=$(l.start);if(!g)continue;const c=r(g);c>0&&c<s&&(a={kind:"trip",item:l},s=c)}for(const l of this._filteredEvents()){if(!l.date)continue;const g=$(l.date);if(!g)continue;const c=r(g);c>=0&&c<s&&(a={kind:"event",item:l},s=c)}if(!a)return null;if(a.kind==="trip"){const l=((d=a.item.location)==null?void 0:d.trim())||a.item.title;return s===1?`${l} starts tomorrow.`:s<=14?`${l} in ${s} days.`:s<=60?`Next trip: ${l} in ${s} days.`:null}return s===0?`${a.item.title} — today.`:s===1?`${a.item.title} — tomorrow.`:s<=7?`${a.item.title} in ${s} days.`:null}_tripDensityByDay(e){const t=new Map;for(const i of this._filteredTrips()){if(!i.start||!i.end)continue;const r=$(i.start),a=$(i.end);if(Number.isNaN(r.getTime())||Number.isNaN(a.getTime())||r.getFullYear()>e||a.getFullYear()<e)continue;const s=new Date(Math.max(r,new Date(e,0,1))),n=new Date(Math.min(a,new Date(e,11,31)));for(;s<=n;){const d=`${String(s.getMonth()+1).padStart(2,"0")}-${String(s.getDate()).padStart(2,"0")}`;t.set(d,Math.min(1,(t.get(d)??0)+.5)),s.setDate(s.getDate()+1)}}return t}_shiftMonth(e){const t=this._displayMonth;this._displayMonth=new Date(t.getFullYear(),t.getMonth()+e,1)}_jumpToMonth(e,t){this._displayMonth=new Date(e,t,1)}_resetToToday(){const e=new Date;this._displayMonth=new Date(e.getFullYear(),e.getMonth(),1)}_renderMonthly(){const e=new Date,t=this._displayMonth??e,i=t.getFullYear(),r=t.getMonth(),s=(new Date(i,r,1).getDay()+6)%7,n=new Date(i,r+1,0).getDate(),d=new Map,l=(k,S)=>{!d.has(k)&&S&&d.set(k,S)},g=[];for(const k of this._filteredEvents()){const S=$(k.date);S&&S.getFullYear()===i&&S.getMonth()===r&&(g.push(S.getDate()),l(S.getDate(),k.title??""))}const c=new Set;for(const k of this._filteredTrips()){if(!k.start||!k.end)continue;const S=$(k.start),R=$(k.end);if(Number.isNaN(S.getTime())||Number.isNaN(R.getTime())||S.getFullYear()>i||R.getFullYear()<i||S.getMonth()>r&&R.getMonth()>r||S.getMonth()<r&&R.getMonth()<r)continue;const O=S.getMonth()===r?S.getDate():1,F=R.getMonth()===r?R.getDate():n;for(let L=O;L<=F;L++)c.add(L),l(L,k.title??"")}const h=new Set;for(const k of this.holidays??[]){const S=$(k.date);S&&S.getFullYear()===i&&S.getMonth()===r&&(h.add(S.getDate()),l(S.getDate(),k.title??"Holiday"))}const f=[];for(let k=0;k<s;k++)f.push(o`<div class="cal-cell empty"></div>`);const x=e.getFullYear()===i&&e.getMonth()===r;for(let k=1;k<=n;k++){const S=x&&k===e.getDate(),R=g.includes(k),O=c.has(k),F=h.has(k),L=d.get(k),ft=["cal-cell",S?"today":"",R?"has-event":"",O?"has-trip":"",F?"has-holiday":""].filter(Boolean).join(" ");f.push(o`<div class=${ft} title=${L??""}>
    ...
    `}_renderTodayTab(){const e=this._childData(),t=o`<div class="scope shared">
      ...
      `;const a=e.milestones,s=a.filter(h=>h.status==="achieved"),n=a.length?Math.round(s.length/a.length*100):0,d=h=>({selfCare:"motor"})[h]||h||"motor",l=s.slice().sort((h,f)=>(f.ageRangeStartMonths??0)-(h.ageRangeStartMonths??0)).slice(0,3),g=(e.insights||[])[0],c=e.dailyCard;return o`
      ${this._renderTodayHeader(t)}
  ...
  `);customElements.define("home-screen",Ye);const it="cairn:pendingLoginIntent";class qe extends A{constructor(){super(),this.user=null,this._mode="choose",this._code="",this._familyName="",this._busy=!1,this._error="",this._childName="",this._childDob="",this._childPhotoBlob=null,this._childPhotoPreview=null,this._parentPhotoBlob=null,this._parentPhotoPreview=null,this._flavor="welcome";try{localStorage.getItem(it)==="1"&&(this._flavor="recovery",localStorage.removeItem(it))}catch{}}willUpdate(e){if(e.has("user")&&this.user&&!this._familyName){const t=(this.user.displayName??"").trim().split(/\s+/).slice(-1)[0];t&&t.length>1&&(this._familyName=`${t} Family`)}}_go(e){this._mode=e,this._error=""}_submitJoin(){const e=(this._code??"").trim().toUpperCase().replace(/\s+/g,"");if(!e){this._error="Paste the connect code you were sent.";return}const t=/^[A-Z0-9]{6}$/.test(e),i=/^CAIRN-[A-Z0-9]{3,6}$/.test(e);if(!t&&!i){this._error="Connect codes are 6 characters.";return}this._error="",this.dispatchEvent(new CustomEvent("join-code",{detail:{code:e},bubbles:!0,composed:!0}))}_goChildrenQuestion(){if(!(this._familyName??"").trim()){this._error="Give your family a name.";return}this._error="",this._go("children")}_goAddChild(){this._error="",this._go("addchild")}async _submitNoChildren(){const e=(this._familyName??"").trim();if(!e){this._error="Give your family a name.";return}this._busy=!0,this._error="";try{const t=await b.createCairnOnlyFamily(e);await this._uploadParentPhotoIfAny(t),m(`Welcome to ${e}.`)}catch(t){console.error("Create family failed:",t),this._error=(t==null?void 0:t.code)==="permission-denied"?"Couldn't create the family — Firestore rules may not be deployed yet.":`Couldn't create the family: ${(t==null?void 0:t.message)??"try again"}`}finally{this._busy=!1}}async _submitWithChild(){const e=(this._familyName??"").trim(),t=(this._childName??"").trim();if(!e){this._error="Give your family a name.";return}if(!t){this._error="Add your child's name.";return}if(!this._childDob){this._error="Add your child's date of birth.";return}const i=new Date(`${this._childDob}T00:00:00`);if(Number.isNaN(i.getTime())){this._error="That date of birth doesn't look right.";return}this._busy=!0,this._error="";try{const r=await b.createPebblePathFamily(e),a=await b.createChild(r,{name:t,dateOfBirth:i});if(this._childPhotoBlob)try{await b.uploadChildAvatar(r,a,this._childPhotoBlob)}catch(s){console.warn("child avatar upload failed (non-fatal):",s),m("Family created — couldn't save the photo, add it later.")}await this._uploadParentPhotoIfAny(r),m(`Welcome to ${e}.`)}catch(r){console.error("Create family + child failed:",r),this._error=(r==null?void 0:r.code)==="permission-denied"?"Couldn't set up your family — Firestore rules may not be deployed yet.":`Couldn't set up your family: ${(r==null?void 0:r.message)??"try again"}`}finally{this._busy=!1}}_iconJoin(){return o`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    `}}y(qe,"properties",{user:{type:Object},_mode:{state:!0},_code:{state:!0},_familyName:{state:!0},_busy:{state:!0},_error:{state:!0},_childName:{state:!0},_childDob:{state:!0},_childPhotoPreview:{state:!0},_parentPhotoPreview:{state:!0},_flavor:{state:!0}}),y(qe,"styles",I`
    * { box-sizing: border-box; }
    :host {
      display: flex;
      align-items: center;
...
//# sourceMappingURL=index-BkaKGTDr.js.map
