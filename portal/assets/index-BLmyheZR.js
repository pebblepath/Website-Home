var mt=Object.defineProperty;var ft=(p,e,t)=>e in p?mt(p,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):p[e]=t;var _=(p,e,t)=>ft(p,typeof e!="symbol"?e+"":e,t);import{i as A,a as I,b as s,o as vt}from"./lit-dM6tPkba.js";import{f as yt,h as xt,j as wt,G as Ve,O as _t,k as kt,s as $t,l as at,m as Ct,n as St,o as Mt,q as At,t as C,v as P,w as k,x as It,y as T,z as G,A as z,B as Y,D as V,E as L,H as j,I as W}from"./firebase-core-DEm61vaB.js";import{g as Pt,h as J}from"./firebase-functions-ID3qFl3p.js";import{g as zt,a as ne,r as ee,u as le}from"./firebase-storage-BqMFCgVD.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const a of r)if(a.type==="childList")for(const o of a.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function t(r){const a={};return r.integrity&&(a.integrity=r.integrity),r.referrerPolicy&&(a.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?a.credentials="include":r.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(r){if(r.ep)return;r.ep=!0;const a=t(r);fetch(r.href,a)}})();class be extends A{constructor(){super(),this.variant="default",this.lifted=!1,this.padding="md"}render(){const e=["panel",this.variant==="strong"?"strong":"",this.lifted?"lifted":"",`pad-${this.padding}`].filter(Boolean).join(" ");return s`
      <div class=${e}>
        <div class="content"><slot></slot></div>
      </div>
    `}}_(be,"properties",{variant:{type:String},lifted:{type:Boolean},padding:{type:String}}),_(be,"styles",I`
    :host {
      display: block;
    }
    :host([stretch]) {
  ...
  `);customElements.define("glass-panel",be);class me extends A{constructor(){super(),this.variant="primary",this.size="md",this.full=!1,this.disabled=!1}render(){const e=[this.variant,`size-${this.size}`,this.full?"full":""].filter(Boolean).join(" ");return s`
    ...
    `}}_(me,"properties",{variant:{type:String},size:{type:String},full:{type:Boolean},disabled:{type:Boolean,reflect:!0}}),_(me,"styles",I`
    * {
      box-sizing: border-box;
    }
    :host {
  ...
  `);customElements.define("glass-button",me);class fe extends A{constructor(){super(),this.size=44}render(){const e=this.size;return s`
    ...
    `}}_(fe,"properties",{size:{type:Number}}),_(fe,"styles",I`
    :host {
      display: inline-block;
      line-height: 0;
    }
  ...
  `);customElements.define("cairn-mark",fe);const Dt="modulepreload",Ft=function(p){return"/portal/"+p},He={},H=function(e,t,i){let r=Promise.resolve();if(t&&t.length>0){let o=function(d){return Promise.all(d.map(g=>Promise.resolve(g).then(c=>({status:"fulfilled",value:c}),c=>({status:"rejected",reason:c}))))};document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),l=(n==null?void 0:n.nonce)||(n==null?void 0:n.getAttribute("nonce"));r=o(t.map(d=>{if(d=Ft(d),d in He)return;He[d]=!0;const g=d.endsWith(".css"),c=g?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${c}`))return;const h=document.createElement("link");if(h.rel=g?"stylesheet":Dt,g||(h.as="script"),h.crossOrigin="",h.href=d,l&&h.setAttribute("nonce",l),document.head.appendChild(h),g)return new Promise((b,m)=>{h.addEventListener("load",b),h.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${d}`)))})}))}function a(o){const n=new Event("vite:preloadError",{cancelable:!0});if(n.payload=o,window.dispatchEvent(n),!n.defaultPrevented)throw o}return r.then(o=>{for(const n of o||[])n.status==="rejected"&&a(n.reason);return e().catch(a)})},ve={apiKey:"AIzaSyA6NKZNLVBeeLrXcLJSXus5M832AxpI2wk",authDomain:"pebblepath-992b6.firebaseapp.com",projectId:"pebblepath-992b6",storageBucket:"pebblepath-992b6.firebasestorage.app",messagingSenderId:"497141667291",appId:"1:497141667291:web:ee84c186db54389d10c3fe"},N=!!(ve.apiKey&&ve.projectId),Z=N?yt(ve):null,w=N?xt(Z):null,u=N?wt(Z):null,B=N?Pt(Z,"us-central1"):null,U=N?zt(Z):null,ye=N?new Ve:null;ye&&ye.setCustomParameters({prompt:"select_account"});const de=N?new Ve:null;de&&de.addScope("https://www.googleapis.com/auth/calendar.readonly");let oe=null,xe=0;async function st(){if(!w||!de)throw new Error("Firebase not configured.");if(oe&&Date.now()<xe-6e4)return oe;const p=w.currentUser;if(!p)throw new Error("Please sign in before importing your calendar.");if(!(p.providerData??[]).some(a=>a.providerId==="google.com")){const a=new Error("Calendar import needs a Google account. You're signed in another way, so Cairn can't read your Google Calendar here yet — add events manually for now.");throw a.code="calendar/needs-google-account",a}let t;try{t=await kt(p,de)}catch(a){if((a==null?void 0:a.code)==="auth/user-mismatch"){const o=new Error("Please choose the same Google account you use to sign in to Cairn.");throw o.code=a.code,o}if((a==null?void 0:a.code)==="auth/popup-closed-by-user"||(a==null?void 0:a.code)==="auth/cancelled-popup-request"){const o=new Error("Calendar connection cancelled.");throw o.code=a.code,o}throw a}const i=Ve.credentialFromResult(t),r=i==null?void 0:i.accessToken;if(!r)throw new Error("Couldn't get a Calendar access token — try again.");return oe=r,xe=Date.now()+3600*1e3,r}function Et(){oe=null,xe=0}function ce(){if(!w)throw new Error("Firebase not configured — fill in .env first.");return at(w,ye)}const te=N?new _t("apple.com"):null;te&&(te.addScope("email"),te.addScope("name"));function we(){if(!w||!te)throw new Error("Firebase not configured — fill in .env first.");return at(w,te)}function ot(p,e){if(!w)throw new Error("Firebase not configured.");return Mt(w,p,e)}async function nt(p,e,t){if(!w)throw new Error("Firebase not configured.");const i=await Ct(w,p,e);if(t&&t.trim())try{await St(i.user,{displayName:t.trim()})}catch{}return i}function lt(p){if(!w)throw new Error("Firebase not configured.");return At(w,p)}function dt(){return w?$t(w):Promise.resolve()}function ct(p){return w?It(w,p):(p(null),()=>{})}const Tt=Object.freeze(Object.defineProperty({__proto__:null,addDoc:j,app:Z,auth:w,clearCalendarToken:Et,collection:z,connectGoogleCalendar:st,db:u,deleteDoc:W,doc:C,firebaseApp:Z,functions:B,getDocs:V,getDownloadURL:ne,httpsCallable:J,isConfigured:N,onAuth:ct,onSnapshot:T,query:G,sendPasswordReset:lt,serverTimestamp:k,setDoc:L,signIn:ce,signInWithApple:we,signInWithEmail:ot,signOutUser:dt,signUpWithEmail:nt,storage:U,storageRef:ee,updateDoc:P,uploadBytes:le,where:Y},Symbol.toStringTag,{value:"Module"})),Nt={"united states":"US","united states of america":"US",usa:"US",us:"US","united kingdom":"GB",uk:"GB","great britain":"GB",england:"GB",scotland:"GB",wales:"GB","northern ireland":"GB",canada:"CA",australia:"AU",ireland:"IE",france:"FR",germany:"DE",spain:"ES",italy:"IT",netherlands:"NL","the netherlands":"NL",belgium:"BE",switzerland:"CH",austria:"AT",portugal:"PT",sweden:"SE",norway:"NO",denmark:"DK",finland:"FI","new zealand":"NZ",mexico:"MX",brazil:"BR","south africa":"ZA",india:"IN",japan:"JP",singapore:"SG",poland:"PL"};class Rt extends EventTarget{constructor(){super(),this.state={user:null,family:null,children:[],trips:[],events:[],holidays:[],ppFamily:null,ppIsMember:!1,ppIsChildViewer:!1,myChildAccessRequest:null,incomingChildRequests:[],ppChildren:[],selectedChildId:null,childMilestones:[],childInsights:[],childDailyCard:null,childPebbleMessages:[],childPebbleSessions:[]},this._uid=null,this._unsubUser=null,this._unsubFamily=null,this._unsubChildren=null,this._unsubTrips=null,this._unsubEvents=null,this._currentFamilyId=null,this._holidayKey=null,this._ppFamilyId=null,this._selectedChildId=null,this._unsubPpFamily=null,this._unsubPpChildren=null,this._unsubChildMs=null,this._unsubChildIns=null,this._unsubChildDaily=null,this._unsubChildPebble=null,this._unsubChildSessions=null,this._ppReadOnly=!1,this._unsubIncomingReq=null,this._unsubMyReq=null,this.userDocResolved=!1}get familyId(){return this._currentFamilyId}start(e){!u||!e||this._uid!==e&&(this.stop(),this._uid=e,this._unsubUser=T(C(u,"users",e),t=>{var a,o,n,l,d,g,c;this.userDocResolved=!0,this.state.user=t.exists()?{id:t.id,...t.data()}:null;const i=((a=this.state.user)==null?void 0:a.cairnFamilyId)??((o=this.state.user)==null?void 0:o.familyId)??null;!i&&this.state.user&&this._healFamilyPointer(e),i!==this._currentFamilyId&&(this._currentFamilyId=i,(n=this._unsubFamily)==null||n.call(this),(l=this._unsubChildren)==null||l.call(this),(d=this._unsubTrips)==null||d.call(this),(g=this._unsubEvents)==null||g.call(this),this._unsubFamily=null,this._unsubChildren=null,this._unsubTrips=null,this._unsubEvents=null,this.state.family=null,this.state.children=[],this.state.trips=[],this.state.events=[],i&&this._subscribeFamily(i));const r=((c=this.state.user)==null?void 0:c.familyId)??null;r!==this._ppFamilyId&&(this._ppFamilyId=r,this._teardownPpFamily(),r&&this._subscribePpFamily(r)),this._emit()}))}async _healFamilyPointer(e){if(!this._healing){this._healing=!0;try{const t=G(z(u,"families"),Y("cairnMemberIds","array-contains",e)),i=await V(t);if(!i.empty){await L(C(u,"users",e),{cairnFamilyId:i.docs[0].id,updatedAt:k()},{merge:!0});return}const r=G(z(u,"families"),Y("memberIds","array-contains",e)),a=await V(r);a.empty||await L(C(u,"users",e),{familyId:a.docs[0].id,updatedAt:k()},{merge:!0})}catch(t){console.warn("[Cairn] auto-heal family pointer failed:",t==null?void 0:t.code,t==null?void 0:t.message)}finally{this._healing=!1}}}async _loadHolidays(){var o,n;const e=(n=(o=this.state.family)==null?void 0:o.homeLocation)==null?void 0:n.country,t=Nt[String(e??"").trim().toLowerCase()]??null;if(!t){this.state.holidays.length&&(this.state.holidays=[],this._holidayKey=null,this._emit());return}const i=new Date().getFullYear(),r=[i,i+1],a=`${t}:${r.join(",")}`;if(this._holidayKey!==a){this._holidayKey=a;try{const l=[];for(const g of r){const c=`pp_hol_${t}_${g}`;let h=null;try{const b=JSON.parse(localStorage.getItem(c)||"null");b&&Date.now()-b.t<720*3600*1e3&&(h=b.h)}catch{}if(!h){const b=await fetch(`https://date.nager.at/api/v3/PublicHolidays/${g}/${t}`);if(!b.ok)continue;const m=await b.json();h=(Array.isArray(m)?m:[]).map(v=>({date:v.date,name:v.name||v.localName||"Holiday"}));try{localStorage.setItem(c,JSON.stringify({t:Date.now(),h}))}catch{}}for(const b of h)l.push({id:`hol-${t}-${b.date}-${b.name}`,title:b.name,date:b.date,source:"holiday"})}const d=new Set;this.state.holidays=l.filter(g=>{const c=`${g.date}|${g.title}`;return d.has(c)?!1:(d.add(c),!0)}),this._emit()}catch{this._holidayKey=null}}}_subscribeFamily(e){var t;this._unsubFamily=T(C(u,"families",e),i=>{this.state.family=i.exists()?{id:i.id,...i.data()}:null,this._reconcileChildViewer(),this._loadHolidays(),this._emit()}),(t=this._unsubMyReq)==null||t.call(this),this._unsubMyReq=T(C(u,"families",e,"childAccessRequests",this._uid),i=>{this.state.myChildAccessRequest=i.exists()?{id:i.id,...i.data()}:null,this._emit()},i=>console.warn("[Portal] childAccessRequest (mine) error:",i.code,i.message)),this._unsubChildren=T(z(u,"families",e,"children"),i=>{this.state.children=i.docs.map(r=>{var o,n;const a=r.data();return{id:r.id,...a,dateOfBirth:((n=(o=a.dateOfBirth)==null?void 0:o.toDate)==null?void 0:n.call(o))??(a.dateOfBirth?new Date(a.dateOfBirth):null)}}),this._emit()}),this._unsubTrips=T(G(z(u,"families",e,"trips"),Y("visibleTo","array-contains",this._uid)),i=>{this.state.trips=i.docs.map(r=>{var o,n,l,d;const a=r.data();return{id:r.id,...a,start:a.start??"",end:a.end??"",createdAt:((n=(o=a.createdAt)==null?void 0:o.toDate)==null?void 0:n.call(o))??null,updatedAt:((d=(l=a.updatedAt)==null?void 0:l.toDate)==null?void 0:d.call(l))??null}}).sort((r,a)=>String(r.start).localeCompare(String(a.start))),this._backfillVisibleTo("trips",i.docs),this._emit()},i=>{console.warn("[Cairn] trips subscription error:",i.code,i.message)}),this._unsubEvents=T(G(z(u,"families",e,"familyEvents"),Y("visibleTo","array-contains",this._uid)),i=>{this.state.events=i.docs.map(r=>{var o,n,l,d;const a=r.data();return{id:r.id,...a,date:a.date??"",createdAt:((n=(o=a.createdAt)==null?void 0:o.toDate)==null?void 0:n.call(o))??null,updatedAt:((d=(l=a.updatedAt)==null?void 0:l.toDate)==null?void 0:d.call(l))??null}}),this._backfillVisibleTo("familyEvents",i.docs),this._emit()},i=>{console.warn("[Cairn] familyEvents subscription error:",i.code,i.message)})}_reconcileChildViewer(){var a;if((a=this.state.user)!=null&&a.familyId)return;const e=this.state.family,t=this._uid,r=!!(e&&Array.isArray(e.childViewers)&&e.childViewers.includes(t)&&!(Array.isArray(e.memberIds)&&e.memberIds.includes(t)))?e.id:null;r!==this._ppFamilyId&&(this._ppFamilyId=r,this._ppReadOnly=!!r,this._teardownPpFamily(),r&&this._subscribePpFamily(r),this._emit())}_subscribePpFamily(e){this._unsubPpFamily=T(C(u,"families",e),t=>{var a;const i=t.exists()?{id:t.id,...t.data()}:null;this.state.ppFamily=i;const r=!!(i&&Array.isArray(i.memberIds)&&i.memberIds.includes(this._uid));this.state.ppIsMember=r,this.state.ppIsChildViewer=!!(!r&&i&&Array.isArray(i.childViewers)&&i.childViewers.includes(this._uid)),r&&this._subscribeIncomingRequests(e),(a=this.state.user)!=null&&a.familyId||this._reconcileChildViewer(),this._emit()},t=>{console.warn("[Portal] ppFamily subscription error:",t.code,t.message)}),this._unsubPpChildren=T(z(u,"families",e,"children"),t=>{var o;const i=t.docs.map(n=>{var d,g;const l=n.data();return{id:n.id,...l,dateOfBirth:((g=(d=l.dateOfBirth)==null?void 0:d.toDate)==null?void 0:g.call(d))??(l.dateOfBirth?new Date(l.dateOfBirth):null)}}).sort((n,l)=>{var d,g,c,h;return(((g=(d=n.createdAt)==null?void 0:d.toMillis)==null?void 0:g.call(d))??0)-(((h=(c=l.createdAt)==null?void 0:c.toMillis)==null?void 0:h.call(c))??0)});this.state.ppChildren=i,this._resolveChildPhotos(e,i);const a=this._selectedChildId&&i.some(n=>n.id===this._selectedChildId)?this._selectedChildId:((o=i[0])==null?void 0:o.id)??null;a!==this._selectedChildId?this._subscribeChild(a):a||this._teardownChild(),this._emit()},t=>{console.warn("[Portal] ppChildren subscription error:",t.code,t.message)})}_subscribeIncomingRequests(e){var t;(t=this._unsubIncomingReq)==null||t.call(this),this._unsubIncomingReq=T(z(u,"families",e,"childAccessRequests"),i=>{this.state.incomingChildRequests=i.docs.map(r=>({id:r.id,...r.data()})).filter(r=>r.status==="pending").sort((r,a)=>{var o,n,l,d;return(((n=(o=r.requestedAt)==null?void 0:o.toMillis)==null?void 0:n.call(o))??0)-(((d=(l=a.requestedAt)==null?void 0:l.toMillis)==null?void 0:d.call(l))??0)}),this._emit()},i=>console.warn("[Portal] childAccessRequests error:",i.code,i.message))}_subscribeChild(e){if(this._teardownChild(),this._selectedChildId=e,this.state.selectedChildId=e,!e||!this._ppFamilyId){this.state.childMilestones=[],this.state.childInsights=[],this.state.childDailyCard=null,this.state.childPebbleMessages=[],this.state.childPebbleSessions=[];return}const t=["families",this._ppFamilyId,"children",e];this._unsubChildMs=T(z(u,...t,"milestones"),i=>{this.state.childMilestones=i.docs.map(r=>({id:r.id,...r.data()})).sort((r,a)=>(r.ageRangeStartMonths??0)-(a.ageRangeStartMonths??0)),this._emit()},i=>console.warn("[Portal] milestones error:",i.code,i.message)),this._unsubChildIns=T(z(u,...t,"insights"),i=>{this.state.childInsights=i.docs.map(r=>({id:r.id,...r.data()})).sort((r,a)=>(a.relevanceScore??0)-(r.relevanceScore??0)),this._emit()},i=>console.warn("[Portal] insights error:",i.code,i.message)),this._ppReadOnly||(this._unsubChildDaily=T(z(u,...t,"dailyCards"),i=>{const r=i.docs.map(a=>({id:a.id,...a.data()}));r.sort((a,o)=>String(o.id).localeCompare(String(a.id))),this.state.childDailyCard=r[0]??null,this._emit()},i=>console.warn("[Portal] dailyCards error:",i.code,i.message))),this._unsubChildPebble=T(z(u,...t,"pebbleMessages"),i=>{this.state.childPebbleMessages=i.docs.map(r=>({id:r.id,...r.data()})).filter(r=>!(r.isPrivate===!0&&r.senderUid!==this._uid)).sort((r,a)=>{var o,n,l,d;return(((n=(o=r.timestamp)==null?void 0:o.toMillis)==null?void 0:n.call(o))??0)-(((d=(l=a.timestamp)==null?void 0:l.toMillis)==null?void 0:d.call(l))??0)}),this._emit()},i=>console.warn("[Portal] pebbleMessages error:",i.code,i.message)),this._unsubChildSessions=T(z(u,...t,"pebbleSessions"),i=>{this.state.childPebbleSessions=i.docs.map(r=>({id:r.id,...r.data()})).filter(r=>r.archived!==!0).filter(r=>!(r.isPrivate===!0&&r.createdBy!==this._uid)).sort((r,a)=>{var o,n,l,d,g,c,h,b;return(((n=(o=a.lastMessageAt)==null?void 0:o.toMillis)==null?void 0:n.call(o))??((d=(l=a.createdAt)==null?void 0:l.toMillis)==null?void 0:d.call(l))??0)-(((c=(g=r.lastMessageAt)==null?void 0:g.toMillis)==null?void 0:c.call(g))??((b=(h=r.createdAt)==null?void 0:h.toMillis)==null?void 0:b.call(h))??0)}),this._emit()},i=>console.warn("[Portal] pebbleSessions error:",i.code,i.message))}_resolveChildPhotos(e,t){if(U){this._photoTried||(this._photoTried=new Set);for(const i of t){const r=i.profilePhotoURL;if(typeof r=="string"&&/^https?:\/\//i.test(r))continue;const a=e+"/"+i.id;this._photoTried.has(a)||(this._photoTried.add(a),ne(ee(U,"families/"+e+"/avatars/children/"+i.id)).then(o=>{const n=this.state.ppChildren||[],l=n.findIndex(d=>d.id===i.id);l>=0&&(n[l]={...n[l],profilePhotoURL:o},this.state.ppChildren=[...n],this._emit())}).catch(()=>{this._photoTried.delete(a)}))}}}selectChild(e){!e||e===this._selectedChildId||this.state.ppChildren.some(t=>t.id===e)&&(this._subscribeChild(e),this._emit())}async askPebbleAboutChild(e,t,i=[],r=!1,a=""){if(!B)throw new Error("Firebase functions not configured.");if(!this._ppFamilyId)throw new Error("No PebblePath family.");if(!e)throw new Error("No child selected.");return(await J(B,"askPebbleAboutChild")({familyId:this._ppFamilyId,childId:e,question:t,history:i,isPrivate:r===!0,sessionId:a||""})).data}_childPebbleBase(e){return["families",this._ppFamilyId,"children",e,"pebbleSessions"]}async createPebbleSession(e,{title:t,isPrivate:i}={}){if(!u||!this._ppFamilyId||!e)throw new Error("No child selected.");return(await j(z(u,...this._childPebbleBase(e)),{title:(t||"New chat").trim()||"New chat",isPrivate:i===!0,archived:!1,createdBy:this._uid??"",createdAt:k(),lastMessageAt:k()})).id}async renamePebbleSession(e,t,i){!u||!this._ppFamilyId||!e||!t||await P(C(u,...this._childPebbleBase(e),t),{title:(i||"").trim()||"Untitled chat"})}async setPebbleSessionPrivacy(e,t,i){!u||!this._ppFamilyId||!e||!t||await P(C(u,...this._childPebbleBase(e),t),{isPrivate:i===!0})}async archivePebbleSession(e,t){!u||!this._ppFamilyId||!e||!t||await P(C(u,...this._childPebbleBase(e),t),{archived:!0})}async touchPebbleSession(e,t){if(!(!u||!this._ppFamilyId||!e||!t))try{await P(C(u,...this._childPebbleBase(e),t),{lastMessageAt:k()})}catch{}}_teardownChild(){var e,t,i,r,a;(e=this._unsubChildMs)==null||e.call(this),(t=this._unsubChildIns)==null||t.call(this),(i=this._unsubChildDaily)==null||i.call(this),(r=this._unsubChildPebble)==null||r.call(this),(a=this._unsubChildSessions)==null||a.call(this),this._unsubChildMs=this._unsubChildIns=this._unsubChildDaily=this._unsubChildPebble=this._unsubChildSessions=null}_teardownPpFamily(){var e,t,i;this._teardownChild(),(e=this._unsubPpFamily)==null||e.call(this),(t=this._unsubPpChildren)==null||t.call(this),(i=this._unsubIncomingReq)==null||i.call(this),this._unsubPpFamily=null,this._unsubPpChildren=null,this._unsubIncomingReq=null,this._selectedChildId=null,this.state.ppFamily=null,this.state.ppIsMember=!1,this.state.ppIsChildViewer=!1,this.state.incomingChildRequests=[],this.state.ppChildren=[],this.state.selectedChildId=null,this.state.childMilestones=[],this.state.childInsights=[],this.state.childDailyCard=null,this.state.childPebbleMessages=[],this.state.childPebbleSessions=[]}async requestChildAccess(){var t;const e=this._currentFamilyId;if(!e)throw new Error("No family to request access from.");await L(C(u,"families",e,"childAccessRequests",this._uid),{uid:this._uid,displayName:((t=this.state.user)==null?void 0:t.displayName)??"Family member",requestedAt:k(),status:"pending"})}async withdrawChildAccessRequest(){const e=this._currentFamilyId;e&&await W(C(u,"families",e,"childAccessRequests",this._uid))}async approveChildAccess(e){var r;const t=this._ppFamilyId;if(!t||!this.state.ppIsMember)throw new Error("Only a parent can approve access.");const i=Array.isArray((r=this.state.ppFamily)==null?void 0:r.childViewers)?this.state.ppFamily.childViewers:[];i.includes(e)||await P(C(u,"families",t),{childViewers:[...i,e],updatedAt:k()}),await P(C(u,"families",t,"childAccessRequests",e),{status:"approved",actionedBy:this._uid,actionedAt:k()})}async declineChildAccess(e){const t=this._ppFamilyId;if(!t||!this.state.ppIsMember)throw new Error("Only a parent can decline access.");await P(C(u,"families",t,"childAccessRequests",e),{status:"declined",actionedBy:this._uid,actionedAt:k()})}async revokeChildViewer(e){var a;const t=this._ppFamilyId;if(!t||!this.state.ppIsMember)throw new Error("Only a parent can revoke access.");const i=Array.isArray((a=this.state.ppFamily)==null?void 0:a.childViewers)?this.state.ppFamily.childViewers:[],r=i.filter(o=>o!==e);r.length!==i.length&&await P(C(u,"families",t),{childViewers:r,updatedAt:k()});try{await P(C(u,"families",t,"childAccessRequests",e),{status:"declined",actionedBy:this._uid,actionedAt:k()})}catch{}}_backfillVisibleTo(e,t){if(!u||!this._currentFamilyId)return;const i=this.state.family;if(i){this._vtBackfilled||(this._vtBackfilled=new Set);for(const r of t){const a=r.data();if(Array.isArray(a.visibleTo))continue;const o=`${e}/${r.id}`;this._vtBackfilled.has(o)||(this._vtBackfilled.add(o),P(C(u,"families",this._currentFamilyId,e,r.id),{visibleTo:pe(a.visibility??"family",i,a.createdBy,Array.isArray(a.attendees)?a.attendees:[])}).catch(n=>{this._vtBackfilled.delete(o),console.warn(`[Cairn] visibleTo backfill failed (${o}):`,n==null?void 0:n.code,n==null?void 0:n.message)}))}}}async _visibleToFor(e,t,i){const r=(e==null?void 0:e.visibility)??"family",a=Array.isArray(e==null?void 0:e.attendees)?e.attendees:[],o=r==="extended"?await Lt(t):[];return pe(r,t,i,a,o)}async saveTrip(e){var d;if(!u||!this._currentFamilyId)throw new Error("No family yet.");const t=(d=w==null?void 0:w.currentUser)==null?void 0:d.uid;if(!t)throw new Error("Not signed in.");const{id:i,createdAt:r,updatedAt:a,...o}=e,n={...o,updatedAt:k()};return n.visibleTo=await this._visibleToFor(o,this.state.family,o.createdBy??t),i?(await P(C(u,"families",this._currentFamilyId,"trips",i),n),i):(n.createdBy=t,n.createdAt=k(),(await j(z(u,"families",this._currentFamilyId,"trips"),n)).id)}async deleteTrip(e){if(!u||!this._currentFamilyId)throw new Error("No family yet.");await W(C(u,"families",this._currentFamilyId,"trips",e))}planItemsListener(e,t){return!u||!this._currentFamilyId||!e?()=>{}:T(z(u,"families",this._currentFamilyId,"trips",e,"planItems"),i=>{const r=i.docs.map(a=>({id:a.id,...a.data()})).sort((a,o)=>{var d,g,c,h;const n=String(a.day??"").localeCompare(String(o.day??""));if(n!==0)return n;const l=String(a.time??"").localeCompare(String(o.time??""));return l!==0?l:(((g=(d=a.createdAt)==null?void 0:d.toMillis)==null?void 0:g.call(d))??0)-(((h=(c=o.createdAt)==null?void 0:c.toMillis)==null?void 0:h.call(c))??0)});t(r)},i=>{console.warn("[Portal] planItems subscription error:",i.code,i.message),t([])})}async addPlanItem(e,t){var n;if(!u||!this._currentFamilyId)throw new Error("No family yet.");const i=(n=w==null?void 0:w.currentUser)==null?void 0:n.uid;if(!i)throw new Error("Not signed in.");const r=String((t==null?void 0:t.title)??"").trim();if(!r)throw new Error("Add a title.");const a=String((t==null?void 0:t.url)??"").trim();return(await j(z(u,"families",this._currentFamilyId,"trips",e,"planItems"),{title:r,type:(t==null?void 0:t.type)??"note",day:(t==null?void 0:t.day)??"",time:(t==null?void 0:t.time)??"",durationMins:Number.isFinite(t==null?void 0:t.durationMins)?t.durationMins:60,.../^https?:\/\//i.test(a)?{url:a}:{},addedBy:i,createdAt:k()})).id}async updatePlanItem(e,t,i){if(!u||!this._currentFamilyId)throw new Error("No family yet.");await P(C(u,"families",this._currentFamilyId,"trips",e,"planItems",t),i)}async uploadPlanAttachment(e,t,i){if(!U||!this._currentFamilyId)throw new Error("Storage unavailable.");const r=`families/${this._currentFamilyId}/planAttachments/${e}__${t}`,a=ee(U,r);return await le(a,i,{contentType:i.type||"application/octet-stream"}),ne(a)}async deletePlanItem(e,t){if(!u||!this._currentFamilyId)throw new Error("No family yet.");await W(C(u,"families",this._currentFamilyId,"trips",e,"planItems",t))}async saveEvent(e){var d;if(!u||!this._currentFamilyId)throw new Error("No family yet.");const t=(d=w==null?void 0:w.currentUser)==null?void 0:d.uid;if(!t)throw new Error("Not signed in.");const{id:i,createdAt:r,updatedAt:a,...o}=e,n={...o,updatedAt:k()};return n.visibleTo=await this._visibleToFor(o,this.state.family,o.createdBy??t),i?(await P(C(u,"families",this._currentFamilyId,"familyEvents",i),n),i):(n.createdBy=t,n.createdAt=k(),(await j(z(u,"families",this._currentFamilyId,"familyEvents"),n)).id)}async deleteEvent(e){if(!u||!this._currentFamilyId)throw new Error("No family yet.");await W(C(u,"families",this._currentFamilyId,"familyEvents",e))}async uploadSchoolCalendar(e){if(!U||!this._currentFamilyId)throw new Error("Storage unavailable.");const t=e.type||"",i=/pdf/.test(t)?"pdf":/^image\//.test(t)?"image":/word|officedocument|msword/.test(t)?"docx":"pdf",r=`families/${this._currentFamilyId}/schoolCalendarUploads/${Date.now()}`;return await le(ee(U,r),e,{contentType:t||"application/octet-stream"}),{storagePath:r,fileType:i}}async extractSchoolCalendarEvents(e,t){var o;if(!B||!this._currentFamilyId)throw new Error("No family yet.");const r=await J(B,"extractSchoolCalendar")({familyId:this._currentFamilyId,storagePath:e,fileType:t}),a=(o=r==null?void 0:r.data)==null?void 0:o.events;return Array.isArray(a)?a:[]}async importSchoolEvents(e){var c;if(!u||!this._currentFamilyId)throw new Error("No family yet.");const t=(c=w==null?void 0:w.currentUser)==null?void 0:c.uid;if(!t)throw new Error("Not signed in.");const i=this.state.family??{},r=Array.isArray(i.memberIds)?i.memberIds:[],a=Array.isArray(i.cairnMemberIds)?i.cairnMemberIds:[],o=[...new Set([...r,...a,t])],n=pe("extended",i,t),l=z(u,"families",this._currentFamilyId,"familyEvents"),d=(e??[]).filter(h=>h&&/^\d{4}-\d{2}-\d{2}$/.test(String(h.date??""))&&String(h.title??"").trim()).slice(0,250);let g=0;return await Promise.all(d.map(async h=>{await j(l,{title:String(h.title).trim().slice(0,120),date:h.date,type:h.type||"other",source:"school-import",personIds:o,visibility:"extended",visibleTo:n,createdBy:t,createdAt:k(),updatedAt:k()}),g+=1})),g}async previewUrl(e){if(!e||typeof e!="string"||!/^https?:\/\//i.test(e.trim()))return null;if(!B)throw new Error("Firebase functions not configured.");return(await J(B,"previewUrl")({url:e.trim()})).data}async lookupFlight(e,t){if(!e||typeof e!="string")return null;if(!B)throw new Error("Firebase functions not configured.");return(await J(B,"lookupFlight")({flightNumber:e.trim(),date:typeof t=="string"?t.trim():""})).data}async askPebble(e,t=[]){if(!B)throw new Error("Firebase functions not configured.");if(!this._currentFamilyId)throw new Error("No family yet.");return(await J(B,"askPebbleAboutActivities")({question:e,familyId:this._currentFamilyId,history:t})).data}async updateChildBirthday(e,t){if(!u||!this._currentFamilyId)throw new Error("No family yet.");await P(C(u,"families",this._currentFamilyId,"children",e),{dateOfBirth:t,updatedAt:k()})}async findFamilyByCairnCode(e){if(!u)throw new Error("Firebase not configured.");const t=G(z(u,"families"),Y("cairnInviteCode","==",e)),i=await V(t);if(i.empty)return null;const r=i.docs[0];return{id:r.id,...r.data()}}async findFamilyByConnectCode(e){if(!u)throw new Error("Firebase not configured.");const t=await V(G(z(u,"families"),Y("cairnInviteCode","==",e)));if(!t.empty){const r=t.docs[0];return{id:r.id,...r.data(),_matchedCodeKind:"cairn"}}const i=await V(G(z(u,"families"),Y("inviteCode","==",e)));if(!i.empty){const r=i.docs[0];return{id:r.id,...r.data(),_matchedCodeKind:"pp"}}return null}async _applyCairnJoin(e){var d;const t=(d=w==null?void 0:w.currentUser)==null?void 0:d.uid;if(!t)throw new Error("Not signed in.");const i=e.cairnMemberIds??[],r=e.memberIds??[],a=w.currentUser;if(i.includes(t)||r.includes(t))return await L(C(u,"users",t),{email:a.email??"",displayName:a.displayName??"",profilePhotoURL:a.photoURL??null,cairnFamilyId:e.id,updatedAt:k()},{merge:!0}),await this._recordMutualConnection(e.id,t),e.id;const o=e.cairnMaxMembers??20;if(i.length>=o){const g=new Error("This family's Cairn ring is full.");throw g.code="full",g}const n=new Date,l={displayName:a.displayName??"",profilePhotoURL:a.photoURL??null,role:"member",joinedAt:n,updatedAt:n};return await P(C(u,"families",e.id),{cairnMemberIds:[...i,t],[`memberProfiles.${t}`]:l,updatedAt:k()}),await L(C(u,"users",t),{email:a.email??"",displayName:a.displayName??"",profilePhotoURL:a.photoURL??null,cairnFamilyId:e.id,role:"member",notificationPreferences:{milestoneReminders:!0,tipNotifications:!0,schoolDeadlines:!0},createdAt:k(),updatedAt:k()},{merge:!0}),await this._recordMutualConnection(e.id,t),e.id}async redeemConnectCode(e){var o,n;if(!u)throw new Error("Firebase not configured.");if(!((o=w==null?void 0:w.currentUser)==null?void 0:o.uid))throw new Error("Not signed in.");const i=await this.findFamilyByConnectCode(e);if(!i){const l=new Error("Invite code not found.");throw l.code="not-found",l}const r=i._matchedCodeKind==="pp"?i.inviteCodeExpiresAt:i.cairnInviteCodeExpiresAt,a=((n=r==null?void 0:r.toDate)==null?void 0:n.call(r))??(r?new Date(r):null);if(!a||a<new Date){const l=new Error("This invite code has expired.");throw l.code="expired",l}return this._applyCairnJoin(i)}async _recordMutualConnection(e,t){var i;try{const{getDoc:r,arrayUnion:a}=await H(async()=>{const{getDoc:l,arrayUnion:d}=await import("./firebase-core-DEm61vaB.js").then(g=>g.J);return{getDoc:l,arrayUnion:d}},[]),o=await r(C(u,"users",t)),n=o.exists()?(i=o.data())==null?void 0:i.familyId:null;if(!n||n===e)return;await P(C(u,"families",e),{connectedFamilyIds:a(n),updatedAt:k()}),await P(C(u,"families",n),{connectedFamilyIds:a(e),updatedAt:k()})}catch(r){console.warn("[connect] mutual connection record skipped (non-fatal):",r)}}async saveSubGroup({id:e,name:t,memberIds:i}){if(!u||!this._currentFamilyId)throw new Error("No family yet.");const r=e??`g_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,6)}`;return await P(C(u,"families",this._currentFamilyId),{[`subGroups.${r}`]:{name:t.trim(),memberIds:Array.isArray(i)?[...i]:[],updatedAt:k()},updatedAt:k()}),r}async deleteSubGroup(e){if(!u||!this._currentFamilyId)throw new Error("No family yet.");const{deleteField:t}=await H(async()=>{const{deleteField:i}=await import("./firebase-core-DEm61vaB.js").then(r=>r.J);return{deleteField:i}},[]);await P(C(u,"families",this._currentFamilyId),{[`subGroups.${e}`]:t(),updatedAt:k()})}async setCairnMemberSubGroup(e,t){var a;if(!u||!this._currentFamilyId)throw new Error("No family yet.");if(!e)throw new Error("uid is required.");const i=((a=this.state.family)==null?void 0:a.subGroups)??{},r={};for(const[o,n]of Object.entries(i)){const l=Array.isArray(n.memberIds)?n.memberIds:[];o===t?l.includes(e)||(r[`subGroups.${o}.memberIds`]=[...l,e]):l.includes(e)&&(r[`subGroups.${o}.memberIds`]=l.filter(d=>d!==e))}Object.keys(r).length!==0&&(r.updatedAt=k(),await P(C(u,"families",this._currentFamilyId),r))}async removeCairnMember(e){if(!u||!this._currentFamilyId)throw new Error("No family yet.");if(!e)throw new Error("uid is required.");const t=this.state.family??{};if((Array.isArray(t.memberIds)?t.memberIds:[]).includes(e))throw new Error("PP members can’t be removed from the ring here.");const{deleteField:r}=await H(async()=>{const{deleteField:d}=await import("./firebase-core-DEm61vaB.js").then(g=>g.J);return{deleteField:d}},[]),a={updatedAt:k()},o=Array.isArray(t.cairnMemberIds)?t.cairnMemberIds:[];o.includes(e)&&(a.cairnMemberIds=o.filter(d=>d!==e)),t.memberProfiles&&t.memberProfiles[e]&&(a[`memberProfiles.${e}`]=r());const n=Array.isArray(t.childViewers)?t.childViewers:[];n.includes(e)&&(a.childViewers=n.filter(d=>d!==e));const l=t.subGroups??{};for(const[d,g]of Object.entries(l)){const c=Array.isArray(g.memberIds)?g.memberIds:[];c.includes(e)&&(a[`subGroups.${d}.memberIds`]=c.filter(h=>h!==e))}await P(C(u,"families",this._currentFamilyId),a);try{await W(C(u,"families",this._currentFamilyId,"childAccessRequests",e))}catch{}}async createCairnOnlyFamily(e){if(!u)throw new Error("Firebase not configured.");const t=w==null?void 0:w.currentUser,i=t==null?void 0:t.uid;if(!i)throw new Error("Not signed in.");const r=(e??"").trim();if(!r)throw new Error("Family name is required.");const a=new Date,o=he(),n=new Date(Date.now()+720*60*60*1e3),l={displayName:t.displayName??"",profilePhotoURL:t.photoURL??null,role:"admin",joinedAt:a,updatedAt:a},d={name:r,createdBy:i,createdInApp:"cairn",memberIds:[],cairnMemberIds:[i],connectedFamilyIds:[],cairnMaxMembers:20,cairnInviteCode:o,cairnInviteCodeExpiresAt:n,memberProfiles:{[i]:l},createdAt:k(),updatedAt:k()},g=await j(z(u,"families"),d);return await L(C(u,"users",i),{email:t.email??"",displayName:t.displayName??"",profilePhotoURL:t.photoURL??null,cairnFamilyId:g.id,role:"admin",notificationPreferences:{milestoneReminders:!1,tipNotifications:!1,schoolDeadlines:!1},createdAt:k(),updatedAt:k()},{merge:!0}),g.id}async createPebblePathFamily(e){if(!u)throw new Error("Firebase not configured.");const t=w==null?void 0:w.currentUser,i=t==null?void 0:t.uid;if(!i)throw new Error("Not signed in.");const r=(e??"").trim();if(!r)throw new Error("Family name is required.");const a=new Date,o=he(),n=new Date(Date.now()+720*60*60*1e3),l={displayName:t.displayName??"",profilePhotoURL:t.photoURL??null,role:"admin",joinedAt:a,updatedAt:a},d={name:r,createdBy:i,memberIds:[i],cairnMemberIds:[i],connectedFamilyIds:[],cairnMaxMembers:20,inviteCode:o,inviteCodeExpiresAt:n,cairnInviteCode:o,cairnInviteCodeExpiresAt:n,memberProfiles:{[i]:l},createdAt:k(),updatedAt:k()},g=await j(z(u,"families"),d);return await L(C(u,"users",i),{email:t.email??"",displayName:t.displayName??"",profilePhotoURL:t.photoURL??null,familyId:g.id,role:"owner",notificationPreferences:{milestoneReminders:!1,tipNotifications:!1,schoolDeadlines:!1},createdAt:k(),updatedAt:k()},{merge:!0}),g.id}async createChild(e,t){var c,h;if(!u)throw new Error("Firebase not configured.");const i=(c=w==null?void 0:w.currentUser)==null?void 0:c.uid;if(!i)throw new Error("Not signed in.");if(!e)throw new Error("No family.");const r=((t==null?void 0:t.name)??"").trim();if(!r)throw new Error("Child's name is required.");if(!((t==null?void 0:t.dateOfBirth)instanceof Date))throw new Error("Child's date of birth is required.");const{getDoc:a}=await H(async()=>{const{getDoc:b}=await import("./firebase-core-DEm61vaB.js").then(m=>m.J);return{getDoc:b}},[]),o=await a(C(u,"families",e)),n=o.exists()?Array.isArray((h=o.data())==null?void 0:h.memberIds)?o.data().memberIds:[]:[],l=n.length?n:[i],d={name:r,dateOfBirth:t.dateOfBirth,profilePhotoURL:null,developmentalFlags:Array.isArray(t==null?void 0:t.developmentalFlags)?t.developmentalFlags:[],pediatricianNotes:null,region:(t==null?void 0:t.region)??null,parentIds:l,needsServerSeed:!0,createdAt:k(),updatedAt:k()};return(await j(z(u,"families",e,"children"),d)).id}async requestToBeCoParent(e){var a,o,n,l,d;if(!u)throw new Error("Firebase not configured.");const t=(a=w==null?void 0:w.currentUser)==null?void 0:a.uid;if(!t)throw new Error("Not signed in.");const i=this._currentFamilyId??((o=this.state.user)==null?void 0:o.cairnFamilyId)??((n=this.state.user)==null?void 0:n.familyId)??null;if(!i)throw new Error("No family.");if(!e)throw new Error("No child.");const r=((l=this.state.user)==null?void 0:l.displayName)??((d=w==null?void 0:w.currentUser)==null?void 0:d.displayName)??"";await L(C(u,"families",i,"children",e,"coParentRequests",t),{uid:t,displayName:r,status:"pending",requestedAt:k()})}async fetchFamilyChildren(e){if(!u||!e)return[];try{return(await V(z(u,"families",e,"children"))).docs.map(i=>({id:i.id,...i.data()}))}catch(t){return console.warn("[parent-prompt] fetchFamilyChildren skipped (non-fatal):",t),[]}}async regenerateCairnInviteCode(){if(!u||!this._currentFamilyId)throw new Error("No family yet.");const e=he(),t=new Date(Date.now()+720*60*60*1e3);return await P(C(u,"families",this._currentFamilyId),{cairnInviteCode:e,cairnInviteCodeExpiresAt:t,updatedAt:k()}),{code:e,expiresAt:t}}stop(){var e,t,i,r,a;(e=this._unsubUser)==null||e.call(this),(t=this._unsubFamily)==null||t.call(this),(i=this._unsubChildren)==null||i.call(this),(r=this._unsubTrips)==null||r.call(this),(a=this._unsubEvents)==null||a.call(this),this._unsubUser=this._unsubFamily=this._unsubChildren=this._unsubTrips=this._unsubEvents=null,this._teardownPpFamily(),this._uid=null,this._currentFamilyId=null,this._holidayKey=null,this._ppFamilyId=null,this.userDocResolved=!1,this.state={user:null,family:null,children:[],trips:[],events:[],holidays:[],ppFamily:null,ppIsMember:!1,ppChildren:[],selectedChildId:null,childMilestones:[],childInsights:[],childDailyCard:null,childPebbleMessages:[],childPebbleSessions:[]}}_emit(){this.dispatchEvent(new Event("change"))}}const f=new Rt;function pt(p,e){const t=e==null?void 0:e.profilePhotoURL;return typeof t=="string"&&/^https?:\/\//i.test(t)?t:p!=null&&p.photoURL?p.photoURL:null}function Ot(p,e){if(!e)return[];const t=e.cairnMemberIds??e.memberIds??[],i=e.memberIds??[],r=e.memberProfiles??{},a=[];let o=280;for(const n of t){if(i.includes(n)||n===p)continue;const l=r[n],d=l==null?void 0:l.profilePhotoURL;a.push({uid:n,displayName:(l==null?void 0:l.displayName)??"Family",photoURL:typeof d=="string"&&/^https?:\/\//i.test(d)?d:null,role:"extended",circles:["extended"],hue:o}),o=(o+47)%360}return a}async function Bt(p,e){var n,l;const t=Array.isArray(e==null?void 0:e.connectedFamilyIds)?e.connectedFamilyIds:[];if(t.length===0||!u)return[];const{getDoc:i}=await H(async()=>{const{getDoc:d}=await import("./firebase-core-DEm61vaB.js").then(g=>g.J);return{getDoc:d}},[]),r=[],a=new Set(p?[p]:[]);let o=150;for(const d of t)try{const g=await i(C(u,"families",d));if(!g.exists())continue;const c=g.data()??{},h=c.memberProfiles??{},b=c.name??"Connection";for(const m of c.memberIds??[]){if(a.has(m))continue;a.add(m);const v=(n=h[m])==null?void 0:n.profilePhotoURL;r.push({uid:m,displayName:((l=h[m])==null?void 0:l.displayName)??"Connection",photoURL:typeof v=="string"&&/^https?:\/\//i.test(v)?v:null,role:"connection",circles:["connection"],familyName:b,hue:o}),o=(o+53)%360}}catch{}return r}function pe(p,e,t,i=[],r=[]){const a=(e==null?void 0:e.memberIds)??[],o=(e==null?void 0:e.cairnMemberIds)??[],n=t?[t]:[],l=Array.isArray(i)?i:[],d=Array.isArray(r)?r:[];return p==="personal"?[...new Set(n)]:p==="extended"?[...new Set([...a,...o,...n,...l,...d])]:[...new Set([...a,...n,...l])]}async function Lt(p){var r;const e=Array.isArray(p==null?void 0:p.connectedFamilyIds)?p.connectedFamilyIds:[];if(e.length===0||!u)return[];const{getDoc:t}=await H(async()=>{const{getDoc:a}=await import("./firebase-core-DEm61vaB.js").then(o=>o.J);return{getDoc:a}},[]),i=new Set;for(const a of e)try{const o=await t(C(u,"families",a));if(!o.exists())continue;for(const n of((r=o.data())==null?void 0:r.memberIds)??[])i.add(n)}catch{}return[...i]}function he(){const p="ABCDEFGHJKMNPQRSTUVWXYZ23456789";let e="";for(let t=0;t<6;t++)e+=p[Math.floor(Math.random()*p.length)];return e}function jt(p,e,t,i,r){const a=[],o=new Set((i==null?void 0:i.memberIds)??[]),n=o.has(p);a.push({uid:p,displayName:(e==null?void 0:e.displayName)??(t==null?void 0:t.displayName)??"You",photoURL:pt(e,t),role:n?"self":"self-extended",circles:["immediate"],hue:198});const l=(i==null?void 0:i.memberProfiles)??{};for(const[g,c]of Object.entries(l)){if(g===p||!o.has(g))continue;const h=c.profilePhotoURL;a.push({uid:g,displayName:c.displayName??"Co-parent",photoURL:typeof h=="string"&&/^https?:\/\//i.test(h)?h:null,role:"co-parent",circles:["immediate"],hue:8})}let d=142;for(const g of r??[]){const c=g.profilePhotoURL;a.push({uid:`child:${g.id}`,displayName:g.name,photoURL:typeof c=="string"&&/^https?:\/\//i.test(c)?c:null,role:"child",circles:["immediate"],hue:d,dateOfBirth:g.dateOfBirth}),d=(d+58)%360}return a}function Ut(p){const e=[];for(const t of p??[]){if(!t.dateOfBirth)continue;const i=t.dateOfBirth,r=i.getUTCFullYear(),a=String(i.getUTCMonth()+1).padStart(2,"0"),o=String(i.getUTCDate()).padStart(2,"0");e.push({id:`bday:${t.id}`,type:"birthday",date:`${r}-${a}-${o}`,personIds:[`child:${t.id}`],title:`${t.name}'s birthday`,_childId:t.id,_childName:t.name,recurring:!0})}return e}function Gt(p,e=new Date){if(!(p!=null&&p.date))return{date:null,yearsElapsed:0};const t=M(p.date);if(!t||Number.isNaN(t.getTime()))return{date:null,yearsElapsed:0};if(!p.recurring)return{date:t,yearsElapsed:0};const i=new Date(e.getFullYear(),t.getMonth(),t.getDate()),r=i<new Date(e.getFullYear(),e.getMonth(),e.getDate())?new Date(e.getFullYear()+1,t.getMonth(),t.getDate()):i,a=r.getFullYear()-t.getFullYear();return{date:r,yearsElapsed:a}}const Ke=["linear-gradient(135deg, #6b9ac4 0%, #c98a8a 60%, #d4a843 100%)","linear-gradient(135deg, #7a9e7e 0%, #4a6754 70%, #2c4439 100%)","linear-gradient(135deg, #c67b5c 0%, #d4a843 50%, #c98a8a 100%)","linear-gradient(135deg, #3d9b8f 0%, #1f5c54 100%)","linear-gradient(135deg, #d4a843 0%, #c67b5c 55%, #c98a8a 100%)","linear-gradient(135deg, #8b7bb5 0%, #c98a8a 60%, #d4a843 100%)","linear-gradient(135deg, #6b9ac4 0%, #3d9b8f 100%)"];function M(p){if(!p)return null;if(p instanceof Date)return p;const e=String(p).match(/^(\d{4})-(\d{2})-(\d{2})/);return e?new Date(Number(e[1]),Number(e[2])-1,Number(e[3])):new Date(p)}function Yt(p){if(!p)return null;const e=p.getFullYear(),t=String(p.getMonth()+1).padStart(2,"0"),i=String(p.getDate()).padStart(2,"0");return`${e}-${t}-${i}`}async function qt(p,e=90,t=100){const i=new Date,r=new Date(i.getTime()+e*24*60*60*1e3),a=new URL("https://www.googleapis.com/calendar/v3/calendars/primary/events");a.searchParams.set("timeMin",i.toISOString()),a.searchParams.set("timeMax",r.toISOString()),a.searchParams.set("maxResults",String(t)),a.searchParams.set("singleEvents","true"),a.searchParams.set("orderBy","startTime");const o=await fetch(a.toString(),{headers:{Authorization:`Bearer ${p}`}});if(!o.ok){const l=await o.text();throw o.status===401?new Error("Your Google session expired — connect your calendar again."):o.status===403&&/accessNotConfigured|SERVICE_DISABLED|PERMISSION_DENIED|insufficient/i.test(l)?new Error("Google Calendar access isn’t configured for this project yet. (Admin: enable the Google Calendar API and add the calendar.readonly scope to the OAuth consent screen in Google Cloud Console.)"):new Error(`Google Calendar: ${o.status} ${l.slice(0,160)}`)}return((await o.json()).items??[]).filter(l=>{var d,g;return l.status!=="cancelled"&&(((d=l.start)==null?void 0:d.date)||((g=l.start)==null?void 0:g.dateTime))})}function Vt(p,e){var r,a,o,n,l,d,g,c;const t=((r=p.start)==null?void 0:r.date)??((o=(a=p.start)==null?void 0:a.dateTime)==null?void 0:o.slice(0,10))??"";let i=((n=p.end)==null?void 0:n.date)??((d=(l=p.end)==null?void 0:l.dateTime)==null?void 0:d.slice(0,10))??t;if((g=p.start)!=null&&g.date&&((c=p.end)!=null&&c.date)){const h=new Date(i);h.setDate(h.getDate()-1),i=h.toISOString().slice(0,10)}return{title:p.summary||"(untitled)",location:p.location??"",start:t,end:i,attendees:e?[e]:[],viewers:[],visibility:"family",notes:(p.description??"").slice(0,1e3),gcalEventId:p.id,gcalEventLink:p.htmlLink??null}}function Ht(p){if(p!=null&&p.coverGradient)return p.coverGradient;const e=((p==null?void 0:p.title)??(p==null?void 0:p.id)??"")+((p==null?void 0:p.location)??"");let t=0;for(let i=0;i<e.length;i++)t=t*31+e.charCodeAt(i)>>>0;return Ke[t%Ke.length]}class _e extends A{constructor(){super(),this.year=new Date().getFullYear(),this.tripDays=new Map,this.trips=[],this.events=[],this.holidays=[],this.today=new Date,this._activeDay=null}_isLeap(e){return e%4===0&&e%100!==0||e%400===0}_daysInMonth(e,t){return[31,this._isLeap(e)?29:28,31,30,31,30,31,31,30,31,30,31][t]}_labelsForMonth(e){var a;const t=this.year,i=new Map,r=(o,n)=>{const l=i.get(o);i.set(o,l?`${l} · ${n}`:n)};for(const o of this.trips??[]){if(!o.start||!o.end)continue;const n=M(o.start),l=M(o.end);if(!n||!l||n.getFullYear()>t||l.getFullYear()<t)continue;const d=new Date(t,e,1),g=new Date(t,e+1,0);if(l<d||n>g)continue;const c=n.getMonth()===e&&n.getFullYear()===t?n.getDate():1,h=l.getMonth()===e&&l.getFullYear()===t?l.getDate():g.getDate(),b=(a=o.location)!=null&&a.trim()?`${o.title} (${o.location.trim()})`:o.title;for(let m=c;m<=h;m++)r(m,b)}for(const o of this.events??[]){const n=M(o.date);n&&n.getFullYear()===t&&n.getMonth()===e&&r(n.getDate(),o.title??"Event")}for(const o of this.holidays??[]){const n=M(o.date);n&&n.getFullYear()===t&&n.getMonth()===e&&r(n.getDate(),o.title??"Public holiday")}return i}_renderMonth(e){var d,g;const t=this.year,r=(new Date(t,e,1).getDay()+6)%7,a=this._daysInMonth(t,e),o=this._labelsForMonth(e),n=[];for(let c=0;c<r;c++)n.push(s`<div class="cell empty"></div>`);const l=this.today;for(let c=1;c<=a;c++){const h=`${String(e+1).padStart(2,"0")}-${String(c).padStart(2,"0")}`,b=this.tripDays.get(h)??0,m=l.getFullYear()===t&&l.getMonth()===e&&l.getDate()===c,v=o.get(c),$=(this.events??[]).some(R=>{const E=M(R.date);return E&&E.getFullYear()===t&&E.getMonth()===e&&E.getDate()===c}),y=(this.holidays??[]).some(R=>{const E=M(R.date);return E&&E.getFullYear()===t&&E.getMonth()===e&&E.getDate()===c}),S=((d=this._activeDay)==null?void 0:d.month)===e&&((g=this._activeDay)==null?void 0:g.day)===c,F=["cell",m?"today":"",y?"holiday":"",b>0?"trip":"",b>.6?"dense":"",$?"event":"",v?"labelled":"",S?"active":""].filter(Boolean).join(" ");n.push(s`<div
      ...
      ${this._activeDay?s`
          ...
          `:""}
    `}}_(_e,"properties",{year:{type:Number},tripDays:{type:Object},trips:{type:Array},events:{type:Array},holidays:{type:Array},today:{type:Object},_activeDay:{state:!0}}),_(_e,"styles",I`
    :host {
      display: block;
    }
  ...
  `);customElements.define("yearly-view",_e);class ke extends A{constructor(){super(),this.name="",this.hue=200,this.photo="",this.size=36,this.showName=!1}_initials(){return this.name.split(/\s+/).map(e=>e[0]).filter(Boolean).slice(0,2).join("").toUpperCase()}render(){const e=`linear-gradient(135deg, hsl(${this.hue}, 55%, 62%) 0%, hsl(${(this.hue+40)%360}, 50%, 42%) 100%)`,t=`width:${this.size}px;height:${this.size}px;background:${e};font-size:${this.size*.38}px;`;return s`
    ...
    `}}_(ke,"properties",{name:{type:String},hue:{type:Number},photo:{type:String},size:{type:Number},showName:{type:Boolean,attribute:"show-name"}}),_(ke,"styles",I`
    :host {
      display: inline-flex;
      align-items: center;
      gap: 8px;
  ...
  `);customElements.define("member-chip",ke);class $e extends A{constructor(){super(),this.start="",this.end="",this._displayMonth=null,this._hoverDate=null}willUpdate(e){if(e.has("start")||this._displayMonth===null){const t=this.start?M(this.start):new Date;this._displayMonth=new Date(t.getFullYear(),t.getMonth(),1)}}_isoFor(e,t,i){return`${e}-${String(t+1).padStart(2,"0")}-${String(i).padStart(2,"0")}`}_emit(e,t){this.start=e,this.end=t,this._hoverDate=null,this.dispatchEvent(new CustomEvent("range-change",{detail:{start:e,end:t},bubbles:!0,composed:!0}))}_onDayClick(e){if(!this.start||this.start&&this.end){this._emit(e,"");return}e<this.start?this._emit(e,this.start):this._emit(this.start,e)}_onDayHover(e){this.start&&!this.end&&(this._hoverDate=e)}_onLeave(){this._hoverDate=null}_shiftMonth(e){const t=this._displayMonth;this._displayMonth=new Date(t.getFullYear(),t.getMonth()+e,1)}_isToday(e,t,i){const r=new Date;return r.getFullYear()===e&&r.getMonth()===t&&r.getDate()===i}_inSelectedRange(e){return!this.start||!this.end?!1:e>this.start&&e<this.end}_inHoverRange(e){if(!this.start||this.end||!this._hoverDate)return!1;const t=this._hoverDate<this.start?this._hoverDate:this.start,i=this._hoverDate<this.start?this.start:this._hoverDate;return e>t&&e<i}_summary(){if(!this.start&&!this.end)return"Pick a start date";const e=t=>{const i=M(t);return i?i.toLocaleString("en-GB",{day:"numeric",month:"short",year:"numeric"}):""};return this.start&&!this.end?`From ${e(this.start)} — pick an end date`:this.start===this.end?e(this.start):`${e(this.start)} – ${e(this.end)}`}_renderGrid(){const e=this._displayMonth.getFullYear(),t=this._displayMonth.getMonth(),r=(new Date(e,t,1).getDay()+6)%7,a=new Date(e,t+1,0).getDate(),o=[];for(let n=0;n<r;n++)o.push(s`<div class="empty"></div>`);for(let n=1;n<=a;n++){const l=this._isoFor(e,t,n),d=l===this.start,g=l===this.end&&l!==this.start,c=this._inSelectedRange(l),h=this._inHoverRange(l),b=this._isToday(e,t,n),m=["day",d?"start":"",g?"end":"",c?"in-range":"",h?"hover-range":"",b&&!d&&!g?"today":""].filter(Boolean).join(" ");o.push(s`
    ...
    `}}_($e,"properties",{start:{type:String},end:{type:String},_displayMonth:{state:!0},_hoverDate:{state:!0}}),_($e,"styles",I`
    * { box-sizing: border-box; }
    :host {
      display: block;
    }
  ...
  `);customElements.define("trip-form",Ce);class Se extends A{constructor(){super(),this.open=!1,this.event=null,this.members=[],this.familyId="",this.busy=!1,this._draft=this._blankDraft(),this._error=""}willUpdate(e){(e.has("event")||e.has("open"))&&(this.open&&(this._draft=this._draftFromEvent(this.event)),this._error="")}_blankDraft(){return{id:null,type:"birthday",title:"",date:new Date().toISOString().slice(0,10),personIds:[],recurring:!0,subtitle:"",notes:"",visibility:"family"}}_draftFromEvent(e){return e?{id:e.id??null,type:e.type??"birthday",title:e.title??"",date:e.date??new Date().toISOString().slice(0,10),personIds:Array.isArray(e.personIds)?[...e.personIds]:[],recurring:e.recurring??!0,subtitle:e.subtitle??"",notes:e.notes??"",visibility:e.visibility??"family"}:this._blankDraft()}_set(e,t){this._draft={...this._draft,[e]:t}}_toggleType(e){this._set("type",e)}_togglePerson(e){const t=this._draft.personIds.includes(e);this._set("personIds",t?this._draft.personIds.filter(i=>i!==e):[...this._draft.personIds,e])}_onSave(){const e=this._draft;if(!e.title.trim()){this._error="Give it a title.";return}if(!e.date){this._error="Pick a date.";return}if(!this.familyId){this._error="No family yet.";return}this._error="",this.dispatchEvent(new CustomEvent("save",{detail:{...e,title:e.title.trim(),subtitle:e.subtitle.trim(),notes:e.notes.trim()}}))}_onDelete(){this._draft.id&&confirm("Delete this event? This can't be undone.")&&this.dispatchEvent(new CustomEvent("remove",{detail:{id:this._draft.id}}))}_onCancel(){this.dispatchEvent(new Event("cancel"))}render(){if(!this.open)return s``;const e=this._draft,t=!!e.id;return s`
    ...
    `}_monthDay(e){if(!e)return"";const t=M(e);return!t||Number.isNaN(t.getTime())?"":t.toLocaleString("en-GB",{day:"numeric",month:"long"})}}_(Se,"properties",{open:{type:Boolean,reflect:!0},event:{type:Object},members:{type:Array},familyId:{type:String},busy:{type:Boolean},_draft:{state:!0},_error:{state:!0}}),_(Se,"styles",I`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
...
They'll lose access to shared trips, celebrations and any read-only child access. You can re-invite them anytime with the invite code.`)){this._removingUid=e.uid;try{await f.removeCairnMember(e.uid),x(`${t} removed.`)}catch(r){x(`Couldn't remove: ${r.code??r.message}`,{duration:5e3})}finally{this._removingUid=null}}}async _regenerate(){if(!this._busy){this._busy=!0;try{await f.regenerateCairnInviteCode(),x("New invite code generated.")}catch(e){console.error(e),x(`Couldn't generate code: ${e.code??e.message}`,{duration:5e3})}finally{this._busy=!1}}}_inviteLink(e){return`${window.location.origin}/portal/?join=${e}`}async _copyLink(){var t;const e=(t=this.family)==null?void 0:t.cairnInviteCode;if(e)try{await navigator.clipboard.writeText(this._inviteLink(e)),x("Invite link copied to clipboard.")}catch{x("Could not copy — try long-press the link instead.")}}async _share(){var i,r;const e=(i=this.family)==null?void 0:i.cairnInviteCode;if(!e)return;const t=this._inviteLink(e);if(navigator.share)try{await navigator.share({title:"Join my family on Cairn",text:`Join ${((r=this.family)==null?void 0:r.name)??"our family"} on Cairn — our shared family calendar.`,url:t})}catch{}else this._copyLink()}_expiryText(e){if(!e)return"";const t=e.toDate?e.toDate():new Date(e),r=Math.max(0,Math.round((t-new Date)/(1440*60*1e3)));return r===0?"Expires today":r===1?"Expires tomorrow":`Expires in ${r} days`}render(){var r,a,o,n;if(!this.open)return s``;const e=(r=this.family)==null?void 0:r.cairnInviteCode,t=(a=this.family)==null?void 0:a.cairnInviteCodeExpiresAt,i=t&&(t.toDate?t.toDate():new Date(t))<new Date;return s`
    ...
    `}}_(Me,"properties",{open:{type:Boolean,reflect:!0},family:{type:Object},immediate:{type:Array},extended:{type:Array},canRemove:{type:Boolean},_busy:{state:!0},_newGroupName:{state:!0},_editingGroupId:{state:!0},_removingUid:{state:!0}}),_(Me,"styles",I`
    * {
      box-sizing: border-box;
    }
    :host {
...
`)}class Ae extends A{constructor(){super(),this.trip=null,this.members=[],this._resizeObs=null}connectedCallback(){super.connectedCallback(),typeof ResizeObserver<"u"&&(this._resizeObs=new ResizeObserver(()=>this._fitTitle()))}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._resizeObs)==null||e.disconnect()}updated(){if(this._resizeObs&&this.renderRoot){const e=this.renderRoot.querySelector("article");e&&!e._observed&&(this._resizeObs.observe(e),e._observed=!0)}this._fitTitle()}_fitTitle(){if(!this.renderRoot)return;const e=this.renderRoot.querySelector("h3");if(!e)return;e.style.fontSize="";let t=19;for(e.style.fontSize=`${t}px`;e.scrollWidth>e.clientWidth+1&&t>13;)t-=.5,e.style.fontSize=`${t}px`}_fmtDates(e,t){const i=M(e),r=M(t);if(!i||!r)return"";const a=i.toLocaleString("en-GB",{month:"short"}),o=r.toLocaleString("en-GB",{month:"short"});return a===o&&i.getFullYear()===r.getFullYear()?`${i.getDate()} – ${r.getDate()} ${a}`:`${i.getDate()} ${a} – ${r.getDate()} ${o}`}async _onShare(e,t,i){i.stopPropagation();const r=Jt(e,t);if(navigator.share)try{await navigator.share({title:`Cairn — ${e.title??"activity"}`,text:r})}catch{}else try{await navigator.clipboard.writeText(r),x("Itinerary copied to clipboard.")}catch{x("Could not copy — try again from a browser tab.")}}render(){const e=this.trip;if(!e)return s``;const t=e.coverImage?`background-image: url(${e.coverImage});`:`background: ${Ht(e)};`,i=e.coverImage?"cover has-image":"cover",r=new Map(this.members.map(l=>[l.uid,l])),a=(e.attendees??[]).map(l=>r.get(l)).filter(Boolean),o=a.slice(0,4),n=Math.max(0,a.length-o.length);return s`
    ...
    `}}_(Ae,"properties",{trip:{type:Object},members:{type:Array}}),_(Ae,"styles",I`
    :host {
      display: block;
    }
    article {
  ...
  `);customElements.define("trip-card",Ae);class Ie extends A{constructor(){super(),this.open=!1,this.trips=[],this.members=[]}_onCancel(){this.dispatchEvent(new Event("cancel"))}_groupByYear(e){const t=[...e].sort((a,o)=>String(a.start).localeCompare(String(o.start))),i=new Date;i.setHours(0,0,0,0);const r=new Map;for(const a of t){if(!a.start)continue;const o=M(a.start),n=M(a.end);if(!o)continue;const l=o.getFullYear();r.has(l)||r.set(l,[]);const d=n?n<i:!1;r.get(l).push({trip:a,isPast:d})}return r}render(){var r;if(!this.open)return s``;const e=this._groupByYear(this.trips??[]),t=((r=this.trips)==null?void 0:r.length)??0,i=new Date().getFullYear();return s`
    ...
    `}}_(Ie,"properties",{open:{type:Boolean,reflect:!0},trips:{type:Array},members:{type:Array}}),_(Ie,"styles",I`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("all-trips-modal",Ie);class Pe extends A{constructor(){super(),this.open=!1,this._events=[],this._selected=new Set,this._loading=!1,this._error="",this._importing=!1,this._started=!1}willUpdate(e){e.has("open")&&this.open&&(this._started=!1,this._error="")}_start(){this._loading||(this._started=!0,this._load())}async _load(){var e,t,i,r,a,o;this._loading=!0,this._error="";try{const n=await st(),l=await qt(n,90),d=new Set((f.state.trips??[]).filter(c=>c.gcalEventId).map(c=>c.gcalEventId));this._events=l.map(c=>({...c,_alreadyImported:d.has(c.id)}));const g=new Set;for(const c of this._events){if(c._alreadyImported)continue;const h=((e=c.start)==null?void 0:e.date)??((i=(t=c.start)==null?void 0:t.dateTime)==null?void 0:i.slice(0,10)),b=((r=c.end)==null?void 0:r.date)??((o=(a=c.end)==null?void 0:a.dateTime)==null?void 0:o.slice(0,10));h&&b&&b!==h&&g.add(c.id)}this._selected=g}catch(n){console.error(n),this._error=(n==null?void 0:n.message)??"Could not load calendar events."}finally{this._loading=!1}}_toggle(e){const t=new Set(this._selected);t.has(e)?t.delete(e):t.add(e),this._selected=t}_toggleAll(){const e=this._events.filter(t=>!t._alreadyImported);this._selected.size===e.length?this._selected=new Set:this._selected=new Set(e.map(t=>t.id))}async _import(){var a;if(this._importing||this._selected.size===0)return;this._importing=!0;const e=(a=w==null?void 0:w.currentUser)==null?void 0:a.uid,t=this._events.filter(o=>this._selected.has(o.id));let i=0,r=0;for(const o of t){const n=Vt(o,e);try{await f.saveTrip(n),i++}catch(l){console.error("Import failed for event",o.id,l),r++}}this._importing=!1,r===0?x(`Imported ${i} ${i===1?"activity":"activities"}.`):x(`Imported ${i}, ${r} failed.`,{duration:5e3}),this._events=[],this._selected=new Set,this.dispatchEvent(new Event("cancel"))}_onCancel(){this.dispatchEvent(new Event("cancel"))}_fmtRange(e){var g,c,h,b,m,v,$,y;const t=((g=e.start)==null?void 0:g.date)??((h=(c=e.start)==null?void 0:c.dateTime)==null?void 0:h.slice(0,10)),i=((b=e.end)==null?void 0:b.date)??((v=(m=e.end)==null?void 0:m.dateTime)==null?void 0:v.slice(0,10));if(!t)return"";const r=new Date(t);if(!i||i===t)return r.toLocaleString("en-GB",{day:"numeric",month:"short",year:"numeric"});let a=new Date(i);($=e.start)!=null&&$.date&&((y=e.end)!=null&&y.date)&&a.setDate(a.getDate()-1);const o=r.getMonth()===a.getMonth()&&r.getFullYear()===a.getFullYear(),n=r.getFullYear()===a.getFullYear();if(o)return`${r.getDate()}–${a.getDate()} ${r.toLocaleString("en-GB",{month:"short",year:"numeric"})}`;const l=r.toLocaleString("en-GB",{day:"numeric",month:"short"}),d=a.toLocaleString("en-GB",{day:"numeric",month:"short",year:"numeric"});return n?`${l} – ${d}`:`${r.toLocaleDateString()} – ${a.toLocaleDateString()}`}render(){if(!this.open)return s``;const e=this._events.filter(i=>!i._alreadyImported),t=e.length>0&&this._selected.size===e.length;return s`
    ...
    `}}_(Pe,"properties",{open:{type:Boolean,reflect:!0},_events:{state:!0},_selected:{state:!0},_loading:{state:!0},_error:{state:!0},_importing:{state:!0},_started:{state:!0}}),_(Pe,"styles",I`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("import-calendar-modal",Pe);class ze extends A{constructor(){super(),this.open=!1,this.user=null,this.pebbleUser=null,this._name="",this._savingName=!1,this._uploadingPhoto=!1}willUpdate(e){var t;e.has("open")&&this.open&&(this._name=((t=this.user)==null?void 0:t.displayName)??"")}_onCancel(){this.dispatchEvent(new Event("cancel"))}async _saveName(){var i,r;const e=this._name.trim();if(!e||e===(((i=this.user)==null?void 0:i.displayName)??""))return;const t=(r=w==null?void 0:w.currentUser)==null?void 0:r.uid;if(!(!t||!u)){this._savingName=!0;try{await P(C(u,"users",t),{displayName:e,updatedAt:k()});const a=f.familyId;if(a)try{await P(C(u,"families",a),{[`memberProfiles.${t}.displayName`]:e,[`memberProfiles.${t}.updatedAt`]:k(),updatedAt:k()})}catch(o){console.warn("memberProfiles fan-out failed:",o)}x("Display name updated.")}catch(a){console.error(a),x(`Couldn't save: ${a.code??a.message}`,{duration:5e3})}finally{this._savingName=!1}}}async _signOut(){confirm("Sign out of Cairn?")&&(this.dispatchEvent(new Event("cancel")),await dt())}_triggerPhotoPicker(){var e;(e=this.renderRoot.querySelector("#photo-file"))==null||e.click()}async _onPhotoChosen(e){var a,o;const t=(a=e.target.files)==null?void 0:a[0];if(e.target.value="",!t)return;if(!t.type.startsWith("image/")){x("Pick an image file (JPG, PNG, etc.).");return}if(t.size>5*1024*1024){x("Photo is too big — keep it under 5 MB.");return}const i=(o=w==null?void 0:w.currentUser)==null?void 0:o.uid,r=f.familyId;if(!i||!r||!U){x("Can't upload yet — you need to be in a family first.");return}this._uploadingPhoto=!0;try{const n=ee(U,`families/${r}/avatars/users/${i}`);await le(n,t,{contentType:t.type});const l=await ne(n);await P(C(u,"users",i),{profilePhotoURL:l,updatedAt:k()});try{await P(C(u,"families",r),{[`memberProfiles.${i}.profilePhotoURL`]:l,[`memberProfiles.${i}.updatedAt`]:k(),updatedAt:k()})}catch(d){console.warn("memberProfiles photo fan-out failed:",d)}x("Photo updated.")}catch(n){console.error("Photo upload failed",n),x(`Upload failed: ${n.code??n.message}`,{duration:5e3})}finally{this._uploadingPhoto=!1}}render(){if(!this.open)return s``;const e=this.user,t=this._name.trim()&&this._name.trim()!==((e==null?void 0:e.displayName)??"");return s`
    ...
    `}}_(ze,"properties",{open:{type:Boolean,reflect:!0},user:{type:Object},pebbleUser:{type:Object},_name:{state:!0},_savingName:{state:!0},_uploadingPhoto:{state:!0}}),_(ze,"styles",I`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("profile-sheet",ze);const ie=class ie extends A{constructor(){super(),this.open=!1}static get OPTIONS(){return[{type:"activity",tone:"sage",icon:s`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    `:s``}};_(ie,"properties",{open:{type:Boolean,reflect:!0}}),_(ie,"styles",I`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);let De=ie;customElements.define("activity-type-picker",De);class Fe extends A{constructor(){super(),this.open=!1,this.floating=!1,this.family=null,this.trips=[],this._messages=[],this._input="",this._loading=!1,this._error="",this._followUps=[]}willUpdate(e){var t;e.has("_messages")&&(this.floating=(((t=this._messages)==null?void 0:t.length)??0)>0)}_onCancel(){this.dispatchEvent(new Event("cancel"))}_suggestions(){const e=[],t=(this.trips??[]).filter(i=>i.start&&new Date(i.start)>=new Date).sort((i,r)=>String(i.start).localeCompare(String(r.start)))[0];return t&&(e.push(`What should we do in ${t.location||t.title}?`),e.push(`What should we pack for ${t.title}?`)),e.push("Plan a family activity for this weekend"),e.push("Gift ideas for an upcoming birthday"),e.slice(0,4)}async _send(e){const t=(e??this._input).trim();if(!(!t||this._loading)){this._error="",this._input="",this._followUps=[],this._messages=[...this._messages,{role:"user",content:t}],this._loading=!0,this.updateComplete.then(()=>this._scrollToBottom());try{const i=this._messages.slice(0,-1).map(a=>({role:a.role,content:a.content})),r=await f.askPebble(t,i);this._messages=[...this._messages,{role:"assistant",content:r.answer}],this._followUps=Array.isArray(r.followUps)?r.followUps:[]}catch(i){console.error(i),(i==null?void 0:i.code)==="functions/unauthenticated"?this._error="Pebble needs you to be signed in.":(i==null?void 0:i.code)==="functions/permission-denied"?this._error="You're not in this family yet.":(i==null?void 0:i.code)==="functions/not-found"||(i==null?void 0:i.code)==="functions/internal"?this._error="Pebble isn't available right now — the Cloud Function may not be deployed yet.":this._error=(i==null?void 0:i.message)??"Pebble could not answer right now."}finally{this._loading=!1,this.updateComplete.then(()=>this._scrollToBottom())}}}_scrollToBottom(){const e=this.renderRoot.querySelector(".thread");e&&(e.scrollTop=e.scrollHeight)}_renderPebbleIcon(){return s`
    ...
    `}}_(Fe,"properties",{open:{type:Boolean,reflect:!0},floating:{type:Boolean,reflect:!0},family:{type:Object},trips:{type:Array},_messages:{state:!0},_input:{state:!0},_loading:{state:!0},_error:{state:!0},_followUps:{state:!0}}),_(Fe,"styles",I`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("discover-pebblepath",gt);class Ee extends A{constructor(){super(),this.code="",this._family=null,this._loading=!0,this._joining=!1,this._error="",this._step="join",this._children=[],this._claiming=!1,this._claimedName=null,this._joinedFamilyId=null}willUpdate(e){e.has("code")&&this.code&&this._lookup()}async _lookup(){var e;this._loading=!0,this._error="";try{const t=await f.findFamilyByConnectCode(this.code);if(!t)this._error="Invite code not found. Check it was typed correctly.",this._family=null;else{const i=t._matchedCodeKind==="pp"?t.inviteCodeExpiresAt:t.cairnInviteCodeExpiresAt,r=((e=i==null?void 0:i.toDate)==null?void 0:e.call(i))??(i?new Date(i):null);!r||r<new Date?(this._error="This invite code has expired. Ask the family for a fresh one.",this._family=null):this._family=t}}catch(t){console.error(t),this._error=(t==null?void 0:t.message)??"Couldn't look up the invite."}finally{this._loading=!1}}async _join(){var e;if(!this._joining){this._joining=!0,this._error="";try{const t=await f.redeemConnectCode(this.code);x(`Welcome to ${((e=this._family)==null?void 0:e.name)??"the family"}.`),this._joinedFamilyId=t;const i=await f.fetchFamilyChildren(t);Array.isArray(i)&&i.length?(this._children=i,this._step="parent"):this.dispatchEvent(new CustomEvent("joined",{detail:{familyId:t}}))}catch(t){console.error(t),this._error=(t==null?void 0:t.message)??"Could not join."}finally{this._joining=!1}}}async _claimChild(e){if(!(this._claiming||!(e!=null&&e.id))){this._claiming=!0,this._error="";try{await f.requestToBeCoParent(e.id),this._claimedName=e.name??"your child"}catch(t){console.error(t),this._error=(t==null?void 0:t.message)??"Couldn't send the request."}finally{this._claiming=!1}}}_notAParent(){this._finishJoin()}_finishJoin(){this.dispatchEvent(new CustomEvent("joined",{detail:{familyId:this._joinedFamilyId}}))}_cancel(){this.dispatchEvent(new Event("cancel"))}_inviterFromFamily(e){var r;if(!e)return null;const t=(r=e.memberProfiles)==null?void 0:r[e.createdBy];if(!t)return null;const i=t.profilePhotoURL;return{displayName:t.displayName??"A family member",photoURL:typeof i=="string"&&/^https?:\/\//i.test(i)?i:null}}_renderParentPrompt(){var t;const e=((t=this._family)==null?void 0:t.name)??"this family";return s`
    ...
    `}}_(Ee,"properties",{code:{type:String},_family:{state:!0},_loading:{state:!0},_joining:{state:!0},_error:{state:!0},_step:{state:!0},_children:{state:!0},_claiming:{state:!0},_claimedName:{state:!0}}),_(Ee,"styles",I`
    * { box-sizing: border-box; }
    :host {
      display: flex;
      align-items: center;
  ...
  `);customElements.define("join-family-screen",Ee);class Te extends A{constructor(){super(),this.error="",this.busy=!1,this.joinCode="",this._codeInputOpen=!1,this._code=""}async _handleSignIn(){if(this.busy)return;const e=(this._code??"").trim().toUpperCase();if(this._codeInputOpen&&e){const t=e.startsWith("CAIRN-")?e:`CAIRN-${e.replace(/^CAIRN-?/i,"")}`;try{localStorage.setItem("cairn:pendingJoinCode",t)}catch{}}this.busy=!0,this.error="";try{await ce()}catch(t){this.error=(t==null?void 0:t.message)??"Sign-in failed."}finally{this.busy=!1}}_toggleCode(){this._codeInputOpen=!this._codeInputOpen,this._codeInputOpen&&requestAnimationFrame(()=>{var e;(e=this.renderRoot.querySelector(".code-input"))==null||e.focus()})}_renderGoogleIcon(){return s`
    ...
    `}}_(Te,"properties",{error:{state:!0},busy:{state:!0},joinCode:{type:String},_codeInputOpen:{state:!0},_code:{state:!0}}),_(Te,"styles",I`
    * {
      box-sizing: border-box;
    }
    :host {
  ...
  `);customElements.define("sign-in-screen",Te);const Xt="cairn:pendingJoinCode",Je="cairn:pendingLoginIntent";class Ne extends A{constructor(){super(),this.error="",this.busy=!1,this.joinCode="",this._step="welcome",this._email="",this._password="",this._displayName="",this._consent=!1,this._code="",this._resetSent=!1,this._invited=!1}willUpdate(e){if(e.has("joinCode")&&this.joinCode&&!this._invited){try{localStorage.setItem(Xt,(this.joinCode??"").trim().toUpperCase())}catch{}this._invited=!0}}_iconGoogle(){return s`<svg viewBox="0 0 48 48" aria-hidden="true">
    ...
    `}}_(Ne,"properties",{error:{state:!0},busy:{state:!0},joinCode:{type:String},_step:{state:!0},_email:{state:!0},_password:{state:!0},_displayName:{state:!0},_consent:{state:!0},_code:{state:!0},_resetSent:{state:!0},_invited:{state:!0}}),_(Ne,"styles",I`
    * { box-sizing: border-box; }
    :host {
      display: flex;
      align-items: center;
  ...
  `);customElements.define("register-screen",Ne);const X=class X extends A{constructor(){super(),this.value="family"}_select(e){e!==this.value&&(this.value=e,this.dispatchEvent(new CustomEvent("circle-change",{detail:{value:e},bubbles:!0,composed:!0})))}render(){return s`
    ...
    `}};_(X,"properties",{value:{type:String,reflect:!0}}),_(X,"OPTIONS",[{value:"personal",label:"Just me"},{value:"family",label:"Family"},{value:"extended",label:"Extended"}]),_(X,"styles",I`
    * {
      box-sizing: border-box;
    }
    :host {
  ...
  `);let Re=X;customElements.define("circle-switcher",Re);class Oe extends A{constructor(){super(),this.event=null,this.members=[]}_icon(e){return e==="birthday"?s`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
    ...
    `}}_(Oe,"properties",{event:{type:Object},members:{type:Array}}),_(Oe,"styles",I`
    :host {
      display: block;
    }
    .row {
  ...
  `);customElements.define("event-row",Oe);class Be extends A{constructor(){super();_(this,"_accept","application/pdf,image/*,application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/msword");this.open=!1,this._reset()}_reset(){this._phase="pick",this._events=[],this._err="",this._count=0}willUpdate(t){t.has("open")&&this.open&&this._reset()}_cancel(){this.dispatchEvent(new Event("cancel"))}async _onFile(t){var r;const i=(r=t.target.files)==null?void 0:r[0];if(t.target.value="",!!i){this._phase="working",this._err="";try{const{storagePath:a,fileType:o}=await f.uploadSchoolCalendar(i),n=await f.extractSchoolCalendarEvents(a,o);if(!n.length){this._phase="error",this._err="Couldn't find any dated events in that file. Try a clearer PDF or a screenshot of the calendar.";return}this._events=n.map(l=>({...l,_sel:!0})).sort((l,d)=>String(l.date).localeCompare(String(d.date))),this._phase="review"}catch(a){console.error("school import failed:",a),this._phase="error",this._err=(a==null?void 0:a.code)==="functions/permission-denied"?"You're not a member of this family.":(a==null?void 0:a.code)==="storage/unauthorized"?"The upload rule needs publishing — ask the team to deploy storage.rules.":(a==null?void 0:a.code)==="functions/not-found"||(a==null?void 0:a.code)==="functions/internal"?"The importer isn't available right now — try again in a moment.":(a==null?void 0:a.message)??"Something went wrong — try again."}}}_patch(t,i,r){const a=this._events.slice();a[t]={...a[t],[i]:r},this._events=a}get _selected(){return this._events.filter(t=>t._sel&&/^\d{4}-\d{2}-\d{2}$/.test(t.date)&&t.title.trim())}async _confirm(){const t=this._selected;if(t.length){this._phase="working";try{const i=await f.importSchoolEvents(t.map(r=>({date:r.date,title:r.title.trim(),type:r.type})));this._count=i,this._phase="done",x(`Added ${i} event${i===1?"":"s"} to the calendar.`),this.dispatchEvent(new CustomEvent("added",{detail:i}))}catch(i){console.error("importSchoolEvents failed:",i),this._phase="error",this._err=(i==null?void 0:i.code)==="permission-denied"?"Couldn't save — you may not have permission.":(i==null?void 0:i.message)??"Couldn't save the events — try again."}}}render(){return this.open?s`
    ...
    `:s``}}_(Be,"properties",{open:{type:Boolean,reflect:!0},_phase:{state:!0},_events:{state:!0},_err:{state:!0},_count:{state:!0}}),_(Be,"styles",I`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("school-import-modal",Be);const Xe=[{vb:"0 0 100 70",d:"M 8 38 C 6 18, 26 6, 48 8 C 72 10, 94 18, 94 38 C 94 58, 72 66, 48 64 C 22 62, 10 58, 8 38 Z"},{vb:"0 0 80 90",d:"M 38 6 C 56 8, 70 24, 72 46 C 74 70, 58 84, 38 84 C 16 84, 6 66, 8 44 C 10 22, 22 4, 38 6 Z"},{vb:"0 0 90 80",d:"M 14 26 C 18 10, 38 4, 56 8 C 78 14, 86 32, 82 50 C 76 70, 54 78, 32 72 C 12 66, 10 42, 14 26 Z"},{vb:"0 0 70 60",d:"M 8 30 C 8 14, 22 6, 38 8 C 54 10, 64 22, 62 36 C 60 52, 44 56, 28 54 C 14 52, 8 44, 8 30 Z"},{vb:"0 0 110 75",d:"M 8 38 C 6 18, 30 8, 56 10 C 84 12, 104 22, 104 40 C 102 58, 80 68, 52 66 C 24 64, 10 56, 8 38 Z"},{vb:"0 0 95 75",d:"M 14 24 C 18 10, 40 6, 56 12 C 70 18, 80 18, 86 30 C 90 44, 80 56, 64 60 C 48 64, 28 60, 18 50 C 10 42, 10 32, 14 24 Z"},{vb:"0 0 80 80",d:"M 14 20 C 20 10, 36 6, 52 10 C 68 16, 76 30, 72 48 C 66 64, 50 72, 32 66 C 16 60, 8 44, 10 30 C 12 24, 12 22, 14 20 Z"}];function Zt(p){let e=5381;const t=String(p??"");for(let i=0;i<t.length;i+=1)e=e*33^t.charCodeAt(i);return Xe[Math.abs(e)%Xe.length]}const Ze={motor:{cls:"fam-motor",fill:"#6b9ac4",dom:"Motor"},language:{cls:"fam-language",fill:"#d4a843",dom:"Language"},socialEmotional:{cls:"fam-social",fill:"#c98a8a",dom:"Social-Emotional"},cognitive:{cls:"fam-cognitive",fill:"#8b7bb5",dom:"Cognitive"},cross:{cls:"fam-cross",fill:"#3d9b8f",dom:""}},Qe={strength:{label:"Strength",svg:s`<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M12 2.5l2.94 5.96 6.58.96-4.76 4.64 1.12 6.55L12 17.6l-5.88 3.01 1.12-6.55-4.76-4.64 6.58-.96L12 2.5z"/></svg>`},watching:{label:"Watching",svg:s`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M1.5 12S5 5 12 5s10.5 7 10.5 7-3.5 7-10.5 7S1.5 12 1.5 12z"/><circle cx="12" cy="12" r="3.2"/></svg>`},connection:{label:"Connection",svg:s`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M10 13a5 5 0 0 0 7.07.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71M14 11a5 5 0 0 0-7.07-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>`},nudge:{label:"Try this",svg:s`<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M9 21c0 .55.45 1 1 1h4c.55 0 1-.45 1-1v-1H9v1zm3-19C8.14 2 5 5.14 5 9c0 2.38 1.19 4.47 3 5.74V17c0 .55.45 1 1 1h6c.55 0 1-.45 1-1v-2.26c1.81-1.27 3-3.36 3-5.74 0-3.86-3.14-7-7-7z"/></svg>`}};class Le extends A{constructor(){super(),this.type="nudge",this.domain="cross",this.title="",this.body=""}render(){const e=Ze[this.domain]??Ze.cross,t=Qe[this.type]??Qe.nudge,i=Zt(`${this.title}${this.type}`);return s`
    ...
    `}}_(Le,"properties",{type:{type:String},domain:{type:String},title:{type:String},body:{type:String}}),_(Le,"styles",I`
  ...
  `);customElements.define("insight-card",Le);const ae=[{key:"motor",label:"Motor",color:"#6b9ac4",svg:s`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><circle cx="13.5" cy="5.5" r="2"/><path d="M9.8 8.9 7 23h2.1l1.8-8 2.1 2v6h2v-7.5l-2.1-2 .6-3c1.3 1.5 3.3 2.5 5.5 2.5v-2c-1.9 0-3.5-1-4.3-2.4l-1-1.6c-.4-.6-1-1-1.7-1-.3 0-.5 0-.8.1L6 7.6V12h2V8.9l1.8-.7z"/></svg>`},{key:"language",label:"Language",color:"#d4a843",svg:s`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M20 2H4a2 2 0 0 0-2 2v18l4-4h14a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2z"/></svg>`},{key:"socialEmotional",label:"Social-Emotional",color:"#c98a8a",svg:s`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg>`},{key:"cognitive",label:"Cognitive",color:"#8b7bb5",svg:s`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M11 4.2A2.7 2.7 0 0 0 6.4 5.9a2.6 2.6 0 0 0-2.5 2.6c0 .5.1.9.3 1.3A2.7 2.7 0 0 0 3 12.2a2.7 2.7 0 0 0 1.2 2.2 2.6 2.6 0 0 0-.2 1c0 1.5 1.2 2.7 2.7 2.7.2 0 .4 0 .6-.1A2.7 2.7 0 0 0 11 20V4.2zm2 0v15.8a2.7 2.7 0 0 0 3.7-1.9c.2 0 .4.1.6.1 1.5 0 2.7-1.2 2.7-2.7 0-.4-.1-.7-.2-1A2.7 2.7 0 0 0 21 12.2a2.7 2.7 0 0 0-1.2-2.4c.2-.4.3-.8.3-1.3a2.6 2.6 0 0 0-2.5-2.6A2.7 2.7 0 0 0 13 4.2z"/></svg>`}];function Q(p){return p==="selfCare"?"motor":p}function Qt(p){var o;if(!p||Number.isNaN(((o=p.getTime)==null?void 0:o.call(p))??NaN))return"";const e=new Date;let t=(e.getFullYear()-p.getFullYear())*12+(e.getMonth()-p.getMonth());e.getDate()<p.getDate()&&(t-=1),t=Math.max(0,t);const i=Math.floor(t/12),r=t%12;if(i===0)return`${r} month${r===1?"":"s"}`;const a=r?`, ${r} month${r===1?"":"s"}`:"";return`${i} year${i===1?"":"s"}${a}`}class je extends A{constructor(){super(),this.child=null,this.children=[],this.milestones=[],this.insights=[],this.dailyCard=null,this.readonly=!1}_domainStats(e){const t=(this.milestones??[]).filter(a=>Q(a.category)===e),i=t.filter(a=>a.status==="achieved").length,r=t.length;return{achieved:i,total:r,pct:r?Math.round(i/r*100):0}}_pebbleIcon(){return s`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round"><circle cx="12" cy="12" r="9" /><circle cx="12" cy="12" r="4" fill="currentColor" stroke="none" /></svg>`}_ageMonths(e){var r;if(!e||Number.isNaN(((r=e.getTime)==null?void 0:r.call(e))??NaN))return 0;const t=new Date;let i=(t.getFullYear()-e.getFullYear())*12+(t.getMonth()-e.getMonth());return t.getDate()<e.getDate()&&(i-=1),Math.max(0,i)}_timelineModel(){var g;const e=this.milestones??[],t=this._ageMonths((g=this.child)==null?void 0:g.dateOfBirth),i=e.reduce((c,h)=>h.status==="achieved"?Math.max(c,h.ageRangeEndMonths??h.ageRangeStartMonths??0):c,0);let r=Math.max(i+12,t+6,18);r=Math.ceil(r/6)*6;const a=c=>Math.min(98,Math.max(2,(c??0)/r*100)),o=[{key:"motor",cls:"motor",name:"Motor"},{key:"language",cls:"language",name:"Language"},{key:"socialEmotional",cls:"social",name:"Social-Emo."},{key:"cognitive",cls:"cognitive",name:"Cognitive"}].map(c=>{const h=e.filter(y=>Q(y.category)===c.key),b=h.filter(y=>y.status==="achieved").sort((y,S)=>(y.ageRangeStartMonths??0)-(S.ageRangeStartMonths??0));let m=b;b.length>7&&(m=Array.from({length:7},(y,S)=>b[Math.round(S*(b.length-1)/6)]));const v=m.map(y=>({left:a(y.ageRangeStartMonths),future:!1})),$=h.filter(y=>y.status!=="achieved").sort((y,S)=>(y.ageRangeStartMonths??0)-(S.ageRangeStartMonths??0))[0];return $&&v.push({left:a($.ageRangeStartMonths),future:!0}),{...c,dots:v}}),n=c=>c<=0?"birth":c<24?`${c} mo`:c%12===0?`${c/12} yr`:`${(c/12).toFixed(1).replace(/\.0$/,"")} yr`,l=Array.from({length:7},(c,h)=>n(Math.round(h*r/6))),d=Math.min(1,Math.max(0,t/r));return{lanes:o,axis:l,ageM:t,nowFrac:d}}render(){const e=this.child;if(!e)return s`<div class="panel empty">No child selected yet.</div>`;const t=this.milestones??[],i=t.filter(h=>h.status==="achieved"),r=t.length?Math.round(i.length/t.length*100):0,a=i.slice().sort((h,b)=>(b.ageRangeStartMonths??0)-(h.ageRangeStartMonths??0)).slice(0,4),o=t.filter(h=>h.status!=="achieved").slice(0,5),n=e.themeColorHex||"var(--teal-pebble)",l=this.insights??[],d=this._timelineModel(),g=h=>h==="achieved"?"done":h==="emerging"?"emerging":"up",c=h=>h==="achieved"?"Achieved":h==="emerging"?"Emerging":"Upcoming";return s`
    ...
    `}}_(je,"properties",{child:{type:Object},children:{type:Array},milestones:{type:Array},insights:{type:Array},dailyCard:{type:Object},readonly:{type:Boolean,reflect:!0}}),_(je,"styles",I`
    *, *::before, *::after { box-sizing: border-box; }
    :host { display: block; }
  ...
  `);customElements.define("child-pebble",Ue);const ge=[{key:"visit",label:"Visit"},{key:"meal",label:"Meal"},{key:"travel",label:"Travel"},{key:"note",label:"Note"}],ei=[{m:30,label:"30 min"},{m:60,label:"1 h"},{m:90,label:"1½ h"},{m:120,label:"2 h"},{m:180,label:"3 h"},{m:240,label:"4 h"},{m:480,label:"All day"}],O=56;function et(p){const e=String(p??"").match(/^(\d{4})-(\d{2})-(\d{2})/);return e?new Date(Number(e[1]),Number(e[2])-1,Number(e[3])):null}function ti(p){const e=p.getFullYear(),t=String(p.getMonth()+1).padStart(2,"0"),i=String(p.getDate()).padStart(2,"0");return`${e}-${t}-${i}`}function se(p){const e=String(p??"").match(/^(\d{1,2}):?(\d{2})?/);return e?Number(e[1])+(e[2]?Number(e[2])/60:0):null}function ue(p){const e=Math.floor(p),t=Math.round((p-e)*60);return`${String(e).padStart(2,"0")}:${String(t).padStart(2,"0")}`}class Ge extends A{constructor(){super(),this.open=!1,this.trip=null,this.members=[],this.currentUid="",this._items=[],this._dayKey=null,this._title="",this._time="12:00",this._type="visit",this._dur=60,this._url="",this._file=null,this._fileName="",this._busy=!1,this._view="day",this._weekStart=0,this._sel=null,this._dragCtx=null,this._onGridMove=this._gridMove.bind(this),this._onGridUp=this._gridUp.bind(this),this._unsub=null,this._subId=null}_weekDays(){const e=this._days();if(e.length<=7)return e;const t=Math.min(Math.max(0,this._weekStart),Math.max(0,e.length-7));return e.slice(t,t+7)}_minFromPointer(e,t,i,r){const a=t.getBoundingClientRect(),o=Math.max(0,Math.min(e-a.top,a.height)),n=i*60+o/O*60,l=Math.round(n/15)*15;return Math.max(i*60,Math.min(r*60,l))}_gridDown(e,t,i,r){if(e.button!=null&&e.button!==0||e.target.closest&&e.target.closest(".evt, .wk-evt, button, a"))return;const a=e.currentTarget,o=this._minFromPointer(e.clientY,a,i,r);this._dragCtx={dayKey:t,lo:i,hi:r,el:a},this._sel={dayKey:t,aMin:o,bMin:o},window.addEventListener("pointermove",this._onGridMove),window.addEventListener("pointerup",this._onGridUp),e.preventDefault()}_gridMove(e){if(!this._dragCtx||!this._sel)return;const{el:t,lo:i,hi:r}=this._dragCtx;this._sel={...this._sel,bMin:this._minFromPointer(e.clientY,t,i,r)}}_gridUp(){window.removeEventListener("pointermove",this._onGridMove),window.removeEventListener("pointerup",this._onGridUp);const e=this._sel,t=this._dragCtx;if(this._sel=null,this._dragCtx=null,!e||!t)return;let i=Math.min(e.aMin,e.bMin),a=Math.max(e.aMin,e.bMin)-i;a<15&&(a=this._dur&&this._dur>=15?this._dur:60);const o=String(Math.floor(i/60)).padStart(2,"0"),n=String(i%60).padStart(2,"0");this._dayKey=e.dayKey,this._time=`${o}:${n}`,this._dur=a,this.updateComplete.then(()=>{const l=this.renderRoot.querySelector(".add-row input.t");l&&l.focus()})}_selGhost(e,t){const i=this._sel;if(!i||i.dayKey!==e)return"";const r=Math.min(i.aMin,i.bMin),a=Math.max(i.aMin,i.bMin),o=(r-t*60)/60*O,n=Math.max(3,(a-r)/60*O),l=`${String(Math.floor(r/60)).padStart(2,"0")}:${String(r%60).padStart(2,"0")}`;return s`<div
    ...
    `}}_(Ge,"properties",{open:{type:Boolean,reflect:!0},trip:{type:Object},members:{type:Array},currentUid:{type:String},_items:{state:!0},_dayKey:{state:!0},_title:{state:!0},_time:{state:!0},_type:{state:!0},_dur:{state:!0},_url:{state:!0},_fileName:{state:!0},_busy:{state:!0},_view:{state:!0},_weekStart:{state:!0},_sel:{state:!0}}),_(Ge,"styles",I`
    *, *::before, *::after { box-sizing: border-box; }
    :host { display: block; }
  ...
  `);customElements.define("home-screen",Ye);const it="cairn:pendingLoginIntent";class qe extends A{constructor(){super(),this.user=null,this._mode="choose",this._code="",this._familyName="",this._busy=!1,this._error="",this._childName="",this._childDob="",this._flavor="welcome";try{localStorage.getItem(it)==="1"&&(this._flavor="recovery",localStorage.removeItem(it))}catch{}}willUpdate(e){if(e.has("user")&&this.user&&!this._familyName){const t=(this.user.displayName??"").trim().split(/\s+/).slice(-1)[0];t&&t.length>1&&(this._familyName=`${t} Family`)}}_go(e){this._mode=e,this._error=""}_submitJoin(){const e=(this._code??"").trim().toUpperCase().replace(/\s+/g,"");if(!e){this._error="Paste the connect code you were sent.";return}const t=/^[A-Z0-9]{6}$/.test(e),i=/^CAIRN-[A-Z0-9]{3,6}$/.test(e);if(!t&&!i){this._error="Connect codes are 6 characters.";return}this._error="",this.dispatchEvent(new CustomEvent("join-code",{detail:{code:e},bubbles:!0,composed:!0}))}_goChildrenQuestion(){if(!(this._familyName??"").trim()){this._error="Give your family a name.";return}this._error="",this._go("children")}_goAddChild(){this._error="",this._go("addchild")}async _submitNoChildren(){const e=(this._familyName??"").trim();if(!e){this._error="Give your family a name.";return}this._busy=!0,this._error="";try{await f.createCairnOnlyFamily(e),x(`Welcome to ${e}.`)}catch(t){console.error("Create family failed:",t),this._error=(t==null?void 0:t.code)==="permission-denied"?"Couldn't create the family — Firestore rules may not be deployed yet.":`Couldn't create the family: ${(t==null?void 0:t.message)??"try again"}`}finally{this._busy=!1}}async _submitWithChild(){const e=(this._familyName??"").trim(),t=(this._childName??"").trim();if(!e){this._error="Give your family a name.";return}if(!t){this._error="Add your child's name.";return}if(!this._childDob){this._error="Add your child's date of birth.";return}const i=new Date(`${this._childDob}T00:00:00`);if(Number.isNaN(i.getTime())){this._error="That date of birth doesn't look right.";return}this._busy=!0,this._error="";try{const r=await f.createPebblePathFamily(e);await f.createChild(r,{name:t,dateOfBirth:i}),x(`Welcome to ${e}.`)}catch(r){console.error("Create family + child failed:",r),this._error=(r==null?void 0:r.code)==="permission-denied"?"Couldn't set up your family — Firestore rules may not be deployed yet.":`Couldn't set up your family: ${(r==null?void 0:r.message)??"try again"}`}finally{this._busy=!1}}_iconJoin(){return s`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    `}}_(qe,"properties",{user:{type:Object},_mode:{state:!0},_code:{state:!0},_familyName:{state:!0},_busy:{state:!0},_error:{state:!0},_childName:{state:!0},_childDob:{state:!0},_flavor:{state:!0}}),_(qe,"styles",I`
    * { box-sizing: border-box; }
    :host {
      display: flex;
      align-items: center;
...
//# sourceMappingURL=index-BLmyheZR.js.map
