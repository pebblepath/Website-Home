        ...
        <div class="panel">
          <div class="timeline">
            ...
            ${l.lanes.map(c=>n`<div class="tl-lane ${c.cls}">
                ...
                <div class="tl-track">
                  ${c.dots.map((b,v)=>{var P,E;const k=((P=this._focusedDot)==null?void 0:P.lane)===c.key&&((E=this._focusedDot)==null?void 0:E.idx)===v,m=b.status==="achieved"?"Achieved":b.status==="emerging"?"Emerging":"Upcoming",x=b.title?`${b.title} · ${b.ageLabel} · ${m}`:`${b.ageLabel} · ${m}`;return n`
                      <button
                        type="button"
...
//# sourceMappingURL=index-COp-HbGE.js.map
