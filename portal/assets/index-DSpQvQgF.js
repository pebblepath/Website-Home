var mt=Object.defineProperty;var ft=(p,e,t)=>e in p?mt(p,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):p[e]=t;var _=(p,e,t)=>ft(p,typeof e!="symbol"?e+"":e,t);import{i as A,a as z,b as s,o as vt}from"./lit-dM6tPkba.js";import{f as yt,h as xt,j as wt,G as He,O as _t,k as kt,s as $t,l as at,m as Ct,n as St,o as Pt,q as Mt,t as $,v as M,w as k,x as At,y as T,z as G,A as I,B as Y,D as H,E as j,H as U,I as J}from"./firebase-core-DEm61vaB.js";import{g as zt,h as X}from"./firebase-functions-ID3qFl3p.js";import{g as It,a as Z,r as V,u as Q}from"./firebase-storage-BqMFCgVD.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const a of r)if(a.type==="childList")for(const o of a.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function t(r){const a={};return r.integrity&&(a.integrity=r.integrity),r.referrerPolicy&&(a.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?a.credentials="include":r.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(r){if(r.ep)return;r.ep=!0;const a=t(r);fetch(r.href,a)}})();class be extends A{constructor(){super(),this.variant="default",this.lifted=!1,this.padding="md"}render(){const e=["panel",this.variant==="strong"?"strong":"",this.lifted?"lifted":"",`pad-${this.padding}`].filter(Boolean).join(" ");return s`
      <div class=${e}>
        <div class="content"><slot></slot></div>
      </div>
    `}}_(be,"properties",{variant:{type:String},lifted:{type:Boolean},padding:{type:String}}),_(be,"styles",z`
    :host {
      display: block;
    }
    :host([stretch]) {
  ...
  `);customElements.define("glass-panel",be);class me extends A{constructor(){super(),this.variant="primary",this.size="md",this.full=!1,this.disabled=!1}render(){const e=[this.variant,`size-${this.size}`,this.full?"full":""].filter(Boolean).join(" ");return s`
      <button class=${e} ?disabled=${this.disabled}>
        <slot></slot>
      </button>
    `}}_(me,"properties",{variant:{type:String},size:{type:String},full:{type:Boolean},disabled:{type:Boolean,reflect:!0}}),_(me,"styles",z`
    * {
      box-sizing: border-box;
    }
    :host {
  ...
  `);customElements.define("glass-button",me);class fe extends A{constructor(){super(),this.size=44}render(){const e=this.size;return s`
    ...
    `}}_(fe,"properties",{size:{type:Number}}),_(fe,"styles",z`
    :host {
      display: inline-block;
      line-height: 0;
    }
  ...
  `);customElements.define("cairn-mark",fe);const Dt="modulepreload",Et=function(p){return"/portal/"+p},Ve={},K=function(e,t,i){let r=Promise.resolve();if(t&&t.length>0){let o=function(d){return Promise.all(d.map(g=>Promise.resolve(g).then(c=>({status:"fulfilled",value:c}),c=>({status:"rejected",reason:c}))))};document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),l=(n==null?void 0:n.nonce)||(n==null?void 0:n.getAttribute("nonce"));r=o(t.map(d=>{if(d=Et(d),d in Ve)return;Ve[d]=!0;const g=d.endsWith(".css"),c=g?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${c}`))return;const h=document.createElement("link");if(h.rel=g?"stylesheet":Dt,g||(h.as="script"),h.crossOrigin="",h.href=d,l&&h.setAttribute("nonce",l),document.head.appendChild(h),g)return new Promise((b,f)=>{h.addEventListener("load",b),h.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${d}`)))})}))}function a(o){const n=new Event("vite:preloadError",{cancelable:!0});if(n.payload=o,window.dispatchEvent(n),!n.defaultPrevented)throw o}return r.then(o=>{for(const n of o||[])n.status==="rejected"&&a(n.reason);return e().catch(a)})},ve={apiKey:"AIzaSyA6NKZNLVBeeLrXcLJSXus5M832AxpI2wk",authDomain:"pebblepath-992b6.firebaseapp.com",projectId:"pebblepath-992b6",storageBucket:"pebblepath-992b6.firebasestorage.app",messagingSenderId:"497141667291",appId:"1:497141667291:web:ee84c186db54389d10c3fe"},N=!!(ve.apiKey&&ve.projectId),te=N?yt(ve):null,w=N?xt(te):null,u=N?wt(te):null,L=N?zt(te,"us-central1"):null,R=N?It(te):null,ye=N?new He:null;ye&&ye.setCustomParameters({prompt:"select_account"});const de=N?new He:null;de&&de.addScope("https://www.googleapis.com/auth/calendar.readonly");let le=null,xe=0;async function st(){if(!w||!de)throw new Error("Firebase not configured.");if(le&&Date.now()<xe-6e4)return le;const p=w.currentUser;if(!p)throw new Error("Please sign in before importing your calendar.");if(!(p.providerData??[]).some(a=>a.providerId==="google.com")){const a=new Error("Calendar import needs a Google account. You're signed in another way, so Cairn can't read your Google Calendar here yet — add events manually for now.");throw a.code="calendar/needs-google-account",a}let t;try{t=await kt(p,de)}catch(a){if((a==null?void 0:a.code)==="auth/user-mismatch"){const o=new Error("Please choose the same Google account you use to sign in to Cairn.");throw o.code=a.code,o}if((a==null?void 0:a.code)==="auth/popup-closed-by-user"||(a==null?void 0:a.code)==="auth/cancelled-popup-request"){const o=new Error("Calendar connection cancelled.");throw o.code=a.code,o}throw a}const i=He.credentialFromResult(t),r=i==null?void 0:i.accessToken;if(!r)throw new Error("Couldn't get a Calendar access token — try again.");return le=r,xe=Date.now()+3600*1e3,r}function Ft(){le=null,xe=0}function ce(){if(!w)throw new Error("Firebase not configured — fill in .env first.");return at(w,ye)}const re=N?new _t("apple.com"):null;re&&(re.addScope("email"),re.addScope("name"));function we(){if(!w||!re)throw new Error("Firebase not configured — fill in .env first.");return at(w,re)}function ot(p,e){if(!w)throw new Error("Firebase not configured.");return Pt(w,p,e)}async function nt(p,e,t){if(!w)throw new Error("Firebase not configured.");const i=await Ct(w,p,e);if(t&&t.trim())try{await St(i.user,{displayName:t.trim()})}catch{}return i}function lt(p){if(!w)throw new Error("Firebase not configured.");return Mt(w,p)}function dt(){return w?$t(w):Promise.resolve()}function ct(p){return w?At(w,p):(p(null),()=>{})}const Tt=Object.freeze(Object.defineProperty({__proto__:null,addDoc:U,app:te,auth:w,clearCalendarToken:Ft,collection:I,connectGoogleCalendar:st,db:u,deleteDoc:J,doc:$,firebaseApp:te,functions:L,getDocs:H,getDownloadURL:Z,httpsCallable:X,isConfigured:N,onAuth:ct,onSnapshot:T,query:G,sendPasswordReset:lt,serverTimestamp:k,setDoc:j,signIn:ce,signInWithApple:we,signInWithEmail:ot,signOutUser:dt,signUpWithEmail:nt,storage:R,storageRef:V,updateDoc:M,uploadBytes:Q,where:Y},Symbol.toStringTag,{value:"Module"})),Nt={"united states":"US","united states of america":"US",usa:"US",us:"US","united kingdom":"GB",uk:"GB","great britain":"GB",england:"GB",scotland:"GB",wales:"GB","northern ireland":"GB",canada:"CA",australia:"AU",ireland:"IE",france:"FR",germany:"DE",spain:"ES",italy:"IT",netherlands:"NL","the netherlands":"NL",belgium:"BE",switzerland:"CH",austria:"AT",portugal:"PT",sweden:"SE",norway:"NO",denmark:"DK",finland:"FI","new zealand":"NZ",mexico:"MX",brazil:"BR","south africa":"ZA",india:"IN",japan:"JP",singapore:"SG",poland:"PL"};class Rt extends EventTarget{constructor(){super(),this.state={user:null,family:null,children:[],trips:[],events:[],holidays:[],ppFamily:null,ppIsMember:!1,ppIsChildViewer:!1,myChildAccessRequest:null,incomingChildRequests:[],ppChildren:[],selectedChildId:null,childMilestones:[],childInsights:[],childDailyCard:null,childPebbleMessages:[],childPebbleSessions:[]},this._uid=null,this._unsubUser=null,this._unsubFamily=null,this._unsubChildren=null,this._unsubTrips=null,this._unsubEvents=null,this._currentFamilyId=null,this._holidayKey=null,this._ppFamilyId=null,this._selectedChildId=null,this._unsubPpFamily=null,this._unsubPpChildren=null,this._unsubChildMs=null,this._unsubChildIns=null,this._unsubChildDaily=null,this._unsubChildPebble=null,this._unsubChildSessions=null,this._ppReadOnly=!1,this._unsubIncomingReq=null,this._unsubMyReq=null,this.userDocResolved=!1}get familyId(){return this._currentFamilyId}start(e){!u||!e||this._uid!==e&&(this.stop(),this._uid=e,this._unsubUser=T($(u,"users",e),t=>{var a,o,n,l,d,g,c;this.userDocResolved=!0,this.state.user=t.exists()?{id:t.id,...t.data()}:null;const i=((a=this.state.user)==null?void 0:a.cairnFamilyId)??((o=this.state.user)==null?void 0:o.familyId)??null;!i&&this.state.user&&this._healFamilyPointer(e),i!==this._currentFamilyId&&(this._currentFamilyId=i,(n=this._unsubFamily)==null||n.call(this),(l=this._unsubChildren)==null||l.call(this),(d=this._unsubTrips)==null||d.call(this),(g=this._unsubEvents)==null||g.call(this),this._unsubFamily=null,this._unsubChildren=null,this._unsubTrips=null,this._unsubEvents=null,this.state.family=null,this.state.children=[],this.state.trips=[],this.state.events=[],i&&this._subscribeFamily(i));const r=((c=this.state.user)==null?void 0:c.familyId)??null;r!==this._ppFamilyId&&(this._ppFamilyId=r,this._teardownPpFamily(),r&&this._subscribePpFamily(r)),this._emit()}))}async _healFamilyPointer(e){if(!this._healing){this._healing=!0;try{const t=G(I(u,"families"),Y("cairnMemberIds","array-contains",e)),i=await H(t);if(!i.empty){await j($(u,"users",e),{cairnFamilyId:i.docs[0].id,updatedAt:k()},{merge:!0});return}const r=G(I(u,"families"),Y("memberIds","array-contains",e)),a=await H(r);a.empty||await j($(u,"users",e),{familyId:a.docs[0].id,updatedAt:k()},{merge:!0})}catch(t){console.warn("[Cairn] auto-heal family pointer failed:",t==null?void 0:t.code,t==null?void 0:t.message)}finally{this._healing=!1}}}async _loadHolidays(){var o,n;const e=(n=(o=this.state.family)==null?void 0:o.homeLocation)==null?void 0:n.country,t=Nt[String(e??"").trim().toLowerCase()]??null;if(!t){this.state.holidays.length&&(this.state.holidays=[],this._holidayKey=null,this._emit());return}const i=new Date().getFullYear(),r=[i,i+1],a=`${t}:${r.join(",")}`;if(this._holidayKey!==a){this._holidayKey=a;try{const l=[];for(const g of r){const c=`pp_hol_${t}_${g}`;let h=null;try{const b=JSON.parse(localStorage.getItem(c)||"null");b&&Date.now()-b.t<720*3600*1e3&&(h=b.h)}catch{}if(!h){const b=await fetch(`https://date.nager.at/api/v3/PublicHolidays/${g}/${t}`);if(!b.ok)continue;const f=await b.json();h=(Array.isArray(f)?f:[]).map(v=>({date:v.date,name:v.name||v.localName||"Holiday"}));try{localStorage.setItem(c,JSON.stringify({t:Date.now(),h}))}catch{}}for(const b of h)l.push({id:`hol-${t}-${b.date}-${b.name}`,title:b.name,date:b.date,source:"holiday"})}const d=new Set;this.state.holidays=l.filter(g=>{const c=`${g.date}|${g.title}`;return d.has(c)?!1:(d.add(c),!0)}),this._emit()}catch{this._holidayKey=null}}}_subscribeFamily(e){var t;this._unsubFamily=T($(u,"families",e),i=>{this.state.family=i.exists()?{id:i.id,...i.data()}:null,this._reconcileChildViewer(),this._loadHolidays(),this._emit()}),(t=this._unsubMyReq)==null||t.call(this),this._unsubMyReq=T($(u,"families",e,"childAccessRequests",this._uid),i=>{this.state.myChildAccessRequest=i.exists()?{id:i.id,...i.data()}:null,this._emit()},i=>console.warn("[Portal] childAccessRequest (mine) error:",i.code,i.message)),this._unsubChildren=T(I(u,"families",e,"children"),i=>{this.state.children=i.docs.map(r=>{var o,n;const a=r.data();return{id:r.id,...a,dateOfBirth:((n=(o=a.dateOfBirth)==null?void 0:o.toDate)==null?void 0:n.call(o))??(a.dateOfBirth?new Date(a.dateOfBirth):null)}}),this._emit()}),this._unsubTrips=T(G(I(u,"families",e,"trips"),Y("visibleTo","array-contains",this._uid)),i=>{this.state.trips=i.docs.map(r=>{var o,n,l,d;const a=r.data();return{id:r.id,...a,start:a.start??"",end:a.end??"",createdAt:((n=(o=a.createdAt)==null?void 0:o.toDate)==null?void 0:n.call(o))??null,updatedAt:((d=(l=a.updatedAt)==null?void 0:l.toDate)==null?void 0:d.call(l))??null}}).sort((r,a)=>String(r.start).localeCompare(String(a.start))),this._backfillVisibleTo("trips",i.docs),this._emit()},i=>{console.warn("[Cairn] trips subscription error:",i.code,i.message)}),this._unsubEvents=T(G(I(u,"families",e,"familyEvents"),Y("visibleTo","array-contains",this._uid)),i=>{this.state.events=i.docs.map(r=>{var o,n,l,d;const a=r.data();return{id:r.id,...a,date:a.date??"",createdAt:((n=(o=a.createdAt)==null?void 0:o.toDate)==null?void 0:n.call(o))??null,updatedAt:((d=(l=a.updatedAt)==null?void 0:l.toDate)==null?void 0:d.call(l))??null}}),this._backfillVisibleTo("familyEvents",i.docs),this._emit()},i=>{console.warn("[Cairn] familyEvents subscription error:",i.code,i.message)})}_reconcileChildViewer(){var a;if((a=this.state.user)!=null&&a.familyId)return;const e=this.state.family,t=this._uid,r=!!(e&&Array.isArray(e.childViewers)&&e.childViewers.includes(t)&&!(Array.isArray(e.memberIds)&&e.memberIds.includes(t)))?e.id:null;r!==this._ppFamilyId&&(this._ppFamilyId=r,this._ppReadOnly=!!r,this._teardownPpFamily(),r&&this._subscribePpFamily(r),this._emit())}_subscribePpFamily(e){this._unsubPpFamily=T($(u,"families",e),t=>{var a;const i=t.exists()?{id:t.id,...t.data()}:null;this.state.ppFamily=i;const r=!!(i&&Array.isArray(i.memberIds)&&i.memberIds.includes(this._uid));this.state.ppIsMember=r,this.state.ppIsChildViewer=!!(!r&&i&&Array.isArray(i.childViewers)&&i.childViewers.includes(this._uid)),r&&this._subscribeIncomingRequests(e),(a=this.state.user)!=null&&a.familyId||this._reconcileChildViewer(),this._emit()},t=>{console.warn("[Portal] ppFamily subscription error:",t.code,t.message)}),this._unsubPpChildren=T(I(u,"families",e,"children"),t=>{var o;const i=t.docs.map(n=>{var d,g;const l=n.data();return{id:n.id,...l,dateOfBirth:((g=(d=l.dateOfBirth)==null?void 0:d.toDate)==null?void 0:g.call(d))??(l.dateOfBirth?new Date(l.dateOfBirth):null)}}).sort((n,l)=>{var d,g,c,h;return(((g=(d=n.createdAt)==null?void 0:d.toMillis)==null?void 0:g.call(d))??0)-(((h=(c=l.createdAt)==null?void 0:c.toMillis)==null?void 0:h.call(c))??0)});this.state.ppChildren=i,this._resolveChildPhotos(e,i);const a=this._selectedChildId&&i.some(n=>n.id===this._selectedChildId)?this._selectedChildId:((o=i[0])==null?void 0:o.id)??null;a!==this._selectedChildId?this._subscribeChild(a):a||this._teardownChild(),this._emit()},t=>{console.warn("[Portal] ppChildren subscription error:",t.code,t.message)})}_subscribeIncomingRequests(e){var t;(t=this._unsubIncomingReq)==null||t.call(this),this._unsubIncomingReq=T(I(u,"families",e,"childAccessRequests"),i=>{this.state.incomingChildRequests=i.docs.map(r=>({id:r.id,...r.data()})).filter(r=>r.status==="pending").sort((r,a)=>{var o,n,l,d;return(((n=(o=r.requestedAt)==null?void 0:o.toMillis)==null?void 0:n.call(o))??0)-(((d=(l=a.requestedAt)==null?void 0:l.toMillis)==null?void 0:d.call(l))??0)}),this._emit()},i=>console.warn("[Portal] childAccessRequests error:",i.code,i.message))}_subscribeChild(e){if(this._teardownChild(),this._selectedChildId=e,this.state.selectedChildId=e,!e||!this._ppFamilyId){this.state.childMilestones=[],this.state.childInsights=[],this.state.childDailyCard=null,this.state.childPebbleMessages=[],this.state.childPebbleSessions=[];return}const t=["families",this._ppFamilyId,"children",e];this._unsubChildMs=T(I(u,...t,"milestones"),i=>{this.state.childMilestones=i.docs.map(r=>({id:r.id,...r.data()})).sort((r,a)=>(r.ageRangeStartMonths??0)-(a.ageRangeStartMonths??0)),this._emit()},i=>console.warn("[Portal] milestones error:",i.code,i.message)),this._unsubChildIns=T(I(u,...t,"insights"),i=>{this.state.childInsights=i.docs.map(r=>({id:r.id,...r.data()})).sort((r,a)=>(a.relevanceScore??0)-(r.relevanceScore??0)),this._emit()},i=>console.warn("[Portal] insights error:",i.code,i.message)),this._ppReadOnly||(this._unsubChildDaily=T(I(u,...t,"dailyCards"),i=>{const r=i.docs.map(a=>({id:a.id,...a.data()}));r.sort((a,o)=>String(o.id).localeCompare(String(a.id))),this.state.childDailyCard=r[0]??null,this._emit()},i=>console.warn("[Portal] dailyCards error:",i.code,i.message))),this._unsubChildPebble=T(I(u,...t,"pebbleMessages"),i=>{this.state.childPebbleMessages=i.docs.map(r=>({id:r.id,...r.data()})).filter(r=>!(r.isPrivate===!0&&r.senderUid!==this._uid)).sort((r,a)=>{var o,n,l,d;return(((n=(o=r.timestamp)==null?void 0:o.toMillis)==null?void 0:n.call(o))??0)-(((d=(l=a.timestamp)==null?void 0:l.toMillis)==null?void 0:d.call(l))??0)}),this._emit()},i=>console.warn("[Portal] pebbleMessages error:",i.code,i.message)),this._unsubChildSessions=T(I(u,...t,"pebbleSessions"),i=>{this.state.childPebbleSessions=i.docs.map(r=>({id:r.id,...r.data()})).filter(r=>r.archived!==!0).filter(r=>!(r.isPrivate===!0&&r.createdBy!==this._uid)).sort((r,a)=>{var o,n,l,d,g,c,h,b;return(((n=(o=a.lastMessageAt)==null?void 0:o.toMillis)==null?void 0:n.call(o))??((d=(l=a.createdAt)==null?void 0:l.toMillis)==null?void 0:d.call(l))??0)-(((c=(g=r.lastMessageAt)==null?void 0:g.toMillis)==null?void 0:c.call(g))??((b=(h=r.createdAt)==null?void 0:h.toMillis)==null?void 0:b.call(h))??0)}),this._emit()},i=>console.warn("[Portal] pebbleSessions error:",i.code,i.message))}_resolveChildPhotos(e,t){if(R){this._photoTried||(this._photoTried=new Set);for(const i of t){const r=i.profilePhotoURL;if(typeof r=="string"&&/^https?:\/\//i.test(r))continue;const a=e+"/"+i.id;this._photoTried.has(a)||(this._photoTried.add(a),Z(V(R,"families/"+e+"/avatars/children/"+i.id)).then(o=>{const n=this.state.ppChildren||[],l=n.findIndex(d=>d.id===i.id);l>=0&&(n[l]={...n[l],profilePhotoURL:o},this.state.ppChildren=[...n],this._emit())}).catch(()=>{this._photoTried.delete(a)}))}}}selectChild(e){!e||e===this._selectedChildId||this.state.ppChildren.some(t=>t.id===e)&&(this._subscribeChild(e),this._emit())}async askPebbleAboutChild(e,t,i=[],r=!1,a=""){if(!L)throw new Error("Firebase functions not configured.");if(!this._ppFamilyId)throw new Error("No PebblePath family.");if(!e)throw new Error("No child selected.");return(await X(L,"askPebbleAboutChild")({familyId:this._ppFamilyId,childId:e,question:t,history:i,isPrivate:r===!0,sessionId:a||""})).data}_childPebbleBase(e){return["families",this._ppFamilyId,"children",e,"pebbleSessions"]}async createPebbleSession(e,{title:t,isPrivate:i}={}){if(!u||!this._ppFamilyId||!e)throw new Error("No child selected.");return(await U(I(u,...this._childPebbleBase(e)),{title:(t||"New chat").trim()||"New chat",isPrivate:i===!0,archived:!1,createdBy:this._uid??"",createdAt:k(),lastMessageAt:k()})).id}async renamePebbleSession(e,t,i){!u||!this._ppFamilyId||!e||!t||await M($(u,...this._childPebbleBase(e),t),{title:(i||"").trim()||"Untitled chat"})}async setPebbleSessionPrivacy(e,t,i){!u||!this._ppFamilyId||!e||!t||await M($(u,...this._childPebbleBase(e),t),{isPrivate:i===!0})}async archivePebbleSession(e,t){!u||!this._ppFamilyId||!e||!t||await M($(u,...this._childPebbleBase(e),t),{archived:!0})}async touchPebbleSession(e,t){if(!(!u||!this._ppFamilyId||!e||!t))try{await M($(u,...this._childPebbleBase(e),t),{lastMessageAt:k()})}catch{}}_teardownChild(){var e,t,i,r,a;(e=this._unsubChildMs)==null||e.call(this),(t=this._unsubChildIns)==null||t.call(this),(i=this._unsubChildDaily)==null||i.call(this),(r=this._unsubChildPebble)==null||r.call(this),(a=this._unsubChildSessions)==null||a.call(this),this._unsubChildMs=this._unsubChildIns=this._unsubChildDaily=this._unsubChildPebble=this._unsubChildSessions=null}_teardownPpFamily(){var e,t,i;this._teardownChild(),(e=this._unsubPpFamily)==null||e.call(this),(t=this._unsubPpChildren)==null||t.call(this),(i=this._unsubIncomingReq)==null||i.call(this),this._unsubPpFamily=null,this._unsubPpChildren=null,this._unsubIncomingReq=null,this._selectedChildId=null,this.state.ppFamily=null,this.state.ppIsMember=!1,this.state.ppIsChildViewer=!1,this.state.incomingChildRequests=[],this.state.ppChildren=[],this.state.selectedChildId=null,this.state.childMilestones=[],this.state.childInsights=[],this.state.childDailyCard=null,this.state.childPebbleMessages=[],this.state.childPebbleSessions=[]}async requestChildAccess(){var t;const e=this._currentFamilyId;if(!e)throw new Error("No family to request access from.");await j($(u,"families",e,"childAccessRequests",this._uid),{uid:this._uid,displayName:((t=this.state.user)==null?void 0:t.displayName)??"Family member",requestedAt:k(),status:"pending"})}async withdrawChildAccessRequest(){const e=this._currentFamilyId;e&&await J($(u,"families",e,"childAccessRequests",this._uid))}async approveChildAccess(e){var r;const t=this._ppFamilyId;if(!t||!this.state.ppIsMember)throw new Error("Only a parent can approve access.");const i=Array.isArray((r=this.state.ppFamily)==null?void 0:r.childViewers)?this.state.ppFamily.childViewers:[];i.includes(e)||await M($(u,"families",t),{childViewers:[...i,e],updatedAt:k()}),await M($(u,"families",t,"childAccessRequests",e),{status:"approved",actionedBy:this._uid,actionedAt:k()})}async declineChildAccess(e){const t=this._ppFamilyId;if(!t||!this.state.ppIsMember)throw new Error("Only a parent can decline access.");await M($(u,"families",t,"childAccessRequests",e),{status:"declined",actionedBy:this._uid,actionedAt:k()})}async revokeChildViewer(e){var a;const t=this._ppFamilyId;if(!t||!this.state.ppIsMember)throw new Error("Only a parent can revoke access.");const i=Array.isArray((a=this.state.ppFamily)==null?void 0:a.childViewers)?this.state.ppFamily.childViewers:[],r=i.filter(o=>o!==e);r.length!==i.length&&await M($(u,"families",t),{childViewers:r,updatedAt:k()});try{await M($(u,"families",t,"childAccessRequests",e),{status:"declined",actionedBy:this._uid,actionedAt:k()})}catch{}}_backfillVisibleTo(e,t){if(!u||!this._currentFamilyId)return;const i=this.state.family;if(i){this._vtBackfilled||(this._vtBackfilled=new Set);for(const r of t){const a=r.data();if(Array.isArray(a.visibleTo))continue;const o=`${e}/${r.id}`;this._vtBackfilled.has(o)||(this._vtBackfilled.add(o),M($(u,"families",this._currentFamilyId,e,r.id),{visibleTo:pe(a.visibility??"family",i,a.createdBy,Array.isArray(a.attendees)?a.attendees:[])}).catch(n=>{this._vtBackfilled.delete(o),console.warn(`[Cairn] visibleTo backfill failed (${o}):`,n==null?void 0:n.code,n==null?void 0:n.message)}))}}}async _visibleToFor(e,t,i){const r=(e==null?void 0:e.visibility)??"family",a=Array.isArray(e==null?void 0:e.attendees)?e.attendees:[],o=r==="extended"?await Lt(t):[];return pe(r,t,i,a,o)}async saveTrip(e){var d;if(!u||!this._currentFamilyId)throw new Error("No family yet.");const t=(d=w==null?void 0:w.currentUser)==null?void 0:d.uid;if(!t)throw new Error("Not signed in.");const{id:i,createdAt:r,updatedAt:a,...o}=e,n={...o,updatedAt:k()};return n.visibleTo=await this._visibleToFor(o,this.state.family,o.createdBy??t),i?(await M($(u,"families",this._currentFamilyId,"trips",i),n),i):(n.createdBy=t,n.createdAt=k(),(await U(I(u,"families",this._currentFamilyId,"trips"),n)).id)}async deleteTrip(e){if(!u||!this._currentFamilyId)throw new Error("No family yet.");await J($(u,"families",this._currentFamilyId,"trips",e))}planItemsListener(e,t){return!u||!this._currentFamilyId||!e?()=>{}:T(I(u,"families",this._currentFamilyId,"trips",e,"planItems"),i=>{const r=i.docs.map(a=>({id:a.id,...a.data()})).sort((a,o)=>{var d,g,c,h;const n=String(a.day??"").localeCompare(String(o.day??""));if(n!==0)return n;const l=String(a.time??"").localeCompare(String(o.time??""));return l!==0?l:(((g=(d=a.createdAt)==null?void 0:d.toMillis)==null?void 0:g.call(d))??0)-(((h=(c=o.createdAt)==null?void 0:c.toMillis)==null?void 0:h.call(c))??0)});t(r)},i=>{console.warn("[Portal] planItems subscription error:",i.code,i.message),t([])})}async addPlanItem(e,t){var n;if(!u||!this._currentFamilyId)throw new Error("No family yet.");const i=(n=w==null?void 0:w.currentUser)==null?void 0:n.uid;if(!i)throw new Error("Not signed in.");const r=String((t==null?void 0:t.title)??"").trim();if(!r)throw new Error("Add a title.");const a=String((t==null?void 0:t.url)??"").trim();return(await U(I(u,"families",this._currentFamilyId,"trips",e,"planItems"),{title:r,type:(t==null?void 0:t.type)??"note",day:(t==null?void 0:t.day)??"",time:(t==null?void 0:t.time)??"",durationMins:Number.isFinite(t==null?void 0:t.durationMins)?t.durationMins:60,.../^https?:\/\//i.test(a)?{url:a}:{},addedBy:i,createdAt:k()})).id}async updatePlanItem(e,t,i){if(!u||!this._currentFamilyId)throw new Error("No family yet.");await M($(u,"families",this._currentFamilyId,"trips",e,"planItems",t),i)}async uploadPlanAttachment(e,t,i){if(!R||!this._currentFamilyId)throw new Error("Storage unavailable.");const r=`families/${this._currentFamilyId}/planAttachments/${e}__${t}`,a=V(R,r);return await Q(a,i,{contentType:i.type||"application/octet-stream"}),Z(a)}async deletePlanItem(e,t){if(!u||!this._currentFamilyId)throw new Error("No family yet.");await J($(u,"families",this._currentFamilyId,"trips",e,"planItems",t))}async saveEvent(e){var d;if(!u||!this._currentFamilyId)throw new Error("No family yet.");const t=(d=w==null?void 0:w.currentUser)==null?void 0:d.uid;if(!t)throw new Error("Not signed in.");const{id:i,createdAt:r,updatedAt:a,...o}=e,n={...o,updatedAt:k()};return n.visibleTo=await this._visibleToFor(o,this.state.family,o.createdBy??t),i?(await M($(u,"families",this._currentFamilyId,"familyEvents",i),n),i):(n.createdBy=t,n.createdAt=k(),(await U(I(u,"families",this._currentFamilyId,"familyEvents"),n)).id)}async deleteEvent(e){if(!u||!this._currentFamilyId)throw new Error("No family yet.");await J($(u,"families",this._currentFamilyId,"familyEvents",e))}async uploadSchoolCalendar(e){if(!R||!this._currentFamilyId)throw new Error("Storage unavailable.");const t=e.type||"",i=/pdf/.test(t)?"pdf":/^image\//.test(t)?"image":/word|officedocument|msword/.test(t)?"docx":"pdf",r=`families/${this._currentFamilyId}/schoolCalendarUploads/${Date.now()}`;return await Q(V(R,r),e,{contentType:t||"application/octet-stream"}),{storagePath:r,fileType:i}}async extractSchoolCalendarEvents(e,t){var o;if(!L||!this._currentFamilyId)throw new Error("No family yet.");const r=await X(L,"extractSchoolCalendar")({familyId:this._currentFamilyId,storagePath:e,fileType:t}),a=(o=r==null?void 0:r.data)==null?void 0:o.events;return Array.isArray(a)?a:[]}async importSchoolEvents(e){var c;if(!u||!this._currentFamilyId)throw new Error("No family yet.");const t=(c=w==null?void 0:w.currentUser)==null?void 0:c.uid;if(!t)throw new Error("Not signed in.");const i=this.state.family??{},r=Array.isArray(i.memberIds)?i.memberIds:[],a=Array.isArray(i.cairnMemberIds)?i.cairnMemberIds:[],o=[...new Set([...r,...a,t])],n=pe("extended",i,t),l=I(u,"families",this._currentFamilyId,"familyEvents"),d=(e??[]).filter(h=>h&&/^\d{4}-\d{2}-\d{2}$/.test(String(h.date??""))&&String(h.title??"").trim()).slice(0,250);let g=0;return await Promise.all(d.map(async h=>{await U(l,{title:String(h.title).trim().slice(0,120),date:h.date,type:h.type||"other",source:"school-import",personIds:o,visibility:"extended",visibleTo:n,createdBy:t,createdAt:k(),updatedAt:k()}),g+=1})),g}async previewUrl(e){if(!e||typeof e!="string"||!/^https?:\/\//i.test(e.trim()))return null;if(!L)throw new Error("Firebase functions not configured.");return(await X(L,"previewUrl")({url:e.trim()})).data}async lookupFlight(e,t){if(!e||typeof e!="string")return null;if(!L)throw new Error("Firebase functions not configured.");return(await X(L,"lookupFlight")({flightNumber:e.trim(),date:typeof t=="string"?t.trim():""})).data}async askPebble(e,t=[]){if(!L)throw new Error("Firebase functions not configured.");if(!this._currentFamilyId)throw new Error("No family yet.");return(await X(L,"askPebbleAboutActivities")({question:e,familyId:this._currentFamilyId,history:t})).data}async updateChildBirthday(e,t){if(!u||!this._currentFamilyId)throw new Error("No family yet.");await M($(u,"families",this._currentFamilyId,"children",e),{dateOfBirth:t,updatedAt:k()})}async findFamilyByCairnCode(e){if(!u)throw new Error("Firebase not configured.");const t=G(I(u,"families"),Y("cairnInviteCode","==",e)),i=await H(t);if(i.empty)return null;const r=i.docs[0];return{id:r.id,...r.data()}}async findFamilyByConnectCode(e){if(!u)throw new Error("Firebase not configured.");const t=await H(G(I(u,"families"),Y("cairnInviteCode","==",e)));if(!t.empty){const r=t.docs[0];return{id:r.id,...r.data(),_matchedCodeKind:"cairn"}}const i=await H(G(I(u,"families"),Y("inviteCode","==",e)));if(!i.empty){const r=i.docs[0];return{id:r.id,...r.data(),_matchedCodeKind:"pp"}}return null}async _applyCairnJoin(e){var d;const t=(d=w==null?void 0:w.currentUser)==null?void 0:d.uid;if(!t)throw new Error("Not signed in.");const i=e.cairnMemberIds??[],r=e.memberIds??[],a=w.currentUser;if(i.includes(t)||r.includes(t))return await j($(u,"users",t),{email:a.email??"",displayName:a.displayName??"",profilePhotoURL:a.photoURL??null,cairnFamilyId:e.id,updatedAt:k()},{merge:!0}),await this._recordMutualConnection(e.id,t),e.id;const o=e.cairnMaxMembers??20;if(i.length>=o){const g=new Error("This family's Cairn ring is full.");throw g.code="full",g}const n=new Date,l={displayName:a.displayName??"",profilePhotoURL:a.photoURL??null,role:"member",joinedAt:n,updatedAt:n};return await M($(u,"families",e.id),{cairnMemberIds:[...i,t],[`memberProfiles.${t}`]:l,updatedAt:k()}),await j($(u,"users",t),{email:a.email??"",displayName:a.displayName??"",profilePhotoURL:a.photoURL??null,cairnFamilyId:e.id,role:"member",notificationPreferences:{milestoneReminders:!0,tipNotifications:!0,schoolDeadlines:!0},createdAt:k(),updatedAt:k()},{merge:!0}),await this._recordMutualConnection(e.id,t),e.id}async redeemConnectCode(e){var o,n;if(!u)throw new Error("Firebase not configured.");if(!((o=w==null?void 0:w.currentUser)==null?void 0:o.uid))throw new Error("Not signed in.");const i=await this.findFamilyByConnectCode(e);if(!i){const l=new Error("Invite code not found.");throw l.code="not-found",l}const r=i._matchedCodeKind==="pp"?i.inviteCodeExpiresAt:i.cairnInviteCodeExpiresAt,a=((n=r==null?void 0:r.toDate)==null?void 0:n.call(r))??(r?new Date(r):null);if(!a||a<new Date){const l=new Error("This invite code has expired.");throw l.code="expired",l}return this._applyCairnJoin(i)}async _recordMutualConnection(e,t){var i;try{const{getDoc:r,arrayUnion:a}=await K(async()=>{const{getDoc:l,arrayUnion:d}=await import("./firebase-core-DEm61vaB.js").then(g=>g.J);return{getDoc:l,arrayUnion:d}},[]),o=await r($(u,"users",t)),n=o.exists()?(i=o.data())==null?void 0:i.familyId:null;if(!n||n===e)return;await M($(u,"families",e),{connectedFamilyIds:a(n),updatedAt:k()}),await M($(u,"families",n),{connectedFamilyIds:a(e),updatedAt:k()})}catch(r){console.warn("[connect] mutual connection record skipped (non-fatal):",r)}}async saveSubGroup({id:e,name:t,memberIds:i}){if(!u||!this._currentFamilyId)throw new Error("No family yet.");const r=e??`g_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,6)}`;return await M($(u,"families",this._currentFamilyId),{[`subGroups.${r}`]:{name:t.trim(),memberIds:Array.isArray(i)?[...i]:[],updatedAt:k()},updatedAt:k()}),r}async deleteSubGroup(e){if(!u||!this._currentFamilyId)throw new Error("No family yet.");const{deleteField:t}=await K(async()=>{const{deleteField:i}=await import("./firebase-core-DEm61vaB.js").then(r=>r.J);return{deleteField:i}},[]);await M($(u,"families",this._currentFamilyId),{[`subGroups.${e}`]:t(),updatedAt:k()})}async setCairnMemberSubGroup(e,t){var a;if(!u||!this._currentFamilyId)throw new Error("No family yet.");if(!e)throw new Error("uid is required.");const i=((a=this.state.family)==null?void 0:a.subGroups)??{},r={};for(const[o,n]of Object.entries(i)){const l=Array.isArray(n.memberIds)?n.memberIds:[];o===t?l.includes(e)||(r[`subGroups.${o}.memberIds`]=[...l,e]):l.includes(e)&&(r[`subGroups.${o}.memberIds`]=l.filter(d=>d!==e))}Object.keys(r).length!==0&&(r.updatedAt=k(),await M($(u,"families",this._currentFamilyId),r))}async removeCairnMember(e){if(!u||!this._currentFamilyId)throw new Error("No family yet.");if(!e)throw new Error("uid is required.");const t=this.state.family??{};if((Array.isArray(t.memberIds)?t.memberIds:[]).includes(e))throw new Error("PP members can’t be removed from the ring here.");const{deleteField:r}=await K(async()=>{const{deleteField:d}=await import("./firebase-core-DEm61vaB.js").then(g=>g.J);return{deleteField:d}},[]),a={updatedAt:k()},o=Array.isArray(t.cairnMemberIds)?t.cairnMemberIds:[];o.includes(e)&&(a.cairnMemberIds=o.filter(d=>d!==e)),t.memberProfiles&&t.memberProfiles[e]&&(a[`memberProfiles.${e}`]=r());const n=Array.isArray(t.childViewers)?t.childViewers:[];n.includes(e)&&(a.childViewers=n.filter(d=>d!==e));const l=t.subGroups??{};for(const[d,g]of Object.entries(l)){const c=Array.isArray(g.memberIds)?g.memberIds:[];c.includes(e)&&(a[`subGroups.${d}.memberIds`]=c.filter(h=>h!==e))}await M($(u,"families",this._currentFamilyId),a);try{await J($(u,"families",this._currentFamilyId,"childAccessRequests",e))}catch{}}async createCairnOnlyFamily(e){if(!u)throw new Error("Firebase not configured.");const t=w==null?void 0:w.currentUser,i=t==null?void 0:t.uid;if(!i)throw new Error("Not signed in.");const r=(e??"").trim();if(!r)throw new Error("Family name is required.");const a=new Date,o=he(),n=new Date(Date.now()+720*60*60*1e3),l={displayName:t.displayName??"",profilePhotoURL:t.photoURL??null,role:"admin",joinedAt:a,updatedAt:a},d={name:r,createdBy:i,createdInApp:"cairn",memberIds:[],cairnMemberIds:[i],connectedFamilyIds:[],cairnMaxMembers:20,cairnInviteCode:o,cairnInviteCodeExpiresAt:n,memberProfiles:{[i]:l},createdAt:k(),updatedAt:k()},g=await U(I(u,"families"),d);return await j($(u,"users",i),{email:t.email??"",displayName:t.displayName??"",profilePhotoURL:t.photoURL??null,cairnFamilyId:g.id,role:"admin",notificationPreferences:{milestoneReminders:!1,tipNotifications:!1,schoolDeadlines:!1},createdAt:k(),updatedAt:k()},{merge:!0}),g.id}async createPebblePathFamily(e){if(!u)throw new Error("Firebase not configured.");const t=w==null?void 0:w.currentUser,i=t==null?void 0:t.uid;if(!i)throw new Error("Not signed in.");const r=(e??"").trim();if(!r)throw new Error("Family name is required.");const a=new Date,o=he(),n=new Date(Date.now()+720*60*60*1e3),l={displayName:t.displayName??"",profilePhotoURL:t.photoURL??null,role:"admin",joinedAt:a,updatedAt:a},d={name:r,createdBy:i,memberIds:[i],cairnMemberIds:[i],connectedFamilyIds:[],cairnMaxMembers:20,inviteCode:o,inviteCodeExpiresAt:n,cairnInviteCode:o,cairnInviteCodeExpiresAt:n,memberProfiles:{[i]:l},createdAt:k(),updatedAt:k()},g=await U(I(u,"families"),d);return await j($(u,"users",i),{email:t.email??"",displayName:t.displayName??"",profilePhotoURL:t.photoURL??null,familyId:g.id,role:"owner",notificationPreferences:{milestoneReminders:!1,tipNotifications:!1,schoolDeadlines:!1},createdAt:k(),updatedAt:k()},{merge:!0}),g.id}async createChild(e,t){var c,h;if(!u)throw new Error("Firebase not configured.");const i=(c=w==null?void 0:w.currentUser)==null?void 0:c.uid;if(!i)throw new Error("Not signed in.");if(!e)throw new Error("No family.");const r=((t==null?void 0:t.name)??"").trim();if(!r)throw new Error("Child's name is required.");if(!((t==null?void 0:t.dateOfBirth)instanceof Date))throw new Error("Child's date of birth is required.");const{getDoc:a}=await K(async()=>{const{getDoc:b}=await import("./firebase-core-DEm61vaB.js").then(f=>f.J);return{getDoc:b}},[]),o=await a($(u,"families",e)),n=o.exists()?Array.isArray((h=o.data())==null?void 0:h.memberIds)?o.data().memberIds:[]:[],l=n.length?n:[i],d={name:r,dateOfBirth:t.dateOfBirth,profilePhotoURL:null,developmentalFlags:Array.isArray(t==null?void 0:t.developmentalFlags)?t.developmentalFlags:[],pediatricianNotes:null,region:(t==null?void 0:t.region)??null,parentIds:l,needsServerSeed:!0,createdAt:k(),updatedAt:k()};return(await U(I(u,"families",e,"children"),d)).id}async uploadChildAvatar(e,t,i){if(!u||!R)throw new Error("Firebase not configured.");if(!e||!t)throw new Error("Missing family/child id.");if(!i)throw new Error("No image.");const r=i.type&&i.type.startsWith("image/")?i.type:"image/jpeg",a=V(R,`families/${e}/avatars/children/${t}`);await Q(a,i,{contentType:r});const o=await Z(a);return await M($(u,"families",e,"children",t),{profilePhotoURL:o,updatedAt:k()}),o}async uploadUserAvatar(e,t){var n;if(!u||!R)throw new Error("Firebase not configured.");const i=(n=w==null?void 0:w.currentUser)==null?void 0:n.uid;if(!i)throw new Error("Not signed in.");if(!e)throw new Error("No family.");if(!t)throw new Error("No image.");const r=t.type&&t.type.startsWith("image/")?t.type:"image/jpeg",a=V(R,`families/${e}/avatars/users/${i}`);await Q(a,t,{contentType:r});const o=await Z(a);await M($(u,"users",i),{profilePhotoURL:o,updatedAt:k()});try{await M($(u,"families",e),{[`memberProfiles.${i}.profilePhotoURL`]:o,[`memberProfiles.${i}.updatedAt`]:k(),updatedAt:k()})}catch(l){console.warn("memberProfiles photo fan-out failed:",l)}return o}async requestToBeCoParent(e){var a,o,n,l,d;if(!u)throw new Error("Firebase not configured.");const t=(a=w==null?void 0:w.currentUser)==null?void 0:a.uid;if(!t)throw new Error("Not signed in.");const i=this._currentFamilyId??((o=this.state.user)==null?void 0:o.cairnFamilyId)??((n=this.state.user)==null?void 0:n.familyId)??null;if(!i)throw new Error("No family.");if(!e)throw new Error("No child.");const r=((l=this.state.user)==null?void 0:l.displayName)??((d=w==null?void 0:w.currentUser)==null?void 0:d.displayName)??"";await j($(u,"families",i,"children",e,"coParentRequests",t),{uid:t,displayName:r,status:"pending",requestedAt:k()})}async fetchFamilyChildren(e){if(!u||!e)return[];try{return(await H(I(u,"families",e,"children"))).docs.map(i=>({id:i.id,...i.data()}))}catch(t){return console.warn("[parent-prompt] fetchFamilyChildren skipped (non-fatal):",t),[]}}async regenerateCairnInviteCode(){if(!u||!this._currentFamilyId)throw new Error("No family yet.");const e=he(),t=new Date(Date.now()+720*60*60*1e3);return await M($(u,"families",this._currentFamilyId),{cairnInviteCode:e,cairnInviteCodeExpiresAt:t,updatedAt:k()}),{code:e,expiresAt:t}}stop(){var e,t,i,r,a;(e=this._unsubUser)==null||e.call(this),(t=this._unsubFamily)==null||t.call(this),(i=this._unsubChildren)==null||i.call(this),(r=this._unsubTrips)==null||r.call(this),(a=this._unsubEvents)==null||a.call(this),this._unsubUser=this._unsubFamily=this._unsubChildren=this._unsubTrips=this._unsubEvents=null,this._teardownPpFamily(),this._uid=null,this._currentFamilyId=null,this._holidayKey=null,this._ppFamilyId=null,this.userDocResolved=!1,this.state={user:null,family:null,children:[],trips:[],events:[],holidays:[],ppFamily:null,ppIsMember:!1,ppChildren:[],selectedChildId:null,childMilestones:[],childInsights:[],childDailyCard:null,childPebbleMessages:[],childPebbleSessions:[]}}_emit(){this.dispatchEvent(new Event("change"))}}const m=new Rt;function pt(p,e){const t=e==null?void 0:e.profilePhotoURL;return typeof t=="string"&&/^https?:\/\//i.test(t)?t:p!=null&&p.photoURL?p.photoURL:null}function Bt(p,e){if(!e)return[];const t=e.cairnMemberIds??e.memberIds??[],i=e.memberIds??[],r=e.memberProfiles??{},a=[];let o=280;for(const n of t){if(i.includes(n)||n===p)continue;const l=r[n],d=l==null?void 0:l.profilePhotoURL;a.push({uid:n,displayName:(l==null?void 0:l.displayName)??"Family",photoURL:typeof d=="string"&&/^https?:\/\//i.test(d)?d:null,role:"extended",circles:["extended"],hue:o}),o=(o+47)%360}return a}async function Ot(p,e){var n,l;const t=Array.isArray(e==null?void 0:e.connectedFamilyIds)?e.connectedFamilyIds:[];if(t.length===0||!u)return[];const{getDoc:i}=await K(async()=>{const{getDoc:d}=await import("./firebase-core-DEm61vaB.js").then(g=>g.J);return{getDoc:d}},[]),r=[],a=new Set(p?[p]:[]);let o=150;for(const d of t)try{const g=await i($(u,"families",d));if(!g.exists())continue;const c=g.data()??{},h=c.memberProfiles??{},b=c.name??"Connection";for(const f of c.memberIds??[]){if(a.has(f))continue;a.add(f);const v=(n=h[f])==null?void 0:n.profilePhotoURL;r.push({uid:f,displayName:((l=h[f])==null?void 0:l.displayName)??"Connection",photoURL:typeof v=="string"&&/^https?:\/\//i.test(v)?v:null,role:"connection",circles:["connection"],familyName:b,hue:o}),o=(o+53)%360}}catch{}return r}function pe(p,e,t,i=[],r=[]){const a=(e==null?void 0:e.memberIds)??[],o=(e==null?void 0:e.cairnMemberIds)??[],n=t?[t]:[],l=Array.isArray(i)?i:[],d=Array.isArray(r)?r:[];return p==="personal"?[...new Set(n)]:p==="extended"?[...new Set([...a,...o,...n,...l,...d])]:[...new Set([...a,...n,...l])]}async function Lt(p){var r;const e=Array.isArray(p==null?void 0:p.connectedFamilyIds)?p.connectedFamilyIds:[];if(e.length===0||!u)return[];const{getDoc:t}=await K(async()=>{const{getDoc:a}=await import("./firebase-core-DEm61vaB.js").then(o=>o.J);return{getDoc:a}},[]),i=new Set;for(const a of e)try{const o=await t($(u,"families",a));if(!o.exists())continue;for(const n of((r=o.data())==null?void 0:r.memberIds)??[])i.add(n)}catch{}return[...i]}function he(){const p="ABCDEFGHJKMNPQRSTUVWXYZ23456789";let e="";for(let t=0;t<6;t++)e+=p[Math.floor(Math.random()*p.length)];return e}function jt(p,e,t,i,r){const a=[],o=new Set((i==null?void 0:i.memberIds)??[]),n=o.has(p);a.push({uid:p,displayName:(e==null?void 0:e.displayName)??(t==null?void 0:t.displayName)??"You",photoURL:pt(e,t),role:n?"self":"self-extended",circles:["immediate"],hue:198});const l=(i==null?void 0:i.memberProfiles)??{};for(const[g,c]of Object.entries(l)){if(g===p||!o.has(g))continue;const h=c.profilePhotoURL;a.push({uid:g,displayName:c.displayName??"Co-parent",photoURL:typeof h=="string"&&/^https?:\/\//i.test(h)?h:null,role:"co-parent",circles:["immediate"],hue:8})}let d=142;for(const g of r??[]){const c=g.profilePhotoURL;a.push({uid:`child:${g.id}`,displayName:g.name,photoURL:typeof c=="string"&&/^https?:\/\//i.test(c)?c:null,role:"child",circles:["immediate"],hue:d,dateOfBirth:g.dateOfBirth}),d=(d+58)%360}return a}function Ut(p){const e=[];for(const t of p??[]){if(!t.dateOfBirth)continue;const i=t.dateOfBirth,r=i.getUTCFullYear(),a=String(i.getUTCMonth()+1).padStart(2,"0"),o=String(i.getUTCDate()).padStart(2,"0");e.push({id:`bday:${t.id}`,type:"birthday",date:`${r}-${a}-${o}`,personIds:[`child:${t.id}`],title:`${t.name}'s birthday`,_childId:t.id,_childName:t.name,recurring:!0})}return e}function Gt(p,e=new Date){if(!(p!=null&&p.date))return{date:null,yearsElapsed:0};const t=P(p.date);if(!t||Number.isNaN(t.getTime()))return{date:null,yearsElapsed:0};if(!p.recurring)return{date:t,yearsElapsed:0};const i=new Date(e.getFullYear(),t.getMonth(),t.getDate()),r=i<new Date(e.getFullYear(),e.getMonth(),e.getDate())?new Date(e.getFullYear()+1,t.getMonth(),t.getDate()):i,a=r.getFullYear()-t.getFullYear();return{date:r,yearsElapsed:a}}const Ke=["linear-gradient(135deg, #6b9ac4 0%, #c98a8a 60%, #d4a843 100%)","linear-gradient(135deg, #7a9e7e 0%, #4a6754 70%, #2c4439 100%)","linear-gradient(135deg, #c67b5c 0%, #d4a843 50%, #c98a8a 100%)","linear-gradient(135deg, #3d9b8f 0%, #1f5c54 100%)","linear-gradient(135deg, #d4a843 0%, #c67b5c 55%, #c98a8a 100%)","linear-gradient(135deg, #8b7bb5 0%, #c98a8a 60%, #d4a843 100%)","linear-gradient(135deg, #6b9ac4 0%, #3d9b8f 100%)"];function P(p){if(!p)return null;if(p instanceof Date)return p;const e=String(p).match(/^(\d{4})-(\d{2})-(\d{2})/);return e?new Date(Number(e[1]),Number(e[2])-1,Number(e[3])):new Date(p)}function Yt(p){if(!p)return null;const e=p.getFullYear(),t=String(p.getMonth()+1).padStart(2,"0"),i=String(p.getDate()).padStart(2,"0");return`${e}-${t}-${i}`}async function qt(p,e=90,t=100){const i=new Date,r=new Date(i.getTime()+e*24*60*60*1e3),a=new URL("https://www.googleapis.com/calendar/v3/calendars/primary/events");a.searchParams.set("timeMin",i.toISOString()),a.searchParams.set("timeMax",r.toISOString()),a.searchParams.set("maxResults",String(t)),a.searchParams.set("singleEvents","true"),a.searchParams.set("orderBy","startTime");const o=await fetch(a.toString(),{headers:{Authorization:`Bearer ${p}`}});if(!o.ok){const l=await o.text();throw o.status===401?new Error("Your Google session expired — connect your calendar again."):o.status===403&&/accessNotConfigured|SERVICE_DISABLED|PERMISSION_DENIED|insufficient/i.test(l)?new Error("Google Calendar access isn’t configured for this project yet. (Admin: enable the Google Calendar API and add the calendar.readonly scope to the OAuth consent screen in Google Cloud Console.)"):new Error(`Google Calendar: ${o.status} ${l.slice(0,160)}`)}return((await o.json()).items??[]).filter(l=>{var d,g;return l.status!=="cancelled"&&(((d=l.start)==null?void 0:d.date)||((g=l.start)==null?void 0:g.dateTime))})}function Ht(p,e){var r,a,o,n,l,d,g,c;const t=((r=p.start)==null?void 0:r.date)??((o=(a=p.start)==null?void 0:a.dateTime)==null?void 0:o.slice(0,10))??"";let i=((n=p.end)==null?void 0:n.date)??((d=(l=p.end)==null?void 0:l.dateTime)==null?void 0:d.slice(0,10))??t;if((g=p.start)!=null&&g.date&&((c=p.end)!=null&&c.date)){const h=new Date(i);h.setDate(h.getDate()-1),i=h.toISOString().slice(0,10)}return{title:p.summary||"(untitled)",location:p.location??"",start:t,end:i,attendees:e?[e]:[],viewers:[],visibility:"family",notes:(p.description??"").slice(0,1e3),gcalEventId:p.id,gcalEventLink:p.htmlLink??null}}function Vt(p){if(p!=null&&p.coverGradient)return p.coverGradient;const e=((p==null?void 0:p.title)??(p==null?void 0:p.id)??"")+((p==null?void 0:p.location)??"");let t=0;for(let i=0;i<e.length;i++)t=t*31+e.charCodeAt(i)>>>0;return Ke[t%Ke.length]}class _e extends A{constructor(){super(),this.year=new Date().getFullYear(),this.tripDays=new Map,this.trips=[],this.events=[],this.holidays=[],this.today=new Date,this._activeDay=null}_isLeap(e){return e%4===0&&e%100!==0||e%400===0}_daysInMonth(e,t){return[31,this._isLeap(e)?29:28,31,30,31,30,31,31,30,31,30,31][t]}_labelsForMonth(e){var a;const t=this.year,i=new Map,r=(o,n)=>{const l=i.get(o);i.set(o,l?`${l} · ${n}`:n)};for(const o of this.trips??[]){if(!o.start||!o.end)continue;const n=P(o.start),l=P(o.end);if(!n||!l||n.getFullYear()>t||l.getFullYear()<t)continue;const d=new Date(t,e,1),g=new Date(t,e+1,0);if(l<d||n>g)continue;const c=n.getMonth()===e&&n.getFullYear()===t?n.getDate():1,h=l.getMonth()===e&&l.getFullYear()===t?l.getDate():g.getDate(),b=(a=o.location)!=null&&a.trim()?`${o.title} (${o.location.trim()})`:o.title;for(let f=c;f<=h;f++)r(f,b)}for(const o of this.events??[]){const n=P(o.date);n&&n.getFullYear()===t&&n.getMonth()===e&&r(n.getDate(),o.title??"Event")}for(const o of this.holidays??[]){const n=P(o.date);n&&n.getFullYear()===t&&n.getMonth()===e&&r(n.getDate(),o.title??"Public holiday")}return i}_renderMonth(e){var d,g;const t=this.year,r=(new Date(t,e,1).getDay()+6)%7,a=this._daysInMonth(t,e),o=this._labelsForMonth(e),n=[];for(let c=0;c<r;c++)n.push(s`<div class="cell empty"></div>`);const l=this.today;for(let c=1;c<=a;c++){const h=`${String(e+1).padStart(2,"0")}-${String(c).padStart(2,"0")}`,b=this.tripDays.get(h)??0,f=l.getFullYear()===t&&l.getMonth()===e&&l.getDate()===c,v=o.get(c),C=(this.events??[]).some(B=>{const F=P(B.date);return F&&F.getFullYear()===t&&F.getMonth()===e&&F.getDate()===c}),x=(this.holidays??[]).some(B=>{const F=P(B.date);return F&&F.getFullYear()===t&&F.getMonth()===e&&F.getDate()===c}),S=((d=this._activeDay)==null?void 0:d.month)===e&&((g=this._activeDay)==null?void 0:g.day)===c,E=["cell",f?"today":"",x?"holiday":"",b>0?"trip":"",b>.6?"dense":"",C?"event":"",v?"labelled":"",S?"active":""].filter(Boolean).join(" ");n.push(s`<div
        class=${E}
        title=${v?`${c} ${this._monthName(e)} — ${v}`:""}
        @click=${B=>v&&this._onDayTap(B,e,c,v)}
      ></div>`)}return n}_onDayTap(e,t,i,r){var a,o;if(e.stopPropagation(),((a=this._activeDay)==null?void 0:a.month)===t&&((o=this._activeDay)==null?void 0:o.day)===i){this._activeDay=null;return}this._activeDay={month:t,day:i,label:r}}_monthName(e){return new Date(this.year,e,1).toLocaleString("en-GB",{month:"short"})}_onSelect(e){this.dispatchEvent(new CustomEvent("month-select",{detail:{month:e,year:this.year},bubbles:!0,composed:!0}))}render(){const e=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],t=this.today.getMonth(),i=this.today.getFullYear()===this.year;return s`
      <div class="grid">
        ${e.map((r,a)=>s`
            <div
      ...
      ${this._activeDay?s`
          ...
          `:""}
    `}}_(_e,"properties",{year:{type:Number},tripDays:{type:Object},trips:{type:Array},events:{type:Array},holidays:{type:Array},today:{type:Object},_activeDay:{state:!0}}),_(_e,"styles",z`
    :host {
      display: block;
    }
  ...
  `);customElements.define("yearly-view",_e);class ke extends A{constructor(){super(),this.name="",this.hue=200,this.photo="",this.size=36,this.showName=!1}_initials(){return this.name.split(/\s+/).map(e=>e[0]).filter(Boolean).slice(0,2).join("").toUpperCase()}render(){const e=`linear-gradient(135deg, hsl(${this.hue}, 55%, 62%) 0%, hsl(${(this.hue+40)%360}, 50%, 42%) 100%)`,t=`width:${this.size}px;height:${this.size}px;background:${e};font-size:${this.size*.38}px;`;return s`
    ...
    `}}_(ke,"properties",{name:{type:String},hue:{type:Number},photo:{type:String},size:{type:Number},showName:{type:Boolean,attribute:"show-name"}}),_(ke,"styles",z`
    :host {
      display: inline-flex;
      align-items: center;
      gap: 8px;
  ...
  `);customElements.define("member-chip",ke);class $e extends A{constructor(){super(),this.start="",this.end="",this._displayMonth=null,this._hoverDate=null}willUpdate(e){if(e.has("start")||this._displayMonth===null){const t=this.start?P(this.start):new Date;this._displayMonth=new Date(t.getFullYear(),t.getMonth(),1)}}_isoFor(e,t,i){return`${e}-${String(t+1).padStart(2,"0")}-${String(i).padStart(2,"0")}`}_emit(e,t){this.start=e,this.end=t,this._hoverDate=null,this.dispatchEvent(new CustomEvent("range-change",{detail:{start:e,end:t},bubbles:!0,composed:!0}))}_onDayClick(e){if(!this.start||this.start&&this.end){this._emit(e,"");return}e<this.start?this._emit(e,this.start):this._emit(this.start,e)}_onDayHover(e){this.start&&!this.end&&(this._hoverDate=e)}_onLeave(){this._hoverDate=null}_shiftMonth(e){const t=this._displayMonth;this._displayMonth=new Date(t.getFullYear(),t.getMonth()+e,1)}_isToday(e,t,i){const r=new Date;return r.getFullYear()===e&&r.getMonth()===t&&r.getDate()===i}_inSelectedRange(e){return!this.start||!this.end?!1:e>this.start&&e<this.end}_inHoverRange(e){if(!this.start||this.end||!this._hoverDate)return!1;const t=this._hoverDate<this.start?this._hoverDate:this.start,i=this._hoverDate<this.start?this.start:this._hoverDate;return e>t&&e<i}_summary(){if(!this.start&&!this.end)return"Pick a start date";const e=t=>{const i=P(t);return i?i.toLocaleString("en-GB",{day:"numeric",month:"short",year:"numeric"}):""};return this.start&&!this.end?`From ${e(this.start)} — pick an end date`:this.start===this.end?e(this.start):`${e(this.start)} – ${e(this.end)}`}_renderGrid(){const e=this._displayMonth.getFullYear(),t=this._displayMonth.getMonth(),r=(new Date(e,t,1).getDay()+6)%7,a=new Date(e,t+1,0).getDate(),o=[];for(let n=0;n<r;n++)o.push(s`<div class="empty"></div>`);for(let n=1;n<=a;n++){const l=this._isoFor(e,t,n),d=l===this.start,g=l===this.end&&l!==this.start,c=this._inSelectedRange(l),h=this._inHoverRange(l),b=this._isToday(e,t,n),f=["day",d?"start":"",g?"end":"",c?"in-range":"",h?"hover-range":"",b&&!d&&!g?"today":""].filter(Boolean).join(" ");o.push(s`
      ...
      `)}return o}render(){if(!this._displayMonth)return s``;const e=this._displayMonth.toLocaleString("en-GB",{month:"long",year:"numeric"});return s`
    ...
    `}}_($e,"properties",{start:{type:String},end:{type:String},_displayMonth:{state:!0},_hoverDate:{state:!0}}),_($e,"styles",z`
    * { box-sizing: border-box; }
    :host {
      display: block;
    }
            ...
            <div class="form-col">
              ...
              <div class="field">
                ...
                ${(this.extendedMembers??[]).length>0?s`
                    ...
                    `:""}
                ${(this.connectionMembers??[]).length>0?s`
                      <div class="att-group-label">Connections</div>
                      <div class="attendees">
                        ${this.connectionMembers.map(i=>s`
                            <div
                              class="att-chip ${e.attendees.includes(i.uid)?"on":""}"
                              @click=${()=>this._toggleAttendee(i.uid)}
                              title=${i.familyName??""}
  ...
  `);customElements.define("trip-form",Ce);class Se extends A{constructor(){super(),this.open=!1,this.event=null,this.members=[],this.familyId="",this.busy=!1,this._draft=this._blankDraft(),this._error=""}willUpdate(e){(e.has("event")||e.has("open"))&&(this.open&&(this._draft=this._draftFromEvent(this.event)),this._error="")}_blankDraft(){return{id:null,type:"birthday",title:"",date:new Date().toISOString().slice(0,10),personIds:[],recurring:!0,subtitle:"",notes:"",visibility:"family"}}_draftFromEvent(e){return e?{id:e.id??null,type:e.type??"birthday",title:e.title??"",date:e.date??new Date().toISOString().slice(0,10),personIds:Array.isArray(e.personIds)?[...e.personIds]:[],recurring:e.recurring??!0,subtitle:e.subtitle??"",notes:e.notes??"",visibility:e.visibility??"family"}:this._blankDraft()}_set(e,t){this._draft={...this._draft,[e]:t}}_toggleType(e){this._set("type",e)}_togglePerson(e){const t=this._draft.personIds.includes(e);this._set("personIds",t?this._draft.personIds.filter(i=>i!==e):[...this._draft.personIds,e])}_onSave(){const e=this._draft;if(!e.title.trim()){this._error="Give it a title.";return}if(!e.date){this._error="Pick a date.";return}if(!this.familyId){this._error="No family yet.";return}this._error="",this.dispatchEvent(new CustomEvent("save",{detail:{...e,title:e.title.trim(),subtitle:e.subtitle.trim(),notes:e.notes.trim()}}))}_onDelete(){this._draft.id&&confirm("Delete this event? This can't be undone.")&&this.dispatchEvent(new CustomEvent("remove",{detail:{id:this._draft.id}}))}_onCancel(){this.dispatchEvent(new Event("cancel"))}render(){if(!this.open)return s``;const e=this._draft,t=!!e.id;return s`
    ...
    `}_monthDay(e){if(!e)return"";const t=P(e);return!t||Number.isNaN(t.getTime())?"":t.toLocaleString("en-GB",{day:"numeric",month:"long"})}}_(Se,"properties",{open:{type:Boolean,reflect:!0},event:{type:Object},members:{type:Array},familyId:{type:String},busy:{type:Boolean},_draft:{state:!0},_error:{state:!0}}),_(Se,"styles",z`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
...
They'll lose access to shared trips, celebrations and any read-only child access. You can re-invite them anytime with the invite code.`)){this._removingUid=e.uid;try{await m.removeCairnMember(e.uid),y(`${t} removed.`)}catch(r){y(`Couldn't remove: ${r.code??r.message}`,{duration:5e3})}finally{this._removingUid=null}}}async _regenerate(){if(!this._busy){this._busy=!0;try{await m.regenerateCairnInviteCode(),y("New invite code generated.")}catch(e){console.error(e),y(`Couldn't generate code: ${e.code??e.message}`,{duration:5e3})}finally{this._busy=!1}}}_inviteLink(e){return`${window.location.origin}/portal/?join=${e}`}async _copyLink(){var t;const e=(t=this.family)==null?void 0:t.cairnInviteCode;if(e)try{await navigator.clipboard.writeText(this._inviteLink(e)),y("Invite link copied to clipboard.")}catch{y("Could not copy — try long-press the link instead.")}}async _share(){var i,r;const e=(i=this.family)==null?void 0:i.cairnInviteCode;if(!e)return;const t=this._inviteLink(e);if(navigator.share)try{await navigator.share({title:"Join my family on Cairn",text:`Join ${((r=this.family)==null?void 0:r.name)??"our family"} on Cairn — our shared family calendar.`,url:t})}catch{}else this._copyLink()}_expiryText(e){if(!e)return"";const t=e.toDate?e.toDate():new Date(e),r=Math.max(0,Math.round((t-new Date)/(1440*60*1e3)));return r===0?"Expires today":r===1?"Expires tomorrow":`Expires in ${r} days`}render(){var r,a,o,n;if(!this.open)return s``;const e=(r=this.family)==null?void 0:r.cairnInviteCode,t=(a=this.family)==null?void 0:a.cairnInviteCodeExpiresAt,i=t&&(t.toDate?t.toDate():new Date(t))<new Date;return s`
          ...
          ${this.extended.length===0?s`<div class="empty">
                ...
                They can see trips and celebrations but not PebblePath child data.
                  ...
                  <div class="member-row">
                    ...
                    ${this.canRemove?s`<button
                          class="remove-btn"
                          ?disabled=${this._removingUid===l.uid}
                          @click=${()=>this._removeMember(l)}
                        >
                          ${this._removingUid===l.uid?"Removing…":"Remove"}
                        </button>`:""}
                  </div>
                `)}

          ${this.extended.length>0||Object.keys(((o=this.family)==null?void 0:o.subGroups)??{}).length>0?s`
                <h3>Sub-groups</h3>
                ${Object.entries(((n=this.family)==null?void 0:n.subGroups)??{}).map(([l,d])=>s`
                    <div class="subgroup">
                      <div class="subgroup-head">
                        <div>
                          <span class="subgroup-name">${d.name}</span>
                          <span class="count">${(d.memberIds??[]).length} ${(d.memberIds??[]).length===1?"member":"members"}</span>
                        </div>
                        <div class="subgroup-actions">
                          ...
                          <button
                            ...
                            title="Delete"
                            @click=${()=>this._deleteSubGroup(l,d.name)}
                          >
                            ×
                          </button>
                        </div>
                      ...
                      ${this._editingGroupId===l?s`
                            <div style="margin-top:4px;">
                              ${this.extended.map(g=>s`
                                  <span
                                    class="chip-toggle ${(d.memberIds??[]).includes(g.uid)?"on":""}"
                                    @click=${()=>this._toggleSubGroupMember(l,g.uid)}
                                  >
                                    <member-chip
                                      .name=${g.displayName}
                                      .photo=${g.photoURL??""}
                          ...
                          `:(d.memberIds??[]).length>0?s`<div style="margin-top:4px;">
                            ${(d.memberIds??[]).map(g=>{const c=this.extended.find(h=>h.uid===g);return c?s`<span class="chip-toggle on" style="cursor:default;">
                                <member-chip
                                  .name=${c.displayName}
                                  .photo=${c.photoURL??""}
                                  .hue=${c.hue}
          ...
          ${this._addingChild?s`
                <div class="add-child-form">
                  <input
                    ...
                    @input=${l=>this._childName=l.target.value}
                    @keydown=${l=>{l.key==="Enter"&&this._saveChild()}}
                  />
                  <input
                    class="new-group-input"
                    type="date"
                    ...
                    @input=${l=>this._childDob=l.target.value}
                  />
    ...
    `}}_(Pe,"properties",{open:{type:Boolean,reflect:!0},family:{type:Object},immediate:{type:Array},extended:{type:Array},canRemove:{type:Boolean},_busy:{state:!0},_newGroupName:{state:!0},_editingGroupId:{state:!0},_removingUid:{state:!0},_addingChild:{state:!0},_childName:{state:!0},_childDob:{state:!0},_savingChild:{state:!0}}),_(Pe,"styles",z`
    * {
      box-sizing: border-box;
    }
    :host {
  ...
  `);customElements.define("manage-members-modal",Pe);const Wt=[[/(^|\.)airbnb\./,"Airbnb"],[/(^|\.)(vrbo|homeaway)\./,"Vrbo"],[/(^|\.)booking\./,"Booking.com"],[/(^|\.)expedia\./,"Expedia"],[/(^|\.)hipcamp\./,"Hipcamp"],[/(^|\.)tripadvisor\./,"Tripadvisor"],[/(^|\.)hotels\./,"Hotels.com"],[/(^|\.)(marriott|hilton|hyatt|ihg|accor|fourseasons)\./,"Hotel"],[/(^|\.)plumguide\./,"Plum Guide"]];function ht(p){const e=(p&&p.lodgingUrl?String(p.lodgingUrl):"").trim();if(e){let t="";try{t=new URL(e.includes("://")?e:`https://${e}`).hostname}catch{t=""}if(t){const i=t.toLowerCase();for(const[r,a]of Wt)if(r.test(i))return a}return"Other"}return p&&p.lodgingHost?"Other":""}function Jt(p,e){const t=[];if(t.push(p.title||"Cairn activity"),p.location&&t.push(p.location),p.start&&p.end){const r=P(p.start),a=P(p.end),o=r.toLocaleString("en-GB",{day:"numeric",month:"short"}),n=a.toLocaleString("en-GB",{day:"numeric",month:"short",year:"numeric"});t.push(p.start===p.end?n:`${o} – ${n}`)}if((p.lodgingUrl||p.lodgingHost||p.lodgingTitle)&&t.push(`Lodging: ${[ht(p),p.lodgingTitle].filter(Boolean).join(" — ")}`),p.flightNumber||p.flightAirline||p.flightDepartAirport){const r=[],a=[p.flightAirline,p.flightNumber].filter(Boolean).join(" ");if(a&&r.push(a),p.flightDepartAirport&&p.flightArriveAirport&&r.push(`${p.flightDepartAirport.toUpperCase()} → ${p.flightArriveAirport.toUpperCase()}`),p.flightDepartTime){const o=new Date(p.flightDepartTime);Number.isNaN(o.getTime())||r.push(`Depart: ${o.toLocaleString("en-GB",{day:"numeric",month:"short",hour:"2-digit",minute:"2-digit"})}`)}r.length&&t.push(`Flight: ${r.join(" · ")}`)}const i=(p.attendees??[]).map(r=>{var a;return(a=e.get(r))==null?void 0:a.displayName}).filter(Boolean);return i.length&&t.push(`With: ${i.join(", ")}`),p.notes&&t.push("",p.notes),t.push("","Shared from Portal · pebblepath.ai/portal"),t.join(`
`)}class Me extends A{constructor(){super(),this.trip=null,this.members=[],this._resizeObs=null}connectedCallback(){super.connectedCallback(),typeof ResizeObserver<"u"&&(this._resizeObs=new ResizeObserver(()=>this._fitTitle()))}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._resizeObs)==null||e.disconnect()}updated(){if(this._resizeObs&&this.renderRoot){const e=this.renderRoot.querySelector("article");e&&!e._observed&&(this._resizeObs.observe(e),e._observed=!0)}this._fitTitle()}_fitTitle(){if(!this.renderRoot)return;const e=this.renderRoot.querySelector("h3");if(!e)return;e.style.fontSize="";let t=19;for(e.style.fontSize=`${t}px`;e.scrollWidth>e.clientWidth+1&&t>13;)t-=.5,e.style.fontSize=`${t}px`}_fmtDates(e,t){const i=P(e),r=P(t);if(!i||!r)return"";const a=i.toLocaleString("en-GB",{month:"short"}),o=r.toLocaleString("en-GB",{month:"short"});return a===o&&i.getFullYear()===r.getFullYear()?`${i.getDate()} – ${r.getDate()} ${a}`:`${i.getDate()} ${a} – ${r.getDate()} ${o}`}async _onShare(e,t,i){i.stopPropagation();const r=Jt(e,t);if(navigator.share)try{await navigator.share({title:`Cairn — ${e.title??"activity"}`,text:r})}catch{}else try{await navigator.clipboard.writeText(r),y("Itinerary copied to clipboard.")}catch{y("Could not copy — try again from a browser tab.")}}render(){const e=this.trip;if(!e)return s``;const t=e.coverImage?`background-image: url(${e.coverImage});`:`background: ${Vt(e)};`,i=e.coverImage?"cover has-image":"cover",r=new Map(this.members.map(l=>[l.uid,l])),a=(e.attendees??[]).map(l=>r.get(l)).filter(Boolean),o=a.slice(0,4),n=Math.max(0,a.length-o.length);return s`
      <article
        tabindex="0"
      ...
      >
        ...
        <div class="body">
          ...
          ${e.lodgingUrl||e.lodgingHost?(()=>{const l=ht(e);return s`<div class="lodging">
                  ${l?s`<span class="pill">${l}</span>`:""}
          ...
          <div class="footer">
            <div class="attendees">
              ${o.map(l=>s`<member-chip
                  .name=${l.displayName}
                  .photo=${l.photoURL??""}
                  .hue=${l.hue}
                  size="28"
                ></member-chip>`)}
              ${n>0?s`<span class="more">+${n}</span>`:""}
            </div>
            <div class="actions">
              <button
                class="icon-btn"
    ...
    `}}_(Me,"properties",{trip:{type:Object},members:{type:Array}}),_(Me,"styles",z`
    :host {
      display: block;
    }
    article {
  ...
  `);customElements.define("trip-card",Me);class Ae extends A{constructor(){super(),this.open=!1,this.trips=[],this.members=[]}_onCancel(){this.dispatchEvent(new Event("cancel"))}_groupByYear(e){const t=[...e].sort((a,o)=>String(a.start).localeCompare(String(o.start))),i=new Date;i.setHours(0,0,0,0);const r=new Map;for(const a of t){if(!a.start)continue;const o=P(a.start),n=P(a.end);if(!o)continue;const l=o.getFullYear();r.has(l)||r.set(l,[]);const d=n?n<i:!1;r.get(l).push({trip:a,isPast:d})}return r}render(){var r;if(!this.open)return s``;const e=this._groupByYear(this.trips??[]),t=((r=this.trips)==null?void 0:r.length)??0,i=new Date().getFullYear();return s`
      <div class="backdrop" @click=${this._onCancel}></div>
      <div class="sheet">
        <glass-panel padding="lg" variant="strong" lifted>
          <div class="header">
          ...
          ${t===0?s`<div class="empty">
              ...
              </div>`:Array.from(e.entries()).map(([a,o])=>s`
                  <div class="year ${a===i?"current":""}">
                    ${a}
                  </div>
                  <div class="grid">
                    ${o.map(({trip:n,isPast:l})=>s`
                        <div class=${l?"past":""}>
    ...
    `}}_(Ae,"properties",{open:{type:Boolean,reflect:!0},trips:{type:Array},members:{type:Array}}),_(Ae,"styles",z`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("all-trips-modal",Ae);class ze extends A{constructor(){super(),this.open=!1,this._events=[],this._selected=new Set,this._loading=!1,this._error="",this._importing=!1,this._started=!1}willUpdate(e){e.has("open")&&this.open&&(this._started=!1,this._error="")}_start(){this._loading||(this._started=!0,this._load())}async _load(){var e,t,i,r,a,o;this._loading=!0,this._error="";try{const n=await st(),l=await qt(n,90),d=new Set((m.state.trips??[]).filter(c=>c.gcalEventId).map(c=>c.gcalEventId));this._events=l.map(c=>({...c,_alreadyImported:d.has(c.id)}));const g=new Set;for(const c of this._events){if(c._alreadyImported)continue;const h=((e=c.start)==null?void 0:e.date)??((i=(t=c.start)==null?void 0:t.dateTime)==null?void 0:i.slice(0,10)),b=((r=c.end)==null?void 0:r.date)??((o=(a=c.end)==null?void 0:a.dateTime)==null?void 0:o.slice(0,10));h&&b&&b!==h&&g.add(c.id)}this._selected=g}catch(n){console.error(n),this._error=(n==null?void 0:n.message)??"Could not load calendar events."}finally{this._loading=!1}}_toggle(e){const t=new Set(this._selected);t.has(e)?t.delete(e):t.add(e),this._selected=t}_toggleAll(){const e=this._events.filter(t=>!t._alreadyImported);this._selected.size===e.length?this._selected=new Set:this._selected=new Set(e.map(t=>t.id))}async _import(){var a;if(this._importing||this._selected.size===0)return;this._importing=!0;const e=(a=w==null?void 0:w.currentUser)==null?void 0:a.uid,t=this._events.filter(o=>this._selected.has(o.id));let i=0,r=0;for(const o of t){const n=Ht(o,e);try{await m.saveTrip(n),i++}catch(l){console.error("Import failed for event",o.id,l),r++}}this._importing=!1,r===0?y(`Imported ${i} ${i===1?"activity":"activities"}.`):y(`Imported ${i}, ${r} failed.`,{duration:5e3}),this._events=[],this._selected=new Set,this.dispatchEvent(new Event("cancel"))}_onCancel(){this.dispatchEvent(new Event("cancel"))}_fmtRange(e){var g,c,h,b,f,v,C,x;const t=((g=e.start)==null?void 0:g.date)??((h=(c=e.start)==null?void 0:c.dateTime)==null?void 0:h.slice(0,10)),i=((b=e.end)==null?void 0:b.date)??((v=(f=e.end)==null?void 0:f.dateTime)==null?void 0:v.slice(0,10));if(!t)return"";const r=new Date(t);if(!i||i===t)return r.toLocaleString("en-GB",{day:"numeric",month:"short",year:"numeric"});let a=new Date(i);(C=e.start)!=null&&C.date&&((x=e.end)!=null&&x.date)&&a.setDate(a.getDate()-1);const o=r.getMonth()===a.getMonth()&&r.getFullYear()===a.getFullYear(),n=r.getFullYear()===a.getFullYear();if(o)return`${r.getDate()}–${a.getDate()} ${r.toLocaleString("en-GB",{month:"short",year:"numeric"})}`;const l=r.toLocaleString("en-GB",{day:"numeric",month:"short"}),d=a.toLocaleString("en-GB",{day:"numeric",month:"short",year:"numeric"});return n?`${l} – ${d}`:`${r.toLocaleDateString()} – ${a.toLocaleDateString()}`}render(){if(!this.open)return s``;const e=this._events.filter(i=>!i._alreadyImported),t=e.length>0&&this._selected.size===e.length;return s`
      <div class="backdrop" @click=${this._onCancel}></div>
      <div class="sheet">
        <glass-panel padding="lg" variant="strong" lifted>
          <div class="header">
    ...
    `}}_(ze,"properties",{open:{type:Boolean,reflect:!0},_events:{state:!0},_selected:{state:!0},_loading:{state:!0},_error:{state:!0},_importing:{state:!0},_started:{state:!0}}),_(ze,"styles",z`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("import-calendar-modal",ze);class Ie extends A{constructor(){super(),this.open=!1,this.user=null,this.pebbleUser=null,this._name="",this._savingName=!1,this._uploadingPhoto=!1}willUpdate(e){var t;e.has("open")&&this.open&&(this._name=((t=this.user)==null?void 0:t.displayName)??"")}_onCancel(){this.dispatchEvent(new Event("cancel"))}async _saveName(){var i,r;const e=this._name.trim();if(!e||e===(((i=this.user)==null?void 0:i.displayName)??""))return;const t=(r=w==null?void 0:w.currentUser)==null?void 0:r.uid;if(!(!t||!u)){this._savingName=!0;try{await M($(u,"users",t),{displayName:e,updatedAt:k()});const a=m.familyId;if(a)try{await M($(u,"families",a),{[`memberProfiles.${t}.displayName`]:e,[`memberProfiles.${t}.updatedAt`]:k(),updatedAt:k()})}catch(o){console.warn("memberProfiles fan-out failed:",o)}y("Display name updated.")}catch(a){console.error(a),y(`Couldn't save: ${a.code??a.message}`,{duration:5e3})}finally{this._savingName=!1}}}async _signOut(){confirm("Sign out of Cairn?")&&(this.dispatchEvent(new Event("cancel")),await dt())}_triggerPhotoPicker(){var e;(e=this.renderRoot.querySelector("#photo-file"))==null||e.click()}async _onPhotoChosen(e){var a,o;const t=(a=e.target.files)==null?void 0:a[0];if(e.target.value="",!t)return;if(!t.type.startsWith("image/")){y("Pick an image file (JPG, PNG, etc.).");return}if(t.size>5*1024*1024){y("Photo is too big — keep it under 5 MB.");return}const i=(o=w==null?void 0:w.currentUser)==null?void 0:o.uid,r=m.familyId;if(!i||!r||!R){y("Can't upload yet — you need to be in a family first.");return}this._uploadingPhoto=!0;try{const n=V(R,`families/${r}/avatars/users/${i}`);await Q(n,t,{contentType:t.type});const l=await Z(n);await M($(u,"users",i),{profilePhotoURL:l,updatedAt:k()});try{await M($(u,"families",r),{[`memberProfiles.${i}.profilePhotoURL`]:l,[`memberProfiles.${i}.updatedAt`]:k(),updatedAt:k()})}catch(d){console.warn("memberProfiles photo fan-out failed:",d)}y("Photo updated.")}catch(n){console.error("Photo upload failed",n),y(`Upload failed: ${n.code??n.message}`,{duration:5e3})}finally{this._uploadingPhoto=!1}}render(){if(!this.open)return s``;const e=this.user,t=this._name.trim()&&this._name.trim()!==((e==null?void 0:e.displayName)??"");return s`
      <div class="backdrop" @click=${this._onCancel}></div>
      <div class="sheet">
        <glass-panel padding="lg" variant="strong" lifted>
          <div class="header">
    ...
    `}}_(Ie,"properties",{open:{type:Boolean,reflect:!0},user:{type:Object},pebbleUser:{type:Object},_name:{state:!0},_savingName:{state:!0},_uploadingPhoto:{state:!0}}),_(Ie,"styles",z`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("profile-sheet",Ie);const ae=class ae extends A{constructor(){super(),this.open=!1}static get OPTIONS(){return[{type:"activity",tone:"sage",icon:s`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    `:s``}};_(ae,"properties",{open:{type:Boolean,reflect:!0}}),_(ae,"styles",z`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);let De=ae;customElements.define("activity-type-picker",De);class Ee extends A{constructor(){super(),this.open=!1,this.floating=!1,this.family=null,this.trips=[],this._messages=[],this._input="",this._loading=!1,this._error="",this._followUps=[]}willUpdate(e){var t;e.has("_messages")&&(this.floating=(((t=this._messages)==null?void 0:t.length)??0)>0)}_onCancel(){this.dispatchEvent(new Event("cancel"))}_suggestions(){const e=[],t=(this.trips??[]).filter(i=>i.start&&new Date(i.start)>=new Date).sort((i,r)=>String(i.start).localeCompare(String(r.start)))[0];return t&&(e.push(`What should we do in ${t.location||t.title}?`),e.push(`What should we pack for ${t.title}?`)),e.push("Plan a family activity for this weekend"),e.push("Gift ideas for an upcoming birthday"),e.slice(0,4)}async _send(e){const t=(e??this._input).trim();if(!(!t||this._loading)){this._error="",this._input="",this._followUps=[],this._messages=[...this._messages,{role:"user",content:t}],this._loading=!0,this.updateComplete.then(()=>this._scrollToBottom());try{const i=this._messages.slice(0,-1).map(a=>({role:a.role,content:a.content})),r=await m.askPebble(t,i);this._messages=[...this._messages,{role:"assistant",content:r.answer}],this._followUps=Array.isArray(r.followUps)?r.followUps:[]}catch(i){console.error(i),(i==null?void 0:i.code)==="functions/unauthenticated"?this._error="Pebble needs you to be signed in.":(i==null?void 0:i.code)==="functions/permission-denied"?this._error="You're not in this family yet.":(i==null?void 0:i.code)==="functions/not-found"||(i==null?void 0:i.code)==="functions/internal"?this._error="Pebble isn't available right now — the Cloud Function may not be deployed yet.":this._error=(i==null?void 0:i.message)??"Pebble could not answer right now."}finally{this._loading=!1,this.updateComplete.then(()=>this._scrollToBottom())}}}_scrollToBottom(){const e=this.renderRoot.querySelector(".thread");e&&(e.scrollTop=e.scrollHeight)}_renderPebbleIcon(){return s`
    ...
    `}}_(Ee,"properties",{open:{type:Boolean,reflect:!0},floating:{type:Boolean,reflect:!0},family:{type:Object},trips:{type:Array},_messages:{state:!0},_input:{state:!0},_loading:{state:!0},_error:{state:!0},_followUps:{state:!0}}),_(Ee,"styles",z`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("pebble-chat",Ee);class gt extends A{render(){return s`
  ...
  `);customElements.define("discover-pebblepath",gt);class Fe extends A{constructor(){super(),this.code="",this._family=null,this._loading=!0,this._joining=!1,this._error="",this._step="join",this._children=[],this._claiming=!1,this._claimedName=null,this._joinedFamilyId=null}willUpdate(e){e.has("code")&&this.code&&this._lookup()}async _lookup(){var e;this._loading=!0,this._error="";try{const t=await m.findFamilyByConnectCode(this.code);if(!t)this._error="Invite code not found. Check it was typed correctly.",this._family=null;else{const i=t._matchedCodeKind==="pp"?t.inviteCodeExpiresAt:t.cairnInviteCodeExpiresAt,r=((e=i==null?void 0:i.toDate)==null?void 0:e.call(i))??(i?new Date(i):null);!r||r<new Date?(this._error="This invite code has expired. Ask the family for a fresh one.",this._family=null):this._family=t}}catch(t){console.error(t),this._error=(t==null?void 0:t.message)??"Couldn't look up the invite."}finally{this._loading=!1}}async _join(){var e;if(!this._joining){this._joining=!0,this._error="";try{const t=await m.redeemConnectCode(this.code);y(`Welcome to ${((e=this._family)==null?void 0:e.name)??"the family"}.`),this._joinedFamilyId=t;const i=await m.fetchFamilyChildren(t);Array.isArray(i)&&i.length?(this._children=i,this._step="parent"):this.dispatchEvent(new CustomEvent("joined",{detail:{familyId:t}}))}catch(t){console.error(t),this._error=(t==null?void 0:t.message)??"Could not join."}finally{this._joining=!1}}}async _claimChild(e){if(!(this._claiming||!(e!=null&&e.id))){this._claiming=!0,this._error="";try{await m.requestToBeCoParent(e.id),this._claimedName=e.name??"your child"}catch(t){console.error(t),this._error=(t==null?void 0:t.message)??"Couldn't send the request."}finally{this._claiming=!1}}}_notAParent(){this._finishJoin()}_finishJoin(){this.dispatchEvent(new CustomEvent("joined",{detail:{familyId:this._joinedFamilyId}}))}_cancel(){this.dispatchEvent(new Event("cancel"))}_inviterFromFamily(e){var r;if(!e)return null;const t=(r=e.memberProfiles)==null?void 0:r[e.createdBy];if(!t)return null;const i=t.profilePhotoURL;return{displayName:t.displayName??"A family member",photoURL:typeof i=="string"&&/^https?:\/\//i.test(i)?i:null}}_renderParentPrompt(){var t;const e=((t=this._family)==null?void 0:t.name)??"this family";return s`
    ...
    `}render(){var r,a,o;if(this._step==="parent")return this._renderParentPrompt();const e=this._inviterFromFamily(this._family),t=(((r=this._family)==null?void 0:r.cairnMemberIds)??((a=this._family)==null?void 0:a.memberIds)??[]).length,i=(((o=this._family)==null?void 0:o.memberIds)??[]).length;return s`
      <div class="wrap">
        <div class="mark">
          <img
            class="brand-icon"
    ...
    `}}_(Fe,"properties",{code:{type:String},_family:{state:!0},_loading:{state:!0},_joining:{state:!0},_error:{state:!0},_step:{state:!0},_children:{state:!0},_claiming:{state:!0},_claimedName:{state:!0}}),_(Fe,"styles",z`
    * { box-sizing: border-box; }
    :host {
      display: flex;
      align-items: center;
  ...
  `);customElements.define("join-family-screen",Fe);class Te extends A{constructor(){super(),this.error="",this.busy=!1,this.joinCode="",this._codeInputOpen=!1,this._code=""}async _handleSignIn(){if(this.busy)return;const e=(this._code??"").trim().toUpperCase();if(this._codeInputOpen&&e){const t=e.startsWith("CAIRN-")?e:`CAIRN-${e.replace(/^CAIRN-?/i,"")}`;try{localStorage.setItem("cairn:pendingJoinCode",t)}catch{}}this.busy=!0,this.error="";try{await ce()}catch(t){this.error=(t==null?void 0:t.message)??"Sign-in failed."}finally{this.busy=!1}}_toggleCode(){this._codeInputOpen=!this._codeInputOpen,this._codeInputOpen&&requestAnimationFrame(()=>{var e;(e=this.renderRoot.querySelector(".code-input"))==null||e.focus()})}_renderGoogleIcon(){return s`
  ...
  `);customElements.define("sign-in-screen",Te);const Xt="cairn:pendingJoinCode",Je="cairn:pendingLoginIntent";class Ne extends A{constructor(){super(),this.error="",this.busy=!1,this.joinCode="",this._step="welcome",this._email="",this._password="",this._displayName="",this._consent=!1,this._code="",this._resetSent=!1,this._invited=!1}willUpdate(e){if(e.has("joinCode")&&this.joinCode&&!this._invited){try{localStorage.setItem(Xt,(this.joinCode??"").trim().toUpperCase())}catch{}this._invited=!0}}_iconGoogle(){return s`<svg viewBox="0 0 48 48" aria-hidden="true">
    ...
    `}_renderLogin(){return s`
      ...
      <div class="step">
        ...
        ${this._renderProviders({google:()=>this._runAuth(()=>ce()),apple:()=>this._runAuth(()=>we()),busyText:"Signing in…"})}
      </div>
    `}_submitEmailAuth(){const e=(this._email??"").trim(),t=this._password??"";if(this._step==="register"){const i=(this._displayName??"").trim();if(!i){this.error="Please enter your name.";return}if(!e.includes("@")){this.error="That email doesn't look right.";return}if(t.length<6){this.error="Pick a password with at least 6 characters.";return}if(!this._consent){this.error="Please confirm you are 18+ and agree to the Terms and Privacy Policy.";return}this._runAuth(()=>nt(e,t,i))}else{if(!e||!t){this.error="Email and password are required.";return}this._runAuth(()=>ot(e,t))}}async _sendReset(){const e=(this._email??"").trim();if(!e){this.error="Enter your email first, then tap Forgot password.";return}this.busy=!0,this.error="";try{await lt(e),this._resetSent=!0}catch(t){this.error=this._humanizeAuthError(t)}finally{this.busy=!1}}_renderRegister(){const e=(this._displayName??"").trim().length>0&&(this._email??"").includes("@")&&(this._password??"").length>=6&&this._consent&&!this.busy;return s`
      ...
      <div class="step">
        ...
        ${this._renderProviders({google:()=>this._runAuth(()=>ce()),apple:()=>this._runAuth(()=>we()),busyText:"Creating…"})}
      </div>
    `}_renderConfigHint(){return s`
      <div class="config-hint">
        Sign-in is awaiting your Firebase config — copy
        <code>.env.example</code> to <code>.env</code> and fill in the web-app
        values from PebblePath's Firebase Console.
      </div>
    `}}_(Ne,"properties",{error:{state:!0},busy:{state:!0},joinCode:{type:String},_step:{state:!0},_email:{state:!0},_password:{state:!0},_displayName:{state:!0},_consent:{state:!0},_code:{state:!0},_resetSent:{state:!0},_invited:{state:!0}}),_(Ne,"styles",z`
    * { box-sizing: border-box; }
    :host {
      display: flex;
      align-items: center;
  ...
  `);customElements.define("register-screen",Ne);const ee=class ee extends A{constructor(){super(),this.value="family"}_select(e){e!==this.value&&(this.value=e,this.dispatchEvent(new CustomEvent("circle-change",{detail:{value:e},bubbles:!0,composed:!0})))}render(){return s`
    ...
    `}};_(ee,"properties",{value:{type:String,reflect:!0}}),_(ee,"OPTIONS",[{value:"personal",label:"Just me"},{value:"family",label:"Family"},{value:"extended",label:"Extended"}]),_(ee,"styles",z`
    * {
      box-sizing: border-box;
    }
    :host {
  ...
  `);let Re=ee;customElements.define("circle-switcher",Re);class Be extends A{constructor(){super(),this.event=null,this.members=[]}_icon(e){return e==="birthday"?s`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
    ...
    </svg>`}_fmtDate(e){const t=P(e)??new Date(e);return{day:t.getDate(),month:t.toLocaleString("en-GB",{month:"short"})}}render(){const e=this.event;if(!e)return s``;const t=this._fmtDate(e.date),i=new Map((this.members??[]).map(a=>[a.uid,a])),r=(e.personIds??[]).map(a=>i.get(a)).filter(Boolean);return s`
      <div
        class="row"
    ...
    `}}_(Be,"properties",{event:{type:Object},members:{type:Array}}),_(Be,"styles",z`
    :host {
      display: block;
    }
    .row {
  ...
  `);customElements.define("event-row",Be);class Oe extends A{constructor(){super();_(this,"_accept","application/pdf,image/*,application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/msword");this.open=!1,this._reset()}_reset(){this._phase="pick",this._events=[],this._err="",this._count=0}willUpdate(t){t.has("open")&&this.open&&this._reset()}_cancel(){this.dispatchEvent(new Event("cancel"))}async _onFile(t){var r;const i=(r=t.target.files)==null?void 0:r[0];if(t.target.value="",!!i){this._phase="working",this._err="";try{const{storagePath:a,fileType:o}=await m.uploadSchoolCalendar(i),n=await m.extractSchoolCalendarEvents(a,o);if(!n.length){this._phase="error",this._err="Couldn't find any dated events in that file. Try a clearer PDF or a screenshot of the calendar.";return}this._events=n.map(l=>({...l,_sel:!0})).sort((l,d)=>String(l.date).localeCompare(String(d.date))),this._phase="review"}catch(a){console.error("school import failed:",a),this._phase="error",this._err=(a==null?void 0:a.code)==="functions/permission-denied"?"You're not a member of this family.":(a==null?void 0:a.code)==="storage/unauthorized"?"The upload rule needs publishing — ask the team to deploy storage.rules.":(a==null?void 0:a.code)==="functions/not-found"||(a==null?void 0:a.code)==="functions/internal"?"The importer isn't available right now — try again in a moment.":(a==null?void 0:a.message)??"Something went wrong — try again."}}}_patch(t,i,r){const a=this._events.slice();a[t]={...a[t],[i]:r},this._events=a}get _selected(){return this._events.filter(t=>t._sel&&/^\d{4}-\d{2}-\d{2}$/.test(t.date)&&t.title.trim())}async _confirm(){const t=this._selected;if(t.length){this._phase="working";try{const i=await m.importSchoolEvents(t.map(r=>({date:r.date,title:r.title.trim(),type:r.type})));this._count=i,this._phase="done",y(`Added ${i} event${i===1?"":"s"} to the calendar.`),this.dispatchEvent(new CustomEvent("added",{detail:i}))}catch(i){console.error("importSchoolEvents failed:",i),this._phase="error",this._err=(i==null?void 0:i.code)==="permission-denied"?"Couldn't save — you may not have permission.":(i==null?void 0:i.message)??"Couldn't save the events — try again."}}}render(){return this.open?s`
      ...
      <div class="sheet">
        <glass-panel padding="lg" variant="strong" lifted>
          ...
          ${this._phase==="pick"?s`
              ...
              `:""}
          ${this._phase==="working"?s`<div class="working">
                <div class="spin"></div>
                <div>Reading the calendar…</div>
              </div>`:""}
          ${this._phase==="review"?s`
                <p class="lede">
                ...
                <div class="list">
                  ${this._events.map((t,i)=>s`<div class="row ${t._sel?"":"off"}">
                      <input
                        type="checkbox"
                        .checked=${t._sel}
              ...
              `:""}
          ${this._phase==="done"?s`<div class="done">
    ...
    `:s``}}_(Oe,"properties",{open:{type:Boolean,reflect:!0},_phase:{state:!0},_events:{state:!0},_err:{state:!0},_count:{state:!0}}),_(Oe,"styles",z`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("school-import-modal",Oe);const Xe=[{vb:"0 0 100 70",d:"M 8 38 C 6 18, 26 6, 48 8 C 72 10, 94 18, 94 38 C 94 58, 72 66, 48 64 C 22 62, 10 58, 8 38 Z"},{vb:"0 0 80 90",d:"M 38 6 C 56 8, 70 24, 72 46 C 74 70, 58 84, 38 84 C 16 84, 6 66, 8 44 C 10 22, 22 4, 38 6 Z"},{vb:"0 0 90 80",d:"M 14 26 C 18 10, 38 4, 56 8 C 78 14, 86 32, 82 50 C 76 70, 54 78, 32 72 C 12 66, 10 42, 14 26 Z"},{vb:"0 0 70 60",d:"M 8 30 C 8 14, 22 6, 38 8 C 54 10, 64 22, 62 36 C 60 52, 44 56, 28 54 C 14 52, 8 44, 8 30 Z"},{vb:"0 0 110 75",d:"M 8 38 C 6 18, 30 8, 56 10 C 84 12, 104 22, 104 40 C 102 58, 80 68, 52 66 C 24 64, 10 56, 8 38 Z"},{vb:"0 0 95 75",d:"M 14 24 C 18 10, 40 6, 56 12 C 70 18, 80 18, 86 30 C 90 44, 80 56, 64 60 C 48 64, 28 60, 18 50 C 10 42, 10 32, 14 24 Z"},{vb:"0 0 80 80",d:"M 14 20 C 20 10, 36 6, 52 10 C 68 16, 76 30, 72 48 C 66 64, 50 72, 32 66 C 16 60, 8 44, 10 30 C 12 24, 12 22, 14 20 Z"}];function Zt(p){let e=5381;const t=String(p??"");for(let i=0;i<t.length;i+=1)e=e*33^t.charCodeAt(i);return Xe[Math.abs(e)%Xe.length]}const Ze={motor:{cls:"fam-motor",fill:"#6b9ac4",dom:"Motor"},language:{cls:"fam-language",fill:"#d4a843",dom:"Language"},socialEmotional:{cls:"fam-social",fill:"#c98a8a",dom:"Social-Emotional"},cognitive:{cls:"fam-cognitive",fill:"#8b7bb5",dom:"Cognitive"},cross:{cls:"fam-cross",fill:"#3d9b8f",dom:""}},Qe={strength:{label:"Strength",svg:s`<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M12 2.5l2.94 5.96 6.58.96-4.76 4.64 1.12 6.55L12 17.6l-5.88 3.01 1.12-6.55-4.76-4.64 6.58-.96L12 2.5z"/></svg>`},watching:{label:"Watching",svg:s`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M1.5 12S5 5 12 5s10.5 7 10.5 7-3.5 7-10.5 7S1.5 12 1.5 12z"/><circle cx="12" cy="12" r="3.2"/></svg>`},connection:{label:"Connection",svg:s`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M10 13a5 5 0 0 0 7.07.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71M14 11a5 5 0 0 0-7.07-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>`},nudge:{label:"Try this",svg:s`<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M9 21c0 .55.45 1 1 1h4c.55 0 1-.45 1-1v-1H9v1zm3-19C8.14 2 5 5.14 5 9c0 2.38 1.19 4.47 3 5.74V17c0 .55.45 1 1 1h6c.55 0 1-.45 1-1v-2.26c1.81-1.27 3-3.36 3-5.74 0-3.86-3.14-7-7-7z"/></svg>`}};class Le extends A{constructor(){super(),this.type="nudge",this.domain="cross",this.title="",this.body=""}render(){const e=Ze[this.domain]??Ze.cross,t=Qe[this.type]??Qe.nudge,i=Zt(`${this.title}${this.type}`);return s`
    ...
    `}}_(Le,"properties",{type:{type:String},domain:{type:String},title:{type:String},body:{type:String}}),_(Le,"styles",z`
  ...
  `);customElements.define("insight-card",Le);const oe=[{key:"motor",label:"Motor",color:"#6b9ac4",svg:s`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><circle cx="13.5" cy="5.5" r="2"/><path d="M9.8 8.9 7 23h2.1l1.8-8 2.1 2v6h2v-7.5l-2.1-2 .6-3c1.3 1.5 3.3 2.5 5.5 2.5v-2c-1.9 0-3.5-1-4.3-2.4l-1-1.6c-.4-.6-1-1-1.7-1-.3 0-.5 0-.8.1L6 7.6V12h2V8.9l1.8-.7z"/></svg>`},{key:"language",label:"Language",color:"#d4a843",svg:s`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M20 2H4a2 2 0 0 0-2 2v18l4-4h14a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2z"/></svg>`},{key:"socialEmotional",label:"Social-Emotional",color:"#c98a8a",svg:s`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg>`},{key:"cognitive",label:"Cognitive",color:"#8b7bb5",svg:s`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M11 4.2A2.7 2.7 0 0 0 6.4 5.9a2.6 2.6 0 0 0-2.5 2.6c0 .5.1.9.3 1.3A2.7 2.7 0 0 0 3 12.2a2.7 2.7 0 0 0 1.2 2.2 2.6 2.6 0 0 0-.2 1c0 1.5 1.2 2.7 2.7 2.7.2 0 .4 0 .6-.1A2.7 2.7 0 0 0 11 20V4.2zm2 0v15.8a2.7 2.7 0 0 0 3.7-1.9c.2 0 .4.1.6.1 1.5 0 2.7-1.2 2.7-2.7 0-.4-.1-.7-.2-1A2.7 2.7 0 0 0 21 12.2a2.7 2.7 0 0 0-1.2-2.4c.2-.4.3-.8.3-1.3a2.6 2.6 0 0 0-2.5-2.6A2.7 2.7 0 0 0 13 4.2z"/></svg>`}];function ie(p){return p==="selfCare"?"motor":p}function Qt(p){var o;if(!p||Number.isNaN(((o=p.getTime)==null?void 0:o.call(p))??NaN))return"";const e=new Date;let t=(e.getFullYear()-p.getFullYear())*12+(e.getMonth()-p.getMonth());e.getDate()<p.getDate()&&(t-=1),t=Math.max(0,t);const i=Math.floor(t/12),r=t%12;if(i===0)return`${r} month${r===1?"":"s"}`;const a=r?`, ${r} month${r===1?"":"s"}`:"";return`${i} year${i===1?"":"s"}${a}`}class je extends A{constructor(){super(),this.child=null,this.children=[],this.milestones=[],this.insights=[],this.dailyCard=null,this.readonly=!1}_domainStats(e){const t=(this.milestones??[]).filter(a=>ie(a.category)===e),i=t.filter(a=>a.status==="achieved").length,r=t.length;return{achieved:i,total:r,pct:r?Math.round(i/r*100):0}}_pebbleIcon(){return s`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round"><circle cx="12" cy="12" r="9" /><circle cx="12" cy="12" r="4" fill="currentColor" stroke="none" /></svg>`}_ageMonths(e){var r;if(!e||Number.isNaN(((r=e.getTime)==null?void 0:r.call(e))??NaN))return 0;const t=new Date;let i=(t.getFullYear()-e.getFullYear())*12+(t.getMonth()-e.getMonth());return t.getDate()<e.getDate()&&(i-=1),Math.max(0,i)}_timelineModel(){var g;const e=this.milestones??[],t=this._ageMonths((g=this.child)==null?void 0:g.dateOfBirth),i=e.reduce((c,h)=>h.status==="achieved"?Math.max(c,h.ageRangeEndMonths??h.ageRangeStartMonths??0):c,0);let r=Math.max(i+12,t+6,18);r=Math.ceil(r/6)*6;const a=c=>Math.min(98,Math.max(2,(c??0)/r*100)),o=[{key:"motor",cls:"motor",name:"Motor"},{key:"language",cls:"language",name:"Language"},{key:"socialEmotional",cls:"social",name:"Social-Emo."},{key:"cognitive",cls:"cognitive",name:"Cognitive"}].map(c=>{const h=e.filter(x=>ie(x.category)===c.key),b=h.filter(x=>x.status==="achieved").sort((x,S)=>(x.ageRangeStartMonths??0)-(S.ageRangeStartMonths??0));let f=b;b.length>7&&(f=Array.from({length:7},(x,S)=>b[Math.round(S*(b.length-1)/6)]));const v=f.map(x=>({left:a(x.ageRangeStartMonths),future:!1})),C=h.filter(x=>x.status!=="achieved").sort((x,S)=>(x.ageRangeStartMonths??0)-(S.ageRangeStartMonths??0))[0];return C&&v.push({left:a(C.ageRangeStartMonths),future:!0}),{...c,dots:v}}),n=c=>c<=0?"birth":c<24?`${c} mo`:c%12===0?`${c/12} yr`:`${(c/12).toFixed(1).replace(/\.0$/,"")} yr`,l=Array.from({length:7},(c,h)=>n(Math.round(h*r/6))),d=Math.min(1,Math.max(0,t/r));return{lanes:o,axis:l,ageM:t,nowFrac:d}}render(){const e=this.child;if(!e)return s`<div class="panel empty">No child selected yet.</div>`;const t=this.milestones??[],i=t.filter(h=>h.status==="achieved"),r=t.length?Math.round(i.length/t.length*100):0,a=i.slice().sort((h,b)=>(b.ageRangeStartMonths??0)-(h.ageRangeStartMonths??0)).slice(0,4),o=t.filter(h=>h.status!=="achieved").slice(0,5),n=e.themeColorHex||"var(--teal-pebble)",l=this.insights??[],d=this._timelineModel(),g=h=>h==="achieved"?"done":h==="emerging"?"emerging":"up",c=h=>h==="achieved"?"Achieved":h==="emerging"?"Emerging":"Upcoming";return s`
      ${(this.children??[]).length>1?s`<div class="switcher">
            ${this.children.map(h=>s`<button
                class=${h.id===e.id?"on":""}
      ...
      <section>
        ...
        >
          ...
          <div class="meta">
            <h2>${e.name}</h2>
            <div class="sub">${Qt(e.dateOfBirth)}</div>
            <span class="agepill"
      ...
      <section>
        ...
        <div class="domains">
          ${oe.map(h=>{const b=this._domainStats(h.key);return s`<div
              class="dtile"
      ...
      <section>
        ...
        <div class="panel">
          <div class="timeline">
            ...
            ${d.lanes.map(h=>s`<div class="tl-lane ${h.cls}">
                <div class="tl-name">${h.name}</div>
                <div class="tl-track">
                  ${h.dots.map(b=>s`<i
                      class=${b.future?"future":""}
                      style="left:${b.left}%"
                    ></i>`)}
                </div>
              </div>`)}
            <div class="tl-axis">
              ${d.axis.map(h=>s`<span>${h}</span>`)}
            </div>
          </div>
        </div>
      </section>
      ...
      <section>
        <div class="two-col">
          <div>
            ...
            <div class="panel">
              ${o.length===0?s`<div class="empty">
                  ...
                  </div>`:o.map(h=>{var f,v;const b=((f=oe.find(C=>C.key===ie(h.category)))==null?void 0:f.color)??"#6b9ac4";return s`<div class="ms-row">
                      <span class="ms-dot" style="background:${b}"></span>
                      <div class="t">
                        ${h.title}
                        <small
                          >${((v=oe.find(C=>C.key===ie(h.category)))==null?void 0:v.label)??""}
            ...
            <div class="panel">
              ${a.length===0?s`<div class="empty">
                  ...
                  </div>`:a.map(h=>{var f;const b=((f=oe.find(v=>v.key===ie(h.category)))==null?void 0:f.color)??"#6b9ac4";return s`<div class="ms-row">
                      <span class="ms-dot" style="background:${b}"></span>
          ...
          <div>
            ...
            ${l.length===0?s`<div class="panel insights-empty">
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
                    stroke="currentColor"
                ...
                </div>`:s`<div class="insight-stack">
                  ${l.map(h=>s`<insight-card
                      .type=${h.type}
                      .domain=${h.domain}
                      .title=${h.title}
                      .body=${h.body}
      ...
      <section>
        ${this.readonly?s`<div class="vis-note">
    ...
    `}}_(je,"properties",{child:{type:Object},children:{type:Array},milestones:{type:Array},insights:{type:Array},dailyCard:{type:Object},readonly:{type:Boolean,reflect:!0}}),_(je,"styles",z`
    *, *::before, *::after { box-sizing: border-box; }
    :host { display: block; }
  ...
  `);customElements.define("child-overview",je);class Ue extends A{constructor(){super(),this.child=null,this.messages=[],this.sessions=[],this.prefill="",this.memberProfiles={},this.myUid="",this._session=[],this._input="",this._loading=!1,this._error="",this._seededKey="",this._activeSessionId=null,this._renamingId=null,this._isPrivate=!1,this._railOpen=!1,this.compact=!1,this._listening=!1,this._recognition=null}disconnectedCallback(){var e;super.disconnectedCallback();try{(e=this._recognition)==null||e.abort()}catch{}this._recognition=null}get _voiceSupported(){return!!(window.SpeechRecognition||window.webkitSpeechRecognition)}_toggleVoice(){var i;if(this._listening){try{(i=this._recognition)==null||i.stop()}catch{}return}const e=window.SpeechRecognition||window.webkitSpeechRecognition;if(!e)return;const t=new e;t.lang="en-US",t.interimResults=!0,t.continuous=!1,t.onresult=r=>{let a="";for(let o=0;o<r.results.length;o+=1)a+=r.results[o][0].transcript;this._input=a},t.onerror=r=>{this._listening=!1,(r.error==="not-allowed"||r.error==="service-not-allowed")&&(this._error="Microphone access is blocked — allow it in your browser to ask by voice.")},t.onend=()=>{this._listening=!1,this._recognition=null},this._recognition=t,this._listening=!0,this._error="";try{t.start()}catch{this._listening=!1,this._recognition=null}}willUpdate(e){var i;if(e.has("child")&&(this._session=[],this._error="",this._activeSessionId=null,this._seededKey=""),this._activeSessionId==null&&(e.has("sessions")||e.has("messages")||e.has("child"))){const r=this._sessionList();r.length&&(this._activeSessionId=r[0].id)}const t=`${((i=this.child)==null?void 0:i.id)??""}|${this._activeSessionId??""}`;if(t!==this._seededKey&&(e.has("messages")||e.has("sessions")||e.has("child")||e.has("_activeSessionId"))){this._session=this._messagesForActive().map(a=>({role:a.role,content:a.content,senderUid:a.senderUid,isPrivate:a.isPrivate===!0})),this._seededKey=t;const r=this._activeSession();this._isPrivate=r?r.isPrivate===!0:!1}e.has("prefill")&&this.prefill&&(this._input=this.prefill)}_sessionList(){const e=(this.sessions??[]).map(i=>({id:i.id,title:i.title||"Untitled chat",isPrivate:i.isPrivate===!0,_real:!0}));return(this.messages??[]).some(i=>!i.sessionId)&&e.push({id:"__legacy",title:"Earlier chats",isPrivate:!1,_real:!1}),e}_activeSession(){return this._sessionList().find(e=>e.id===this._activeSessionId)??null}_messagesForActive(){const e=this._activeSessionId;if(e==null)return[];const t=this.messages??[];return e==="__legacy"?t.filter(i=>!i.sessionId):t.filter(i=>i.sessionId===e)}_selectSession(e){if(this._activeSessionId===e){this._railOpen=!1;return}this._activeSessionId=e,this._railOpen=!1,this._error=""}async _newChat(){var e;if(this._railOpen=!1,this._error="",!!((e=this.child)!=null&&e.id))try{const t=await m.createPebbleSession(this.child.id,{title:"New chat",isPrivate:!1});this._activeSessionId=t,this._session=[],this._input="",this.updateComplete.then(()=>{var i;return(i=this.renderRoot.querySelector("textarea"))==null?void 0:i.focus()})}catch(t){this._error=(t==null?void 0:t.message)??"Couldn't start a new chat."}}async _renameSession(e){var r;if(!(e!=null&&e._real)||!((r=this.child)!=null&&r.id))return;const t=window.prompt("Rename chat",e.title);if(t==null)return;const i=t.trim();if(!(!i||i===e.title))try{await m.renamePebbleSession(this.child.id,e.id,i)}catch(a){this._error=(a==null?void 0:a.message)??"Couldn't rename."}}async _archiveSession(e){var t;if(!(!(e!=null&&e._real)||!((t=this.child)!=null&&t.id))&&window.confirm(`Archive "${e.title}"? It'll leave your chat list.`))try{await m.archivePebbleSession(this.child.id,e.id),this._activeSessionId===e.id&&(this._activeSessionId=null,this._seededKey="")}catch(i){this._error=(i==null?void 0:i.message)??"Couldn't archive."}}async _togglePrivacy(e){var i;const t=this._activeSession();if(this._isPrivate=e,!(!t||!t._real||!((i=this.child)!=null&&i.id)))try{await m.setPebbleSessionPrivacy(this.child.id,t.id,e)}catch(r){this._error=(r==null?void 0:r.message)??"Couldn't change privacy."}}updated(e){(e.has("messages")||e.has("_session")||e.has("_loading"))&&this.updateComplete.then(()=>this._scrollToBottom())}_scrollToBottom(){const e=this.renderRoot.querySelector(".thread");e&&(e.scrollTop=e.scrollHeight)}_suggestions(){var t;const e=((t=this.child)==null?void 0:t.name)??"your child";return[`What's coming up for ${e}?`,`Ideas for a rainy weekend with ${e}`,`Is ${e}'s speech on track?`,`How can I support ${e} this week?`]}_recentQuestions(){const e=[];return this._session.forEach((t,i)=>{if(t.role!=="user")return;const r=String(t.content??"").trim();r&&e.push({idx:i,text:r,isPrivate:t.isPrivate===!0})}),e.reverse()}_scrollToMsg(e){this._railOpen=!1,this.updateComplete.then(()=>{const t=this.renderRoot.querySelector(`.thread [data-idx="${e}"]`);t&&t.scrollIntoView({behavior:"smooth",block:"center"})})}_newQuestion(){this._railOpen=!1,this._input="",this.updateComplete.then(()=>{const e=this.renderRoot.querySelector("textarea");e==null||e.focus(),this._scrollToBottom()})}async _send(e){var n;const t=(e??this._input).trim();if(!t||this._loading)return;if(!((n=this.child)!=null&&n.id)){this._error="No child selected.";return}this._error="",this._input="";const i=this._session.slice(-20).map(l=>({role:l.role,content:l.content})),r=this._isPrivate===!0;let a=this._activeSessionId;const o=this._activeSession();if(!o||!o._real)try{a=await m.createPebbleSession(this.child.id,{title:t.slice(0,48),isPrivate:r}),this._activeSessionId=a,this._seededKey=`${this.child.id}|${a}`,this._session=[]}catch(l){this._error=(l==null?void 0:l.message)??"Couldn't start a chat.";return}else o.title==="New chat"&&this._session.filter(l=>l.role==="user").length===0&&m.renamePebbleSession(this.child.id,a,t.slice(0,48)).catch(()=>{});this._session=[...this._session,{role:"user",content:t,senderUid:this.myUid,isPrivate:r}],this._loading=!0;try{const l=await m.askPebbleAboutChild(this.child.id,t,i,r,a);this._session=[...this._session,{role:"assistant",content:(l==null?void 0:l.answer)??"…",isPrivate:r,senderUid:r?this.myUid:void 0}]}catch(l){console.error(l),(l==null?void 0:l.code)==="functions/unauthenticated"?this._error="Pebble needs you to be signed in.":(l==null?void 0:l.code)==="functions/permission-denied"?this._error="Pebble's child advisor is for parents on this household.":(l==null?void 0:l.code)==="functions/not-found"||(l==null?void 0:l.code)==="functions/internal"?this._error="Pebble isn't available right now — try again in a moment.":this._error=(l==null?void 0:l.message)??"Pebble could not answer right now."}finally{this._loading=!1}}_pico(){return s`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"><circle cx="12" cy="12" r="9" /><circle cx="12" cy="12" r="4.5" fill="currentColor" stroke="none" /></svg>`}_senderName(e){var i;if(!e||e===this.myUid)return"You";const t=(i=this.memberProfiles)==null?void 0:i[e];return t!=null&&t.displayName?t.displayName:e.charAt(0).toUpperCase()+e.slice(1)}_senderPhoto(e){var i,r;const t=(r=(i=this.memberProfiles)==null?void 0:i[e])==null?void 0:r.profilePhotoURL;return typeof t=="string"&&/^https?:\/\//i.test(t)?t:""}_fmt(e){const i=String(e??"").replace(/^[ \t\u00A0]+/gm,"").trim().replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\*\*([^*]+)\*\*/g,"<b>$1</b>").replace(/(^|[\s(])\*([^*\n]+)\*(?=[\s).,!?]|$)/g,"$1<i>$2</i>").replace(/\[([^\]]+)\]\((https?:\/\/[^\s)]+)\)/g,'<a href="$2" target="_blank" rel="noopener">$1</a>');return vt(i)}render(){var o;const e=((o=this.child)==null?void 0:o.name)??"your child",t=this._session.length>0,i=this._sessionList(),r=this._activeSession(),a=!!(r&&r._real);return s`
      <div class="pebble-wrap ${this.compact?"compact":""}">
        <aside class="rail ${this._railOpen?"open":""}">
          ...
          ${i.length===0?s`<div class="rail-empty">
                ...
                >
                  ${n.isPrivate?s`<svg class="lock" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" aria-hidden="true"><rect x="5" y="11" width="14" height="9" rx="2"/><path d="M8 11V8a4 4 0 018 0v3" stroke-linecap="round"/></svg>`:""}
                  <span class="rail-title">${n.title}</span>
                  ${n._real?s`<span class="rail-acts">
                        <button
                          class="ra"
                          title="Rename"
      ...
      <div class="chatpane">
        ...
        <div class="thread">
            ${t?s`
                  ${this._session.map((n,l)=>n.role==="assistant"?s`<div class="msg pb" data-idx="${l}">
                          <span class="pic">${this._pico()}</span>
                          <div class="col">
                            <!-- prettier-ignore -->
                            <div class="bubble">${this._fmt(n.content)}</div>
                          </div>
                        </div>`:s`<div class="msg you" data-idx="${l}">
                          <span class="av">
                            <member-chip
                  ...
                  ${this._loading?s`<div class="typing">
                ...
                `:s`<div class="empty">
                  ...
                  <div class="prompts">
                    ${this._suggestions().map(n=>s`<button @click=${()=>this._send(n)}>
                        ${n}
                      </button>`)}
                  </div>
                </div>`}
  ...
  `);customElements.define("child-pebble",Ue);const ge=[{key:"visit",label:"Visit"},{key:"meal",label:"Meal"},{key:"travel",label:"Travel"},{key:"note",label:"Note"}],ei=[{m:30,label:"30 min"},{m:60,label:"1 h"},{m:90,label:"1½ h"},{m:120,label:"2 h"},{m:180,label:"3 h"},{m:240,label:"4 h"},{m:480,label:"All day"}],O=56;function et(p){const e=String(p??"").match(/^(\d{4})-(\d{2})-(\d{2})/);return e?new Date(Number(e[1]),Number(e[2])-1,Number(e[3])):null}function ti(p){const e=p.getFullYear(),t=String(p.getMonth()+1).padStart(2,"0"),i=String(p.getDate()).padStart(2,"0");return`${e}-${t}-${i}`}function ne(p){const e=String(p??"").match(/^(\d{1,2}):?(\d{2})?/);return e?Number(e[1])+(e[2]?Number(e[2])/60:0):null}function ue(p){const e=Math.floor(p),t=Math.round((p-e)*60);return`${String(e).padStart(2,"0")}:${String(t).padStart(2,"0")}`}class Ge extends A{constructor(){super(),this.open=!1,this.trip=null,this.members=[],this.currentUid="",this._items=[],this._dayKey=null,this._title="",this._time="12:00",this._type="visit",this._dur=60,this._url="",this._file=null,this._fileName="",this._busy=!1,this._view="day",this._weekStart=0,this._sel=null,this._dragCtx=null,this._onGridMove=this._gridMove.bind(this),this._onGridUp=this._gridUp.bind(this),this._unsub=null,this._subId=null}_weekDays(){const e=this._days();if(e.length<=7)return e;const t=Math.min(Math.max(0,this._weekStart),Math.max(0,e.length-7));return e.slice(t,t+7)}_minFromPointer(e,t,i,r){const a=t.getBoundingClientRect(),o=Math.max(0,Math.min(e-a.top,a.height)),n=i*60+o/O*60,l=Math.round(n/15)*15;return Math.max(i*60,Math.min(r*60,l))}_gridDown(e,t,i,r){if(e.button!=null&&e.button!==0||e.target.closest&&e.target.closest(".evt, .wk-evt, button, a"))return;const a=e.currentTarget,o=this._minFromPointer(e.clientY,a,i,r);this._dragCtx={dayKey:t,lo:i,hi:r,el:a},this._sel={dayKey:t,aMin:o,bMin:o},window.addEventListener("pointermove",this._onGridMove),window.addEventListener("pointerup",this._onGridUp),e.preventDefault()}_gridMove(e){if(!this._dragCtx||!this._sel)return;const{el:t,lo:i,hi:r}=this._dragCtx;this._sel={...this._sel,bMin:this._minFromPointer(e.clientY,t,i,r)}}_gridUp(){window.removeEventListener("pointermove",this._onGridMove),window.removeEventListener("pointerup",this._onGridUp);const e=this._sel,t=this._dragCtx;if(this._sel=null,this._dragCtx=null,!e||!t)return;let i=Math.min(e.aMin,e.bMin),a=Math.max(e.aMin,e.bMin)-i;a<15&&(a=this._dur&&this._dur>=15?this._dur:60);const o=String(Math.floor(i/60)).padStart(2,"0"),n=String(i%60).padStart(2,"0");this._dayKey=e.dayKey,this._time=`${o}:${n}`,this._dur=a,this.updateComplete.then(()=>{const l=this.renderRoot.querySelector(".add-row input.t");l&&l.focus()})}_selGhost(e,t){const i=this._sel;if(!i||i.dayKey!==e)return"";const r=Math.min(i.aMin,i.bMin),a=Math.max(i.aMin,i.bMin),o=(r-t*60)/60*O,n=Math.max(3,(a-r)/60*O),l=`${String(Math.floor(r/60)).padStart(2,"0")}:${String(r%60).padStart(2,"0")}`;return s`<div
      class="sel-ghost"
      style="top:${o}px;height:${n}px;"
    >
      <span>${l}</span>
    </div>`}willUpdate(e){var t,i;if(e.has("open")||e.has("trip")){const r=((t=this.trip)==null?void 0:t.id)??null;this.open&&r?this._subId!==r&&(this._teardown(),this._subId=r,this._dayKey=((i=this._days()[0])==null?void 0:i.key)??"",this._unsub=m.planItemsListener(r,a=>{this._items=a})):this.open||this._teardown()}}disconnectedCallback(){super.disconnectedCallback(),this._teardown()}_teardown(){var e;(e=this._unsub)==null||e.call(this),this._unsub=null,this._subId=null,this._items=[],window.removeEventListener("pointermove",this._onGridMove),window.removeEventListener("pointerup",this._onGridUp),this._sel=null,this._dragCtx=null}_close(){this.dispatchEvent(new Event("cancel"))}_days(){var o,n;const e=et((o=this.trip)==null?void 0:o.start),t=et((n=this.trip)==null?void 0:n.end)??e;if(!e)return[{key:"",lbl:"Day",d:"The trip"}];const i=[],r=new Date(e);let a=0;for(;r<=t&&a<31;)i.push({key:ti(r),lbl:r.toLocaleDateString("en-GB",{weekday:"short"}),d:r.toLocaleDateString("en-GB",{day:"numeric",month:"short"})}),r.setDate(r.getDate()+1),a+=1;return i.length?i:[{key:"",lbl:"Day",d:"The trip"}]}_member(e){return(this.members??[]).find(t=>t.uid===e)??null}async _add(){const e=this._title.trim();if(!e||this._busy)return;this._busy=!0;const t=this._file;try{const i=await m.addPlanItem(this.trip.id,{title:e,type:this._type,day:this._dayKey??"",time:this._time||"",durationMins:this._dur,url:this._url.trim()});if(t&&i)try{const r=await m.uploadPlanAttachment(this.trip.id,i,t);await m.updatePlanItem(this.trip.id,i,{attachmentURL:r,attachmentName:t.name||"attachment"})}catch(r){console.error("plan attachment upload failed:",r),y((r==null?void 0:r.code)==="storage/unauthorized"?"Item added — but the attachment needs the Storage rule published.":"Item added — couldn't attach the file, try again.",{duration:5e3})}this._title="",this._url="",this._file=null,this._fileName="",this._dur=60}catch(i){console.error("addPlanItem failed:",i),y((i==null?void 0:i.code)==="permission-denied"?"Couldn't add — the planner rule may need publishing.":`Couldn't add: ${(i==null?void 0:i.message)??"try again"}`,{duration:5e3})}finally{this._busy=!1}}async _remove(e){try{await m.deletePlanItem(this.trip.id,e.id)}catch(t){y(`Couldn't remove: ${(t==null?void 0:t.code)??(t==null?void 0:t.message)}`,{duration:4e3})}}_renderWeek(){const e=this._weekDays(),t=e.length||1,i=new Set(e.map(d=>d.key)),r=(this._items||[]).filter(d=>i.has(String(d.day??"")));let a=8,o=20;for(const d of r){const g=ne(d.time);if(g==null)continue;const c=Math.max(.5,(Number(d.durationMins)||60)/60);a=Math.min(a,Math.floor(g)),o=Math.max(o,Math.ceil(g+c))}a=Math.max(0,Math.min(a,8)),o=Math.min(24,Math.max(o,20));const n=[];for(let d=a;d<o;d++)n.push(s`<div class="wk-hr">${String(d).padStart(2,"0")}:00</div>`);const l=(o-a)*O;return s`
      <div class="wk">
        ...
        <div class="wk-body" style="--cols:${t};">
          ...
          ${e.map(d=>{const g=r.filter(c=>String(c.day??"")===String(d.key));return s`<div
              class="wk-col"
              style="height:${l}px;"
              @pointerdown=${c=>this._gridDown(c,d.key,a,o)}
            >
              ${this._selGhost(d.key,a)}
              ${g.map(c=>{const h=ne(c.time);if(h==null)return"";const b=Math.max(.5,(Number(c.durationMins)||60)/60),f=(h-a)*O+2,v=Math.max(26,b*O-4),C=ge.some(x=>x.key===c.type)?c.type:"note";return s`<div
                  class="wk-evt ${C}"
                  style="top:${f}px;height:${v}px;"
                  title=${c.title}
                >
                  ${c.addedBy===this.currentUid?s`<button
                        class="wkdel"
                        title="Remove"
    ...
    `}render(){var l;if(!this.open||!this.trip)return s``;const e=this._days(),t=this._dayKey??((l=e[0])==null?void 0:l.key)??"",i=(this._items||[]).filter(d=>String(d.day??"")===String(t));let r=8,a=20;for(const d of i){const g=ne(d.time);if(g==null)continue;const c=Math.max(.5,(Number(d.durationMins)||60)/60);r=Math.min(r,Math.floor(g)),a=Math.max(a,Math.ceil(g+c))}r=Math.max(0,Math.min(r,8)),a=Math.min(24,Math.max(a,20));const o=[];for(let d=r;d<a;d++)o.push(s`<div class="sched-row">
        <div class="hr">${String(d).padStart(2,"0")}:00</div>
        <div></div>
      </div>`);const n=i.map(d=>{const g=ne(d.time);if(g==null)return null;const c=Math.max(.5,(Number(d.durationMins)||60)/60),h=(g-r)*O+3,b=c*O-8,f=this._member(d.addedBy),v=ge.some(C=>C.key===d.type)?d.type:"note";return s`<div
          class="evt ${v}"
          style="top:${h}px;height:${Math.max(34,b)}px;"
        >
          <div class="et">
            <b>${d.title}</b>
            <span>${ue(g)}${c?`–${ue(g+c)}`:""}</span>
            ${d.url||d.attachmentURL?s`<div class="adorn">
                  ${d.url?s`<a
                        href=${d.url}
                        target="_blank"
                        rel="noopener"
          ...
          ${d.addedBy===this.currentUid?s`<button class="del" title="Remove" @click=${()=>this._remove(d)}>×</button>`:""}
        </div>`}).filter(Boolean);return s`
      <section>
        <div class="glass">
          <div class="pl-head">
            <div>
              ...
              <div class="pl-sub">
                ...
                <span class="who-adds">
                  ${(this.members??[]).slice(0,4).map(d=>s`<member-chip
                      .name=${d.displayName}
                      .photo=${d.photoURL??""}
                      .hue=${d.hue??198}
                      size="22"
          ...
          <div class="pl-modebar">
            ...
            ${this._view==="week"&&e.length>7?s`<div class="wk-pager">
                  <button
          ...
          ${this._view==="week"?this._renderWeek():s`
                <div class="day-rail">
                  ${e.map(d=>s`<button
                ...
                <div class="sched">
                  <div class="sched-inner">
                    ...
                    >
                      ${n.length?n:s`<div class="sched-empty">
          ...
          >
            ...
            >
              ${ge.map(d=>s`<option value=${d.key}>${d.label}</option>`)}
            </select>
            <select
              class="dur"
              aria-label="Duration"
            ...
            <label class="attach" title="Attach a PDF or screenshot">
              ...
              <input
                ...
                @change=${d=>{var c;const g=((c=d.target.files)==null?void 0:c[0])??null;this._file=g,this._fileName=g?g.name:""}}
              />
            </label>
    ...
    `}}_(Ge,"properties",{open:{type:Boolean,reflect:!0},trip:{type:Object},members:{type:Array},currentUid:{type:String},_items:{state:!0},_dayKey:{state:!0},_title:{state:!0},_time:{state:!0},_type:{state:!0},_dur:{state:!0},_url:{state:!0},_fileName:{state:!0},_busy:{state:!0},_view:{state:!0},_weekStart:{state:!0},_sel:{state:!0}}),_(Ge,"styles",z`
    *, *::before, *::after { box-sizing: border-box; }
    :host { display: block; }
  ...
  `);customElements.define("trip-planner",Ge);const ii={uid:"preview-user",displayName:"Thomas Paris",email:"thomas@example.com",photoURL:null},tt=[{uid:"thomas",displayName:"Thomas",circles:["immediate"],hue:198},{uid:"partner",displayName:"Élise",circles:["immediate"],hue:8},{uid:"kid1",displayName:"Oscar",circles:["immediate"],hue:142},{uid:"kid2",displayName:"Mila",circles:["immediate"],hue:44},{uid:"mum",displayName:"Mum",circles:["extended"],hue:320},{uid:"dad",displayName:"Dad",circles:["extended"],hue:28},{uid:"sister",displayName:"Camille",circles:["extended"],hue:280},{uid:"bro-in-law",displayName:"Sam",circles:["extended"],hue:175},{uid:"niece",displayName:"Léa",circles:["extended"],hue:100}],ri=[{id:"t1",title:"Côte d’Azur, summer",location:"Antibes, France",start:"2026-07-12",end:"2026-07-21",coverGradient:"linear-gradient(135deg, #6b9ac4 0%, #c98a8a 60%, #d4a843 100%)",lodgingHost:"Airbnb",lodgingTitle:"Villa near Cap d’Antibes",attendees:["thomas","partner","kid1","kid2","mum","dad"],notes:"Mum + Dad arrive day 2. Dinner reservations at La Guérite booked.",visibility:"extended"},{id:"t2",title:"Half-term in the Alps",location:"Chamonix, France",start:"2026-10-24",end:"2026-10-31",coverGradient:"linear-gradient(135deg, #7a9e7e 0%, #4a6754 70%, #2c4439 100%)",lodgingHost:"Booking.com",lodgingTitle:"Chalet Les Drus",attendees:["thomas","partner","kid1","kid2"],notes:"Need ski school for the kids — book by September.",visibility:"immediate"},{id:"t3",title:"Camille’s 40th",location:"Lisbon, Portugal",start:"2026-09-05",end:"2026-09-08",coverGradient:"linear-gradient(135deg, #c67b5c 0%, #d4a843 50%, #c98a8a 100%)",lodgingHost:"Airbnb",lodgingTitle:"Alfama rooftop apartment",attendees:["thomas","partner","sister","bro-in-law"],notes:"Surprise. Don’t mention to Camille.",visibility:"family"}],ai=[{id:"e1",type:"birthday",date:"2026-05-24",personIds:["mum"],title:"Mum’s birthday"},{id:"e2",type:"anniversary",date:"2026-05-28",personIds:["mum","dad"],title:"Mum & Dad’s anniversary",subtitle:"38 years"},{id:"e3",type:"birthday",date:"2026-06-11",personIds:["kid1"],title:"Oscar turns 7"},{id:"e4",type:"birthday",date:"2026-06-30",personIds:["niece"],title:"Léa’s birthday"}],ut={id:"preview-felix",name:"Felix",dateOfBirth:new Date("2023-11-15"),profilePhotoURL:null,pronouns:"he",themeColorHex:"#3D9B8F",developmentalFlags:["speech and language"]},si=[ut],oi=[{id:"m1",category:"motor",title:"Kicks a ball forward",status:"achieved",ageRangeStartMonths:18,ageRangeEndMonths:24},{id:"m2",category:"motor",title:"Walks up stairs holding on",status:"achieved",ageRangeStartMonths:18,ageRangeEndMonths:24},{id:"m3",category:"motor",title:"Jumps with both feet off the ground",status:"emerging",ageRangeStartMonths:24,ageRangeEndMonths:30},{id:"m4",category:"motor",title:"Pedals a tricycle",status:"notStarted",ageRangeStartMonths:30,ageRangeEndMonths:36},{id:"m5",category:"language",title:"Uses two-word phrases",status:"achieved",ageRangeStartMonths:18,ageRangeEndMonths:24},{id:"m6",category:"language",title:"Says first name when asked",status:"emerging",ageRangeStartMonths:24,ageRangeEndMonths:30},{id:"m7",category:"language",title:"Names six body parts",status:"notStarted",ageRangeStartMonths:24,ageRangeEndMonths:30},{id:"m8",category:"language",title:"Uses three-word sentences",status:"notStarted",ageRangeStartMonths:30,ageRangeEndMonths:36},{id:"m9",category:"socialEmotional",title:"Shows affection unprompted",status:"achieved",ageRangeStartMonths:18,ageRangeEndMonths:24},{id:"m10",category:"socialEmotional",title:"Plays alongside other children",status:"emerging",ageRangeStartMonths:24,ageRangeEndMonths:36},{id:"m11",category:"socialEmotional",title:"Takes turns in simple games",status:"notStarted",ageRangeStartMonths:30,ageRangeEndMonths:42},{id:"m12",category:"cognitive",title:"Follows a two-step instruction",status:"achieved",ageRangeStartMonths:18,ageRangeEndMonths:24},{id:"m13",category:"cognitive",title:"Sorts objects by shape or colour",status:"emerging",ageRangeStartMonths:30,ageRangeEndMonths:36},{id:"m14",category:"cognitive",title:"Completes a 4-piece puzzle",status:"notStarted",ageRangeStartMonths:30,ageRangeEndMonths:36}],ni=[{id:"i1",type:"strength",domain:"language",title:"Language is tracking ahead",body:"Felix is combining words earlier than the typical 24–30 month window — keep the back-and-forth conversations going.",relevanceScore:.95},{id:"i2",type:"connection",domain:"cross",title:"Fine-motor + sorting → pre-literacy",body:"A strong pincer grip alongside early sorting is a classic pre-literacy signal. Picture books with pointing build on both at once.",relevanceScore:.82},{id:"i3",type:"nudge",domain:"language",title:"Narrate your daily routine",body:'"Now we are washing hands… water on… soap…" — Felix is ready for longer sentence models during everyday moments.',relevanceScore:.7}],li={id:"2026-05-16",title:"Felix is stringing two words together",body:'You have logged "more milk" and "Daddy go" this week — early two-word speech, right on the edge of the 24–30 month window. Narrating your routine out loud is the single best way to grow sentence length from here.',topicForChat:"How can I support Felix's two-word speech?"},di=[{id:"p1",role:"user",content:"Felix isn't saying many words yet — should I be worried at 2.5?",senderUid:"partner"},{id:"p2",role:"assistant",content:"At 2½, every child's pace differs. From your logs Felix **uses two-word phrases** and follows two-step instructions — both strong signs. A few practical things to try, and a clear marker for when to mention it at his check-up."},{id:"p3",role:"user",content:"Any toddler-friendly ideas for a rainy weekend?",senderUid:"thomas"},{id:"p4",role:"assistant",content:"Rainy days are great for the kind of close-up play that grows language fastest at this stage. A few ideas matched to where Felix is right now."}];class Ye extends A{constructor(){super(),this.user=ii,this.pebbleUser=null,this.family=null,this.children=[],this.trips=[],this.events=[],this.holidays=[],this._connectionMembers=[],this._connKey="",this.ppFamily=null,this.ppIsMember=!1,this.ppChildren=[],this.selectedChildId=null,this.childMilestones=[],this.childInsights=[],this.childDailyCard=null,this.childPebbleMessages=[],this.childPebbleSessions=[],this.ppIsChildViewer=!1,this.incomingChildRequests=[],this.myChildAccessRequest=null,this._pebblePrefill="",this._plannerOpen=!1,this._plannerTrip=null,this.preview=!1,this.circle="extended",this._activeTab="today",this._formOpen=!1,this._formTrip=null,this._formBusy=!1,this._membersOpen=!1,this._eventFormOpen=!1,this._eventFormEvent=null,this._eventFormBusy=!1,this._allTripsOpen=!1,this._editingFamilyName=!1,this._importOpen=!1,this._schoolImportOpen=!1,this._profileOpen=!1,this._typePickerOpen=!1,this._formMode="trip",this._pebbleFabOpen=!1,this._themeLight=typeof document<"u"&&document.documentElement.classList.contains("theme-light"),this._dragOverTarget=null;const e=new Date;this._displayMonth=new Date(e.getFullYear(),e.getMonth(),1)}async _saveFamilyName(e){var a,o;const i=(e.target.value??"").trim(),r=((a=this.family)==null?void 0:a.name)??"";if(i&&i!==r&&((o=this.family)!=null&&o.id))try{const{db:n,doc:l,updateDoc:d,serverTimestamp:g}=await K(async()=>{const{db:c,doc:h,updateDoc:b,serverTimestamp:f}=await Promise.resolve().then(()=>Tt);return{db:c,doc:h,updateDoc:b,serverTimestamp:f}},void 0);await d(l(n,"families",this.family.id),{name:i,updatedAt:g()}),y("Family name updated.")}catch(n){console.error("Update family name failed:",n),y(`Couldn't save: ${n.code??n.message}`,{duration:5e3})}this._editingFamilyName=!1}_liveImmediate(){var e;return this.preview||!((e=this.user)!=null&&e.uid)?tt.filter(t=>t.circles.includes("immediate")):jt(this.user.uid,this.user,this.pebbleUser,this.family,this.children)}_liveExtended(){var e;return this.preview?tt.filter(t=>t.circles.includes("extended")):Bt((e=this.user)==null?void 0:e.uid,this.family)}_liveConnections(){return this.preview?[]:this._connectionMembers??[]}async _refreshConnectionMembers(){var e;if(this.preview||!this.family){this._connectionMembers=[];return}try{this._connectionMembers=await Ot((e=this.user)==null?void 0:e.uid,this.family)}catch{this._connectionMembers=[]}}updated(e){var t,i;if(e.has("family")){const r=Array.isArray((t=this.family)==null?void 0:t.connectedFamilyIds)?this.family.connectedFamilyIds:[],a=`${((i=this.family)==null?void 0:i.id)??""}|${[...r].sort().join(",")}`;a!==this._connKey&&(this._connKey=a,this._refreshConnectionMembers())}}_liveTrips(){return this.preview?ri:this.trips??[]}_liveEvents(){if(this.preview)return ai;const e=r=>{const{date:a,yearsElapsed:o}=Gt(r);return{...r,date:a?Yt(a):r.date,_yearsElapsed:o,_originalDate:r.date}},t=Ut(this.children).map(e),i=(this.events??[]).map(e);return[...t,...i].sort((r,a)=>String(r.date).localeCompare(String(a.date)))}_filteredMembers(){const e=this._liveImmediate(),t=this._liveExtended();return this.circle==="personal"?e.filter(i=>{var r;return i.uid===((r=this.user)==null?void 0:r.uid)}):this.circle==="family"?e:[...e,...t]}_circleTrips(){var o;const e=this._liveTrips(),t=((o=this.user)==null?void 0:o.uid)??"thomas";let i;this.circle==="personal"?i=e.filter(n=>{var l;return(l=n.attendees)==null?void 0:l.includes(t)}):this.circle==="family"?i=e.filter(n=>n.visibility!=="extended"&&this._userCanSeeTrip(n)):i=e.filter(n=>this._userCanSeeTrip(n));const r=new Set,a=[];for(const n of i){const l=n.id??`${n.title}|${n.start}|${n.end}`;r.has(l)||(r.add(l),a.push(n))}return a}_filteredTrips(){const e=new Date;return e.setHours(0,0,0,0),this._circleTrips().filter(t=>t.end?P(t.end)>=e:!0)}_userCanSeeTrip(e){var l,d,g,c,h,b;const t=(l=this.user)==null?void 0:l.uid;if(!t)return!1;if((d=e.attendees)!=null&&d.includes(t)||(g=e.viewers)!=null&&g.includes(t))return!0;const i=((c=this.family)==null?void 0:c.memberIds)??[],r=((h=this.family)==null?void 0:h.cairnMemberIds)??i,a=i.includes(t),o=r.includes(t);if(a)return!0;if(!o)return!1;const n=e.visibility||"family";if(n==="personal")return!1;if(n==="family")return!0;if(n==="extended"){const f=e.targetSubGroups??[];if(f.length===0)return!0;const v=Object.entries(((b=this.family)==null?void 0:b.subGroups)??{}).filter(([,C])=>(C.memberIds??[]).includes(t)).map(([C])=>C);return f.some(C=>v.includes(C))}return!1}_filteredEvents(){const e=new Set(this._filteredMembers().map(t=>t.uid));return this._liveEvents().filter(t=>t.personIds.some(i=>e.has(i)))}_smartCallout(){var n,l;const e=new Date,t=new Date(e.getFullYear(),e.getMonth(),e.getDate()),i=1440*60*1e3,r=d=>Math.round((d-t)/i);for(const d of this._circleTrips()){if(!d.start||!d.end)continue;const g=P(d.start),c=P(d.end);if(g.setHours(0,0,0,0),c.setHours(0,0,0,0),g<=t&&t<=c){const h=r(g)+1,b=r(c)-r(g)+1,f=((n=d.location)==null?void 0:n.trim())||d.title;return`Day ${h} of ${b} in ${f}.`}}let a=null,o=1/0;for(const d of this._circleTrips()){if(!d.start)continue;const g=P(d.start);if(!g)continue;const c=r(g);c>0&&c<o&&(a={kind:"trip",item:d},o=c)}for(const d of this._filteredEvents()){if(!d.date)continue;const g=P(d.date);if(!g)continue;const c=r(g);c>=0&&c<o&&(a={kind:"event",item:d},o=c)}if(!a)return null;if(a.kind==="trip"){const d=((l=a.item.location)==null?void 0:l.trim())||a.item.title;return o===1?`${d} starts tomorrow.`:o<=14?`${d} in ${o} days.`:o<=60?`Next trip: ${d} in ${o} days.`:null}return o===0?`${a.item.title} — today.`:o===1?`${a.item.title} — tomorrow.`:o<=7?`${a.item.title} in ${o} days.`:null}_tripDensityByDay(e){const t=new Map;for(const i of this._filteredTrips()){if(!i.start||!i.end)continue;const r=P(i.start),a=P(i.end);if(Number.isNaN(r.getTime())||Number.isNaN(a.getTime())||r.getFullYear()>e||a.getFullYear()<e)continue;const o=new Date(Math.max(r,new Date(e,0,1))),n=new Date(Math.min(a,new Date(e,11,31)));for(;o<=n;){const l=`${String(o.getMonth()+1).padStart(2,"0")}-${String(o.getDate()).padStart(2,"0")}`;t.set(l,Math.min(1,(t.get(l)??0)+.5)),o.setDate(o.getDate()+1)}}return t}_shiftMonth(e){const t=this._displayMonth;this._displayMonth=new Date(t.getFullYear(),t.getMonth()+e,1)}_jumpToMonth(e,t){this._displayMonth=new Date(e,t,1)}_resetToToday(){const e=new Date;this._displayMonth=new Date(e.getFullYear(),e.getMonth(),1)}_renderStone({label:e,members:t,pebbleClass:i,emptyLabel:r,onClick:a,maxChips:o=6,dropTargetId:n=null,draggable:l=()=>!1}){const d=n?{dragover:f=>{var v;(v=f.dataTransfer.types)!=null&&v.includes("text/cairn-uid")&&(f.preventDefault(),this._dragOverTarget=n)},dragleave:()=>{this._dragOverTarget===n&&(this._dragOverTarget=null)},drop:async f=>{f.preventDefault(),this._dragOverTarget=null;const v=f.dataTransfer.getData("text/cairn-uid");if(!v)return;const C=n==="extended"?null:n;try{await m.setCairnMemberSubGroup(v,C),y(C?`Moved to ${e}.`:"Moved to extended.")}catch(x){console.error("Move failed:",x),y(`Couldn't move: ${x.code??x.message}`,{duration:4e3})}}}:{},g=n&&this._dragOverTarget===n,c=`pebble ${i}${g?" pebble-drop":""}`;if(!t||t.length===0)return s`
        <button
          ...
          @drop=${d.drop}
        >
          <span class="${c} pebble-empty">${r}</span>
          <span class="stone-label">${e}</span>
        </button>
      `;const h=t.slice(0,o),b=t.length-h.length;return s`
      <button
        class="stone"
        @click=${a}
      ...
      >
        <span class="${c}">
          <span class="stone-chips">
            ${h.map(f=>{const v=l(f);return s`
                <member-chip
                  draggable=${v?"true":"false"}
                  class=${v?"is-draggable":""}
                  @dragstart=${C=>{if(!v){C.preventDefault();return}C.stopPropagation(),C.dataTransfer.setData("text/cairn-uid",f.uid),C.dataTransfer.effectAllowed="move"}}
                  .name=${f.displayName}
                  .photo=${f.photoURL??""}
                  .hue=${f.hue}
                  size="26"
                ></member-chip>
              `})}
            ${b>0?s`<span class="stone-more">+${b}</span>`:""}
          </span>
        </span>
        <span class="stone-label">${e}</span>
      </button>
    `}_renderMonthly(){const e=new Date,t=this._displayMonth??e,i=t.getFullYear(),r=t.getMonth(),o=(new Date(i,r,1).getDay()+6)%7,n=new Date(i,r+1,0).getDate(),l=new Map,d=(x,S)=>{l.has(x)||l.set(x,S)},g=[];for(const x of this._filteredEvents()){const S=P(x.date);S&&S.getFullYear()===i&&S.getMonth()===r&&(g.push(S.getDate()),d(S.getDate(),x.title??""))}const c=new Set;for(const x of this._filteredTrips()){if(!x.start||!x.end)continue;const S=P(x.start),E=P(x.end);if(Number.isNaN(S.getTime())||Number.isNaN(E.getTime())||S.getFullYear()>i||E.getFullYear()<i||S.getMonth()>r&&E.getMonth()>r||S.getMonth()<r&&E.getMonth()<r)continue;const B=S.getMonth()===r?S.getDate():1,F=E.getMonth()===r?E.getDate():n;for(let D=B;D<=F;D++)c.add(D),d(D,x.title??"")}const h=new Set;for(const x of this.holidays??[]){const S=P(x.date);S&&S.getFullYear()===i&&S.getMonth()===r&&(h.add(S.getDate()),d(S.getDate(),x.title??"Holiday"))}const b=[];for(let x=0;x<o;x++)b.push(s`<div class="cal-cell empty"></div>`);const f=e.getFullYear()===i&&e.getMonth()===r;for(let x=1;x<=n;x++){const S=f&&x===e.getDate(),E=g.includes(x),B=c.has(x),F=h.has(x),D=S?l.get(x)??"Today":l.get(x),se=["cal-cell",S?"today":"",E?"has-event":"",B?"has-trip":"",F?"has-holiday":""].filter(Boolean).join(" ");b.push(s`<div class=${se} title=${D?`${x} — ${D}`:""}>
        <span class="cal-cell-day">${x}</span>
        ${D?s`<span class="cal-cell-label">${D}</span>`:""}
      </div>`)}const v=new Date(i,r,1).toLocaleString("en-GB",{month:"long",year:"numeric"});return s`
      <div class="cal-head">
        <h3>${v}</h3>
        <div class="nav">
          ${!f?s`<button
    ...
    `}_renderTabHeader(e,t,i=""){return s`
        <div class="hello">
          <div>
            <h1>${e}</h1>
            ${t?s`<div class="page-sub">${t}</div>`:""}
          </div>
          ${i}
        </div>
    `}_renderComingUpSection(){const e=this._filteredTrips(),t=this._liveImmediate().concat(this._liveExtended());return s`
        <section>
          <div class="section-head">
            <h2>Coming up</h2>
    ...
    `}_renderCalendarsSection(){var t,i,r;const e=new Date;return s`
        <section>
          <div class="cal-row">
    ...
    `}_renderCelebrationsSection(){const e=this._filteredEvents(),t=this._liveImmediate().concat(this._liveExtended());return s`
        <section>
          <div class="section-head">
            <h2>Celebrations</h2>
            <button class="link" @click=${()=>this._openCreateEvent()}>+ Add event</button>
          </div>
          ${(()=>{const i=e.slice().sort((r,a)=>String(r.date).localeCompare(String(a.date)));return s`
              <glass-panel padding="md" variant="strong">
                ${i.length===0?s`<div class="cel-empty">No celebrations yet.</div>`:i.map(r=>s`<event-row
                        .event=${r}
                        .members=${t}
    ...
    `}_renderCairnStackPanel(){const e=this._liveImmediate(),t=this._liveExtended(),i=e.concat(t);return s`
          <glass-panel padding="md" variant="strong">
            ${(()=>{var c,h,b,f,v;const r=e.find(C=>{var x;return C.uid===((x=this.user)==null?void 0:x.uid)}),o=new Set(((c=this.family)==null?void 0:c.memberIds)??[]).has((h=this.user)==null?void 0:h.uid),n=e.filter(C=>{var x;return C.uid!==((x=this.user)==null?void 0:x.uid)}),l=!o&&r?[{...r,role:"extended"},...t]:t,d=Object.entries(((b=this.family)==null?void 0:b.subGroups)??{}),g=new Map(i.map(C=>[C.uid,C]));return s`
                <div class="cairn-stack">
                  ${o?s`
                        ...
                        >
                          <span class="pebble pebble-self">
                            <span class="stone-chips">
                              <member-chip
                                .name=${(r==null?void 0:r.displayName)??((f=this.user)==null?void 0:f.displayName)??"You"}
                                .photo=${(r==null?void 0:r.photoURL)??((v=this.user)==null?void 0:v.photoURL)??""}
                                .hue=${(r==null?void 0:r.hue)??198}
                                size="28"
                              ></member-chip>
                            </span>
                          </span>
                  ...
                  ${this._renderStone({label:"Family",members:n,pebbleClass:"pebble-family",emptyLabel:"+ Add co-parent or child",onClick:()=>this._membersOpen=!0})}

                  <!-- Extended (deeper teal, larger). -->
                  ${this._renderStone({label:"Extended",members:l,pebbleClass:"pebble-extended",emptyLabel:"+ Invite extended family",onClick:()=>this._membersOpen=!0,dropTargetId:"extended",draggable:C=>C.role==="extended"})}

                  <!-- Sub-group base row — each stone is a drop target. -->
                  ${d.length>0?s`
                        <div class="subgroup-row">
                          ${d.map(([C,x])=>{const S=(x.memberIds??[]).map(E=>g.get(E)).filter(Boolean);return this._renderStone({label:x.name??"Group",members:S,pebbleClass:"pebble-subgroup",emptyLabel:`${x.name??"Group"} (empty)`,onClick:()=>this._membersOpen=!0,maxChips:4,dropTargetId:C,draggable:E=>E.role==="extended"})})}
                        </div>
                      `:""}
                </div>
                ${n.length===0&&t.length===0?s`
    ...
    `}_childData(){if(this.preview)return{hasPP:!0,readonly:!1,children:si,child:ut,milestones:oi,insights:ni,dailyCard:li,pebbleMessages:di,pebbleSessions:[]};const e=this.ppChildren??[],t=e.find(r=>r.id===this.selectedChildId)??e[0]??null;return{hasPP:!!((this.ppIsMember||this.ppIsChildViewer)&&t),readonly:!!(this.ppIsChildViewer&&!this.ppIsMember),children:e,child:t,milestones:this.childMilestones??[],insights:this.childInsights??[],dailyCard:this.childDailyCard??null,pebbleMessages:this.childPebbleMessages??[],pebbleSessions:this.childPebbleSessions??[]}}_onSelectChild(e){this.preview||m.selectChild(e.detail)}_onAskPebble(e){this._pebblePrefill=e.detail??"",this._activeTab="pebble"}async _requestChildAccess(){if(!this.preview)try{await m.requestChildAccess(),y("Request sent — a parent will be notified.")}catch(e){y(`Couldn't send request: ${e.code??e.message}`,{duration:5e3})}}async _withdrawChildAccess(){if(!this.preview)try{await m.withdrawChildAccessRequest(),y("Request withdrawn.")}catch(e){y(`Couldn't withdraw: ${e.code??e.message}`,{duration:4e3})}}async _approveChildAccess(e){try{await m.approveChildAccess(e),y("Access granted — read-only Children view.")}catch(t){y(`Couldn't approve: ${t.code??t.message}`,{duration:5e3})}}async _declineChildAccess(e){try{await m.declineChildAccess(e),y("Request declined.")}catch(t){y(`Couldn't decline: ${t.code??t.message}`,{duration:4e3})}}async _revokeChildViewer(e){try{await m.revokeChildViewer(e),y("Read-only access revoked.")}catch(t){y(`Couldn't revoke: ${t.code??t.message}`,{duration:4e3})}}_ageShort(e){var o;if(!e||Number.isNaN(((o=e.getTime)==null?void 0:o.call(e))??NaN))return"";const t=new Date;let i=(t.getFullYear()-e.getFullYear())*12+(t.getMonth()-e.getMonth());t.getDate()<e.getDate()&&(i-=1),i=Math.max(0,i);const r=Math.floor(i/12),a=i%12;return r===0?`${a} mo`:`${r}y${a?` ${a}m`:""}`}_ageLong(e){var n;if(!e||Number.isNaN(((n=e.getTime)==null?void 0:n.call(e))??NaN))return"";const t=new Date;let i=(t.getFullYear()-e.getFullYear())*12+(t.getMonth()-e.getMonth());t.getDate()<e.getDate()&&(i-=1),i=Math.max(0,i);const r=Math.floor(i/12),a=i%12;if(r===0)return`${a} month${a===1?"":"s"}`;const o=a?`, ${a} month${a===1?"":"s"}`:"";return`${r} year${r===1?"":"s"}${o}`}_comingUp(){const e=[];for(const i of this._filteredTrips())i.start&&e.push({kind:"trip",title:i.title||"Trip",sub:i.location||i.lodgingHost||"",date:i.start,chip:this._fmtRangeShort(i.start,i.end)});for(const i of this._filteredEvents()){if(!i.date)continue;const r=P(i.date);r&&e.push({kind:i.source==="school-import"?"external":"event",title:i.title||"Celebration",sub:"",date:i.date,chip:r.toLocaleDateString("en-GB",{day:"numeric",month:"short"})})}const t=new Date().toISOString().slice(0,10);for(const i of this.holidays??[]){if(!i.date||i.date<t)continue;const r=P(i.date);r&&e.push({kind:"holiday",title:i.title||"Public holiday",sub:"Public holiday",date:i.date,chip:r.toLocaleDateString("en-GB",{day:"numeric",month:"short"})})}return e.sort((i,r)=>String(i.date).localeCompare(String(r.date))).slice(0,5)}_fmtRangeShort(e,t){const i=P(e),r=P(t);if(!i)return"";const a=i.toLocaleDateString("en-GB",{month:"short"});if(!r||i.getDate()===r.getDate()&&a===r.toLocaleDateString("en-GB",{month:"short"}))return`${i.getDate()} ${a}`;const o=r.toLocaleDateString("en-GB",{month:"short"});return a===o?`${i.getDate()}–${r.getDate()} ${a}`:`${i.getDate()} ${a} – ${r.getDate()} ${o}`}_tripGico(){return s`<span class="gico trip"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M21.62 3.05a1 1 0 0 0-1.12-.18L3.7 10.3c-.86.38-.83 1.62.05 1.95l6.06 2.27 2.27 6.06c.33.88 1.57.9 1.95.05L21.8 4.17a1 1 0 0 0-.18-1.12zM10.5 12.7l6.4-5.7-4.9 6.6-.1.1z"/></svg></span>`}_eventGico(){return s`<span class="gico event"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M11.1 6.7C10.4 5 9.2 3.7 7.8 3.3c-1-.3-1.9.1-2.2.9-.4 1 .2 2.1 1 2.7 1 .75 2.5 1.05 4.5 1.05z"/><path d="M12.9 6.7c.7-1.7 1.9-3 3.3-3.4 1-.3 1.9.1 2.2.9.4 1-.2 2.1-1 2.7-1 .75-2.5 1.05-4.5 1.05z"/><rect x="3" y="8" width="8.1" height="3.5" rx="1"/><rect x="12.9" y="8" width="8.1" height="3.5" rx="1"/><rect x="4.1" y="11.7" width="7" height="9.1" rx="1.4"/><rect x="12.9" y="11.7" width="7" height="9.1" rx="1.4"/></svg></span>`}_holidayGico(){return s`<span class="gico holiday"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M15 4V2M15 4V6M15 4H10.5M3 10V19C3 20.1046 3.89543 21 5 21H19C20.1046 21 21 20.1046 21 19V10H3Z"/><path d="M3 10V6C3 4.89543 3.89543 4 5 4H7"/><path d="M7 2V6"/><path d="M21 10V6C21 4.89543 20.1046 4 19 4H18.5"/></svg></span>`}_schoolGico(){return s`<span class="gico school"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 10l9-5 9 5-9 5-9-5z"/><path d="M7 12.5V17c0 1 2.5 2.5 5 2.5s5-1.5 5-2.5v-4.5M21 10v5"/></svg></span>`}_gicoFor(e){return e.kind==="trip"?this._tripGico():e.kind==="holiday"?this._holidayGico():e.kind==="external"?this._schoolGico():this._eventGico()}_renderTodayTab(){const e=this._childData(),t=s`<div class="scope shared">
        ...
        <div class="today-top">
          <div class="today-top-left">
            ...
            ${c?s`<div class="daily">
                  ...
                  <button
                    class="ask"
                    @click=${()=>this._onAskPebble({detail:c.topicForChat||`Tell me more about: ${c.title}`})}
                  >
                    Ask Pebble about this →
                  </button>
                </div>`:s`<div class="daily">
                  <div class="tag">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round"><circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="4" fill="currentColor" stroke="none"/></svg>
                    Pebble's daily
                  </div>
        ...
        <div class="grid-2 today-insight-row">
          ...
          <glass-panel padding="md" variant="strong">
            ...
            ${g?s`<insight-card
                  ...
                  .title=${g.title}
                  .body=${g.body}
                ></insight-card>`:s`<div class="ring-note" style="padding:8px 4px;">Pebble surfaces patterns here as more of ${e.child.name}'s milestones are logged.</div>`}
          </glass-panel>
        </div>
      </section>
    `}_renderActivitiesTab(){var i,r;const e=this._liveImmediate().concat(this._liveExtended()),t=s`<div class="scope shared">
      ...
      ${this._renderCelebrationsSection()}
    `}_renderChildAccessSection(){var o,n;if(this.preview||!this.ppIsMember)return"";const e=this.incomingChildRequests??[],t=Array.isArray((o=this.ppFamily)==null?void 0:o.childViewers)?this.ppFamily.childViewers:[];if(e.length===0&&t.length===0)return"";const i=((n=this.ppFamily)==null?void 0:n.memberProfiles)??{},r=(l,d)=>{var g;return((g=i[l])==null?void 0:g.displayName)??d??`${String(l).charAt(0).toUpperCase()}${String(l).slice(1)}`},a=s`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="3.5"/><path d="M5 20c0-4 3-6 7-6s7 2 7 6" stroke-linecap="round"/></svg>`;return s`
      <section>
        <div class="section-head">
        ...
        <glass-panel padding="md" variant="strong">
          ${e.length===0?"":e.map(l=>s`<div class="set-row">
          ...
          ${t.length===0?"":s`<div class="ring-note">
    ...
    `}_setTheme(e){this._themeLight=e;try{document.documentElement.classList.toggle("theme-light",e),localStorage.setItem("portalTheme",e?"light":"dark");const t=document.querySelector('meta[name="theme-color"]');t&&t.setAttribute("content",e?"#f2ede3":"#1f5c54")}catch{}}_renderCairnTab(){var r,a,o;const e=((r=this.user)==null?void 0:r.displayName)??"You",t=((a=this.user)==null?void 0:a.email)??"",i=((o=this.family)==null?void 0:o.name)??"Your family";return s`
    ...
    `}_renderChildGate(){const e=this.myChildAccessRequest,t=this.children??[],i=t.length>0,r=t.length===1?`${t[0].name}'s`:"the children's",a=s`<button
      class="empty-cta ghost"
      @click=${()=>this._activeTab="activities"}
    >
      Back to Activities
    </button>`;return i?(e==null?void 0:e.status)==="pending"?s`
      ...
      `:(e==null?void 0:e.status)==="approved"?s`
      ...
      <div class="empty-sub">
        ...
        ${(e==null?void 0:e.status)==="declined"?s`<br /><span style="color:var(--text-tertiary);"
    ...
    `:s`
      ...
      Private to parents
    </span>`;if(e.hasPP){const i=e.readonly?"Milestones & growth insights — read-only, shared by the parents":"Milestones and insights",r=e.readonly?s`<span class="scope-chip">
    ...
    `}_renderPebbleTab(){var t,i;const e=this._childData();return this._pebbleAvailable&&e.child?s`
        <child-pebble
          .child=${e.child}
    ...
    `}_renderPebbleFab(){var i,r;if(this._activeTab==="pebble"||!this._pebbleAvailable)return"";const e=this._childData();if(!e.child)return"";const t=s`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"><circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="4.5" fill="currentColor" stroke="none"/></svg>`;return s`
      <button
        class="pebble-fab"
    ...
    `}render(){var r,a,o,n,l,d,g;const e=this._liveImmediate(),t=this._liveExtended(),i=e.concat(t);return s`
      <div class="topbar">
        <div class="brand">
          <img
            class="brand-icon"
        ...
        <div class="who">
          ...
          >
            <member-chip
              ...
              .photo=${((o=this.user)==null?void 0:o.photoURL)??""}
              .hue=${198}
              size="36"
            ></member-chip>
          </button>
  ...
  `);customElements.define("home-screen",Ye);const it="cairn:pendingLoginIntent";class qe extends A{constructor(){super(),this.user=null,this._mode="choose",this._code="",this._familyName="",this._busy=!1,this._error="",this._childName="",this._childDob="",this._childPhotoBlob=null,this._childPhotoPreview=null,this._parentPhotoBlob=null,this._parentPhotoPreview=null,this._flavor="welcome";try{localStorage.getItem(it)==="1"&&(this._flavor="recovery",localStorage.removeItem(it))}catch{}}willUpdate(e){if(e.has("user")&&this.user&&!this._familyName){const t=(this.user.displayName??"").trim().split(/\s+/).slice(-1)[0];t&&t.length>1&&(this._familyName=`${t} Family`)}}_go(e){this._mode=e,this._error=""}_submitJoin(){const e=(this._code??"").trim().toUpperCase().replace(/\s+/g,"");if(!e){this._error="Paste the connect code you were sent.";return}const t=/^[A-Z0-9]{6}$/.test(e),i=/^CAIRN-[A-Z0-9]{3,6}$/.test(e);if(!t&&!i){this._error="Connect codes are 6 characters.";return}this._error="",this.dispatchEvent(new CustomEvent("join-code",{detail:{code:e},bubbles:!0,composed:!0}))}_goChildrenQuestion(){if(!(this._familyName??"").trim()){this._error="Give your family a name.";return}this._error="",this._go("children")}_goAddChild(){this._error="",this._go("addchild")}async _submitNoChildren(){const e=(this._familyName??"").trim();if(!e){this._error="Give your family a name.";return}this._busy=!0,this._error="";try{const t=await m.createCairnOnlyFamily(e);await this._uploadParentPhotoIfAny(t),y(`Welcome to ${e}.`)}catch(t){console.error("Create family failed:",t),this._error=(t==null?void 0:t.code)==="permission-denied"?"Couldn't create the family — Firestore rules may not be deployed yet.":`Couldn't create the family: ${(t==null?void 0:t.message)??"try again"}`}finally{this._busy=!1}}async _submitWithChild(){const e=(this._familyName??"").trim(),t=(this._childName??"").trim();if(!e){this._error="Give your family a name.";return}if(!t){this._error="Add your child's name.";return}if(!this._childDob){this._error="Add your child's date of birth.";return}const i=new Date(`${this._childDob}T00:00:00`);if(Number.isNaN(i.getTime())){this._error="That date of birth doesn't look right.";return}this._busy=!0,this._error="";try{const r=await m.createPebblePathFamily(e),a=await m.createChild(r,{name:t,dateOfBirth:i});if(this._childPhotoBlob)try{await m.uploadChildAvatar(r,a,this._childPhotoBlob)}catch(o){console.warn("child avatar upload failed (non-fatal):",o),y("Family created — couldn't save the photo, add it later.")}await this._uploadParentPhotoIfAny(r),y(`Welcome to ${e}.`)}catch(r){console.error("Create family + child failed:",r),this._error=(r==null?void 0:r.code)==="permission-denied"?"Couldn't set up your family — Firestore rules may not be deployed yet.":`Couldn't set up your family: ${(r==null?void 0:r.message)??"try again"}`}finally{this._busy=!1}}_iconJoin(){return s`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    </svg>`}_iconPerson(){return s`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z" />
    </svg>`}render(){return this._mode==="join"?this._renderJoin():this._mode==="create"?this._renderCreate():this._mode==="children"?this._renderChildren():this._mode==="addchild"?this._renderAddChild():this._renderChoose()}_renderChoose(){const e=this._flavor==="recovery";return s`
      <div class="wrap">
        <glass-panel padding="lg" variant="strong" lifted>
    ...
    `}_renderAvatarPicker({preview:e,inputId:t,onPick:i,onChange:r,ariaLabel:a}){return s`
      <div class="av-pick">
        <button type="button" @click=${i} aria-label=${a}>
          <span class="ring">
            ${e?s`<img src=${e} alt="" />`:s`<svg
                  class="ph"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  aria-hidden="true"
    ...
    `}}_(qe,"properties",{user:{type:Object},_mode:{state:!0},_code:{state:!0},_familyName:{state:!0},_busy:{state:!0},_error:{state:!0},_childName:{state:!0},_childDob:{state:!0},_childPhotoPreview:{state:!0},_parentPhotoPreview:{state:!0},_flavor:{state:!0}}),_(qe,"styles",z`
    * { box-sizing: border-box; }
    :host {
      display: flex;
      align-items: center;
  ...
  `);customElements.define("onboarding-wizard",qe);const W="cairn:pendingJoinCode",rt="cairn:pendingCreateFamily";class bt extends A{constructor(){super(),this.authUser=null,this.loading=!0;const e=new URLSearchParams(window.location.search);if(this.preview=e.has("preview"),this._resetMode=e.has("reset"),this._resetMode)try{localStorage.removeItem(W)}catch{}const t=e.get("join");if(t&&!this._resetMode)try{localStorage.setItem(W,t)}catch{}let i=null;if(!this._resetMode)try{i=localStorage.getItem(W)}catch{}this.joinCode=this._resetMode?null:t??i??null,this.pebbleUser=null,this.family=null,this.children=[],this.trips=[],this.events=[],this.holidays=[],this.ppFamily=null,this.ppIsMember=!1,this.ppChildren=[],this.selectedChildId=null,this.childMilestones=[],this.childInsights=[],this.childDailyCard=null,this.childPebbleMessages=[],this.childPebbleSessions=[],this.ppIsChildViewer=!1,this.incomingChildRequests=[],this.myChildAccessRequest=null,this._unsubAuth=null,this._onDataChange=()=>{this.pebbleUser=m.state.user,this.family=m.state.family,this.children=m.state.children,this.trips=m.state.trips,this.events=m.state.events,this.holidays=m.state.holidays,this.ppFamily=m.state.ppFamily,this.ppIsMember=m.state.ppIsMember,this.ppChildren=m.state.ppChildren,this.selectedChildId=m.state.selectedChildId,this.childMilestones=m.state.childMilestones,this.childInsights=m.state.childInsights,this.childDailyCard=m.state.childDailyCard,this.childPebbleMessages=m.state.childPebbleMessages,this.childPebbleSessions=m.state.childPebbleSessions,this.ppIsChildViewer=m.state.ppIsChildViewer,this.incomingChildRequests=m.state.incomingChildRequests,this.myChildAccessRequest=m.state.myChildAccessRequest,this.userDocResolved=m.userDocResolved},this.userDocResolved=!1}_clearJoinState(){this.joinCode=null;try{localStorage.removeItem(W)}catch{}const e=new URL(window.location.href);e.searchParams.delete("join"),window.history.replaceState({},"",e.toString())}connectedCallback(){if(super.connectedCallback(),typeof document<"u"&&document.documentElement.style.setProperty("--pre-login-bg","url('/portal/assets/pebblepath-daybreak-empty.jpg')"),this.preview){this.loading=!1;return}m.addEventListener("change",this._onDataChange),this._unsubAuth=ct(e=>{if(this.authUser=e,this.loading=!1,e){if(!this._resetMode)try{const t=localStorage.getItem(W);t&&!this.joinCode&&(this.joinCode=t)}catch{}m.start(e.uid),this._consumePendingCreate()}else m.stop(),this.userDocResolved=!1})}async _consumePendingCreate(){let e=null;try{e=localStorage.getItem(rt)}catch{}if(e){try{localStorage.removeItem(rt)}catch{}try{await m.createCairnOnlyFamily(e),y(`Welcome to ${e}.`)}catch(t){console.error("Pending family create failed:",t),y((t==null?void 0:t.code)==="permission-denied"?"Couldn't create the family — Firestore rules may need a redeploy.":`Couldn't create the family: ${(t==null?void 0:t.message)??"try again"}`,{duration:5e3})}}}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._unsubAuth)==null||e.call(this),m.removeEventListener("change",this._onDataChange)}_composeViewer(){var i,r;const e=this.authUser,t=(i=this.pebbleUser)==null?void 0:i.displayName;return{uid:e.uid,displayName:t&&t.trim()||e.displayName||"You",email:e.email??((r=this.pebbleUser)==null?void 0:r.email)??"",photoURL:pt(e,this.pebbleUser)}}_needsOnboarding(){var t,i;return!this.authUser||this.joinCode?!1:this._resetMode?!0:this.userDocResolved?!(((t=this.pebbleUser)==null?void 0:t.familyId)??((i=this.pebbleUser)==null?void 0:i.cairnFamilyId)??null):!1}updated(){this.setAttribute("data-route",this._currentRoute())}_currentRoute(){return this.loading?"loading":this.preview?"home":this.authUser?this.joinCode?"join":!this.userDocResolved&&!this._resetMode||this._needsOnboarding()?"wizard":"home":"register"}render(){return this.loading?s``:this.preview?s`<home-screen preview></home-screen>`:this.authUser?this.joinCode?s`
        <join-family-screen
          .code=${this.joinCode}
          @joined=${()=>this._clearJoinState()}
          @cancel=${()=>this._clearJoinState()}
        ></join-family-screen>
      `:!this.userDocResolved&&!this._resetMode?s``:this._needsOnboarding()?s`
        <onboarding-wizard
          .user=${this.authUser}
          @join-code=${e=>{this.joinCode=e.detail.code;try{localStorage.setItem(W,e.detail.code)}catch{}}}
        ></onboarding-wizard>
      `:s`
      <home-screen
...
//# sourceMappingURL=index-DSpQvQgF.js.map
