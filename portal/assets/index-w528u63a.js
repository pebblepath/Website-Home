        ...
        <div class="two-col">
          ...
          <div>
            ...
            ${l.length===0?s`<div class="panel empty">
                ...
                </div>`:l.map(p=>{const u=He[p.domain]??He.cross,b=Je[p.type]??Je.nudge,f=Vt(`${p.title}${p.type}`);return s`<div class="insight ${u.cls}">
                    <svg
                      class="wm"
                      viewBox=${f.vb}
...
//# sourceMappingURL=index-w528u63a.js.map
