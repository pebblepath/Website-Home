var vt=Object.defineProperty;var yt=(p,e,t)=>e in p?vt(p,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):p[e]=t;var y=(p,e,t)=>yt(p,typeof e!="symbol"?e+"":e,t);import{i as A,a as M,b as o,o as xt}from"./lit-dM6tPkba.js";import{f as wt,h as _t,j as kt,G as Ve,O as $t,k as Ct,s as Pt,l as rt,m as St,n as At,o as Mt,q as It,t as _,v as C,w,x as zt,y as D,z as G,A as z,B as Y,D as H,E as j,H as L,I as Z}from"./firebase-core-DEm61vaB.js";import{g as Dt,h as ie}from"./firebase-functions-ID3qFl3p.js";import{g as Tt,a as W,r as q,u as J}from"./firebase-storage-BqMFCgVD.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(a){if(a.ep)return;a.ep=!0;const r=t(a);fetch(a.href,r)}})();class ue extends A{constructor(){super(),this.variant="default",this.lifted=!1,this.padding="md"}render(){const e=["panel",this.variant==="strong"?"strong":"",this.lifted?"lifted":"",`pad-${this.padding}`].filter(Boolean).join(" ");return o`
      <div class=${e}>
  ...
  `);customElements.define("cairn-mark",me);class st extends A{constructor(){super(),this.size=24,this.color="currentColor",this.mode="production"}render(){const e=Number(this.size)||24,t=this.color||"currentColor",i=this.mode==="template"?{fill:t,opacity:.25}:{fill:"white",opacity:.33};return o`
      <svg
        width=${e}
        height=${e}
        viewBox="0 0 24 24"
  ...
  `);customElements.define("event-form",Ce);class Pe extends A{constructor(){super(),this.immediate=[],this.extended=[]}_self(){return(this.immediate??[]).find(e=>e.role==="self"||e.role==="self-extended")}_family(){return(this.immediate??[]).filter(e=>e.role==="co-parent"||e.role==="child")}_connections(){return this.extended??[]}_pos(e,t,i,a){if(t<=0)return"left:50%;top:50%;";const r=(a+e/t*360)*(Math.PI/180),s=50+i*Math.cos(r),n=50+i*Math.sin(r);return`left:${s}%;top:${n}%;`}_node(e,t,i){const a=(e.displayName??"").split(/\s+/)[0]||e.displayName||"";return o`
    ...
    `}}y(Pe,"properties",{immediate:{type:Array},extended:{type:Array}}),y(Pe,"styles",M`
    * {
      box-sizing: border-box;
    }
    :host {
...
`)}class Ae extends A{constructor(){super(),this.trip=null,this.members=[],this._resizeObs=null}connectedCallback(){super.connectedCallback(),typeof ResizeObserver<"u"&&(this._resizeObs=new ResizeObserver(()=>this._fitTitle()))}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._resizeObs)==null||e.disconnect()}updated(){if(this._resizeObs&&this.renderRoot){const e=this.renderRoot.querySelector("article");e&&!e._observed&&(this._resizeObs.observe(e),e._observed=!0)}this._fitTitle()}_fitTitle(){if(!this.renderRoot)return;const e=this.renderRoot.querySelector("h3");if(!e)return;e.style.fontSize="";let t=19;for(e.style.fontSize=`${t}px`;e.scrollWidth>e.clientWidth+1&&t>13;)t-=.5,e.style.fontSize=`${t}px`}_fmtDates(e,t){const i=$(e),a=$(t);if(!i||!a)return"";const r=i.toLocaleString("en-GB",{month:"short"}),s=a.toLocaleString("en-GB",{month:"short"});return r===s&&i.getFullYear()===a.getFullYear()?`${i.getDate()} – ${a.getDate()} ${r}`:`${i.getDate()} ${r} – ${a.getDate()} ${s}`}async _onShare(e,t,i){i.stopPropagation();const a=Zt(e,t);if(navigator.share)try{await navigator.share({title:`Portal — ${e.title??"activity"}`,text:a})}catch{}else try{await navigator.clipboard.writeText(a),m("Itinerary copied to clipboard.")}catch{m("Could not copy — try again from a browser tab.")}}render(){const e=this.trip;if(!e)return o``;const t=e.previewImage&&String(e.previewImage).trim()||e.coverImage,i=t?`background-image: url("${t}");`:`background: ${Jt(e)};`,a=t?"cover has-image":"cover",r=new Map(this.members.map(l=>[l.uid,l])),s=(e.attendees??[]).map(l=>r.get(l)).filter(Boolean),n=s.slice(0,4),d=Math.max(0,s.length-n.length);return o`
      ...
      >
        ...
        <div class="body">
          ...
          ${e.lodgingUrl||e.lodgingHost?(()=>{const l=gt(e);return o`<div class="lodging">
  ...
  `);customElements.define("all-trips-modal",Me);class Ie extends A{constructor(){super(),this.open=!1,this._events=[],this._selected=new Set,this._loading=!1,this._error="",this._importing=!1,this._started=!1,this._mode=null,this._targetTripId="",this._skippedOutOfRange=0,this._addedCount=0}willUpdate(e){e.has("open")&&this.open&&(this._started=!1,this._error="",this._mode=null,this._targetTripId="",this._skippedOutOfRange=0,this._addedCount=0)}_eligibleTrips(){const e=new Date().toISOString().slice(0,10);return(Array.isArray(b.state.trips)?b.state.trips:[]).filter(i=>i&&i.end&&String(i.end)>=e).sort((i,a)=>String(i.start||"").localeCompare(String(a.start||"")))}_pickMode(e){this._mode=e}_pickTrip(e){this._targetTripId=e}_start(){this._loading||(this._started=!0,this._load())}async _load(){var e,t,i,a,r,s;this._loading=!0,this._error="";try{const n=await ot(),d=await Ht(n,90),l=new Set((b.state.trips??[]).filter(c=>c.gcalEventId).map(c=>c.gcalEventId));this._events=d.map(c=>({...c,_alreadyImported:l.has(c.id)}));const g=new Set;for(const c of this._events){if(c._alreadyImported)continue;const h=((e=c.start)==null?void 0:e.date)??((i=(t=c.start)==null?void 0:t.dateTime)==null?void 0:i.slice(0,10)),f=((a=c.end)==null?void 0:a.date)??((s=(r=c.end)==null?void 0:r.dateTime)==null?void 0:s.slice(0,10));h&&f&&f!==h&&g.add(c.id)}this._selected=g}catch(n){console.error(n),this._error=(n==null?void 0:n.message)??"Could not load calendar events."}finally{this._loading=!1}}_toggle(e){const t=new Set(this._selected);t.has(e)?t.delete(e):t.add(e),this._selected=t}_toggleAll(){const e=this._events.filter(t=>!t._alreadyImported);this._selected.size===e.length?this._selected=new Set:this._selected=new Set(e.map(t=>t.id))}async _import(){var s,n,d,l;if(this._importing||this._selected.size===0)return;this._importing=!0;const e=(s=v==null?void 0:v.currentUser)==null?void 0:s.uid,t=this._events.filter(g=>this._selected.has(g.id));let i=0,a=0,r=0;if(this._mode==="addToTrip"){const g=this._eligibleTrips().find(c=>c.id===this._targetTripId);if(!g){this._importing=!1,m("Couldn’t find that activity. Try again.",{duration:4e3});return}for(const c of t){const h=((n=c.start)==null?void 0:n.date)??((l=(d=c.start)==null?void 0:d.dateTime)==null?void 0:l.slice(0,10));if(!h){r++;continue}if(h<g.start||h>g.end){r++;continue}const f=this._calendarEventToPlanItem(c,h);try{await b.addPlanItem(g.id,f),i++}catch(x){console.error("addPlanItem failed for event",c.id,x),a++}}this._importing=!1,this._skippedOutOfRange=r,this._addedCount=i;return}for(const g of t){const c=Wt(g,e);try{await b.saveTrip(c),i++}catch(h){console.error("Import failed for event",g.id,h),a++}}this._importing=!1,a===0?m(`Imported ${i} ${i===1?"activity":"activities"}.`):m(`Imported ${i}, ${a} failed.`,{duration:5e3}),this._events=[],this._selected=new Set,this.dispatchEvent(new Event("cancel"))}_calendarEventToPlanItem(e,t){var n,d;const i=`${e.summary??""} ${e.description??""}`.toLowerCase();let a="visit";/(lunch|dinner|breakfast|brunch|coffee|restaurant|caf[eé])/i.test(i)?a="meal":/(flight|airline|airport|drive|train|taxi|uber|lyft|transfer)/i.test(i)&&(a="travel");let r="",s;if((n=e.start)!=null&&n.dateTime&&((d=e.end)!=null&&d.dateTime)){const l=new Date(e.start.dateTime),g=new Date(e.end.dateTime),c=String(l.getHours()).padStart(2,"0"),h=String(l.getMinutes()).padStart(2,"0");r=`${c}:${h}`;const f=Math.round((g-l)/6e4);f>0&&(s=Math.min(f,600))}return{title:(e.summary||"(untitled)").trim(),type:a,day:t,time:r,durationMins:s}}_openPlannerForTarget(){this._targetTripId&&(this.dispatchEvent(new CustomEvent("open-trip-planner",{detail:{tripId:this._targetTripId},bubbles:!0,composed:!0})),this._closeAndReset())}_closeAndReset(){this._events=[],this._selected=new Set,this._mode=null,this._targetTripId="",this._skippedOutOfRange=0,this._addedCount=0,this._started=!1,this.dispatchEvent(new Event("cancel"))}_onCancel(){this.dispatchEvent(new Event("cancel"))}_fmtRange(e){var g,c,h,f,x,P,I,k;const t=((g=e.start)==null?void 0:g.date)??((h=(c=e.start)==null?void 0:c.dateTime)==null?void 0:h.slice(0,10)),i=((f=e.end)==null?void 0:f.date)??((P=(x=e.end)==null?void 0:x.dateTime)==null?void 0:P.slice(0,10));if(!t)return"";const a=new Date(t);if(!i||i===t)return a.toLocaleString("en-GB",{day:"numeric",month:"short",year:"numeric"});let r=new Date(i);(I=e.start)!=null&&I.date&&((k=e.end)!=null&&k.date)&&r.setDate(r.getDate()-1);const s=a.getMonth()===r.getMonth()&&a.getFullYear()===r.getFullYear(),n=a.getFullYear()===r.getFullYear();if(s)return`${a.getDate()}–${r.getDate()} ${a.toLocaleString("en-GB",{month:"short",year:"numeric"})}`;const d=a.toLocaleString("en-GB",{day:"numeric",month:"short"}),l=r.toLocaleString("en-GB",{day:"numeric",month:"short",year:"numeric"});return n?`${d} – ${l}`:`${a.toLocaleDateString()} – ${r.toLocaleDateString()}`}render(){if(!this.open)return o``;const e=this._events.filter(s=>!s._alreadyImported),t=e.length>0&&this._selected.size===e.length,i=this._mode===null,a=this._mode==="addToTrip"&&!this._targetTripId,r=this._mode==="addToTrip"&&this._addedCount>0&&!this._importing;return o`
    ...
    `}_renderLoadAndList(e,t){return o`
      ...
      ${this._started?this._loading?o`<div class="loading">Loading your calendar…</div>`:this._error?o`
              ...
              `}
    `}}y(Ie,"properties",{open:{type:Boolean,reflect:!0},_events:{state:!0},_selected:{state:!0},_loading:{state:!0},_error:{state:!0},_importing:{state:!0},_started:{state:!0},_mode:{state:!0},_targetTripId:{state:!0},_skippedOutOfRange:{state:!0},_addedCount:{state:!0}}),y(Ie,"styles",M`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("import-calendar-modal",Ie);class ze extends A{constructor(){super(),this.open=!1,this.user=null,this.pebbleUser=null,this._name="",this._savingName=!1,this._uploadingPhoto=!1}willUpdate(e){var t;e.has("open")&&this.open&&(this._name=((t=this.user)==null?void 0:t.displayName)??"")}_onCancel(){this.dispatchEvent(new Event("cancel"))}async _saveName(){var i,a;const e=this._name.trim();if(!e||e===(((i=this.user)==null?void 0:i.displayName)??""))return;const t=(a=v==null?void 0:v.currentUser)==null?void 0:a.uid;if(!(!t||!u)){this._savingName=!0;try{await C(_(u,"users",t),{displayName:e,updatedAt:w()});const r=b.familyId;if(r)try{await C(_(u,"families",r),{[`memberProfiles.${t}.displayName`]:e,[`memberProfiles.${t}.updatedAt`]:w(),updatedAt:w()})}catch(s){console.warn("memberProfiles fan-out failed:",s)}m("Display name updated.")}catch(r){console.error(r),m(`Couldn't save: ${r.code??r.message}`,{duration:5e3})}finally{this._savingName=!1}}}async _signOut(){confirm("Sign out of PebblePath?")&&(this.dispatchEvent(new Event("cancel")),await ct())}_triggerPhotoPicker(){var e;(e=this.renderRoot.querySelector("#photo-file"))==null||e.click()}async _onPhotoChosen(e){var r,s;const t=(r=e.target.files)==null?void 0:r[0];if(e.target.value="",!t)return;if(!t.type.startsWith("image/")){m("Pick an image file (JPG, PNG, etc.).");return}if(t.size>5*1024*1024){m("Photo is too big — keep it under 5 MB.");return}const i=(s=v==null?void 0:v.currentUser)==null?void 0:s.uid,a=b.familyId;if(!i||!a||!T){m("Can't upload yet — you need to be in a family first.");return}this._uploadingPhoto=!0;try{const n=q(T,`families/${a}/avatars/users/${i}`);await J(n,t,{contentType:t.type});const d=await W(n);await C(_(u,"users",i),{profilePhotoURL:d,updatedAt:w()});try{await C(_(u,"families",a),{[`memberProfiles.${i}.profilePhotoURL`]:d,[`memberProfiles.${i}.updatedAt`]:w(),updatedAt:w()})}catch(l){console.warn("memberProfiles photo fan-out failed:",l)}m("Photo updated.")}catch(n){console.error("Photo upload failed",n),m(`Upload failed: ${n.code??n.message}`,{duration:5e3})}finally{this._uploadingPhoto=!1}}render(){if(!this.open)return o``;const e=this.user,t=this._name.trim()&&this._name.trim()!==((e==null?void 0:e.displayName)??"");return o`
    ...
    `}}y(ze,"properties",{open:{type:Boolean,reflect:!0},user:{type:Object},pebbleUser:{type:Object},_name:{state:!0},_savingName:{state:!0},_uploadingPhoto:{state:!0}}),y(ze,"styles",M`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("profile-sheet",ze);const re=class re extends A{constructor(){super(),this.open=!1}static get OPTIONS(){return[{type:"activity",tone:"sage",icon:o`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    `:o``}};y(re,"properties",{open:{type:Boolean,reflect:!0}}),y(re,"styles",M`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);let De=re;customElements.define("activity-type-picker",De);class Te extends A{constructor(){super(),this.open=!1,this.floating=!1,this.family=null,this.trips=[],this._messages=[],this._input="",this._loading=!1,this._error="",this._followUps=[]}willUpdate(e){var t;e.has("_messages")&&(this.floating=(((t=this._messages)==null?void 0:t.length)??0)>0)}_onCancel(){this.dispatchEvent(new Event("cancel"))}_suggestions(){const e=[],t=(this.trips??[]).filter(i=>i.start&&new Date(i.start)>=new Date).sort((i,a)=>String(i.start).localeCompare(String(a.start)))[0];return t&&(e.push(`What should we do in ${t.location||t.title}?`),e.push(`What should we pack for ${t.title}?`)),e.push("Plan a family activity for this weekend"),e.push("Gift ideas for an upcoming birthday"),e.slice(0,4)}async _send(e){const t=(e??this._input).trim();if(!(!t||this._loading)){this._error="",this._input="",this._followUps=[],this._messages=[...this._messages,{role:"user",content:t}],this._loading=!0,this.updateComplete.then(()=>this._scrollToBottom());try{const i=this._messages.slice(0,-1).map(r=>({role:r.role,content:r.content})),a=await b.askPebble(t,i);this._messages=[...this._messages,{role:"assistant",content:a.answer}],this._followUps=Array.isArray(a.followUps)?a.followUps:[]}catch(i){console.error(i),(i==null?void 0:i.code)==="functions/unauthenticated"?this._error="Pebble needs you to be signed in.":(i==null?void 0:i.code)==="functions/permission-denied"?this._error="You're not in this family yet.":(i==null?void 0:i.code)==="functions/not-found"||(i==null?void 0:i.code)==="functions/internal"?this._error="Pebble isn't available right now — the Cloud Function may not be deployed yet.":this._error=(i==null?void 0:i.message)??"Pebble could not answer right now."}finally{this._loading=!1,this.updateComplete.then(()=>this._scrollToBottom())}}}_scrollToBottom(){const e=this.renderRoot.querySelector(".thread");e&&(e.scrollTop=e.scrollHeight)}_renderPebbleIcon(){return o`<pebble-icon color="#fff"></pebble-icon>`}render(){if(!this.open)return o``;const e=this._suggestions();return o`
    ...
    `}}y(Te,"properties",{open:{type:Boolean,reflect:!0},floating:{type:Boolean,reflect:!0},family:{type:Object},trips:{type:Array},_messages:{state:!0},_input:{state:!0},_loading:{state:!0},_error:{state:!0},_followUps:{state:!0}}),y(Te,"styles",M`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("pebble-chat",Te);class ut extends A{render(){return o`
  ...
  `);customElements.define("discover-pebblepath",ut);class Ee extends A{constructor(){super(),this.code="",this._family=null,this._loading=!0,this._joining=!1,this._error="",this._step="join",this._children=[],this._claiming=!1,this._claimedName=null,this._joinedFamilyId=null}willUpdate(e){e.has("code")&&this.code&&this._lookup()}async _lookup(){var e;this._loading=!0,this._error="";try{const t=await b.findFamilyByConnectCode(this.code);if(!t)this._error="Invite code not found. Check it was typed correctly.",this._family=null;else{const i=t._matchedCodeKind==="pp"?t.inviteCodeExpiresAt:t.cairnInviteCodeExpiresAt,a=((e=i==null?void 0:i.toDate)==null?void 0:e.call(i))??(i?new Date(i):null);!a||a<new Date?(this._error="This invite code has expired. Ask the family for a fresh one.",this._family=null):this._family=t}}catch(t){console.error(t),this._error=(t==null?void 0:t.message)??"Couldn't look up the invite."}finally{this._loading=!1}}async _join(){var e;if(!this._joining){this._joining=!0,this._error="";try{const t=await b.redeemConnectCode(this.code);m(`Welcome to ${((e=this._family)==null?void 0:e.name)??"the family"}.`),this._joinedFamilyId=t;const i=await b.fetchFamilyChildren(t);Array.isArray(i)&&i.length?(this._children=i,this._step="parent"):this.dispatchEvent(new CustomEvent("joined",{detail:{familyId:t}}))}catch(t){console.error(t),this._error=(t==null?void 0:t.message)??"Could not join."}finally{this._joining=!1}}}async _claimChild(e){if(!(this._claiming||!(e!=null&&e.id))){this._claiming=!0,this._error="";try{await b.requestToBeCoParent(e.id),this._claimedName=e.name??"your child"}catch(t){console.error(t),this._error=(t==null?void 0:t.message)??"Couldn't send the request."}finally{this._claiming=!1}}}_notAParent(){this._finishJoin()}_finishJoin(){this.dispatchEvent(new CustomEvent("joined",{detail:{familyId:this._joinedFamilyId}}))}_cancel(){this.dispatchEvent(new Event("cancel"))}_inviterFromFamily(e){var a;if(!e)return null;const t=(a=e.memberProfiles)==null?void 0:a[e.createdBy];if(!t)return null;const i=t.profilePhotoURL;return{displayName:t.displayName??"A family member",photoURL:typeof i=="string"&&/^https?:\/\//i.test(i)?i:null}}_renderParentPrompt(){var t;const e=((t=this._family)==null?void 0:t.name)??"this family";return o`
    ...
    `}}y(Ee,"properties",{code:{type:String},_family:{state:!0},_loading:{state:!0},_joining:{state:!0},_error:{state:!0},_step:{state:!0},_children:{state:!0},_claiming:{state:!0},_claimedName:{state:!0}}),y(Ee,"styles",M`
    * { box-sizing: border-box; }
    :host {
      display: flex;
      align-items: center;
  ...
  `);customElements.define("join-family-screen",Ee);class Fe extends A{constructor(){super(),this.error="",this.busy=!1,this.joinCode="",this._codeInputOpen=!1,this._code=""}async _handleSignIn(){if(this.busy)return;const e=(this._code??"").trim().toUpperCase();if(this._codeInputOpen&&e){const t=e.startsWith("CAIRN-")?e:`CAIRN-${e.replace(/^CAIRN-?/i,"")}`;try{localStorage.setItem("cairn:pendingJoinCode",t)}catch{}}this.busy=!0,this.error="";try{await de()}catch(t){this.error=(t==null?void 0:t.message)??"Sign-in failed."}finally{this.busy=!1}}_toggleCode(){this._codeInputOpen=!this._codeInputOpen,this._codeInputOpen&&requestAnimationFrame(()=>{var e;(e=this.renderRoot.querySelector(".code-input"))==null||e.focus()})}_renderGoogleIcon(){return o`
    ...
    `}}y(Fe,"properties",{error:{state:!0},busy:{state:!0},joinCode:{type:String},_codeInputOpen:{state:!0},_code:{state:!0}}),y(Fe,"styles",M`
    * {
      box-sizing: border-box;
    }
    :host {
  ...
  `);let Re=Q;customElements.define("circle-switcher",Re);class Oe extends A{constructor(){super(),this.event=null,this.members=[]}_icon(e){return e==="birthday"?o`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
    ...
    `}}y(Oe,"properties",{event:{type:Object},members:{type:Array}}),y(Oe,"styles",M`
    :host {
      display: block;
    }
    .row {
  ...
  `);customElements.define("event-row",Oe);class Be extends A{constructor(){super();y(this,"_accept","application/pdf,image/*,application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/msword");this.open=!1,this._reset()}_reset(){this._phase="pick",this._events=[],this._err="",this._count=0}willUpdate(t){t.has("open")&&this.open&&this._reset()}_cancel(){this.dispatchEvent(new Event("cancel"))}async _onFile(t){var a;const i=(a=t.target.files)==null?void 0:a[0];if(t.target.value="",!!i){this._phase="working",this._err="";try{const{storagePath:r,fileType:s}=await b.uploadSchoolCalendar(i),n=await b.extractSchoolCalendarEvents(r,s);if(!n.length){this._phase="error",this._err="Couldn't find any dated events in that file. Try a clearer PDF or a screenshot of the calendar.";return}this._events=n.map(d=>({...d,_sel:!0})).sort((d,l)=>String(d.date).localeCompare(String(l.date))),this._phase="review"}catch(r){console.error("school import failed:",r),this._phase="error",this._err=(r==null?void 0:r.code)==="functions/permission-denied"?"You're not a member of this family.":(r==null?void 0:r.code)==="storage/unauthorized"?"The upload rule needs publishing — ask the team to deploy storage.rules.":(r==null?void 0:r.code)==="functions/not-found"||(r==null?void 0:r.code)==="functions/internal"?"The importer isn't available right now — try again in a moment.":(r==null?void 0:r.message)??"Something went wrong — try again."}}}_patch(t,i,a){const r=this._events.slice();r[t]={...r[t],[i]:a},this._events=r}get _selected(){return this._events.filter(t=>t._sel&&/^\d{4}-\d{2}-\d{2}$/.test(t.date)&&t.title.trim())}async _confirm(){const t=this._selected;if(t.length){this._phase="working";try{const i=await b.importSchoolEvents(t.map(a=>({date:a.date,title:a.title.trim(),type:a.type})));this._count=i,this._phase="done",m(`Added ${i} event${i===1?"":"s"} to the calendar.`),this.dispatchEvent(new CustomEvent("added",{detail:i}))}catch(i){console.error("importSchoolEvents failed:",i),this._phase="error",this._err=(i==null?void 0:i.code)==="permission-denied"?"Couldn't save — you may not have permission.":(i==null?void 0:i.message)??"Couldn't save the events — try again."}}}render(){return this.open?o`
    ...
    `:o``}}y(Be,"properties",{open:{type:Boolean,reflect:!0},_phase:{state:!0},_events:{state:!0},_err:{state:!0},_count:{state:!0}}),y(Be,"styles",M`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("school-import-modal",Be);const Xe=[{vb:"0 0 100 70",d:"M 8 38 C 6 18, 26 6, 48 8 C 72 10, 94 18, 94 38 C 94 58, 72 66, 48 64 C 22 62, 10 58, 8 38 Z"},{vb:"0 0 80 90",d:"M 38 6 C 56 8, 70 24, 72 46 C 74 70, 58 84, 38 84 C 16 84, 6 66, 8 44 C 10 22, 22 4, 38 6 Z"},{vb:"0 0 90 80",d:"M 14 26 C 18 10, 38 4, 56 8 C 78 14, 86 32, 82 50 C 76 70, 54 78, 32 72 C 12 66, 10 42, 14 26 Z"},{vb:"0 0 70 60",d:"M 8 30 C 8 14, 22 6, 38 8 C 54 10, 64 22, 62 36 C 60 52, 44 56, 28 54 C 14 52, 8 44, 8 30 Z"},{vb:"0 0 110 75",d:"M 8 38 C 6 18, 30 8, 56 10 C 84 12, 104 22, 104 40 C 102 58, 80 68, 52 66 C 24 64, 10 56, 8 38 Z"},{vb:"0 0 95 75",d:"M 14 24 C 18 10, 40 6, 56 12 C 70 18, 80 18, 86 30 C 90 44, 80 56, 64 60 C 48 64, 28 60, 18 50 C 10 42, 10 32, 14 24 Z"},{vb:"0 0 80 80",d:"M 14 20 C 20 10, 36 6, 52 10 C 68 16, 76 30, 72 48 C 66 64, 50 72, 32 66 C 16 60, 8 44, 10 30 C 12 24, 12 22, 14 20 Z"}];function ei(p){let e=5381;const t=String(p??"");for(let i=0;i<t.length;i+=1)e=e*33^t.charCodeAt(i);return Xe[Math.abs(e)%Xe.length]}const Ze={motor:{cls:"fam-motor",fill:"#6b9ac4",dom:"Motor"},language:{cls:"fam-language",fill:"#d4a843",dom:"Language"},socialEmotional:{cls:"fam-social",fill:"#c98a8a",dom:"Social-Emotional"},cognitive:{cls:"fam-cognitive",fill:"#8b7bb5",dom:"Cognitive"},cross:{cls:"fam-cross",fill:"#3d9b8f",dom:""}},Qe={strength:{label:"Strength",svg:o`<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M12 2.5l2.94 5.96 6.58.96-4.76 4.64 1.12 6.55L12 17.6l-5.88 3.01 1.12-6.55-4.76-4.64 6.58-.96L12 2.5z"/></svg>`},watching:{label:"Watching",svg:o`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M1.5 12S5 5 12 5s10.5 7 10.5 7-3.5 7-10.5 7S1.5 12 1.5 12z"/><circle cx="12" cy="12" r="3.2"/></svg>`},connection:{label:"Connection",svg:o`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M10 13a5 5 0 0 0 7.07.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71M14 11a5 5 0 0 0-7.07-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>`},nudge:{label:"Try this",svg:o`<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M9 21c0 .55.45 1 1 1h4c.55 0 1-.45 1-1v-1H9v1zm3-19C8.14 2 5 5.14 5 9c0 2.38 1.19 4.47 3 5.74V17c0 .55.45 1 1 1h6c.55 0 1-.45 1-1v-2.26c1.81-1.27 3-3.36 3-5.74 0-3.86-3.14-7-7-7z"/></svg>`}};class je extends A{constructor(){super(),this.type="nudge",this.domain="cross",this.title="",this.body=""}render(){const e=Ze[this.domain]??Ze.cross,t=Qe[this.type]??Qe.nudge,i=ei(`${this.title}${this.type}`);return o`
    ...
    `}}y(je,"properties",{type:{type:String},domain:{type:String},title:{type:String},body:{type:String}}),y(je,"styles",M`
  ...
  `);customElements.define("insight-card",je);const se=[{key:"motor",label:"Motor",color:"#6b9ac4",svg:o`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><circle cx="13.5" cy="5.5" r="2"/><path d="M9.8 8.9 7 23h2.1l1.8-8 2.1 2v6h2v-7.5l-2.1-2 .6-3c1.3 1.5 3.3 2.5 5.5 2.5v-2c-1.9 0-3.5-1-4.3-2.4l-1-1.6c-.4-.6-1-1-1.7-1-.3 0-.5 0-.8.1L6 7.6V12h2V8.9l1.8-.7z"/></svg>`},{key:"language",label:"Language",color:"#d4a843",svg:o`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M20 2H4a2 2 0 0 0-2 2v18l4-4h14a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2z"/></svg>`},{key:"socialEmotional",label:"Social-Emotional",color:"#c98a8a",svg:o`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg>`},{key:"cognitive",label:"Cognitive",color:"#8b7bb5",svg:o`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M11 4.2A2.7 2.7 0 0 0 6.4 5.9a2.6 2.6 0 0 0-2.5 2.6c0 .5.1.9.3 1.3A2.7 2.7 0 0 0 3 12.2a2.7 2.7 0 0 0 1.2 2.2 2.6 2.6 0 0 0-.2 1c0 1.5 1.2 2.7 2.7 2.7.2 0 .4 0 .6-.1A2.7 2.7 0 0 0 11 20V4.2zm2 0v15.8a2.7 2.7 0 0 0 3.7-1.9c.2 0 .4.1.6.1 1.5 0 2.7-1.2 2.7-2.7 0-.4-.1-.7-.2-1A2.7 2.7 0 0 0 21 12.2a2.7 2.7 0 0 0-1.2-2.4c.2-.4.3-.8.3-1.3a2.6 2.6 0 0 0-2.5-2.6A2.7 2.7 0 0 0 13 4.2z"/></svg>`}];function te(p){return p==="selfCare"?"motor":p}function ti(p){var s;if(!p||Number.isNaN(((s=p.getTime)==null?void 0:s.call(p))??NaN))return"";const e=new Date;let t=(e.getFullYear()-p.getFullYear())*12+(e.getMonth()-p.getMonth());e.getDate()<p.getDate()&&(t-=1),t=Math.max(0,t);const i=Math.floor(t/12),a=t%12;if(i===0)return`${a} month${a===1?"":"s"}`;const r=a?`, ${a} month${a===1?"":"s"}`:"";return`${i} year${i===1?"":"s"}${r}`}class Le extends A{constructor(){super(),this.child=null,this.children=[],this.milestones=[],this.insights=[],this.dailyCard=null,this.readonly=!1}_domainStats(e){const t=(this.milestones??[]).filter(r=>te(r.category)===e),i=t.filter(r=>r.status==="achieved").length,a=t.length;return{achieved:i,total:a,pct:a?Math.round(i/a*100):0}}_pebbleIcon(){return o`<pebble-icon></pebble-icon>`}_ageMonths(e){var a;if(!e||Number.isNaN(((a=e.getTime)==null?void 0:a.call(e))??NaN))return 0;const t=new Date;let i=(t.getFullYear()-e.getFullYear())*12+(t.getMonth()-e.getMonth());return t.getDate()<e.getDate()&&(i-=1),Math.max(0,i)}_timelineModel(){var g;const e=this.milestones??[],t=this._ageMonths((g=this.child)==null?void 0:g.dateOfBirth),i=e.reduce((c,h)=>h.status==="achieved"?Math.max(c,h.ageRangeEndMonths??h.ageRangeStartMonths??0):c,0);let a=Math.max(i+12,t+6,18);a=Math.ceil(a/6)*6;const r=c=>Math.min(98,Math.max(2,(c??0)/a*100)),s=[{key:"motor",cls:"motor",name:"Motor"},{key:"language",cls:"language",name:"Language"},{key:"socialEmotional",cls:"social",name:"Social-Emo."},{key:"cognitive",cls:"cognitive",name:"Cognitive"}].map(c=>{const h=e.filter(k=>te(k.category)===c.key),f=h.filter(k=>k.status==="achieved").sort((k,S)=>(k.ageRangeStartMonths??0)-(S.ageRangeStartMonths??0));let x=f;f.length>7&&(x=Array.from({length:7},(k,S)=>f[Math.round(S*(f.length-1)/6)]));const P=x.map(k=>({left:r(k.ageRangeStartMonths),future:!1})),I=h.filter(k=>k.status!=="achieved").sort((k,S)=>(k.ageRangeStartMonths??0)-(S.ageRangeStartMonths??0))[0];return I&&P.push({left:r(I.ageRangeStartMonths),future:!0}),{...c,dots:P}}),n=c=>c<=0?"birth":c<24?`${c} mo`:c%12===0?`${c/12} yr`:`${(c/12).toFixed(1).replace(/\.0$/,"")} yr`,d=Array.from({length:7},(c,h)=>n(Math.round(h*a/6))),l=Math.min(1,Math.max(0,t/a));return{lanes:s,axis:d,ageM:t,nowFrac:l}}render(){const e=this.child;if(!e)return o`<div class="panel empty">No child selected yet.</div>`;const t=this.milestones??[],i=t.filter(h=>h.status==="achieved"),a=t.length?Math.round(i.length/t.length*100):0,r=i.slice().sort((h,f)=>(f.ageRangeStartMonths??0)-(h.ageRangeStartMonths??0)).slice(0,4),s=t.filter(h=>h.status!=="achieved").slice(0,5),n=e.themeColorHex||"var(--teal-pebble)",d=this.insights??[],l=this._timelineModel(),g=h=>h==="achieved"?"done":h==="emerging"?"emerging":"up",c=h=>h==="achieved"?"Achieved":h==="emerging"?"Emerging":"Upcoming";return o`
      ...
      <section>
        ...
        >
          ...
          <div class="meta">
            <h2>${e.name}</h2>
            <div class="sub">${ti(e.dateOfBirth)}</div>
            <span class="agepill"
      ...
      <section>
        ...
        <div class="domains">
          ${se.map(h=>{const f=this._domainStats(h.key);return o`<div
              class="dtile"
          ...
          <div>
            ...
            <div class="panel">
              ${s.length===0?o`<div class="empty">
                  ...
                  </div>`:s.map(h=>{var x,P;const f=((x=se.find(I=>I.key===te(h.category)))==null?void 0:x.color)??"#6b9ac4";return o`<div class="ms-row">
                      <span class="ms-dot" style="background:${f}"></span>
                      <div class="t">
                        ${h.title}
                        <small
                          >${((P=se.find(I=>I.key===te(h.category)))==null?void 0:P.label)??""}
            ...
            <div class="panel">
              ${r.length===0?o`<div class="empty">
                  ...
                  </div>`:r.map(h=>{var x;const f=((x=se.find(P=>P.key===te(h.category)))==null?void 0:x.color)??"#6b9ac4";return o`<div class="ms-row">
                      <span class="ms-dot" style="background:${f}"></span>
  ...
  `);customElements.define("child-pebble",Ue);const he=[{key:"visit",label:"Visit"},{key:"meal",label:"Meal"},{key:"travel",label:"Travel"},{key:"note",label:"Note"}],ii=[{m:30,label:"30 min"},{m:60,label:"1 h"},{m:90,label:"1½ h"},{m:120,label:"2 h"},{m:180,label:"3 h"},{m:240,label:"4 h"},{m:480,label:"All day"}],N=40;function et(p){const e=String(p??"").match(/^(\d{4})-(\d{2})-(\d{2})/);return e?new Date(Number(e[1]),Number(e[2])-1,Number(e[3])):null}function ai(p){const e=p.getFullYear(),t=String(p.getMonth()+1).padStart(2,"0"),i=String(p.getDate()).padStart(2,"0");return`${e}-${t}-${i}`}function oe(p){const e=String(p??"").match(/^(\d{1,2}):?(\d{2})?/);return e?Number(e[1])+(e[2]?Number(e[2])/60:0):null}function ge(p){const e=Math.floor(p),t=Math.round((p-e)*60);return`${String(e).padStart(2,"0")}:${String(t).padStart(2,"0")}`}class Ge extends A{constructor(){super(),this.open=!1,this.trip=null,this.members=[],this.currentUid="",this._items=[],this._dayKey=null,this._title="",this._time="12:00",this._type="visit",this._dur=60,this._url="",this._file=null,this._fileName="",this._busy=!1,this._view="day",this._weekStart=0,this._sel=null,this._dragCtx=null,this._onGridMove=this._gridMove.bind(this),this._onGridUp=this._gridUp.bind(this),this._unsub=null,this._subId=null}_weekDays(){const e=this._days();if(e.length<=7)return e;const t=Math.min(Math.max(0,this._weekStart),Math.max(0,e.length-7));return e.slice(t,t+7)}_minFromPointer(e,t,i,a){const r=t.getBoundingClientRect(),s=Math.max(0,Math.min(e-r.top,r.height)),n=i*60+s/N*60,d=Math.round(n/15)*15;return Math.max(i*60,Math.min(a*60,d))}_gridDown(e,t,i,a){if(e.button!=null&&e.button!==0||e.target.closest&&e.target.closest(".evt, .wk-evt, button, a"))return;const r=e.currentTarget,s=this._minFromPointer(e.clientY,r,i,a);this._dragCtx={dayKey:t,lo:i,hi:a,el:r},this._sel={dayKey:t,aMin:s,bMin:s},window.addEventListener("pointermove",this._onGridMove),window.addEventListener("pointerup",this._onGridUp),e.preventDefault()}_gridMove(e){if(!this._dragCtx||!this._sel)return;const{el:t,lo:i,hi:a}=this._dragCtx;this._sel={...this._sel,bMin:this._minFromPointer(e.clientY,t,i,a)}}_gridUp(){window.removeEventListener("pointermove",this._onGridMove),window.removeEventListener("pointerup",this._onGridUp);const e=this._sel,t=this._dragCtx;if(this._sel=null,this._dragCtx=null,!e||!t)return;let i=Math.min(e.aMin,e.bMin),r=Math.max(e.aMin,e.bMin)-i;r<15&&(r=this._dur&&this._dur>=15?this._dur:60);const s=String(Math.floor(i/60)).padStart(2,"0"),n=String(i%60).padStart(2,"0");this._dayKey=e.dayKey,this._time=`${s}:${n}`,this._dur=r,this.updateComplete.then(()=>{const d=this.renderRoot.querySelector(".add-row input.t");d&&d.focus()})}_selGhost(e,t){const i=this._sel;if(!i||i.dayKey!==e)return"";const a=Math.min(i.aMin,i.bMin),r=Math.max(i.aMin,i.bMin),s=(a-t*60)/60*N,n=Math.max(3,(r-a)/60*N),d=`${String(Math.floor(a/60)).padStart(2,"0")}:${String(a%60).padStart(2,"0")}`;return o`<div
        ...
        <div class="wk-body" style="--cols:${t};">
          ...
          ${e.map(l=>{const g=a.filter(c=>String(c.day??"")===String(l.key));return o`<div
            ...
            >
              ...
              ${g.map(c=>{const h=oe(c.time);if(h==null)return"";const f=Math.max(.5,(Number(c.durationMins)||60)/60),x=(h-r)*N+2,P=Math.max(26,f*N-4),I=he.some(k=>k.key===c.type)?c.type:"note";return o`<div
                  class="wk-evt ${I}"
    ...
    `}render(){var d;if(!this.open||!this.trip)return o``;const e=this._days(),t=this._dayKey??((d=e[0])==null?void 0:d.key)??"",i=(this._items||[]).filter(l=>String(l.day??"")===String(t));let a=8,r=20;for(const l of i){const g=oe(l.time);if(g==null)continue;const c=Math.max(.5,(Number(l.durationMins)||60)/60);a=Math.min(a,Math.floor(g)),r=Math.max(r,Math.ceil(g+c))}a=Math.max(0,Math.min(a,8)),r=Math.min(24,Math.max(r,20));const s=[];for(let l=a;l<r;l++)s.push(o`<div class="sched-row">
        <div class="hr">${String(l).padStart(2,"0")}:00</div>
        <div></div>
      </div>`);const n=i.map(l=>{const g=oe(l.time);if(g==null)return null;const c=Math.max(.5,(Number(l.durationMins)||60)/60),h=(g-a)*N+3,f=c*N-8,x=this._member(l.addedBy),P=he.some(I=>I.key===l.type)?l.type:"note";return o`<div
          class="evt ${P}"
      ...
      <section>
        <div class="glass">
          ...
          >
            ...
            >
              ${he.map(l=>o`<option value=${l.key}>${l.label}</option>`)}
            </select>
            <select
              class="dur"
              aria-label="Duration"
