var gt=Object.defineProperty;var ut=(c,e,t)=>e in c?gt(c,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):c[e]=t;var x=(c,e,t)=>ut(c,typeof e!="symbol"?e+"":e,t);import{i as M,a as S,b as s,o as mt}from"./lit-dM6tPkba.js";import{f as bt,h as ft,j as vt,G as Te,O as xt,k as yt,s as wt,l as et,m as _t,n as kt,o as $t,q as Ct,t as D,v as P,w as C,x as zt,y as T,z as L,A as E,B as U,D as ee,E as G,H as V,I as te}from"./firebase-core-WlNQdXp3.js";import{g as Mt,h as X}from"./firebase-functions-EPI35Sfs.js";import{g as St,a as Ne,r as Be,u as tt}from"./firebase-storage-BMyqKy67.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const a of r)if(a.type==="childList")for(const o of a.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function t(r){const a={};return r.integrity&&(a.integrity=r.integrity),r.referrerPolicy&&(a.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?a.credentials="include":r.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(r){if(r.ep)return;r.ep=!0;const a=t(r);fetch(r.href,a)}})();class ne extends M{constructor(){super(),this.variant="default",this.lifted=!1,this.padding="md"}render(){const e=["panel",this.variant==="strong"?"strong":"",this.lifted?"lifted":"",`pad-${this.padding}`].filter(Boolean).join(" ");return s`
  ...
  `);customElements.define("member-chip",ue);class me extends M{constructor(){super(),this.start="",this.end="",this._displayMonth=null,this._hoverDate=null}willUpdate(e){if(e.has("start")||this._displayMonth===null){const t=this.start?$(this.start):new Date;this._displayMonth=new Date(t.getFullYear(),t.getMonth(),1)}}_isoFor(e,t,i){return`${e}-${String(t+1).padStart(2,"0")}-${String(i).padStart(2,"0")}`}_emit(e,t){this.start=e,this.end=t,this._hoverDate=null,this.dispatchEvent(new CustomEvent("range-change",{detail:{start:e,end:t},bubbles:!0,composed:!0}))}_onDayClick(e){if(!this.start||this.start&&this.end){this._emit(e,"");return}e<this.start?this._emit(e,this.start):this._emit(this.start,e)}_onDayHover(e){this.start&&!this.end&&(this._hoverDate=e)}_onLeave(){this._hoverDate=null}_shiftMonth(e){const t=this._displayMonth;this._displayMonth=new Date(t.getFullYear(),t.getMonth()+e,1)}_isToday(e,t,i){const r=new Date;return r.getFullYear()===e&&r.getMonth()===t&&r.getDate()===i}_inSelectedRange(e){return!this.start||!this.end?!1:e>this.start&&e<this.end}_inHoverRange(e){if(!this.start||this.end||!this._hoverDate)return!1;const t=this._hoverDate<this.start?this._hoverDate:this.start,i=this._hoverDate<this.start?this.start:this._hoverDate;return e>t&&e<i}_summary(){if(!this.start&&!this.end)return"Pick a start date";const e=t=>{const i=$(t);return i?i.toLocaleString("en-GB",{day:"numeric",month:"short",year:"numeric"}):""};return this.start&&!this.end?`From ${e(this.start)} — pick an end date`:this.start===this.end?e(this.start):`${e(this.start)} – ${e(this.end)}`}_renderGrid(){const e=this._displayMonth.getFullYear(),t=this._displayMonth.getMonth(),r=(new Date(e,t,1).getDay()+6)%7,a=new Date(e,t+1,0).getDate(),o=[];for(let n=0;n<r;n++)o.push(s`<div class="empty"></div>`);for(let n=1;n<=a;n++){const l=this._isoFor(e,t,n),d=l===this.start,g=l===this.end&&l!==this.start,h=this._inSelectedRange(l),p=this._inHoverRange(l),u=this._isToday(e,t,n),m=["day",d?"start":"",g?"end":"",h?"in-range":"",p?"hover-range":"",u&&!d&&!g?"today":""].filter(Boolean).join(" ");o.push(s`
    ...
    `}}x(me,"properties",{start:{type:String},end:{type:String},_displayMonth:{state:!0},_hoverDate:{state:!0}}),x(me,"styles",S`
    * { box-sizing: border-box; }
    :host {
      display: block;
    }
...
`)}class xe extends M{constructor(){super(),this.trip=null,this.members=[],this._resizeObs=null}connectedCallback(){super.connectedCallback(),typeof ResizeObserver<"u"&&(this._resizeObs=new ResizeObserver(()=>this._fitTitle()))}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._resizeObs)==null||e.disconnect()}updated(){if(this._resizeObs&&this.renderRoot){const e=this.renderRoot.querySelector("article");e&&!e._observed&&(this._resizeObs.observe(e),e._observed=!0)}this._fitTitle()}_fitTitle(){if(!this.renderRoot)return;const e=this.renderRoot.querySelector("h3");if(!e)return;e.style.fontSize="";let t=19;for(e.style.fontSize=`${t}px`;e.scrollWidth>e.clientWidth+1&&t>13;)t-=.5,e.style.fontSize=`${t}px`}_fmtDates(e,t){const i=$(e),r=$(t);if(!i||!r)return"";const a=i.toLocaleString("en-GB",{month:"short"}),o=r.toLocaleString("en-GB",{month:"short"});return a===o&&i.getFullYear()===r.getFullYear()?`${i.getDate()} – ${r.getDate()} ${a}`:`${i.getDate()} ${a} – ${r.getDate()} ${o}`}async _onShare(e,t,i){i.stopPropagation();const r=Gt(e,t);if(navigator.share)try{await navigator.share({title:`Cairn — ${e.title??"activity"}`,text:r})}catch{}else try{await navigator.clipboard.writeText(r),w("Itinerary copied to clipboard.")}catch{w("Could not copy — try again from a browser tab.")}}render(){const e=this.trip;if(!e)return s``;const t=e.coverImage?`background-image: url(${e.coverImage});`:`background: ${Lt(e)};`,i=e.coverImage?"cover has-image":"cover",r=new Map(this.members.map(l=>[l.uid,l])),a=(e.attendees??[]).map(l=>r.get(l)).filter(Boolean),o=a.slice(0,4),n=Math.max(0,a.length-o.length);return s`
        ...
        <div class="two-col">
          <div>
            ...
            <div class="panel">
              ${o.length===0?s`<div class="empty">
                  ...
                  </div>`:o.map(p=>{var m,f;const u=((m=Q.find(b=>b.key===J(p.category)))==null?void 0:m.color)??"#6b9ac4";return s`<div class="ms-row">
                      <span class="ms-dot" style="background:${u}"></span>
                      <div class="t">
                        ${p.title}
                        <small
                          >${((f=Q.find(b=>b.key===J(p.category)))==null?void 0:f.label)??""}
            ...
            <div class="panel">
              ${a.length===0?s`<div class="empty">
                  ...
                  </div>`:a.map(p=>{var m;const u=((m=Q.find(f=>f.key===J(p.category)))==null?void 0:m.color)??"#6b9ac4";return s`<div class="ms-row">
                      <span class="ms-dot" style="background:${u}"></span>
          ...
          <div>
            ...
            ${l.length===0?s`<div class="panel empty">
                ...
                </div>`:l.map(p=>{const u=He[p.domain]??He.cross,m=Je[p.type]??Je.nudge,f=Vt(`${p.title}${p.type}`);return s`<div class="insight ${u.cls}">
                    <svg
                      class="wm"
                      viewBox=${f.vb}
  ...
  `);customElements.define("child-overview",Ie);class Ae extends M{constructor(){super(),this.child=null,this.messages=[],this.prefill="",this.memberProfiles={},this.myUid="",this._session=[],this._input="",this._loading=!1,this._error="",this._seeded=!1}willUpdate(e){e.has("child")&&(this._seeded=!1,this._session=[],this._error=""),!this._seeded&&Array.isArray(this.messages)&&this.messages.length&&(this._session=this.messages.map(t=>({role:t.role,content:t.content,senderUid:t.senderUid})),this._seeded=!0),e.has("prefill")&&this.prefill&&(this._input=this.prefill)}updated(e){(e.has("messages")||e.has("_session")||e.has("_loading"))&&this.updateComplete.then(()=>this._scrollToBottom())}_scrollToBottom(){const e=this.renderRoot.querySelector(".thread");e&&(e.scrollTop=e.scrollHeight)}_suggestions(){var t;const e=((t=this.child)==null?void 0:t.name)??"your child";return[`What's coming up for ${e}?`,`Ideas for a rainy weekend with ${e}`,`Is ${e}'s speech on track?`,`How can I support ${e} this week?`]}async _send(e){var r;const t=(e??this._input).trim();if(!t||this._loading)return;if(!((r=this.child)!=null&&r.id)){this._error="No child selected.";return}this._error="",this._input="";const i=this._session.slice(-20).map(a=>({role:a.role,content:a.content}));this._session=[...this._session,{role:"user",content:t,senderUid:this.myUid}],this._loading=!0;try{const a=await y.askPebbleAboutChild(this.child.id,t,i);this._session=[...this._session,{role:"assistant",content:(a==null?void 0:a.answer)??"…"}]}catch(a){console.error(a),(a==null?void 0:a.code)==="functions/unauthenticated"?this._error="Pebble needs you to be signed in.":(a==null?void 0:a.code)==="functions/permission-denied"?this._error="Pebble's child advisor is for parents on this household.":(a==null?void 0:a.code)==="functions/not-found"||(a==null?void 0:a.code)==="functions/internal"?this._error="Pebble isn't available right now — try again in a moment.":this._error=(a==null?void 0:a.message)??"Pebble could not answer right now."}finally{this._loading=!1}}_pico(){return s`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"><circle cx="12" cy="12" r="9" /><circle cx="12" cy="12" r="4.5" fill="currentColor" stroke="none" /></svg>`}_senderName(e){var i;if(!e||e===this.myUid)return"You";const t=(i=this.memberProfiles)==null?void 0:i[e];return t!=null&&t.displayName?t.displayName:e.charAt(0).toUpperCase()+e.slice(1)}_senderPhoto(e){var i,r;const t=(r=(i=this.memberProfiles)==null?void 0:i[e])==null?void 0:r.profilePhotoURL;return typeof t=="string"&&/^https?:\/\//i.test(t)?t:""}_fmt(e){const i=String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\*\*([^*]+)\*\*/g,"<b>$1</b>").replace(/(^|[\s(])\*([^*\n]+)\*(?=[\s).,!?]|$)/g,"$1<i>$2</i>").replace(/\[([^\]]+)\]\((https?:\/\/[^\s)]+)\)/g,'<a href="$2" target="_blank" rel="noopener">$1</a>');return mt(i)}render(){var i;const e=((i=this.child)==null?void 0:i.name)??"your child",t=this._session.length>0;return s`
    ...
    `}}x(Ae,"properties",{child:{type:Object},messages:{type:Array},prefill:{type:String},memberProfiles:{type:Object},myUid:{type:String},_session:{state:!0},_input:{state:!0},_loading:{state:!0},_error:{state:!0},_seeded:{state:!0}}),x(Ae,"styles",S`
    *, *::before, *::after { box-sizing: border-box; }
    :host { display: block; }
    .wrap {
      max-width: 880px;
  ...
  `);customElements.define("trip-planner",Ee);const Wt={uid:"preview-user",displayName:"Thomas Paris",email:"thomas@example.com",photoURL:null},qe=[{uid:"thomas",displayName:"Thomas",circles:["immediate"],hue:198},{uid:"partner",displayName:"Élise",circles:["immediate"],hue:8},{uid:"kid1",displayName:"Oscar",circles:["immediate"],hue:142},{uid:"kid2",displayName:"Mila",circles:["immediate"],hue:44},{uid:"mum",displayName:"Mum",circles:["extended"],hue:320},{uid:"dad",displayName:"Dad",circles:["extended"],hue:28},{uid:"sister",displayName:"Camille",circles:["extended"],hue:280},{uid:"bro-in-law",displayName:"Sam",circles:["extended"],hue:175},{uid:"niece",displayName:"Léa",circles:["extended"],hue:100}],Kt=[{id:"t1",title:"Côte d’Azur, summer",location:"Antibes, France",start:"2026-07-12",end:"2026-07-21",coverGradient:"linear-gradient(135deg, #6b9ac4 0%, #c98a8a 60%, #d4a843 100%)",lodgingHost:"Airbnb",lodgingTitle:"Villa near Cap d’Antibes",attendees:["thomas","partner","kid1","kid2","mum","dad"],notes:"Mum + Dad arrive day 2. Dinner reservations at La Guérite booked.",visibility:"extended"},{id:"t2",title:"Half-term in the Alps",location:"Chamonix, France",start:"2026-10-24",end:"2026-10-31",coverGradient:"linear-gradient(135deg, #7a9e7e 0%, #4a6754 70%, #2c4439 100%)",lodgingHost:"Booking.com",lodgingTitle:"Chalet Les Drus",attendees:["thomas","partner","kid1","kid2"],notes:"Need ski school for the kids — book by September.",visibility:"immediate"},{id:"t3",title:"Camille’s 40th",location:"Lisbon, Portugal",start:"2026-09-05",end:"2026-09-08",coverGradient:"linear-gradient(135deg, #c67b5c 0%, #d4a843 50%, #c98a8a 100%)",lodgingHost:"Airbnb",lodgingTitle:"Alfama rooftop apartment",attendees:["thomas","partner","sister","bro-in-law"],notes:"Surprise. Don’t mention to Camille.",visibility:"family"}],qt=[{id:"e1",type:"birthday",date:"2026-05-24",personIds:["mum"],title:"Mum’s birthday"},{id:"e2",type:"anniversary",date:"2026-05-28",personIds:["mum","dad"],title:"Mum & Dad’s anniversary",subtitle:"38 years"},{id:"e3",type:"birthday",date:"2026-06-11",personIds:["kid1"],title:"Oscar turns 7"},{id:"e4",type:"birthday",date:"2026-06-30",personIds:["niece"],title:"Léa’s birthday"}],pt={id:"preview-felix",name:"Felix",dateOfBirth:new Date("2023-11-15"),profilePhotoURL:null,pronouns:"he",themeColorHex:"#3D9B8F",developmentalFlags:["speech and language"]},Zt=[pt],Qt=[{id:"m1",category:"motor",title:"Kicks a ball forward",status:"achieved",ageRangeStartMonths:18,ageRangeEndMonths:24},{id:"m2",category:"motor",title:"Walks up stairs holding on",status:"achieved",ageRangeStartMonths:18,ageRangeEndMonths:24},{id:"m3",category:"motor",title:"Jumps with both feet off the ground",status:"emerging",ageRangeStartMonths:24,ageRangeEndMonths:30},{id:"m4",category:"motor",title:"Pedals a tricycle",status:"notStarted",ageRangeStartMonths:30,ageRangeEndMonths:36},{id:"m5",category:"language",title:"Uses two-word phrases",status:"achieved",ageRangeStartMonths:18,ageRangeEndMonths:24},{id:"m6",category:"language",title:"Says first name when asked",status:"emerging",ageRangeStartMonths:24,ageRangeEndMonths:30},{id:"m7",category:"language",title:"Names six body parts",status:"notStarted",ageRangeStartMonths:24,ageRangeEndMonths:30},{id:"m8",category:"language",title:"Uses three-word sentences",status:"notStarted",ageRangeStartMonths:30,ageRangeEndMonths:36},{id:"m9",category:"socialEmotional",title:"Shows affection unprompted",status:"achieved",ageRangeStartMonths:18,ageRangeEndMonths:24},{id:"m10",category:"socialEmotional",title:"Plays alongside other children",status:"emerging",ageRangeStartMonths:24,ageRangeEndMonths:36},{id:"m11",category:"socialEmotional",title:"Takes turns in simple games",status:"notStarted",ageRangeStartMonths:30,ageRangeEndMonths:42},{id:"m12",category:"cognitive",title:"Follows a two-step instruction",status:"achieved",ageRangeStartMonths:18,ageRangeEndMonths:24},{id:"m13",category:"cognitive",title:"Sorts objects by shape or colour",status:"emerging",ageRangeStartMonths:30,ageRangeEndMonths:36},{id:"m14",category:"cognitive",title:"Completes a 4-piece puzzle",status:"notStarted",ageRangeStartMonths:30,ageRangeEndMonths:36}],ei=[{id:"i1",type:"strength",domain:"language",title:"Language is tracking ahead",body:"Felix is combining words earlier than the typical 24–30 month window — keep the back-and-forth conversations going.",relevanceScore:.95},{id:"i2",type:"connection",domain:"cross",title:"Fine-motor + sorting → pre-literacy",body:"A strong pincer grip alongside early sorting is a classic pre-literacy signal. Picture books with pointing build on both at once.",relevanceScore:.82},{id:"i3",type:"nudge",domain:"language",title:"Narrate your daily routine",body:'"Now we are washing hands… water on… soap…" — Felix is ready for longer sentence models during everyday moments.',relevanceScore:.7}],ti={id:"2026-05-16",title:"Felix is stringing two words together",body:'You have logged "more milk" and "Daddy go" this week — early two-word speech, right on the edge of the 24–30 month window. Narrating your routine out loud is the single best way to grow sentence length from here.',topicForChat:"How can I support Felix's two-word speech?"},ii=[{id:"p1",role:"user",content:"Felix isn't saying many words yet — should I be worried at 2.5?",senderUid:"partner"},{id:"p2",role:"assistant",content:"At 2½, every child's pace differs. From your logs Felix **uses two-word phrases** and follows two-step instructions — both strong signs. A few practical things to try, and a clear marker for when to mention it at his check-up."},{id:"p3",role:"user",content:"Any toddler-friendly ideas for a rainy weekend?",senderUid:"thomas"},{id:"p4",role:"assistant",content:"Rainy days are great for the kind of close-up play that grows language fastest at this stage. A few ideas matched to where Felix is right now."}];class Pe extends M{constructor(){super(),this.user=Wt,this.pebbleUser=null,this.family=null,this.children=[],this.trips=[],this.events=[],this.ppFamily=null,this.ppIsMember=!1,this.ppChildren=[],this.selectedChildId=null,this.childMilestones=[],this.childInsights=[],this.childDailyCard=null,this.childPebbleMessages=[],this._pebblePrefill="",this._plannerOpen=!1,this._plannerTrip=null,this.preview=!1,this.circle="extended",this._activeTab="today",this._formOpen=!1,this._formTrip=null,this._formBusy=!1,this._membersOpen=!1,this._eventFormOpen=!1,this._eventFormEvent=null,this._eventFormBusy=!1,this._allTripsOpen=!1,this._editingFamilyName=!1,this._importOpen=!1,this._profileOpen=!1,this._typePickerOpen=!1,this._formMode="trip",this._pebbleOpen=!1,this._dragOverTarget=null;const e=new Date;this._displayMonth=new Date(e.getFullYear(),e.getMonth(),1)}async _saveFamilyName(e){var a,o;const i=(e.target.value??"").trim(),r=((a=this.family)==null?void 0:a.name)??"";if(i&&i!==r&&((o=this.family)!=null&&o.id))try{const{db:n,doc:l,updateDoc:d,serverTimestamp:g}=await it(async()=>{const{db:h,doc:p,updateDoc:u,serverTimestamp:m}=await Promise.resolve().then(()=>Et);return{db:h,doc:p,updateDoc:u,serverTimestamp:m}},void 0);await d(l(n,"families",this.family.id),{name:i,updatedAt:g()}),w("Family name updated.")}catch(n){console.error("Update family name failed:",n),w(`Couldn't save: ${n.code??n.message}`,{duration:5e3})}this._editingFamilyName=!1}_liveImmediate(){var e;return this.preview||!((e=this.user)!=null&&e.uid)?qe.filter(t=>t.circles.includes("immediate")):Tt(this.user.uid,this.user,this.pebbleUser,this.family,this.children)}_liveExtended(){var e;return this.preview?qe.filter(t=>t.circles.includes("extended")):Ft((e=this.user)==null?void 0:e.uid,this.family)}_liveTrips(){return this.preview?Kt:this.trips??[]}_liveEvents(){if(this.preview)return qt;const e=r=>{const{date:a,yearsElapsed:o}=Bt(r);return{...r,date:a?Ot(a):r.date,_yearsElapsed:o,_originalDate:r.date}},t=Nt(this.children).map(e),i=(this.events??[]).map(e);return[...t,...i].sort((r,a)=>String(r.date).localeCompare(String(a.date)))}_filteredMembers(){const e=this._liveImmediate(),t=this._liveExtended();return this.circle==="personal"?e.filter(i=>{var r;return i.uid===((r=this.user)==null?void 0:r.uid)}):this.circle==="family"?e:[...e,...t]}_circleTrips(){var o;const e=this._liveTrips(),t=((o=this.user)==null?void 0:o.uid)??"thomas";let i;this.circle==="personal"?i=e.filter(n=>{var l;return(l=n.attendees)==null?void 0:l.includes(t)}):this.circle==="family"?i=e.filter(n=>n.visibility!=="extended"&&this._userCanSeeTrip(n)):i=e.filter(n=>this._userCanSeeTrip(n));const r=new Set,a=[];for(const n of i){const l=n.id??`${n.title}|${n.start}|${n.end}`;r.has(l)||(r.add(l),a.push(n))}return a}_filteredTrips(){const e=new Date;return e.setHours(0,0,0,0),this._circleTrips().filter(t=>t.end?$(t.end)>=e:!0)}_userCanSeeTrip(e){var l,d,g,h,p,u;const t=(l=this.user)==null?void 0:l.uid;if(!t)return!1;if((d=e.attendees)!=null&&d.includes(t)||(g=e.viewers)!=null&&g.includes(t))return!0;const i=((h=this.family)==null?void 0:h.memberIds)??[],r=((p=this.family)==null?void 0:p.cairnMemberIds)??i,a=i.includes(t),o=r.includes(t);if(a)return!0;if(!o)return!1;const n=e.visibility||"family";if(n==="personal")return!1;if(n==="family")return!0;if(n==="extended"){const m=e.targetSubGroups??[];if(m.length===0)return!0;const f=Object.entries(((u=this.family)==null?void 0:u.subGroups)??{}).filter(([,b])=>(b.memberIds??[]).includes(t)).map(([b])=>b);return m.some(b=>f.includes(b))}return!1}_filteredEvents(){const e=new Set(this._filteredMembers().map(t=>t.uid));return this._liveEvents().filter(t=>t.personIds.some(i=>e.has(i)))}_smartCallout(){var n,l;const e=new Date,t=new Date(e.getFullYear(),e.getMonth(),e.getDate()),i=1440*60*1e3,r=d=>Math.round((d-t)/i);for(const d of this._circleTrips()){if(!d.start||!d.end)continue;const g=$(d.start),h=$(d.end);if(g.setHours(0,0,0,0),h.setHours(0,0,0,0),g<=t&&t<=h){const p=r(g)+1,u=r(h)-r(g)+1,m=((n=d.location)==null?void 0:n.trim())||d.title;return`Day ${p} of ${u} in ${m}.`}}let a=null,o=1/0;for(const d of this._circleTrips()){if(!d.start)continue;const g=$(d.start);if(!g)continue;const h=r(g);h>0&&h<o&&(a={kind:"trip",item:d},o=h)}for(const d of this._filteredEvents()){if(!d.date)continue;const g=$(d.date);if(!g)continue;const h=r(g);h>=0&&h<o&&(a={kind:"event",item:d},o=h)}if(!a)return null;if(a.kind==="trip"){const d=((l=a.item.location)==null?void 0:l.trim())||a.item.title;return o===1?`${d} starts tomorrow.`:o<=14?`${d} in ${o} days.`:o<=60?`Next trip: ${d} in ${o} days.`:null}return o===0?`${a.item.title} — today.`:o===1?`${a.item.title} — tomorrow.`:o<=7?`${a.item.title} in ${o} days.`:null}_tripDensityByDay(e){const t=new Map;for(const i of this._filteredTrips()){if(!i.start||!i.end)continue;const r=$(i.start),a=$(i.end);if(Number.isNaN(r.getTime())||Number.isNaN(a.getTime())||r.getFullYear()>e||a.getFullYear()<e)continue;const o=new Date(Math.max(r,new Date(e,0,1))),n=new Date(Math.min(a,new Date(e,11,31)));for(;o<=n;){const l=`${String(o.getMonth()+1).padStart(2,"0")}-${String(o.getDate()).padStart(2,"0")}`;t.set(l,Math.min(1,(t.get(l)??0)+.5)),o.setDate(o.getDate()+1)}}return t}_shiftMonth(e){const t=this._displayMonth;this._displayMonth=new Date(t.getFullYear(),t.getMonth()+e,1)}_jumpToMonth(e,t){this._displayMonth=new Date(e,t,1)}_resetToToday(){const e=new Date;this._displayMonth=new Date(e.getFullYear(),e.getMonth(),1)}_renderStone({label:e,members:t,pebbleClass:i,emptyLabel:r,onClick:a,maxChips:o=6,dropTargetId:n=null,draggable:l=()=>!1}){const d=n?{dragover:m=>{var f;(f=m.dataTransfer.types)!=null&&f.includes("text/cairn-uid")&&(m.preventDefault(),this._dragOverTarget=n)},dragleave:()=>{this._dragOverTarget===n&&(this._dragOverTarget=null)},drop:async m=>{m.preventDefault(),this._dragOverTarget=null;const f=m.dataTransfer.getData("text/cairn-uid");if(!f)return;const b=n==="extended"?null:n;try{await y.setCairnMemberSubGroup(f,b),w(b?`Moved to ${e}.`:"Moved to extended.")}catch(_){console.error("Move failed:",_),w(`Couldn't move: ${_.code??_.message}`,{duration:4e3})}}}:{},g=n&&this._dragOverTarget===n,h=`pebble ${i}${g?" pebble-drop":""}`;if(!t||t.length===0)return s`
      ...
      >
        <span class="${h}">
          <span class="stone-chips">
            ${p.map(m=>{const f=l(m);return s`
                <member-chip
                  draggable=${f?"true":"false"}
                  class=${f?"is-draggable":""}
                  @dragstart=${b=>{if(!f){b.preventDefault();return}b.stopPropagation(),b.dataTransfer.setData("text/cairn-uid",m.uid),b.dataTransfer.effectAllowed="move"}}
                  .name=${m.displayName}
                  .photo=${m.photoURL??""}
                  .hue=${m.hue}
                  size="26"
    ...
    `}_renderMonthly(){const e=new Date,t=this._displayMonth??e,i=t.getFullYear(),r=t.getMonth(),o=(new Date(i,r,1).getDay()+6)%7,n=new Date(i,r+1,0).getDate(),l=new Map,d=(b,_)=>{l.has(b)||l.set(b,_)},g=[];for(const b of this._filteredEvents()){const _=$(b.date);_&&_.getFullYear()===i&&_.getMonth()===r&&(g.push(_.getDate()),d(_.getDate(),b.title??""))}const h=new Set;for(const b of this._filteredTrips()){if(!b.start||!b.end)continue;const _=$(b.start),A=$(b.end);if(Number.isNaN(_.getTime())||Number.isNaN(A.getTime())||_.getFullYear()>i||A.getFullYear()<i||_.getMonth()>r&&A.getMonth()>r||_.getMonth()<r&&A.getMonth()<r)continue;const z=_.getMonth()===r?_.getDate():1,I=A.getMonth()===r?A.getDate():n;for(let N=z;N<=I;N++)h.add(N),d(N,b.title??"")}const p=[];for(let b=0;b<o;b++)p.push(s`<div class="cal-cell empty"></div>`);const u=e.getFullYear()===i&&e.getMonth()===r;for(let b=1;b<=n;b++){const _=u&&b===e.getDate(),A=g.includes(b),z=h.has(b),I=_?l.get(b)??"Today":l.get(b),N=["cal-cell",_?"today":"",A?"has-event":"",z?"has-trip":""].filter(Boolean).join(" ");p.push(s`<div class=${N} title=${I?`${b} — ${I}`:""}>
                ...
                <div class="cairn-stack">
                  ...
                  ${d.length>0?s`
                        <div class="subgroup-row">
                          ${d.map(([b,_])=>{const A=(_.memberIds??[]).map(z=>g.get(z)).filter(Boolean);return this._renderStone({label:_.name??"Group",members:A,pebbleClass:"pebble-subgroup",emptyLabel:`${_.name??"Group"} (empty)`,onClick:()=>this._membersOpen=!0,maxChips:4,dropTargetId:b,draggable:z=>z.role==="extended"})})}
                        </div>
                      `:""}
                </div>
    ...
    `}_renderPebbleTab(){var r,a;const e=this._childData();if(e.hasPP&&e.child){const o=s`<span class="scope-chip">
        ...
        ></child-pebble>
      `}const t=(this._circleTrips()??[]).filter(o=>o.start&&$(o.start)>=new Date).sort((o,n)=>String(o.start).localeCompare(String(n.start)))[0],i=s`<span class="scope-chip">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="5" y="11" width="14" height="9" rx="2" /><path d="M8 11V8a4 4 0 018 0v3" stroke-linecap="round" /></svg>
...
//# sourceMappingURL=index-CH7_H7qN.js.map
