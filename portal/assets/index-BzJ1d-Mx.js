var gt=Object.defineProperty;var ut=(c,e,t)=>e in c?gt(c,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):c[e]=t;var x=(c,e,t)=>ut(c,typeof e!="symbol"?e+"":e,t);import{i as M,a as S,b as s}from"./lit-2GpawzfI.js";import{f as bt,h as mt,j as ft,G as Te,O as vt,k as xt,s as yt,l as et,m as wt,n as _t,o as kt,q as $t,t as D,v as P,w as C,x as Ct,y as T,z as L,A as E,B as U,D as ee,E as G,H as V,I as te}from"./firebase-core-WlNQdXp3.js";import{g as zt,h as X}from"./firebase-functions-EPI35Sfs.js";import{g as Mt,a as Ne,r as Be,u as tt}from"./firebase-storage-BMyqKy67.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const a of r)if(a.type==="childList")for(const o of a.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function t(r){const a={};return r.integrity&&(a.integrity=r.integrity),r.referrerPolicy&&(a.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?a.credentials="include":r.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(r){if(r.ep)return;r.ep=!0;const a=t(r);fetch(r.href,a)}})();class ne extends M{constructor(){super(),this.variant="default",this.lifted=!1,this.padding="md"}render(){const e=["panel",this.variant==="strong"?"strong":"",this.lifted?"lifted":"",`pad-${this.padding}`].filter(Boolean).join(" ");return s`
      <div class=${e}>
        <div class="content"><slot></slot></div>
      </div>
    `}}x(ne,"properties",{variant:{type:String},lifted:{type:Boolean},padding:{type:String}}),x(ne,"styles",S`
    :host {
      display: block;
    }
    :host([stretch]) {
  ...
  `);customElements.define("glass-panel",ne);class le extends M{constructor(){super(),this.variant="primary",this.size="md",this.full=!1,this.disabled=!1}render(){const e=[this.variant,`size-${this.size}`,this.full?"full":""].filter(Boolean).join(" ");return s`
      <button class=${e} ?disabled=${this.disabled}>
        <slot></slot>
      </button>
    `}}x(le,"properties",{variant:{type:String},size:{type:String},full:{type:Boolean},disabled:{type:Boolean,reflect:!0}}),x(le,"styles",S`
    * {
      box-sizing: border-box;
    }
    :host {
  ...
  `);customElements.define("glass-button",le);class de extends M{constructor(){super(),this.size=44}render(){const e=this.size;return s`
      <svg
        viewBox="0 0 64 64"
        width=${e}
        height=${e}
    ...
    `}}x(de,"properties",{size:{type:Number}}),x(de,"styles",S`
    :host {
      display: inline-block;
      line-height: 0;
    }
  ...
  `);customElements.define("cairn-mark",de);const St="modulepreload",Dt=function(c){return"/portal/"+c},Re={},it=function(e,t,i){let r=Promise.resolve();if(t&&t.length>0){let o=function(d){return Promise.all(d.map(g=>Promise.resolve(g).then(h=>({status:"fulfilled",value:h}),h=>({status:"rejected",reason:h}))))};document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),l=(n==null?void 0:n.nonce)||(n==null?void 0:n.getAttribute("nonce"));r=o(t.map(d=>{if(d=Dt(d),d in Re)return;Re[d]=!0;const g=d.endsWith(".css"),h=g?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${h}`))return;const p=document.createElement("link");if(p.rel=g?"stylesheet":St,g||(p.as="script"),p.crossOrigin="",p.href=d,l&&p.setAttribute("nonce",l),document.head.appendChild(p),g)return new Promise((u,b)=>{p.addEventListener("load",u),p.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${d}`)))})}))}function a(o){const n=new Event("vite:preloadError",{cancelable:!0});if(n.payload=o,window.dispatchEvent(n),!n.defaultPrevented)throw o}return r.then(o=>{for(const n of o||[])n.status==="rejected"&&a(n.reason);return e().catch(a)})},ce={apiKey:"AIzaSyA6NKZNLVBeeLrXcLJSXus5M832AxpI2wk",authDomain:"pebblepath-992b6.firebaseapp.com",projectId:"pebblepath-992b6",storageBucket:"pebblepath-992b6.firebasestorage.app",messagingSenderId:"497141667291",appId:"1:497141667291:web:ee84c186db54389d10c3fe"},F=!!(ce.apiKey&&ce.projectId),H=F?bt(ce):null,k=F?mt(H):null,v=F?ft(H):null,O=F?zt(H,"us-central1"):null,Z=F?Mt(H):null,pe=F?new Te:null;pe&&pe.setCustomParameters({prompt:"select_account"});const ae=F?new Te:null;ae&&ae.addScope("https://www.googleapis.com/auth/calendar.readonly");let ie=null,he=0;async function rt(){if(!k||!ae)throw new Error("Firebase not configured.");if(ie&&Date.now()<he-6e4)return ie;const c=k.currentUser;if(!c)throw new Error("Please sign in before importing your calendar.");if(!(c.providerData??[]).some(a=>a.providerId==="google.com")){const a=new Error("Calendar import needs a Google account. You're signed in another way, so Cairn can't read your Google Calendar here yet — add events manually for now.");throw a.code="calendar/needs-google-account",a}let t;try{t=await xt(c,ae)}catch(a){if((a==null?void 0:a.code)==="auth/user-mismatch"){const o=new Error("Please choose the same Google account you use to sign in to Cairn.");throw o.code=a.code,o}if((a==null?void 0:a.code)==="auth/popup-closed-by-user"||(a==null?void 0:a.code)==="auth/cancelled-popup-request"){const o=new Error("Calendar connection cancelled.");throw o.code=a.code,o}throw a}const i=Te.credentialFromResult(t),r=i==null?void 0:i.accessToken;if(!r)throw new Error("Couldn't get a Calendar access token — try again.");return ie=r,he=Date.now()+3600*1e3,r}function It(){ie=null,he=0}function W(){if(!k)throw new Error("Firebase not configured — fill in .env first.");return et(k,pe)}const K=F?new vt("apple.com"):null;K&&(K.addScope("email"),K.addScope("name"));function re(){if(!k||!K)throw new Error("Firebase not configured — fill in .env first.");return et(k,K)}function at(c,e){if(!k)throw new Error("Firebase not configured.");return kt(k,c,e)}async function st(c,e,t){if(!k)throw new Error("Firebase not configured.");const i=await wt(k,c,e);if(t&&t.trim())try{await _t(i.user,{displayName:t.trim()})}catch{}return i}function ot(c){if(!k)throw new Error("Firebase not configured.");return $t(k,c)}function nt(){return k?yt(k):Promise.resolve()}function lt(c){return k?Ct(k,c):(c(null),()=>{})}const At=Object.freeze(Object.defineProperty({__proto__:null,addDoc:V,app:H,auth:k,clearCalendarToken:It,collection:E,connectGoogleCalendar:rt,db:v,deleteDoc:te,doc:D,firebaseApp:H,functions:O,getDocs:ee,getDownloadURL:Ne,httpsCallable:X,isConfigured:F,onAuth:lt,onSnapshot:T,query:L,sendPasswordReset:ot,serverTimestamp:C,setDoc:G,signIn:W,signInWithApple:re,signInWithEmail:at,signOutUser:nt,signUpWithEmail:st,storage:Z,storageRef:Be,updateDoc:P,uploadBytes:tt,where:U},Symbol.toStringTag,{value:"Module"}));class Et extends EventTarget{constructor(){super(),this.state={user:null,family:null,children:[],trips:[],events:[],ppFamily:null,ppIsMember:!1,ppChildren:[],selectedChildId:null,childMilestones:[],childInsights:[],childDailyCard:null,childPebbleMessages:[]},this._uid=null,this._unsubUser=null,this._unsubFamily=null,this._unsubChildren=null,this._unsubTrips=null,this._unsubEvents=null,this._currentFamilyId=null,this._ppFamilyId=null,this._selectedChildId=null,this._unsubPpFamily=null,this._unsubPpChildren=null,this._unsubChildMs=null,this._unsubChildIns=null,this._unsubChildDaily=null,this._unsubChildPebble=null,this.userDocResolved=!1}get familyId(){return this._currentFamilyId}start(e){!v||!e||this._uid!==e&&(this.stop(),this._uid=e,this._unsubUser=T(D(v,"users",e),t=>{var a,o,n,l,d,g,h;this.userDocResolved=!0,this.state.user=t.exists()?{id:t.id,...t.data()}:null;const i=((a=this.state.user)==null?void 0:a.cairnFamilyId)??((o=this.state.user)==null?void 0:o.familyId)??null;!i&&this.state.user&&this._healFamilyPointer(e),i!==this._currentFamilyId&&(this._currentFamilyId=i,(n=this._unsubFamily)==null||n.call(this),(l=this._unsubChildren)==null||l.call(this),(d=this._unsubTrips)==null||d.call(this),(g=this._unsubEvents)==null||g.call(this),this._unsubFamily=null,this._unsubChildren=null,this._unsubTrips=null,this._unsubEvents=null,this.state.family=null,this.state.children=[],this.state.trips=[],this.state.events=[],i&&this._subscribeFamily(i));const r=((h=this.state.user)==null?void 0:h.familyId)??null;r!==this._ppFamilyId&&(this._ppFamilyId=r,this._teardownPpFamily(),r&&this._subscribePpFamily(r)),this._emit()}))}async _healFamilyPointer(e){if(!this._healing){this._healing=!0;try{const t=L(E(v,"families"),U("cairnMemberIds","array-contains",e)),i=await ee(t);if(!i.empty){await G(D(v,"users",e),{cairnFamilyId:i.docs[0].id,updatedAt:C()},{merge:!0});return}const r=L(E(v,"families"),U("memberIds","array-contains",e)),a=await ee(r);a.empty||await G(D(v,"users",e),{familyId:a.docs[0].id,updatedAt:C()},{merge:!0})}catch(t){console.warn("[Cairn] auto-heal family pointer failed:",t==null?void 0:t.code,t==null?void 0:t.message)}finally{this._healing=!1}}}_subscribeFamily(e){this._unsubFamily=T(D(v,"families",e),t=>{this.state.family=t.exists()?{id:t.id,...t.data()}:null,this._emit()}),this._unsubChildren=T(E(v,"families",e,"children"),t=>{this.state.children=t.docs.map(i=>{var a,o;const r=i.data();return{id:i.id,...r,dateOfBirth:((o=(a=r.dateOfBirth)==null?void 0:a.toDate)==null?void 0:o.call(a))??(r.dateOfBirth?new Date(r.dateOfBirth):null)}}),this._emit()}),this._unsubTrips=T(L(E(v,"families",e,"trips"),U("visibleTo","array-contains",this._uid)),t=>{this.state.trips=t.docs.map(i=>{var a,o,n,l;const r=i.data();return{id:i.id,...r,start:r.start??"",end:r.end??"",createdAt:((o=(a=r.createdAt)==null?void 0:a.toDate)==null?void 0:o.call(a))??null,updatedAt:((l=(n=r.updatedAt)==null?void 0:n.toDate)==null?void 0:l.call(n))??null}}).sort((i,r)=>String(i.start).localeCompare(String(r.start))),this._backfillVisibleTo("trips",t.docs),this._emit()},t=>{console.warn("[Cairn] trips subscription error:",t.code,t.message)}),this._unsubEvents=T(L(E(v,"families",e,"familyEvents"),U("visibleTo","array-contains",this._uid)),t=>{this.state.events=t.docs.map(i=>{var a,o,n,l;const r=i.data();return{id:i.id,...r,date:r.date??"",createdAt:((o=(a=r.createdAt)==null?void 0:a.toDate)==null?void 0:o.call(a))??null,updatedAt:((l=(n=r.updatedAt)==null?void 0:n.toDate)==null?void 0:l.call(n))??null}}),this._backfillVisibleTo("familyEvents",t.docs),this._emit()},t=>{console.warn("[Cairn] familyEvents subscription error:",t.code,t.message)})}_subscribePpFamily(e){this._unsubPpFamily=T(D(v,"families",e),t=>{const i=t.exists()?{id:t.id,...t.data()}:null;this.state.ppFamily=i,this.state.ppIsMember=!!(i&&Array.isArray(i.memberIds)&&i.memberIds.includes(this._uid)),this._emit()},t=>{console.warn("[Portal] ppFamily subscription error:",t.code,t.message)}),this._unsubPpChildren=T(E(v,"families",e,"children"),t=>{var o;const i=t.docs.map(n=>{var d,g;const l=n.data();return{id:n.id,...l,dateOfBirth:((g=(d=l.dateOfBirth)==null?void 0:d.toDate)==null?void 0:g.call(d))??(l.dateOfBirth?new Date(l.dateOfBirth):null)}}).sort((n,l)=>{var d,g,h,p;return(((g=(d=n.createdAt)==null?void 0:d.toMillis)==null?void 0:g.call(d))??0)-(((p=(h=l.createdAt)==null?void 0:h.toMillis)==null?void 0:p.call(h))??0)});this.state.ppChildren=i,this._resolveChildPhotos(e,i);const a=this._selectedChildId&&i.some(n=>n.id===this._selectedChildId)?this._selectedChildId:((o=i[0])==null?void 0:o.id)??null;a!==this._selectedChildId?this._subscribeChild(a):a||this._teardownChild(),this._emit()},t=>{console.warn("[Portal] ppChildren subscription error:",t.code,t.message)})}_subscribeChild(e){if(this._teardownChild(),this._selectedChildId=e,this.state.selectedChildId=e,!e||!this._ppFamilyId){this.state.childMilestones=[],this.state.childInsights=[],this.state.childDailyCard=null,this.state.childPebbleMessages=[];return}const t=["families",this._ppFamilyId,"children",e];this._unsubChildMs=T(E(v,...t,"milestones"),i=>{this.state.childMilestones=i.docs.map(r=>({id:r.id,...r.data()})).sort((r,a)=>(r.ageRangeStartMonths??0)-(a.ageRangeStartMonths??0)),this._emit()},i=>console.warn("[Portal] milestones error:",i.code,i.message)),this._unsubChildIns=T(E(v,...t,"insights"),i=>{this.state.childInsights=i.docs.map(r=>({id:r.id,...r.data()})).sort((r,a)=>(a.relevanceScore??0)-(r.relevanceScore??0)),this._emit()},i=>console.warn("[Portal] insights error:",i.code,i.message)),this._unsubChildDaily=T(E(v,...t,"dailyCards"),i=>{const r=i.docs.map(a=>({id:a.id,...a.data()}));r.sort((a,o)=>String(o.id).localeCompare(String(a.id))),this.state.childDailyCard=r[0]??null,this._emit()},i=>console.warn("[Portal] dailyCards error:",i.code,i.message)),this._unsubChildPebble=T(E(v,...t,"pebbleMessages"),i=>{this.state.childPebbleMessages=i.docs.map(r=>({id:r.id,...r.data()})).filter(r=>!(r.isPrivate===!0&&r.senderUid!==this._uid)).sort((r,a)=>{var o,n,l,d;return(((n=(o=r.timestamp)==null?void 0:o.toMillis)==null?void 0:n.call(o))??0)-(((d=(l=a.timestamp)==null?void 0:l.toMillis)==null?void 0:d.call(l))??0)}),this._emit()},i=>console.warn("[Portal] pebbleMessages error:",i.code,i.message))}_resolveChildPhotos(e,t){if(Z){this._photoTried||(this._photoTried=new Set);for(const i of t){const r=i.profilePhotoURL;if(typeof r=="string"&&/^https?:\/\//i.test(r))continue;const a=e+"/"+i.id;this._photoTried.has(a)||(this._photoTried.add(a),Ne(Be(Z,"families/"+e+"/avatars/children/"+i.id)).then(o=>{const n=this.state.ppChildren||[],l=n.findIndex(d=>d.id===i.id);l>=0&&(n[l]={...n[l],profilePhotoURL:o},this.state.ppChildren=[...n],this._emit())}).catch(()=>{this._photoTried.delete(a)}))}}}selectChild(e){!e||e===this._selectedChildId||this.state.ppChildren.some(t=>t.id===e)&&(this._subscribeChild(e),this._emit())}async askPebbleAboutChild(e,t,i=[]){if(!O)throw new Error("Firebase functions not configured.");if(!this._ppFamilyId)throw new Error("No PebblePath family.");if(!e)throw new Error("No child selected.");return(await X(O,"askPebbleAboutChild")({familyId:this._ppFamilyId,childId:e,question:t,history:i})).data}_teardownChild(){var e,t,i,r;(e=this._unsubChildMs)==null||e.call(this),(t=this._unsubChildIns)==null||t.call(this),(i=this._unsubChildDaily)==null||i.call(this),(r=this._unsubChildPebble)==null||r.call(this),this._unsubChildMs=this._unsubChildIns=this._unsubChildDaily=this._unsubChildPebble=null}_teardownPpFamily(){var e,t;this._teardownChild(),(e=this._unsubPpFamily)==null||e.call(this),(t=this._unsubPpChildren)==null||t.call(this),this._unsubPpFamily=null,this._unsubPpChildren=null,this._selectedChildId=null,this.state.ppFamily=null,this.state.ppIsMember=!1,this.state.ppChildren=[],this.state.selectedChildId=null,this.state.childMilestones=[],this.state.childInsights=[],this.state.childDailyCard=null,this.state.childPebbleMessages=[]}_backfillVisibleTo(e,t){if(!v||!this._currentFamilyId)return;const i=this.state.family;if(i){this._vtBackfilled||(this._vtBackfilled=new Set);for(const r of t){const a=r.data();if(Array.isArray(a.visibleTo))continue;const o=`${e}/${r.id}`;this._vtBackfilled.has(o)||(this._vtBackfilled.add(o),P(D(v,"families",this._currentFamilyId,e,r.id),{visibleTo:se(a.visibility??"family",i,a.createdBy)}).catch(n=>{this._vtBackfilled.delete(o),console.warn(`[Cairn] visibleTo backfill failed (${o}):`,n==null?void 0:n.code,n==null?void 0:n.message)}))}}}async saveTrip(e){var d;if(!v||!this._currentFamilyId)throw new Error("No family yet.");const t=(d=k==null?void 0:k.currentUser)==null?void 0:d.uid;if(!t)throw new Error("Not signed in.");const{id:i,createdAt:r,updatedAt:a,...o}=e,n={...o,updatedAt:C()};return n.visibleTo=se(o.visibility??"family",this.state.family,o.createdBy??t),i?(await P(D(v,"families",this._currentFamilyId,"trips",i),n),i):(n.createdBy=t,n.createdAt=C(),(await V(E(v,"families",this._currentFamilyId,"trips"),n)).id)}async deleteTrip(e){if(!v||!this._currentFamilyId)throw new Error("No family yet.");await te(D(v,"families",this._currentFamilyId,"trips",e))}planItemsListener(e,t){return!v||!this._currentFamilyId||!e?()=>{}:T(E(v,"families",this._currentFamilyId,"trips",e,"planItems"),i=>{const r=i.docs.map(a=>({id:a.id,...a.data()})).sort((a,o)=>{var d,g,h,p;const n=String(a.day??"").localeCompare(String(o.day??""));if(n!==0)return n;const l=String(a.time??"").localeCompare(String(o.time??""));return l!==0?l:(((g=(d=a.createdAt)==null?void 0:d.toMillis)==null?void 0:g.call(d))??0)-(((p=(h=o.createdAt)==null?void 0:h.toMillis)==null?void 0:p.call(h))??0)});t(r)},i=>{console.warn("[Portal] planItems subscription error:",i.code,i.message),t([])})}async addPlanItem(e,t){var o;if(!v||!this._currentFamilyId)throw new Error("No family yet.");const i=(o=k==null?void 0:k.currentUser)==null?void 0:o.uid;if(!i)throw new Error("Not signed in.");const r=String((t==null?void 0:t.title)??"").trim();if(!r)throw new Error("Add a title.");return(await V(E(v,"families",this._currentFamilyId,"trips",e,"planItems"),{title:r,type:(t==null?void 0:t.type)??"note",day:(t==null?void 0:t.day)??"",time:(t==null?void 0:t.time)??"",durationMins:Number.isFinite(t==null?void 0:t.durationMins)?t.durationMins:60,addedBy:i,createdAt:C()})).id}async deletePlanItem(e,t){if(!v||!this._currentFamilyId)throw new Error("No family yet.");await te(D(v,"families",this._currentFamilyId,"trips",e,"planItems",t))}async saveEvent(e){var d;if(!v||!this._currentFamilyId)throw new Error("No family yet.");const t=(d=k==null?void 0:k.currentUser)==null?void 0:d.uid;if(!t)throw new Error("Not signed in.");const{id:i,createdAt:r,updatedAt:a,...o}=e,n={...o,updatedAt:C()};return n.visibleTo=se(o.visibility??"family",this.state.family,o.createdBy??t),i?(await P(D(v,"families",this._currentFamilyId,"familyEvents",i),n),i):(n.createdBy=t,n.createdAt=C(),(await V(E(v,"families",this._currentFamilyId,"familyEvents"),n)).id)}async deleteEvent(e){if(!v||!this._currentFamilyId)throw new Error("No family yet.");await te(D(v,"families",this._currentFamilyId,"familyEvents",e))}async previewUrl(e){if(!e||typeof e!="string"||!/^https?:\/\//i.test(e.trim()))return null;if(!O)throw new Error("Firebase functions not configured.");return(await X(O,"previewUrl")({url:e.trim()})).data}async lookupFlight(e,t){if(!e||typeof e!="string")return null;if(!O)throw new Error("Firebase functions not configured.");return(await X(O,"lookupFlight")({flightNumber:e.trim(),date:typeof t=="string"?t.trim():""})).data}async askPebble(e,t=[]){if(!O)throw new Error("Firebase functions not configured.");if(!this._currentFamilyId)throw new Error("No family yet.");return(await X(O,"askPebbleAboutActivities")({question:e,familyId:this._currentFamilyId,history:t})).data}async updateChildBirthday(e,t){if(!v||!this._currentFamilyId)throw new Error("No family yet.");await P(D(v,"families",this._currentFamilyId,"children",e),{dateOfBirth:t,updatedAt:C()})}async findFamilyByCairnCode(e){if(!v)throw new Error("Firebase not configured.");const t=L(E(v,"families"),U("cairnInviteCode","==",e)),i=await ee(t);if(i.empty)return null;const r=i.docs[0];return{id:r.id,...r.data()}}async joinFamilyAsCairn(e){var h,p,u;if(!v)throw new Error("Firebase not configured.");const t=(h=k==null?void 0:k.currentUser)==null?void 0:h.uid;if(!t)throw new Error("Not signed in.");const i=await this.findFamilyByCairnCode(e);if(!i){const b=new Error("Invite code not found.");throw b.code="not-found",b}const r=((u=(p=i.cairnInviteCodeExpiresAt)==null?void 0:p.toDate)==null?void 0:u.call(p))??(i.cairnInviteCodeExpiresAt?new Date(i.cairnInviteCodeExpiresAt):null);if(!r||r<new Date){const b=new Error("This invite code has expired.");throw b.code="expired",b}const a=i.cairnMemberIds??[],o=i.memberIds??[],n=k.currentUser;if(a.includes(t)||o.includes(t))return await G(D(v,"users",t),{email:n.email??"",displayName:n.displayName??"",profilePhotoURL:n.photoURL??null,cairnFamilyId:i.id,updatedAt:C()},{merge:!0}),i.id;const l=i.cairnMaxMembers??20;if(a.length>=l){const b=new Error("This family's Cairn ring is full.");throw b.code="full",b}const d=new Date,g={displayName:n.displayName??"",profilePhotoURL:n.photoURL??null,role:"member",joinedAt:d,updatedAt:d};return await P(D(v,"families",i.id),{cairnMemberIds:[...a,t],[`memberProfiles.${t}`]:g,updatedAt:C()}),await G(D(v,"users",t),{email:n.email??"",displayName:n.displayName??"",profilePhotoURL:n.photoURL??null,cairnFamilyId:i.id,role:"member",notificationPreferences:{milestoneReminders:!0,tipNotifications:!0,schoolDeadlines:!0},createdAt:C(),updatedAt:C()},{merge:!0}),i.id}async saveSubGroup({id:e,name:t,memberIds:i}){if(!v||!this._currentFamilyId)throw new Error("No family yet.");const r=e??`g_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,6)}`;return await P(D(v,"families",this._currentFamilyId),{[`subGroups.${r}`]:{name:t.trim(),memberIds:Array.isArray(i)?[...i]:[],updatedAt:C()},updatedAt:C()}),r}async deleteSubGroup(e){if(!v||!this._currentFamilyId)throw new Error("No family yet.");const{deleteField:t}=await it(async()=>{const{deleteField:i}=await import("./firebase-core-WlNQdXp3.js").then(r=>r.J);return{deleteField:i}},[]);await P(D(v,"families",this._currentFamilyId),{[`subGroups.${e}`]:t(),updatedAt:C()})}async setCairnMemberSubGroup(e,t){var a;if(!v||!this._currentFamilyId)throw new Error("No family yet.");if(!e)throw new Error("uid is required.");const i=((a=this.state.family)==null?void 0:a.subGroups)??{},r={};for(const[o,n]of Object.entries(i)){const l=Array.isArray(n.memberIds)?n.memberIds:[];o===t?l.includes(e)||(r[`subGroups.${o}.memberIds`]=[...l,e]):l.includes(e)&&(r[`subGroups.${o}.memberIds`]=l.filter(d=>d!==e))}Object.keys(r).length!==0&&(r.updatedAt=C(),await P(D(v,"families",this._currentFamilyId),r))}async createCairnOnlyFamily(e){if(!v)throw new Error("Firebase not configured.");const t=k==null?void 0:k.currentUser,i=t==null?void 0:t.uid;if(!i)throw new Error("Not signed in.");const r=(e??"").trim();if(!r)throw new Error("Family name is required.");const a=new Date,o=je(),n=new Date(Date.now()+720*60*60*1e3),l={displayName:t.displayName??"",profilePhotoURL:t.photoURL??null,role:"admin",joinedAt:a,updatedAt:a},d={name:r,createdBy:i,createdInApp:"cairn",memberIds:[],cairnMemberIds:[i],cairnMaxMembers:20,cairnInviteCode:o,cairnInviteCodeExpiresAt:n,memberProfiles:{[i]:l},createdAt:C(),updatedAt:C()},g=await V(E(v,"families"),d);return await G(D(v,"users",i),{email:t.email??"",displayName:t.displayName??"",profilePhotoURL:t.photoURL??null,cairnFamilyId:g.id,role:"admin",notificationPreferences:{milestoneReminders:!1,tipNotifications:!1,schoolDeadlines:!1},createdAt:C(),updatedAt:C()},{merge:!0}),g.id}async regenerateCairnInviteCode(){if(!v||!this._currentFamilyId)throw new Error("No family yet.");const e=je(),t=new Date(Date.now()+720*60*60*1e3);return await P(D(v,"families",this._currentFamilyId),{cairnInviteCode:e,cairnInviteCodeExpiresAt:t,updatedAt:C()}),{code:e,expiresAt:t}}stop(){var e,t,i,r,a;(e=this._unsubUser)==null||e.call(this),(t=this._unsubFamily)==null||t.call(this),(i=this._unsubChildren)==null||i.call(this),(r=this._unsubTrips)==null||r.call(this),(a=this._unsubEvents)==null||a.call(this),this._unsubUser=this._unsubFamily=this._unsubChildren=this._unsubTrips=this._unsubEvents=null,this._teardownPpFamily(),this._uid=null,this._currentFamilyId=null,this._ppFamilyId=null,this.userDocResolved=!1,this.state={user:null,family:null,children:[],trips:[],events:[],ppFamily:null,ppIsMember:!1,ppChildren:[],selectedChildId:null,childMilestones:[],childInsights:[],childDailyCard:null,childPebbleMessages:[]}}_emit(){this.dispatchEvent(new Event("change"))}}const y=new Et;function dt(c,e){const t=e==null?void 0:e.profilePhotoURL;return typeof t=="string"&&/^https?:\/\//i.test(t)?t:c!=null&&c.photoURL?c.photoURL:null}function Pt(c,e){if(!e)return[];const t=e.cairnMemberIds??e.memberIds??[],i=e.memberIds??[],r=e.memberProfiles??{},a=[];let o=280;for(const n of t){if(i.includes(n)||n===c)continue;const l=r[n],d=l==null?void 0:l.profilePhotoURL;a.push({uid:n,displayName:(l==null?void 0:l.displayName)??"Family",photoURL:typeof d=="string"&&/^https?:\/\//i.test(d)?d:null,role:"extended",circles:["extended"],hue:o}),o=(o+47)%360}return a}function se(c,e,t){const i=(e==null?void 0:e.memberIds)??[],r=(e==null?void 0:e.cairnMemberIds)??[],a=t?[t]:[];return c==="personal"?[...new Set(a)]:c==="extended"?[...new Set([...i,...r,...a])]:[...new Set([...i,...a])]}function je(){const c="ABCDEFGHJKLMNPQRSTUVWXYZ23456789";let e="CAIRN-";for(let t=0;t<4;t++)e+=c[Math.floor(Math.random()*c.length)];return e}function Ft(c,e,t,i,r){const a=[],o=new Set((i==null?void 0:i.memberIds)??[]),n=o.has(c);a.push({uid:c,displayName:(e==null?void 0:e.displayName)??(t==null?void 0:t.displayName)??"You",photoURL:dt(e,t),role:n?"self":"self-extended",circles:["immediate"],hue:198});const l=(i==null?void 0:i.memberProfiles)??{};for(const[g,h]of Object.entries(l)){if(g===c||!o.has(g))continue;const p=h.profilePhotoURL;a.push({uid:g,displayName:h.displayName??"Co-parent",photoURL:typeof p=="string"&&/^https?:\/\//i.test(p)?p:null,role:"co-parent",circles:["immediate"],hue:8})}let d=142;for(const g of r??[]){const h=g.profilePhotoURL;a.push({uid:`child:${g.id}`,displayName:g.name,photoURL:typeof h=="string"&&/^https?:\/\//i.test(h)?h:null,role:"child",circles:["immediate"],hue:d,dateOfBirth:g.dateOfBirth}),d=(d+58)%360}return a}function Tt(c){const e=[];for(const t of c??[]){if(!t.dateOfBirth)continue;const i=t.dateOfBirth,r=i.getUTCFullYear(),a=String(i.getUTCMonth()+1).padStart(2,"0"),o=String(i.getUTCDate()).padStart(2,"0");e.push({id:`bday:${t.id}`,type:"birthday",date:`${r}-${a}-${o}`,personIds:[`child:${t.id}`],title:`${t.name}'s birthday`,_childId:t.id,_childName:t.name,recurring:!0})}return e}function Nt(c,e=new Date){if(!(c!=null&&c.date))return{date:null,yearsElapsed:0};const t=$(c.date);if(!t||Number.isNaN(t.getTime()))return{date:null,yearsElapsed:0};if(!c.recurring)return{date:t,yearsElapsed:0};const i=new Date(e.getFullYear(),t.getMonth(),t.getDate()),r=i<new Date(e.getFullYear(),e.getMonth(),e.getDate())?new Date(e.getFullYear()+1,t.getMonth(),t.getDate()):i,a=r.getFullYear()-t.getFullYear();return{date:r,yearsElapsed:a}}const Le=["linear-gradient(135deg, #6b9ac4 0%, #c98a8a 60%, #d4a843 100%)","linear-gradient(135deg, #7a9e7e 0%, #4a6754 70%, #2c4439 100%)","linear-gradient(135deg, #c67b5c 0%, #d4a843 50%, #c98a8a 100%)","linear-gradient(135deg, #3d9b8f 0%, #1f5c54 100%)","linear-gradient(135deg, #d4a843 0%, #c67b5c 55%, #c98a8a 100%)","linear-gradient(135deg, #8b7bb5 0%, #c98a8a 60%, #d4a843 100%)","linear-gradient(135deg, #6b9ac4 0%, #3d9b8f 100%)"];function $(c){if(!c)return null;if(c instanceof Date)return c;const e=String(c).match(/^(\d{4})-(\d{2})-(\d{2})/);return e?new Date(Number(e[1]),Number(e[2])-1,Number(e[3])):new Date(c)}function Bt(c){if(!c)return null;const e=c.getFullYear(),t=String(c.getMonth()+1).padStart(2,"0"),i=String(c.getDate()).padStart(2,"0");return`${e}-${t}-${i}`}async function Ot(c,e=90,t=100){const i=new Date,r=new Date(i.getTime()+e*24*60*60*1e3),a=new URL("https://www.googleapis.com/calendar/v3/calendars/primary/events");a.searchParams.set("timeMin",i.toISOString()),a.searchParams.set("timeMax",r.toISOString()),a.searchParams.set("maxResults",String(t)),a.searchParams.set("singleEvents","true"),a.searchParams.set("orderBy","startTime");const o=await fetch(a.toString(),{headers:{Authorization:`Bearer ${c}`}});if(!o.ok){const l=await o.text();throw o.status===401?new Error("Your Google session expired — connect your calendar again."):o.status===403&&/accessNotConfigured|SERVICE_DISABLED|PERMISSION_DENIED|insufficient/i.test(l)?new Error("Google Calendar access isn’t configured for this project yet. (Admin: enable the Google Calendar API and add the calendar.readonly scope to the OAuth consent screen in Google Cloud Console.)"):new Error(`Google Calendar: ${o.status} ${l.slice(0,160)}`)}return((await o.json()).items??[]).filter(l=>{var d,g;return l.status!=="cancelled"&&(((d=l.start)==null?void 0:d.date)||((g=l.start)==null?void 0:g.dateTime))})}function Rt(c,e){var r,a,o,n,l,d,g,h;const t=((r=c.start)==null?void 0:r.date)??((o=(a=c.start)==null?void 0:a.dateTime)==null?void 0:o.slice(0,10))??"";let i=((n=c.end)==null?void 0:n.date)??((d=(l=c.end)==null?void 0:l.dateTime)==null?void 0:d.slice(0,10))??t;if((g=c.start)!=null&&g.date&&((h=c.end)!=null&&h.date)){const p=new Date(i);p.setDate(p.getDate()-1),i=p.toISOString().slice(0,10)}return{title:c.summary||"(untitled)",location:c.location??"",start:t,end:i,attendees:e?[e]:[],viewers:[],visibility:"family",notes:(c.description??"").slice(0,1e3),gcalEventId:c.id,gcalEventLink:c.htmlLink??null}}function jt(c){if(c!=null&&c.coverGradient)return c.coverGradient;const e=((c==null?void 0:c.title)??(c==null?void 0:c.id)??"")+((c==null?void 0:c.location)??"");let t=0;for(let i=0;i<e.length;i++)t=t*31+e.charCodeAt(i)>>>0;return Le[t%Le.length]}class ge extends M{constructor(){super(),this.year=new Date().getFullYear(),this.tripDays=new Map,this.trips=[],this.events=[],this.today=new Date,this._activeDay=null}_isLeap(e){return e%4===0&&e%100!==0||e%400===0}_daysInMonth(e,t){return[31,this._isLeap(e)?29:28,31,30,31,30,31,31,30,31,30,31][t]}_labelsForMonth(e){var a;const t=this.year,i=new Map,r=(o,n)=>{const l=i.get(o);i.set(o,l?`${l} · ${n}`:n)};for(const o of this.trips??[]){if(!o.start||!o.end)continue;const n=$(o.start),l=$(o.end);if(!n||!l||n.getFullYear()>t||l.getFullYear()<t)continue;const d=new Date(t,e,1),g=new Date(t,e+1,0);if(l<d||n>g)continue;const h=n.getMonth()===e&&n.getFullYear()===t?n.getDate():1,p=l.getMonth()===e&&l.getFullYear()===t?l.getDate():g.getDate(),u=(a=o.location)!=null&&a.trim()?`${o.title} (${o.location.trim()})`:o.title;for(let b=h;b<=p;b++)r(b,u)}for(const o of this.events??[]){const n=$(o.date);n&&n.getFullYear()===t&&n.getMonth()===e&&r(n.getDate(),o.title??"Event")}return i}_renderMonth(e){var d,g;const t=this.year,r=(new Date(t,e,1).getDay()+6)%7,a=this._daysInMonth(t,e),o=this._labelsForMonth(e),n=[];for(let h=0;h<r;h++)n.push(s`<div class="cell empty"></div>`);const l=this.today;for(let h=1;h<=a;h++){const p=`${String(e+1).padStart(2,"0")}-${String(h).padStart(2,"0")}`,u=this.tripDays.get(p)??0,b=l.getFullYear()===t&&l.getMonth()===e&&l.getDate()===h,f=o.get(h),m=(this.events??[]).some(z=>{const I=$(z.date);return I&&I.getFullYear()===t&&I.getMonth()===e&&I.getDate()===h}),_=((d=this._activeDay)==null?void 0:d.month)===e&&((g=this._activeDay)==null?void 0:g.day)===h,A=["cell",b?"today":"",u>0?"trip":"",u>.6?"dense":"",m?"event":"",f?"labelled":"",_?"active":""].filter(Boolean).join(" ");n.push(s`<div
        class=${A}
        title=${f?`${h} ${this._monthName(e)} — ${f}`:""}
        @click=${z=>f&&this._onDayTap(z,e,h,f)}
      ...
      ${this._activeDay?s`
          ...
          `:""}
    `}}x(ge,"properties",{year:{type:Number},tripDays:{type:Object},trips:{type:Array},events:{type:Array},today:{type:Object},_activeDay:{state:!0}}),x(ge,"styles",S`
    :host {
      display: block;
    }
  ...
  `);customElements.define("yearly-view",ge);class ue extends M{constructor(){super(),this.name="",this.hue=200,this.photo="",this.size=36,this.showName=!1}_initials(){return this.name.split(/\s+/).map(e=>e[0]).filter(Boolean).slice(0,2).join("").toUpperCase()}render(){const e=`linear-gradient(135deg, hsl(${this.hue}, 55%, 62%) 0%, hsl(${(this.hue+40)%360}, 50%, 42%) 100%)`,t=`width:${this.size}px;height:${this.size}px;background:${e};font-size:${this.size*.38}px;`;return s`
    ...
    `}}x(ue,"properties",{name:{type:String},hue:{type:Number},photo:{type:String},size:{type:Number},showName:{type:Boolean,attribute:"show-name"}}),x(ue,"styles",S`
    :host {
      display: inline-flex;
      align-items: center;
      gap: 8px;
  ...
  `);customElements.define("member-chip",ue);class be extends M{constructor(){super(),this.start="",this.end="",this._displayMonth=null,this._hoverDate=null}willUpdate(e){if(e.has("start")||this._displayMonth===null){const t=this.start?$(this.start):new Date;this._displayMonth=new Date(t.getFullYear(),t.getMonth(),1)}}_isoFor(e,t,i){return`${e}-${String(t+1).padStart(2,"0")}-${String(i).padStart(2,"0")}`}_emit(e,t){this.start=e,this.end=t,this._hoverDate=null,this.dispatchEvent(new CustomEvent("range-change",{detail:{start:e,end:t},bubbles:!0,composed:!0}))}_onDayClick(e){if(!this.start||this.start&&this.end){this._emit(e,"");return}e<this.start?this._emit(e,this.start):this._emit(this.start,e)}_onDayHover(e){this.start&&!this.end&&(this._hoverDate=e)}_onLeave(){this._hoverDate=null}_shiftMonth(e){const t=this._displayMonth;this._displayMonth=new Date(t.getFullYear(),t.getMonth()+e,1)}_isToday(e,t,i){const r=new Date;return r.getFullYear()===e&&r.getMonth()===t&&r.getDate()===i}_inSelectedRange(e){return!this.start||!this.end?!1:e>this.start&&e<this.end}_inHoverRange(e){if(!this.start||this.end||!this._hoverDate)return!1;const t=this._hoverDate<this.start?this._hoverDate:this.start,i=this._hoverDate<this.start?this.start:this._hoverDate;return e>t&&e<i}_summary(){if(!this.start&&!this.end)return"Pick a start date";const e=t=>{const i=$(t);return i?i.toLocaleString("en-GB",{day:"numeric",month:"short",year:"numeric"}):""};return this.start&&!this.end?`From ${e(this.start)} — pick an end date`:this.start===this.end?e(this.start):`${e(this.start)} – ${e(this.end)}`}_renderGrid(){const e=this._displayMonth.getFullYear(),t=this._displayMonth.getMonth(),r=(new Date(e,t,1).getDay()+6)%7,a=new Date(e,t+1,0).getDate(),o=[];for(let n=0;n<r;n++)o.push(s`<div class="empty"></div>`);for(let n=1;n<=a;n++){const l=this._isoFor(e,t,n),d=l===this.start,g=l===this.end&&l!==this.start,h=this._inSelectedRange(l),p=this._inHoverRange(l),u=this._isToday(e,t,n),b=["day",d?"start":"",g?"end":"",h?"in-range":"",p?"hover-range":"",u&&!d&&!g?"today":""].filter(Boolean).join(" ");o.push(s`
    ...
    `}}x(be,"properties",{start:{type:String},end:{type:String},_displayMonth:{state:!0},_hoverDate:{state:!0}}),x(be,"styles",S`
    * { box-sizing: border-box; }
    :host {
      display: block;
    }
  ...
  `);customElements.define("trip-form",me);class fe extends M{constructor(){super(),this.open=!1,this.event=null,this.members=[],this.familyId="",this.busy=!1,this._draft=this._blankDraft(),this._error=""}willUpdate(e){(e.has("event")||e.has("open"))&&(this.open&&(this._draft=this._draftFromEvent(this.event)),this._error="")}_blankDraft(){return{id:null,type:"birthday",title:"",date:new Date().toISOString().slice(0,10),personIds:[],recurring:!0,subtitle:"",notes:"",visibility:"family"}}_draftFromEvent(e){return e?{id:e.id??null,type:e.type??"birthday",title:e.title??"",date:e.date??new Date().toISOString().slice(0,10),personIds:Array.isArray(e.personIds)?[...e.personIds]:[],recurring:e.recurring??!0,subtitle:e.subtitle??"",notes:e.notes??"",visibility:e.visibility??"family"}:this._blankDraft()}_set(e,t){this._draft={...this._draft,[e]:t}}_toggleType(e){this._set("type",e)}_togglePerson(e){const t=this._draft.personIds.includes(e);this._set("personIds",t?this._draft.personIds.filter(i=>i!==e):[...this._draft.personIds,e])}_onSave(){const e=this._draft;if(!e.title.trim()){this._error="Give it a title.";return}if(!e.date){this._error="Pick a date.";return}if(!this.familyId){this._error="No family yet.";return}this._error="",this.dispatchEvent(new CustomEvent("save",{detail:{...e,title:e.title.trim(),subtitle:e.subtitle.trim(),notes:e.notes.trim()}}))}_onDelete(){this._draft.id&&confirm("Delete this event? This can't be undone.")&&this.dispatchEvent(new CustomEvent("remove",{detail:{id:this._draft.id}}))}_onCancel(){this.dispatchEvent(new Event("cancel"))}render(){if(!this.open)return s``;const e=this._draft,t=!!e.id;return s`
    ...
    `}_monthDay(e){if(!e)return"";const t=$(e);return!t||Number.isNaN(t.getTime())?"":t.toLocaleString("en-GB",{day:"numeric",month:"long"})}}x(fe,"properties",{open:{type:Boolean,reflect:!0},event:{type:Object},members:{type:Array},familyId:{type:String},busy:{type:Boolean},_draft:{state:!0},_error:{state:!0}}),x(fe,"styles",S`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("event-form",fe);let R=null,Ue=null;function Lt(){return R||(R=document.createElement("div"),R.id="cairn-toast-host",Object.assign(R.style,{position:"fixed",bottom:"24px",left:"50%",transform:"translateX(-50%)",zIndex:9999,pointerEvents:"none"}),document.body.appendChild(R),R)}function w(c,{duration:e=2800}={}){const t=Lt();clearTimeout(Ue),t.innerHTML="";const i=document.createElement("div");i.textContent=c,Object.assign(i.style,{padding:"12px 18px",background:"rgba(20, 12, 6, 0.78)",backdropFilter:"blur(24px) saturate(180%)",webkitBackdropFilter:"blur(24px) saturate(180%)",border:"1px solid rgba(255, 248, 235, 0.22)",borderRadius:"999px",color:"rgba(255, 248, 235, 0.96)",fontFamily:"'Inter', system-ui, sans-serif",fontSize:"13.5px",fontWeight:"500",letterSpacing:"0.005em",boxShadow:"0 12px 32px rgba(20, 12, 6, 0.45)",pointerEvents:"auto",transform:"translateY(8px)",opacity:"0",transition:"opacity 200ms ease, transform 240ms ease"}),t.appendChild(i),requestAnimationFrame(()=>{i.style.opacity="1",i.style.transform="translateY(0)"}),Ue=setTimeout(()=>{i.style.opacity="0",i.style.transform="translateY(8px)",setTimeout(()=>i.remove(),260)},e)}class ve extends M{constructor(){super(),this.open=!1,this.family=null,this.immediate=[],this.extended=[],this._busy=!1,this._newGroupName="",this._editingGroupId=null}_onCancel(){this.dispatchEvent(new Event("cancel"))}async _createSubGroup(){const e=this._newGroupName.trim();if(!(!e||this._busy)){this._busy=!0;try{const t=await y.saveSubGroup({name:e,memberIds:[]});this._newGroupName="",this._editingGroupId=t,w(`Sub-group "${e}" created.`)}catch(t){w(`Couldn't create: ${t.code??t.message}`,{duration:5e3})}finally{this._busy=!1}}}async _toggleSubGroupMember(e,t){var o,n;const i=(n=(o=this.family)==null?void 0:o.subGroups)==null?void 0:n[e];if(!i)return;const r=i.memberIds??[],a=r.includes(t)?r.filter(l=>l!==t):[...r,t];try{await y.saveSubGroup({id:e,name:i.name,memberIds:a})}catch(l){w(`Couldn't update: ${l.code??l.message}`,{duration:5e3})}}async _deleteSubGroup(e,t){if(confirm(`Delete the "${t}" sub-group?`))try{await y.deleteSubGroup(e),this._editingGroupId===e&&(this._editingGroupId=null),w("Sub-group deleted.")}catch(i){w(`Couldn't delete: ${i.code??i.message}`,{duration:5e3})}}async _regenerate(){if(!this._busy){this._busy=!0;try{await y.regenerateCairnInviteCode(),w("New invite code generated.")}catch(e){console.error(e),w(`Couldn't generate code: ${e.code??e.message}`,{duration:5e3})}finally{this._busy=!1}}}_inviteLink(e){return`${window.location.origin}/portal/?join=${e}`}async _copyLink(){var t;const e=(t=this.family)==null?void 0:t.cairnInviteCode;if(e)try{await navigator.clipboard.writeText(this._inviteLink(e)),w("Invite link copied to clipboard.")}catch{w("Could not copy — try long-press the link instead.")}}async _share(){var i,r;const e=(i=this.family)==null?void 0:i.cairnInviteCode;if(!e)return;const t=this._inviteLink(e);if(navigator.share)try{await navigator.share({title:"Join my family on Cairn",text:`Join ${((r=this.family)==null?void 0:r.name)??"our family"} on Cairn — our shared family calendar.`,url:t})}catch{}else this._copyLink()}_expiryText(e){if(!e)return"";const t=e.toDate?e.toDate():new Date(e),r=Math.max(0,Math.round((t-new Date)/(1440*60*1e3)));return r===0?"Expires today":r===1?"Expires tomorrow":`Expires in ${r} days`}render(){var r,a,o,n;if(!this.open)return s``;const e=(r=this.family)==null?void 0:r.cairnInviteCode,t=(a=this.family)==null?void 0:a.cairnInviteCodeExpiresAt,i=t&&(t.toDate?t.toDate():new Date(t))<new Date;return s`
    ...
    `}}x(ve,"properties",{open:{type:Boolean,reflect:!0},family:{type:Object},immediate:{type:Array},extended:{type:Array},_busy:{state:!0},_newGroupName:{state:!0},_editingGroupId:{state:!0}}),x(ve,"styles",S`
    * {
      box-sizing: border-box;
    }
    :host {
...
`)}class xe extends M{constructor(){super(),this.trip=null,this.members=[],this._resizeObs=null}connectedCallback(){super.connectedCallback(),typeof ResizeObserver<"u"&&(this._resizeObs=new ResizeObserver(()=>this._fitTitle()))}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._resizeObs)==null||e.disconnect()}updated(){if(this._resizeObs&&this.renderRoot){const e=this.renderRoot.querySelector("article");e&&!e._observed&&(this._resizeObs.observe(e),e._observed=!0)}this._fitTitle()}_fitTitle(){if(!this.renderRoot)return;const e=this.renderRoot.querySelector("h3");if(!e)return;e.style.fontSize="";let t=19;for(e.style.fontSize=`${t}px`;e.scrollWidth>e.clientWidth+1&&t>13;)t-=.5,e.style.fontSize=`${t}px`}_fmtDates(e,t){const i=$(e),r=$(t);if(!i||!r)return"";const a=i.toLocaleString("en-GB",{month:"short"}),o=r.toLocaleString("en-GB",{month:"short"});return a===o&&i.getFullYear()===r.getFullYear()?`${i.getDate()} – ${r.getDate()} ${a}`:`${i.getDate()} ${a} – ${r.getDate()} ${o}`}async _onShare(e,t,i){i.stopPropagation();const r=Ut(e,t);if(navigator.share)try{await navigator.share({title:`Cairn — ${e.title??"activity"}`,text:r})}catch{}else try{await navigator.clipboard.writeText(r),w("Itinerary copied to clipboard.")}catch{w("Could not copy — try again from a browser tab.")}}render(){const e=this.trip;if(!e)return s``;const t=e.coverImage?`background-image: url(${e.coverImage});`:`background: ${jt(e)};`,i=e.coverImage?"cover has-image":"cover",r=new Map(this.members.map(l=>[l.uid,l])),a=(e.attendees??[]).map(l=>r.get(l)).filter(Boolean),o=a.slice(0,4),n=Math.max(0,a.length-o.length);return s`
    ...
    `}}x(xe,"properties",{trip:{type:Object},members:{type:Array}}),x(xe,"styles",S`
    :host {
      display: block;
    }
    article {
  ...
  `);customElements.define("trip-card",xe);class ye extends M{constructor(){super(),this.open=!1,this.trips=[],this.members=[]}_onCancel(){this.dispatchEvent(new Event("cancel"))}_groupByYear(e){const t=[...e].sort((a,o)=>String(a.start).localeCompare(String(o.start))),i=new Date;i.setHours(0,0,0,0);const r=new Map;for(const a of t){if(!a.start)continue;const o=$(a.start),n=$(a.end);if(!o)continue;const l=o.getFullYear();r.has(l)||r.set(l,[]);const d=n?n<i:!1;r.get(l).push({trip:a,isPast:d})}return r}render(){var r;if(!this.open)return s``;const e=this._groupByYear(this.trips??[]),t=((r=this.trips)==null?void 0:r.length)??0,i=new Date().getFullYear();return s`
      <div class="backdrop" @click=${this._onCancel}></div>
      <div class="sheet">
        <glass-panel padding="lg" variant="strong" lifted>
          <div class="header">
    ...
    `}}x(ye,"properties",{open:{type:Boolean,reflect:!0},trips:{type:Array},members:{type:Array}}),x(ye,"styles",S`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("all-trips-modal",ye);class we extends M{constructor(){super(),this.open=!1,this._events=[],this._selected=new Set,this._loading=!1,this._error="",this._importing=!1,this._started=!1}willUpdate(e){e.has("open")&&this.open&&(this._started=!1,this._error="")}_start(){this._loading||(this._started=!0,this._load())}async _load(){var e,t,i,r,a,o;this._loading=!0,this._error="";try{const n=await rt(),l=await Ot(n,90),d=new Set((y.state.trips??[]).filter(h=>h.gcalEventId).map(h=>h.gcalEventId));this._events=l.map(h=>({...h,_alreadyImported:d.has(h.id)}));const g=new Set;for(const h of this._events){if(h._alreadyImported)continue;const p=((e=h.start)==null?void 0:e.date)??((i=(t=h.start)==null?void 0:t.dateTime)==null?void 0:i.slice(0,10)),u=((r=h.end)==null?void 0:r.date)??((o=(a=h.end)==null?void 0:a.dateTime)==null?void 0:o.slice(0,10));p&&u&&u!==p&&g.add(h.id)}this._selected=g}catch(n){console.error(n),this._error=(n==null?void 0:n.message)??"Could not load calendar events."}finally{this._loading=!1}}_toggle(e){const t=new Set(this._selected);t.has(e)?t.delete(e):t.add(e),this._selected=t}_toggleAll(){const e=this._events.filter(t=>!t._alreadyImported);this._selected.size===e.length?this._selected=new Set:this._selected=new Set(e.map(t=>t.id))}async _import(){var a;if(this._importing||this._selected.size===0)return;this._importing=!0;const e=(a=k==null?void 0:k.currentUser)==null?void 0:a.uid,t=this._events.filter(o=>this._selected.has(o.id));let i=0,r=0;for(const o of t){const n=Rt(o,e);try{await y.saveTrip(n),i++}catch(l){console.error("Import failed for event",o.id,l),r++}}this._importing=!1,r===0?w(`Imported ${i} ${i===1?"activity":"activities"}.`):w(`Imported ${i}, ${r} failed.`,{duration:5e3}),this._events=[],this._selected=new Set,this.dispatchEvent(new Event("cancel"))}_onCancel(){this.dispatchEvent(new Event("cancel"))}_fmtRange(e){var g,h,p,u,b,f,m,_;const t=((g=e.start)==null?void 0:g.date)??((p=(h=e.start)==null?void 0:h.dateTime)==null?void 0:p.slice(0,10)),i=((u=e.end)==null?void 0:u.date)??((f=(b=e.end)==null?void 0:b.dateTime)==null?void 0:f.slice(0,10));if(!t)return"";const r=new Date(t);if(!i||i===t)return r.toLocaleString("en-GB",{day:"numeric",month:"short",year:"numeric"});let a=new Date(i);(m=e.start)!=null&&m.date&&((_=e.end)!=null&&_.date)&&a.setDate(a.getDate()-1);const o=r.getMonth()===a.getMonth()&&r.getFullYear()===a.getFullYear(),n=r.getFullYear()===a.getFullYear();if(o)return`${r.getDate()}–${a.getDate()} ${r.toLocaleString("en-GB",{month:"short",year:"numeric"})}`;const l=r.toLocaleString("en-GB",{day:"numeric",month:"short"}),d=a.toLocaleString("en-GB",{day:"numeric",month:"short",year:"numeric"});return n?`${l} – ${d}`:`${r.toLocaleDateString()} – ${a.toLocaleDateString()}`}render(){if(!this.open)return s``;const e=this._events.filter(i=>!i._alreadyImported),t=e.length>0&&this._selected.size===e.length;return s`
      <div class="backdrop" @click=${this._onCancel}></div>
      <div class="sheet">
        <glass-panel padding="lg" variant="strong" lifted>
          <div class="header">
    ...
    `}}x(we,"properties",{open:{type:Boolean,reflect:!0},_events:{state:!0},_selected:{state:!0},_loading:{state:!0},_error:{state:!0},_importing:{state:!0},_started:{state:!0}}),x(we,"styles",S`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("import-calendar-modal",we);class _e extends M{constructor(){super(),this.open=!1,this.user=null,this.pebbleUser=null,this._name="",this._savingName=!1,this._uploadingPhoto=!1}willUpdate(e){var t;e.has("open")&&this.open&&(this._name=((t=this.user)==null?void 0:t.displayName)??"")}_onCancel(){this.dispatchEvent(new Event("cancel"))}async _saveName(){var i,r;const e=this._name.trim();if(!e||e===(((i=this.user)==null?void 0:i.displayName)??""))return;const t=(r=k==null?void 0:k.currentUser)==null?void 0:r.uid;if(!(!t||!v)){this._savingName=!0;try{await P(D(v,"users",t),{displayName:e,updatedAt:C()});const a=y.familyId;if(a)try{await P(D(v,"families",a),{[`memberProfiles.${t}.displayName`]:e,[`memberProfiles.${t}.updatedAt`]:C(),updatedAt:C()})}catch(o){console.warn("memberProfiles fan-out failed:",o)}w("Display name updated.")}catch(a){console.error(a),w(`Couldn't save: ${a.code??a.message}`,{duration:5e3})}finally{this._savingName=!1}}}async _signOut(){confirm("Sign out of Cairn?")&&(this.dispatchEvent(new Event("cancel")),await nt())}_triggerPhotoPicker(){var e;(e=this.renderRoot.querySelector("#photo-file"))==null||e.click()}async _onPhotoChosen(e){var a,o;const t=(a=e.target.files)==null?void 0:a[0];if(e.target.value="",!t)return;if(!t.type.startsWith("image/")){w("Pick an image file (JPG, PNG, etc.).");return}if(t.size>5*1024*1024){w("Photo is too big — keep it under 5 MB.");return}const i=(o=k==null?void 0:k.currentUser)==null?void 0:o.uid,r=y.familyId;if(!i||!r||!Z){w("Can't upload yet — you need to be in a family first.");return}this._uploadingPhoto=!0;try{const n=Be(Z,`families/${r}/avatars/users/${i}`);await tt(n,t,{contentType:t.type});const l=await Ne(n);await P(D(v,"users",i),{profilePhotoURL:l,updatedAt:C()});try{await P(D(v,"families",r),{[`memberProfiles.${i}.profilePhotoURL`]:l,[`memberProfiles.${i}.updatedAt`]:C(),updatedAt:C()})}catch(d){console.warn("memberProfiles photo fan-out failed:",d)}w("Photo updated.")}catch(n){console.error("Photo upload failed",n),w(`Upload failed: ${n.code??n.message}`,{duration:5e3})}finally{this._uploadingPhoto=!1}}render(){if(!this.open)return s``;const e=this.user,t=this._name.trim()&&this._name.trim()!==((e==null?void 0:e.displayName)??"");return s`
    ...
    `}}x(_e,"properties",{open:{type:Boolean,reflect:!0},user:{type:Object},pebbleUser:{type:Object},_name:{state:!0},_savingName:{state:!0},_uploadingPhoto:{state:!0}}),x(_e,"styles",S`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("profile-sheet",_e);const q=class q extends M{constructor(){super(),this.open=!1}static get OPTIONS(){return[{type:"activity",tone:"sage",icon:s`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    `:s``}};x(q,"properties",{open:{type:Boolean,reflect:!0}}),x(q,"styles",S`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);let ke=q;customElements.define("activity-type-picker",ke);class $e extends M{constructor(){super(),this.open=!1,this.floating=!1,this.family=null,this.trips=[],this._messages=[],this._input="",this._loading=!1,this._error="",this._followUps=[]}willUpdate(e){var t;e.has("_messages")&&(this.floating=(((t=this._messages)==null?void 0:t.length)??0)>0)}_onCancel(){this.dispatchEvent(new Event("cancel"))}_suggestions(){const e=[],t=(this.trips??[]).filter(i=>i.start&&new Date(i.start)>=new Date).sort((i,r)=>String(i.start).localeCompare(String(r.start)))[0];return t&&(e.push(`What should we do in ${t.location||t.title}?`),e.push(`What should we pack for ${t.title}?`)),e.push("Plan a family activity for this weekend"),e.push("Gift ideas for an upcoming birthday"),e.slice(0,4)}async _send(e){const t=(e??this._input).trim();if(!(!t||this._loading)){this._error="",this._input="",this._followUps=[],this._messages=[...this._messages,{role:"user",content:t}],this._loading=!0,this.updateComplete.then(()=>this._scrollToBottom());try{const i=this._messages.slice(0,-1).map(a=>({role:a.role,content:a.content})),r=await y.askPebble(t,i);this._messages=[...this._messages,{role:"assistant",content:r.answer}],this._followUps=Array.isArray(r.followUps)?r.followUps:[]}catch(i){console.error(i),(i==null?void 0:i.code)==="functions/unauthenticated"?this._error="Pebble needs you to be signed in.":(i==null?void 0:i.code)==="functions/permission-denied"?this._error="You're not in this family yet.":(i==null?void 0:i.code)==="functions/not-found"||(i==null?void 0:i.code)==="functions/internal"?this._error="Pebble isn't available right now — the Cloud Function may not be deployed yet.":this._error=(i==null?void 0:i.message)??"Pebble could not answer right now."}finally{this._loading=!1,this.updateComplete.then(()=>this._scrollToBottom())}}}_scrollToBottom(){const e=this.renderRoot.querySelector(".thread");e&&(e.scrollTop=e.scrollHeight)}_renderPebbleIcon(){return s`
    ...
    `}}x($e,"properties",{open:{type:Boolean,reflect:!0},floating:{type:Boolean,reflect:!0},family:{type:Object},trips:{type:Array},_messages:{state:!0},_input:{state:!0},_loading:{state:!0},_error:{state:!0},_followUps:{state:!0}}),x($e,"styles",S`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("pebble-chat",$e);class ct extends M{render(){return s`
  ...
  `);customElements.define("discover-pebblepath",ct);class Ce extends M{constructor(){super(),this.code="",this._family=null,this._loading=!0,this._joining=!1,this._error=""}willUpdate(e){e.has("code")&&this.code&&this._lookup()}async _lookup(){var e,t;this._loading=!0,this._error="";try{const i=await y.findFamilyByCairnCode(this.code);if(!i)this._error="Invite code not found. Check it was typed correctly.",this._family=null;else{const r=((t=(e=i.cairnInviteCodeExpiresAt)==null?void 0:e.toDate)==null?void 0:t.call(e))??(i.cairnInviteCodeExpiresAt?new Date(i.cairnInviteCodeExpiresAt):null);!r||r<new Date?(this._error="This invite code has expired. Ask the family for a fresh one.",this._family=null):this._family=i}}catch(i){console.error(i),this._error=(i==null?void 0:i.message)??"Couldn't look up the invite."}finally{this._loading=!1}}async _join(){var e;if(!this._joining){this._joining=!0,this._error="";try{const t=await y.joinFamilyAsCairn(this.code);w(`Welcome to ${((e=this._family)==null?void 0:e.name)??"the family"}.`),this.dispatchEvent(new CustomEvent("joined",{detail:{familyId:t}}))}catch(t){console.error(t),this._error=(t==null?void 0:t.message)??"Could not join."}finally{this._joining=!1}}}_cancel(){this.dispatchEvent(new Event("cancel"))}_inviterFromFamily(e){var r;if(!e)return null;const t=(r=e.memberProfiles)==null?void 0:r[e.createdBy];if(!t)return null;const i=t.profilePhotoURL;return{displayName:t.displayName??"A family member",photoURL:typeof i=="string"&&/^https?:\/\//i.test(i)?i:null}}render(){var r,a,o;const e=this._inviterFromFamily(this._family),t=(((r=this._family)==null?void 0:r.cairnMemberIds)??((a=this._family)==null?void 0:a.memberIds)??[]).length,i=(((o=this._family)==null?void 0:o.memberIds)??[]).length;return s`
    ...
    `}}x(Ce,"properties",{code:{type:String},_family:{state:!0},_loading:{state:!0},_joining:{state:!0},_error:{state:!0}}),x(Ce,"styles",S`
    * { box-sizing: border-box; }
    :host {
      display: flex;
      align-items: center;
  ...
  `);customElements.define("join-family-screen",Ce);class ze extends M{constructor(){super(),this.error="",this.busy=!1,this.joinCode="",this._codeInputOpen=!1,this._code=""}async _handleSignIn(){if(this.busy)return;const e=(this._code??"").trim().toUpperCase();if(this._codeInputOpen&&e){const t=e.startsWith("CAIRN-")?e:`CAIRN-${e.replace(/^CAIRN-?/i,"")}`;try{localStorage.setItem("cairn:pendingJoinCode",t)}catch{}}this.busy=!0,this.error="";try{await W()}catch(t){this.error=(t==null?void 0:t.message)??"Sign-in failed."}finally{this.busy=!1}}_toggleCode(){this._codeInputOpen=!this._codeInputOpen,this._codeInputOpen&&requestAnimationFrame(()=>{var e;(e=this.renderRoot.querySelector(".code-input"))==null||e.focus()})}_renderGoogleIcon(){return s`
    ...
    `}}x(ze,"properties",{error:{state:!0},busy:{state:!0},joinCode:{type:String},_codeInputOpen:{state:!0},_code:{state:!0}}),x(ze,"styles",S`
    * {
      box-sizing: border-box;
    }
    :host {
  ...
  `);customElements.define("sign-in-screen",ze);const Gt="cairn:pendingCreateFamily",Yt="cairn:pendingJoinCode",Ge="cairn:pendingLoginIntent";class Me extends M{constructor(){super(),this.error="",this.busy=!1,this.joinCode="",this._step="choose",this._authMode=null,this._email="",this._password="",this._confirmPassword="",this._displayName="",this._familyName="",this._code="",this._resetSent=!1}willUpdate(e){e.has("joinCode")&&this.joinCode&&this._step==="choose"&&(this._code=this.joinCode,this._step="join")}_iconLogin(){return s`<svg viewBox="0 0 24 24" aria-hidden="true">
    ...
    `}}x(Me,"properties",{error:{state:!0},busy:{state:!0},joinCode:{type:String},_step:{state:!0},_authMode:{state:!0},_email:{state:!0},_password:{state:!0},_confirmPassword:{state:!0},_displayName:{state:!0},_familyName:{state:!0},_code:{state:!0},_resetSent:{state:!0}}),x(Me,"styles",S`
    * { box-sizing: border-box; }
    :host {
      display: flex;
      align-items: center;
  ...
  `);customElements.define("register-screen",Me);const Y=class Y extends M{constructor(){super(),this.value="family"}_select(e){e!==this.value&&(this.value=e,this.dispatchEvent(new CustomEvent("circle-change",{detail:{value:e},bubbles:!0,composed:!0})))}render(){return s`
    ...
    `}};x(Y,"properties",{value:{type:String,reflect:!0}}),x(Y,"OPTIONS",[{value:"personal",label:"Just me"},{value:"family",label:"Family"},{value:"extended",label:"Extended"}]),x(Y,"styles",S`
    * {
      box-sizing: border-box;
    }
    :host {
  ...
  `);let Se=Y;customElements.define("circle-switcher",Se);class De extends M{constructor(){super(),this.event=null,this.members=[]}_icon(e){return e==="birthday"?s`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
    ...
    </svg>`}_fmtDate(e){const t=$(e)??new Date(e);return{day:t.getDate(),month:t.toLocaleString("en-GB",{month:"short"})}}render(){const e=this.event;if(!e)return s``;const t=this._fmtDate(e.date),i=new Map((this.members??[]).map(a=>[a.uid,a])),r=(e.personIds??[]).map(a=>i.get(a)).filter(Boolean);return s`
      <div
        class="row"
    ...
    `}}x(De,"properties",{event:{type:Object},members:{type:Array}}),x(De,"styles",S`
    :host {
      display: block;
    }
    .row {
  ...
  `);customElements.define("event-row",De);const Q=[{key:"motor",label:"Motor",color:"#6b9ac4",svg:s`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><circle cx="13.5" cy="4" r="2"/><path d="M12.6 7.3 8.8 9.9a1 1 0 0 0-.42.66l-.7 3.6a1 1 0 0 0 1.96.38l.5-2.6 1.5-.9-1 4-2.4 4.8a1 1 0 0 0 1.8.9l2.4-4.9.6-2 1.3 2.2.5 4.6a1 1 0 0 0 2-.2l-.5-5a1 1 0 0 0-.13-.42l-1.7-2.9.5-2.7 1.7 1.9a1 1 0 0 0 .76.34l2.3-.05a1 1 0 0 0 0-2l-1.86.04-2.7-3a1 1 0 0 0-.7-.33l-3.3-.06a1 1 0 0 0-.5.12z"/></svg>`},{key:"language",label:"Language",color:"#d4a843",svg:s`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M5 3.5h14A3.5 3.5 0 0 1 22.5 7v6A3.5 3.5 0 0 1 19 16.5h-7.6l-5 4.2A1 1 0 0 1 5 20V16.5A3.5 3.5 0 0 1 1.5 13V7A3.5 3.5 0 0 1 5 3.5z"/></svg>`},{key:"socialEmotional",label:"Social-Emotional",color:"#c98a8a",svg:s`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 21s-7.4-4.6-9.7-9.2A5.4 5.4 0 0 1 12 6.1a5.4 5.4 0 0 1 9.7 5.7C19.4 16.4 12 21 12 21z"/></svg>`},{key:"cognitive",label:"Cognitive",color:"#8b7bb5",svg:s`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M15.5 21v-3.2a3 3 0 0 0 2.3-2.9 4 4 0 0 0-.8-6.6A4.2 4.2 0 0 0 9 5.4 4 4 0 0 0 5 9.3a3.9 3.9 0 0 0 1.6 3.2 3 3 0 0 0 1.7 5.3V21"/><path d="M10.5 8.2a2.3 2.3 0 0 1 2.5 2.2v7"/></svg>`}];function J(c){return c==="selfCare"?"motor":c}function Ht(c){var o;if(!c||Number.isNaN(((o=c.getTime)==null?void 0:o.call(c))??NaN))return"";const e=new Date;let t=(e.getFullYear()-c.getFullYear())*12+(e.getMonth()-c.getMonth());e.getDate()<c.getDate()&&(t-=1),t=Math.max(0,t);const i=Math.floor(t/12),r=t%12;if(i===0)return`${r} month${r===1?"":"s"}`;const a=r?`, ${r} month${r===1?"":"s"}`:"";return`${i} year${i===1?"":"s"}${a}`}const Ye=[{vb:"0 0 100 70",d:"M 8 38 C 6 18, 26 6, 48 8 C 72 10, 94 18, 94 38 C 94 58, 72 66, 48 64 C 22 62, 10 58, 8 38 Z"},{vb:"0 0 80 90",d:"M 38 6 C 56 8, 70 24, 72 46 C 74 70, 58 84, 38 84 C 16 84, 6 66, 8 44 C 10 22, 22 4, 38 6 Z"},{vb:"0 0 90 80",d:"M 14 26 C 18 10, 38 4, 56 8 C 78 14, 86 32, 82 50 C 76 70, 54 78, 32 72 C 12 66, 10 42, 14 26 Z"},{vb:"0 0 70 60",d:"M 8 30 C 8 14, 22 6, 38 8 C 54 10, 64 22, 62 36 C 60 52, 44 56, 28 54 C 14 52, 8 44, 8 30 Z"},{vb:"0 0 110 75",d:"M 8 38 C 6 18, 30 8, 56 10 C 84 12, 104 22, 104 40 C 102 58, 80 68, 52 66 C 24 64, 10 56, 8 38 Z"},{vb:"0 0 95 75",d:"M 14 24 C 18 10, 40 6, 56 12 C 70 18, 80 18, 86 30 C 90 44, 80 56, 64 60 C 48 64, 28 60, 18 50 C 10 42, 10 32, 14 24 Z"},{vb:"0 0 80 80",d:"M 14 20 C 20 10, 36 6, 52 10 C 68 16, 76 30, 72 48 C 66 64, 50 72, 32 66 C 16 60, 8 44, 10 30 C 12 24, 12 22, 14 20 Z"}];function Jt(c){let e=5381;const t=String(c??"");for(let i=0;i<t.length;i+=1)e=e*33^t.charCodeAt(i);return Ye[Math.abs(e)%Ye.length]}const He={motor:{cls:"fam-motor",fill:"#6b9ac4",dom:"Motor"},language:{cls:"fam-language",fill:"#d4a843",dom:"Language"},socialEmotional:{cls:"fam-social",fill:"#c98a8a",dom:"Social-Emotional"},cognitive:{cls:"fam-cognitive",fill:"#8b7bb5",dom:"Cognitive"},cross:{cls:"fam-cross",fill:"#3d9b8f",dom:""}},Je={strength:{label:"Strength",svg:s`<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M12 2.5l2.94 5.96 6.58.96-4.76 4.64 1.12 6.55L12 17.6l-5.88 3.01 1.12-6.55-4.76-4.64 6.58-.96L12 2.5z"/></svg>`},watching:{label:"Watching",svg:s`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M1.5 12S5 5 12 5s10.5 7 10.5 7-3.5 7-10.5 7S1.5 12 1.5 12z"/><circle cx="12" cy="12" r="3.2"/></svg>`},connection:{label:"Connection",svg:s`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M10 13a5 5 0 0 0 7.07.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71M14 11a5 5 0 0 0-7.07-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>`},nudge:{label:"Try this",svg:s`<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M9 21c0 .55.45 1 1 1h4c.55 0 1-.45 1-1v-1H9v1zm3-19C8.14 2 5 5.14 5 9c0 2.38 1.19 4.47 3 5.74V17c0 .55.45 1 1 1h6c.55 0 1-.45 1-1v-2.26c1.81-1.27 3-3.36 3-5.74 0-3.86-3.14-7-7-7z"/></svg>`}};class Ie extends M{constructor(){super(),this.child=null,this.children=[],this.milestones=[],this.insights=[],this.dailyCard=null}_domainStats(e){const t=(this.milestones??[]).filter(a=>J(a.category)===e),i=t.filter(a=>a.status==="achieved").length,r=t.length;return{achieved:i,total:r,pct:r?Math.round(i/r*100):0}}_pebbleIcon(){return s`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round"><circle cx="12" cy="12" r="9" /><circle cx="12" cy="12" r="4" fill="currentColor" stroke="none" /></svg>`}_ageMonths(e){var r;if(!e||Number.isNaN(((r=e.getTime)==null?void 0:r.call(e))??NaN))return 0;const t=new Date;let i=(t.getFullYear()-e.getFullYear())*12+(t.getMonth()-e.getMonth());return t.getDate()<e.getDate()&&(i-=1),Math.max(0,i)}_timelineModel(){var p;const e=this.milestones??[],t=this._ageMonths((p=this.child)==null?void 0:p.dateOfBirth),i=e.reduce((u,b)=>Math.max(u,b.ageRangeEndMonths??0),0),r=[36,48,60,72,96,120,144,168,216,264],a=Math.max(t+4,i,36),o=r.find(u=>u>=a)??r[r.length-1],n=u=>Math.min(98,Math.max(2,(u??0)/o*100)),l=[{key:"motor",cls:"motor",name:"Motor"},{key:"language",cls:"language",name:"Language"},{key:"socialEmotional",cls:"social",name:"Social-Emo."},{key:"cognitive",cls:"cognitive",name:"Cognitive"}].map(u=>{const b=e.filter(z=>J(z.category)===u.key),f=b.filter(z=>z.status==="achieved").sort((z,I)=>(z.ageRangeStartMonths??0)-(I.ageRangeStartMonths??0));let m=f;f.length>7&&(m=Array.from({length:7},(z,I)=>f[Math.round(I*(f.length-1)/6)]));const _=m.map(z=>({left:n(z.ageRangeStartMonths),future:!1})),A=b.filter(z=>z.status!=="achieved").sort((z,I)=>(z.ageRangeStartMonths??0)-(I.ageRangeStartMonths??0))[0];return A&&_.push({left:n(A.ageRangeStartMonths),future:!0}),{...u,dots:_}}),d=u=>u<=0?"birth":u<24?`${u} mo`:u%12===0?`${u/12} yr`:`${(u/12).toFixed(1).replace(/\.0$/,"")} yr`,g=Array.from({length:7},(u,b)=>d(Math.round(b*o/6))),h=Math.min(1,Math.max(0,t/o));return{lanes:l,axis:g,ageM:t,nowFrac:h}}render(){const e=this.child;if(!e)return s`<div class="panel empty">No child selected yet.</div>`;const t=this.milestones??[],i=t.filter(p=>p.status==="achieved"),r=t.length?Math.round(i.length/t.length*100):0,a=i.slice().sort((p,u)=>(u.ageRangeStartMonths??0)-(p.ageRangeStartMonths??0)).slice(0,4),o=t.filter(p=>p.status!=="achieved").slice(0,5),n=e.themeColorHex||"var(--teal-pebble)",l=this.insights??[],d=this._timelineModel(),g=p=>p==="achieved"?"done":p==="emerging"?"emerging":"up",h=p=>p==="achieved"?"Achieved":p==="emerging"?"Emerging":"Upcoming";return s`
      ...
      <section>
        <div class="panel">
          <div class="child-card" style="--theme:${n};">
            ...
            <div class="meta">
              <h2>${e.name}</h2>
              <div class="sub">${Ht(e.dateOfBirth)}</div>
              <span class="agepill"
      ...
      <section>
        ...
        <div class="domains">
          ${Q.map(p=>{const u=this._domainStats(p.key);return s`<div
              class="dtile"
      ...
      <section>
        ...
        <div class="panel">
          <div class="timeline">
            <div
              class="tl-now"
              style="left:calc(118px + (100% - 118px) * ${d.nowFrac});"
            >
              <span
        ...
        <div class="two-col">
          <div>
            ...
            <div class="panel">
              ${o.length===0?s`<div class="empty">
                  ...
                  </div>`:o.map(p=>{var b,f;const u=((b=Q.find(m=>m.key===J(p.category)))==null?void 0:b.color)??"#6b9ac4";return s`<div class="ms-row">
                      <span class="ms-dot" style="background:${u}"></span>
                      <div class="t">
                        ${p.title}
                        <small
                          >${((f=Q.find(m=>m.key===J(p.category)))==null?void 0:f.label)??""}
            ...
            <div class="panel">
              ${a.length===0?s`<div class="empty">
                  ...
                  </div>`:a.map(p=>{var b;const u=((b=Q.find(f=>f.key===J(p.category)))==null?void 0:b.color)??"#6b9ac4";return s`<div class="ms-row">
                      <span class="ms-dot" style="background:${u}"></span>
          ...
          <div>
            ...
            ${l.length===0?s`<div class="panel empty">
                ...
                </div>`:l.map(p=>{const u=He[p.domain]??He.cross,b=Je[p.type]??Je.nudge,f=Jt(`${p.title}${p.type}`);return s`<div class="insight ${u.cls}">
                    <svg
                      class="wm"
                      viewBox=${f.vb}
                      ...
                      aria-hidden="true"
                    >
                      <path d=${f.d} fill=${u.fill} />
                    </svg>
                    <div class="irow">
                      <div class="icirc">${b.svg}</div>
                      <div class="icontent">
                        <div class="cat">
                          <span class="type">${b.label}</span>
        ...
        <div class="panel">
          <div class="cta-card">
            ...
            <div class="ctx">
              ...
              <p>
                A clinician-ready summary of ${e.name}'s milestone
    ...
    `}}x(Ie,"properties",{child:{type:Object},children:{type:Array},milestones:{type:Array},insights:{type:Array},dailyCard:{type:Object}}),x(Ie,"styles",S`
  ...
  `);customElements.define("child-overview",Ie);class Ae extends M{constructor(){super(),this.child=null,this.messages=[],this.prefill="",this._session=[],this._input="",this._loading=!1,this._error="",this._seeded=!1}willUpdate(e){e.has("child")&&(this._seeded=!1,this._session=[],this._error=""),!this._seeded&&Array.isArray(this.messages)&&this.messages.length&&(this._session=this.messages.map(t=>({role:t.role,content:t.content})),this._seeded=!0),e.has("prefill")&&this.prefill&&(this._input=this.prefill)}updated(e){(e.has("messages")||e.has("_session")||e.has("_loading"))&&this.updateComplete.then(()=>this._scrollToBottom())}_scrollToBottom(){const e=this.renderRoot.querySelector(".thread");e&&(e.scrollTop=e.scrollHeight)}_suggestions(){var t;const e=((t=this.child)==null?void 0:t.name)??"your child";return[`What's coming up for ${e}?`,`Ideas for a rainy weekend with ${e}`,`Is ${e}'s speech on track?`,`How can I support ${e} this week?`]}async _send(e){var r;const t=(e??this._input).trim();if(!t||this._loading)return;if(!((r=this.child)!=null&&r.id)){this._error="No child selected.";return}this._error="",this._input="";const i=this._session.slice(-20).map(a=>({role:a.role,content:a.content}));this._session=[...this._session,{role:"user",content:t}],this._loading=!0;try{const a=await y.askPebbleAboutChild(this.child.id,t,i);this._session=[...this._session,{role:"assistant",content:(a==null?void 0:a.answer)??"…"}]}catch(a){console.error(a),(a==null?void 0:a.code)==="functions/unauthenticated"?this._error="Pebble needs you to be signed in.":(a==null?void 0:a.code)==="functions/permission-denied"?this._error="Pebble's child advisor is for parents on this household.":(a==null?void 0:a.code)==="functions/not-found"||(a==null?void 0:a.code)==="functions/internal"?this._error="Pebble isn't available right now — try again in a moment.":this._error=(a==null?void 0:a.message)??"Pebble could not answer right now."}finally{this._loading=!1}}_pico(){return s`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"><circle cx="12" cy="12" r="9" /><circle cx="12" cy="12" r="4.5" fill="currentColor" stroke="none" /></svg>`}render(){var i;const e=((i=this.child)==null?void 0:i.name)??"your child",t=this._session.length>0;return s`
      <div class="wrap">
        <div class="panel">
          <div class="head">
            ...
            <div class="ht">
              <b>Ask Pebble</b>
              <span>Personalised to ${e} · private to parents</span>
            </div>
          </div>

          <div class="thread">
            ${t?s`
                  ${this._session.map(r=>s`<div class="bubble ${r.role}">
                      ${r.content}
                    </div>`)}
    ...
    `}}x(Ae,"properties",{child:{type:Object},messages:{type:Array},prefill:{type:String},_session:{state:!0},_input:{state:!0},_loading:{state:!0},_error:{state:!0},_seeded:{state:!0}}),x(Ae,"styles",S`
    *, *::before, *::after { box-sizing: border-box; }
    :host { display: block; }
    .wrap {
      max-width: 880px;
  ...
  `);customElements.define("child-pebble",Ae);const Ve=[{key:"visit",label:"Visit"},{key:"meal",label:"Meal"},{key:"travel",label:"Travel"},{key:"note",label:"Note"}],oe=56;function Xe(c){const e=String(c??"").match(/^(\d{4})-(\d{2})-(\d{2})/);return e?new Date(Number(e[1]),Number(e[2])-1,Number(e[3])):null}function Vt(c){const e=c.getFullYear(),t=String(c.getMonth()+1).padStart(2,"0"),i=String(c.getDate()).padStart(2,"0");return`${e}-${t}-${i}`}function We(c){const e=String(c??"").match(/^(\d{1,2}):?(\d{2})?/);return e?Number(e[1])+(e[2]?Number(e[2])/60:0):null}function Ke(c){const e=Math.floor(c),t=Math.round((c-e)*60);return`${String(e).padStart(2,"0")}:${String(t).padStart(2,"0")}`}class Ee extends M{constructor(){super(),this.open=!1,this.trip=null,this.members=[],this.currentUid="",this._items=[],this._dayKey=null,this._title="",this._time="12:00",this._type="visit",this._busy=!1,this._unsub=null,this._subId=null}willUpdate(e){var t,i;if(e.has("open")||e.has("trip")){const r=((t=this.trip)==null?void 0:t.id)??null;this.open&&r?this._subId!==r&&(this._teardown(),this._subId=r,this._dayKey=((i=this._days()[0])==null?void 0:i.key)??"",this._unsub=y.planItemsListener(r,a=>{this._items=a})):this.open||this._teardown()}}disconnectedCallback(){super.disconnectedCallback(),this._teardown()}_teardown(){var e;(e=this._unsub)==null||e.call(this),this._unsub=null,this._subId=null,this._items=[]}_close(){this.dispatchEvent(new Event("cancel"))}_days(){var o,n;const e=Xe((o=this.trip)==null?void 0:o.start),t=Xe((n=this.trip)==null?void 0:n.end)??e;if(!e)return[{key:"",lbl:"Day",d:"The trip"}];const i=[],r=new Date(e);let a=0;for(;r<=t&&a<31;)i.push({key:Vt(r),lbl:r.toLocaleDateString("en-GB",{weekday:"short"}),d:r.toLocaleDateString("en-GB",{day:"numeric",month:"short"})}),r.setDate(r.getDate()+1),a+=1;return i.length?i:[{key:"",lbl:"Day",d:"The trip"}]}_member(e){return(this.members??[]).find(t=>t.uid===e)??null}async _add(){const e=this._title.trim();if(!(!e||this._busy)){this._busy=!0;try{await y.addPlanItem(this.trip.id,{title:e,type:this._type,day:this._dayKey??"",time:this._time||""}),this._title=""}catch(t){console.error("addPlanItem failed:",t),w((t==null?void 0:t.code)==="permission-denied"?"Couldn't add — the planner rule may need publishing.":`Couldn't add: ${(t==null?void 0:t.message)??"try again"}`,{duration:5e3})}finally{this._busy=!1}}}async _remove(e){try{await y.deletePlanItem(this.trip.id,e.id)}catch(t){w(`Couldn't remove: ${(t==null?void 0:t.code)??(t==null?void 0:t.message)}`,{duration:4e3})}}render(){var l;if(!this.open||!this.trip)return s``;const e=this._days(),t=this._dayKey??((l=e[0])==null?void 0:l.key)??"",i=(this._items||[]).filter(d=>String(d.day??"")===String(t));let r=8,a=20;for(const d of i){const g=We(d.time);if(g==null)continue;const h=Math.max(.5,(Number(d.durationMins)||60)/60);r=Math.min(r,Math.floor(g)),a=Math.max(a,Math.ceil(g+h))}r=Math.max(0,Math.min(r,8)),a=Math.min(24,Math.max(a,20));const o=[];for(let d=r;d<a;d++)o.push(s`<div class="sched-row">
        <div class="hr">${String(d).padStart(2,"0")}:00</div>
        <div></div>
      </div>`);const n=i.map(d=>{const g=We(d.time);if(g==null)return null;const h=Math.max(.5,(Number(d.durationMins)||60)/60),p=(g-r)*oe+3,u=h*oe-8,b=this._member(d.addedBy),f=Ve.some(m=>m.key===d.type)?d.type:"note";return s`<div
          class="evt ${f}"
          style="top:${p}px;height:${Math.max(34,u)}px;"
        >
          <div class="et">
            <b>${d.title}</b>
            <span>${Ke(g)}${h?`–${Ke(g+h)}`:""}</span>
          </div>
          <div class="by">
            <member-chip
      ...
      <section>
        <div class="glass">
          ...
          >
            ...
            >
              ${Ve.map(d=>s`<option value=${d.key}>${d.label}</option>`)}
            </select>
    ...
    `}}x(Ee,"properties",{open:{type:Boolean,reflect:!0},trip:{type:Object},members:{type:Array},currentUid:{type:String},_items:{state:!0},_dayKey:{state:!0},_title:{state:!0},_time:{state:!0},_type:{state:!0},_busy:{state:!0}}),x(Ee,"styles",S`
    *, *::before, *::after { box-sizing: border-box; }
    :host { display: block; }
  ...
  `);customElements.define("trip-planner",Ee);const Xt={uid:"preview-user",displayName:"Thomas Paris",email:"thomas@example.com",photoURL:null},qe=[{uid:"thomas",displayName:"Thomas",circles:["immediate"],hue:198},{uid:"partner",displayName:"Élise",circles:["immediate"],hue:8},{uid:"kid1",displayName:"Oscar",circles:["immediate"],hue:142},{uid:"kid2",displayName:"Mila",circles:["immediate"],hue:44},{uid:"mum",displayName:"Mum",circles:["extended"],hue:320},{uid:"dad",displayName:"Dad",circles:["extended"],hue:28},{uid:"sister",displayName:"Camille",circles:["extended"],hue:280},{uid:"bro-in-law",displayName:"Sam",circles:["extended"],hue:175},{uid:"niece",displayName:"Léa",circles:["extended"],hue:100}],Wt=[{id:"t1",title:"Côte d’Azur, summer",location:"Antibes, France",start:"2026-07-12",end:"2026-07-21",coverGradient:"linear-gradient(135deg, #6b9ac4 0%, #c98a8a 60%, #d4a843 100%)",lodgingHost:"Airbnb",lodgingTitle:"Villa near Cap d’Antibes",attendees:["thomas","partner","kid1","kid2","mum","dad"],notes:"Mum + Dad arrive day 2. Dinner reservations at La Guérite booked.",visibility:"extended"},{id:"t2",title:"Half-term in the Alps",location:"Chamonix, France",start:"2026-10-24",end:"2026-10-31",coverGradient:"linear-gradient(135deg, #7a9e7e 0%, #4a6754 70%, #2c4439 100%)",lodgingHost:"Booking.com",lodgingTitle:"Chalet Les Drus",attendees:["thomas","partner","kid1","kid2"],notes:"Need ski school for the kids — book by September.",visibility:"immediate"},{id:"t3",title:"Camille’s 40th",location:"Lisbon, Portugal",start:"2026-09-05",end:"2026-09-08",coverGradient:"linear-gradient(135deg, #c67b5c 0%, #d4a843 50%, #c98a8a 100%)",lodgingHost:"Airbnb",lodgingTitle:"Alfama rooftop apartment",attendees:["thomas","partner","sister","bro-in-law"],notes:"Surprise. Don’t mention to Camille.",visibility:"family"}],Kt=[{id:"e1",type:"birthday",date:"2026-05-24",personIds:["mum"],title:"Mum’s birthday"},{id:"e2",type:"anniversary",date:"2026-05-28",personIds:["mum","dad"],title:"Mum & Dad’s anniversary",subtitle:"38 years"},{id:"e3",type:"birthday",date:"2026-06-11",personIds:["kid1"],title:"Oscar turns 7"},{id:"e4",type:"birthday",date:"2026-06-30",personIds:["niece"],title:"Léa’s birthday"}],pt={id:"preview-felix",name:"Felix",dateOfBirth:new Date("2023-11-15"),profilePhotoURL:null,pronouns:"he",themeColorHex:"#3D9B8F",developmentalFlags:["speech and language"]},qt=[pt],Zt=[{id:"m1",category:"motor",title:"Kicks a ball forward",status:"achieved",ageRangeStartMonths:18,ageRangeEndMonths:24},{id:"m2",category:"motor",title:"Walks up stairs holding on",status:"achieved",ageRangeStartMonths:18,ageRangeEndMonths:24},{id:"m3",category:"motor",title:"Jumps with both feet off the ground",status:"emerging",ageRangeStartMonths:24,ageRangeEndMonths:30},{id:"m4",category:"motor",title:"Pedals a tricycle",status:"notStarted",ageRangeStartMonths:30,ageRangeEndMonths:36},{id:"m5",category:"language",title:"Uses two-word phrases",status:"achieved",ageRangeStartMonths:18,ageRangeEndMonths:24},{id:"m6",category:"language",title:"Says first name when asked",status:"emerging",ageRangeStartMonths:24,ageRangeEndMonths:30},{id:"m7",category:"language",title:"Names six body parts",status:"notStarted",ageRangeStartMonths:24,ageRangeEndMonths:30},{id:"m8",category:"language",title:"Uses three-word sentences",status:"notStarted",ageRangeStartMonths:30,ageRangeEndMonths:36},{id:"m9",category:"socialEmotional",title:"Shows affection unprompted",status:"achieved",ageRangeStartMonths:18,ageRangeEndMonths:24},{id:"m10",category:"socialEmotional",title:"Plays alongside other children",status:"emerging",ageRangeStartMonths:24,ageRangeEndMonths:36},{id:"m11",category:"socialEmotional",title:"Takes turns in simple games",status:"notStarted",ageRangeStartMonths:30,ageRangeEndMonths:42},{id:"m12",category:"cognitive",title:"Follows a two-step instruction",status:"achieved",ageRangeStartMonths:18,ageRangeEndMonths:24},{id:"m13",category:"cognitive",title:"Sorts objects by shape or colour",status:"emerging",ageRangeStartMonths:30,ageRangeEndMonths:36},{id:"m14",category:"cognitive",title:"Completes a 4-piece puzzle",status:"notStarted",ageRangeStartMonths:30,ageRangeEndMonths:36}],Qt=[{id:"i1",type:"strength",domain:"language",title:"Language is tracking ahead",body:"Felix is combining words earlier than the typical 24–30 month window — keep the back-and-forth conversations going.",relevanceScore:.95},{id:"i2",type:"connection",domain:"cross",title:"Fine-motor + sorting → pre-literacy",body:"A strong pincer grip alongside early sorting is a classic pre-literacy signal. Picture books with pointing build on both at once.",relevanceScore:.82},{id:"i3",type:"nudge",domain:"language",title:"Narrate your daily routine",body:'"Now we are washing hands… water on… soap…" — Felix is ready for longer sentence models during everyday moments.',relevanceScore:.7}],ei={id:"2026-05-16",title:"Felix is stringing two words together",body:'You have logged "more milk" and "Daddy go" this week — early two-word speech, right on the edge of the 24–30 month window. Narrating your routine out loud is the single best way to grow sentence length from here.',topicForChat:"How can I support Felix's two-word speech?"},ti=[{id:"p1",role:"user",content:"Felix isn't saying many words yet — should I be worried at 2.5?",senderUid:"partner"},{id:"p2",role:"assistant",content:"At 2½, every child's pace differs. From your logs Felix **uses two-word phrases** and follows two-step instructions — both strong signs. A few practical things to try, and a clear marker for when to mention it at his check-up."},{id:"p3",role:"user",content:"Any toddler-friendly ideas for a rainy weekend?",senderUid:"thomas"},{id:"p4",role:"assistant",content:"Rainy days are great for the kind of close-up play that grows language fastest at this stage. A few ideas matched to where Felix is right now."}];class Pe extends M{constructor(){super(),this.user=Xt,this.pebbleUser=null,this.family=null,this.children=[],this.trips=[],this.events=[],this.ppFamily=null,this.ppIsMember=!1,this.ppChildren=[],this.selectedChildId=null,this.childMilestones=[],this.childInsights=[],this.childDailyCard=null,this.childPebbleMessages=[],this._pebblePrefill="",this._plannerOpen=!1,this._plannerTrip=null,this.preview=!1,this.circle="extended",this._activeTab="today",this._formOpen=!1,this._formTrip=null,this._formBusy=!1,this._membersOpen=!1,this._eventFormOpen=!1,this._eventFormEvent=null,this._eventFormBusy=!1,this._allTripsOpen=!1,this._editingFamilyName=!1,this._importOpen=!1,this._profileOpen=!1,this._typePickerOpen=!1,this._formMode="trip",this._pebbleOpen=!1,this._dragOverTarget=null;const e=new Date;this._displayMonth=new Date(e.getFullYear(),e.getMonth(),1)}async _saveFamilyName(e){var a,o;const i=(e.target.value??"").trim(),r=((a=this.family)==null?void 0:a.name)??"";if(i&&i!==r&&((o=this.family)!=null&&o.id))try{const{db:n,doc:l,updateDoc:d,serverTimestamp:g}=await it(async()=>{const{db:h,doc:p,updateDoc:u,serverTimestamp:b}=await Promise.resolve().then(()=>At);return{db:h,doc:p,updateDoc:u,serverTimestamp:b}},void 0);await d(l(n,"families",this.family.id),{name:i,updatedAt:g()}),w("Family name updated.")}catch(n){console.error("Update family name failed:",n),w(`Couldn't save: ${n.code??n.message}`,{duration:5e3})}this._editingFamilyName=!1}_liveImmediate(){var e;return this.preview||!((e=this.user)!=null&&e.uid)?qe.filter(t=>t.circles.includes("immediate")):Ft(this.user.uid,this.user,this.pebbleUser,this.family,this.children)}_liveExtended(){var e;return this.preview?qe.filter(t=>t.circles.includes("extended")):Pt((e=this.user)==null?void 0:e.uid,this.family)}_liveTrips(){return this.preview?Wt:this.trips??[]}_liveEvents(){if(this.preview)return Kt;const e=r=>{const{date:a,yearsElapsed:o}=Nt(r);return{...r,date:a?Bt(a):r.date,_yearsElapsed:o,_originalDate:r.date}},t=Tt(this.children).map(e),i=(this.events??[]).map(e);return[...t,...i].sort((r,a)=>String(r.date).localeCompare(String(a.date)))}_filteredMembers(){const e=this._liveImmediate(),t=this._liveExtended();return this.circle==="personal"?e.filter(i=>{var r;return i.uid===((r=this.user)==null?void 0:r.uid)}):this.circle==="family"?e:[...e,...t]}_circleTrips(){var o;const e=this._liveTrips(),t=((o=this.user)==null?void 0:o.uid)??"thomas";let i;this.circle==="personal"?i=e.filter(n=>{var l;return(l=n.attendees)==null?void 0:l.includes(t)}):this.circle==="family"?i=e.filter(n=>n.visibility!=="extended"&&this._userCanSeeTrip(n)):i=e.filter(n=>this._userCanSeeTrip(n));const r=new Set,a=[];for(const n of i){const l=n.id??`${n.title}|${n.start}|${n.end}`;r.has(l)||(r.add(l),a.push(n))}return a}_filteredTrips(){const e=new Date;return e.setHours(0,0,0,0),this._circleTrips().filter(t=>t.end?$(t.end)>=e:!0)}_userCanSeeTrip(e){var l,d,g,h,p,u;const t=(l=this.user)==null?void 0:l.uid;if(!t)return!1;if((d=e.attendees)!=null&&d.includes(t)||(g=e.viewers)!=null&&g.includes(t))return!0;const i=((h=this.family)==null?void 0:h.memberIds)??[],r=((p=this.family)==null?void 0:p.cairnMemberIds)??i,a=i.includes(t),o=r.includes(t);if(a)return!0;if(!o)return!1;const n=e.visibility||"family";if(n==="personal")return!1;if(n==="family")return!0;if(n==="extended"){const b=e.targetSubGroups??[];if(b.length===0)return!0;const f=Object.entries(((u=this.family)==null?void 0:u.subGroups)??{}).filter(([,m])=>(m.memberIds??[]).includes(t)).map(([m])=>m);return b.some(m=>f.includes(m))}return!1}_filteredEvents(){const e=new Set(this._filteredMembers().map(t=>t.uid));return this._liveEvents().filter(t=>t.personIds.some(i=>e.has(i)))}_smartCallout(){var n,l;const e=new Date,t=new Date(e.getFullYear(),e.getMonth(),e.getDate()),i=1440*60*1e3,r=d=>Math.round((d-t)/i);for(const d of this._circleTrips()){if(!d.start||!d.end)continue;const g=$(d.start),h=$(d.end);if(g.setHours(0,0,0,0),h.setHours(0,0,0,0),g<=t&&t<=h){const p=r(g)+1,u=r(h)-r(g)+1,b=((n=d.location)==null?void 0:n.trim())||d.title;return`Day ${p} of ${u} in ${b}.`}}let a=null,o=1/0;for(const d of this._circleTrips()){if(!d.start)continue;const g=$(d.start);if(!g)continue;const h=r(g);h>0&&h<o&&(a={kind:"trip",item:d},o=h)}for(const d of this._filteredEvents()){if(!d.date)continue;const g=$(d.date);if(!g)continue;const h=r(g);h>=0&&h<o&&(a={kind:"event",item:d},o=h)}if(!a)return null;if(a.kind==="trip"){const d=((l=a.item.location)==null?void 0:l.trim())||a.item.title;return o===1?`${d} starts tomorrow.`:o<=14?`${d} in ${o} days.`:o<=60?`Next trip: ${d} in ${o} days.`:null}return o===0?`${a.item.title} — today.`:o===1?`${a.item.title} — tomorrow.`:o<=7?`${a.item.title} in ${o} days.`:null}_tripDensityByDay(e){const t=new Map;for(const i of this._filteredTrips()){if(!i.start||!i.end)continue;const r=$(i.start),a=$(i.end);if(Number.isNaN(r.getTime())||Number.isNaN(a.getTime())||r.getFullYear()>e||a.getFullYear()<e)continue;const o=new Date(Math.max(r,new Date(e,0,1))),n=new Date(Math.min(a,new Date(e,11,31)));for(;o<=n;){const l=`${String(o.getMonth()+1).padStart(2,"0")}-${String(o.getDate()).padStart(2,"0")}`;t.set(l,Math.min(1,(t.get(l)??0)+.5)),o.setDate(o.getDate()+1)}}return t}_shiftMonth(e){const t=this._displayMonth;this._displayMonth=new Date(t.getFullYear(),t.getMonth()+e,1)}_jumpToMonth(e,t){this._displayMonth=new Date(e,t,1)}_resetToToday(){const e=new Date;this._displayMonth=new Date(e.getFullYear(),e.getMonth(),1)}_renderStone({label:e,members:t,pebbleClass:i,emptyLabel:r,onClick:a,maxChips:o=6,dropTargetId:n=null,draggable:l=()=>!1}){const d=n?{dragover:b=>{var f;(f=b.dataTransfer.types)!=null&&f.includes("text/cairn-uid")&&(b.preventDefault(),this._dragOverTarget=n)},dragleave:()=>{this._dragOverTarget===n&&(this._dragOverTarget=null)},drop:async b=>{b.preventDefault(),this._dragOverTarget=null;const f=b.dataTransfer.getData("text/cairn-uid");if(!f)return;const m=n==="extended"?null:n;try{await y.setCairnMemberSubGroup(f,m),w(m?`Moved to ${e}.`:"Moved to extended.")}catch(_){console.error("Move failed:",_),w(`Couldn't move: ${_.code??_.message}`,{duration:4e3})}}}:{},g=n&&this._dragOverTarget===n,h=`pebble ${i}${g?" pebble-drop":""}`;if(!t||t.length===0)return s`
      ...
      >
        <span class="${h}">
          <span class="stone-chips">
            ${p.map(b=>{const f=l(b);return s`
                <member-chip
                  draggable=${f?"true":"false"}
                  class=${f?"is-draggable":""}
                  @dragstart=${m=>{if(!f){m.preventDefault();return}m.stopPropagation(),m.dataTransfer.setData("text/cairn-uid",b.uid),m.dataTransfer.effectAllowed="move"}}
                  .name=${b.displayName}
                  .photo=${b.photoURL??""}
                  .hue=${b.hue}
                  size="26"
    ...
    `}_renderMonthly(){const e=new Date,t=this._displayMonth??e,i=t.getFullYear(),r=t.getMonth(),o=(new Date(i,r,1).getDay()+6)%7,n=new Date(i,r+1,0).getDate(),l=new Map,d=(m,_)=>{l.has(m)||l.set(m,_)},g=[];for(const m of this._filteredEvents()){const _=$(m.date);_&&_.getFullYear()===i&&_.getMonth()===r&&(g.push(_.getDate()),d(_.getDate(),m.title??""))}const h=new Set;for(const m of this._filteredTrips()){if(!m.start||!m.end)continue;const _=$(m.start),A=$(m.end);if(Number.isNaN(_.getTime())||Number.isNaN(A.getTime())||_.getFullYear()>i||A.getFullYear()<i||_.getMonth()>r&&A.getMonth()>r||_.getMonth()<r&&A.getMonth()<r)continue;const z=_.getMonth()===r?_.getDate():1,I=A.getMonth()===r?A.getDate():n;for(let N=z;N<=I;N++)h.add(N),d(N,m.title??"")}const p=[];for(let m=0;m<o;m++)p.push(s`<div class="cal-cell empty"></div>`);const u=e.getFullYear()===i&&e.getMonth()===r;for(let m=1;m<=n;m++){const _=u&&m===e.getDate(),A=g.includes(m),z=h.has(m),I=_?l.get(m)??"Today":l.get(m),N=["cal-cell",_?"today":"",A?"has-event":"",z?"has-trip":""].filter(Boolean).join(" ");p.push(s`<div class=${N} title=${I?`${m} — ${I}`:""}>
    ...
    `;return s`
      <nav class="tabs" role="tablist" aria-label="Sections">
        ${e("today","Today",s`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12l9-9 9 9" /><path d="M5 10v10h14V10" /></svg>`)}
        ${e("children","Children",s`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="4" /><path d="M5 21c0-4 3-6 7-6s7 2 7 6" /></svg>`)}
        ${e("activities","Activities",s`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="17" rx="2" /><path d="M3 9h18M8 2v4M16 2v4" /></svg>`)}
        ${e("pebble","Pebble",s`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9" /><circle cx="12" cy="12" r="4.5" fill="currentColor" stroke="none" /></svg>`)}
        ${e("cairn","My Cairn",s`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><ellipse cx="12" cy="6.5" rx="3.5" ry="1.5" /><ellipse cx="12" cy="12" rx="6" ry="2.4" /><ellipse cx="12" cy="18" rx="8" ry="3" /></svg>`)}
      </nav>
    `}_renderActiveTab(){switch(this._activeTab){case"children":return this._renderChildrenTab();case"activities":return this._renderActivitiesTab();case"pebble":return this._renderPebbleTab();case"cairn":return this._renderCairnTab();default:return this._renderTodayTab()}}_renderTodayHeader(e=""){var g;const t=(((g=this.user)==null?void 0:g.displayName)??"there").split(" ")[0],i=this._filteredEvents(),r=new Date,a=new Date(r.getFullYear(),r.getMonth(),1),o=new Date(r.getFullYear(),r.getMonth()+1,0),n=i.filter(h=>{const p=$(h.date);return p&&p.getFullYear()===r.getFullYear()&&p.getMonth()===r.getMonth()}),d=this._circleTrips().filter(h=>{if(!h.start||!h.end)return!1;const p=$(h.start),u=$(h.end);return Number.isNaN(p.getTime())||Number.isNaN(u.getTime())?!1:p<=o&&u>=a}).length+n.length;return s`
        <div class="hello">
          <div>
            <h1>Hi ${t}.</h1>
    ...
    `}_renderCairnStackPanel(){const e=this._liveImmediate(),t=this._liveExtended(),i=e.concat(t);return s`
          <glass-panel padding="md" variant="strong">
            ${(()=>{var h,p,u,b,f;const r=e.find(m=>{var _;return m.uid===((_=this.user)==null?void 0:_.uid)}),o=new Set(((h=this.family)==null?void 0:h.memberIds)??[]).has((p=this.user)==null?void 0:p.uid),n=e.filter(m=>{var _;return m.uid!==((_=this.user)==null?void 0:_.uid)}),l=!o&&r?[{...r,role:"extended"},...t]:t,d=Object.entries(((u=this.family)==null?void 0:u.subGroups)??{}),g=new Map(i.map(m=>[m.uid,m]));return s`
                <div class="cairn-stack">
                  ...
                  ${this._renderStone({label:"Extended",members:l,pebbleClass:"pebble-extended",emptyLabel:"+ Invite extended family",onClick:()=>this._membersOpen=!0,dropTargetId:"extended",draggable:m=>m.role==="extended"})}

                  <!-- Sub-group base row — each stone is a drop target. -->
                  ${d.length>0?s`
                        <div class="subgroup-row">
                          ${d.map(([m,_])=>{const A=(_.memberIds??[]).map(z=>g.get(z)).filter(Boolean);return this._renderStone({label:_.name??"Group",members:A,pebbleClass:"pebble-subgroup",emptyLabel:`${_.name??"Group"} (empty)`,onClick:()=>this._membersOpen=!0,maxChips:4,dropTargetId:m,draggable:z=>z.role==="extended"})})}
                        </div>
                      `:""}
                </div>
    ...
    `}_renderPebbleTab(){const e=this._childData();if(e.hasPP&&e.child){const r=s`<span class="scope-chip">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="5" y="11" width="14" height="9" rx="2" /><path d="M8 11V8a4 4 0 018 0v3" stroke-linecap="round" /></svg>
        Private to parents
      </span>`;return s`
        ...
        ></child-pebble>
      `}const t=(this._circleTrips()??[]).filter(r=>r.start&&$(r.start)>=new Date).sort((r,a)=>String(r.start).localeCompare(String(a.start)))[0],i=s`<span class="scope-chip">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="5" y="11" width="14" height="9" rx="2" /><path d="M8 11V8a4 4 0 018 0v3" stroke-linecap="round" /></svg>
    ...
    `}render(){var r,a,o,n,l,d,g;const e=this._liveImmediate(),t=this._liveExtended(),i=e.concat(t);return s`
      ...
      ></pebble-chat>
    `}}x(Pe,"properties",{user:{type:Object},pebbleUser:{type:Object},family:{type:Object},children:{type:Array},trips:{type:Array},events:{type:Array},preview:{type:Boolean},ppFamily:{type:Object},ppIsMember:{type:Boolean},ppChildren:{type:Array},selectedChildId:{type:String},childMilestones:{type:Array},childInsights:{type:Array},childDailyCard:{type:Object},childPebbleMessages:{type:Array},_pebblePrefill:{state:!0},_plannerOpen:{state:!0},_plannerTrip:{state:!0},circle:{state:!0},_activeTab:{state:!0},_formOpen:{state:!0},_formTrip:{state:!0},_formBusy:{state:!0},_membersOpen:{state:!0},_eventFormOpen:{state:!0},_eventFormEvent:{state:!0},_eventFormBusy:{state:!0},_displayMonth:{state:!0},_allTripsOpen:{state:!0},_editingFamilyName:{state:!0},_importOpen:{state:!0},_profileOpen:{state:!0},_typePickerOpen:{state:!0},_formMode:{state:!0},_pebbleOpen:{state:!0},_dragOverTarget:{state:!0}}),x(Pe,"styles",S`
  ...
  `);customElements.define("home-screen",Pe);const Ze="cairn:pendingLoginIntent";class Fe extends M{constructor(){super(),this.user=null,this._mode="choose",this._code="",this._familyName="",this._busy=!1,this._error="",this._flavor="welcome";try{localStorage.getItem(Ze)==="1"&&(this._flavor="recovery",localStorage.removeItem(Ze))}catch{}}willUpdate(e){if(e.has("user")&&this.user&&!this._familyName){const t=(this.user.displayName??"").trim().split(/\s+/).slice(-1)[0];t&&t.length>1&&(this._familyName=`${t} Family`)}}_go(e){this._mode=e,this._error=""}_submitJoin(){const e=(this._code??"").trim().toUpperCase();if(!e){this._error="Paste the family code you were sent.";return}const t=e.startsWith("CAIRN-")?e:`CAIRN-${e.replace(/^CAIRN-?/i,"")}`;if(!/^CAIRN-[A-Z0-9]{3,6}$/.test(t)){this._error="Codes look like CAIRN-XXXX.";return}this._error="",this.dispatchEvent(new CustomEvent("join-code",{detail:{code:t},bubbles:!0,composed:!0}))}async _submitCreate(){const e=(this._familyName??"").trim();if(!e){this._error="Give your family a name.";return}this._busy=!0,this._error="";try{await y.createCairnOnlyFamily(e),w(`Welcome to ${e}.`)}catch(t){console.error("Create family failed:",t),this._error=(t==null?void 0:t.code)==="permission-denied"?"Couldn't create the family — Firestore rules may not be deployed yet.":`Couldn't create the family: ${(t==null?void 0:t.message)??"try again"}`}finally{this._busy=!1}}_iconJoin(){return s`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    `}}x(Fe,"properties",{user:{type:Object},_mode:{state:!0},_code:{state:!0},_familyName:{state:!0},_busy:{state:!0},_error:{state:!0},_flavor:{state:!0}}),x(Fe,"styles",S`
    * { box-sizing: border-box; }
    :host {
      display: flex;
      align-items: center;
  ...
  `);customElements.define("onboarding-wizard",Fe);const j="cairn:pendingJoinCode",Qe="cairn:pendingCreateFamily";class ht extends M{constructor(){super(),this.authUser=null,this.loading=!0;const e=new URLSearchParams(window.location.search);if(this.preview=e.has("preview"),this._resetMode=e.has("reset"),this._resetMode)try{localStorage.removeItem(j)}catch{}const t=e.get("join");if(t&&!this._resetMode)try{localStorage.setItem(j,t)}catch{}let i=null;if(!this._resetMode)try{i=localStorage.getItem(j)}catch{}this.joinCode=this._resetMode?null:t??i??null,this.pebbleUser=null,this.family=null,this.children=[],this.trips=[],this.events=[],this.ppFamily=null,this.ppIsMember=!1,this.ppChildren=[],this.selectedChildId=null,this.childMilestones=[],this.childInsights=[],this.childDailyCard=null,this.childPebbleMessages=[],this._unsubAuth=null,this._onDataChange=()=>{this.pebbleUser=y.state.user,this.family=y.state.family,this.children=y.state.children,this.trips=y.state.trips,this.events=y.state.events,this.ppFamily=y.state.ppFamily,this.ppIsMember=y.state.ppIsMember,this.ppChildren=y.state.ppChildren,this.selectedChildId=y.state.selectedChildId,this.childMilestones=y.state.childMilestones,this.childInsights=y.state.childInsights,this.childDailyCard=y.state.childDailyCard,this.childPebbleMessages=y.state.childPebbleMessages,this.userDocResolved=y.userDocResolved},this.userDocResolved=!1}_clearJoinState(){this.joinCode=null;try{localStorage.removeItem(j)}catch{}const e=new URL(window.location.href);e.searchParams.delete("join"),window.history.replaceState({},"",e.toString())}connectedCallback(){if(super.connectedCallback(),typeof document<"u"&&document.documentElement.style.setProperty("--pre-login-bg","url('/portal/assets/pebblepath-daybreak-empty.png')"),this.preview){this.loading=!1;return}y.addEventListener("change",this._onDataChange),this._unsubAuth=lt(e=>{if(this.authUser=e,this.loading=!1,e){if(!this._resetMode)try{const t=localStorage.getItem(j);t&&!this.joinCode&&(this.joinCode=t)}catch{}y.start(e.uid),this._consumePendingCreate()}else y.stop(),this.userDocResolved=!1})}async _consumePendingCreate(){let e=null;try{e=localStorage.getItem(Qe)}catch{}if(e){try{localStorage.removeItem(Qe)}catch{}try{await y.createCairnOnlyFamily(e),w(`Welcome to ${e}.`)}catch(t){console.error("Pending family create failed:",t),w((t==null?void 0:t.code)==="permission-denied"?"Couldn't create the family — Firestore rules may need a redeploy.":`Couldn't create the family: ${(t==null?void 0:t.message)??"try again"}`,{duration:5e3})}}}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._unsubAuth)==null||e.call(this),y.removeEventListener("change",this._onDataChange)}_composeViewer(){var i,r;const e=this.authUser,t=(i=this.pebbleUser)==null?void 0:i.displayName;return{uid:e.uid,displayName:t&&t.trim()||e.displayName||"You",email:e.email??((r=this.pebbleUser)==null?void 0:r.email)??"",photoURL:dt(e,this.pebbleUser)}}_needsOnboarding(){var t,i;return!this.authUser||this.joinCode?!1:this._resetMode?!0:this.userDocResolved?!(((t=this.pebbleUser)==null?void 0:t.familyId)??((i=this.pebbleUser)==null?void 0:i.cairnFamilyId)??null):!1}updated(){this.setAttribute("data-route",this._currentRoute())}_currentRoute(){return this.loading?"loading":this.preview?"home":this.authUser?this.joinCode?"join":this._needsOnboarding()?"wizard":"home":"register"}render(){return this.loading?s``:this.preview?s`<home-screen preview></home-screen>`:this.authUser?this.joinCode?s`
        <join-family-screen
          .code=${this.joinCode}
