...
`).trim()||"This is a family-planning conversation. Help with activities, plans, and logistics. No child information is available."}async askPebblePlanning(e,t=[]){if(!R)throw new Error("Firebase functions not configured.");if(!this._currentFamilyId)throw new Error("No family.");return(await H(R,"askPebblePlanning")({familyId:this._currentFamilyId,question:e,history:t,clientContext:this.buildPlanningContext()})).data}async streamPebblePlanning(e,t=[],{onStatus:i,onDelta:a}={}){if(!R)throw new Error("Firebase functions not configured.");if(!this._currentFamilyId)throw new Error("No family.");const r=H(R,"streamPebblePlanning"),{stream:s,data:o}=await r.stream({familyId:this._currentFamilyId,question:e,history:t,clientContext:this.buildPlanningContext()});for await(const d of s)d&&(d.kind==="status"&&typeof i=="function"?i(d.status):d.kind==="delta"&&typeof d.text=="string"&&typeof a=="function"&&a(d.text));return await o}async appendPlanningMessage(e){if(!this._currentFamilyId)throw new Error("No family.");if(!this._uid)throw new Error("Not signed in.");const t={role:e.role,content:e.content,timestamp:Se.now()};e.role==="user"&&(t.senderUid=this._uid),await j(I(b,"families",this._currentFamilyId,"pebblePlanningMessages"),t)}async deleteAllPlanningMessages(){if(!this._currentFamilyId)return;const e=await ae(I(b,"families",this._currentFamilyId,"pebblePlanningMessages"));await Promise.all(e.docs.map(t=>W(t.ref)))}_toMillis(e){var t,i,a;return((a=(i=(t=e==null?void 0:e.toDate)==null?void 0:t.call(e))==null?void 0:i.getTime)==null?void 0:a.call(i))??(e?new Date(e).getTime():null)}get _pebbleUnlimited(){const e=this.state.user;return!!(e&&(e.isPremium===!0||e.bypassPebbleQuota===!0))}_pebbleQuotaShouldReset(e=new Date){var i;const t=this._toMillis((i=this.state.family)==null?void 0:i.pebbleWeekStartedAt);return t==null?!0:e.getTime()-t>=10080*60*1e3}pebbleQuestionsRemaining(e=new Date){const t=this.state.family,i=typeof(t==null?void 0:t.pebbleQuestionsLimit)=="number"?t.pebbleQuestionsLimit:5;if(this._pebbleQuotaShouldReset(e))return i;const a=typeof(t==null?void 0:t.pebbleQuestionsUsed)=="number"?t.pebbleQuestionsUsed:0;return Math.max(0,i-a)}pebbleWeekRollover(e=new Date){var i;const t=this._toMillis((i=this.state.family)==null?void 0:i.pebbleWeekStartedAt);return t==null||this._pebbleQuotaShouldReset(e)?null:new Date(t+10080*60*1e3)}pebbleQuota(){var a;const e=this.state.user,t=this._pebbleUnlimited,i=this.pebbleQuestionsRemaining();return{unlimited:t,bypassed:(e==null?void 0:e.bypassPebbleQuota)===!0,premium:(e==null?void 0:e.isPremium)===!0,limit:((a=this.state.family)==null?void 0:a.pebbleQuestionsLimit)??5,remaining:i,atLimit:!t&&i<=0,rollover:this.pebbleWeekRollover()}}async incrementPebbleQuota(){if(this._pebbleUnlimited||!this._currentFamilyId)return;const e=$(b,"families",this._currentFamilyId);try{this._pebbleQuotaShouldReset()?await M(e,{pebbleQuestionsUsed:1,pebbleWeekStartedAt:Se.now()}):await M(e,{pebbleQuestionsUsed:Pt(1)})}catch(t){console.warn("[Cairn] pebble quota increment failed:",t==null?void 0:t.code,t==null?void 0:t.message)}}async refreshFamilyBrief(){if(!R)throw new Error("Firebase functions not configured.");if(!this._ppFamilyId)throw new Error("No PebblePath family.");return(await H(R,"refreshFamilyBrief")({familyId:this._ppFamilyId})).data}_childPebbleBase(e){return["families",this._ppFamilyId,"children",e,"pebbleSessions"]}async createPebbleSession(e,{title:t,isPrivate:i}={}){if(!b||!this._ppFamilyId||!e)throw new Error("No child selected.");return(await j(I(b,...this._childPebbleBase(e)),{title:(t||"New chat").trim()||"New chat",isPrivate:i===!0,archived:!1,createdBy:this._uid??"",createdAt:C(),lastMessageAt:C()})).id}async renamePebbleSession(e,t,i){!b||!this._ppFamilyId||!e||!t||await M($(b,...this._childPebbleBase(e),t),{title:(i||"").trim()||"Untitled chat"})}async setPebbleSessionPrivacy(e,t,i){!b||!this._ppFamilyId||!e||!t||await M($(b,...this._childPebbleBase(e),t),{isPrivate:i===!0})}async archivePebbleSession(e,t){!b||!this._ppFamilyId||!e||!t||await M($(b,...this._childPebbleBase(e),t),{archived:!0})}async touchPebbleSession(e,t){if(!(!b||!this._ppFamilyId||!e||!t))try{await M($(b,...this._childPebbleBase(e),t),{lastMessageAt:C()})}catch{}}_teardownChild(){var e,t,i,a,r;(e=this._unsubChildMs)==null||e.call(this),(t=this._unsubChildIns)==null||t.call(this),(i=this._unsubChildDaily)==null||i.call(this),(a=this._unsubChildPebble)==null||a.call(this),(r=this._unsubChildSessions)==null||r.call(this),this._unsubChildMs=this._unsubChildIns=this._unsubChildDaily=this._unsubChildPebble=this._unsubChildSessions=null}_teardownPpFamily(){var e,t,i,a,r,s,o,d;this._teardownChild(),(e=this._unsubPpFamily)==null||e.call(this),(t=this._unsubPpChildren)==null||t.call(this),(i=this._unsubFamilyDaily)==null||i.call(this),(a=this._unsubAnchors)==null||a.call(this),(r=this._unsubRhythms)==null||r.call(this),(s=this._unsubPatterns)==null||s.call(this),(o=this._unsubLiveContext)==null||o.call(this),(d=this._unsubIncomingReq)==null||d.call(this),this._unsubPpFamily=null,this._unsubPpChildren=null,this._unsubFamilyDaily=null,this._unsubAnchors=null,this._unsubRhythms=null,this._unsubPatterns=null,this._unsubLiveContext=null,this._unsubIncomingReq=null,this._selectedChildId=null,this.state.ppFamily=null,this.state.ppIsMember=!1,this.state.ppIsChildViewer=!1,this.state.incomingChildRequests=[],this.state.ppChildren=[],this.state.selectedChildId=null,this.state.childMilestones=[],this.state.childInsights=[],this.state.childDailyCard=null,this.state.familyDailyCard=null,this.state.pebbleAnchors=[],this.state.pebbleRhythms=[],this.state.pebblePatterns=[],this.state.pebbleLiveContext=[],this.state.childPebbleMessages=[],this.state.childPebbleSessions=[]}async requestChildAccess(){var t;const e=this._currentFamilyId;if(!e)throw new Error("No family to request access from.");await Y($(b,"families",e,"childAccessRequests",this._uid),{uid:this._uid,displayName:((t=this.state.user)==null?void 0:t.displayName)??"Family member",requestedAt:C(),status:"pending"})}async withdrawChildAccessRequest(){const e=this._currentFamilyId;e&&await W($(b,"families",e,"childAccessRequests",this._uid))}async setMemberLabel(e,t){!this._uid||!e||await M($(b,"users",this._uid),{[`memberLabels.${e}`]:(t??"").trim()})}async approveChildAccess(e){var a;const t=this._ppFamilyId;if(!t||!this.state.ppIsMember)throw new Error("Only a parent can approve access.");const i=Array.isArray((a=this.state.ppFamily)==null?void 0:a.childViewers)?this.state.ppFamily.childViewers:[];i.includes(e)||await M($(b,"families",t),{childViewers:[...i,e],updatedAt:C()}),await M($(b,"families",t,"childAccessRequests",e),{status:"approved",actionedBy:this._uid,actionedAt:C()})}async declineChildAccess(e){const t=this._ppFamilyId;if(!t||!this.state.ppIsMember)throw new Error("Only a parent can decline access.");await M($(b,"families",t,"childAccessRequests",e),{status:"declined",actionedBy:this._uid,actionedAt:C()})}async grantChildViewerDirectly(e){var a;const t=this._ppFamilyId;if(!t||!this.state.ppIsMember)throw new Error("Only a parent can grant access.");const i=Array.isArray((a=this.state.ppFamily)==null?void 0:a.childViewers)?this.state.ppFamily.childViewers:[];i.includes(e)||await M($(b,"families",t),{childViewers:[...i,e],updatedAt:C()})}async grantParentAccessForOwnChildren(e){const t=this._ppFamilyId;if(!t||!this.state.ppIsMember)throw new Error("Only a parent can grant access.");const i=this._uid;if(!i)throw new Error("Not signed in.");const r=(Array.isArray(this.state.ppChildren)?this.state.ppChildren:[]).filter(o=>(o==null?void 0:o.id)&&Array.isArray(o.parentIds)&&o.parentIds.includes(i));if(r.length===0)return[];const s=[];for(const o of r){const d=Array.isArray(o.parentIds)?o.parentIds:[];if(d.includes(e)){s.push(o.name??"your child");continue}await M($(b,"families",t,"children",o.id),{parentIds:[...d,e],updatedAt:C()}),s.push(o.name??"your child")}return s}async revokeChildViewer(e){var r;const t=this._ppFamilyId;if(!t||!this.state.ppIsMember)throw new Error("Only a parent can revoke access.");const i=Array.isArray((r=this.state.ppFamily)==null?void 0:r.childViewers)?this.state.ppFamily.childViewers:[],a=i.filter(s=>s!==e);a.length!==i.length&&await M($(b,"families",t),{childViewers:a,updatedAt:C()});try{await M($(b,"families",t,"childAccessRequests",e),{status:"declined",actionedBy:this._uid,actionedAt:C()})}catch{}}_backfillVisibleTo(e,t){if(!b||!this._currentFamilyId)return;const i=this.state.family;if(i){this._vtBackfilled||(this._vtBackfilled=new Set);for(const a of t){const r=a.data();if(Array.isArray(r.visibleTo))continue;const s=`${e}/${a.id}`;this._vtBackfilled.has(s)||(this._vtBackfilled.add(s),M($(b,"families",this._currentFamilyId,e,a.id),{visibleTo:xe(r.visibility??"family",i,r.createdBy,Array.isArray(r.attendees)?r.attendees:[])}).catch(o=>{this._vtBackfilled.delete(s),console.warn(`[Cairn] visibleTo backfill failed (${s}):`,o==null?void 0:o.code,o==null?void 0:o.message)}))}}}async _visibleToFor(e,t,i){const a=(e==null?void 0:e.visibility)??"family",r=Array.isArray(e==null?void 0:e.attendees)?e.attendees:[],s=a==="extended"?await bi(t):[];return xe(a,t,i,r,s)}async saveTrip(e){var l;if(!b||!this._currentFamilyId)throw new Error("No family yet.");const t=(l=_==null?void 0:_.currentUser)==null?void 0:l.uid;if(!t)throw new Error("Not signed in.");const{id:i,createdAt:a,updatedAt:r,...s}=e,o={...s,updatedAt:C()};return o.visibleTo=await this._visibleToFor(s,this.state.family,s.createdBy??t),i?(await M($(b,"families",this._currentFamilyId,"trips",i),o),i):(o.createdBy=t,o.createdAt=C(),(await j(I(b,"families",this._currentFamilyId,"trips"),o)).id)}async deleteTrip(e){if(!b||!this._currentFamilyId)throw new Error("No family yet.");await W($(b,"families",this._currentFamilyId,"trips",e))}packingTemplatesListener(e){return!b||!this._currentFamilyId?()=>{}:F(I(b,"families",this._currentFamilyId,"packingTemplates"),t=>{const i=t.docs.map(a=>({id:a.id,...a.data()})).sort((a,r)=>{var s,o,d,l;return(((o=(s=r.updatedAt)==null?void 0:s.toMillis)==null?void 0:o.call(s))??0)-(((l=(d=a.updatedAt)==null?void 0:d.toMillis)==null?void 0:l.call(d))??0)});e(i)},t=>{console.warn("[Portal] packingTemplates error:",t.code,t.message),e([])})}packingListListener(e,t){return!b||!this._currentFamilyId||!e?()=>{}:F(I(b,"families",this._currentFamilyId,"trips",e,"packingList"),i=>{const a=i.docs.map(r=>({id:r.id,...r.data()})).sort((r,s)=>{const o=String(r.groupName??"").localeCompare(String(s.groupName??""));return o!==0?o:(r.order??0)-(s.order??0)});t(a)},i=>{console.warn("[Portal] packingList error:",i.code,i.message),t([])})}_packingListCol(e){return I(b,"families",this._currentFamilyId,"trips",e,"packingList")}async addPackingItem(e,{groupName:t,text:i,order:a=0,addedByPebble:r=!1}){var l;if(!b||!this._currentFamilyId)throw new Error("No family yet.");const s=(l=_==null?void 0:_.currentUser)==null?void 0:l.uid;if(!s)throw new Error("Not signed in.");const o=String(i??"").trim();if(!o)throw new Error("Add an item.");return(await j(this._packingListCol(e),{groupName:t,text:o,checked:!1,order:a,addedBy:s,addedByPebble:r===!0,addedAt:C()})).id}async togglePackingItem(e,t){!b||!this._currentFamilyId||!(t!=null&&t.id)||await M($(this._packingListCol(e),t.id),{checked:t.checked!==!0})}async updatePackingItemText(e,t,i){if(!b||!this._currentFamilyId||!t)return;const a=String(i??"").trim();a&&await M($(this._packingListCol(e),t),{text:a})}async deletePackingItem(e,t){!b||!this._currentFamilyId||!t||await W($(this._packingListCol(e),t))}async applyPackingTemplate(e,t){var r;if(!b||!this._currentFamilyId||!(t!=null&&t.id))return;const i=(r=_==null?void 0:_.currentUser)==null?void 0:r.uid;if(!i)throw new Error("Not signed in.");const a=[];for(const s of Array.isArray(t.groups)?t.groups:[]){const o=Array.isArray(s.items)?s.items:[];for(const d of o.slice().sort((l,c)=>(l.order??0)-(c.order??0)))a.push(j(this._packingListCol(e),{templateId:t.id,groupName:s.name,text:String(d.text??"").trim(),checked:!1,order:d.order??0,addedBy:i,addedByPebble:d.addedByPebble===!0,addedAt:C()}))}a.length!==0&&(await Promise.all(a),await M($(b,"families",this._currentFamilyId,"trips",e),{"packingListMeta.derivedFromTemplateId":t.id}))}async savePackingListAsTemplate(e,t,i){var l;if(!b||!this._currentFamilyId)throw new Error("No family yet.");const a=(l=_==null?void 0:_.currentUser)==null?void 0:l.uid;if(!a)throw new Error("Not signed in.");const r=new Map;for(const c of Array.isArray(i)?i:[]){const p=c.groupName??"Parents";r.has(p)||r.set(p,[]),r.get(p).push(c)}const s=[...r.entries()].map(([c,p])=>({id:crypto.randomUUID(),name:c,items:p.slice().sort((h,u)=>(h.order??0)-(u.order??0)).map((h,u)=>({id:crypto.randomUUID(),text:String(h.text??"").trim(),order:u,addedByPebble:h.addedByPebble===!0}))})),o=C();return(await j(I(b,"families",this._currentFamilyId,"packingTemplates"),{name:String(e??"My list").trim()||"My list",...t?{iconKey:t}:{},groups:s,createdBy:a,createdAt:o,updatedAt:o})).id}async deletePackingTemplate(e){!b||!this._currentFamilyId||!e||await W($(b,"families",this._currentFamilyId,"packingTemplates",e))}async markPackingReviewed(e){!b||!this._currentFamilyId||!e||await M($(b,"families",this._currentFamilyId,"trips",e),{"packingListMeta.lastReviewedAt":C()})}async generatePackingReview(e,t,i,a,r,s){if(!R)throw new Error("Firebase functions not configured.");if(!this._currentFamilyId)throw new Error("No family yet.");return(await H(R,"generatePackingReview")({familyId:this._currentFamilyId,tripId:e,trip:t,family:i,currentList:a,dismissedTexts:r,groupNames:s})).data}async generateFamilyPlan(e,t){var s;if(!R)throw new Error("Firebase functions not configured.");if(!this._currentFamilyId)throw new Error("No family yet.");const a=await H(R,"generateFamilyPlan")({familyId:this._currentFamilyId,family:e,window:t}),r=(s=a==null?void 0:a.data)==null?void 0:s.candidates;return Array.isArray(r)?r:[]}async saveEvent(e){var l;if(!b||!this._currentFamilyId)throw new Error("No family yet.");const t=(l=_==null?void 0:_.currentUser)==null?void 0:l.uid;if(!t)throw new Error("Not signed in.");const{id:i,createdAt:a,updatedAt:r,...s}=e,o={...s,updatedAt:C()};return o.visibleTo=await this._visibleToFor(s,this.state.family,s.createdBy??t),i?(await M($(b,"families",this._currentFamilyId,"familyEvents",i),o),i):(o.createdBy=t,o.createdAt=C(),(await j(I(b,"families",this._currentFamilyId,"familyEvents"),o)).id)}async deleteEvent(e){if(!b||!this._currentFamilyId)throw new Error("No family yet.");await W($(b,"families",this._currentFamilyId,"familyEvents",e))}activitiesListener(e){if(!b||!this._currentFamilyId||!this._uid)return()=>{};const t=J(I(b,"families",this._currentFamilyId,"activities"),X("visibleTo","array-contains",this._uid));return F(t,i=>{const a=i.docs.map(r=>({id:r.id,...r.data()})).sort((r,s)=>{var l,c,p,h;const o=String(r.day??"").localeCompare(String(s.day??""));if(o!==0)return o;const d=String(r.time??"").localeCompare(String(s.time??""));return d!==0?d:(((c=(l=r.createdAt)==null?void 0:l.toMillis)==null?void 0:c.call(l))??0)-(((h=(p=s.createdAt)==null?void 0:p.toMillis)==null?void 0:h.call(p))??0)});e(a)},i=>{console.warn("[Portal] activities subscription error:",i.code,i.message),e([])})}async saveActivity(e){var c;if(!b||!this._currentFamilyId)throw new Error("No family yet.");const t=(c=_==null?void 0:_.currentUser)==null?void 0:c.uid;if(!t)throw new Error("Not signed in.");const{id:i,createdAt:a,updatedAt:r,...s}=e,o={...s,updatedAt:C()},d=s.addedBy??t;if(s.tripId){const p=(this.state.trips??[]).find(h=>h.id===s.tripId);o.visibleTo=Array.isArray(p==null?void 0:p.visibleTo)&&p.visibleTo.length?p.visibleTo:await this._visibleToFor(s,this.state.family,d)}else{const p=Array.isArray(s.personIds)?s.personIds:[];o.visibleTo=await this._visibleToFor({...s,attendees:p},this.state.family,d)}return i?(await M($(b,"families",this._currentFamilyId,"activities",i),o),i):(o.addedBy=t,o.createdAt=C(),(await j(I(b,"families",this._currentFamilyId,"activities"),o)).id)}async deleteActivity(e){if(!b||!this._currentFamilyId)throw new Error("No family yet.");await W($(b,"families",this._currentFamilyId,"activities",e))}async updateActivity(e,t){if(!b||!this._currentFamilyId)throw new Error("No family yet.");await M($(b,"families",this._currentFamilyId,"activities",e),t)}async uploadActivityAttachment(e,t){if(!O||!this._currentFamilyId)throw new Error("Storage unavailable.");const i=`families/${this._currentFamilyId}/planAttachments/activity__${e}`,a=Z(O,i);return await se(a,t,{contentType:t.type||"application/octet-stream"}),re(a)}async uploadSchoolCalendar(e){if(!O||!this._currentFamilyId)throw new Error("Storage unavailable.");const t=e.type||"",i=/pdf/.test(t)?"pdf":/^image\//.test(t)?"image":/word|officedocument|msword/.test(t)?"docx":"pdf",a=`families/${this._currentFamilyId}/schoolCalendarUploads/${Date.now()}`;return await se(Z(O,a),e,{contentType:t||"application/octet-stream"}),{storagePath:a,fileType:i}}async uploadTripPreview(e){var r;if(!O||!this._currentFamilyId)throw new Error("Storage unavailable.");if(!/^image\//.test(e.type||""))throw new Error("Preview image must be an image file.");const t=((r=crypto==null?void 0:crypto.randomUUID)==null?void 0:r.call(crypto))||`${Date.now()}-${Math.random().toString(36).slice(2)}`,i=`families/${this._currentFamilyId}/trip-previews/${t}`,a=Z(O,i);return await se(a,e,{contentType:e.type}),await re(a)}async extractSchoolCalendarEvents(e,t){var s;if(!R||!this._currentFamilyId)throw new Error("No family yet.");const a=await H(R,"extractSchoolCalendar")({familyId:this._currentFamilyId,storagePath:e,fileType:t}),r=(s=a==null?void 0:a.data)==null?void 0:s.events;return Array.isArray(r)?r:[]}async importSchoolEvents(e,t={}){var x;if(!b||!this._currentFamilyId)throw new Error("No family yet.");const i=(x=_==null?void 0:_.currentUser)==null?void 0:x.uid;if(!i)throw new Error("Not signed in.");const a=this.state.family??{},r=Array.isArray(a.memberIds)?a.memberIds:[],s=Array.isArray(a.cairnMemberIds)?a.cairnMemberIds:[],o=[...new Set([...r,...s,i])],d=xe("family",a,i),l=t.category==="celebration",c=String(t.tag??"").trim().slice(0,60),p=I(b,"families",this._currentFamilyId,"familyEvents"),h=I(b,"families",this._currentFamilyId,"activities"),u=(e??[]).filter(f=>f&&/^\d{4}-\d{2}-\d{2}$/.test(String(f.date??""))&&String(f.title??"").trim()).slice(0,250);let m=0;return await Promise.all(u.map(async f=>{const w=String(f.description??"").trim().slice(0,1e3);l?await j(p,{title:String(f.title).trim().slice(0,120),date:f.date,type:"custom",recurring:!1,category:"celebration",...c?{calTag:c}:{},...w?{notes:w}:{},source:"school-import",personIds:o,visibility:"family",visibleTo:d,createdBy:i,createdAt:C(),updatedAt:C()}):await j(h,{title:String(f.title).trim().slice(0,120),type:"note",day:f.date,...w?{notes:w}:{},...c?{calTag:c}:{},source:"school-import",visibility:"family",visibleTo:d,addedBy:i,createdAt:C(),updatedAt:C()}),m+=1})),m}async renameCalTag(e,t){if(!b||!this._currentFamilyId)throw new Error("No family yet.");const i=String(e??"").trim(),a=String(t??"").trim().slice(0,60);return!i||!a||i===a?0:this._applyTagWrite(i,{calTag:a,updatedAt:C()})}async deleteCalTag(e){if(!b||!this._currentFamilyId)throw new Error("No family yet.");const t=String(e??"").trim();return t?this._applyTagWrite(t,{calTag:null,updatedAt:C()}):0}async _applyTagWrite(e,t){const i=[];for(const a of this.state.events??[])a!=null&&a.id&&String((a==null?void 0:a.calTag)??"").trim()===e&&i.push(["familyEvents",a.id]);for(const a of this.state.activities??[])a!=null&&a.id&&String((a==null?void 0:a.calTag)??"").trim()===e&&i.push(["activities",a.id]);return await Promise.all(i.map(([a,r])=>M($(b,"families",this._currentFamilyId,a,r),t))),i.length}async previewUrl(e){if(!e||typeof e!="string"||!/^https?:\/\//i.test(e.trim()))return null;if(!R)throw new Error("Firebase functions not configured.");return(await H(R,"previewUrl")({url:e.trim()})).data}async askPebble(e,t=[]){if(!R)throw new Error("Firebase functions not configured.");if(!this._currentFamilyId)throw new Error("No family yet.");return(await H(R,"askPebbleAboutActivities")({question:e,familyId:this._currentFamilyId,history:t})).data}async updateChildBirthday(e,t){if(!b||!this._currentFamilyId)throw new Error("No family yet.");await M($(b,"families",this._currentFamilyId,"children",e),{dateOfBirth:t,updatedAt:C()})}async findFamilyByConnectCode(e){var i;if(!b)throw new Error("Firebase not configured.");const t=String(e??"").trim().toUpperCase();if(t)try{const{getDoc:a}=await K(async()=>{const{getDoc:s}=await import("./firebase-core-Dmfgjia1.js").then(o=>o.L);return{getDoc:s}},[]),r=await a($(b,"inviteCodes",t));if(r.exists()&&typeof((i=r.data())==null?void 0:i.familyId)=="string"){const s=r.data();return console.debug("[ConnectCode] resolved via /inviteCodes mapping →",s.familyId),{id:s.familyId,name:s.familyName??"",cairnInviteCodeExpiresAt:s.expiresAt??null,_matchedCodeKind:"cairn",_viaMapping:!0}}}catch(a){console.debug("[ConnectCode] mapping lookup errored, trying legacy:",a==null?void 0:a.code)}try{const a=await ae(J(I(b,"families"),X("cairnInviteCode","==",e)));if(!a.empty){const s=a.docs[0];return console.debug("[ConnectCode] resolved via LEGACY list query (cairn field)"),{id:s.id,...s.data(),_matchedCodeKind:"cairn"}}const r=await ae(J(I(b,"families"),X("inviteCode","==",e)));if(!r.empty){const s=r.docs[0];return console.debug("[ConnectCode] resolved via LEGACY list query (pp field)"),{id:s.id,...s.data(),_matchedCodeKind:"pp"}}}catch(a){return console.debug("[ConnectCode] legacy fallback denied (expected post-gate-D):",a==null?void 0:a.code),null}return null}async _applyCairnJoin(e){var l;const t=(l=_==null?void 0:_.currentUser)==null?void 0:l.uid;if(!t)throw new Error("Not signed in.");const i=_.currentUser;let a=e;if(e._viaMapping)try{const{getDoc:c}=await K(async()=>{const{getDoc:h}=await import("./firebase-core-Dmfgjia1.js").then(u=>u.L);return{getDoc:h}},[]),p=await c($(b,"families",e.id));a=p.exists()?{id:p.id,...p.data()}:null}catch{a=null}const r=(a==null?void 0:a.cairnMemberIds)??[],s=(a==null?void 0:a.memberIds)??[];if(r.includes(t)||s.includes(t))return await Y($(b,"users",t),{email:i.email??"",displayName:i.displayName??"",profilePhotoURL:i.photoURL??null,cairnFamilyId:e.id,updatedAt:C()},{merge:!0}),await this._recordMutualConnection(e.id,t),e.id;if(a){const c=a.cairnMaxMembers??20;if(r.length>=c){const p=new Error("This family's connection ring is full.");throw p.code="full",p}}const o=new Date,d={displayName:i.displayName??"",profilePhotoURL:i.photoURL??null,role:"member",joinedAt:o,updatedAt:o};try{const{arrayUnion:c}=await K(async()=>{const{arrayUnion:p}=await import("./firebase-core-Dmfgjia1.js").then(h=>h.L);return{arrayUnion:p}},[]);await M($(b,"families",e.id),{cairnMemberIds:c(t),[`memberProfiles.${t}`]:d,updatedAt:C()})}catch(c){if((c==null?void 0:c.code)==="permission-denied"){const p=new Error("Couldn't join this family. The code may have been replaced, or the family's circle is full — ask them for a fresh invite.");throw p.code="join-rejected",p}throw c}return await Y($(b,"users",t),{email:i.email??"",displayName:i.displayName??"",profilePhotoURL:i.photoURL??null,cairnFamilyId:e.id,role:"member",notificationPreferences:{milestoneReminders:!0,tipNotifications:!0,schoolDeadlines:!0},createdAt:C(),updatedAt:C()},{merge:!0}),await this._recordMutualConnection(e.id,t),e.id}async redeemConnectCode(e){var s,o;if(!b)throw new Error("Firebase not configured.");if(!((s=_==null?void 0:_.currentUser)==null?void 0:s.uid))throw new Error("Not signed in.");const i=await this.findFamilyByConnectCode(e);if(!i){const d=new Error("Invite code not found.");throw d.code="not-found",d}const a=i._matchedCodeKind==="pp"?i.inviteCodeExpiresAt:i.cairnInviteCodeExpiresAt,r=((o=a==null?void 0:a.toDate)==null?void 0:o.call(a))??(a?new Date(a):null);if(!r||r<new Date){const d=new Error("This invite code has expired.");throw d.code="expired",d}return this._applyCairnJoin(i)}async _recordMutualConnection(e,t){var i;try{const{getDoc:a,arrayUnion:r}=await K(async()=>{const{getDoc:d,arrayUnion:l}=await import("./firebase-core-Dmfgjia1.js").then(c=>c.L);return{getDoc:d,arrayUnion:l}},[]),s=await a($(b,"users",t)),o=s.exists()?(i=s.data())==null?void 0:i.familyId:null;if(!o||o===e)return;await M($(b,"families",e),{connectedFamilyIds:r(o),updatedAt:C()}),await M($(b,"families",o),{connectedFamilyIds:r(e),updatedAt:C()})}catch(a){console.warn("[connect] mutual connection record skipped (non-fatal):",a)}}async saveSubGroup({id:e,name:t,memberIds:i}){if(!b||!this._currentFamilyId)throw new Error("No family yet.");const a=e??`g_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,6)}`;return await M($(b,"families",this._currentFamilyId),{[`subGroups.${a}`]:{name:t.trim(),memberIds:Array.isArray(i)?[...i]:[],updatedAt:C()},updatedAt:C()}),a}async deleteSubGroup(e){if(!b||!this._currentFamilyId)throw new Error("No family yet.");const{deleteField:t}=await K(async()=>{const{deleteField:i}=await import("./firebase-core-Dmfgjia1.js").then(a=>a.L);return{deleteField:i}},[]);await M($(b,"families",this._currentFamilyId),{[`subGroups.${e}`]:t(),updatedAt:C()})}async setCairnMemberSubGroup(e,t){var r;if(!b||!this._currentFamilyId)throw new Error("No family yet.");if(!e)throw new Error("uid is required.");const i=((r=this.state.family)==null?void 0:r.subGroups)??{},a={};for(const[s,o]of Object.entries(i)){const d=Array.isArray(o.memberIds)?o.memberIds:[];s===t?d.includes(e)||(a[`subGroups.${s}.memberIds`]=[...d,e]):d.includes(e)&&(a[`subGroups.${s}.memberIds`]=d.filter(l=>l!==e))}Object.keys(a).length!==0&&(a.updatedAt=C(),await M($(b,"families",this._currentFamilyId),a))}async removeCairnMember(e){if(!b||!this._currentFamilyId)throw new Error("No family yet.");if(!e)throw new Error("uid is required.");const t=this.state.family??{};if((Array.isArray(t.memberIds)?t.memberIds:[]).includes(e))throw new Error("parents can’t be removed from the ring here.");const{deleteField:a}=await K(async()=>{const{deleteField:l}=await import("./firebase-core-Dmfgjia1.js").then(c=>c.L);return{deleteField:l}},[]),r={updatedAt:C()},s=Array.isArray(t.cairnMemberIds)?t.cairnMemberIds:[];s.includes(e)&&(r.cairnMemberIds=s.filter(l=>l!==e)),t.memberProfiles&&t.memberProfiles[e]&&(r[`memberProfiles.${e}`]=a());const o=Array.isArray(t.childViewers)?t.childViewers:[];o.includes(e)&&(r.childViewers=o.filter(l=>l!==e));const d=t.subGroups??{};for(const[l,c]of Object.entries(d)){const p=Array.isArray(c.memberIds)?c.memberIds:[];p.includes(e)&&(r[`subGroups.${l}.memberIds`]=p.filter(h=>h!==e))}await M($(b,"families",this._currentFamilyId),r);try{await W($(b,"families",this._currentFamilyId,"childAccessRequests",e))}catch{}}async createCairnOnlyFamily(e){if(!b)throw new Error("Firebase not configured.");const t=_==null?void 0:_.currentUser,i=t==null?void 0:t.uid;if(!i)throw new Error("Not signed in.");const a=(e??"").trim();if(!a)throw new Error("Family name is required.");const r=new Date,s=we(),o=new Date(Date.now()+720*60*60*1e3),d={displayName:t.displayName??"",profilePhotoURL:t.photoURL??null,role:"admin",joinedAt:r,updatedAt:r},l={name:a,createdBy:i,createdInApp:"cairn",memberIds:[],cairnMemberIds:[i],connectedFamilyIds:[],cairnMaxMembers:20,cairnInviteCode:s,cairnInviteCodeExpiresAt:o,memberProfiles:{[i]:d},createdAt:C(),updatedAt:C()},c=await j(I(b,"families"),l);try{await Y($(b,"inviteCodes",s),{familyId:c.id,familyName:a,expiresAt:o,createdAt:C()})}catch(p){console.warn("[Cairn] invite-code mapping write failed (backfill heals):",p==null?void 0:p.code)}return await Y($(b,"users",i),{email:t.email??"",displayName:t.displayName??"",profilePhotoURL:t.photoURL??null,cairnFamilyId:c.id,role:"admin",notificationPreferences:{milestoneReminders:!1,tipNotifications:!1,schoolDeadlines:!1},createdAt:C(),updatedAt:C()},{merge:!0}),c.id}async createPebblePathFamily(e){if(!b)throw new Error("Firebase not configured.");const t=_==null?void 0:_.currentUser,i=t==null?void 0:t.uid;if(!i)throw new Error("Not signed in.");const a=(e??"").trim();if(!a)throw new Error("Family name is required.");const r=new Date,s=we(),o=new Date(Date.now()+720*60*60*1e3),d={displayName:t.displayName??"",profilePhotoURL:t.photoURL??null,role:"admin",joinedAt:r,updatedAt:r},l={name:a,createdBy:i,memberIds:[i],cairnMemberIds:[i],connectedFamilyIds:[],cairnMaxMembers:20,inviteCode:s,inviteCodeExpiresAt:o,cairnInviteCode:s,cairnInviteCodeExpiresAt:o,memberProfiles:{[i]:d},createdAt:C(),updatedAt:C()},c=await j(I(b,"families"),l);try{await Y($(b,"inviteCodes",s),{familyId:c.id,familyName:a,expiresAt:o,createdAt:C()})}catch(p){console.warn("[Cairn] invite-code mapping write failed (backfill heals):",p==null?void 0:p.code)}return await Y($(b,"users",i),{email:t.email??"",displayName:t.displayName??"",profilePhotoURL:t.photoURL??null,familyId:c.id,role:"owner",notificationPreferences:{milestoneReminders:!1,tipNotifications:!1,schoolDeadlines:!1},createdAt:C(),updatedAt:C()},{merge:!0}),c.id}async createChild(e,t){var p,h;if(!b)throw new Error("Firebase not configured.");const i=(p=_==null?void 0:_.currentUser)==null?void 0:p.uid;if(!i)throw new Error("Not signed in.");if(!e)throw new Error("No family.");const a=((t==null?void 0:t.name)??"").trim();if(!a)throw new Error("Child's name is required.");if(!((t==null?void 0:t.dateOfBirth)instanceof Date))throw new Error("Child's date of birth is required.");const{getDoc:r}=await K(async()=>{const{getDoc:u}=await import("./firebase-core-Dmfgjia1.js").then(m=>m.L);return{getDoc:u}},[]),s=await r($(b,"families",e)),o=s.exists()?Array.isArray((h=s.data())==null?void 0:h.memberIds)?s.data().memberIds:[]:[],d=o.length?o:[i],l={name:a,dateOfBirth:t.dateOfBirth,profilePhotoURL:null,developmentalFlags:Array.isArray(t==null?void 0:t.developmentalFlags)?t.developmentalFlags:[],pediatricianNotes:null,region:(t==null?void 0:t.region)??null,parentIds:d,needsServerSeed:!0,createdAt:C(),updatedAt:C()};return(await j(I(b,"families",e,"children"),l)).id}async uploadChildAvatar(e,t,i){if(!b||!O)throw new Error("Firebase not configured.");if(!e||!t)throw new Error("Missing family/child id.");if(!i)throw new Error("No image.");const a=i.type&&i.type.startsWith("image/")?i.type:"image/jpeg",r=Z(O,`families/${e}/avatars/children/${t}`);await se(r,i,{contentType:a});const s=await re(r);return await M($(b,"families",e,"children",t),{profilePhotoURL:s,updatedAt:C()}),s}async uploadUserAvatar(e,t){var o;if(!b||!O)throw new Error("Firebase not configured.");const i=(o=_==null?void 0:_.currentUser)==null?void 0:o.uid;if(!i)throw new Error("Not signed in.");if(!e)throw new Error("No family.");if(!t)throw new Error("No image.");const a=t.type&&t.type.startsWith("image/")?t.type:"image/jpeg",r=Z(O,`families/${e}/avatars/users/${i}`);await se(r,t,{contentType:a});const s=await re(r);await M($(b,"users",i),{profilePhotoURL:s,updatedAt:C()});try{await M($(b,"families",e),{[`memberProfiles.${i}.profilePhotoURL`]:s,[`memberProfiles.${i}.updatedAt`]:C(),updatedAt:C()})}catch(d){console.warn("memberProfiles photo fan-out failed:",d)}return s}async requestToBeCoParent(e){var r,s,o,d,l;if(!b)throw new Error("Firebase not configured.");const t=(r=_==null?void 0:_.currentUser)==null?void 0:r.uid;if(!t)throw new Error("Not signed in.");const i=this._currentFamilyId??((s=this.state.user)==null?void 0:s.cairnFamilyId)??((o=this.state.user)==null?void 0:o.familyId)??null;if(!i)throw new Error("No family.");if(!e)throw new Error("No child.");const a=((d=this.state.user)==null?void 0:d.displayName)??((l=_==null?void 0:_.currentUser)==null?void 0:l.displayName)??"";await Y($(b,"families",i,"children",e,"coParentRequests",t),{uid:t,displayName:a,status:"pending",requestedAt:C()})}async fetchFamilyChildren(e){if(!b||!e)return[];try{return(await ae(I(b,"families",e,"children"))).docs.map(i=>({id:i.id,...i.data()}))}catch(t){return console.warn("[parent-prompt] fetchFamilyChildren skipped (non-fatal):",t),[]}}async regenerateCairnInviteCode(){if(!b||!this._currentFamilyId)throw new Error("No family yet.");const e=we(),t=new Date(Date.now()+720*60*60*1e3),i=this.state.family,a=String((i==null?void 0:i.cairnInviteCode)??"").toUpperCase(),r=String((i==null?void 0:i.inviteCode)??"").toUpperCase();if(a&&a!==r&&a!==e)try{await W($(b,"inviteCodes",a))}catch(s){console.warn("[Cairn] stale invite-code mapping delete failed:",s==null?void 0:s.code)}await M($(b,"families",this._currentFamilyId),{cairnInviteCode:e,cairnInviteCodeExpiresAt:t,updatedAt:C()});try{await Y($(b,"inviteCodes",e),{familyId:this._currentFamilyId,familyName:(i==null?void 0:i.name)??"",expiresAt:t,createdAt:C()})}catch(s){console.warn("[Cairn] invite-code mapping write failed (backfill heals):",s==null?void 0:s.code)}return{code:e,expiresAt:t}}_maybeMigrateInviteCodeFormat(){const e=this.state.family;if(!e||!this._uid||this._inviteCodeMigratedFamilyId===e.id)return;const t=e.cairnInviteCode;if(!t||typeof t!="string")return;if(!t.includes("-")){this._inviteCodeMigratedFamilyId=e.id;return}(Array.isArray(e.memberIds)?e.memberIds:[]).includes(this._uid)&&(this._inviteCodeMigratedFamilyId=e.id,this.regenerateCairnInviteCode().catch(a=>{console.debug("invite-code format migration deferred:",(a==null?void 0:a.code)??(a==null?void 0:a.message)??a)}))}stop(){var e,t,i,a,r,s,o;(e=this._unsubUser)==null||e.call(this),(t=this._unsubFamily)==null||t.call(this),(i=this._unsubChildren)==null||i.call(this),(a=this._unsubTrips)==null||a.call(this),(r=this._unsubEvents)==null||r.call(this),(s=this._unsubActivities)==null||s.call(this),(o=this._unsubPlanning)==null||o.call(this),this._unsubUser=this._unsubFamily=this._unsubChildren=this._unsubTrips=this._unsubEvents=this._unsubActivities=this._unsubPlanning=null,this._teardownPpFamily(),this._uid=null,this._currentFamilyId=null,this._inviteCodeMigratedFamilyId=null,this._holidayKey=null,this._ppFamilyId=null,this.userDocResolved=!1,this.state={user:null,family:null,children:[],trips:[],events:[],holidays:[],ppFamily:null,ppIsMember:!1,ppChildren:[],selectedChildId:null,childMilestones:[],childInsights:[],childDailyCard:null,familyDailyCard:null,pebbleAnchors:[],pebbleRhythms:[],pebblePatterns:[],pebbleLiveContext:[],childPebbleMessages:[],childPebbleSessions:[],planningMessages:[]}}_emit(){this.dispatchEvent(new Event("change"))}}const v=new hi;function Nt(g,e){const t=e==null?void 0:e.profilePhotoURL;return typeof t=="string"&&/^https?:\/\//i.test(t)?t:g!=null&&g.photoURL?g.photoURL:null}function gi(g,e,t=[]){if(!e)return[];const i=e.memberIds??[],a=e.cairnMemberIds??e.memberIds??[],r=e.memberProfiles??{},s=i.includes(g),o=s?a:Array.from(new Set([...a,...i])),d=[];let l=280;for(const c of o){if(c===g||s&&i.includes(c))continue;const p=r[c],h=p==null?void 0:p.profilePhotoURL,u=i.includes(c);d.push({uid:c,displayName:(p==null?void 0:p.displayName)??"Family",photoURL:typeof h=="string"&&/^https?:\/\//i.test(h)?h:null,role:u?"co-parent":"extended",circles:["extended"],hue:l}),l=(l+47)%360}return d}async function ui(g,e){var o,d;const t=Array.isArray(e==null?void 0:e.connectedFamilyIds)?e.connectedFamilyIds:[];if(t.length===0||!b)return[];const{getDoc:i}=await K(async()=>{const{getDoc:l}=await import("./firebase-core-Dmfgjia1.js").then(c=>c.L);return{getDoc:l}},[]),a=[],r=new Set(g?[g]:[]);let s=150;for(const l of t)try{const c=await i($(b,"families",l));if(!c.exists())continue;const p=c.data()??{},h=p.memberProfiles??{},u=p.name??"Connection";for(const m of p.memberIds??[]){if(r.has(m))continue;r.add(m);const x=(o=h[m])==null?void 0:o.profilePhotoURL;a.push({uid:m,displayName:((d=h[m])==null?void 0:d.displayName)??"Connection",photoURL:typeof x=="string"&&/^https?:\/\//i.test(x)?x:null,role:"connection",circles:["connection"],familyName:u,hue:s}),s=(s+53)%360}}catch{}return a}function xe(g,e,t,i=[],a=[]){const r=(e==null?void 0:e.memberIds)??[],s=(e==null?void 0:e.cairnMemberIds)??[],o=t?[t]:[],d=Array.isArray(i)?i:[],l=Array.isArray(a)?a:[];return g==="personal"?[...new Set(o)]:g==="extended"?[...new Set([...r,...s,...o,...d,...l])]:[...new Set([...r,...o,...d])]}async function bi(g){var a;const e=Array.isArray(g==null?void 0:g.connectedFamilyIds)?g.connectedFamilyIds:[];if(e.length===0||!b)return[];const{getDoc:t}=await K(async()=>{const{getDoc:r}=await import("./firebase-core-Dmfgjia1.js").then(s=>s.L);return{getDoc:r}},[]),i=new Set;for(const r of e)try{const s=await t($(b,"families",r));if(!s.exists())continue;for(const o of((a=s.data())==null?void 0:a.memberIds)??[])i.add(o)}catch{}return[...i]}function we(){const g="ABCDEFGHJKMNPQRSTUVWXYZ23456789";let e="";for(let t=0;t<6;t++)e+=g[Math.floor(Math.random()*g.length)];return e}function mi(g,e,t,i,a){const r=[],s=new Set((i==null?void 0:i.memberIds)??[]),o=s.has(g);if(r.push({uid:g,displayName:(e==null?void 0:e.displayName)??(t==null?void 0:t.displayName)??"You",photoURL:Nt(e,t),role:o?"self":"self-extended",circles:["immediate"],hue:198}),!o)return r;const d=(i==null?void 0:i.memberProfiles)??{};for(const[c,p]of Object.entries(d)){if(c===g||!s.has(c))continue;const h=p.profilePhotoURL;r.push({uid:c,displayName:p.displayName??"Co-parent",photoURL:typeof h=="string"&&/^https?:\/\//i.test(h)?h:null,role:"co-parent",circles:["immediate"],hue:8})}let l=142;for(const c of a??[]){const p=c.profilePhotoURL;r.push({uid:`child:${c.id}`,displayName:c.name,photoURL:typeof p=="string"&&/^https?:\/\//i.test(p)?p:null,role:"child",circles:["immediate"],hue:l,dateOfBirth:c.dateOfBirth}),l=(l+58)%360}return r}function fi(g){const e=[];for(const t of g??[]){if(!t.dateOfBirth)continue;const i=t.dateOfBirth,a=i.getUTCFullYear(),r=String(i.getUTCMonth()+1).padStart(2,"0"),s=String(i.getUTCDate()).padStart(2,"0");e.push({id:`bday:${t.id}`,type:"birthday",date:`${a}-${r}-${s}`,personIds:[`child:${t.id}`],title:`${t.name}'s birthday`,_childId:t.id,_childName:t.name,recurring:!0})}return e}function ht(g,e=new Date){if(!(g!=null&&g.date))return{date:null,yearsElapsed:0};const t=A(g.date);if(!t||Number.isNaN(t.getTime()))return{date:null,yearsElapsed:0};if(!g.recurring)return{date:t,yearsElapsed:0};const i=new Date(e.getFullYear(),t.getMonth(),t.getDate()),a=i<new Date(e.getFullYear(),e.getMonth(),e.getDate())?new Date(e.getFullYear()+1,t.getMonth(),t.getDate()):i,r=a.getFullYear()-t.getFullYear();return{date:a,yearsElapsed:r}}const gt=["linear-gradient(135deg, #6b9ac4 0%, #c98a8a 60%, #d4a843 100%)","linear-gradient(135deg, #7a9e7e 0%, #4a6754 70%, #2c4439 100%)","linear-gradient(135deg, #c67b5c 0%, #d4a843 50%, #c98a8a 100%)","linear-gradient(135deg, #3d9b8f 0%, #1f5c54 100%)","linear-gradient(135deg, #d4a843 0%, #c67b5c 55%, #c98a8a 100%)","linear-gradient(135deg, #8b7bb5 0%, #c98a8a 60%, #d4a843 100%)","linear-gradient(135deg, #6b9ac4 0%, #3d9b8f 100%)"];function A(g){if(!g)return null;if(g instanceof Date)return g;const e=String(g).match(/^(\d{4})-(\d{2})-(\d{2})/);return e?new Date(Number(e[1]),Number(e[2])-1,Number(e[3])):new Date(g)}function ee(g){if(!g)return null;const e=g.getFullYear(),t=String(g.getMonth()+1).padStart(2,"0"),i=String(g.getDate()).padStart(2,"0");return`${e}-${t}-${i}`}async function vi(g,e=90,t=100){const i=new Date,a=new Date(i.getTime()+e*24*60*60*1e3),r=new URL("https://www.googleapis.com/calendar/v3/calendars/primary/events");r.searchParams.set("timeMin",i.toISOString()),r.searchParams.set("timeMax",a.toISOString()),r.searchParams.set("maxResults",String(t)),r.searchParams.set("singleEvents","true"),r.searchParams.set("orderBy","startTime");const s=await fetch(r.toString(),{headers:{Authorization:`Bearer ${g}`}});if(!s.ok){const d=await s.text();throw s.status===401?new Error("Your Google session expired — connect your calendar again."):s.status===403&&/accessNotConfigured|SERVICE_DISABLED|PERMISSION_DENIED|insufficient/i.test(d)?new Error("Google Calendar access isn’t configured for this project yet. (Admin: enable the Google Calendar API and add the calendar.readonly scope to the OAuth consent screen in Google Cloud Console.)"):new Error(`Google Calendar: ${s.status} ${d.slice(0,160)}`)}return((await s.json()).items??[]).filter(d=>{var l,c;return d.status!=="cancelled"&&(((l=d.start)==null?void 0:l.date)||((c=d.start)==null?void 0:c.dateTime))})}function yi(g,e){var a,r,s,o,d,l,c,p;const t=((a=g.start)==null?void 0:a.date)??((s=(r=g.start)==null?void 0:r.dateTime)==null?void 0:s.slice(0,10))??"";let i=((o=g.end)==null?void 0:o.date)??((l=(d=g.end)==null?void 0:d.dateTime)==null?void 0:l.slice(0,10))??t;if((c=g.start)!=null&&c.date&&((p=g.end)!=null&&p.date)){const h=new Date(i);h.setDate(h.getDate()-1),i=h.toISOString().slice(0,10)}return{title:g.summary||"(untitled)",location:g.location??"",start:t,end:i,attendees:e?[e]:[],viewers:[],visibility:"family",notes:(g.description??"").slice(0,1e3),gcalEventId:g.id,gcalEventLink:g.htmlLink??null}}function Rt(g){if(g!=null&&g.coverGradient)return g.coverGradient;const e=((g==null?void 0:g.title)??(g==null?void 0:g.id)??"")+((g==null?void 0:g.location)??"");let t=0;for(let i=0;i<e.length;i++)t=t*31+e.charCodeAt(i)>>>0;return gt[t%gt.length]}class Ne extends T{constructor(){super(),this.start="",this.end="",this._displayMonth=null,this._hoverDate=null}willUpdate(e){if(e.has("start")||this._displayMonth===null){const t=this.start?A(this.start):new Date;this._displayMonth=new Date(t.getFullYear(),t.getMonth(),1)}}_isoFor(e,t,i){return`${e}-${String(t+1).padStart(2,"0")}-${String(i).padStart(2,"0")}`}_emit(e,t){this.start=e,this.end=t,this._hoverDate=null,this.dispatchEvent(new CustomEvent("range-change",{detail:{start:e,end:t},bubbles:!0,composed:!0}))}_onDayClick(e){if(!this.start||this.start&&this.end){this._emit(e,"");return}e<this.start?this._emit(e,this.start):this._emit(this.start,e)}_onDayHover(e){this.start&&!this.end&&(this._hoverDate=e)}_onLeave(){this._hoverDate=null}_shiftMonth(e){const t=this._displayMonth;this._displayMonth=new Date(t.getFullYear(),t.getMonth()+e,1)}_isToday(e,t,i){const a=new Date;return a.getFullYear()===e&&a.getMonth()===t&&a.getDate()===i}_inSelectedRange(e){return!this.start||!this.end?!1:e>this.start&&e<this.end}_inHoverRange(e){if(!this.start||this.end||!this._hoverDate)return!1;const t=this._hoverDate<this.start?this._hoverDate:this.start,i=this._hoverDate<this.start?this.start:this._hoverDate;return e>t&&e<i}_summary(){if(!this.start&&!this.end)return"Pick a start date";const e=t=>{const i=A(t);return i?i.toLocaleString("en-GB",{day:"numeric",month:"short",year:"numeric"}):""};return this.start&&!this.end?`From ${e(this.start)} — pick an end date`:this.start===this.end?e(this.start):`${e(this.start)} – ${e(this.end)}`}_renderGrid(){const e=this._displayMonth.getFullYear(),t=this._displayMonth.getMonth(),a=(new Date(e,t,1).getDay()+6)%7,r=new Date(e,t+1,0).getDate(),s=[];for(let o=0;o<a;o++)s.push(n`<div class="empty"></div>`);for(let o=1;o<=r;o++){const d=this._isoFor(e,t,o),l=d===this.start,c=d===this.end&&d!==this.start,p=this._inSelectedRange(d),h=this._inHoverRange(d),u=this._isToday(e,t,o),m=["day",l?"start":"",c?"end":"",p?"in-range":"",h?"hover-range":"",u&&!l&&!c?"today":""].filter(Boolean).join(" ");s.push(n`
  ...
  `);customElements.define("event-form",Be);class Le extends T{constructor(){super(),this.immediate=[],this.extended=[]}_self(){return(this.immediate??[]).find(e=>e.role==="self"||e.role==="self-extended")}_family(){return(this.immediate??[]).filter(e=>e.role==="co-parent"||e.role==="child")}_connections(){return this.extended??[]}_pos(e,t,i,a){if(t<=0)return"left:50%;top:50%;";const r=(a+e/t*360)*(Math.PI/180),s=50+i*Math.cos(r),o=50+i*Math.sin(r);return`left:${s}%;top:${o}%;`}_node(e,t,i){const a=(e.displayName??"").split(/\s+/)[0]||e.displayName||"";return n`
...
`)}class je extends T{constructor(){super(),this.trip=null,this.members=[],this._resizeObs=null}connectedCallback(){super.connectedCallback(),typeof ResizeObserver<"u"&&(this._resizeObs=new ResizeObserver(()=>this._fitTitle()))}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._resizeObs)==null||e.disconnect()}updated(){if(this._resizeObs&&this.renderRoot){const e=this.renderRoot.querySelector("article");e&&!e._observed&&(this._resizeObs.observe(e),e._observed=!0)}this._fitTitle()}_fitTitle(){if(!this.renderRoot)return;const e=this.renderRoot.querySelector("h3");if(!e)return;e.style.fontSize="";let t=19;for(e.style.fontSize=`${t}px`;e.scrollWidth>e.clientWidth+1&&t>13;)t-=.5,e.style.fontSize=`${t}px`}_fmtDates(e,t){const i=A(e),a=A(t);if(!i||!a)return"";const r=i.toLocaleString("en-GB",{month:"short"}),s=a.toLocaleString("en-GB",{month:"short"});return r===s&&i.getFullYear()===a.getFullYear()?`${i.getDate()} – ${a.getDate()} ${r}`:`${i.getDate()} ${r} – ${a.getDate()} ${s}`}async _onShare(e,t,i){i.stopPropagation();const a=_i(e,t);if(navigator.share)try{await navigator.share({title:`Portal — ${e.title??"activity"}`,text:a})}catch{}else try{await navigator.clipboard.writeText(a),y("Itinerary copied to clipboard.")}catch{y("Could not copy — try again from a browser tab.")}}render(){const e=this.trip;if(!e)return n``;const t=e.previewImage&&String(e.previewImage).trim()||e.coverImage,i=t?`background-image: url("${t}");`:`background: ${Rt(e)};`,a=t?"cover has-image":"cover",r=new Map(this.members.map(l=>[l.uid,l])),s=(e.attendees??[]).map(l=>r.get(l)).filter(Boolean),o=s.slice(0,4),d=Math.max(0,s.length-o.length);return n`
      ...
      >
        ...
        <div class="body">
          ...
          ${e.lodgingUrl||e.lodgingHost?(()=>{const l=Bt(e);return n`<div class="lodging">
  ...
  `);customElements.define("discover-pebblepath",Lt);class He extends T{constructor(){super(),this.code="",this._family=null,this._loading=!0,this._joining=!1,this._error="",this._step="join",this._children=[],this._claiming=!1,this._claimedName=null,this._joinedFamilyId=null}willUpdate(e){e.has("code")&&this.code&&this._lookup()}async _lookup(){var e;this._loading=!0,this._error="";try{const t=await v.findFamilyByConnectCode(this.code);if(!t)this._error="Invite code not found. Check it was typed correctly.",this._family=null;else{const i=t._matchedCodeKind==="pp"?t.inviteCodeExpiresAt:t.cairnInviteCodeExpiresAt,a=((e=i==null?void 0:i.toDate)==null?void 0:e.call(i))??(i?new Date(i):null);!a||a<new Date?(this._error="This invite code has expired. Ask the family for a fresh one.",this._family=null):this._family=t}}catch(t){console.error(t),this._error=(t==null?void 0:t.message)??"Couldn't look up the invite."}finally{this._loading=!1}}async _join(){var e;if(!this._joining){this._joining=!0,this._error="";try{const t=await v.redeemConnectCode(this.code);y(`Welcome to ${((e=this._family)==null?void 0:e.name)??"the family"}.`),this._joinedFamilyId=t;const i=await v.fetchFamilyChildren(t);Array.isArray(i)&&i.length?(this._children=i,this._step="parent"):this.dispatchEvent(new CustomEvent("joined",{detail:{familyId:t}}))}catch(t){console.error(t),this._error=(t==null?void 0:t.message)??"Could not join."}finally{this._joining=!1}}}async _claimChild(e){if(!(this._claiming||!(e!=null&&e.id))){this._claiming=!0,this._error="";try{await v.requestToBeCoParent(e.id),this._claimedName=e.name??"your child"}catch(t){console.error(t),this._error=(t==null?void 0:t.message)??"Couldn't send the request."}finally{this._claiming=!1}}}_notAParent(){this._finishJoin()}_finishJoin(){this.dispatchEvent(new CustomEvent("joined",{detail:{familyId:this._joinedFamilyId}}))}_cancel(){this.dispatchEvent(new Event("cancel"))}_inviterFromFamily(e){var a;if(!e)return null;const t=(a=e.memberProfiles)==null?void 0:a[e.createdBy];if(!t)return null;const i=t.profilePhotoURL;return{displayName:t.displayName??"A family member",photoURL:typeof i=="string"&&/^https?:\/\//i.test(i)?i:null}}_renderParentPrompt(){var t;const e=((t=this._family)==null?void 0:t.name)??"this family";return n`
    ...
    `}}k(He,"properties",{code:{type:String},_family:{state:!0},_loading:{state:!0},_joining:{state:!0},_error:{state:!0},_step:{state:!0},_children:{state:!0},_claiming:{state:!0},_claimedName:{state:!0}}),k(He,"styles",z`
    * { box-sizing: border-box; }
    :host {
      display: flex;
      align-items: center;
  ...
  `);customElements.define("event-row",Xe);class Qe extends T{constructor(){super(),this.open=!1,this.activity=null,this.members=[],this.children=[],this.familyId="",this.busy=!1,this.defaultDay="",this.defaultTripId=null,this.defaultTime="",this.defaultDuration=60,this._draft=this._blankDraft(),this._error=""}willUpdate(e){(e.has("activity")||e.has("open"))&&(this.open&&(this._draft=this.activity?this._draftFromActivity(this.activity):this._blankDraft()),this._error="")}_blankDraft(){const e=new Date().toISOString().slice(0,10);return{id:null,title:"",type:"visit",day:this.defaultDay||e,time:this.defaultTime||"",durationMins:this.defaultDuration||60,personIds:[],visibility:"family",calTag:"",notes:"",url:"",tripId:this.defaultTripId||null}}_draftFromActivity(e){if(!e)return this._blankDraft();const t=new Date().toISOString().slice(0,10);return{id:e.id??null,title:e.title??"",type:e.type??"visit",day:e.day??t,time:e.time??"",durationMins:e.durationMins??60,personIds:Array.isArray(e.personIds)?[...e.personIds]:[],visibility:e.visibility??"family",calTag:e.calTag??"",notes:e.notes??"",url:e.url??"",tripId:e.tripId??null}}_set(e,t){this._draft={...this._draft,[e]:t}}_toggleTime(){this._set("time",this._draft.time?"":"09:00")}_togglePerson(e){const t=this._draft.personIds.includes(e);this._set("personIds",t?this._draft.personIds.filter(i=>i!==e):[...this._draft.personIds,e])}_onSave(){const e=this._draft;if(!e.title.trim()){this._error="Give it a title.";return}if(!e.day){this._error="Pick a date.";return}if(!this.familyId){this._error="No family yet.";return}const t=(e.url??"").trim();if(t&&!/^https?:\/\//i.test(t)){this._error="Links must start with http:// or https://";return}this._error="";const i=!!e.time,a={id:e.id,title:e.title.trim(),type:e.type,day:e.day,time:i?e.time:null,durationMins:i?e.durationMins:null,personIds:[...e.personIds],visibility:e.visibility,calTag:e.calTag.trim()||null,notes:e.notes.trim()||null,url:t||null};e.tripId&&(a.tripId=e.tripId),this.dispatchEvent(new CustomEvent("save",{detail:a}))}_onDelete(){this._draft.id&&confirm("Delete this activity? This can't be undone.")&&this.dispatchEvent(new CustomEvent("remove",{detail:{id:this._draft.id}}))}_onCancel(){this.dispatchEvent(new Event("cancel"))}render(){if(!this.open)return n``;const e=this._draft,t=!!e.id,i=!!e.tripId,a=!!e.time,r=[{v:30,label:"30m"},{v:60,label:"1h"},{v:120,label:"2h"},{v:180,label:"3h"},{v:1440,label:"All day"}];return n`
    ...
    `}_titlePlaceholder(e){return e==="visit"?"e.g. Zoo morning":e==="meal"?"e.g. Pizza night":e==="travel"?"e.g. Drive to grandma's":"e.g. Pack swim bag"}}k(Qe,"properties",{open:{type:Boolean,reflect:!0},activity:{type:Object},members:{type:Array},children:{type:Array},familyId:{type:String},busy:{type:Boolean},defaultDay:{type:String},defaultTripId:{type:String},defaultTime:{type:String},defaultDuration:{type:Number},_draft:{state:!0},_error:{state:!0}}),k(Qe,"styles",z`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("growth-pathways",it);const $e=[{key:"motor",label:"Motor",color:"#6b9ac4",svg:n`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><circle cx="13.5" cy="5.5" r="2"/><path d="M9.8 8.9 7 23h2.1l1.8-8 2.1 2v6h2v-7.5l-2.1-2 .6-3c1.3 1.5 3.3 2.5 5.5 2.5v-2c-1.9 0-3.5-1-4.3-2.4l-1-1.6c-.4-.6-1-1-1.7-1-.3 0-.5 0-.8.1L6 7.6V12h2V8.9l1.8-.7z"/></svg>`},{key:"language",label:"Language",color:"#d4a843",svg:n`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M20 2H4a2 2 0 0 0-2 2v18l4-4h14a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2z"/></svg>`},{key:"socialEmotional",label:"Social-Emotional",color:"#c98a8a",svg:n`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg>`},{key:"cognitive",label:"Cognitive",color:"#8b7bb5",svg:n`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M11 4.2A2.7 2.7 0 0 0 6.4 5.9a2.6 2.6 0 0 0-2.5 2.6c0 .5.1.9.3 1.3A2.7 2.7 0 0 0 3 12.2a2.7 2.7 0 0 0 1.2 2.2 2.6 2.6 0 0 0-.2 1c0 1.5 1.2 2.7 2.7 2.7.2 0 .4 0 .6-.1A2.7 2.7 0 0 0 11 20V4.2zm2 0v15.8a2.7 2.7 0 0 0 3.7-1.9c.2 0 .4.1.6.1 1.5 0 2.7-1.2 2.7-2.7 0-.4-.1-.7-.2-1A2.7 2.7 0 0 0 21 12.2a2.7 2.7 0 0 0-1.2-2.4c.2-.4.3-.8.3-1.3a2.6 2.6 0 0 0-2.5-2.6A2.7 2.7 0 0 0 13 4.2z"/></svg>`}];function pe(g){return g==="selfCare"?"motor":g}function Pi(g){var s;if(!g||Number.isNaN(((s=g.getTime)==null?void 0:s.call(g))??NaN))return"";const e=new Date;let t=(e.getFullYear()-g.getFullYear())*12+(e.getMonth()-g.getMonth());e.getDate()<g.getDate()&&(t-=1),t=Math.max(0,t);const i=Math.floor(t/12),a=t%12;if(i===0)return`${a} month${a===1?"":"s"}`;const r=a?`, ${a} month${a===1?"":"s"}`:"";return`${i} year${i===1?"":"s"}${r}`}class at extends T{constructor(){super(),this.child=null,this.children=[],this.milestones=[],this.insights=[],this.dailyCard=null,this.readonly=!1,this._focusedDot=null,this._onDocClick=e=>{var a;if(this._focusedDot==null)return;(((a=e.composedPath)==null?void 0:a.call(e))??[]).some(r=>{var s,o,d,l;return((o=(s=r==null?void 0:r.classList)==null?void 0:s.contains)==null?void 0:o.call(s,"tl-dot"))||((l=(d=r==null?void 0:r.classList)==null?void 0:d.contains)==null?void 0:l.call(d,"tl-popover"))})||(this._focusedDot=null)}}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._onDocClick)}disconnectedCallback(){document.removeEventListener("click",this._onDocClick),super.disconnectedCallback()}_domainStats(e){const t=(this.milestones??[]).filter(r=>pe(r.category)===e),i=t.filter(r=>r.status==="achieved").length,a=t.length;return{achieved:i,total:a,pct:a?Math.round(i/a*100):0}}_pebbleIcon(){return n`<pebble-icon></pebble-icon>`}_ageMonths(e){var a;if(!e||Number.isNaN(((a=e.getTime)==null?void 0:a.call(e))??NaN))return 0;const t=new Date;let i=(t.getFullYear()-e.getFullYear())*12+(t.getMonth()-e.getMonth());return t.getDate()<e.getDate()&&(i-=1),Math.max(0,i)}_timelineModel(){var p;const e=this.milestones??[],t=this._ageMonths((p=this.child)==null?void 0:p.dateOfBirth),i=e.reduce((h,u)=>u.status==="achieved"?Math.max(h,u.ageRangeEndMonths??u.ageRangeStartMonths??0):h,0);let a=Math.max(i+12,t+6,18);a=Math.ceil(a/6)*6;const r=h=>Math.min(98,Math.max(2,(h??0)/a*100)),s=h=>h<=0?"birth":h<24?`${h} mo`:h%12===0?`${h/12} yr`:`${(h/12).toFixed(1).replace(/\.0$/,"")} yr`,o=(h,u)=>{const m=h.ageRangeStartMonths??0,x=h.ageRangeEndMonths??m;return{left:r(m),future:!!u,title:h.title??"",status:h.status,ageLabel:m===x?`at ${s(m)}`:`${s(m)}–${s(x)}`}},d=[{key:"motor",cls:"motor",name:"Motor"},{key:"language",cls:"language",name:"Language"},{key:"socialEmotional",cls:"social",name:"Social-Emo."},{key:"cognitive",cls:"cognitive",name:"Cognitive"}].map(h=>{const u=e.filter(S=>pe(S.category)===h.key),m=u.filter(S=>S.status==="achieved").sort((S,E)=>(S.ageRangeStartMonths??0)-(E.ageRangeStartMonths??0));let x=m;m.length>7&&(x=Array.from({length:7},(S,E)=>m[Math.round(E*(m.length-1)/6)]));const f=x.map(S=>o(S,!1)),w=u.filter(S=>S.status!=="achieved").sort((S,E)=>(S.ageRangeStartMonths??0)-(E.ageRangeStartMonths??0))[0];return w&&f.push(o(w,!0)),{...h,dots:f}}),l=Array.from({length:7},(h,u)=>s(Math.round(u*a/6))),c=Math.min(1,Math.max(0,t/a));return{lanes:d,axis:l,ageM:t,nowFrac:c}}render(){const e=this.child;if(!e)return n`<div class="panel empty">No child selected yet.</div>`;const t=this.milestones??[],i=t.filter(p=>p.status==="achieved"),a=t.length?Math.round(i.length/t.length*100):0,r=i.slice().sort((p,h)=>(h.ageRangeStartMonths??0)-(p.ageRangeStartMonths??0)).slice(0,4),s=t.filter(p=>p.status!=="achieved").slice(0,4),o=e.themeColorHex||"var(--teal-pebble)",d=(this.insights??[]).slice(0,4),l=p=>p==="achieved"?"done":p==="emerging"?"emerging":"up",c=p=>p==="achieved"?"Achieved":p==="emerging"?"Emerging":"Upcoming";return n`
      ...
      <section>
        ...
        >
          ...
          <div class="meta">
            <h2>${e.name}</h2>
            <div class="sub">${Pi(e.dateOfBirth)}</div>
            <span class="agepill"
...
`),visibility:"family",source:"pebble-weekend-plan"}),this._accepted=t,setTimeout(()=>{this._accepted=null},2200)}catch(s){this._error=(s==null?void 0:s.message)||"Could not add this plan."}}_close(){this.dispatchEvent(new Event("cancel"))}render(){return this.open?n`
  ...
  `);customElements.define("weekend-planner",ot);const Di={uid:"preview-user",displayName:"Thomas Paris",email:"thomas@example.com",photoURL:null},_t=[{uid:"thomas",displayName:"Thomas",circles:["immediate"],hue:198},{uid:"partner",displayName:"Élise",circles:["immediate"],hue:8},{uid:"kid1",displayName:"Oscar",circles:["immediate"],hue:142},{uid:"kid2",displayName:"Mila",circles:["immediate"],hue:44},{uid:"mum",displayName:"Mum",circles:["extended"],hue:320},{uid:"dad",displayName:"Dad",circles:["extended"],hue:28},{uid:"sister",displayName:"Camille",circles:["extended"],hue:280},{uid:"bro-in-law",displayName:"Sam",circles:["extended"],hue:175},{uid:"niece",displayName:"Léa",circles:["extended"],hue:100}],Fi=[{id:"t1",title:"Côte d’Azur, summer",location:"Antibes, France",start:"2026-07-12",end:"2026-07-21",coverGradient:"linear-gradient(135deg, #6b9ac4 0%, #c98a8a 60%, #d4a843 100%)",lodgingHost:"Airbnb",lodgingTitle:"Villa near Cap d’Antibes",attendees:["thomas","partner","kid1","kid2","mum","dad"],notes:"Mum + Dad arrive day 2. Dinner reservations at La Guérite booked.",visibility:"extended"},{id:"t2",title:"Half-term in the Alps",location:"Chamonix, France",start:"2026-10-24",end:"2026-10-31",coverGradient:"linear-gradient(135deg, #7a9e7e 0%, #4a6754 70%, #2c4439 100%)",lodgingHost:"Booking.com",lodgingTitle:"Chalet Les Drus",attendees:["thomas","partner","kid1","kid2"],notes:"Need ski school for the kids — book by September.",visibility:"immediate"},{id:"t3",title:"Camille’s 40th",location:"Lisbon, Portugal",start:"2026-09-05",end:"2026-09-08",coverGradient:"linear-gradient(135deg, #c67b5c 0%, #d4a843 50%, #c98a8a 100%)",lodgingHost:"Airbnb",lodgingTitle:"Alfama rooftop apartment",attendees:["thomas","partner","sister","bro-in-law"],notes:"Surprise. Don’t mention to Camille.",visibility:"family"}],Ei=[{id:"e1",type:"birthday",date:"2026-05-24",personIds:["mum"],title:"Mum’s birthday"},{id:"e2",type:"anniversary",date:"2026-05-28",personIds:["mum","dad"],title:"Mum & Dad’s anniversary",subtitle:"38 years"},{id:"e3",type:"birthday",date:"2026-06-11",personIds:["kid1"],title:"Oscar turns 7"},{id:"e4",type:"birthday",date:"2026-06-30",personIds:["niece"],title:"Léa’s birthday"}],Ot={id:"preview-felix",name:"Felix",dateOfBirth:new Date("2023-11-15"),profilePhotoURL:null,pronouns:"he",themeColorHex:"#3D9B8F",developmentalFlags:["speech and language"]},Ni=[Ot],Ri=[{id:"m15",category:"socialEmotional",title:"Social smile",status:"achieved",ageRangeStartMonths:1,ageRangeEndMonths:3,arc:"attentionToLiteracy",arcOrder:1},{id:"m16",category:"language",title:"Babbles ('ba-ba', 'da-da')",status:"achieved",ageRangeStartMonths:4,ageRangeEndMonths:7,arc:"attentionToLiteracy",arcOrder:2},{id:"m17",category:"motor",title:"Sits without support",status:"achieved",ageRangeStartMonths:6,ageRangeEndMonths:9,arc:"movementToCoordination",arcOrder:3},{id:"m18",category:"cognitive",title:"Explores cause and effect",status:"achieved",ageRangeStartMonths:8,ageRangeEndMonths:12,arc:"curiosityToReasoning",arcOrder:2},{id:"m1",category:"motor",title:"Kicks a ball forward",status:"achieved",ageRangeStartMonths:18,ageRangeEndMonths:24,arc:"movementToCoordination",arcOrder:6},{id:"m2",category:"motor",title:"Walks up stairs holding on",status:"achieved",ageRangeStartMonths:18,ageRangeEndMonths:24,arc:"movementToCoordination",arcOrder:7},{id:"m3",category:"motor",title:"Jumps with both feet off the ground",status:"emerging",ageRangeStartMonths:24,ageRangeEndMonths:30,arc:"movementToCoordination",arcOrder:8},{id:"m4",category:"motor",title:"Pedals a tricycle",status:"notStarted",ageRangeStartMonths:30,ageRangeEndMonths:36,arc:"movementToCoordination",arcOrder:9},{id:"m5",category:"language",title:"Uses two-word phrases",status:"achieved",ageRangeStartMonths:18,ageRangeEndMonths:24,arc:"attentionToLiteracy",arcOrder:5},{id:"m6",category:"language",title:"Says first name when asked",status:"emerging",ageRangeStartMonths:24,ageRangeEndMonths:30,arc:"attentionToLiteracy",arcOrder:6},{id:"m7",category:"language",title:"Names six body parts",status:"notStarted",ageRangeStartMonths:24,ageRangeEndMonths:30,arc:"attentionToLiteracy",arcOrder:7},{id:"m8",category:"language",title:"Uses three-word sentences",status:"notStarted",ageRangeStartMonths:30,ageRangeEndMonths:36,arc:"attentionToLiteracy",arcOrder:8},{id:"m19",category:"cognitive",title:"Recognizes familiar logos and print",status:"notStarted",ageRangeStartMonths:36,ageRangeEndMonths:48,arc:"attentionToLiteracy",arcOrder:9},{id:"m9",category:"socialEmotional",title:"Shows affection unprompted",status:"achieved",ageRangeStartMonths:18,ageRangeEndMonths:24,arc:"connectionToFriendship",arcOrder:3},{id:"m10",category:"socialEmotional",title:"Plays alongside other children",status:"emerging",ageRangeStartMonths:24,ageRangeEndMonths:36,arc:"connectionToFriendship",arcOrder:4},{id:"m11",category:"socialEmotional",title:"Takes turns in simple games",status:"notStarted",ageRangeStartMonths:30,ageRangeEndMonths:42,arc:"connectionToFriendship",arcOrder:5},{id:"m12",category:"cognitive",title:"Follows a two-step instruction",status:"achieved",ageRangeStartMonths:18,ageRangeEndMonths:24,arc:"curiosityToReasoning",arcOrder:4},{id:"m13",category:"cognitive",title:"Sorts objects by shape or colour",status:"emerging",ageRangeStartMonths:30,ageRangeEndMonths:36,arc:"curiosityToReasoning",arcOrder:5},{id:"m14",category:"cognitive",title:"Completes a 4-piece puzzle",status:"notStarted",ageRangeStartMonths:30,ageRangeEndMonths:36,arc:"curiosityToReasoning",arcOrder:6}],Bi=[{id:"i1",type:"strength",domain:"language",title:"Language is tracking ahead",body:"Felix is combining words earlier than the typical 24–30 month window — keep the back-and-forth conversations going.",relevanceScore:.95},{id:"i2",type:"connection",domain:"cross",title:"Fine-motor + sorting → pre-literacy",body:"A strong pincer grip alongside early sorting is a classic pre-literacy signal. Picture books with pointing build on both at once.",relevanceScore:.82},{id:"i3",type:"nudge",domain:"language",title:"Narrate your daily routine",body:'"Now we are washing hands… water on… soap…" — Felix is ready for longer sentence models during everyday moments.',relevanceScore:.7}],Li={id:"2026-05-16",title:"Felix is stringing two words together",body:'You have logged "more milk" and "Daddy go" this week — early two-word speech, right on the edge of the 24–30 month window. Narrating your routine out loud is the single best way to grow sentence length from here.',topicForChat:"How can I support Felix's two-word speech?"},Oi={id:"2026-05-16",title:"Busy Saturday, water shoes for Felix",body:"Splash day at the park this morning, both kids back to routine by nap.",topicForChat:"What should we prep tonight for tomorrow?",mode:"brief",generatedAt:{toMillis:()=>new Date().setHours(6,14,0,0)},bullets:[{kind:"plan",text:"Splash day at 10. Park sprinklers are on for the morning."},{kind:"weather",text:"74°F and sunny. Sun hats for both kids."},{kind:"packing",text:"Felix's water shoes still unchecked on the bag list."},{kind:"coordinate",text:"Ellie is on pickup. You packed the towels last night."}]},ji=[{id:"p1",role:"user",content:"Felix isn't saying many words yet — should I be worried at 2.5?",senderUid:"partner"},{id:"p2",role:"assistant",content:"At 2½, every child's pace differs. From your logs Felix **uses two-word phrases** and follows two-step instructions — both strong signs. A few practical things to try, and a clear marker for when to mention it at his check-up."},{id:"p3",role:"user",content:"Any toddler-friendly ideas for a rainy weekend?",senderUid:"thomas"},{id:"p4",role:"assistant",content:"Rainy days are great for the kind of close-up play that grows language fastest at this stage. A few ideas matched to where Felix is right now."}];class lt extends T{constructor(){super(),this.user=Di,this.pebbleUser=null,this.family=null,this.children=[],this.trips=[],this.events=[],this.activities=[],this.holidays=[],this._connectionMembers=[],this._connKey="",this.ppFamily=null,this.ppIsMember=!1,this.ppChildren=[],this.selectedChildId=null,this.childMilestones=[],this.childInsights=[],this.childDailyCard=null,this.familyDailyCard=null,this.pebbleAnchors=[],this.pebbleRhythms=[],this.pebblePatterns=[],this.pebbleLiveContext=[],this._wpkExpanded=new Set,this.childPebbleMessages=[],this.childPebbleSessions=[],this.planningMessages=[],this.pebbleQuota=null,this.ppIsChildViewer=!1,this.incomingChildRequests=[],this.myChildAccessRequest=null,this._claimingChildId=null,this._claimedChildName=null,this._joinAnotherCode="",this._joinAnotherBusy=!1,this._joinAnotherError="",this._joinAnotherSuccessName="",this._pebblePrefill="",this._plannerOpen=!1,this._plannerTrip=null,this.preview=!1,this.circle="extended",this._activeTab="today",this._refreshingFamilyBrief=!1,this._autoBriefAttempted=!1,this._weekendOpen=!1,this._wpkOpen=!1,this._packingTemplates=[],this._formOpen=!1,this._formTrip=null,this._formBusy=!1,this._membersOpen=!1,this._eventFormOpen=!1,this._eventFormEvent=null,this._eventFormBusy=!1,this._activityFormOpen=!1,this._activityFormActivity=null,this._activityFormBusy=!1,this._allTripsOpen=!1,this._editingFamilyName=!1,this._importOpen=!1,this._schoolImportOpen=!1,this._profileOpen=!1,this._typePickerOpen=!1,this._formMode="trip",this._pebbleFabOpen=!1,this._themeLight=typeof document<"u"&&document.documentElement.classList.contains("theme-light"),this._dragOverTarget=null;const e=new Date;this._displayMonth=new Date(e.getFullYear(),e.getMonth(),1),this._calendarView="week";const t=new Date(e);t.setHours(0,0,0,0),this._displayWeekStart=new Date(t),this._displayWeekStart.setDate(t.getDate()-t.getDay()),this._calFilters={trip:!0,holiday:!0,event:!0,celebrate:!0},this._managingTags=!1,this._tagRenaming=null,this._tagRenameDraft="",this._tagDeleting=null}_onJoinAnotherCodeInput(e){var a;const t=(((a=e.target)==null?void 0:a.value)??"").toString(),i=t.toUpperCase().replace(/[^A-Z0-9]/g,"").slice(0,6);i!==t&&(e.target.value=i),this._joinAnotherCode=i,this._joinAnotherError&&(this._joinAnotherError="")}async _attemptJoinAnotherFamily(){var t;const e=(this._joinAnotherCode??"").trim();if(!(e.length!==6||this._joinAnotherBusy)){this._joinAnotherBusy=!0,this._joinAnotherError="",this._joinAnotherSuccessName="";try{const i=await v.findFamilyByConnectCode(e);if(!i){this._joinAnotherError="Couldn't find that family. Double-check the code with whoever invited you.";return}const a=i.name||"the family";await v.redeemConnectCode(e),this._joinAnotherSuccessName=a,y(`Joined ${a}.`),this._joinAnotherCode=""}catch(i){console.error("Join another family failed:",i),this._joinAnotherError=((t=i==null?void 0:i.message)==null?void 0:t.replace(/^Error:\s*/,""))??"Couldn't join — double-check the code with whoever invited you."}finally{this._joinAnotherBusy=!1}}}async _saveFamilyName(e){var r,s;const i=(e.target.value??"").trim(),a=((r=this.family)==null?void 0:r.name)??"";if(i&&i!==a&&((s=this.family)!=null&&s.id))try{const{db:o,doc:d,updateDoc:l,serverTimestamp:c}=await K(async()=>{const{db:p,doc:h,updateDoc:u,serverTimestamp:m}=await Promise.resolve().then(()=>ci);return{db:p,doc:h,updateDoc:u,serverTimestamp:m}},void 0);await l(d(o,"families",this.family.id),{name:i,updatedAt:c()}),y("Family name updated.")}catch(o){console.error("Update family name failed:",o),y(`Couldn't save: ${o.code??o.message}`,{duration:5e3})}this._editingFamilyName=!1}_liveImmediate(){var e;return this.preview||!((e=this.user)!=null&&e.uid)?_t.filter(t=>t.circles.includes("immediate")):mi(this.user.uid,this.user,this.pebbleUser,this.family,this.children)}_liveExtended(){var e;return this.preview?_t.filter(t=>t.circles.includes("extended")):gi((e=this.user)==null?void 0:e.uid,this.family,this.children)}_liveConnections(){return this.preview?[]:this._connectionMembers??[]}async _refreshConnectionMembers(){var e;if(this.preview||!this.family){this._connectionMembers=[];return}try{this._connectionMembers=await ui((e=this.user)==null?void 0:e.uid,this.family)}catch{this._connectionMembers=[]}}updated(e){var t,i;if(e.has("family")){const a=Array.isArray((t=this.family)==null?void 0:t.connectedFamilyIds)?this.family.connectedFamilyIds:[],r=`${((i=this.family)==null?void 0:i.id)??""}|${[...a].sort().join(",")}`;r!==this._connKey&&(this._connKey=r,this._refreshConnectionMembers())}e.has("_activeTab")&&(this._positionTabSlider({animate:!0}),this._activeTab!=="cairn"&&this._wpkOpen&&(this._wpkOpen=!1))}_liveTrips(){return this.preview?Fi:this.trips??[]}_liveEvents(){if(this.preview)return Ei;const e=a=>{const{date:r,yearsElapsed:s}=ht(a);return{...a,date:r?ee(r):a.date,_yearsElapsed:s,_originalDate:a.date}},t=fi(this.children).map(e),i=(this.events??[]).map(e);return[...t,...i].sort((a,r)=>String(a.date).localeCompare(String(r.date)))}_filteredMembers(){const e=this._liveImmediate(),t=this._liveExtended();return this.circle==="personal"?e.filter(i=>{var a;return i.uid===((a=this.user)==null?void 0:a.uid)}):this.circle==="family"?e:[...e,...t]}_circleTrips(){var s;const e=this._liveTrips(),t=((s=this.user)==null?void 0:s.uid)??"thomas";let i;this.circle==="personal"?i=e.filter(o=>{var d;return(d=o.attendees)==null?void 0:d.includes(t)}):this.circle==="family"?i=e.filter(o=>o.visibility!=="extended"&&this._userCanSeeTrip(o)):i=e.filter(o=>this._userCanSeeTrip(o));const a=new Set,r=[];for(const o of i){const d=o.id??`${o.title}|${o.start}|${o.end}`;a.has(d)||(a.add(d),r.push(o))}return r}_filteredTrips(){const e=new Date;return e.setHours(0,0,0,0),this._circleTrips().filter(t=>t.end?A(t.end)>=e:!0)}_userCanSeeTrip(e){var d,l,c,p,h,u;const t=(d=this.user)==null?void 0:d.uid;if(!t)return!1;if((l=e.attendees)!=null&&l.includes(t)||(c=e.viewers)!=null&&c.includes(t))return!0;const i=((p=this.family)==null?void 0:p.memberIds)??[],a=((h=this.family)==null?void 0:h.cairnMemberIds)??i,r=i.includes(t),s=a.includes(t);if(r)return!0;if(!s)return!1;const o=e.visibility||"family";if(o==="personal")return!1;if(o==="family")return!0;if(o==="extended"){const m=e.targetSubGroups??[];if(m.length===0)return!0;const x=Object.entries(((u=this.family)==null?void 0:u.subGroups)??{}).filter(([,f])=>(f.memberIds??[]).includes(t)).map(([f])=>f);return m.some(f=>x.includes(f))}return!1}_filteredEvents(){const e=new Set(this._filteredMembers().map(t=>t.uid));return this._liveEvents().filter(t=>(Array.isArray(t==null?void 0:t.personIds)?t.personIds:[]).some(a=>e.has(a)))}_standaloneActivities(){return(this.activities??[]).filter(e=>!(e!=null&&e.tripId)&&this._tagVisible(e))}_calendarActivities(){return(this.activities??[]).filter(e=>e&&this._tagVisible(e))}_smartCallout(){var o;const e=new Date,t=new Date(e.getFullYear(),e.getMonth(),e.getDate()),i=1440*60*1e3,a=d=>Math.round((d-t)/i);let r=null,s=1/0;for(const d of this._circleTrips()){if(!d.start)continue;const l=A(d.start);if(!l)continue;const c=a(l);c>0&&c<s&&(r={kind:"trip",item:d},s=c)}for(const d of this._filteredEvents()){if(!d.date)continue;const l=A(d.date);if(!l)continue;const c=a(l);c>=0&&c<s&&(r={kind:"event",item:d},s=c)}if(!r)return null;if(r.kind==="trip"){const d=((o=r.item.location)==null?void 0:o.trim())||r.item.title;return s===1?`${d} starts tomorrow.`:s<=14?`${d} in ${s} days.`:s<=60?`Next trip: ${d} in ${s} days.`:null}return s===0?`${r.item.title} — today.`:s===1?`${r.item.title} — tomorrow.`:s<=7?`${r.item.title} in ${s} days.`:null}_tripDensityByDay(e){const t=new Map;for(const i of this._filteredTrips()){if(!i.start||!i.end)continue;const a=A(i.start),r=A(i.end);if(Number.isNaN(a.getTime())||Number.isNaN(r.getTime())||a.getFullYear()>e||r.getFullYear()<e)continue;const s=new Date(Math.max(a,new Date(e,0,1))),o=new Date(Math.min(r,new Date(e,11,31)));for(;s<=o;){const d=`${String(s.getMonth()+1).padStart(2,"0")}-${String(s.getDate()).padStart(2,"0")}`;t.set(d,Math.min(1,(t.get(d)??0)+.5)),s.setDate(s.getDate()+1)}}return t}_shiftMonth(e){const t=this._displayMonth;this._displayMonth=new Date(t.getFullYear(),t.getMonth()+e,1)}_jumpToMonth(e,t){this._displayMonth=new Date(e,t,1)}_resetToToday(){const e=new Date;this._displayMonth=new Date(e.getFullYear(),e.getMonth(),1)}_openCreate(){if(this.preview){y("Sign in to create real activities.");return}if(!v.familyId){y("You need a PebblePath family first.");return}this._typePickerOpen=!0}_onTypePicked(e){this._typePickerOpen=!1;const t=e.detail.type;if(t==="event"){this._eventFormEvent=null,this._eventFormOpen=!0;return}if(t==="import"){this._importOpen=!0;return}if(t==="activity"){this._openNewActivity();return}this._formMode="trip",this._formTrip=null,this._formOpen=!0}_openPlanner(e){this._plannerTrip=e,this._plannerOpen=!0,this._activeTab="activities",this.updateComplete.then(()=>{requestAnimationFrame(()=>requestAnimationFrame(()=>{var i;const t=(i=this.renderRoot)==null?void 0:i.querySelector("trip-planner");t==null||t.scrollIntoView({behavior:"smooth",block:"start"})}))})}_onOpenTripPlannerFromImport(e){var a;const t=(a=e==null?void 0:e.detail)==null?void 0:a.tripId;if(!t)return;this._importOpen=!1;const i=(v.state.trips??[]).find(r=>r.id===t);i&&requestAnimationFrame(()=>this._openPlanner(i))}_openEdit(e){if(this.preview){y("Sign in to edit real activities.");return}const t=e.lodgingUrl||e.lodgingHost||e.flightNumber||e.flightDepartAirport;this._formMode=t?"trip":"activity",this._formTrip=e,this._formOpen=!0}async _onSaveTrip(e){const t=e.detail;this._formBusy=!0;try{await v.saveTrip(t),this._formOpen=!1,this._formTrip=null,y(t.id?"Trip updated.":"Trip created.")}catch(i){console.error("Save trip failed:",i),y(`Couldn't save: ${i.code??i.message}`,{duration:5e3})}finally{this._formBusy=!1}}async _onDeleteTrip(e){this._formBusy=!0;try{await v.deleteTrip(e.detail.id),this._formOpen=!1,this._formTrip=null,y("Trip deleted.")}catch(t){console.error("Delete trip failed:",t),y(`Couldn't delete: ${t.code??t.message}`,{duration:5e3})}finally{this._formBusy=!1}}_openCreateEvent(){if(this.preview){y("Sign in to add real events.");return}if(!v.familyId){y("You need a family first.");return}this._eventFormEvent=null,this._eventFormOpen=!0}_openEditEvent(e){if(this.preview){y("Sign in to edit real events.");return}if(e!=null&&e._childId){const t=prompt(`Edit ${e._childName}'s birthday (YYYY-MM-DD):`,e.date);if(!t)return;if(!/^\d{4}-\d{2}-\d{2}$/.test(t)){y("Use YYYY-MM-DD format.");return}v.updateChildBirthday(e._childId,new Date(t)).then(()=>y(`Updated ${e._childName}'s birthday.`)).catch(i=>{console.error("Update child birthday failed:",i),y(`Couldn't update: ${i.code??i.message}`,{duration:5e3})});return}this._eventFormEvent={...e,date:e._originalDate??e.date},this._eventFormOpen=!0}async _onSaveEvent(e){this._eventFormBusy=!0;try{await v.saveEvent(e.detail),this._eventFormOpen=!1,this._eventFormEvent=null,y(e.detail.id?"Event updated.":"Event added.")}catch(t){console.error("Save event failed:",t),y(`Couldn't save: ${t.code??t.message}`,{duration:5e3})}finally{this._eventFormBusy=!1}}async _onDeleteEvent(e){this._eventFormBusy=!0;try{await v.deleteEvent(e.detail.id),this._eventFormOpen=!1,this._eventFormEvent=null,y("Event deleted.")}catch(t){console.error("Delete event failed:",t),y(`Couldn't delete: ${t.code??t.message}`,{duration:5e3})}finally{this._eventFormBusy=!1}}_openNewActivity(){if(this.preview){y("Sign in to create real activities.");return}if(!v.familyId){y("You need a family first.");return}this._activityFormActivity=null,this._activityFormOpen=!0}_openEditActivity(e){if(this.preview){y("Sign in to edit real activities.");return}this._activityFormActivity={...e},this._activityFormOpen=!0}async _onSaveActivity(e){this._activityFormBusy=!0;try{await v.saveActivity(e.detail),this._activityFormOpen=!1,this._activityFormActivity=null,y(e.detail.id?"Activity updated.":"Activity added.")}catch(t){console.error("Save activity failed:",t),y(`Couldn't save: ${t.code??t.message}`,{duration:5e3})}finally{this._activityFormBusy=!1}}async _onDeleteActivity(e){this._activityFormBusy=!0;try{await v.deleteActivity(e.detail.id),this._activityFormOpen=!1,this._activityFormActivity=null,y("Activity deleted.")}catch(t){console.error("Delete activity failed:",t),y(`Couldn't delete: ${t.code??t.message}`,{duration:5e3})}finally{this._activityFormBusy=!1}}get _pebbleAvailable(){return this.preview||this.ppIsMember||this.ppIsChildViewer||!!this.family}_tabDefs(){const e={id:"pebble",label:"Pebble",icon:n`<pebble-icon></pebble-icon>`};return[{id:"today",label:"Today",icon:n`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12l9-9 9 9" /><path d="M5 10v10h14V10" /></svg>`},{id:"children",label:"Children",icon:n`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="4" /><path d="M5 21c0-4 3-6 7-6s7 2 7 6" /></svg>`},...this._pebbleAvailable?[e]:[],{id:"activities",label:"Activities",icon:n`<span
    ...
    `}render(){var a,r,s,o,d,l,c,p;const e=this._liveImmediate(),t=this._liveExtended(),i=e.concat(t);return n`
      <div class="topbar">
        <div class="brand">
          <img
            class="brand-icon"
    ...
    `}_nextUpcomingTrip(){const e=new Date,t=new Date(e.getFullYear(),e.getMonth(),e.getDate());let i=null,a=1/0;for(const r of this._circleTrips()){const s=A(r.start);!s||(A(r.end)??s)<t||s.getTime()<a&&(i=r,a=s.getTime())}return i}_fmtTripRange(e){const t=A(e.start);if(!t)return"";const i=A(e.end)??t,a={month:"short",day:"numeric"},r=t.toLocaleDateString(void 0,a);if(i.getTime()===t.getTime())return r;const o=t.getMonth()===i.getMonth()&&t.getFullYear()===i.getFullYear()?String(i.getDate()):i.toLocaleDateString(void 0,a);return`${r} – ${o}`}_renderNextTripCard(){const e=()=>{this._activeTab="activities"},t=this._nextUpcomingTrip();if(!t)return n`<button
      ...
      </button>`;const i=t.previewImage&&String(t.previewImage).trim()||t.coverImage,a=i?`background-image: url("${i}"); background-position: center center; background-size: cover;`:`background: ${Rt(t)};`;return n`<button
