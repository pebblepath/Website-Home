var gt=Object.defineProperty;var mt=(d,e,t)=>e in d?gt(d,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):d[e]=t;var b=(d,e,t)=>mt(d,typeof e!="symbol"?e+"":e,t);import{i as D,a as S,b as s}from"./lit-2GpawzfI.js";import{f as ft,h as bt,j as vt,G as Be,O as yt,k as xt,s as wt,l as Qe,m as _t,n as kt,o as $t,q as Ct,t as A,v as M,w as z,x as zt,y as X,z as oe,A as G,B as ne,D as le,E as W,H as de,I as me}from"./firebase-core-WlNQdXp3.js";import{g as Dt,h as ce}from"./firebase-functions-EPI35Sfs.js";import{g as St,r as et,u as tt,a as it}from"./firebase-storage-BMyqKy67.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const a of r)if(a.type==="childList")for(const n of a.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(r){const a={};return r.integrity&&(a.integrity=r.integrity),r.referrerPolicy&&(a.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?a.credentials="include":r.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(r){if(r.ep)return;r.ep=!0;const a=t(r);fetch(r.href,a)}})();class fe extends D{constructor(){super(),this.variant="default",this.lifted=!1,this.padding="md"}render(){const e=["panel",this.variant==="strong"?"strong":"",this.lifted?"lifted":"",`pad-${this.padding}`].filter(Boolean).join(" ");return s`
  ...
  `);customElements.define("cairn-mark",ve);const At="modulepreload",Et=function(d){return"/cairn/"+d},He={},rt=function(e,t,i){let r=Promise.resolve();if(t&&t.length>0){let n=function(c){return Promise.all(c.map(h=>Promise.resolve(h).then(p=>({status:"fulfilled",value:p}),p=>({status:"rejected",reason:p}))))};document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),l=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));r=n(t.map(c=>{if(c=Et(c),c in He)return;He[c]=!0;const h=c.endsWith(".css"),p=h?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${p}`))return;const u=document.createElement("link");if(u.rel=h?"stylesheet":At,h||(u.as="script"),u.crossOrigin="",u.href=c,l&&u.setAttribute("nonce",l),document.head.appendChild(u),h)return new Promise((_,f)=>{u.addEventListener("load",_),u.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${c}`)))})}))}function a(n){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=n,window.dispatchEvent(o),!o.defaultPrevented)throw n}return r.then(n=>{for(const o of n||[])o.status==="rejected"&&a(o.reason);return e().catch(a)})},ye={apiKey:"AIzaSyA6NKZNLVBeeLrXcLJSXus5M832AxpI2wk",authDomain:"pebblepath-992b6.firebaseapp.com",projectId:"pebblepath-992b6",storageBucket:"pebblepath-992b6.firebasestorage.app",messagingSenderId:"497141667291",appId:"1:497141667291:web:ee84c186db54389d10c3fe"},N=!!(ye.apiKey&&ye.projectId),V=N?ft(ye):null,w=N?bt(V):null,y=N?vt(V):null,Y=N?Dt(V,"us-central1"):null,xe=N?St(V):null,we=N?new Be:null;we&&we.setCustomParameters({prompt:"select_account"});const ue=N?new Be:null;ue&&ue.addScope("https://www.googleapis.com/auth/calendar.readonly");let pe=null,_e=0;async function at(){if(!w||!ue)throw new Error("Firebase not configured.");if(pe&&Date.now()<_e-6e4)return pe;const d=w.currentUser;if(!d)throw new Error("Please sign in before importing your calendar.");if(!(d.providerData??[]).some(a=>a.providerId==="google.com")){const a=new Error("Calendar import needs a Google account. You're signed in another way, so Cairn can't read your Google Calendar here yet — add events manually for now.");throw a.code="calendar/needs-google-account",a}let t;try{t=await xt(d,ue)}catch(a){if((a==null?void 0:a.code)==="auth/user-mismatch"){const n=new Error("Please choose the same Google account you use to sign in to Cairn.");throw n.code=a.code,n}if((a==null?void 0:a.code)==="auth/popup-closed-by-user"||(a==null?void 0:a.code)==="auth/cancelled-popup-request"){const n=new Error("Calendar connection cancelled.");throw n.code=a.code,n}throw a}const i=Be.credentialFromResult(t),r=i==null?void 0:i.accessToken;if(!r)throw new Error("Couldn't get a Calendar access token — try again.");return pe=r,_e=Date.now()+3600*1e3,r}function Ft(){pe=null,_e=0}function ee(){if(!w)throw new Error("Firebase not configured — fill in .env first.");return Qe(w,we)}const te=N?new yt("apple.com"):null;te&&(te.addScope("email"),te.addScope("name"));function he(){if(!w||!te)throw new Error("Firebase not configured — fill in .env first.");return Qe(w,te)}function st(d,e){if(!w)throw new Error("Firebase not configured.");return $t(w,d,e)}async function ot(d,e,t){if(!w)throw new Error("Firebase not configured.");const i=await _t(w,d,e);if(t&&t.trim())try{await kt(i.user,{displayName:t.trim()})}catch{}return i}function nt(d){if(!w)throw new Error("Firebase not configured.");return Ct(w,d)}function lt(){return w?wt(w):Promise.resolve()}function dt(d){return w?zt(w,d):(d(null),()=>{})}const It=Object.freeze(Object.defineProperty({__proto__:null,addDoc:de,app:V,auth:w,clearCalendarToken:Ft,collection:G,connectGoogleCalendar:at,db:y,deleteDoc:me,doc:A,firebaseApp:V,functions:Y,getDocs:le,getDownloadURL:it,httpsCallable:ce,isConfigured:N,onAuth:dt,onSnapshot:X,query:oe,sendPasswordReset:nt,serverTimestamp:z,setDoc:W,signIn:ee,signInWithApple:he,signInWithEmail:st,signOutUser:lt,signUpWithEmail:ot,storage:xe,storageRef:et,updateDoc:M,uploadBytes:tt,where:ne},Symbol.toStringTag,{value:"Module"}));class Nt extends EventTarget{constructor(){super(),this.state={user:null,family:null,children:[],trips:[],events:[]},this._uid=null,this._unsubUser=null,this._unsubFamily=null,this._unsubChildren=null,this._unsubTrips=null,this._unsubEvents=null,this._currentFamilyId=null,this.userDocResolved=!1}get familyId(){return this._currentFamilyId}start(e){!y||!e||this._uid!==e&&(this.stop(),this._uid=e,this._unsubUser=X(A(y,"users",e),t=>{var r,a,n,o,l,c;this.userDocResolved=!0,this.state.user=t.exists()?{id:t.id,...t.data()}:null;const i=((r=this.state.user)==null?void 0:r.cairnFamilyId)??((a=this.state.user)==null?void 0:a.familyId)??null;!i&&this.state.user&&this._healFamilyPointer(e),i!==this._currentFamilyId&&(this._currentFamilyId=i,(n=this._unsubFamily)==null||n.call(this),(o=this._unsubChildren)==null||o.call(this),(l=this._unsubTrips)==null||l.call(this),(c=this._unsubEvents)==null||c.call(this),this._unsubFamily=null,this._unsubChildren=null,this._unsubTrips=null,this._unsubEvents=null,this.state.family=null,this.state.children=[],this.state.trips=[],this.state.events=[],i&&this._subscribeFamily(i)),this._emit()}))}async _healFamilyPointer(e){if(!this._healing){this._healing=!0;try{const t=oe(G(y,"families"),ne("cairnMemberIds","array-contains",e)),i=await le(t);if(!i.empty){await W(A(y,"users",e),{cairnFamilyId:i.docs[0].id,updatedAt:z()},{merge:!0});return}const r=oe(G(y,"families"),ne("memberIds","array-contains",e)),a=await le(r);a.empty||await W(A(y,"users",e),{familyId:a.docs[0].id,updatedAt:z()},{merge:!0})}catch(t){console.warn("[Cairn] auto-heal family pointer failed:",t==null?void 0:t.code,t==null?void 0:t.message)}finally{this._healing=!1}}}_subscribeFamily(e){this._unsubFamily=X(A(y,"families",e),t=>{this.state.family=t.exists()?{id:t.id,...t.data()}:null,this._emit()}),this._unsubChildren=X(G(y,"families",e,"children"),t=>{this.state.children=t.docs.map(i=>{var a,n;const r=i.data();return{id:i.id,...r,dateOfBirth:((n=(a=r.dateOfBirth)==null?void 0:a.toDate)==null?void 0:n.call(a))??(r.dateOfBirth?new Date(r.dateOfBirth):null)}}),this._emit()}),this._unsubTrips=X(G(y,"families",e,"trips"),t=>{this.state.trips=t.docs.map(i=>{var a,n,o,l;const r=i.data();return{id:i.id,...r,start:r.start??"",end:r.end??"",createdAt:((n=(a=r.createdAt)==null?void 0:a.toDate)==null?void 0:n.call(a))??null,updatedAt:((l=(o=r.updatedAt)==null?void 0:o.toDate)==null?void 0:l.call(o))??null}}).sort((i,r)=>String(i.start).localeCompare(String(r.start))),this._emit()},t=>{console.warn("[Cairn] trips subscription error:",t.code,t.message)}),this._unsubEvents=X(G(y,"families",e,"familyEvents"),t=>{this.state.events=t.docs.map(i=>{var a,n,o,l;const r=i.data();return{id:i.id,...r,date:r.date??"",createdAt:((n=(a=r.createdAt)==null?void 0:a.toDate)==null?void 0:n.call(a))??null,updatedAt:((l=(o=r.updatedAt)==null?void 0:o.toDate)==null?void 0:l.call(o))??null}}),this._emit()},t=>{console.warn("[Cairn] familyEvents subscription error:",t.code,t.message)})}async saveTrip(e){var c;if(!y||!this._currentFamilyId)throw new Error("No family yet.");const t=(c=w==null?void 0:w.currentUser)==null?void 0:c.uid;if(!t)throw new Error("Not signed in.");const{id:i,createdAt:r,updatedAt:a,...n}=e,o={...n,updatedAt:z()};return i?(await M(A(y,"families",this._currentFamilyId,"trips",i),o),i):(o.createdBy=t,o.createdAt=z(),(await de(G(y,"families",this._currentFamilyId,"trips"),o)).id)}async deleteTrip(e){if(!y||!this._currentFamilyId)throw new Error("No family yet.");await me(A(y,"families",this._currentFamilyId,"trips",e))}async saveEvent(e){var c;if(!y||!this._currentFamilyId)throw new Error("No family yet.");const t=(c=w==null?void 0:w.currentUser)==null?void 0:c.uid;if(!t)throw new Error("Not signed in.");const{id:i,createdAt:r,updatedAt:a,...n}=e,o={...n,updatedAt:z()};return i?(await M(A(y,"families",this._currentFamilyId,"familyEvents",i),o),i):(o.createdBy=t,o.createdAt=z(),(await de(G(y,"families",this._currentFamilyId,"familyEvents"),o)).id)}async deleteEvent(e){if(!y||!this._currentFamilyId)throw new Error("No family yet.");await me(A(y,"families",this._currentFamilyId,"familyEvents",e))}async previewUrl(e){if(!e||typeof e!="string"||!/^https?:\/\//i.test(e.trim()))return null;if(!Y)throw new Error("Firebase functions not configured.");return(await ce(Y,"previewUrl")({url:e.trim()})).data}async lookupFlight(e,t){if(!e||typeof e!="string")return null;if(!Y)throw new Error("Firebase functions not configured.");return(await ce(Y,"lookupFlight")({flightNumber:e.trim(),date:typeof t=="string"?t.trim():""})).data}async askPebble(e,t=[]){if(!Y)throw new Error("Firebase functions not configured.");if(!this._currentFamilyId)throw new Error("No family yet.");return(await ce(Y,"askPebbleAboutActivities")({question:e,familyId:this._currentFamilyId,history:t})).data}async updateChildBirthday(e,t){if(!y||!this._currentFamilyId)throw new Error("No family yet.");await M(A(y,"families",this._currentFamilyId,"children",e),{dateOfBirth:t,updatedAt:z()})}async findFamilyByCairnCode(e){if(!y)throw new Error("Firebase not configured.");const t=oe(G(y,"families"),ne("cairnInviteCode","==",e)),i=await le(t);if(i.empty)return null;const r=i.docs[0];return{id:r.id,...r.data()}}async joinFamilyAsCairn(e){var p,u,_;if(!y)throw new Error("Firebase not configured.");const t=(p=w==null?void 0:w.currentUser)==null?void 0:p.uid;if(!t)throw new Error("Not signed in.");const i=await this.findFamilyByCairnCode(e);if(!i){const f=new Error("Invite code not found.");throw f.code="not-found",f}const r=((_=(u=i.cairnInviteCodeExpiresAt)==null?void 0:u.toDate)==null?void 0:_.call(u))??(i.cairnInviteCodeExpiresAt?new Date(i.cairnInviteCodeExpiresAt):null);if(!r||r<new Date){const f=new Error("This invite code has expired.");throw f.code="expired",f}const a=i.cairnMemberIds??[],n=i.memberIds??[],o=w.currentUser;if(a.includes(t)||n.includes(t))return await W(A(y,"users",t),{email:o.email??"",displayName:o.displayName??"",profilePhotoURL:o.photoURL??null,cairnFamilyId:i.id,updatedAt:z()},{merge:!0}),i.id;const l=i.cairnMaxMembers??20;if(a.length>=l){const f=new Error("This family's Cairn ring is full.");throw f.code="full",f}const c=new Date,h={displayName:o.displayName??"",profilePhotoURL:o.photoURL??null,role:"member",joinedAt:c,updatedAt:c};return await M(A(y,"families",i.id),{cairnMemberIds:[...a,t],[`memberProfiles.${t}`]:h,updatedAt:z()}),await W(A(y,"users",t),{email:o.email??"",displayName:o.displayName??"",profilePhotoURL:o.photoURL??null,cairnFamilyId:i.id,role:"member",notificationPreferences:{milestoneReminders:!0,tipNotifications:!0,schoolDeadlines:!0},createdAt:z(),updatedAt:z()},{merge:!0}),i.id}async saveSubGroup({id:e,name:t,memberIds:i}){if(!y||!this._currentFamilyId)throw new Error("No family yet.");const r=e??`g_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,6)}`;return await M(A(y,"families",this._currentFamilyId),{[`subGroups.${r}`]:{name:t.trim(),memberIds:Array.isArray(i)?[...i]:[],updatedAt:z()},updatedAt:z()}),r}async deleteSubGroup(e){if(!y||!this._currentFamilyId)throw new Error("No family yet.");const{deleteField:t}=await rt(async()=>{const{deleteField:i}=await import("./firebase-core-WlNQdXp3.js").then(r=>r.J);return{deleteField:i}},[]);await M(A(y,"families",this._currentFamilyId),{[`subGroups.${e}`]:t(),updatedAt:z()})}async setCairnMemberSubGroup(e,t){var a;if(!y||!this._currentFamilyId)throw new Error("No family yet.");if(!e)throw new Error("uid is required.");const i=((a=this.state.family)==null?void 0:a.subGroups)??{},r={};for(const[n,o]of Object.entries(i)){const l=Array.isArray(o.memberIds)?o.memberIds:[];n===t?l.includes(e)||(r[`subGroups.${n}.memberIds`]=[...l,e]):l.includes(e)&&(r[`subGroups.${n}.memberIds`]=l.filter(c=>c!==e))}Object.keys(r).length!==0&&(r.updatedAt=z(),await M(A(y,"families",this._currentFamilyId),r))}async createCairnOnlyFamily(e){if(!y)throw new Error("Firebase not configured.");const t=w==null?void 0:w.currentUser,i=t==null?void 0:t.uid;if(!i)throw new Error("Not signed in.");const r=(e??"").trim();if(!r)throw new Error("Family name is required.");const a=new Date,n=Je(),o=new Date(Date.now()+720*60*60*1e3),l={displayName:t.displayName??"",profilePhotoURL:t.photoURL??null,role:"admin",joinedAt:a,updatedAt:a},c={name:r,createdBy:i,createdInApp:"cairn",memberIds:[],cairnMemberIds:[i],cairnMaxMembers:20,cairnInviteCode:n,cairnInviteCodeExpiresAt:o,memberProfiles:{[i]:l},createdAt:z(),updatedAt:z()},h=await de(G(y,"families"),c);return await W(A(y,"users",i),{email:t.email??"",displayName:t.displayName??"",profilePhotoURL:t.photoURL??null,cairnFamilyId:h.id,role:"admin",notificationPreferences:{milestoneReminders:!1,tipNotifications:!1,schoolDeadlines:!1},createdAt:z(),updatedAt:z()},{merge:!0}),h.id}async regenerateCairnInviteCode(){if(!y||!this._currentFamilyId)throw new Error("No family yet.");const e=Je(),t=new Date(Date.now()+720*60*60*1e3);return await M(A(y,"families",this._currentFamilyId),{cairnInviteCode:e,cairnInviteCodeExpiresAt:t,updatedAt:z()}),{code:e,expiresAt:t}}stop(){var e,t,i,r,a;(e=this._unsubUser)==null||e.call(this),(t=this._unsubFamily)==null||t.call(this),(i=this._unsubChildren)==null||i.call(this),(r=this._unsubTrips)==null||r.call(this),(a=this._unsubEvents)==null||a.call(this),this._unsubUser=this._unsubFamily=this._unsubChildren=this._unsubTrips=this._unsubEvents=null,this._uid=null,this._currentFamilyId=null,this.userDocResolved=!1,this.state={user:null,family:null,children:[],trips:[],events:[]}}_emit(){this.dispatchEvent(new Event("change"))}}const k=new Nt;function ct(d,e){const t=e==null?void 0:e.profilePhotoURL;return typeof t=="string"&&/^https?:\/\//i.test(t)?t:d!=null&&d.photoURL?d.photoURL:null}function Tt(d,e){if(!e)return[];const t=e.cairnMemberIds??e.memberIds??[],i=e.memberIds??[],r=e.memberProfiles??{},a=[];let n=280;for(const o of t){if(i.includes(o)||o===d)continue;const l=r[o],c=l==null?void 0:l.profilePhotoURL;a.push({uid:o,displayName:(l==null?void 0:l.displayName)??"Family",photoURL:typeof c=="string"&&/^https?:\/\//i.test(c)?c:null,role:"extended",circles:["extended"],hue:n}),n=(n+47)%360}return a}function Je(){const d="ABCDEFGHJKLMNPQRSTUVWXYZ23456789";let e="CAIRN-";for(let t=0;t<4;t++)e+=d[Math.floor(Math.random()*d.length)];return e}function Pt(d,e,t,i,r){const a=[],n=new Set((i==null?void 0:i.memberIds)??[]),o=n.has(d);a.push({uid:d,displayName:(e==null?void 0:e.displayName)??(t==null?void 0:t.displayName)??"You",photoURL:ct(e,t),role:o?"self":"self-extended",circles:["immediate"],hue:198});const l=(i==null?void 0:i.memberProfiles)??{};for(const[h,p]of Object.entries(l)){if(h===d||!n.has(h))continue;const u=p.profilePhotoURL;a.push({uid:h,displayName:p.displayName??"Co-parent",photoURL:typeof u=="string"&&/^https?:\/\//i.test(u)?u:null,role:"co-parent",circles:["immediate"],hue:8})}let c=142;for(const h of r??[]){const p=h.profilePhotoURL;a.push({uid:`child:${h.id}`,displayName:h.name,photoURL:typeof p=="string"&&/^https?:\/\//i.test(p)?p:null,role:"child",circles:["immediate"],hue:c,dateOfBirth:h.dateOfBirth}),c=(c+58)%360}return a}function Mt(d){const e=[];for(const t of d??[]){if(!t.dateOfBirth)continue;const i=t.dateOfBirth,r=i.getUTCFullYear(),a=String(i.getUTCMonth()+1).padStart(2,"0"),n=String(i.getUTCDate()).padStart(2,"0");e.push({id:`bday:${t.id}`,type:"birthday",date:`${r}-${a}-${n}`,personIds:[`child:${t.id}`],title:`${t.name}'s birthday`,_childId:t.id,_childName:t.name,recurring:!0})}return e}function Ot(d,e=new Date){if(!(d!=null&&d.date))return{date:null,yearsElapsed:0};const t=C(d.date);if(!t||Number.isNaN(t.getTime()))return{date:null,yearsElapsed:0};if(!d.recurring)return{date:t,yearsElapsed:0};const i=new Date(e.getFullYear(),t.getMonth(),t.getDate()),r=i<new Date(e.getFullYear(),e.getMonth(),e.getDate())?new Date(e.getFullYear()+1,t.getMonth(),t.getDate()):i,a=r.getFullYear()-t.getFullYear();return{date:r,yearsElapsed:a}}const Xe=["linear-gradient(135deg, #6b9ac4 0%, #c98a8a 60%, #d4a843 100%)","linear-gradient(135deg, #7a9e7e 0%, #4a6754 70%, #2c4439 100%)","linear-gradient(135deg, #c67b5c 0%, #d4a843 50%, #c98a8a 100%)","linear-gradient(135deg, #3d9b8f 0%, #1f5c54 100%)","linear-gradient(135deg, #d4a843 0%, #c67b5c 55%, #c98a8a 100%)","linear-gradient(135deg, #8b7bb5 0%, #c98a8a 60%, #d4a843 100%)","linear-gradient(135deg, #6b9ac4 0%, #3d9b8f 100%)"];function C(d){if(!d)return null;if(d instanceof Date)return d;const e=String(d).match(/^(\d{4})-(\d{2})-(\d{2})/);return e?new Date(Number(e[1]),Number(e[2])-1,Number(e[3])):new Date(d)}function jt(d){if(!d)return null;const e=d.getFullYear(),t=String(d.getMonth()+1).padStart(2,"0"),i=String(d.getDate()).padStart(2,"0");return`${e}-${t}-${i}`}async function Lt(d,e=90,t=100){const i=new Date,r=new Date(i.getTime()+e*24*60*60*1e3),a=new URL("https://www.googleapis.com/calendar/v3/calendars/primary/events");a.searchParams.set("timeMin",i.toISOString()),a.searchParams.set("timeMax",r.toISOString()),a.searchParams.set("maxResults",String(t)),a.searchParams.set("singleEvents","true"),a.searchParams.set("orderBy","startTime");const n=await fetch(a.toString(),{headers:{Authorization:`Bearer ${d}`}});if(!n.ok){const l=await n.text();throw n.status===401?new Error("Your Google session expired — connect your calendar again."):n.status===403&&/accessNotConfigured|SERVICE_DISABLED|PERMISSION_DENIED|insufficient/i.test(l)?new Error("Google Calendar access isn’t configured for this project yet. (Admin: enable the Google Calendar API and add the calendar.readonly scope to the OAuth consent screen in Google Cloud Console.)"):new Error(`Google Calendar: ${n.status} ${l.slice(0,160)}`)}return((await n.json()).items??[]).filter(l=>{var c,h;return l.status!=="cancelled"&&(((c=l.start)==null?void 0:c.date)||((h=l.start)==null?void 0:h.dateTime))})}function Gt(d,e){var r,a,n,o,l,c,h,p;const t=((r=d.start)==null?void 0:r.date)??((n=(a=d.start)==null?void 0:a.dateTime)==null?void 0:n.slice(0,10))??"";let i=((o=d.end)==null?void 0:o.date)??((c=(l=d.end)==null?void 0:l.dateTime)==null?void 0:c.slice(0,10))??t;if((h=d.start)!=null&&h.date&&((p=d.end)!=null&&p.date)){const u=new Date(i);u.setDate(u.getDate()-1),i=u.toISOString().slice(0,10)}return{title:d.summary||"(untitled)",location:d.location??"",start:t,end:i,attendees:e?[e]:[],viewers:[],visibility:"family",notes:(d.description??"").slice(0,1e3),gcalEventId:d.id,gcalEventLink:d.htmlLink??null}}function Rt(d){if(d!=null&&d.coverGradient)return d.coverGradient;const e=((d==null?void 0:d.title)??(d==null?void 0:d.id)??"")+((d==null?void 0:d.location)??"");let t=0;for(let i=0;i<e.length;i++)t=t*31+e.charCodeAt(i)>>>0;return Xe[t%Xe.length]}class ke extends D{constructor(){super(),this.year=new Date().getFullYear(),this.tripDays=new Map,this.trips=[],this.events=[],this.today=new Date,this._activeDay=null}_isLeap(e){return e%4===0&&e%100!==0||e%400===0}_daysInMonth(e,t){return[31,this._isLeap(e)?29:28,31,30,31,30,31,31,30,31,30,31][t]}_labelsForMonth(e){var a;const t=this.year,i=new Map,r=(n,o)=>{const l=i.get(n);i.set(n,l?`${l} · ${o}`:o)};for(const n of this.trips??[]){if(!n.start||!n.end)continue;const o=C(n.start),l=C(n.end);if(!o||!l||o.getFullYear()>t||l.getFullYear()<t)continue;const c=new Date(t,e,1),h=new Date(t,e+1,0);if(l<c||o>h)continue;const p=o.getMonth()===e&&o.getFullYear()===t?o.getDate():1,u=l.getMonth()===e&&l.getFullYear()===t?l.getDate():h.getDate(),_=(a=n.location)!=null&&a.trim()?`${n.title} (${n.location.trim()})`:n.title;for(let f=p;f<=u;f++)r(f,_)}for(const n of this.events??[]){const o=C(n.date);o&&o.getFullYear()===t&&o.getMonth()===e&&r(o.getDate(),n.title??"Event")}return i}_renderMonth(e){var c,h;const t=this.year,r=(new Date(t,e,1).getDay()+6)%7,a=this._daysInMonth(t,e),n=this._labelsForMonth(e),o=[];for(let p=0;p<r;p++)o.push(s`<div class="cell empty"></div>`);const l=this.today;for(let p=1;p<=a;p++){const u=`${String(e+1).padStart(2,"0")}-${String(p).padStart(2,"0")}`,_=this.tripDays.get(u)??0,f=l.getFullYear()===t&&l.getMonth()===e&&l.getDate()===p,g=n.get(p),m=(this.events??[]).some(T=>{const F=C(T.date);return F&&F.getFullYear()===t&&F.getMonth()===e&&F.getDate()===p}),$=((c=this._activeDay)==null?void 0:c.month)===e&&((h=this._activeDay)==null?void 0:h.day)===p,E=["cell",f?"today":"",_>0?"trip":"",_>.6?"dense":"",m?"event":"",g?"labelled":"",$?"active":""].filter(Boolean).join(" ");o.push(s`<div
        class=${E}
  ...
  `);customElements.define("trip-form",ze);class De extends D{constructor(){super(),this.open=!1,this.event=null,this.members=[],this.familyId="",this.busy=!1,this._draft=this._blankDraft(),this._error=""}willUpdate(e){(e.has("event")||e.has("open"))&&(this.open&&(this._draft=this._draftFromEvent(this.event)),this._error="")}_blankDraft(){return{id:null,type:"birthday",title:"",date:new Date().toISOString().slice(0,10),personIds:[],recurring:!0,subtitle:"",notes:"",visibility:"family"}}_draftFromEvent(e){return e?{id:e.id??null,type:e.type??"birthday",title:e.title??"",date:e.date??new Date().toISOString().slice(0,10),personIds:Array.isArray(e.personIds)?[...e.personIds]:[],recurring:e.recurring??!0,subtitle:e.subtitle??"",notes:e.notes??"",visibility:e.visibility??"family"}:this._blankDraft()}_set(e,t){this._draft={...this._draft,[e]:t}}_toggleType(e){this._set("type",e)}_togglePerson(e){const t=this._draft.personIds.includes(e);this._set("personIds",t?this._draft.personIds.filter(i=>i!==e):[...this._draft.personIds,e])}_onSave(){const e=this._draft;if(!e.title.trim()){this._error="Give it a title.";return}if(!e.date){this._error="Pick a date.";return}if(!this.familyId){this._error="No family yet.";return}this._error="",this.dispatchEvent(new CustomEvent("save",{detail:{...e,title:e.title.trim(),subtitle:e.subtitle.trim(),notes:e.notes.trim()}}))}_onDelete(){this._draft.id&&confirm("Delete this event? This can't be undone.")&&this.dispatchEvent(new CustomEvent("remove",{detail:{id:this._draft.id}}))}_onCancel(){this.dispatchEvent(new Event("cancel"))}render(){if(!this.open)return s``;const e=this._draft,t=!!e.id;return s`
    ...
    `}_monthDay(e){if(!e)return"";const t=C(e);return!t||Number.isNaN(t.getTime())?"":t.toLocaleString("en-GB",{day:"numeric",month:"long"})}}b(De,"properties",{open:{type:Boolean,reflect:!0},event:{type:Object},members:{type:Array},familyId:{type:String},busy:{type:Boolean},_draft:{state:!0},_error:{state:!0}}),b(De,"styles",S`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
...
`)}class Ae extends D{constructor(){super(),this.trip=null,this.members=[],this._resizeObs=null}connectedCallback(){super.connectedCallback(),typeof ResizeObserver<"u"&&(this._resizeObs=new ResizeObserver(()=>this._fitTitle()))}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._resizeObs)==null||e.disconnect()}updated(){if(this._resizeObs&&this.renderRoot){const e=this.renderRoot.querySelector("article");e&&!e._observed&&(this._resizeObs.observe(e),e._observed=!0)}this._fitTitle()}_fitTitle(){if(!this.renderRoot)return;const e=this.renderRoot.querySelector("h3");if(!e)return;e.style.fontSize="";let t=19;for(e.style.fontSize=`${t}px`;e.scrollWidth>e.clientWidth+1&&t>13;)t-=.5,e.style.fontSize=`${t}px`}_fmtDates(e,t){const i=C(e),r=C(t);if(!i||!r)return"";const a=i.toLocaleString("en-GB",{month:"short"}),n=r.toLocaleString("en-GB",{month:"short"});return a===n&&i.getFullYear()===r.getFullYear()?`${i.getDate()} – ${r.getDate()} ${a}`:`${i.getDate()} ${a} – ${r.getDate()} ${n}`}async _onShare(e,t,i){i.stopPropagation();const r=Ut(e,t);if(navigator.share)try{await navigator.share({title:`Cairn — ${e.title??"activity"}`,text:r})}catch{}else try{await navigator.clipboard.writeText(r),x("Itinerary copied to clipboard.")}catch{x("Could not copy — try again from a browser tab.")}}render(){const e=this.trip;if(!e)return s``;const t=e.coverImage?`background-image: url(${e.coverImage});`:`background: ${Rt(e)};`,i=e.coverImage?"cover has-image":"cover",r=new Map(this.members.map(l=>[l.uid,l])),a=(e.attendees??[]).map(l=>r.get(l)).filter(Boolean),n=a.slice(0,4),o=Math.max(0,a.length-n.length);return s`
  ...
  `);customElements.define("trip-card",Ae);class Ee extends D{constructor(){super(),this.open=!1,this.trips=[],this.members=[]}_onCancel(){this.dispatchEvent(new Event("cancel"))}_groupByYear(e){const t=[...e].sort((a,n)=>String(a.start).localeCompare(String(n.start))),i=new Date;i.setHours(0,0,0,0);const r=new Map;for(const a of t){if(!a.start)continue;const n=C(a.start),o=C(a.end);if(!n)continue;const l=n.getFullYear();r.has(l)||r.set(l,[]);const c=o?o<i:!1;r.get(l).push({trip:a,isPast:c})}return r}render(){var r;if(!this.open)return s``;const e=this._groupByYear(this.trips??[]),t=((r=this.trips)==null?void 0:r.length)??0,i=new Date().getFullYear();return s`
    ...
    `}}b(Ee,"properties",{open:{type:Boolean,reflect:!0},trips:{type:Array},members:{type:Array}}),b(Ee,"styles",S`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
        ...
        <section>
          <div class="cal-row">
            ...
            <glass-panel padding="md" variant="strong" stretch>
              ...
              <yearly-view
                .year=${((E=this._displayMonth)==null?void 0:E.getFullYear())??o.getFullYear()}
        ...
        <section>
          <div class="cel-cairn-row">
            ...
            <div class="cel-cairn-col">
              ...
              ${(()=>{const v=(P,H)=>String(P.date).localeCompare(String(H.date)),I=t.filter(P=>P.type==="birthday").slice().sort(v),B=t.filter(P=>P.type==="anniversary").slice().sort(v),Z=t.filter(P=>P.type!=="birthday"&&P.type!=="anniversary").slice().sort(v),Q=(P,H,re)=>s`
                ...
                `;return s`
                  <glass-panel padding="md" variant="strong">
                    ...
                    ${Q("Anniversaries",B,"No anniversaries yet.")}
            ...
            <div class="cel-cairn-col">
              ...
              <glass-panel padding="md" variant="strong">
                ${(()=>{var re,ae,se,Ue,Ye;const v=i.find(L=>{var R;return L.uid===((R=this.user)==null?void 0:R.uid)}),B=new Set(((re=this.family)==null?void 0:re.memberIds)??[]).has((ae=this.user)==null?void 0:ae.uid),Z=i.filter(L=>{var R;return L.uid!==((R=this.user)==null?void 0:R.uid)}),Q=!B&&v?[{...v,role:"extended"},...r]:r,P=Object.entries(((se=this.family)==null?void 0:se.subGroups)??{}),H=new Map(a.map(L=>[L.uid,L]));return s`
                <div class="cairn-stack">
                          ...
                          <span class="pebble pebble-self">
                            <span class="stone-chips">
                              <member-chip
                                ...
                                .photo=${(v==null?void 0:v.photoURL)??((Ye=this.user)==null?void 0:Ye.photoURL)??""}
                  ...
                  ${P.length>0?s`
                        <div class="subgroup-row">
                          ${P.map(([L,R])=>{const ut=(R.memberIds??[]).map(ge=>H.get(ge)).filter(Boolean);return this._renderStone({label:R.name??"Group",members:ut,pebbleClass:"pebble-subgroup",emptyLabel:`${R.name??"Group"} (empty)`,onClick:()=>this._membersOpen=!0,maxChips:4,dropTargetId:L,draggable:ge=>ge.role==="extended"})})}
                        </div>
                      `:""}
                </div>
