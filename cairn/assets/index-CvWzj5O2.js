var et=Object.defineProperty;var tt=(d,e,t)=>e in d?et(d,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):d[e]=t;var m=(d,e,t)=>tt(d,typeof e!="symbol"?e+"":e,t);import{i as C,a as z,b as s}from"./lit-2GpawzfI.js";import{f as it,h as rt,j as at,G as Te,s as Le,k as st,l as E,m as L,n as S,o as ot,q as J,t as U,v as ee,w as oe,x as Be,y as Ge,z as Ue,A as ne}from"./firebase-core-DVt9Aunh.js";import{g as nt,h as te}from"./firebase-functions-CfBtnn7v.js";import{g as lt,r as Ye,u as Re,a as He}from"./firebase-storage-C5Nl_r0j.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const a of r)if(a.type==="childList")for(const n of a.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(r){const a={};return r.integrity&&(a.integrity=r.integrity),r.referrerPolicy&&(a.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?a.credentials="include":r.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(r){if(r.ep)return;r.ep=!0;const a=t(r);fetch(r.href,a)}})();class le extends C{constructor(){super(),this.variant="default",this.lifted=!1,this.padding="md"}render(){const e=["panel",this.variant==="strong"?"strong":"",this.lifted?"lifted":"",`pad-${this.padding}`].filter(Boolean).join(" ");return s`
      <div class=${e}>
        <div class="content"><slot></slot></div>
      </div>
    `}}m(le,"properties",{variant:{type:String},lifted:{type:Boolean},padding:{type:String}}),m(le,"styles",z`
    :host {
      display: block;
    }
    :host([stretch]) {
  ...
  `);customElements.define("glass-panel",le);class de extends C{constructor(){super(),this.variant="primary",this.size="md",this.full=!1,this.disabled=!1}render(){const e=[this.variant,`size-${this.size}`,this.full?"full":""].filter(Boolean).join(" ");return s`
      <button class=${e} ?disabled=${this.disabled}>
        <slot></slot>
      </button>
    `}}m(de,"properties",{variant:{type:String},size:{type:String},full:{type:Boolean},disabled:{type:Boolean,reflect:!0}}),m(de,"styles",z`
    * {
      box-sizing: border-box;
    }
    :host {
  ...
  `);customElements.define("glass-button",de);class ce extends C{constructor(){super(),this.size=44}render(){const e=this.size;return s`
      <svg
        viewBox="0 0 64 64"
        width=${e}
        height=${e}
    ...
    `}}m(ce,"properties",{size:{type:Number}}),m(ce,"styles",z`
    :host {
      display: inline-block;
      line-height: 0;
    }
  ...
  `);customElements.define("cairn-mark",ce);const dt="modulepreload",ct=function(d){return"/cairn/"+d},Ne={},Je=function(e,t,i){let r=Promise.resolve();if(t&&t.length>0){let n=function(c){return Promise.all(c.map(p=>Promise.resolve(p).then(h=>({status:"fulfilled",value:h}),h=>({status:"rejected",reason:h}))))};document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),l=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));r=n(t.map(c=>{if(c=ct(c),c in Ne)return;Ne[c]=!0;const p=c.endsWith(".css"),h=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${h}`))return;const g=document.createElement("link");if(g.rel=p?"stylesheet":dt,p||(g.as="script"),g.crossOrigin="",g.href=c,l&&g.setAttribute("nonce",l),document.head.appendChild(g),p)return new Promise((x,w)=>{g.addEventListener("load",x),g.addEventListener("error",()=>w(new Error(`Unable to preload CSS for ${c}`)))})}))}function a(n){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=n,window.dispatchEvent(o),!o.defaultPrevented)throw n}return r.then(n=>{for(const o of n||[])o.status==="rejected"&&a(o.reason);return e().catch(a)})},pe={apiKey:"AIzaSyA6NKZNLVBeeLrXcLJSXus5M832AxpI2wk",authDomain:"pebblepath-992b6.firebaseapp.com",projectId:"pebblepath-992b6",storageBucket:"pebblepath-992b6.firebasestorage.app",messagingSenderId:"497141667291",appId:"1:497141667291:web:ee84c186db54389d10c3fe"},B=!!(pe.apiKey&&pe.projectId),q=B?it(pe):null,$=B?rt(q):null,y=B?at(q):null,H=B?nt(q,"us-central1"):null,he=B?lt(q):null,ue=B?new Te:null;ue&&ue.setCustomParameters({prompt:"select_account"});const re=B?new Te:null;re&&re.addScope("https://www.googleapis.com/auth/calendar.readonly");let ie=null,ge=0;async function Xe(){if(!$||!re)throw new Error("Firebase not configured.");if(ie&&Date.now()<ge-6e4)return ie;const d=await Le($,re),e=Te.credentialFromResult(d),t=e==null?void 0:e.accessToken;if(!t)throw new Error("Couldn't get a Calendar access token — try again.");return ie=t,ge=Date.now()+3600*1e3,t}function pt(){ie=null,ge=0}function qe(){if(!$)throw new Error("Firebase not configured — fill in .env first.");return Le($,ue)}function We(){return $?st($):Promise.resolve()}function Ve(d){return $?ot($,d):(d(null),()=>{})}const ht=Object.freeze(Object.defineProperty({__proto__:null,addDoc:ee,app:q,auth:$,clearCalendarToken:pt,collection:U,connectGoogleCalendar:Xe,db:y,deleteDoc:oe,doc:E,firebaseApp:q,functions:H,getDocs:Ue,getDownloadURL:He,httpsCallable:te,isConfigured:B,onAuth:Ve,onSnapshot:J,query:Be,serverTimestamp:S,setDoc:ne,signIn:qe,signOutUser:We,storage:he,storageRef:Ye,updateDoc:L,uploadBytes:Re,where:Ge},Symbol.toStringTag,{value:"Module"}));class ut extends EventTarget{constructor(){super(),this.state={user:null,family:null,children:[],trips:[],events:[]},this._uid=null,this._unsubUser=null,this._unsubFamily=null,this._unsubChildren=null,this._unsubTrips=null,this._unsubEvents=null,this._currentFamilyId=null,this.userDocResolved=!1}get familyId(){return this._currentFamilyId}start(e){!y||!e||this._uid!==e&&(this.stop(),this._uid=e,this._unsubUser=J(E(y,"users",e),t=>{var r,a,n,o,l,c;this.userDocResolved=!0,this.state.user=t.exists()?{id:t.id,...t.data()}:null;const i=((r=this.state.user)==null?void 0:r.familyId)??((a=this.state.user)==null?void 0:a.cairnFamilyId)??null;i!==this._currentFamilyId&&(this._currentFamilyId=i,(n=this._unsubFamily)==null||n.call(this),(o=this._unsubChildren)==null||o.call(this),(l=this._unsubTrips)==null||l.call(this),(c=this._unsubEvents)==null||c.call(this),this._unsubFamily=null,this._unsubChildren=null,this._unsubTrips=null,this._unsubEvents=null,this.state.family=null,this.state.children=[],this.state.trips=[],this.state.events=[],i&&this._subscribeFamily(i)),this._emit()}))}_subscribeFamily(e){this._unsubFamily=J(E(y,"families",e),t=>{this.state.family=t.exists()?{id:t.id,...t.data()}:null,this._emit()}),this._unsubChildren=J(U(y,"families",e,"children"),t=>{this.state.children=t.docs.map(i=>{var a,n;const r=i.data();return{id:i.id,...r,dateOfBirth:((n=(a=r.dateOfBirth)==null?void 0:a.toDate)==null?void 0:n.call(a))??(r.dateOfBirth?new Date(r.dateOfBirth):null)}}),this._emit()}),this._unsubTrips=J(U(y,"families",e,"trips"),t=>{this.state.trips=t.docs.map(i=>{var a,n,o,l;const r=i.data();return{id:i.id,...r,start:r.start??"",end:r.end??"",createdAt:((n=(a=r.createdAt)==null?void 0:a.toDate)==null?void 0:n.call(a))??null,updatedAt:((l=(o=r.updatedAt)==null?void 0:o.toDate)==null?void 0:l.call(o))??null}}).sort((i,r)=>String(i.start).localeCompare(String(r.start))),this._emit()},t=>{console.warn("[Cairn] trips subscription error:",t.code,t.message)}),this._unsubEvents=J(U(y,"families",e,"familyEvents"),t=>{this.state.events=t.docs.map(i=>{var a,n,o,l;const r=i.data();return{id:i.id,...r,date:r.date??"",createdAt:((n=(a=r.createdAt)==null?void 0:a.toDate)==null?void 0:n.call(a))??null,updatedAt:((l=(o=r.updatedAt)==null?void 0:o.toDate)==null?void 0:l.call(o))??null}}),this._emit()},t=>{console.warn("[Cairn] familyEvents subscription error:",t.code,t.message)})}async saveTrip(e){var c;if(!y||!this._currentFamilyId)throw new Error("No family yet.");const t=(c=$==null?void 0:$.currentUser)==null?void 0:c.uid;if(!t)throw new Error("Not signed in.");const{id:i,createdAt:r,updatedAt:a,...n}=e,o={...n,updatedAt:S()};return i?(await L(E(y,"families",this._currentFamilyId,"trips",i),o),i):(o.createdBy=t,o.createdAt=S(),(await ee(U(y,"families",this._currentFamilyId,"trips"),o)).id)}async deleteTrip(e){if(!y||!this._currentFamilyId)throw new Error("No family yet.");await oe(E(y,"families",this._currentFamilyId,"trips",e))}async saveEvent(e){var c;if(!y||!this._currentFamilyId)throw new Error("No family yet.");const t=(c=$==null?void 0:$.currentUser)==null?void 0:c.uid;if(!t)throw new Error("Not signed in.");const{id:i,createdAt:r,updatedAt:a,...n}=e,o={...n,updatedAt:S()};return i?(await L(E(y,"families",this._currentFamilyId,"familyEvents",i),o),i):(o.createdBy=t,o.createdAt=S(),(await ee(U(y,"families",this._currentFamilyId,"familyEvents"),o)).id)}async deleteEvent(e){if(!y||!this._currentFamilyId)throw new Error("No family yet.");await oe(E(y,"families",this._currentFamilyId,"familyEvents",e))}async previewUrl(e){if(!e||typeof e!="string"||!/^https?:\/\//i.test(e.trim()))return null;if(!H)throw new Error("Firebase functions not configured.");return(await te(H,"previewUrl")({url:e.trim()})).data}async lookupFlight(e,t){if(!e||typeof e!="string")return null;if(!H)throw new Error("Firebase functions not configured.");return(await te(H,"lookupFlight")({flightNumber:e.trim(),date:typeof t=="string"?t.trim():""})).data}async askPebble(e,t=[]){if(!H)throw new Error("Firebase functions not configured.");if(!this._currentFamilyId)throw new Error("No family yet.");return(await te(H,"askPebbleAboutActivities")({question:e,familyId:this._currentFamilyId,history:t})).data}async updateChildBirthday(e,t){if(!y||!this._currentFamilyId)throw new Error("No family yet.");await L(E(y,"families",this._currentFamilyId,"children",e),{dateOfBirth:t,updatedAt:S()})}async findFamilyByCairnCode(e){if(!y)throw new Error("Firebase not configured.");const t=Be(U(y,"families"),Ge("cairnInviteCode","==",e)),i=await Ue(t);if(i.empty)return null;const r=i.docs[0];return{id:r.id,...r.data()}}async joinFamilyAsCairn(e){var p,h,g;if(!y)throw new Error("Firebase not configured.");const t=(p=$==null?void 0:$.currentUser)==null?void 0:p.uid;if(!t)throw new Error("Not signed in.");const i=await this.findFamilyByCairnCode(e);if(!i){const x=new Error("Invite code not found.");throw x.code="not-found",x}const r=((g=(h=i.cairnInviteCodeExpiresAt)==null?void 0:h.toDate)==null?void 0:g.call(h))??(i.cairnInviteCodeExpiresAt?new Date(i.cairnInviteCodeExpiresAt):null);if(!r||r<new Date){const x=new Error("This invite code has expired.");throw x.code="expired",x}const a=i.cairnMemberIds??[];if(a.includes(t)||(i.memberIds??[]).includes(t)){const x=new Error("You're already in this family on Cairn.");throw x.code="already-member",x}const n=i.cairnMaxMembers??20;if(a.length>=n){const x=new Error("This family's Cairn ring is full.");throw x.code="full",x}const o=$.currentUser,l=new Date,c={displayName:o.displayName??"",profilePhotoURL:o.photoURL??null,role:"member",joinedAt:l,updatedAt:l};return await L(E(y,"families",i.id),{cairnMemberIds:[...a,t],[`memberProfiles.${t}`]:c,updatedAt:S()}),await ne(E(y,"users",t),{email:o.email??"",displayName:o.displayName??"",profilePhotoURL:o.photoURL??null,cairnFamilyId:i.id,role:"member",notificationPreferences:{milestoneReminders:!0,tipNotifications:!0,schoolDeadlines:!0},createdAt:S(),updatedAt:S()},{merge:!0}),i.id}async saveSubGroup({id:e,name:t,memberIds:i}){if(!y||!this._currentFamilyId)throw new Error("No family yet.");const r=e??`g_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,6)}`;return await L(E(y,"families",this._currentFamilyId),{[`subGroups.${r}`]:{name:t.trim(),memberIds:Array.isArray(i)?[...i]:[],updatedAt:S()},updatedAt:S()}),r}async deleteSubGroup(e){if(!y||!this._currentFamilyId)throw new Error("No family yet.");const{deleteField:t}=await Je(async()=>{const{deleteField:i}=await import("./firebase-core-DVt9Aunh.js").then(r=>r.B);return{deleteField:i}},[]);await L(E(y,"families",this._currentFamilyId),{[`subGroups.${e}`]:t(),updatedAt:S()})}async setCairnMemberSubGroup(e,t){var a;if(!y||!this._currentFamilyId)throw new Error("No family yet.");if(!e)throw new Error("uid is required.");const i=((a=this.state.family)==null?void 0:a.subGroups)??{},r={};for(const[n,o]of Object.entries(i)){const l=Array.isArray(o.memberIds)?o.memberIds:[];n===t?l.includes(e)||(r[`subGroups.${n}.memberIds`]=[...l,e]):l.includes(e)&&(r[`subGroups.${n}.memberIds`]=l.filter(c=>c!==e))}Object.keys(r).length!==0&&(r.updatedAt=S(),await L(E(y,"families",this._currentFamilyId),r))}async createCairnOnlyFamily(e){if(!y)throw new Error("Firebase not configured.");const t=$==null?void 0:$.currentUser,i=t==null?void 0:t.uid;if(!i)throw new Error("Not signed in.");const r=(e??"").trim();if(!r)throw new Error("Family name is required.");const a=new Date,n=Me(),o=new Date(Date.now()+720*60*60*1e3),l={displayName:t.displayName??"",profilePhotoURL:t.photoURL??null,role:"admin",joinedAt:a,updatedAt:a},c={name:r,createdBy:i,createdInApp:"cairn",memberIds:[],cairnMemberIds:[i],cairnMaxMembers:20,cairnInviteCode:n,cairnInviteCodeExpiresAt:o,memberProfiles:{[i]:l},createdAt:S(),updatedAt:S()},p=await ee(U(y,"families"),c);return await ne(E(y,"users",i),{email:t.email??"",displayName:t.displayName??"",profilePhotoURL:t.photoURL??null,cairnFamilyId:p.id,role:"admin",notificationPreferences:{milestoneReminders:!1,tipNotifications:!1,schoolDeadlines:!1},createdAt:S(),updatedAt:S()},{merge:!0}),p.id}async regenerateCairnInviteCode(){if(!y||!this._currentFamilyId)throw new Error("No family yet.");const e=Me(),t=new Date(Date.now()+720*60*60*1e3);return await L(E(y,"families",this._currentFamilyId),{cairnInviteCode:e,cairnInviteCodeExpiresAt:t,updatedAt:S()}),{code:e,expiresAt:t}}stop(){var e,t,i,r,a;(e=this._unsubUser)==null||e.call(this),(t=this._unsubFamily)==null||t.call(this),(i=this._unsubChildren)==null||i.call(this),(r=this._unsubTrips)==null||r.call(this),(a=this._unsubEvents)==null||a.call(this),this._unsubUser=this._unsubFamily=this._unsubChildren=this._unsubTrips=this._unsubEvents=null,this._uid=null,this._currentFamilyId=null,this.userDocResolved=!1,this.state={user:null,family:null,children:[],trips:[],events:[]}}_emit(){this.dispatchEvent(new Event("change"))}}const k=new ut;function Ke(d,e){const t=e==null?void 0:e.profilePhotoURL;return typeof t=="string"&&/^https?:\/\//i.test(t)?t:d!=null&&d.photoURL?d.photoURL:null}function Me(){const d="ABCDEFGHJKLMNPQRSTUVWXYZ23456789";let e="CAIRN-";for(let t=0;t<4;t++)e+=d[Math.floor(Math.random()*d.length)];return e}function gt(d,e,t,i,r){const a=[];a.push({uid:d,displayName:(e==null?void 0:e.displayName)??(t==null?void 0:t.displayName)??"You",photoURL:Ke(e,t),role:"self",circles:["immediate"],hue:198});const n=(i==null?void 0:i.memberProfiles)??{};for(const[l,c]of Object.entries(n)){if(l===d)continue;const p=c.profilePhotoURL;a.push({uid:l,displayName:c.displayName??"Co-parent",photoURL:typeof p=="string"&&/^https?:\/\//i.test(p)?p:null,role:"co-parent",circles:["immediate"],hue:8})}let o=142;for(const l of r??[]){const c=l.profilePhotoURL;a.push({uid:`child:${l.id}`,displayName:l.name,photoURL:typeof c=="string"&&/^https?:\/\//i.test(c)?c:null,role:"child",circles:["immediate"],hue:o,dateOfBirth:l.dateOfBirth}),o=(o+58)%360}return a}function mt(d){const e=[];for(const t of d??[]){if(!t.dateOfBirth)continue;const i=t.dateOfBirth,r=i.getUTCFullYear(),a=String(i.getUTCMonth()+1).padStart(2,"0"),n=String(i.getUTCDate()).padStart(2,"0");e.push({id:`bday:${t.id}`,type:"birthday",date:`${r}-${a}-${n}`,personIds:[`child:${t.id}`],title:`${t.name}'s birthday`,_childId:t.id,_childName:t.name,recurring:!0})}return e}function bt(d,e=new Date){if(!(d!=null&&d.date))return{date:null,yearsElapsed:0};const t=D(d.date);if(!t||Number.isNaN(t.getTime()))return{date:null,yearsElapsed:0};if(!d.recurring)return{date:t,yearsElapsed:0};const i=new Date(e.getFullYear(),t.getMonth(),t.getDate()),r=i<new Date(e.getFullYear(),e.getMonth(),e.getDate())?new Date(e.getFullYear()+1,t.getMonth(),t.getDate()):i,a=r.getFullYear()-t.getFullYear();return{date:r,yearsElapsed:a}}const Oe=["linear-gradient(135deg, #6b9ac4 0%, #c98a8a 60%, #d4a843 100%)","linear-gradient(135deg, #7a9e7e 0%, #4a6754 70%, #2c4439 100%)","linear-gradient(135deg, #c67b5c 0%, #d4a843 50%, #c98a8a 100%)","linear-gradient(135deg, #3d9b8f 0%, #1f5c54 100%)","linear-gradient(135deg, #d4a843 0%, #c67b5c 55%, #c98a8a 100%)","linear-gradient(135deg, #8b7bb5 0%, #c98a8a 60%, #d4a843 100%)","linear-gradient(135deg, #6b9ac4 0%, #3d9b8f 100%)"];function D(d){if(!d)return null;if(d instanceof Date)return d;const e=String(d).match(/^(\d{4})-(\d{2})-(\d{2})/);return e?new Date(Number(e[1]),Number(e[2])-1,Number(e[3])):new Date(d)}function ft(d){if(!d)return null;const e=d.getFullYear(),t=String(d.getMonth()+1).padStart(2,"0"),i=String(d.getDate()).padStart(2,"0");return`${e}-${t}-${i}`}async function vt(d,e=90,t=100){const i=new Date,r=new Date(i.getTime()+e*24*60*60*1e3),a=new URL("https://www.googleapis.com/calendar/v3/calendars/primary/events");a.searchParams.set("timeMin",i.toISOString()),a.searchParams.set("timeMax",r.toISOString()),a.searchParams.set("maxResults",String(t)),a.searchParams.set("singleEvents","true"),a.searchParams.set("orderBy","startTime");const n=await fetch(a.toString(),{headers:{Authorization:`Bearer ${d}`}});if(!n.ok){const l=await n.text();throw new Error(`Google Calendar: ${n.status} ${l.slice(0,160)}`)}return((await n.json()).items??[]).filter(l=>{var c,p;return l.status!=="cancelled"&&(((c=l.start)==null?void 0:c.date)||((p=l.start)==null?void 0:p.dateTime))})}function xt(d,e){var r,a,n,o,l,c,p,h;const t=((r=d.start)==null?void 0:r.date)??((n=(a=d.start)==null?void 0:a.dateTime)==null?void 0:n.slice(0,10))??"";let i=((o=d.end)==null?void 0:o.date)??((c=(l=d.end)==null?void 0:l.dateTime)==null?void 0:c.slice(0,10))??t;if((p=d.start)!=null&&p.date&&((h=d.end)!=null&&h.date)){const g=new Date(i);g.setDate(g.getDate()-1),i=g.toISOString().slice(0,10)}return{title:d.summary||"(untitled)",location:d.location??"",start:t,end:i,attendees:e?[e]:[],viewers:[],visibility:"family",notes:(d.description??"").slice(0,1e3),gcalEventId:d.id,gcalEventLink:d.htmlLink??null}}function yt(d){if(d!=null&&d.coverGradient)return d.coverGradient;const e=((d==null?void 0:d.title)??(d==null?void 0:d.id)??"")+((d==null?void 0:d.location)??"");let t=0;for(let i=0;i<e.length;i++)t=t*31+e.charCodeAt(i)>>>0;return Oe[t%Oe.length]}class me extends C{constructor(){super(),this.year=new Date().getFullYear(),this.tripDays=new Map,this.trips=[],this.events=[],this.today=new Date,this._activeDay=null}_isLeap(e){return e%4===0&&e%100!==0||e%400===0}_daysInMonth(e,t){return[31,this._isLeap(e)?29:28,31,30,31,30,31,31,30,31,30,31][t]}_labelsForMonth(e){var a;const t=this.year,i=new Map,r=(n,o)=>{const l=i.get(n);i.set(n,l?`${l} · ${o}`:o)};for(const n of this.trips??[]){if(!n.start||!n.end)continue;const o=D(n.start),l=D(n.end);if(!o||!l||o.getFullYear()>t||l.getFullYear()<t)continue;const c=new Date(t,e,1),p=new Date(t,e+1,0);if(l<c||o>p)continue;const h=o.getMonth()===e&&o.getFullYear()===t?o.getDate():1,g=l.getMonth()===e&&l.getFullYear()===t?l.getDate():p.getDate(),x=(a=n.location)!=null&&a.trim()?`${n.title} (${n.location.trim()})`:n.title;for(let w=h;w<=g;w++)r(w,x)}for(const n of this.events??[]){const o=D(n.date);o&&o.getFullYear()===t&&o.getMonth()===e&&r(o.getDate(),n.title??"Event")}return i}_renderMonth(e){var c,p;const t=this.year,r=(new Date(t,e,1).getDay()+6)%7,a=this._daysInMonth(t,e),n=this._labelsForMonth(e),o=[];for(let h=0;h<r;h++)o.push(s`<div class="cell empty"></div>`);const l=this.today;for(let h=1;h<=a;h++){const g=`${String(e+1).padStart(2,"0")}-${String(h).padStart(2,"0")}`,x=this.tripDays.get(g)??0,w=l.getFullYear()===t&&l.getMonth()===e&&l.getDate()===h,u=n.get(h),b=(this.events??[]).some(N=>{const A=D(N.date);return A&&A.getFullYear()===t&&A.getMonth()===e&&A.getDate()===h}),_=((c=this._activeDay)==null?void 0:c.month)===e&&((p=this._activeDay)==null?void 0:p.day)===h,F=["cell",w?"today":"",x>0?"trip":"",x>.6?"dense":"",b?"event":"",u?"labelled":"",_?"active":""].filter(Boolean).join(" ");o.push(s`<div
        class=${F}
      ...
      ${this._activeDay?s`
          ...
          `:""}
    `}}m(me,"properties",{year:{type:Number},tripDays:{type:Object},trips:{type:Array},events:{type:Array},today:{type:Object},_activeDay:{state:!0}}),m(me,"styles",z`
    :host {
      display: block;
    }
    .grid {
  ...
  `);customElements.define("yearly-view",me);class be extends C{constructor(){super(),this.name="",this.hue=200,this.photo="",this.size=36,this.showName=!1}_initials(){return this.name.split(/\s+/).map(e=>e[0]).filter(Boolean).slice(0,2).join("").toUpperCase()}render(){const e=`linear-gradient(135deg, hsl(${this.hue}, 55%, 62%) 0%, hsl(${(this.hue+40)%360}, 50%, 42%) 100%)`,t=`width:${this.size}px;height:${this.size}px;background:${e};font-size:${this.size*.38}px;`;return s`
    ...
    `}}m(be,"properties",{name:{type:String},hue:{type:Number},photo:{type:String},size:{type:Number},showName:{type:Boolean,attribute:"show-name"}}),m(be,"styles",z`
    :host {
      display: inline-flex;
      align-items: center;
      gap: 8px;
  ...
  `);customElements.define("member-chip",be);class fe extends C{constructor(){super(),this.start="",this.end="",this._displayMonth=null,this._hoverDate=null}willUpdate(e){if(e.has("start")||this._displayMonth===null){const t=this.start?D(this.start):new Date;this._displayMonth=new Date(t.getFullYear(),t.getMonth(),1)}}_isoFor(e,t,i){return`${e}-${String(t+1).padStart(2,"0")}-${String(i).padStart(2,"0")}`}_emit(e,t){this.start=e,this.end=t,this._hoverDate=null,this.dispatchEvent(new CustomEvent("range-change",{detail:{start:e,end:t},bubbles:!0,composed:!0}))}_onDayClick(e){if(!this.start||this.start&&this.end){this._emit(e,"");return}e<this.start?this._emit(e,this.start):this._emit(this.start,e)}_onDayHover(e){this.start&&!this.end&&(this._hoverDate=e)}_onLeave(){this._hoverDate=null}_shiftMonth(e){const t=this._displayMonth;this._displayMonth=new Date(t.getFullYear(),t.getMonth()+e,1)}_isToday(e,t,i){const r=new Date;return r.getFullYear()===e&&r.getMonth()===t&&r.getDate()===i}_inSelectedRange(e){return!this.start||!this.end?!1:e>this.start&&e<this.end}_inHoverRange(e){if(!this.start||this.end||!this._hoverDate)return!1;const t=this._hoverDate<this.start?this._hoverDate:this.start,i=this._hoverDate<this.start?this.start:this._hoverDate;return e>t&&e<i}_summary(){if(!this.start&&!this.end)return"Pick a start date";const e=t=>{const i=D(t);return i?i.toLocaleString("en-GB",{day:"numeric",month:"short",year:"numeric"}):""};return this.start&&!this.end?`From ${e(this.start)} — pick an end date`:this.start===this.end?e(this.start):`${e(this.start)} – ${e(this.end)}`}_renderGrid(){const e=this._displayMonth.getFullYear(),t=this._displayMonth.getMonth(),r=(new Date(e,t,1).getDay()+6)%7,a=new Date(e,t+1,0).getDate(),n=[];for(let o=0;o<r;o++)n.push(s`<div class="empty"></div>`);for(let o=1;o<=a;o++){const l=this._isoFor(e,t,o),c=l===this.start,p=l===this.end&&l!==this.start,h=this._inSelectedRange(l),g=this._inHoverRange(l),x=this._isToday(e,t,o),w=["day",c?"start":"",p?"end":"",h?"in-range":"",g?"hover-range":"",x&&!c&&!p?"today":""].filter(Boolean).join(" ");n.push(s`
    ...
    `}}m(fe,"properties",{start:{type:String},end:{type:String},_displayMonth:{state:!0},_hoverDate:{state:!0}}),m(fe,"styles",z`
    * { box-sizing: border-box; }
    :host {
      display: block;
    }
  ...
  `);customElements.define("date-range-picker",fe);class ve extends C{constructor(){super(),this.open=!1,this.trip=null,this.members=[],this.currentUid="",this.familyId="",this.busy=!1,this.formMode="trip",this.subGroups={},this._draft=this._blankDraft(),this._error="",this._previewing=!1,this._previewError="",this._previewDebounce=null,this._lastPreviewedUrl="",this._showReturn=!1,this._showOutboundDetails=!1,this._showReturnDetails=!1,this._showFlight=!1,this._outboundLookupState="idle",this._outboundLookupMessage="",this._returnLookupState="idle",this._returnLookupMessage="",this._lastLookedUpOutbound="",this._lastLookedUpReturn=""}async _runFlightLookup(e){var h,g,x,w;const t=e==="return",i=t?"returnFlightNumber":"flightNumber",r=(this._draft[i]??"").trim();if(!r)return;const a=r.toUpperCase().replace(/[^A-Z0-9]/g,"");if(!/^[A-Z]{2,3}\d{1,4}[A-Z]?$/.test(a)){this[t?"_returnLookupState":"_outboundLookupState"]="idle";return}const n=t?"_lastLookedUpReturn":"_lastLookedUpOutbound",o=t?this._draft.end:this._draft.start,l=`${a}|${o??""}`;if(this[n]===l)return;const c=t?"_returnLookupState":"_outboundLookupState",p=t?"_returnLookupMessage":"_outboundLookupMessage";this[c]="loading",this[p]="";try{const u=await k.lookupFlight(a,o);if(!u)return;this[n]=l;const b=t?"returnFlightAirline":"flightAirline",_=t?"returnFlightDepartAirport":"flightDepartAirport",F=t?"returnFlightArriveAirport":"flightArriveAirport",N=t?"returnFlightDepartTime":"flightDepartTime",A=t?"returnFlightArriveTime":"flightArriveTime",M=W=>W?String(W).slice(0,16):"",O={};if(!this._draft[b]&&u.airline&&(O[b]=u.airline),!this._draft[_]&&((h=u.depart)!=null&&h.iata)&&(O[_]=u.depart.iata),!this._draft[F]&&((g=u.arrive)!=null&&g.iata)&&(O[F]=u.arrive.iata),!this._draft[N]&&((x=u.depart)!=null&&x.scheduledTime)&&(O[N]=M(u.depart.scheduledTime)),!this._draft[A]&&((w=u.arrive)!=null&&w.scheduledTime)&&(O[A]=M(u.arrive.scheduledTime)),Object.keys(O).length===0){this[c]="idle";return}this._draft={...this._draft,...O},(O[_]||O[F])&&(t?this._showReturnDetails=!0:this._showOutboundDetails=!0),this[c]="ok",this[p]=`Filled from ${u.airline??"flight record"}.`}catch(u){console.warn("Flight lookup failed:",u),this[c]="error",(u==null?void 0:u.code)==="functions/failed-precondition"?this[p]="Auto-fill not configured — enter details manually.":(u==null?void 0:u.code)==="functions/not-found"?this[p]="Couldn't find that flight — enter details manually.":(u==null?void 0:u.code)==="functions/invalid-argument"?this[p]="That doesn't look like a flight number.":(u==null?void 0:u.code)==="functions/unauthenticated"?this[p]="Sign in to use flight lookup.":this[p]="Flight lookup unavailable — enter details manually."}}willUpdate(e){(e.has("trip")||e.has("open"))&&(this.open&&(this._draft=this._draftFromTrip(this.trip),this._draft.id&&this._draft.lodgingUrl&&!this._draft.coverImage&&requestAnimationFrame(()=>this._autoRefreshPreview()),this._showReturn=!!(this._draft.returnFlightNumber||this._draft.returnFlightDepartTime||this._draft.returnFlightDepartAirport||this._draft.returnFlightArriveAirport),this._showOutboundDetails=!!(this._draft.flightDepartAirport||this._draft.flightArriveAirport),this._showReturnDetails=!!(this._draft.returnFlightDepartAirport||this._draft.returnFlightArriveAirport),this._showFlight=!!(this._draft.flightNumber||this._draft.flightAirline||this._draft.flightDepartTime||this._draft.flightDepartAirport||this._draft.flightArriveAirport||this._showReturn)),this._error="")}async _autoRefreshPreview(){const e=this._draft.lodgingUrl,t=this._draft.id;if(!(!e||!t||this._previewing)){this._previewing=!0,this._previewError="";try{const i=await k.previewUrl(e);if(!(i!=null&&i.image)){this._previewError="No preview image found for this URL.";return}const r={coverImage:i.image,lodgingHost:i.siteName??i.host??this._draft.lodgingHost??"",lodgingTitle:i.title??this._draft.lodgingTitle??""};this._draft={...this._draft,...r},this._lastPreviewedUrl=e;try{await k.saveTrip({id:t,...r})}catch(a){console.warn("Auto-save cover failed:",a)}}catch(i){console.warn("Auto preview failed:",i),this._previewError=(i==null?void 0:i.code)==="functions/unauthenticated"?"Preview needs you to be signed in.":"Preview unavailable — try the Refresh button."}finally{this._previewing=!1}}}_blankDraft(){const e=new Date().toISOString().slice(0,10);return{id:null,title:"",location:"",start:e,end:e,visibility:"family",attendees:this.currentUid?[this.currentUid]:[],viewers:[],targetSubGroups:[],lodgingUrl:"",lodgingHost:"",lodgingTitle:"",flightAirline:"",flightNumber:"",flightDepartAirport:"",flightDepartTime:"",flightArriveAirport:"",flightArriveTime:"",returnFlightAirline:"",returnFlightNumber:"",returnFlightDepartAirport:"",returnFlightDepartTime:"",returnFlightArriveAirport:"",returnFlightArriveTime:"",notes:""}}_draftFromTrip(e){return e?{id:e.id??null,title:e.title??"",location:e.location??"",start:e.start??new Date().toISOString().slice(0,10),end:e.end??e.start??new Date().toISOString().slice(0,10),visibility:e.visibility??"family",attendees:Array.isArray(e.attendees)?[...e.attendees]:[],viewers:Array.isArray(e.viewers)?[...e.viewers]:[],targetSubGroups:Array.isArray(e.targetSubGroups)?[...e.targetSubGroups]:[],lodgingUrl:e.lodgingUrl??"",lodgingHost:e.lodgingHost??"",lodgingTitle:e.lodgingTitle??"",flightAirline:e.flightAirline??"",flightNumber:e.flightNumber??"",flightDepartAirport:e.flightDepartAirport??"",flightDepartTime:e.flightDepartTime??"",flightArriveAirport:e.flightArriveAirport??"",flightArriveTime:e.flightArriveTime??"",returnFlightAirline:e.returnFlightAirline??"",returnFlightNumber:e.returnFlightNumber??"",returnFlightDepartAirport:e.returnFlightDepartAirport??"",returnFlightDepartTime:e.returnFlightDepartTime??"",returnFlightArriveAirport:e.returnFlightArriveAirport??"",returnFlightArriveTime:e.returnFlightArriveTime??"",coverImage:e.coverImage??"",notes:e.notes??""}:this._blankDraft()}_set(e,t){this._draft={...this._draft,[e]:t}}_onLodgingChange(e){this._set("lodgingUrl",e),this._previewError="",this._previewDebounce&&clearTimeout(this._previewDebounce);const t=e.trim();if(!t){this._set("coverImage",""),this._set("lodgingHost",""),this._set("lodgingTitle",""),this._lastPreviewedUrl="";return}/^https?:\/\//i.test(t)&&t!==this._lastPreviewedUrl&&(this._previewDebounce=setTimeout(()=>this._runPreview(t),700))}async _runPreview(e){this._previewing=!0,this._previewError="";try{const t=await k.previewUrl(e);if(!t)return;this._lastPreviewedUrl=e,this._draft={...this._draft,coverImage:t.image??this._draft.coverImage,lodgingHost:t.siteName??t.host??this._draft.lodgingHost,lodgingTitle:t.title??this._draft.lodgingTitle}}catch(t){console.warn("Preview failed:",t),(t==null?void 0:t.code)==="functions/unauthenticated"?this._previewError="Preview unavailable — sign in.":(t==null?void 0:t.code)==="functions/invalid-argument"?this._previewError="That URL doesn’t look right.":this._previewError="Preview unavailable — paste it again or skip."}finally{this._previewing=!1}}_toggleAttendee(e){const t=this._draft.attendees.includes(e),i=t?this._draft.attendees.filter(a=>a!==e):[...this._draft.attendees,e];let r=this._draft.viewers??[];t||(r=r.filter(a=>a!==e)),this._draft={...this._draft,attendees:i,viewers:r}}_toggleViewer(e){if(this._draft.attendees.includes(e))return;const i=(this._draft.viewers??[]).includes(e)?this._draft.viewers.filter(r=>r!==e):[...this._draft.viewers??[],e];this._set("viewers",i)}_toggleSubGroup(e){const i=(this._draft.targetSubGroups??[]).includes(e)?this._draft.targetSubGroups.filter(r=>r!==e):[...this._draft.targetSubGroups??[],e];this._set("targetSubGroups",i)}_renderFlightLookupStatus(e){const t=e==="return",i=t?this._returnLookupState:this._outboundLookupState,r=t?this._returnLookupMessage:this._outboundLookupMessage;return i==="idle"?s`<div class="hint">
    ...
    `}}m(ve,"properties",{open:{type:Boolean,reflect:!0},trip:{type:Object},members:{type:Array},currentUid:{type:String},familyId:{type:String},busy:{type:Boolean},formMode:{type:String},subGroups:{type:Object},_draft:{state:!0},_error:{state:!0},_previewing:{state:!0},_previewError:{state:!0},_showReturn:{state:!0},_showOutboundDetails:{state:!0},_showReturnDetails:{state:!0},_showFlight:{state:!0},_outboundLookupState:{state:!0},_outboundLookupMessage:{state:!0},_returnLookupState:{state:!0},_returnLookupMessage:{state:!0}}),m(ve,"styles",z`
    * {
      box-sizing: border-box;
    }
    :host {
  ...
  `);customElements.define("trip-form",ve);class xe extends C{constructor(){super(),this.open=!1,this.event=null,this.members=[],this.familyId="",this.busy=!1,this._draft=this._blankDraft(),this._error=""}willUpdate(e){(e.has("event")||e.has("open"))&&(this.open&&(this._draft=this._draftFromEvent(this.event)),this._error="")}_blankDraft(){return{id:null,type:"birthday",title:"",date:new Date().toISOString().slice(0,10),personIds:[],recurring:!0,subtitle:"",notes:"",visibility:"family"}}_draftFromEvent(e){return e?{id:e.id??null,type:e.type??"birthday",title:e.title??"",date:e.date??new Date().toISOString().slice(0,10),personIds:Array.isArray(e.personIds)?[...e.personIds]:[],recurring:e.recurring??!0,subtitle:e.subtitle??"",notes:e.notes??"",visibility:e.visibility??"family"}:this._blankDraft()}_set(e,t){this._draft={...this._draft,[e]:t}}_toggleType(e){this._set("type",e)}_togglePerson(e){const t=this._draft.personIds.includes(e);this._set("personIds",t?this._draft.personIds.filter(i=>i!==e):[...this._draft.personIds,e])}_onSave(){const e=this._draft;if(!e.title.trim()){this._error="Give it a title.";return}if(!e.date){this._error="Pick a date.";return}if(!this.familyId){this._error="No family yet.";return}this._error="",this.dispatchEvent(new CustomEvent("save",{detail:{...e,title:e.title.trim(),subtitle:e.subtitle.trim(),notes:e.notes.trim()}}))}_onDelete(){this._draft.id&&confirm("Delete this event? This can't be undone.")&&this.dispatchEvent(new CustomEvent("remove",{detail:{id:this._draft.id}}))}_onCancel(){this.dispatchEvent(new Event("cancel"))}render(){if(!this.open)return s``;const e=this._draft,t=!!e.id;return s`
    ...
    `}_monthDay(e){if(!e)return"";const t=new Date(e);return Number.isNaN(t.getTime())?"":t.toLocaleString("en-GB",{day:"numeric",month:"long"})}}m(xe,"properties",{open:{type:Boolean,reflect:!0},event:{type:Object},members:{type:Array},familyId:{type:String},busy:{type:Boolean},_draft:{state:!0},_error:{state:!0}}),m(xe,"styles",z`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("event-form",xe);let R=null,Pe=null;function wt(){return R||(R=document.createElement("div"),R.id="cairn-toast-host",Object.assign(R.style,{position:"fixed",bottom:"24px",left:"50%",transform:"translateX(-50%)",zIndex:9999,pointerEvents:"none"}),document.body.appendChild(R),R)}function v(d,{duration:e=2800}={}){const t=wt();clearTimeout(Pe),t.innerHTML="";const i=document.createElement("div");i.textContent=d,Object.assign(i.style,{padding:"12px 18px",background:"rgba(20, 12, 6, 0.78)",backdropFilter:"blur(24px) saturate(180%)",webkitBackdropFilter:"blur(24px) saturate(180%)",border:"1px solid rgba(255, 248, 235, 0.22)",borderRadius:"999px",color:"rgba(255, 248, 235, 0.96)",fontFamily:"'Inter', system-ui, sans-serif",fontSize:"13.5px",fontWeight:"500",letterSpacing:"0.005em",boxShadow:"0 12px 32px rgba(20, 12, 6, 0.45)",pointerEvents:"auto",transform:"translateY(8px)",opacity:"0",transition:"opacity 200ms ease, transform 240ms ease"}),t.appendChild(i),requestAnimationFrame(()=>{i.style.opacity="1",i.style.transform="translateY(0)"}),Pe=setTimeout(()=>{i.style.opacity="0",i.style.transform="translateY(8px)",setTimeout(()=>i.remove(),260)},e)}class ye extends C{constructor(){super(),this.open=!1,this.family=null,this.immediate=[],this.extended=[],this._busy=!1,this._newGroupName="",this._editingGroupId=null}_onCancel(){this.dispatchEvent(new Event("cancel"))}async _createSubGroup(){const e=this._newGroupName.trim();if(!(!e||this._busy)){this._busy=!0;try{const t=await k.saveSubGroup({name:e,memberIds:[]});this._newGroupName="",this._editingGroupId=t,v(`Sub-group "${e}" created.`)}catch(t){v(`Couldn't create: ${t.code??t.message}`,{duration:5e3})}finally{this._busy=!1}}}async _toggleSubGroupMember(e,t){var n,o;const i=(o=(n=this.family)==null?void 0:n.subGroups)==null?void 0:o[e];if(!i)return;const r=i.memberIds??[],a=r.includes(t)?r.filter(l=>l!==t):[...r,t];try{await k.saveSubGroup({id:e,name:i.name,memberIds:a})}catch(l){v(`Couldn't update: ${l.code??l.message}`,{duration:5e3})}}async _deleteSubGroup(e,t){if(confirm(`Delete the "${t}" sub-group?`))try{await k.deleteSubGroup(e),this._editingGroupId===e&&(this._editingGroupId=null),v("Sub-group deleted.")}catch(i){v(`Couldn't delete: ${i.code??i.message}`,{duration:5e3})}}async _regenerate(){if(!this._busy){this._busy=!0;try{await k.regenerateCairnInviteCode(),v("New invite code generated.")}catch(e){console.error(e),v(`Couldn't generate code: ${e.code??e.message}`,{duration:5e3})}finally{this._busy=!1}}}_inviteLink(e){return`${window.location.origin}/cairn/?join=${e}`}async _copyLink(){var t;const e=(t=this.family)==null?void 0:t.cairnInviteCode;if(e)try{await navigator.clipboard.writeText(this._inviteLink(e)),v("Invite link copied to clipboard.")}catch{v("Could not copy — try long-press the link instead.")}}async _share(){var i,r;const e=(i=this.family)==null?void 0:i.cairnInviteCode;if(!e)return;const t=this._inviteLink(e);if(navigator.share)try{await navigator.share({title:"Join my family on Cairn",text:`Join ${((r=this.family)==null?void 0:r.name)??"our family"} on Cairn — our shared family calendar.`,url:t})}catch{}else this._copyLink()}_expiryText(e){if(!e)return"";const t=e.toDate?e.toDate():new Date(e),r=Math.max(0,Math.round((t-new Date)/(1440*60*1e3)));return r===0?"Expires today":r===1?"Expires tomorrow":`Expires in ${r} days`}render(){var r,a,n,o;if(!this.open)return s``;const e=(r=this.family)==null?void 0:r.cairnInviteCode,t=(a=this.family)==null?void 0:a.cairnInviteCodeExpiresAt,i=t&&(t.toDate?t.toDate():new Date(t))<new Date;return s`
    ...
    `}}m(ye,"properties",{open:{type:Boolean,reflect:!0},family:{type:Object},immediate:{type:Array},extended:{type:Array},_busy:{state:!0},_newGroupName:{state:!0},_editingGroupId:{state:!0}}),m(ye,"styles",z`
    * {
      box-sizing: border-box;
    }
    :host {
...
`)}class we extends C{constructor(){super(),this.trip=null,this.members=[],this._resizeObs=null}connectedCallback(){super.connectedCallback(),typeof ResizeObserver<"u"&&(this._resizeObs=new ResizeObserver(()=>this._fitTitle()))}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._resizeObs)==null||e.disconnect()}updated(){if(this._resizeObs&&this.renderRoot){const e=this.renderRoot.querySelector("article");e&&!e._observed&&(this._resizeObs.observe(e),e._observed=!0)}this._fitTitle()}_fitTitle(){if(!this.renderRoot)return;const e=this.renderRoot.querySelector("h3");if(!e)return;e.style.fontSize="";let t=19;for(e.style.fontSize=`${t}px`;e.scrollWidth>e.clientWidth+1&&t>13;)t-=.5,e.style.fontSize=`${t}px`}_fmtDates(e,t){const i=D(e),r=D(t);if(!i||!r)return"";const a=i.toLocaleString("en-GB",{month:"short"}),n=r.toLocaleString("en-GB",{month:"short"});return a===n&&i.getFullYear()===r.getFullYear()?`${i.getDate()} – ${r.getDate()} ${a}`:`${i.getDate()} ${a} – ${r.getDate()} ${n}`}async _onShare(e,t,i){i.stopPropagation();const r=_t(e,t);if(navigator.share)try{await navigator.share({title:`Cairn — ${e.title??"activity"}`,text:r})}catch{}else try{await navigator.clipboard.writeText(r),v("Itinerary copied to clipboard.")}catch{v("Could not copy — try again from a browser tab.")}}render(){const e=this.trip;if(!e)return s``;const t=e.coverImage?`background-image: url(${e.coverImage});`:`background: ${yt(e)};`,i=e.coverImage?"cover has-image":"cover",r=new Map(this.members.map(l=>[l.uid,l])),a=(e.attendees??[]).map(l=>r.get(l)).filter(Boolean),n=a.slice(0,4),o=Math.max(0,a.length-n.length);return s`
    ...
    `}}m(we,"properties",{trip:{type:Object},members:{type:Array}}),m(we,"styles",z`
    :host {
      display: block;
    }
    article {
  ...
  `);customElements.define("trip-card",we);class _e extends C{constructor(){super(),this.open=!1,this.trips=[],this.members=[]}_onCancel(){this.dispatchEvent(new Event("cancel"))}_groupByYear(e){const t=[...e].sort((a,n)=>String(a.start).localeCompare(String(n.start))),i=new Date;i.setHours(0,0,0,0);const r=new Map;for(const a of t){if(!a.start)continue;const n=D(a.start),o=D(a.end);if(!n)continue;const l=n.getFullYear();r.has(l)||r.set(l,[]);const c=o?o<i:!1;r.get(l).push({trip:a,isPast:c})}return r}render(){var r;if(!this.open)return s``;const e=this._groupByYear(this.trips??[]),t=((r=this.trips)==null?void 0:r.length)??0,i=new Date().getFullYear();return s`
      <div class="backdrop" @click=${this._onCancel}></div>
      <div class="sheet">
        <glass-panel padding="lg" variant="strong" lifted>
          <div class="header">
    ...
    `}}m(_e,"properties",{open:{type:Boolean,reflect:!0},trips:{type:Array},members:{type:Array}}),m(_e,"styles",z`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("all-trips-modal",_e);class ke extends C{constructor(){super(),this.open=!1,this._events=[],this._selected=new Set,this._loading=!1,this._error="",this._importing=!1}willUpdate(e){e.has("open")&&this.open&&this._events.length===0&&!this._loading&&this._load()}async _load(){var e,t,i,r,a,n;this._loading=!0,this._error="";try{const o=await Xe(),l=await vt(o,90),c=new Set((k.state.trips??[]).filter(h=>h.gcalEventId).map(h=>h.gcalEventId));this._events=l.map(h=>({...h,_alreadyImported:c.has(h.id)}));const p=new Set;for(const h of this._events){if(h._alreadyImported)continue;const g=((e=h.start)==null?void 0:e.date)??((i=(t=h.start)==null?void 0:t.dateTime)==null?void 0:i.slice(0,10)),x=((r=h.end)==null?void 0:r.date)??((n=(a=h.end)==null?void 0:a.dateTime)==null?void 0:n.slice(0,10));g&&x&&x!==g&&p.add(h.id)}this._selected=p}catch(o){console.error(o),this._error=(o==null?void 0:o.message)??"Could not load calendar events."}finally{this._loading=!1}}_toggle(e){const t=new Set(this._selected);t.has(e)?t.delete(e):t.add(e),this._selected=t}_toggleAll(){const e=this._events.filter(t=>!t._alreadyImported);this._selected.size===e.length?this._selected=new Set:this._selected=new Set(e.map(t=>t.id))}async _import(){var a;if(this._importing||this._selected.size===0)return;this._importing=!0;const e=(a=$==null?void 0:$.currentUser)==null?void 0:a.uid,t=this._events.filter(n=>this._selected.has(n.id));let i=0,r=0;for(const n of t){const o=xt(n,e);try{await k.saveTrip(o),i++}catch(l){console.error("Import failed for event",n.id,l),r++}}this._importing=!1,r===0?v(`Imported ${i} ${i===1?"activity":"activities"}.`):v(`Imported ${i}, ${r} failed.`,{duration:5e3}),this._events=[],this._selected=new Set,this.dispatchEvent(new Event("cancel"))}_onCancel(){this.dispatchEvent(new Event("cancel"))}_fmtRange(e){var p,h,g,x,w,u,b,_;const t=((p=e.start)==null?void 0:p.date)??((g=(h=e.start)==null?void 0:h.dateTime)==null?void 0:g.slice(0,10)),i=((x=e.end)==null?void 0:x.date)??((u=(w=e.end)==null?void 0:w.dateTime)==null?void 0:u.slice(0,10));if(!t)return"";const r=new Date(t);if(!i||i===t)return r.toLocaleString("en-GB",{day:"numeric",month:"short",year:"numeric"});let a=new Date(i);(b=e.start)!=null&&b.date&&((_=e.end)!=null&&_.date)&&a.setDate(a.getDate()-1);const n=r.getMonth()===a.getMonth()&&r.getFullYear()===a.getFullYear(),o=r.getFullYear()===a.getFullYear();if(n)return`${r.getDate()}–${a.getDate()} ${r.toLocaleString("en-GB",{month:"short",year:"numeric"})}`;const l=r.toLocaleString("en-GB",{day:"numeric",month:"short"}),c=a.toLocaleString("en-GB",{day:"numeric",month:"short",year:"numeric"});return o?`${l} – ${c}`:`${r.toLocaleDateString()} – ${a.toLocaleDateString()}`}render(){if(!this.open)return s``;const e=this._events.filter(i=>!i._alreadyImported),t=e.length>0&&this._selected.size===e.length;return s`
      <div class="backdrop" @click=${this._onCancel}></div>
      <div class="sheet">
        <glass-panel padding="lg" variant="strong" lifted>
          <div class="header">
    ...
    `}}m(ke,"properties",{open:{type:Boolean,reflect:!0},_events:{state:!0},_selected:{state:!0},_loading:{state:!0},_error:{state:!0},_importing:{state:!0}}),m(ke,"styles",z`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("import-calendar-modal",ke);class $e extends C{constructor(){super(),this.open=!1,this.user=null,this.pebbleUser=null,this._name="",this._savingName=!1,this._uploadingPhoto=!1}willUpdate(e){var t;e.has("open")&&this.open&&(this._name=((t=this.user)==null?void 0:t.displayName)??"")}_onCancel(){this.dispatchEvent(new Event("cancel"))}async _saveName(){var t,i;const e=this._name.trim();if(!(!e||e===(((t=this.user)==null?void 0:t.displayName)??""))&&!(!((i=$==null?void 0:$.currentUser)!=null&&i.uid)||!y)){this._savingName=!0;try{await L(E(y,"users",$.currentUser.uid),{displayName:e,updatedAt:S()}),v("Display name updated.")}catch(r){console.error(r),v(`Couldn't save: ${r.code??r.message}`,{duration:5e3})}finally{this._savingName=!1}}}async _signOut(){confirm("Sign out of Cairn?")&&(this.dispatchEvent(new Event("cancel")),await We())}_triggerPhotoPicker(){var e;(e=this.renderRoot.querySelector("#photo-file"))==null||e.click()}async _onPhotoChosen(e){var a,n;const t=(a=e.target.files)==null?void 0:a[0];if(e.target.value="",!t)return;if(!t.type.startsWith("image/")){v("Pick an image file (JPG, PNG, etc.).");return}if(t.size>5*1024*1024){v("Photo is too big — keep it under 5 MB.");return}const i=(n=$==null?void 0:$.currentUser)==null?void 0:n.uid,r=k.familyId;if(!i||!r||!he){v("Can't upload yet — you need to be in a family first.");return}this._uploadingPhoto=!0;try{const o=Ye(he,`families/${r}/avatars/users/${i}`);await Re(o,t,{contentType:t.type});const l=await He(o);await L(E(y,"users",i),{profilePhotoURL:l,updatedAt:S()}),v("Photo updated.")}catch(o){console.error("Photo upload failed",o),v(`Upload failed: ${o.code??o.message}`,{duration:5e3})}finally{this._uploadingPhoto=!1}}render(){if(!this.open)return s``;const e=this.user,t=this._name.trim()&&this._name.trim()!==((e==null?void 0:e.displayName)??"");return s`
      <div class="backdrop" @click=${this._onCancel}></div>
      <div class="sheet">
        <glass-panel padding="lg" variant="strong" lifted>
          <div class="header">
    ...
    `}}m($e,"properties",{open:{type:Boolean,reflect:!0},user:{type:Object},pebbleUser:{type:Object},_name:{state:!0},_savingName:{state:!0},_uploadingPhoto:{state:!0}}),m($e,"styles",z`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("profile-sheet",$e);const Z=class Z extends C{constructor(){super(),this.open=!1}static get OPTIONS(){return[{type:"activity",tone:"sage",icon:s`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    `:s``}};m(Z,"properties",{open:{type:Boolean,reflect:!0}}),m(Z,"styles",z`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);let De=Z;customElements.define("activity-type-picker",De);class Ce extends C{constructor(){super(),this.open=!1,this.floating=!1,this.family=null,this.trips=[],this._messages=[],this._input="",this._loading=!1,this._error="",this._followUps=[]}willUpdate(e){var t;e.has("_messages")&&(this.floating=(((t=this._messages)==null?void 0:t.length)??0)>0)}_onCancel(){this.dispatchEvent(new Event("cancel"))}_suggestions(){const e=[],t=(this.trips??[]).filter(i=>i.start&&new Date(i.start)>=new Date).sort((i,r)=>String(i.start).localeCompare(String(r.start)))[0];return t&&(e.push(`What should we do in ${t.location||t.title}?`),e.push(`What should we pack for ${t.title}?`)),e.push("Plan a family activity for this weekend"),e.push("Gift ideas for an upcoming birthday"),e.slice(0,4)}async _send(e){const t=(e??this._input).trim();if(!(!t||this._loading)){this._error="",this._input="",this._followUps=[],this._messages=[...this._messages,{role:"user",content:t}],this._loading=!0,this.updateComplete.then(()=>this._scrollToBottom());try{const i=this._messages.slice(0,-1).map(a=>({role:a.role,content:a.content})),r=await k.askPebble(t,i);this._messages=[...this._messages,{role:"assistant",content:r.answer}],this._followUps=Array.isArray(r.followUps)?r.followUps:[]}catch(i){console.error(i),(i==null?void 0:i.code)==="functions/unauthenticated"?this._error="Pebble needs you to be signed in.":(i==null?void 0:i.code)==="functions/permission-denied"?this._error="You're not in this family yet.":(i==null?void 0:i.code)==="functions/not-found"||(i==null?void 0:i.code)==="functions/internal"?this._error="Pebble isn't available right now — the Cloud Function may not be deployed yet.":this._error=(i==null?void 0:i.message)??"Pebble could not answer right now."}finally{this._loading=!1,this.updateComplete.then(()=>this._scrollToBottom())}}}_scrollToBottom(){const e=this.renderRoot.querySelector(".thread");e&&(e.scrollTop=e.scrollHeight)}_renderPebbleIcon(){return s`
    ...
    `}}m(Ce,"properties",{open:{type:Boolean,reflect:!0},floating:{type:Boolean,reflect:!0},family:{type:Object},trips:{type:Array},_messages:{state:!0},_input:{state:!0},_loading:{state:!0},_error:{state:!0},_followUps:{state:!0}}),m(Ce,"styles",z`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("pebble-chat",Ce);class Ze extends C{render(){return s`
  ...
  `);customElements.define("discover-pebblepath",Ze);class ze extends C{constructor(){super(),this.code="",this._family=null,this._loading=!0,this._joining=!1,this._error=""}willUpdate(e){e.has("code")&&this.code&&this._lookup()}async _lookup(){var e,t;this._loading=!0,this._error="";try{const i=await k.findFamilyByCairnCode(this.code);if(!i)this._error="Invite code not found. Check it was typed correctly.",this._family=null;else{const r=((t=(e=i.cairnInviteCodeExpiresAt)==null?void 0:e.toDate)==null?void 0:t.call(e))??(i.cairnInviteCodeExpiresAt?new Date(i.cairnInviteCodeExpiresAt):null);!r||r<new Date?(this._error="This invite code has expired. Ask the family for a fresh one.",this._family=null):this._family=i}}catch(i){console.error(i),this._error=(i==null?void 0:i.message)??"Couldn't look up the invite."}finally{this._loading=!1}}async _join(){var e;if(!this._joining){this._joining=!0,this._error="";try{const t=await k.joinFamilyAsCairn(this.code);v(`Welcome to ${((e=this._family)==null?void 0:e.name)??"the family"}.`),this.dispatchEvent(new CustomEvent("joined",{detail:{familyId:t}}))}catch(t){console.error(t),this._error=(t==null?void 0:t.message)??"Could not join."}finally{this._joining=!1}}}_cancel(){this.dispatchEvent(new Event("cancel"))}_inviterFromFamily(e){var r;if(!e)return null;const t=(r=e.memberProfiles)==null?void 0:r[e.createdBy];if(!t)return null;const i=t.profilePhotoURL;return{displayName:t.displayName??"A family member",photoURL:typeof i=="string"&&/^https?:\/\//i.test(i)?i:null}}render(){var r,a,n;const e=this._inviterFromFamily(this._family),t=(((r=this._family)==null?void 0:r.cairnMemberIds)??((a=this._family)==null?void 0:a.memberIds)??[]).length,i=(((n=this._family)==null?void 0:n.memberIds)??[]).length;return s`
    ...
    `}}m(ze,"properties",{code:{type:String},_family:{state:!0},_loading:{state:!0},_joining:{state:!0},_error:{state:!0}}),m(ze,"styles",z`
    * { box-sizing: border-box; }
    :host {
      display: flex;
      align-items: center;
  ...
  `);customElements.define("join-family-screen",ze);class Se extends C{constructor(){super(),this.error="",this.busy=!1,this.joinCode="",this._codeInputOpen=!1,this._code=""}async _handleSignIn(){if(this.busy)return;const e=(this._code??"").trim().toUpperCase();if(this._codeInputOpen&&e){const t=e.startsWith("CAIRN-")?e:`CAIRN-${e.replace(/^CAIRN-?/i,"")}`;try{localStorage.setItem("cairn:pendingJoinCode",t)}catch{}}this.busy=!0,this.error="";try{await qe()}catch(t){this.error=(t==null?void 0:t.message)??"Sign-in failed."}finally{this.busy=!1}}_toggleCode(){this._codeInputOpen=!this._codeInputOpen,this._codeInputOpen&&requestAnimationFrame(()=>{var e;(e=this.renderRoot.querySelector(".code-input"))==null||e.focus()})}_renderGoogleIcon(){return s`
    ...
    `}}m(Se,"properties",{error:{state:!0},busy:{state:!0},joinCode:{type:String},_codeInputOpen:{state:!0},_code:{state:!0}}),m(Se,"styles",z`
    * {
      box-sizing: border-box;
    }
    :host {
  ...
  `);customElements.define("sign-in-screen",Se);const X=class X extends C{constructor(){super(),this.value="family"}_select(e){e!==this.value&&(this.value=e,this.dispatchEvent(new CustomEvent("circle-change",{detail:{value:e},bubbles:!0,composed:!0})))}render(){return s`
    ...
    `}};m(X,"properties",{value:{type:String,reflect:!0}}),m(X,"OPTIONS",[{value:"personal",label:"Just me"},{value:"family",label:"Family"},{value:"extended",label:"Extended"}]),m(X,"styles",z`
    * {
      box-sizing: border-box;
    }
    :host {
  ...
  `);let Fe=X;customElements.define("circle-switcher",Fe);class Ae extends C{constructor(){super(),this.event=null,this.members=[]}_icon(e){return e==="birthday"?s`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
    ...
    </svg>`}_fmtDate(e){const t=D(e)??new Date(e);return{day:t.getDate(),month:t.toLocaleString("en-GB",{month:"short"})}}render(){const e=this.event;if(!e)return s``;const t=this._fmtDate(e.date),i=new Map((this.members??[]).map(a=>[a.uid,a])),r=(e.personIds??[]).map(a=>i.get(a)).filter(Boolean);return s`
      <div
        class="row"
    ...
    `}}m(Ae,"properties",{event:{type:Object},members:{type:Array}}),m(Ae,"styles",z`
    :host {
      display: block;
    }
    .row {
  ...
  `);customElements.define("event-row",Ae);const kt={uid:"preview-user",displayName:"Thomas Paris",email:"thomas@example.com",photoURL:null},je=[{uid:"thomas",displayName:"Thomas",circles:["immediate"],hue:198},{uid:"partner",displayName:"Élise",circles:["immediate"],hue:8},{uid:"kid1",displayName:"Oscar",circles:["immediate"],hue:142},{uid:"kid2",displayName:"Mila",circles:["immediate"],hue:44},{uid:"mum",displayName:"Mum",circles:["extended"],hue:320},{uid:"dad",displayName:"Dad",circles:["extended"],hue:28},{uid:"sister",displayName:"Camille",circles:["extended"],hue:280},{uid:"bro-in-law",displayName:"Sam",circles:["extended"],hue:175},{uid:"niece",displayName:"Léa",circles:["extended"],hue:100}],$t=[{id:"t1",title:"Côte d’Azur, summer",location:"Antibes, France",start:"2026-07-12",end:"2026-07-21",coverGradient:"linear-gradient(135deg, #6b9ac4 0%, #c98a8a 60%, #d4a843 100%)",lodgingHost:"Airbnb",lodgingTitle:"Villa near Cap d’Antibes",attendees:["thomas","partner","kid1","kid2","mum","dad"],notes:"Mum + Dad arrive day 2. Dinner reservations at La Guérite booked.",visibility:"extended"},{id:"t2",title:"Half-term in the Alps",location:"Chamonix, France",start:"2026-10-24",end:"2026-10-31",coverGradient:"linear-gradient(135deg, #7a9e7e 0%, #4a6754 70%, #2c4439 100%)",lodgingHost:"Booking.com",lodgingTitle:"Chalet Les Drus",attendees:["thomas","partner","kid1","kid2"],notes:"Need ski school for the kids — book by September.",visibility:"immediate"},{id:"t3",title:"Camille’s 40th",location:"Lisbon, Portugal",start:"2026-09-05",end:"2026-09-08",coverGradient:"linear-gradient(135deg, #c67b5c 0%, #d4a843 50%, #c98a8a 100%)",lodgingHost:"Airbnb",lodgingTitle:"Alfama rooftop apartment",attendees:["thomas","partner","sister","bro-in-law"],notes:"Surprise. Don’t mention to Camille.",visibility:"family"}],Dt=[{id:"e1",type:"birthday",date:"2026-05-24",personIds:["mum"],title:"Mum’s birthday"},{id:"e2",type:"anniversary",date:"2026-05-28",personIds:["mum","dad"],title:"Mum & Dad’s anniversary",subtitle:"38 years"},{id:"e3",type:"birthday",date:"2026-06-11",personIds:["kid1"],title:"Oscar turns 7"},{id:"e4",type:"birthday",date:"2026-06-30",personIds:["niece"],title:"Léa’s birthday"}];class Ee extends C{constructor(){super(),this.user=kt,this.pebbleUser=null,this.family=null,this.children=[],this.trips=[],this.events=[],this.preview=!1,this.circle="extended",this._formOpen=!1,this._formTrip=null,this._formBusy=!1,this._membersOpen=!1,this._eventFormOpen=!1,this._eventFormEvent=null,this._eventFormBusy=!1,this._allTripsOpen=!1,this._editingFamilyName=!1,this._importOpen=!1,this._profileOpen=!1,this._typePickerOpen=!1,this._formMode="trip",this._pebbleOpen=!1,this._dragOverTarget=null;const e=new Date;this._displayMonth=new Date(e.getFullYear(),e.getMonth(),1)}async _saveFamilyName(e){var a,n;const i=(e.target.value??"").trim(),r=((a=this.family)==null?void 0:a.name)??"";if(i&&i!==r&&((n=this.family)!=null&&n.id))try{const{db:o,doc:l,updateDoc:c,serverTimestamp:p}=await Je(async()=>{const{db:h,doc:g,updateDoc:x,serverTimestamp:w}=await Promise.resolve().then(()=>ht);return{db:h,doc:g,updateDoc:x,serverTimestamp:w}},void 0);await c(l(o,"families",this.family.id),{name:i,updatedAt:p()}),v("Family name updated.")}catch(o){console.error("Update family name failed:",o),v(`Couldn't save: ${o.code??o.message}`,{duration:5e3})}this._editingFamilyName=!1}_liveImmediate(){var e;return this.preview||!((e=this.user)!=null&&e.uid)?je.filter(t=>t.circles.includes("immediate")):gt(this.user.uid,this.user,this.pebbleUser,this.family,this.children)}_liveExtended(){return this.preview?je.filter(e=>e.circles.includes("extended")):[]}_liveTrips(){return this.preview?$t:this.trips??[]}_liveEvents(){if(this.preview)return Dt;const e=r=>{const{date:a,yearsElapsed:n}=bt(r);return{...r,date:a?ft(a):r.date,_yearsElapsed:n,_originalDate:r.date}},t=mt(this.children).map(e),i=(this.events??[]).map(e);return[...t,...i].sort((r,a)=>String(r.date).localeCompare(String(a.date)))}_filteredMembers(){const e=this._liveImmediate(),t=this._liveExtended();return this.circle==="personal"?e.filter(i=>{var r;return i.uid===((r=this.user)==null?void 0:r.uid)}):this.circle==="family"?e:[...e,...t]}_circleTrips(){var n;const e=this._liveTrips(),t=((n=this.user)==null?void 0:n.uid)??"thomas";let i;this.circle==="personal"?i=e.filter(o=>{var l;return(l=o.attendees)==null?void 0:l.includes(t)}):this.circle==="family"?i=e.filter(o=>o.visibility!=="extended"&&this._userCanSeeTrip(o)):i=e.filter(o=>this._userCanSeeTrip(o));const r=new Set,a=[];for(const o of i){const l=o.id??`${o.title}|${o.start}|${o.end}`;r.has(l)||(r.add(l),a.push(o))}return a}_filteredTrips(){const e=new Date;return e.setHours(0,0,0,0),this._circleTrips().filter(t=>t.end?D(t.end)>=e:!0)}_userCanSeeTrip(e){var i,r,a,n,o;const t=(i=this.user)==null?void 0:i.uid;if(!t)return!1;if((r=e.attendees)!=null&&r.includes(t)||(a=e.viewers)!=null&&a.includes(t)||e.visibility==="family")return!0;if(e.visibility==="extended"){if((((n=this.family)==null?void 0:n.memberIds)??[]).includes(t))return!0;const l=e.targetSubGroups??[];if(l.length===0)return!0;const c=Object.entries(((o=this.family)==null?void 0:o.subGroups)??{}).filter(([,p])=>(p.memberIds??[]).includes(t)).map(([p])=>p);return l.some(p=>c.includes(p))}return!1}_filteredEvents(){const e=new Set(this._filteredMembers().map(t=>t.uid));return this._liveEvents().filter(t=>t.personIds.some(i=>e.has(i)))}_smartCallout(){var o,l;const e=new Date,t=new Date(e.getFullYear(),e.getMonth(),e.getDate()),i=1440*60*1e3,r=c=>Math.round((c-t)/i);for(const c of this._circleTrips()){if(!c.start||!c.end)continue;const p=D(c.start),h=D(c.end);if(p.setHours(0,0,0,0),h.setHours(0,0,0,0),p<=t&&t<=h){const g=r(p)+1,x=r(h)-r(p)+1,w=((o=c.location)==null?void 0:o.trim())||c.title;return`Day ${g} of ${x} in ${w}.`}}let a=null,n=1/0;for(const c of this._circleTrips()){if(!c.start)continue;const p=D(c.start);if(!p)continue;const h=r(p);h>0&&h<n&&(a={kind:"trip",item:c},n=h)}for(const c of this._filteredEvents()){if(!c.date)continue;const p=D(c.date);if(!p)continue;const h=r(p);h>=0&&h<n&&(a={kind:"event",item:c},n=h)}if(!a)return null;if(a.kind==="trip"){const c=((l=a.item.location)==null?void 0:l.trim())||a.item.title;return n===1?`${c} starts tomorrow.`:n<=14?`${c} in ${n} days.`:n<=60?`Next trip: ${c} in ${n} days.`:null}return n===0?`${a.item.title} — today.`:n===1?`${a.item.title} — tomorrow.`:n<=7?`${a.item.title} in ${n} days.`:null}_tripDensityByDay(e){const t=new Map;for(const i of this._filteredTrips()){if(!i.start||!i.end)continue;const r=D(i.start),a=D(i.end);if(Number.isNaN(r.getTime())||Number.isNaN(a.getTime())||r.getFullYear()>e||a.getFullYear()<e)continue;const n=new Date(Math.max(r,new Date(e,0,1))),o=new Date(Math.min(a,new Date(e,11,31)));for(;n<=o;){const l=`${String(n.getMonth()+1).padStart(2,"0")}-${String(n.getDate()).padStart(2,"0")}`;t.set(l,Math.min(1,(t.get(l)??0)+.5)),n.setDate(n.getDate()+1)}}return t}_shiftMonth(e){const t=this._displayMonth;this._displayMonth=new Date(t.getFullYear(),t.getMonth()+e,1)}_jumpToMonth(e,t){this._displayMonth=new Date(e,t,1)}_resetToToday(){const e=new Date;this._displayMonth=new Date(e.getFullYear(),e.getMonth(),1)}_renderStone({label:e,members:t,pebbleClass:i,emptyLabel:r,onClick:a,maxChips:n=6,dropTargetId:o=null,draggable:l=()=>!1}){const c=o?{dragover:w=>{var u;(u=w.dataTransfer.types)!=null&&u.includes("text/cairn-uid")&&(w.preventDefault(),this._dragOverTarget=o)},dragleave:()=>{this._dragOverTarget===o&&(this._dragOverTarget=null)},drop:async w=>{w.preventDefault(),this._dragOverTarget=null;const u=w.dataTransfer.getData("text/cairn-uid");if(!u)return;const b=o==="extended"?null:o;try{await k.setCairnMemberSubGroup(u,b),v(b?`Moved to ${e}.`:"Moved to extended.")}catch(_){console.error("Move failed:",_),v(`Couldn't move: ${_.code??_.message}`,{duration:4e3})}}}:{},p=o&&this._dragOverTarget===o,h=`pebble ${i}${p?" pebble-drop":""}`;if(!t||t.length===0)return s`
        <button
          class="stone"
          @click=${a}
          title=${r}
      ...
      `;const g=t.slice(0,n),x=t.length-g.length;return s`
      <button
        class="stone"
        @click=${a}
      ...
      >
        <span class="${h}">
          <span class="stone-chips">
            ${g.map(w=>{const u=l(w);return s`
                <member-chip
                  draggable=${u?"true":"false"}
                  class=${u?"is-draggable":""}
                  @dragstart=${b=>{if(!u){b.preventDefault();return}b.stopPropagation(),b.dataTransfer.setData("text/cairn-uid",w.uid),b.dataTransfer.effectAllowed="move"}}
                  .name=${w.displayName}
                  .photo=${w.photoURL??""}
                  .hue=${w.hue}
                  size="26"
    ...
    `}_renderMonthly(){const e=new Date,t=this._displayMonth??e,i=t.getFullYear(),r=t.getMonth(),n=(new Date(i,r,1).getDay()+6)%7,o=new Date(i,r+1,0).getDate(),l=new Map,c=(b,_)=>{l.has(b)||l.set(b,_)},p=[];for(const b of this._filteredEvents()){const _=D(b.date);_&&_.getFullYear()===i&&_.getMonth()===r&&(p.push(_.getDate()),c(_.getDate(),b.title??""))}const h=new Set;for(const b of this._filteredTrips()){if(!b.start||!b.end)continue;const _=D(b.start),F=D(b.end);if(Number.isNaN(_.getTime())||Number.isNaN(F.getTime())||_.getFullYear()>i||F.getFullYear()<i||_.getMonth()>r&&F.getMonth()>r||_.getMonth()<r&&F.getMonth()<r)continue;const N=_.getMonth()===r?_.getDate():1,A=F.getMonth()===r?F.getDate():o;for(let M=N;M<=A;M++)h.add(M),c(M,b.title??"")}const g=[];for(let b=0;b<n;b++)g.push(s`<div class="cal-cell empty"></div>`);const x=e.getFullYear()===i&&e.getMonth()===r;for(let b=1;b<=o;b++){const _=x&&b===e.getDate(),F=p.includes(b),N=h.has(b),A=_?l.get(b)??"Today":l.get(b),M=["cal-cell",_?"today":"",F?"has-event":"",N?"has-trip":""].filter(Boolean).join(" ");g.push(s`<div class=${M} title=${A?`${b} — ${A}`:""}>
        <span class="cal-cell-day">${b}</span>
        ${A?s`<span class="cal-cell-label">${A}</span>`:""}
      </div>`)}const w=new Date(i,r,1).toLocaleString("en-GB",{month:"long",year:"numeric"});return s`
      <div class="cal-head">
        <h3>${w}</h3>
        <div class="nav">
          ${!x?s`<button
    ...
    `}_openCreate(){if(this.preview){v("Sign in to create real activities.");return}if(!k.familyId){v("You need a PebblePath family first.");return}this._typePickerOpen=!0}_onTypePicked(e){this._typePickerOpen=!1;const t=e.detail.type;if(t==="event"){this._eventFormEvent=null,this._eventFormOpen=!0;return}if(t==="import"){this._importOpen=!0;return}this._formMode=t,this._formTrip=null,this._formOpen=!0}_openEdit(e){if(this.preview){v("Sign in to edit real activities.");return}const t=e.lodgingUrl||e.lodgingHost||e.flightNumber||e.flightDepartAirport;this._formMode=t?"trip":"activity",this._formTrip=e,this._formOpen=!0}async _onSaveTrip(e){const t=e.detail;this._formBusy=!0;try{await k.saveTrip(t),this._formOpen=!1,this._formTrip=null,v(t.id?"Trip updated.":"Trip created.")}catch(i){console.error("Save trip failed:",i),v(`Couldn't save: ${i.code??i.message}`,{duration:5e3})}finally{this._formBusy=!1}}async _onDeleteTrip(e){this._formBusy=!0;try{await k.deleteTrip(e.detail.id),this._formOpen=!1,this._formTrip=null,v("Trip deleted.")}catch(t){console.error("Delete trip failed:",t),v(`Couldn't delete: ${t.code??t.message}`,{duration:5e3})}finally{this._formBusy=!1}}_openCreateEvent(){if(this.preview){v("Sign in to add real events.");return}if(!k.familyId){v("You need a family first.");return}this._eventFormEvent=null,this._eventFormOpen=!0}_openEditEvent(e){if(this.preview){v("Sign in to edit real events.");return}if(e!=null&&e._childId){const t=prompt(`Edit ${e._childName}'s birthday (YYYY-MM-DD):`,e.date);if(!t)return;if(!/^\d{4}-\d{2}-\d{2}$/.test(t)){v("Use YYYY-MM-DD format.");return}k.updateChildBirthday(e._childId,new Date(t)).then(()=>v(`Updated ${e._childName}'s birthday.`)).catch(i=>{console.error("Update child birthday failed:",i),v(`Couldn't update: ${i.code??i.message}`,{duration:5e3})});return}this._eventFormEvent={...e,date:e._originalDate??e.date},this._eventFormOpen=!0}async _onSaveEvent(e){this._eventFormBusy=!0;try{await k.saveEvent(e.detail),this._eventFormOpen=!1,this._eventFormEvent=null,v(e.detail.id?"Event updated.":"Event added.")}catch(t){console.error("Save event failed:",t),v(`Couldn't save: ${t.code??t.message}`,{duration:5e3})}finally{this._eventFormBusy=!1}}async _onDeleteEvent(e){this._eventFormBusy=!0;try{await k.deleteEvent(e.detail.id),this._eventFormOpen=!1,this._eventFormEvent=null,v("Event deleted.")}catch(t){console.error("Delete event failed:",t),v(`Couldn't delete: ${t.code??t.message}`,{duration:5e3})}finally{this._eventFormBusy=!1}}render(){var x,w,u,b,_,F,N,A,M,O,W;const e=this._filteredTrips(),t=this._filteredEvents(),i=this._liveImmediate(),r=this._liveExtended(),a=i.concat(r),n=(((x=this.user)==null?void 0:x.displayName)??"there").split(" ")[0],o=new Date,l=new Date(o.getFullYear(),o.getMonth(),1),c=new Date(o.getFullYear(),o.getMonth()+1,0),p=t.filter(f=>{const I=D(f.date);return I&&I.getFullYear()===o.getFullYear()&&I.getMonth()===o.getMonth()}),g=this._circleTrips().filter(f=>{if(!f.start||!f.end)return!1;const I=D(f.start),Y=D(f.end);return Number.isNaN(I.getTime())||Number.isNaN(Y.getTime())?!1:I<=c&&Y>=l}).length+p.length;return s`
      <div class="topbar">
        <div class="brand">
          <img
            class="brand-icon"
        ...
        <div
          class="pebble-search"
          @click=${f=>{var I;f.target.tagName!=="INPUT"&&((I=this.renderRoot.querySelector(".pebble-search-input"))==null||I.focus())}}
        >
        ...
        <div class="who">
          ...
          <button
            ...
            title="${((w=this.user)==null?void 0:w.displayName)??"Profile"} — open settings"
      ...
      <main>
        <div class="hello">
          <div>
            <h1>Hi ${n}.</h1>
            ${(()=>{const f=this._smartCallout();return f?s`<div class="smart">${f}</div>`:""})()}
            ${g>0?s`<div class="stat">
        ...
        <section>
          <div class="cal-row">
            ...
            <glass-panel padding="md" variant="strong" stretch>
              <div class="cal-head">
                <h3>${((_=this._displayMonth)==null?void 0:_.getFullYear())??o.getFullYear()}</h3>
                <div style="font-size:12px;color:var(--text-tertiary);">Yearly</div>
              </div>
              <yearly-view
                .year=${((F=this._displayMonth)==null?void 0:F.getFullYear())??o.getFullYear()}
                .tripDays=${this._tripDensityByDay(((N=this._displayMonth)==null?void 0:N.getFullYear())??o.getFullYear())}
        ...
        <section>
          ...
          ${(()=>{const f=(T,G)=>String(T.date).localeCompare(String(G.date)),I=t.filter(T=>T.type==="birthday").slice().sort(f),Y=t.filter(T=>T.type==="anniversary").slice().sort(f),Q=t.filter(T=>T.type!=="birthday"&&T.type!=="anniversary").slice().sort(f),V=(T,G,P)=>s`
              <glass-panel padding="sm" variant="strong" class="cel-col">
                <div class="cel-col-head">
                  <span class="cel-col-title">${T}</span>
                </div>
                ${G.length===0?s`<div class="cel-empty">${P}</div>`:G.map(j=>s`<event-row
                        .event=${j}
                        .members=${a}
                        @edit-event=${ae=>this._openEditEvent(ae.detail)}
                      ></event-row>`)}
              </glass-panel>
            `;return s`
              <div class="cel-row">
                ${V("Birthdays",I,"No birthdays yet.")}
                ${V("Anniversaries",Y,"No anniversaries yet.")}
              </div>
              ${Q.length>0?s`<glass-panel padding="md" variant="strong" style="margin-top:18px;">
                    <div class="cel-col-head">
        ...
        <section>
          ...
          <glass-panel padding="md" variant="strong">
            ${(()=>{var V,T,G;const f=i.find(P=>{var j;return P.uid===((j=this.user)==null?void 0:j.uid)}),I=i.filter(P=>{var j;return P.uid!==((j=this.user)==null?void 0:j.uid)}),Y=Object.entries(((V=this.family)==null?void 0:V.subGroups)??{}),Q=new Map(a.map(P=>[P.uid,P]));return s`
                <div class="cairn-stack">
                  ...
                  >
                    <span class="pebble pebble-self">
                      <span class="stone-chips">
                        <member-chip
                          .name=${(f==null?void 0:f.displayName)??((T=this.user)==null?void 0:T.displayName)??"You"}
                  ...
                  ${this._renderStone({label:"Family",members:I,pebbleClass:"pebble-family",emptyLabel:"+ Add co-parent or child",onClick:()=>this._membersOpen=!0})}
                  ...
                  ${Y.length>0?s`
                        <div class="subgroup-row">
                          ${Y.map(([P,j])=>{const ae=(j.memberIds??[]).map(se=>Q.get(se)).filter(Boolean);return this._renderStone({label:j.name??"Group",members:ae,pebbleClass:"pebble-subgroup",emptyLabel:`${j.name??"Group"} (empty)`,onClick:()=>this._membersOpen=!0,maxChips:4,dropTargetId:P,draggable:se=>se.role==="extended"})})}
                        </div>
                      `:""}
                </div>
                ${I.length===0&&r.length===0?s`
  ...
  `);customElements.define("home-screen",Ee);class Ie extends C{constructor(){super(),this.user=null,this._mode="choose",this._code="",this._familyName="",this._busy=!1,this._error=""}willUpdate(e){if(e.has("user")&&this.user&&!this._familyName){const t=(this.user.displayName??"").trim().split(/\s+/).slice(-1)[0];t&&t.length>1&&(this._familyName=`${t} Family`)}}_go(e){this._mode=e,this._error=""}_submitJoin(){const e=(this._code??"").trim().toUpperCase();if(!e){this._error="Paste the family code you were sent.";return}const t=e.startsWith("CAIRN-")?e:`CAIRN-${e.replace(/^CAIRN-?/i,"")}`;if(!/^CAIRN-[A-Z0-9]{3,6}$/.test(t)){this._error="Codes look like CAIRN-XXXX.";return}this._error="",this.dispatchEvent(new CustomEvent("join-code",{detail:{code:t},bubbles:!0,composed:!0}))}async _submitCreate(){const e=(this._familyName??"").trim();if(!e){this._error="Give your family a name.";return}this._busy=!0,this._error="";try{await k.createCairnOnlyFamily(e),v(`Welcome to ${e}.`)}catch(t){console.error("Create family failed:",t),this._error=(t==null?void 0:t.code)==="permission-denied"?"Couldn't create the family — Firestore rules may not be deployed yet.":`Couldn't create the family: ${(t==null?void 0:t.message)??"try again"}`}finally{this._busy=!1}}_iconJoin(){return s`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    </svg>`}render(){return this._mode==="join"?this._renderJoin():this._mode==="create"?this._renderCreate():this._mode==="download"?this._renderDownload():this._renderChoose()}_renderChoose(){var t;const e=(((t=this.user)==null?void 0:t.displayName)??"").trim().split(/\s+/)[0]||"there";return s`
      <div class="wrap">
        <glass-panel padding="lg" variant="strong" lifted>
          <h1>Welcome, ${e}.</h1>
    ...
    `}}m(Ie,"properties",{user:{type:Object},_mode:{state:!0},_code:{state:!0},_familyName:{state:!0},_busy:{state:!0},_error:{state:!0}}),m(Ie,"styles",z`
    * { box-sizing: border-box; }
    :host {
      display: flex;
      align-items: center;
  ...
  `);customElements.define("onboarding-wizard",Ie);const K="cairn:pendingJoinCode";class Qe extends C{constructor(){super(),this.authUser=null,this.loading=!0;const e=new URLSearchParams(window.location.search);this.preview=e.has("preview");const t=e.get("join");if(t)try{localStorage.setItem(K,t)}catch{}let i=null;try{i=localStorage.getItem(K)}catch{}this.joinCode=t??i??null,this.pebbleUser=null,this.family=null,this.children=[],this.trips=[],this.events=[],this._unsubAuth=null,this._onDataChange=()=>{this.pebbleUser=k.state.user,this.family=k.state.family,this.children=k.state.children,this.trips=k.state.trips,this.events=k.state.events,this.userDocResolved=k.userDocResolved},this.userDocResolved=!1}_clearJoinState(){this.joinCode=null;try{localStorage.removeItem(K)}catch{}const e=new URL(window.location.href);e.searchParams.delete("join"),window.history.replaceState({},"",e.toString())}connectedCallback(){if(super.connectedCallback(),this.preview){this.loading=!1;return}k.addEventListener("change",this._onDataChange),this._unsubAuth=Ve(e=>{if(this.authUser=e,this.loading=!1,e){try{const t=localStorage.getItem(K);t&&!this.joinCode&&(this.joinCode=t)}catch{}k.start(e.uid)}else k.stop(),this.userDocResolved=!1})}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._unsubAuth)==null||e.call(this),k.removeEventListener("change",this._onDataChange)}_composeViewer(){var i,r;const e=this.authUser,t=(i=this.pebbleUser)==null?void 0:i.displayName;return{uid:e.uid,displayName:t&&t.trim()||e.displayName||"You",email:e.email??((r=this.pebbleUser)==null?void 0:r.email)??"",photoURL:Ke(e,this.pebbleUser)}}_needsOnboarding(){var t,i;return!this.authUser||this.joinCode||!this.userDocResolved?!1:!(((t=this.pebbleUser)==null?void 0:t.familyId)??((i=this.pebbleUser)==null?void 0:i.cairnFamilyId)??null)}render(){return this.loading?s``:this.preview?s`<home-screen preview></home-screen>`:this.authUser?this.joinCode?s`
        <join-family-screen
          .code=${this.joinCode}
    ...
    `:s`
        ...
        ></sign-in-screen>
      `}}m(Qe,"properties",{authUser:{state:!0},loading:{state:!0},preview:{state:!0},joinCode:{state:!0},pebbleUser:{state:!0},family:{state:!0},children:{state:!0},trips:{state:!0},events:{state:!0},userDocResolved:{state:!0}});customElements.define("cairn-app",Qe);
//# sourceMappingURL=index-CvWzj5O2.js.map
