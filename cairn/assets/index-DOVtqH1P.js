 ...
 */const nn=globalThis;class se extends wn{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t;const e=super.createRenderRoot();return(t=this.renderOptions).renderBefore??(t.renderBefore=e.firstChild),e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Jf(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)==null||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)==null||e.setConnected(!1)}render(){return Dn}}var sh;se._$litElement$=!0,se.finalized=!0,(sh=nn.litElementHydrateSupport)==null||sh.call(nn,{LitElement:se});const Xs=nn.litElementPolyfillSupport;Xs==null||Xs({LitElement:se});(nn.litElementVersions??(nn.litElementVersions=[])).push("4.2.2");class po extends se{constructor(){super(),this.variant="default",this.lifted=!1,this.padding="md"}render(){const e=["panel",this.variant==="strong"?"strong":"",this.lifted?"lifted":"",`pad-${this.padding}`].filter(Boolean).join(" ");return R`
  ...
  `);customElements.define("glass-panel",po);class fo extends se{constructor(){super(),this.variant="primary",this.size="md",this.full=!1,this.disabled=!1}render(){const e=[this.variant,`size-${this.size}`,this.full?"full":""].filter(Boolean).join(" ");return R`
  ...
  `);customElements.define("glass-button",fo);class mo extends se{constructor(){super(),this.size=44}render(){const e=this.size;return R`
      <svg
        viewBox="0 0 64 64"
        width=${e}
        height=${e}
  ...
  `);customElements.define("yearly-view",go);class yo extends se{constructor(){super(),this.name="",this.hue=200,this.photo="",this.size=36,this.showName=!1}_initials(){return this.name.split(/\s+/).map(e=>e[0]).filter(Boolean).slice(0,2).join("").toUpperCase()}render(){const e=`linear-gradient(135deg, hsl(${this.hue}, 55%, 62%) 0%, hsl(${(this.hue+40)%360}, 50%, 42%) 100%)`,t=`width:${this.size}px;height:${this.size}px;background:${e};font-size:${this.size*.38}px;`;return R`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function am(r,e){if(r.uid)throw new Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');const t={alg:"none",type:"JWT"},n=e||"demo-project",i=r.iat||0,s=r.sub||r.user_id;if(!s)throw new Error("mockUserToken must contain 'sub' or 'user_id' field!");const a=Object.assign({iss:`https://securetoken.google.com/${n}`,aud:n,iat:i,exp:i+3600,auth_time:i,sub:s,user_id:s,firebase:{sign_in_provider:"custom",identities:{}}},r);return[Di(JSON.stringify(t)),Di(JSON.stringify(a)),""].join(".")}const yr={};function lm(){const r={prod:[],emulator:[]};for(const e of Object.keys(yr))yr[e]?r.emulator.push(e):r.prod.push(e);return r}function cm(r){let e=document.getElementById(r),t=!1;return e||(e=document.createElement("div"),e.setAttribute("id",r),t=!0),{created:t,element:e}}let Ic=!1;function ma(r,e){if(typeof window>"u"||typeof document>"u"||!pn(window.location.host)||yr[r]===e||yr[r]||Ic)return;yr[r]=e;function t(g){return`__firebase__banner__${g}`}const n="__firebase__banner",s=lm().prod.length>0;function a(){const g=document.getElementById(n);g&&g.remove()}function l(g){g.style.display="flex",g.style.background="#7faaf0",g.style.position="fixed",g.style.bottom="5px",g.style.left="5px",g.style.padding=".5em",g.style.borderRadius="5px",g.style.alignItems="center"}function u(g,I){g.setAttribute("width","24"),g.setAttribute("id",I),g.setAttribute("height","24"),g.setAttribute("viewBox","0 0 24 24"),g.setAttribute("fill","none"),g.style.marginLeft="-6px"}function h(){const g=document.createElement("span");return g.style.cursor="pointer",g.style.marginLeft="16px",g.style.fontSize="24px",g.innerHTML=" &times;",g.onclick=()=>{Ic=!0,a()},g}function p(g,I){g.setAttribute("id",I),g.innerText="Learn more",g.href="https://firebase.google.com/docs/studio/preview-apps#preview-backend",g.setAttribute("target","__blank"),g.style.paddingLeft="5px",g.style.textDecoration="underline"}function m(){const g=cm(n),I=t("text"),A=document.getElementById(I)||document.createElement("span"),D=t("learnmore"),P=document.getElementById(D)||document.createElement("a"),z=t("preprendIcon"),F=document.getElementById(z)||document.createElementNS("http://www.w3.org/2000/svg","svg");if(g.created){const V=g.element;l(V),p(P,D);const J=h();u(F,z),V.append(F,A,P,J),document.body.appendChild(V)}s?(A.innerText="Preview backend disconnected.",F.innerHTML=`<g clip-path="url(#clip0_6013_33858)">
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function $i(r){var e;const t=r.auth,n=await r.getIdToken(),i=await Sr(r,Oi(t,{idToken:n}));U(i==null?void 0:i.users.length,t,"internal-error");const s=i.users[0];r._notifyReloadListener(s);const a=!((e=s.providerUserInfo)===null||e===void 0)&&e.length?Rh(s.providerUserInfo):[],l=Xg(r.providerData,a),u=r.isAnonymous,h=!(r.email&&s.passwordHash)&&!(l!=null&&l.length),p=u?h:!1,m={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:l,metadata:new Io(s.createdAt,s.lastLoginAt),isAnonymous:p};Object.assign(r,m)}async function Jg(r){const e=de(r);await $i(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function Xg(r,e){return[...r.filter(n=>!e.some(i=>i.providerId===n.providerId)),...e]}function Rh(r){return r.map(e=>{var{providerId:t}=e,n=va(e,["providerId"]);return{providerId:t,uid:n.rawId||"",displayName:n.displayName||null,email:n.email||null,phoneNumber:n.phoneNumber||null,photoURL:n.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wi(r,e,t){return`firebase:${r}:${e}:${t}`}class kn{constructor(e,t,n){this.persistence=e,this.auth=t,this.userKey=n;const{config:i,name:s}=this.auth;this.fullUserKey=wi(this.userKey,i.apiKey,s),this.fullPersistenceKey=wi("persistence",i.apiKey,s),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);if(!e)return null;if(typeof e=="string"){const t=await Oi(this.auth,{idToken:e}).catch(()=>{});return t?Ke._fromGetAccountInfoResponse(this.auth,t,e):null}return Ke._fromJSON(this.auth,e)}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,t)return this.setCurrentUser(t)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,n="authUser"){if(!t.length)return new kn(ht(Mc),e,n);const i=(await Promise.all(t.map(async h=>{if(await h._isAvailable())return h}))).filter(h=>h);let s=i[0]||ht(Mc);const a=wi(n,e.config.apiKey,e.name);let l=null;for(const h of t)try{const p=await h._get(a);if(p){let m;if(typeof p=="string"){const g=await Oi(e,{idToken:p}).catch(()=>{});if(!g)break;m=await Ke._fromGetAccountInfoResponse(e,g,p)}else m=Ke._fromJSON(e,p);h!==s&&(l=m),s=h;break}}catch{}const u=i.filter(h=>h._shouldAllowMigration);return!s._shouldAllowMigration||!u.length?new kn(s,e,n):(s=u[0],l&&await s._set(a,l.toJSON()),await Promise.all(t.map(async h=>{if(h!==s)try{await h._remove(a)}catch{}})),new kn(s,e,n))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dy(r,e){const t=ns(r,"auth");if(t.isInitialized()){const i=t.getImmediate(),s=t.getOptions();if(ln(s,e??{}))return i;it(i,"already-initialized")}return t.initialize({options:e})}function py(r,e){const t=(e==null?void 0:e.persistence)||[],n=(Array.isArray(t)?t:[t]).map(ht);e!=null&&e.errorMap&&r._updateErrorMap(e.errorMap),r._initializeWithPersistence(n,e==null?void 0:e.popupRedirectResolver)}function fy(r,e,t){const n=rs(r);U(/^https?:\/\//.test(e),n,"invalid-emulator-scheme");const i=!1,s=zh(e),{host:a,port:l}=my(e),u=l===null?"":`:${l}`,h={url:`${s}//${a}${u}/`},p=Object.freeze({host:a,port:l,protocol:s.replace(":",""),options:Object.freeze({disableWarnings:i})});if(!n._canInitEmulator){U(n.config.emulator&&n.emulatorConfig,n,"emulator-config-failed"),U(ln(h,n.config.emulator)&&ln(p,n.emulatorConfig),n,"emulator-config-failed");return}n.config.emulator=h,n.emulatorConfig=p,n.settings.appVerificationDisabledForTesting=!0,pn(a)?(fa(`${s}//${a}${u}`),ma("Auth",!0)):gy()}function zh(r){const e=r.indexOf(":");return e<0?"":r.substr(0,e+1)}function my(r){const e=zh(r),t=/(\/\/)?([^?#/]+)/.exec(r.substr(e.length));if(!t)return{host:"",port:null};const n=t[2].split("@").pop()||"",i=/^(\[[^\]]+\])(:|$)/.exec(n);if(i){const s=i[1];return{host:s,port:Uc(n.substr(s.length+1))}}else{const[s,a]=n.split(":");return{host:s,port:Uc(a)}}}function Uc(r){if(!r)return null;const e=Number(r);return isNaN(e)?null:e}function gy(){function r(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",r):r())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function vy(r,e,t=!1){const{auth:n}=r;if(ze(n.app))return Promise.reject(rn(n));const i="reauthenticate";try{const s=await Sr(r,jh(n,i,e,r),t);U(s.idToken,n,"internal-error");const a=Ia(s.idToken);U(a,n,"internal-error");const{sub:l}=a;return U(r.uid===l,n,"user-mismatch"),Vn._forOperation(r,i,s)}catch(s){throw(s==null?void 0:s.code)==="auth/user-not-found"&&it(n,"user-mismatch"),s}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xh(r,e){return e?ht(e):(U(r._popupRedirectResolver,r,"argument-error"),r._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var Rt,nd;(function(){var r;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(w,y){function v(){}v.prototype=y.prototype,w.D=y.prototype,w.prototype=new v,w.prototype.constructor=w,w.C=function(b,E,x){for(var _=Array(arguments.length-2),at=2;at<arguments.length;at++)_[at-2]=arguments[at];return y.prototype[E].apply(b,_)}}function t(){this.blockSize=-1}function n(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(n,t),n.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(w,y,v){v||(v=0);var b=Array(16);if(typeof y=="string")for(var E=0;16>E;++E)b[E]=y.charCodeAt(v++)|y.charCodeAt(v++)<<8|y.charCodeAt(v++)<<16|y.charCodeAt(v++)<<24;else for(E=0;16>E;++E)b[E]=y[v++]|y[v++]<<8|y[v++]<<16|y[v++]<<24;y=w.g[0],v=w.g[1],E=w.g[2];var x=w.g[3],_=y+(x^v&(E^x))+b[0]+3614090360&4294967295;y=v+(_<<7&4294967295|_>>>25),_=x+(E^y&(v^E))+b[1]+3905402710&4294967295,x=y+(_<<12&4294967295|_>>>20),_=E+(v^x&(y^v))+b[2]+606105819&4294967295,E=x+(_<<17&4294967295|_>>>15),_=v+(y^E&(x^y))+b[3]+3250441966&4294967295,v=E+(_<<22&4294967295|_>>>10),_=y+(x^v&(E^x))+b[4]+4118548399&4294967295,y=v+(_<<7&4294967295|_>>>25),_=x+(E^y&(v^E))+b[5]+1200080426&4294967295,x=y+(_<<12&4294967295|_>>>20),_=E+(v^x&(y^v))+b[6]+2821735955&4294967295,E=x+(_<<17&4294967295|_>>>15),_=v+(y^E&(x^y))+b[7]+4249261313&4294967295,v=E+(_<<22&4294967295|_>>>10),_=y+(x^v&(E^x))+b[8]+1770035416&4294967295,y=v+(_<<7&4294967295|_>>>25),_=x+(E^y&(v^E))+b[9]+2336552879&4294967295,x=y+(_<<12&4294967295|_>>>20),_=E+(v^x&(y^v))+b[10]+4294925233&4294967295,E=x+(_<<17&4294967295|_>>>15),_=v+(y^E&(x^y))+b[11]+2304563134&4294967295,v=E+(_<<22&4294967295|_>>>10),_=y+(x^v&(E^x))+b[12]+1804603682&4294967295,y=v+(_<<7&4294967295|_>>>25),_=x+(E^y&(v^E))+b[13]+4254626195&4294967295,x=y+(_<<12&4294967295|_>>>20),_=E+(v^x&(y^v))+b[14]+2792965006&4294967295,E=x+(_<<17&4294967295|_>>>15),_=v+(y^E&(x^y))+b[15]+1236535329&4294967295,v=E+(_<<22&4294967295|_>>>10),_=y+(E^x&(v^E))+b[1]+4129170786&4294967295,y=v+(_<<5&4294967295|_>>>27),_=x+(v^E&(y^v))+b[6]+3225465664&4294967295,x=y+(_<<9&4294967295|_>>>23),_=E+(y^v&(x^y))+b[11]+643717713&4294967295,E=x+(_<<14&4294967295|_>>>18),_=v+(x^y&(E^x))+b[0]+3921069994&4294967295,v=E+(_<<20&4294967295|_>>>12),_=y+(E^x&(v^E))+b[5]+3593408605&4294967295,y=v+(_<<5&4294967295|_>>>27),_=x+(v^E&(y^v))+b[10]+38016083&4294967295,x=y+(_<<9&4294967295|_>>>23),_=E+(y^v&(x^y))+b[15]+3634488961&4294967295,E=x+(_<<14&4294967295|_>>>18),_=v+(x^y&(E^x))+b[4]+3889429448&4294967295,v=E+(_<<20&4294967295|_>>>12),_=y+(E^x&(v^E))+b[9]+568446438&4294967295,y=v+(_<<5&4294967295|_>>>27),_=x+(v^E&(y^v))+b[14]+3275163606&4294967295,x=y+(_<<9&4294967295|_>>>23),_=E+(y^v&(x^y))+b[3]+4107603335&4294967295,E=x+(_<<14&4294967295|_>>>18),_=v+(x^y&(E^x))+b[8]+1163531501&4294967295,v=E+(_<<20&4294967295|_>>>12),_=y+(E^x&(v^E))+b[13]+2850285829&4294967295,y=v+(_<<5&4294967295|_>>>27),_=x+(v^E&(y^v))+b[2]+4243563512&4294967295,x=y+(_<<9&4294967295|_>>>23),_=E+(y^v&(x^y))+b[7]+1735328473&4294967295,E=x+(_<<14&4294967295|_>>>18),_=v+(x^y&(E^x))+b[12]+2368359562&4294967295,v=E+(_<<20&4294967295|_>>>12),_=y+(v^E^x)+b[5]+4294588738&4294967295,y=v+(_<<4&4294967295|_>>>28),_=x+(y^v^E)+b[8]+2272392833&4294967295,x=y+(_<<11&4294967295|_>>>21),_=E+(x^y^v)+b[11]+1839030562&4294967295,E=x+(_<<16&4294967295|_>>>16),_=v+(E^x^y)+b[14]+4259657740&4294967295,v=E+(_<<23&4294967295|_>>>9),_=y+(v^E^x)+b[1]+2763975236&4294967295,y=v+(_<<4&4294967295|_>>>28),_=x+(y^v^E)+b[4]+1272893353&4294967295,x=y+(_<<11&4294967295|_>>>21),_=E+(x^y^v)+b[7]+4139469664&4294967295,E=x+(_<<16&4294967295|_>>>16),_=v+(E^x^y)+b[10]+3200236656&4294967295,v=E+(_<<23&4294967295|_>>>9),_=y+(v^E^x)+b[13]+681279174&4294967295,y=v+(_<<4&4294967295|_>>>28),_=x+(y^v^E)+b[0]+3936430074&4294967295,x=y+(_<<11&4294967295|_>>>21),_=E+(x^y^v)+b[3]+3572445317&4294967295,E=x+(_<<16&4294967295|_>>>16),_=v+(E^x^y)+b[6]+76029189&4294967295,v=E+(_<<23&4294967295|_>>>9),_=y+(v^E^x)+b[9]+3654602809&4294967295,y=v+(_<<4&4294967295|_>>>28),_=x+(y^v^E)+b[12]+3873151461&4294967295,x=y+(_<<11&4294967295|_>>>21),_=E+(x^y^v)+b[15]+530742520&4294967295,E=x+(_<<16&4294967295|_>>>16),_=v+(E^x^y)+b[2]+3299628645&4294967295,v=E+(_<<23&4294967295|_>>>9),_=y+(E^(v|~x))+b[0]+4096336452&4294967295,y=v+(_<<6&4294967295|_>>>26),_=x+(v^(y|~E))+b[7]+1126891415&4294967295,x=y+(_<<10&4294967295|_>>>22),_=E+(y^(x|~v))+b[14]+2878612391&4294967295,E=x+(_<<15&4294967295|_>>>17),_=v+(x^(E|~y))+b[5]+4237533241&4294967295,v=E+(_<<21&4294967295|_>>>11),_=y+(E^(v|~x))+b[12]+1700485571&4294967295,y=v+(_<<6&4294967295|_>>>26),_=x+(v^(y|~E))+b[3]+2399980690&4294967295,x=y+(_<<10&4294967295|_>>>22),_=E+(y^(x|~v))+b[10]+4293915773&4294967295,E=x+(_<<15&4294967295|_>>>17),_=v+(x^(E|~y))+b[1]+2240044497&4294967295,v=E+(_<<21&4294967295|_>>>11),_=y+(E^(v|~x))+b[8]+1873313359&4294967295,y=v+(_<<6&4294967295|_>>>26),_=x+(v^(y|~E))+b[15]+4264355552&4294967295,x=y+(_<<10&4294967295|_>>>22),_=E+(y^(x|~v))+b[6]+2734768916&4294967295,E=x+(_<<15&4294967295|_>>>17),_=v+(x^(E|~y))+b[13]+1309151649&4294967295,v=E+(_<<21&4294967295|_>>>11),_=y+(E^(v|~x))+b[4]+4149444226&4294967295,y=v+(_<<6&4294967295|_>>>26),_=x+(v^(y|~E))+b[11]+3174756917&4294967295,x=y+(_<<10&4294967295|_>>>22),_=E+(y^(x|~v))+b[2]+718787259&4294967295,E=x+(_<<15&4294967295|_>>>17),_=v+(x^(E|~y))+b[9]+3951481745&4294967295,w.g[0]=w.g[0]+y&4294967295,w.g[1]=w.g[1]+(E+(_<<21&4294967295|_>>>11))&4294967295,w.g[2]=w.g[2]+E&4294967295,w.g[3]=w.g[3]+x&4294967295}n.prototype.u=function(w,y){y===void 0&&(y=w.length);for(var v=y-this.blockSize,b=this.B,E=this.h,x=0;x<y;){if(E==0)for(;x<=v;)i(this,w,x),x+=this.blockSize;if(typeof w=="string"){for(;x<y;)if(b[E++]=w.charCodeAt(x++),E==this.blockSize){i(this,b),E=0;break}}else for(;x<y;)if(b[E++]=w[x++],E==this.blockSize){i(this,b),E=0;break}}this.h=E,this.o+=y},n.prototype.v=function(){var w=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);w[0]=128;for(var y=1;y<w.length-8;++y)w[y]=0;var v=8*this.o;for(y=w.length-8;y<w.length;++y)w[y]=v&255,v/=256;for(this.u(w),w=Array(16),y=v=0;4>y;++y)for(var b=0;32>b;b+=8)w[v++]=this.g[y]>>>b&255;return w};function s(w,y){var v=l;return Object.prototype.hasOwnProperty.call(v,w)?v[w]:v[w]=y(w)}function a(w,y){this.h=y;for(var v=[],b=!0,E=w.length-1;0<=E;E--){var x=w[E]|0;b&&x==y||(v[E]=x,b=!1)}this.g=v}var l={};function u(w){return-128<=w&&128>w?s(w,function(y){return new a([y|0],0>y?-1:0)}):new a([w|0],0>w?-1:0)}function h(w){if(isNaN(w)||!isFinite(w))return m;if(0>w)return P(h(-w));for(var y=[],v=1,b=0;w>=v;b++)y[b]=w/v|0,v*=4294967296;return new a(y,0)}function p(w,y){if(w.length==0)throw Error("number format error: empty string");if(y=y||10,2>y||36<y)throw Error("radix out of range: "+y);if(w.charAt(0)=="-")return P(p(w.substring(1),y));if(0<=w.indexOf("-"))throw Error('number format error: interior "-" character');for(var v=h(Math.pow(y,8)),b=m,E=0;E<w.length;E+=8){var x=Math.min(8,w.length-E),_=parseInt(w.substring(E,E+x),y);8>x?(x=h(Math.pow(y,x)),b=b.j(x).add(h(_))):(b=b.j(v),b=b.add(h(_)))}return b}var m=u(0),g=u(1),I=u(16777216);r=a.prototype,r.m=function(){if(D(this))return-P(this).m();for(var w=0,y=1,v=0;v<this.g.length;v++){var b=this.i(v);w+=(0<=b?b:4294967296+b)*y,y*=4294967296}return w},r.toString=function(w){if(w=w||10,2>w||36<w)throw Error("radix out of range: "+w);if(A(this))return"0";if(D(this))return"-"+P(this).toString(w);for(var y=h(Math.pow(w,6)),v=this,b="";;){var E=J(v,y).g;v=z(v,E.j(y));var x=((0<v.g.length?v.g[0]:v.h)>>>0).toString(w);if(v=E,A(v))return x+b;for(;6>x.length;)x="0"+x;b=x+b}},r.i=function(w){return 0>w?0:w<this.g.length?this.g[w]:this.h};function A(w){if(w.h!=0)return!1;for(var y=0;y<w.g.length;y++)if(w.g[y]!=0)return!1;return!0}function D(w){return w.h==-1}r.l=function(w){return w=z(this,w),D(w)?-1:A(w)?0:1};function P(w){for(var y=w.g.length,v=[],b=0;b<y;b++)v[b]=~w.g[b];return new a(v,~w.h).add(g)}r.abs=function(){return D(this)?P(this):this},r.add=function(w){for(var y=Math.max(this.g.length,w.g.length),v=[],b=0,E=0;E<=y;E++){var x=b+(this.i(E)&65535)+(w.i(E)&65535),_=(x>>>16)+(this.i(E)>>>16)+(w.i(E)>>>16);b=_>>>16,x&=65535,_&=65535,v[E]=_<<16|x}return new a(v,v[v.length-1]&-2147483648?-1:0)};function z(w,y){return w.add(P(y))}r.j=function(w){if(A(this)||A(w))return m;if(D(this))return D(w)?P(this).j(P(w)):P(P(this).j(w));if(D(w))return P(this.j(P(w)));if(0>this.l(I)&&0>w.l(I))return h(this.m()*w.m());for(var y=this.g.length+w.g.length,v=[],b=0;b<2*y;b++)v[b]=0;for(b=0;b<this.g.length;b++)for(var E=0;E<w.g.length;E++){var x=this.i(b)>>>16,_=this.i(b)&65535,at=w.i(E)>>>16,Wn=w.i(E)&65535;v[2*b+2*E]+=_*Wn,F(v,2*b+2*E),v[2*b+2*E+1]+=x*Wn,F(v,2*b+2*E+1),v[2*b+2*E+1]+=_*at,F(v,2*b+2*E+1),v[2*b+2*E+2]+=x*at,F(v,2*b+2*E+2)}for(b=0;b<y;b++)v[b]=v[2*b+1]<<16|v[2*b];for(b=y;b<2*y;b++)v[b]=0;return new a(v,0)};function F(w,y){for(;(w[y]&65535)!=w[y];)w[y+1]+=w[y]>>>16,w[y]&=65535,y++}function V(w,y){this.g=w,this.h=y}function J(w,y){if(A(y))throw Error("division by zero");if(A(w))return new V(m,m);if(D(w))return y=J(P(w),y),new V(P(y.g),P(y.h));if(D(y))return y=J(w,P(y)),new V(P(y.g),y.h);if(30<w.g.length){if(D(w)||D(y))throw Error("slowDivide_ only works with positive integers.");for(var v=g,b=y;0>=b.l(w);)v=Ue(v),b=Ue(b);var E=ce(v,1),x=ce(b,1);for(b=ce(b,2),v=ce(v,2);!A(b);){var _=x.add(b);0>=_.l(w)&&(E=E.add(v),x=_),b=ce(b,1),v=ce(v,1)}return y=z(w,E.j(y)),new V(E,y)}for(E=m;0<=w.l(y);){for(v=Math.max(1,Math.floor(w.m()/y.m())),b=Math.ceil(Math.log(v)/Math.LN2),b=48>=b?1:Math.pow(2,b-48),x=h(v),_=x.j(y);D(_)||0<_.l(w);)v-=b,x=h(v),_=x.j(y);A(x)&&(x=g),E=E.add(x),w=z(w,_)}return new V(E,w)}r.A=function(w){return J(this,w).h},r.and=function(w){for(var y=Math.max(this.g.length,w.g.length),v=[],b=0;b<y;b++)v[b]=this.i(b)&w.i(b);return new a(v,this.h&w.h)},r.or=function(w){for(var y=Math.max(this.g.length,w.g.length),v=[],b=0;b<y;b++)v[b]=this.i(b)|w.i(b);return new a(v,this.h|w.h)},r.xor=function(w){for(var y=Math.max(this.g.length,w.g.length),v=[],b=0;b<y;b++)v[b]=this.i(b)^w.i(b);return new a(v,this.h^w.h)};function Ue(w){for(var y=w.g.length+1,v=[],b=0;b<y;b++)v[b]=w.i(b)<<1|w.i(b-1)>>>31;return new a(v,w.h)}function ce(w,y){var v=y>>5;y%=32;for(var b=w.g.length-v,E=[],x=0;x<b;x++)E[x]=0<y?w.i(x+v)>>>y|w.i(x+v+1)<<32-y:w.i(x+v);return new a(E,w.h)}n.prototype.digest=n.prototype.v,n.prototype.reset=n.prototype.s,n.prototype.update=n.prototype.u,nd=n,a.prototype.add=a.prototype.add,a.prototype.multiply=a.prototype.j,a.prototype.modulo=a.prototype.A,a.prototype.compare=a.prototype.l,a.prototype.toNumber=a.prototype.m,a.prototype.toString=a.prototype.toString,a.prototype.getBits=a.prototype.i,a.fromNumber=h,a.fromString=p,Rt=a}).apply(typeof Jc<"u"?Jc:typeof self<"u"?self:typeof window<"u"?window:{});var fi=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hn=new ga("@firebase/firestore");function En(){return hn.logLevel}function O(r,...e){if(hn.logLevel<=G.DEBUG){const t=e.map(Ra);hn.debug(`Firestore (${jn}): ${r}`,...t)}}function ft(r,...e){if(hn.logLevel<=G.ERROR){const t=e.map(Ra);hn.error(`Firestore (${jn}): ${r}`,...t)}}function Vt(r,...e){if(hn.logLevel<=G.WARN){const t=e.map(Ra);hn.warn(`Firestore (${jn}): ${r}`,...t)}}function Ra(r){if(typeof r=="string")return r;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function L(r,e,t){let n="Unexpected state";typeof e=="string"?n=e:t=e,ld(r,n,t)}function ld(r,e,t){let n=`FIRESTORE (${jn}) INTERNAL ASSERTION FAILED: ${e} (ID: ${r.toString(16)})`;if(t!==void 0)try{n+=" CONTEXT: "+JSON.stringify(t)}catch{n+=" CONTEXT: "+t}throw ft(n),new Error(n)}function X(r,e,t,n){let i="Unexpected state";typeof t=="string"?i=t:n=t,r||ld(e,i,n)}function j(r,e){return r}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function me(r,e){const t={typeString:r};return e&&(t.value=e),t}function zr(r,e){if(!dd(r))throw new $(C.INVALID_ARGUMENT,"JSON must be an object");let t;for(const n in e)if(e[n]){const i=e[n].typeString,s="value"in e[n]?{value:e[n].value}:void 0;if(!(n in r)){t=`JSON missing required field: '${n}'`;break}const a=r[n];if(i&&typeof a!==i){t=`JSON field '${n}' must be a ${i}.`;break}if(s!==void 0&&a!==s.value){t=`Expected '${n}' field to equal '${s.value}'`;break}}if(t)throw new $(C.INVALID_ARGUMENT,t);return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cr=-1;function G_(r,e){const t=r.toTimestamp().seconds,n=r.toTimestamp().nanoseconds+1,i=B.fromTimestamp(n===1e9?new ie(t+1,0):new ie(t,n));return new Ot(i,M.empty(),e)}function W_(r){return new Ot(r.readTime,r.key,Cr)}class Ot{constructor(e,t,n){this.readTime=e,this.documentKey=t,this.largestBatchId=n}static min(){return new Ot(B.min(),M.empty(),Cr)}static max(){return new Ot(B.max(),M.empty(),Cr)}}function K_(r,e){let t=r.readTime.compareTo(e.readTime);return t!==0?t:(t=M.comparator(r.documentKey,e.documentKey),t!==0?t:q(r.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function qn(r){if(r.code!==C.FAILED_PRECONDITION||r.message!==Y_)throw r;O("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fe{constructor(e){this.fields=e,e.sort(Ee.comparator)}static empty(){return new Fe([])}unionWith(e){let t=new ge(Ee.comparator);for(const n of this.fields)t=t.add(n);for(const n of e)t=t.add(n);return new Fe(t.toArray())}covers(e){for(const t of this.fields)if(t.isPrefixOf(e))return!0;return!1}isEqual(e){return On(this.fields,e.fields,((t,n)=>t.isEqual(n)))}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bv=new oe(M.comparator);function mt(){return bv}const Dd=new oe(M.comparator);function dr(...r){let e=Dd;for(const t of r)e=e.insert(t.key,t);return e}function Nd(r){let e=Dd;return r.forEach(((t,n)=>e=e.insert(t,n.overlayedDocument))),e}function tn(){return wr()}function Vd(){return wr()}function wr(){return new fn((r=>r.toString()),((r,e)=>r.isEqual(e)))}const wv=new oe(M.comparator),Ev=new ge(M.comparator);function W(...r){let e=Ev;for(const t of r)e=e.add(t);return e}const Tv=new ge(q);function Iv(){return Tv}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fs{constructor(e,t,n,i,s){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=n,this.documentUpdates=i,this.resolvedLimboDocuments=s}static createSynthesizedRemoteEventForCurrentChange(e,t,n){const i=new Map;return i.set(e,qr.createSynthesizedTargetChangeForCurrentChange(e,t,n)),new fs(B.min(),i,new oe(q),mt(),W())}}class qr{constructor(e,t,n,i,s){this.resumeToken=e,this.current=t,this.addedDocuments=n,this.modifiedDocuments=i,this.removedDocuments=s}static createSynthesizedTargetChangeForCurrentChange(e,t,n){return new qr(n,t,W(),W(),W())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ci{constructor(e,t,n,i){this.Se=e,this.removedTargetIds=t,this.key=n,this.be=i}}class jd{constructor(e,t){this.targetId=e,this.De=t}}class qd{constructor(e,t,n=Te.EMPTY_BYTE_STRING,i=null){this.state=e,this.targetIds=t,this.resumeToken=n,this.cause=i}}class xu{constructor(){this.ve=0,this.Ce=Au(),this.Fe=Te.EMPTY_BYTE_STRING,this.Me=!1,this.xe=!0}get current(){return this.Me}get resumeToken(){return this.Fe}get Oe(){return this.ve!==0}get Ne(){return this.xe}Be(e){e.approximateByteSize()>0&&(this.xe=!0,this.Fe=e)}Le(){let e=W(),t=W(),n=W();return this.Ce.forEach(((i,s)=>{switch(s){case 0:e=e.add(i);break;case 2:t=t.add(i);break;case 1:n=n.add(i);break;default:L(38017,{changeType:s})}})),new qr(this.Fe,this.Me,e,t,n)}ke(){this.xe=!1,this.Ce=Au()}qe(e,t){this.xe=!0,this.Ce=this.Ce.insert(e,t)}Qe(e){this.xe=!0,this.Ce=this.Ce.remove(e)}$e(){this.ve+=1}Ue(){this.ve-=1,X(this.ve>=0,3241,{ve:this.ve})}Ke(){this.xe=!0,this.Me=!0}}class Fv{constructor(e){this.We=e,this.Ge=new Map,this.ze=mt(),this.je=yi(),this.Je=yi(),this.He=new oe(q)}Ye(e){for(const t of e.Se)e.be&&e.be.isFoundDocument()?this.Ze(t,e.be):this.Xe(t,e.key,e.be);for(const t of e.removedTargetIds)this.Xe(t,e.key,e.be)}et(e){this.forEachTarget(e,(t=>{const n=this.tt(t);switch(e.state){case 0:this.nt(t)&&n.Be(e.resumeToken);break;case 1:n.Ue(),n.Oe||n.ke(),n.Be(e.resumeToken);break;case 2:n.Ue(),n.Oe||this.removeTarget(t);break;case 3:this.nt(t)&&(n.Ke(),n.Be(e.resumeToken));break;case 4:this.nt(t)&&(this.rt(t),n.Be(e.resumeToken));break;default:L(56790,{state:e.state})}}))}forEachTarget(e,t){e.targetIds.length>0?e.targetIds.forEach(t):this.Ge.forEach(((n,i)=>{this.nt(i)&&t(i)}))}it(e){const t=e.targetId,n=e.De.count,i=this.st(t);if(i){const s=i.target;if(Po(s))if(n===0){const a=new M(s.path);this.Xe(t,a,Re.newNoDocument(a,B.min()))}else X(n===1,20013,{expectedCount:n});else{const a=this.ot(t);if(a!==n){const l=this._t(e),u=l?this.ut(l,e,a):1;if(u!==0){this.rt(t);const h=u===2?"TargetPurposeExistenceFilterMismatchBloom":"TargetPurposeExistenceFilterMismatch";this.He=this.He.insert(t,h)}}}}}_t(e){const t=e.De.unchangedNames;if(!t||!t.bits)return null;const{bits:{bitmap:n="",padding:i=0},hashCount:s=0}=t;let a,l;try{a=Mt(n).toUint8Array()}catch(u){if(u instanceof md)return Vt("Decoding the base64 bloom filter in existence filter failed ("+u.message+"); ignoring the bloom filter and falling back to full re-query."),null;throw u}try{l=new za(a,i,s)}catch(u){return Vt(u instanceof pr?"BloomFilter error: ":"Applying bloom filter failed: ",u),null}return l.fe===0?null:l}ut(e,t,n){return t.De.count===n-this.ht(e,t.targetId)?0:2}ht(e,t){const n=this.We.getRemoteKeysForTarget(t);let i=0;return n.forEach((s=>{const a=this.We.lt(),l=`projects/${a.projectId}/databases/${a.database}/documents/${s.path.canonicalString()}`;e.mightContain(l)||(this.Xe(t,s,null),i++)})),i}Pt(e){const t=new Map;this.Ge.forEach(((s,a)=>{const l=this.st(a);if(l){if(s.current&&Po(l.target)){const u=new M(l.target.path);this.Tt(u).has(a)||this.It(a,u)||this.Xe(a,u,Re.newNoDocument(u,e))}s.Ne&&(t.set(a,s.Le()),s.ke())}}));let n=W();this.Je.forEach(((s,a)=>{let l=!0;a.forEachWhile((u=>{const h=this.st(u);return!h||h.purpose==="TargetPurposeLimboResolution"||(l=!1,!1)})),l&&(n=n.add(s))})),this.ze.forEach(((s,a)=>a.setReadTime(e)));const i=new fs(e,t,this.He,this.ze,n);return this.ze=mt(),this.je=yi(),this.Je=yi(),this.He=new oe(q),i}Ze(e,t){if(!this.nt(e))return;const n=this.It(e,t.key)?2:0;this.tt(e).qe(t.key,n),this.ze=this.ze.insert(t.key,t),this.je=this.je.insert(t.key,this.Tt(t.key).add(e)),this.Je=this.Je.insert(t.key,this.dt(t.key).add(e))}Xe(e,t,n){if(!this.nt(e))return;const i=this.tt(e);this.It(e,t)?i.qe(t,1):i.Qe(t),this.Je=this.Je.insert(t,this.dt(t).delete(e)),this.Je=this.Je.insert(t,this.dt(t).add(e)),n&&(this.ze=this.ze.insert(t,n))}removeTarget(e){this.Ge.delete(e)}ot(e){const t=this.tt(e).Le();return this.We.getRemoteKeysForTarget(e).size+t.addedDocuments.size-t.removedDocuments.size}$e(e){this.tt(e).$e()}tt(e){let t=this.Ge.get(e);return t||(t=new xu,this.Ge.set(e,t)),t}dt(e){let t=this.Je.get(e);return t||(t=new ge(q),this.Je=this.Je.insert(e,t)),t}Tt(e){let t=this.je.get(e);return t||(t=new ge(q),this.je=this.je.insert(e,t)),t}nt(e){const t=this.st(e)!==null;return t||O("WatchChangeAggregator","Detected inactive target",e),t}st(e){const t=this.Ge.get(e);return t&&t.Oe?null:this.We.Et(e)}rt(e){this.Ge.set(e,new xu),this.We.getRemoteKeysForTarget(e).forEach((t=>{this.Xe(e,t,null)}))}It(e,t){return this.We.getRemoteKeysForTarget(e).has(t)}}function yi(){return new oe(M.comparator)}function Au(){return new oe(M.comparator)}const Uv={asc:"ASCENDING",desc:"DESCENDING"},zv={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"},Bv={and:"AND",or:"OR"};class jv{constructor(e,t){this.databaseId=e,this.useProto3Json=t}}function Vo(r,e){return r.useProto3Json||ls(e)?e:{value:e}}function Gi(r,e){return r.useProto3Json?`${new Date(1e3*e.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+e.nanoseconds).slice(-9)}Z`:{seconds:""+e.seconds,nanos:e.nanoseconds}}function Hd(r,e){return r.useProto3Json?e.toBase64():e.toUint8Array()}function qv(r,e){return Gi(r,e.toTimestamp())}function tt(r){return X(!!r,49232),B.fromTimestamp((function(t){const n=$t(t);return new ie(n.seconds,n.nanos)})(r))}function Ba(r,e){return Oo(r,e).canonicalString()}function Oo(r,e){const t=(function(i){return new ne(["projects",i.projectId,"databases",i.database])})(r).child("documents");return e===void 0?t:t.child(e)}function Gd(r){const e=ne.fromString(r);return X(Jd(e),10190,{key:e.toString()}),e}function $o(r,e){return Ba(r.databaseId,e.path)}function oo(r,e){const t=Gd(e);if(t.get(1)!==r.databaseId.projectId)throw new $(C.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+t.get(1)+" vs "+r.databaseId.projectId);if(t.get(3)!==r.databaseId.database)throw new $(C.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+t.get(3)+" vs "+r.databaseId.database);return new M(Kd(t))}function Wd(r,e){return Ba(r.databaseId,e)}function Hv(r){const e=Gd(r);return e.length===4?ne.emptyPath():Kd(e)}function Mo(r){return new ne(["projects",r.databaseId.projectId,"databases",r.databaseId.database]).canonicalString()}function Kd(r){return X(r.length>4&&r.get(4)==="documents",29091,{key:r.toString()}),r.popFirst(5)}function Su(r,e,t){return{name:$o(r,e),fields:t.value.mapValue.fields}}function Gv(r,e){let t;if("targetChange"in e){e.targetChange;const n=(function(h){return h==="NO_CHANGE"?0:h==="ADD"?1:h==="REMOVE"?2:h==="CURRENT"?3:h==="RESET"?4:L(39313,{state:h})})(e.targetChange.targetChangeType||"NO_CHANGE"),i=e.targetChange.targetIds||[],s=(function(h,p){return h.useProto3Json?(X(p===void 0||typeof p=="string",58123),Te.fromBase64String(p||"")):(X(p===void 0||p instanceof Buffer||p instanceof Uint8Array,16193),Te.fromUint8Array(p||new Uint8Array))})(r,e.targetChange.resumeToken),a=e.targetChange.cause,l=a&&(function(h){const p=h.code===void 0?C.UNKNOWN:Bd(h.code);return new $(p,h.message||"")})(a);t=new qd(n,i,s,l||null)}else if("documentChange"in e){e.documentChange;const n=e.documentChange;n.document,n.document.name,n.document.updateTime;const i=oo(r,n.document.name),s=tt(n.document.updateTime),a=n.document.createTime?tt(n.document.createTime):B.min(),l=new Oe({mapValue:{fields:n.document.fields}}),u=Re.newFoundDocument(i,s,a,l),h=n.targetIds||[],p=n.removedTargetIds||[];t=new Ci(h,p,u.key,u)}else if("documentDelete"in e){e.documentDelete;const n=e.documentDelete;n.document;const i=oo(r,n.document),s=n.readTime?tt(n.readTime):B.min(),a=Re.newNoDocument(i,s),l=n.removedTargetIds||[];t=new Ci([],l,a.key,a)}else if("documentRemove"in e){e.documentRemove;const n=e.documentRemove;n.document;const i=oo(r,n.document),s=n.removedTargetIds||[];t=new Ci([],s,i,null)}else{if(!("filter"in e))return L(11601,{At:e});{e.filter;const n=e.filter;n.targetId;const{count:i=0,unchangedNames:s}=n,a=new $v(i,s),l=n.targetId;t=new jd(l,a)}}return t}function Wv(r,e){let t;if(e instanceof jr)t={update:Su(r,e.key,e.value)};else if(e instanceof Fa)t={delete:$o(r,e.key)};else if(e instanceof jt)t={update:Su(r,e.key,e.data),updateMask:nb(e.fieldMask)};else{if(!(e instanceof Nv))return L(16599,{Rt:e.type});t={verify:$o(r,e.key)}}return e.fieldTransforms.length>0&&(t.updateTransforms=e.fieldTransforms.map((n=>(function(s,a){const l=a.transform;if(l instanceof Dr)return{fieldPath:a.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(l instanceof Nr)return{fieldPath:a.field.canonicalString(),appendMissingElements:{values:l.elements}};if(l instanceof Vr)return{fieldPath:a.field.canonicalString(),removeAllFromArray:{values:l.elements}};if(l instanceof Hi)return{fieldPath:a.field.canonicalString(),increment:l.Ee};throw L(20930,{transform:a.transform})})(0,n)))),e.precondition.isNone||(t.currentDocument=(function(i,s){return s.updateTime!==void 0?{updateTime:qv(i,s.updateTime)}:s.exists!==void 0?{exists:s.exists}:L(27497)})(r,e.precondition)),t}function Kv(r,e){return r&&r.length>0?(X(e!==void 0,14353),r.map((t=>(function(i,s){let a=i.updateTime?tt(i.updateTime):tt(s);return a.isEqual(B.min())&&(a=tt(s)),new Rv(a,i.transformResults||[])})(t,e)))):[]}function Yv(r,e){return{documents:[Wd(r,e.path)]}}function Qv(r,e){const t={structuredQuery:{}},n=e.path;let i;e.collectionGroup!==null?(i=n,t.structuredQuery.from=[{collectionId:e.collectionGroup,allDescendants:!0}]):(i=n.popLast(),t.structuredQuery.from=[{collectionId:n.lastSegment()}]),t.parent=Wd(r,i);const s=(function(h){if(h.length!==0)return Qd(Qe.create(h,"and"))})(e.filters);s&&(t.structuredQuery.where=s);const a=(function(h){if(h.length!==0)return h.map((p=>(function(g){return{field:In(g.field),direction:Zv(g.dir)}})(p)))})(e.orderBy);a&&(t.structuredQuery.orderBy=a);const l=Vo(r,e.limit);return l!==null&&(t.structuredQuery.limit=l),e.startAt&&(t.structuredQuery.startAt=(function(h){return{before:h.inclusive,values:h.position}})(e.startAt)),e.endAt&&(t.structuredQuery.endAt=(function(h){return{before:!h.inclusive,values:h.position}})(e.endAt)),{Vt:t,parent:i}}function Jv(r){let e=Hv(r.parent);const t=r.structuredQuery,n=t.from?t.from.length:0;let i=null;if(n>0){X(n===1,65062);const p=t.from[0];p.allDescendants?i=p.collectionId:e=e.child(p.collectionId)}let s=[];t.where&&(s=(function(m){const g=Yd(m);return g instanceof Qe&&xd(g)?g.getFilters():[g]})(t.where));let a=[];t.orderBy&&(a=(function(m){return m.map((g=>(function(A){return new qi(xn(A.field),(function(P){switch(P){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}})(A.direction))})(g)))})(t.orderBy));let l=null;t.limit&&(l=(function(m){let g;return g=typeof m=="object"?m.value:m,ls(g)?null:g})(t.limit));let u=null;t.startAt&&(u=(function(m){const g=!!m.before,I=m.values||[];return new ji(I,g)})(t.startAt));let h=null;return t.endAt&&(h=(function(m){const g=!m.before,I=m.values||[];return new ji(I,g)})(t.endAt)),gv(e,i,a,s,l,"F",u,h)}function Xv(r,e){const t=(function(i){switch(i){case"TargetPurposeListen":return null;case"TargetPurposeExistenceFilterMismatch":return"existence-filter-mismatch";case"TargetPurposeExistenceFilterMismatchBloom":return"existence-filter-mismatch-bloom";case"TargetPurposeLimboResolution":return"limbo-document";default:return L(28987,{purpose:i})}})(e.purpose);return t==null?null:{"goog-listen-tags":t}}function Yd(r){return r.unaryFilter!==void 0?(function(t){switch(t.unaryFilter.op){case"IS_NAN":const n=xn(t.unaryFilter.field);return fe.create(n,"==",{doubleValue:NaN});case"IS_NULL":const i=xn(t.unaryFilter.field);return fe.create(i,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":const s=xn(t.unaryFilter.field);return fe.create(s,"!=",{doubleValue:NaN});case"IS_NOT_NULL":const a=xn(t.unaryFilter.field);return fe.create(a,"!=",{nullValue:"NULL_VALUE"});case"OPERATOR_UNSPECIFIED":return L(61313);default:return L(60726)}})(r):r.fieldFilter!==void 0?(function(t){return fe.create(xn(t.fieldFilter.field),(function(i){switch(i){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";case"OPERATOR_UNSPECIFIED":return L(58110);default:return L(50506)}})(t.fieldFilter.op),t.fieldFilter.value)})(r):r.compositeFilter!==void 0?(function(t){return Qe.create(t.compositeFilter.filters.map((n=>Yd(n))),(function(i){switch(i){case"AND":return"and";case"OR":return"or";default:return L(1026)}})(t.compositeFilter.op))})(r):L(30097,{filter:r})}function Zv(r){return Uv[r]}function eb(r){return zv[r]}function tb(r){return Bv[r]}function In(r){return{fieldPath:r.canonicalString()}}function xn(r){return Ee.fromServerFormat(r.fieldPath)}function Qd(r){return r instanceof fe?(function(t){if(t.op==="=="){if(fu(t.value))return{unaryFilter:{field:In(t.field),op:"IS_NAN"}};if(pu(t.value))return{unaryFilter:{field:In(t.field),op:"IS_NULL"}}}else if(t.op==="!="){if(fu(t.value))return{unaryFilter:{field:In(t.field),op:"IS_NOT_NAN"}};if(pu(t.value))return{unaryFilter:{field:In(t.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:In(t.field),op:eb(t.op),value:t.value}}})(r):r instanceof Qe?(function(t){const n=t.getFilters().map((i=>Qd(i)));return n.length===1?n[0]:{compositeFilter:{op:tb(t.op),filters:n}}})(r):L(54877,{filter:r})}function nb(r){const e=[];return r.fields.forEach((t=>e.push(t.canonicalString()))),{fieldPaths:e}}function Jd(r){return r.length>=4&&r.get(0)==="projects"&&r.get(2)==="databases"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Ve.DEFAULT_COLLECTION_PERCENTILE=10,Ve.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT=1e3,Ve.DEFAULT=new Ve(Xd,Ve.DEFAULT_COLLECTION_PERCENTILE,Ve.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT),Ve.DISABLED=new Ve(-1,0,0);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fb{constructor(e,t,n,i){this.remoteDocumentCache=e,this.mutationQueue=t,this.documentOverlayCache=n,this.indexManager=i}getDocument(e,t){let n=null;return this.documentOverlayCache.getOverlay(e,t).next((i=>(n=i,this.remoteDocumentCache.getEntry(e,t)))).next((i=>(n!==null&&Er(n.mutation,i,Fe.empty(),ie.now()),i)))}getDocuments(e,t){return this.remoteDocumentCache.getEntries(e,t).next((n=>this.getLocalViewOfDocuments(e,n,W()).next((()=>n))))}getLocalViewOfDocuments(e,t,n=W()){const i=tn();return this.populateOverlays(e,i,t).next((()=>this.computeViews(e,t,i,n).next((s=>{let a=dr();return s.forEach(((l,u)=>{a=a.insert(l,u.overlayedDocument)})),a}))))}getOverlayedDocuments(e,t){const n=tn();return this.populateOverlays(e,n,t).next((()=>this.computeViews(e,t,n,W())))}populateOverlays(e,t,n){const i=[];return n.forEach((s=>{t.has(s)||i.push(s)})),this.documentOverlayCache.getOverlays(e,i).next((s=>{s.forEach(((a,l)=>{t.set(a,l)}))}))}computeViews(e,t,n,i){let s=mt();const a=wr(),l=(function(){return wr()})();return t.forEach(((u,h)=>{const p=n.get(h.key);i.has(h.key)&&(p===void 0||p.mutation instanceof jt)?s=s.insert(h.key,h):p!==void 0?(a.set(h.key,p.mutation.getFieldMask()),Er(p.mutation,h,p.mutation.getFieldMask(),ie.now())):a.set(h.key,Fe.empty())})),this.recalculateAndSaveOverlays(e,s).next((u=>(u.forEach(((h,p)=>a.set(h,p))),t.forEach(((h,p)=>{var m;return l.set(h,new pb(p,(m=a.get(h))!==null&&m!==void 0?m:null))})),l)))}recalculateAndSaveOverlays(e,t){const n=wr();let i=new oe(((a,l)=>a-l)),s=W();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,t).next((a=>{for(const l of a)l.keys().forEach((u=>{const h=t.get(u);if(h===null)return;let p=n.get(u)||Fe.empty();p=l.applyToLocalView(h,p),n.set(u,p);const m=(i.get(l.batchId)||W()).add(u);i=i.insert(l.batchId,m)}))})).next((()=>{const a=[],l=i.getReverseIterator();for(;l.hasNext();){const u=l.getNext(),h=u.key,p=u.value,m=Vd();p.forEach((g=>{if(!s.has(g)){const I=Ud(t.get(g),n.get(g));I!==null&&m.set(g,I),s=s.add(g)}})),a.push(this.documentOverlayCache.saveOverlays(e,h,m))}return k.waitFor(a)})).next((()=>n))}recalculateAndSaveOverlaysForDocumentKeys(e,t){return this.remoteDocumentCache.getEntries(e,t).next((n=>this.recalculateAndSaveOverlays(e,n)))}getDocumentsMatchingQuery(e,t,n,i){return(function(a){return M.isDocumentKey(a.path)&&a.collectionGroup===null&&a.filters.length===0})(t)?this.getDocumentsMatchingDocumentQuery(e,t.path):kd(t)?this.getDocumentsMatchingCollectionGroupQuery(e,t,n,i):this.getDocumentsMatchingCollectionQuery(e,t,n,i)}getNextDocuments(e,t,n,i){return this.remoteDocumentCache.getAllFromCollectionGroup(e,t,n,i).next((s=>{const a=i-s.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,t,n.largestBatchId,i-s.size):k.resolve(tn());let l=Cr,u=s;return a.next((h=>k.forEach(h,((p,m)=>(l<m.largestBatchId&&(l=m.largestBatchId),s.get(p)?k.resolve():this.remoteDocumentCache.getEntry(e,p).next((g=>{u=u.insert(p,g)}))))).next((()=>this.populateOverlays(e,h,s))).next((()=>this.computeViews(e,u,h,W()))).next((p=>({batchId:l,changes:Nd(p)})))))}))}getDocumentsMatchingDocumentQuery(e,t){return this.getDocument(e,new M(t)).next((n=>{let i=dr();return n.isFoundDocument()&&(i=i.insert(n.key,n)),i}))}getDocumentsMatchingCollectionGroupQuery(e,t,n,i){const s=t.collectionGroup;let a=dr();return this.indexManager.getCollectionParents(e,s).next((l=>k.forEach(l,(u=>{const h=(function(m,g){return new Br(g,null,m.explicitOrderBy.slice(),m.filters.slice(),m.limit,m.limitType,m.startAt,m.endAt)})(t,u.child(s));return this.getDocumentsMatchingCollectionQuery(e,h,n,i).next((p=>{p.forEach(((m,g)=>{a=a.insert(m,g)}))}))})).next((()=>a))))}getDocumentsMatchingCollectionQuery(e,t,n,i){let s;return this.documentOverlayCache.getOverlaysForCollection(e,t.path,n.largestBatchId).next((a=>(s=a,this.remoteDocumentCache.getDocumentsMatchingQuery(e,t,n,s,i)))).next((a=>{s.forEach(((u,h)=>{const p=h.getKey();a.get(p)===null&&(a=a.insert(p,Re.newInvalidDocument(p)))}));let l=dr();return a.forEach(((u,h)=>{const p=s.get(u);p!==void 0&&Er(p.mutation,h,Fe.empty(),ie.now()),hs(t,h)&&(l=l.insert(u,h))})),l}))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gb{constructor(){this.overlays=new oe(M.comparator),this.kr=new Map}getOverlay(e,t){return k.resolve(this.overlays.get(t))}getOverlays(e,t){const n=tn();return k.forEach(t,(i=>this.getOverlay(e,i).next((s=>{s!==null&&n.set(i,s)})))).next((()=>n))}saveOverlays(e,t,n){return n.forEach(((i,s)=>{this.wt(e,t,s)})),k.resolve()}removeOverlaysForBatchId(e,t,n){const i=this.kr.get(n);return i!==void 0&&(i.forEach((s=>this.overlays=this.overlays.remove(s))),this.kr.delete(n)),k.resolve()}getOverlaysForCollection(e,t,n){const i=tn(),s=t.length+1,a=new M(t.child("")),l=this.overlays.getIteratorFrom(a);for(;l.hasNext();){const u=l.getNext().value,h=u.getKey();if(!t.isPrefixOf(h.path))break;h.path.length===s&&u.largestBatchId>n&&i.set(u.getKey(),u)}return k.resolve(i)}getOverlaysForCollectionGroup(e,t,n,i){let s=new oe(((h,p)=>h-p));const a=this.overlays.getIterator();for(;a.hasNext();){const h=a.getNext().value;if(h.getKey().getCollectionGroup()===t&&h.largestBatchId>n){let p=s.get(h.largestBatchId);p===null&&(p=tn(),s=s.insert(h.largestBatchId,p)),p.set(h.getKey(),h)}}const l=tn(),u=s.getIterator();for(;u.hasNext()&&(u.getNext().value.forEach(((h,p)=>l.set(h,p))),!(l.size()>=i)););return k.resolve(l)}wt(e,t,n){const i=this.overlays.get(n.key);if(i!==null){const a=this.kr.get(i.largestBatchId).delete(n.key);this.kr.set(i.largestBatchId,a)}this.overlays=this.overlays.insert(n.key,new Ov(t,n));let s=this.kr.get(t);s===void 0&&(s=W(),this.kr.set(t,s)),this.kr.set(t,s.add(n.key))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ib{constructor(){this.As=!1,this.Rs=!1,this.Vs=100,this.fs=(function(){return gm()?8:J_(Pe())>0?6:4})()}initialize(e,t){this.gs=e,this.indexManager=t,this.As=!0}getDocumentsMatchingQuery(e,t,n,i){const s={result:null};return this.ps(e,t).next((a=>{s.result=a})).next((()=>{if(!s.result)return this.ys(e,t,i,n).next((a=>{s.result=a}))})).next((()=>{if(s.result)return;const a=new Tb;return this.ws(e,t,a).next((l=>{if(s.result=l,this.Rs)return this.Ss(e,t,a,l.size)}))})).next((()=>s.result))}Ss(e,t,n,i){return n.documentReadCount<this.Vs?(En()<=G.DEBUG&&O("QueryEngine","SDK will not create cache indexes for query:",Tn(t),"since it only creates cache indexes for collection contains","more than or equal to",this.Vs,"documents"),k.resolve()):(En()<=G.DEBUG&&O("QueryEngine","Query:",Tn(t),"scans",n.documentReadCount,"local documents and returns",i,"documents as results."),n.documentReadCount>this.fs*i?(En()<=G.DEBUG&&O("QueryEngine","The SDK decides to create cache indexes for query:",Tn(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,et(t))):k.resolve())}ps(e,t){if(_u(t))return k.resolve(null);let n=et(t);return this.indexManager.getIndexType(e,n).next((i=>i===0?null:(t.limit!==null&&i===1&&(t=No(t,null,"F"),n=et(t)),this.indexManager.getDocumentsMatchingTarget(e,n).next((s=>{const a=W(...s);return this.gs.getDocuments(e,a).next((l=>this.indexManager.getMinOffset(e,n).next((u=>{const h=this.bs(t,l);return this.Ds(t,h,a,u.readTime)?this.ps(e,No(t,null,"F")):this.vs(e,h,t,u)}))))})))))}ys(e,t,n,i){return _u(t)||i.isEqual(B.min())?k.resolve(null):this.gs.getDocuments(e,n).next((s=>{const a=this.bs(t,s);return this.Ds(t,a,n,i)?k.resolve(null):(En()<=G.DEBUG&&O("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),Tn(t)),this.vs(e,a,t,G_(i,Cr)).next((l=>l)))}))}bs(e,t){let n=new ge(Pd(e));return t.forEach(((i,s)=>{hs(e,s)&&(n=n.add(s))})),n}Ds(e,t,n,i){if(e.limit===null)return!1;if(n.size!==t.size)return!0;const s=e.limitType==="F"?t.last():t.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(i)>0)}ws(e,t,n){return En()<=G.DEBUG&&O("QueryEngine","Using full collection scan to execute query:",Tn(t)),this.gs.getDocumentsMatchingQuery(e,t,Ot.min(),n)}vs(e,t,n,i){return this.gs.getDocumentsMatchingQuery(e,n,i).next((s=>(t.forEach((a=>{s=s.insert(a.key,a)})),s)))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ga="LocalStore",xb=3e8;class Ab{constructor(e,t,n,i){this.persistence=e,this.Cs=t,this.serializer=i,this.Fs=new oe(q),this.Ms=new fn((s=>Oa(s)),$a),this.xs=new Map,this.Os=e.getRemoteDocumentCache(),this.hi=e.getTargetCache(),this.Ti=e.getBundleCache(),this.Ns(n)}Ns(e){this.documentOverlayCache=this.persistence.getDocumentOverlayCache(e),this.indexManager=this.persistence.getIndexManager(e),this.mutationQueue=this.persistence.getMutationQueue(e,this.indexManager),this.localDocuments=new fb(this.Os,this.mutationQueue,this.documentOverlayCache,this.indexManager),this.Os.setIndexManager(this.indexManager),this.Cs.initialize(this.localDocuments,this.indexManager)}collectGarbage(e){return this.persistence.runTransaction("Collect garbage","readwrite-primary",(t=>e.collect(t,this.Fs)))}}function Sb(r,e,t,n){return new Ab(r,e,t,n)}async function ep(r,e){const t=j(r);return await t.persistence.runTransaction("Handle user change","readonly",(n=>{let i;return t.mutationQueue.getAllMutationBatches(n).next((s=>(i=s,t.Ns(e),t.mutationQueue.getAllMutationBatches(n)))).next((s=>{const a=[],l=[];let u=W();for(const h of i){a.push(h.batchId);for(const p of h.mutations)u=u.add(p.key)}for(const h of s){l.push(h.batchId);for(const p of h.mutations)u=u.add(p.key)}return t.localDocuments.getDocuments(n,u).next((h=>({Bs:h,removedBatchIds:a,addedBatchIds:l})))}))}))}function Cb(r,e){const t=j(r);return t.persistence.runTransaction("Acknowledge batch","readwrite-primary",(n=>{const i=e.batch.keys(),s=t.Os.newChangeBuffer({trackRemovals:!0});return(function(l,u,h,p){const m=h.batch,g=m.keys();let I=k.resolve();return g.forEach((A=>{I=I.next((()=>p.getEntry(u,A))).next((D=>{const P=h.docVersions.get(A);X(P!==null,48541),D.version.compareTo(P)<0&&(m.applyToRemoteDocument(D,h),D.isValidDocument()&&(D.setReadTime(h.commitVersion),p.addEntry(D)))}))})),I.next((()=>l.mutationQueue.removeMutationBatch(u,m)))})(t,n,e,s).next((()=>s.apply(n))).next((()=>t.mutationQueue.performConsistencyCheck(n))).next((()=>t.documentOverlayCache.removeOverlaysForBatchId(n,i,e.batch.batchId))).next((()=>t.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(n,(function(l){let u=W();for(let h=0;h<l.mutationResults.length;++h)l.mutationResults[h].transformResults.length>0&&(u=u.add(l.batch.mutations[h].key));return u})(e)))).next((()=>t.localDocuments.getDocuments(n,i)))}))}function tp(r){const e=j(r);return e.persistence.runTransaction("Get last remote snapshot version","readonly",(t=>e.hi.getLastRemoteSnapshotVersion(t)))}function kb(r,e){const t=j(r),n=e.snapshotVersion;let i=t.Fs;return t.persistence.runTransaction("Apply remote event","readwrite-primary",(s=>{const a=t.Os.newChangeBuffer({trackRemovals:!0});i=t.Fs;const l=[];e.targetChanges.forEach(((p,m)=>{const g=i.get(m);if(!g)return;l.push(t.hi.removeMatchingKeys(s,p.removedDocuments,m).next((()=>t.hi.addMatchingKeys(s,p.addedDocuments,m))));let I=g.withSequenceNumber(s.currentSequenceNumber);e.targetMismatches.get(m)!==null?I=I.withResumeToken(Te.EMPTY_BYTE_STRING,B.min()).withLastLimboFreeSnapshotVersion(B.min()):p.resumeToken.approximateByteSize()>0&&(I=I.withResumeToken(p.resumeToken,n)),i=i.insert(m,I),(function(D,P,z){return D.resumeToken.approximateByteSize()===0||P.snapshotVersion.toMicroseconds()-D.snapshotVersion.toMicroseconds()>=xb?!0:z.addedDocuments.size+z.modifiedDocuments.size+z.removedDocuments.size>0})(g,I,p)&&l.push(t.hi.updateTargetData(s,I))}));let u=mt(),h=W();if(e.documentUpdates.forEach((p=>{e.resolvedLimboDocuments.has(p)&&l.push(t.persistence.referenceDelegate.updateLimboDocument(s,p))})),l.push(Rb(s,a,e.documentUpdates).next((p=>{u=p.Ls,h=p.ks}))),!n.isEqual(B.min())){const p=t.hi.getLastRemoteSnapshotVersion(s).next((m=>t.hi.setTargetsMetadata(s,s.currentSequenceNumber,n)));l.push(p)}return k.waitFor(l).next((()=>a.apply(s))).next((()=>t.localDocuments.getLocalViewOfDocuments(s,u,h))).next((()=>u))})).then((s=>(t.Fs=i,s)))}function Rb(r,e,t){let n=W(),i=W();return t.forEach((s=>n=n.add(s))),e.getEntries(r,n).next((s=>{let a=mt();return t.forEach(((l,u)=>{const h=s.get(l);u.isFoundDocument()!==h.isFoundDocument()&&(i=i.add(l)),u.isNoDocument()&&u.version.isEqual(B.min())?(e.removeEntry(l,u.readTime),a=a.insert(l,u)):!h.isValidDocument()||u.version.compareTo(h.version)>0||u.version.compareTo(h.version)===0&&h.hasPendingWrites?(e.addEntry(u),a=a.insert(l,u)):O(Ga,"Ignoring outdated watch update for ",l,". Current version:",h.version," Watch version:",u.version)})),{Ls:a,ks:i}}))}function Pb(r,e){const t=j(r);return t.persistence.runTransaction("Get next mutation batch","readonly",(n=>(e===void 0&&(e=Da),t.mutationQueue.getNextMutationBatchAfterBatchId(n,e))))}function Db(r,e){const t=j(r);return t.persistence.runTransaction("Allocate target","readwrite",(n=>{let i;return t.hi.getTargetData(n,e).next((s=>s?(i=s,k.resolve(i)):t.hi.allocateTargetId(n).next((a=>(i=new At(e,a,"TargetPurposeListen",n.currentSequenceNumber),t.hi.addTargetData(n,i).next((()=>i)))))))})).then((n=>{const i=t.Fs.get(n.targetId);return(i===null||n.snapshotVersion.compareTo(i.snapshotVersion)>0)&&(t.Fs=t.Fs.insert(n.targetId,n),t.Ms.set(e,n.targetId)),n}))}async function Lo(r,e,t){const n=j(r),i=n.Fs.get(e),s=t?"readwrite":"readwrite-primary";try{t||await n.persistence.runTransaction("Release target",s,(a=>n.persistence.referenceDelegate.removeTarget(a,i)))}catch(a){if(!Hn(a))throw a;O(Ga,`Failed to update sequence numbers for target ${e}: ${a}`)}n.Fs=n.Fs.remove(e),n.Ms.delete(i.target)}function Pu(r,e,t){const n=j(r);let i=B.min(),s=W();return n.persistence.runTransaction("Execute query","readwrite",(a=>(function(u,h,p){const m=j(u),g=m.Ms.get(p);return g!==void 0?k.resolve(m.Fs.get(g)):m.hi.getTargetData(h,p)})(n,a,et(e)).next((l=>{if(l)return i=l.lastLimboFreeSnapshotVersion,n.hi.getMatchingKeysForTargetId(a,l.targetId).next((u=>{s=u}))})).next((()=>n.Cs.getDocumentsMatchingQuery(a,e,t?i:B.min(),t?s:W()))).next((l=>(Nb(n,_v(e),l),{documents:l,qs:s})))))}function Nb(r,e,t){let n=r.xs.get(e)||B.min();t.forEach(((i,s)=>{s.readTime.compareTo(n)>0&&(n=s.readTime)})),r.xs.set(e,n)}class Du{constructor(){this.activeTargetIds=Iv()}Gs(e){this.activeTargetIds=this.activeTargetIds.add(e)}zs(e){this.activeTargetIds=this.activeTargetIds.delete(e)}Ws(){const e={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(e)}}class Vb{constructor(){this.Fo=new Du,this.Mo={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}addPendingMutation(e){}updateMutationState(e,t,n){}addLocalQueryTarget(e,t=!0){return t&&this.Fo.Gs(e),this.Mo[e]||"not-current"}updateQueryState(e,t,n){this.Mo[e]=t}removeLocalQueryTarget(e){this.Fo.zs(e)}isLocalQueryTarget(e){return this.Fo.activeTargetIds.has(e)}clearQueryState(e){delete this.Mo[e]}getAllActiveQueryTargets(){return this.Fo.activeTargetIds}isActiveQueryTarget(e){return this.Fo.activeTargetIds.has(e)}start(){return this.Fo=new Du,Promise.resolve()}handleUserChange(e,t,n){}setOnlineState(e){}shutdown(){}writeSequenceNumber(e){}notifyBundleLoaded(e){}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ao="RestConnection",$b={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery"};class Mb{get Qo(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",n=encodeURIComponent(this.databaseId.projectId),i=encodeURIComponent(this.databaseId.database);this.$o=t+"://"+e.host,this.Uo=`projects/${n}/databases/${i}`,this.Ko=this.databaseId.database===zi?`project_id=${n}`:`project_id=${n}&database_id=${i}`}Wo(e,t,n,i,s){const a=Fo(),l=this.Go(e,t.toUriEncodedString());O(ao,`Sending RPC '${e}' ${a}:`,l,n);const u={"google-cloud-resource-prefix":this.Uo,"x-goog-request-params":this.Ko};this.zo(u,i,s);const{host:h}=new URL(l),p=pn(h);return this.jo(e,l,u,n,p).then((m=>(O(ao,`Received RPC '${e}' ${a}: `,m),m)),(m=>{throw Vt(ao,`RPC '${e}' ${a} failed with error: `,m,"url: ",l,"request:",n),m}))}Jo(e,t,n,i,s,a){return this.Wo(e,t,n,i,s)}zo(e,t,n){e["X-Goog-Api-Client"]=(function(){return"gl-js/ fire/"+jn})(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach(((i,s)=>e[s]=i)),n&&n.headers.forEach(((i,s)=>e[s]=i))}Go(e,t){const n=$b[e];return`${this.$o}/v1/${t}:${n}`}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ce="WebChannelConnection";class Fb extends Mb{constructor(e){super(e),this.u_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}jo(e,t,n,i,s){const a=Fo();return new Promise(((l,u)=>{const h=new rd;h.setWithCredentials(!0),h.listenOnce(id.COMPLETE,(()=>{try{switch(h.getLastErrorCode()){case Ii.NO_ERROR:const m=h.getResponseJson();O(Ce,`XHR for RPC '${e}' ${a} received:`,JSON.stringify(m)),l(m);break;case Ii.TIMEOUT:O(Ce,`RPC '${e}' ${a} timed out`),u(new $(C.DEADLINE_EXCEEDED,"Request time out"));break;case Ii.HTTP_ERROR:const g=h.getStatus();if(O(Ce,`RPC '${e}' ${a} failed with status:`,g,"response text:",h.getResponseText()),g>0){let I=h.getResponseJson();Array.isArray(I)&&(I=I[0]);const A=I==null?void 0:I.error;if(A&&A.status&&A.message){const D=(function(z){const F=z.toLowerCase().replace(/_/g,"-");return Object.values(C).indexOf(F)>=0?F:C.UNKNOWN})(A.status);u(new $(D,A.message))}else u(new $(C.UNKNOWN,"Server responded with status "+h.getStatus()))}else u(new $(C.UNAVAILABLE,"Connection failed."));break;default:L(9055,{c_:e,streamId:a,l_:h.getLastErrorCode(),h_:h.getLastError()})}}finally{O(Ce,`RPC '${e}' ${a} completed.`)}}));const p=JSON.stringify(i);O(Ce,`RPC '${e}' ${a} sending request:`,i),h.send(t,"POST",p,n,15)}))}P_(e,t,n){const i=Fo(),s=[this.$o,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=ad(),l=od(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},h=this.longPollingOptions.timeoutSeconds;h!==void 0&&(u.longPollingTimeout=Math.round(1e3*h)),this.useFetchStreams&&(u.useFetchStreams=!0),this.zo(u.initMessageHeaders,t,n),u.encodeInitMessageHeaders=!0;const p=s.join("");O(Ce,`Creating RPC '${e}' stream ${i}: ${p}`,u);const m=a.createWebChannel(p,u);this.T_(m);let g=!1,I=!1;const A=new Lb({Ho:P=>{I?O(Ce,`Not sending because RPC '${e}' stream ${i} is closed:`,P):(g||(O(Ce,`Opening RPC '${e}' stream ${i} transport.`),m.open(),g=!0),O(Ce,`RPC '${e}' stream ${i} sending:`,P),m.send(P))},Yo:()=>m.close()}),D=(P,z,F)=>{P.listen(z,(V=>{try{F(V)}catch(J){setTimeout((()=>{throw J}),0)}}))};return D(m,hr.EventType.OPEN,(()=>{I||(O(Ce,`RPC '${e}' stream ${i} transport opened.`),A.s_())})),D(m,hr.EventType.CLOSE,(()=>{I||(I=!0,O(Ce,`RPC '${e}' stream ${i} transport closed`),A.__(),this.I_(m))})),D(m,hr.EventType.ERROR,(P=>{I||(I=!0,Vt(Ce,`RPC '${e}' stream ${i} transport errored. Name:`,P.name,"Message:",P.message),A.__(new $(C.UNAVAILABLE,"The operation could not be completed")))})),D(m,hr.EventType.MESSAGE,(P=>{var z;if(!I){const F=P.data[0];X(!!F,16349);const V=F,J=(V==null?void 0:V.error)||((z=V[0])===null||z===void 0?void 0:z.error);if(J){O(Ce,`RPC '${e}' stream ${i} received error:`,J);const Ue=J.status;let ce=(function(v){const b=pe[v];if(b!==void 0)return Bd(b)})(Ue),w=J.message;ce===void 0&&(ce=C.INTERNAL,w="Unknown error status: "+Ue+" with message "+J.message),I=!0,A.__(new $(ce,w)),m.close()}else O(Ce,`RPC '${e}' stream ${i} received:`,F),A.a_(F)}})),D(l,sd.STAT_EVENT,(P=>{P.stat===Ao.PROXY?O(Ce,`RPC '${e}' stream ${i} detected buffering proxy`):P.stat===Ao.NOPROXY&&O(Ce,`RPC '${e}' stream ${i} detected no buffering proxy`)})),setTimeout((()=>{A.o_()}),0),A}terminate(){this.u_.forEach((e=>e.close())),this.u_=[]}T_(e){this.u_.push(e)}I_(e){this.u_=this.u_.filter((t=>t===e))}}function lo(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dn="RemoteStore";class Hb{constructor(e,t,n,i,s){this.localStore=e,this.datastore=t,this.asyncQueue=n,this.remoteSyncer={},this.Pa=[],this.Ta=new Map,this.Ia=new Set,this.da=[],this.Ea=s,this.Ea.xo((a=>{n.enqueueAndForget((async()=>{mn(this)&&(O(dn,"Restarting streams for network reachability change."),await(async function(u){const h=j(u);h.Ia.add(4),await Hr(h),h.Aa.set("Unknown"),h.Ia.delete(4),await gs(h)})(this))}))})),this.Aa=new qb(n,i)}}async function gs(r){if(mn(r))for(const e of r.da)await e(!0)}async function Hr(r){for(const e of r.da)await e(!1)}function ip(r,e){const t=j(r);t.Ta.has(e.targetId)||(t.Ta.set(e.targetId,e),Qa(t)?Ya(t):Gn(t).x_()&&Ka(t,e))}function Wa(r,e){const t=j(r),n=Gn(t);t.Ta.delete(e),n.x_()&&sp(t,e),t.Ta.size===0&&(n.x_()?n.B_():mn(t)&&t.Aa.set("Unknown"))}function Ka(r,e){if(r.Ra.$e(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(B.min())>0){const t=r.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}Gn(r).H_(e)}function sp(r,e){r.Ra.$e(e),Gn(r).Y_(e)}function Ya(r){r.Ra=new Fv({getRemoteKeysForTarget:e=>r.remoteSyncer.getRemoteKeysForTarget(e),Et:e=>r.Ta.get(e)||null,lt:()=>r.datastore.serializer.databaseId}),Gn(r).start(),r.Aa.aa()}function Qa(r){return mn(r)&&!Gn(r).M_()&&r.Ta.size>0}function mn(r){return j(r).Ia.size===0}function op(r){r.Ra=void 0}async function Gb(r){r.Aa.set("Online")}async function Wb(r){r.Ta.forEach(((e,t)=>{Ka(r,e)}))}async function Kb(r,e){op(r),Qa(r)?(r.Aa.la(e),Ya(r)):r.Aa.set("Unknown")}async function Yb(r,e,t){if(r.Aa.set("Online"),e instanceof qd&&e.state===2&&e.cause)try{await(async function(i,s){const a=s.cause;for(const l of s.targetIds)i.Ta.has(l)&&(await i.remoteSyncer.rejectListen(l,a),i.Ta.delete(l),i.Ra.removeTarget(l))})(r,e)}catch(n){O(dn,"Failed to remove targets %s: %s ",e.targetIds.join(","),n),await Ki(r,n)}else if(e instanceof Ci?r.Ra.Ye(e):e instanceof jd?r.Ra.it(e):r.Ra.et(e),!t.isEqual(B.min()))try{const n=await tp(r.localStore);t.compareTo(n)>=0&&await(function(s,a){const l=s.Ra.Pt(a);return l.targetChanges.forEach(((u,h)=>{if(u.resumeToken.approximateByteSize()>0){const p=s.Ta.get(h);p&&s.Ta.set(h,p.withResumeToken(u.resumeToken,a))}})),l.targetMismatches.forEach(((u,h)=>{const p=s.Ta.get(u);if(!p)return;s.Ta.set(u,p.withResumeToken(Te.EMPTY_BYTE_STRING,p.snapshotVersion)),sp(s,u);const m=new At(p.target,u,h,p.sequenceNumber);Ka(s,m)})),s.remoteSyncer.applyRemoteEvent(l)})(r,t)}catch(n){O(dn,"Failed to raise snapshot:",n),await Ki(r,n)}}async function Ki(r,e,t){if(!Hn(e))throw e;r.Ia.add(1),await Hr(r),r.Aa.set("Offline"),t||(t=()=>tp(r.localStore)),r.asyncQueue.enqueueRetryable((async()=>{O(dn,"Retrying IndexedDB access"),await t(),r.Ia.delete(1),await gs(r)}))}function ap(r,e){return e().catch((t=>Ki(r,t,e)))}async function ys(r){const e=j(r),t=Ft(e);let n=e.Pa.length>0?e.Pa[e.Pa.length-1].batchId:Da;for(;Qb(e);)try{const i=await Pb(e.localStore,n);if(i===null){e.Pa.length===0&&t.B_();break}n=i.batchId,Jb(e,i)}catch(i){await Ki(e,i)}lp(e)&&cp(e)}function Qb(r){return mn(r)&&r.Pa.length<10}function Jb(r,e){r.Pa.push(e);const t=Ft(r);t.x_()&&t.Z_&&t.X_(e.mutations)}function lp(r){return mn(r)&&!Ft(r).M_()&&r.Pa.length>0}function cp(r){Ft(r).start()}async function Xb(r){Ft(r).na()}async function Zb(r){const e=Ft(r);for(const t of r.Pa)e.X_(t.mutations)}async function e0(r,e,t){const n=r.Pa.shift(),i=Ua.from(n,e,t);await ap(r,(()=>r.remoteSyncer.applySuccessfulWrite(i))),await ys(r)}async function t0(r,e){e&&Ft(r).Z_&&await(async function(n,i){if((function(a){return Mv(a)&&a!==C.ABORTED})(i.code)){const s=n.Pa.shift();Ft(n).N_(),await ap(n,(()=>n.remoteSyncer.rejectFailedWrite(s.batchId,i))),await ys(n)}})(r,e),lp(r)&&cp(r)}async function $u(r,e){const t=j(r);t.asyncQueue.verifyOperationInProgress(),O(dn,"RemoteStore received new credentials");const n=mn(t);t.Ia.add(3),await Hr(t),n&&t.Aa.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.Ia.delete(3),await gs(t)}async function n0(r,e){const t=j(r);e?(t.Ia.delete(2),await gs(t)):e||(t.Ia.add(2),await Hr(t),t.Aa.set("Unknown"))}function Gn(r){return r.Va||(r.Va=(function(t,n,i){const s=j(t);return s.ia(),new Ub(n,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,i)})(r.datastore,r.asyncQueue,{Zo:Gb.bind(null,r),e_:Wb.bind(null,r),n_:Kb.bind(null,r),J_:Yb.bind(null,r)}),r.da.push((async e=>{e?(r.Va.N_(),Qa(r)?Ya(r):r.Aa.set("Unknown")):(await r.Va.stop(),op(r))}))),r.Va}function Ft(r){return r.ma||(r.ma=(function(t,n,i){const s=j(t);return s.ia(),new zb(n,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,i)})(r.datastore,r.asyncQueue,{Zo:()=>Promise.resolve(),e_:Xb.bind(null,r),n_:t0.bind(null,r),ea:Zb.bind(null,r),ta:e0.bind(null,r)}),r.da.push((async e=>{e?(r.ma.N_(),await ys(r)):(await r.ma.stop(),r.Pa.length>0&&(O(dn,`Stopping write stream with ${r.Pa.length} pending writes`),r.Pa=[]))}))),r.ma}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mu{constructor(){this.fa=new oe(M.comparator)}track(e){const t=e.doc.key,n=this.fa.get(t);n?e.type!==0&&n.type===3?this.fa=this.fa.insert(t,e):e.type===3&&n.type!==1?this.fa=this.fa.insert(t,{type:n.type,doc:e.doc}):e.type===2&&n.type===2?this.fa=this.fa.insert(t,{type:2,doc:e.doc}):e.type===2&&n.type===0?this.fa=this.fa.insert(t,{type:0,doc:e.doc}):e.type===1&&n.type===0?this.fa=this.fa.remove(t):e.type===1&&n.type===2?this.fa=this.fa.insert(t,{type:1,doc:n.doc}):e.type===0&&n.type===1?this.fa=this.fa.insert(t,{type:2,doc:e.doc}):L(63341,{At:e,ga:n}):this.fa=this.fa.insert(t,e)}pa(){const e=[];return this.fa.inorderTraversal(((t,n)=>{e.push(n)})),e}}class Fn{constructor(e,t,n,i,s,a,l,u,h){this.query=e,this.docs=t,this.oldDocs=n,this.docChanges=i,this.mutatedKeys=s,this.fromCache=a,this.syncStateChanged=l,this.excludesMetadataChanges=u,this.hasCachedResults=h}static fromInitialDocuments(e,t,n,i,s){const a=[];return t.forEach((l=>{a.push({type:0,doc:l})})),new Fn(e,t,Pn.emptySet(t),a,n,i,!0,!1,s)}get hasPendingWrites(){return!this.mutatedKeys.isEmpty()}isEqual(e){if(!(this.fromCache===e.fromCache&&this.hasCachedResults===e.hasCachedResults&&this.syncStateChanged===e.syncStateChanged&&this.mutatedKeys.isEqual(e.mutatedKeys)&&us(this.query,e.query)&&this.docs.isEqual(e.docs)&&this.oldDocs.isEqual(e.oldDocs)))return!1;const t=this.docChanges,n=e.docChanges;if(t.length!==n.length)return!1;for(let i=0;i<t.length;i++)if(t[i].type!==n[i].type||!t[i].doc.isEqual(n[i].doc))return!1;return!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ip="firestore.googleapis.com",qu=!0;class Hu{constructor(e){var t,n;if(e.host===void 0){if(e.ssl!==void 0)throw new $(C.INVALID_ARGUMENT,"Can't provide ssl option if host option is not set");this.host=Ip,this.ssl=qu}else this.host=e.host,this.ssl=(t=e.ssl)!==null&&t!==void 0?t:qu;if(this.isUsingEmulator=e.emulatorOptions!==void 0,this.credentials=e.credentials,this.ignoreUndefinedProperties=!!e.ignoreUndefinedProperties,this.localCache=e.localCache,e.cacheSizeBytes===void 0)this.cacheSizeBytes=Xd;else{if(e.cacheSizeBytes!==-1&&e.cacheSizeBytes<ab)throw new $(C.INVALID_ARGUMENT,"cacheSizeBytes must be at least 1048576");this.cacheSizeBytes=e.cacheSizeBytes}H_("experimentalForceLongPolling",e.experimentalForceLongPolling,"experimentalAutoDetectLongPolling",e.experimentalAutoDetectLongPolling),this.experimentalForceLongPolling=!!e.experimentalForceLongPolling,this.experimentalForceLongPolling?this.experimentalAutoDetectLongPolling=!1:e.experimentalAutoDetectLongPolling===void 0?this.experimentalAutoDetectLongPolling=!0:this.experimentalAutoDetectLongPolling=!!e.experimentalAutoDetectLongPolling,this.experimentalLongPollingOptions=Tp((n=e.experimentalLongPollingOptions)!==null&&n!==void 0?n:{}),(function(s){if(s.timeoutSeconds!==void 0){if(isNaN(s.timeoutSeconds))throw new $(C.INVALID_ARGUMENT,`invalid long polling timeout: ${s.timeoutSeconds} (must not be NaN)`);if(s.timeoutSeconds<5)throw new $(C.INVALID_ARGUMENT,`invalid long polling timeout: ${s.timeoutSeconds} (minimum allowed value is 5)`);if(s.timeoutSeconds>30)throw new $(C.INVALID_ARGUMENT,`invalid long polling timeout: ${s.timeoutSeconds} (maximum allowed value is 30)`)}})(this.experimentalLongPollingOptions),this.useFetchStreams=!!e.useFetchStreams}isEqual(e){return this.host===e.host&&this.ssl===e.ssl&&this.credentials===e.credentials&&this.cacheSizeBytes===e.cacheSizeBytes&&this.experimentalForceLongPolling===e.experimentalForceLongPolling&&this.experimentalAutoDetectLongPolling===e.experimentalAutoDetectLongPolling&&(function(n,i){return n.timeoutSeconds===i.timeoutSeconds})(this.experimentalLongPollingOptions,e.experimentalLongPollingOptions)&&this.ignoreUndefinedProperties===e.ignoreUndefinedProperties&&this.useFetchStreams===e.useFetchStreams}}class _s{constructor(e,t,n,i){this._authCredentials=e,this._appCheckCredentials=t,this._databaseId=n,this._app=i,this.type="firestore-lite",this._persistenceKey="(lite)",this._settings=new Hu({}),this._settingsFrozen=!1,this._emulatorOptions={},this._terminateTask="notTerminated"}get app(){if(!this._app)throw new $(C.FAILED_PRECONDITION,"Firestore was not initialized using the Firebase SDK. 'app' is not available");return this._app}get _initialized(){return this._settingsFrozen}get _terminated(){return this._terminateTask!=="notTerminated"}_setSettings(e){if(this._settingsFrozen)throw new $(C.FAILED_PRECONDITION,"Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");this._settings=new Hu(e),this._emulatorOptions=e.emulatorOptions||{},e.credentials!==void 0&&(this._authCredentials=(function(n){if(!n)return new $_;switch(n.type){case"firstParty":return new U_(n.sessionIndex||"0",n.iamToken||null,n.authTokenFactory||null);case"provider":return n.client;default:throw new $(C.INVALID_ARGUMENT,"makeAuthCredentialsProvider failed due to invalid credential type")}})(e.credentials))}_getSettings(){return this._settings}_getEmulatorOptions(){return this._emulatorOptions}_freezeSettings(){return this._settingsFrozen=!0,this._settings}_delete(){return this._terminateTask==="notTerminated"&&(this._terminateTask=this._terminate()),this._terminateTask}async _restart(){this._terminateTask==="notTerminated"?await this._terminate():this._terminateTask="notTerminated"}toJSON(){return{app:this._app,databaseId:this._databaseId,settings:this._settings}}_terminate(){return(function(t){const n=ju.get(t);n&&(O("ComponentProvider","Removing Datastore"),ju.delete(t),n.terminate())})(this),Promise.resolve()}}function k0(r,e,t,n={}){var i;r=je(r,_s);const s=pn(e),a=r._getSettings(),l=Object.assign(Object.assign({},a),{emulatorOptions:r._getEmulatorOptions()}),u=`${e}:${t}`;s&&(fa(`https://${u}`),ma("Firestore",!0)),a.host!==Ip&&a.host!==u&&Vt("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used.");const h=Object.assign(Object.assign({},a),{host:u,ssl:s,emulatorOptions:n});if(!ln(h,l)&&(r._setSettings(h),n.mockUserToken)){let p,m;if(typeof n.mockUserToken=="string")p=n.mockUserToken,m=ke.MOCK_USER;else{p=am(n.mockUserToken,(i=r._app)===null||i===void 0?void 0:i.options.projectId);const g=n.mockUserToken.sub||n.mockUserToken.user_id;if(!g)throw new $(C.INVALID_ARGUMENT,"mockUserToken must contain 'sub' or 'user_id' field!");m=new ke(g)}r._authCredentials=new M_(new cd(p,m))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Be{constructor(e){this._byteString=e}static fromBase64String(e){try{return new Be(Te.fromBase64String(e))}catch(t){throw new $(C.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new Be(Te.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}toJSON(){return{type:Be._jsonSchemaVersion,bytes:this.toBase64()}}static fromJSON(e){if(zr(e,Be._jsonSchema))return Be.fromBase64String(e.bytes)}}Be._jsonSchemaVersion="firestore/bytes/1.0",Be._jsonSchema={type:me("string",Be._jsonSchemaVersion),bytes:me("string")};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vs{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new $(C.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Ee(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xu={OK:"ok",CANCELLED:"cancelled",UNKNOWN:"unknown",INVALID_ARGUMENT:"invalid-argument",DEADLINE_EXCEEDED:"deadline-exceeded",NOT_FOUND:"not-found",ALREADY_EXISTS:"already-exists",PERMISSION_DENIED:"permission-denied",UNAUTHENTICATED:"unauthenticated",RESOURCE_EXHAUSTED:"resource-exhausted",FAILED_PRECONDITION:"failed-precondition",ABORTED:"aborted",OUT_OF_RANGE:"out-of-range",UNIMPLEMENTED:"unimplemented",INTERNAL:"internal",UNAVAILABLE:"unavailable",DATA_LOSS:"data-loss"};class $e extends ot{constructor(e,t,n){super(`${hl}/${e}`,t||""),this.details=n,Object.setPrototypeOf(this,$e.prototype)}}function G0(r){if(r>=200&&r<300)return"ok";switch(r){case 0:return"internal";case 400:return"invalid-argument";case 401:return"unauthenticated";case 403:return"permission-denied";case 404:return"not-found";case 409:return"aborted";case 429:return"resource-exhausted";case 499:return"cancelled";case 500:return"internal";case 501:return"unimplemented";case 503:return"unavailable";case 504:return"deadline-exceeded"}return"unknown"}function Xi(r,e){let t=G0(r),n=t,i;try{const s=e&&e.error;if(s){const a=s.status;if(typeof a=="string"){if(!Xu[a])return new $e("internal","internal");t=Xu[a],n=a}const l=s.message;typeof l=="string"&&(n=l),i=s.details,i!==void 0&&(i=Un(i))}}catch{}return t==="ok"?null:new $e(t,n,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`)}class ta extends se{constructor(){super(),this.trip=null,this.members=[]}_fmtDates(e,t){const n=new Date(e),i=new Date(t),s=n.toLocaleString("en-GB",{month:"short"}),a=i.toLocaleString("en-GB",{month:"short"});return s===a&&n.getFullYear()===i.getFullYear()?`${n.getDate()}–${i.getDate()} ${s}`:`${n.getDate()} ${s} – ${i.getDate()} ${a}`}async _onShare(e,t,n){n.stopPropagation();const i=Ew(e,t);if(navigator.share)try{await navigator.share({title:`Cairn — ${e.title??"activity"}`,text:i})}catch{}else try{await navigator.clipboard.writeText(i),Q("Itinerary copied to clipboard.")}catch{Q("Could not copy — try again from a browser tab.")}}render(){const e=this.trip;if(!e)return R``;const t=e.coverImage?`background-image: url(${e.coverImage});`:`background: ${bw(e)};`,n=new Map(this.members.map(l=>[l.uid,l])),i=(e.attendees??[]).map(l=>n.get(l)).filter(Boolean),s=i.slice(0,4),a=Math.max(0,i.length-s.length);return R`
  ...
  `);customElements.define("all-trips-modal",na);class ra extends se{constructor(){super(),this.open=!1,this._events=[],this._selected=new Set,this._loading=!1,this._error="",this._importing=!1}willUpdate(e){e.has("open")&&this.open&&this._events.length===0&&!this._loading&&this._load()}async _load(){var e,t,n,i,s,a;this._loading=!0,this._error="";try{const l=await Bp(),u=await _w(l,90),h=new Set((le.state.trips??[]).filter(m=>m.gcalEventId).map(m=>m.gcalEventId));this._events=u.map(m=>({...m,_alreadyImported:h.has(m.id)}));const p=new Set;for(const m of this._events){if(m._alreadyImported)continue;const g=((e=m.start)==null?void 0:e.date)??((n=(t=m.start)==null?void 0:t.dateTime)==null?void 0:n.slice(0,10)),I=((i=m.end)==null?void 0:i.date)??((a=(s=m.end)==null?void 0:s.dateTime)==null?void 0:a.slice(0,10));g&&I&&I!==g&&p.add(m.id)}this._selected=p}catch(l){console.error(l),this._error=(l==null?void 0:l.message)??"Could not load calendar events."}finally{this._loading=!1}}_toggle(e){const t=new Set(this._selected);t.has(e)?t.delete(e):t.add(e),this._selected=t}_toggleAll(){const e=this._events.filter(t=>!t._alreadyImported);this._selected.size===e.length?this._selected=new Set:this._selected=new Set(e.map(t=>t.id))}async _import(){var s;if(this._importing||this._selected.size===0)return;this._importing=!0;const e=(s=te==null?void 0:te.currentUser)==null?void 0:s.uid,t=this._events.filter(a=>this._selected.has(a.id));let n=0,i=0;for(const a of t){const l=vw(a,e);try{await le.saveTrip(l),n++}catch(u){console.error("Import failed for event",a.id,u),i++}}this._importing=!1,i===0?Q(`Imported ${n} ${n===1?"activity":"activities"}.`):Q(`Imported ${n}, ${i} failed.`,{duration:5e3}),this._events=[],this._selected=new Set,this.dispatchEvent(new Event("cancel"))}_onCancel(){this.dispatchEvent(new Event("cancel"))}_fmtRange(e){var p,m,g,I,A,D,P,z;const t=((p=e.start)==null?void 0:p.date)??((g=(m=e.start)==null?void 0:m.dateTime)==null?void 0:g.slice(0,10)),n=((I=e.end)==null?void 0:I.date)??((D=(A=e.end)==null?void 0:A.dateTime)==null?void 0:D.slice(0,10));if(!t)return"";const i=new Date(t);if(!n||n===t)return i.toLocaleString("en-GB",{day:"numeric",month:"short",year:"numeric"});let s=new Date(n);(P=e.start)!=null&&P.date&&((z=e.end)!=null&&z.date)&&s.setDate(s.getDate()-1);const a=i.getMonth()===s.getMonth()&&i.getFullYear()===s.getFullYear(),l=i.getFullYear()===s.getFullYear();if(a)return`${i.getDate()}–${s.getDate()} ${i.toLocaleString("en-GB",{month:"short",year:"numeric"})}`;const u=i.toLocaleString("en-GB",{day:"numeric",month:"short"}),h=s.toLocaleString("en-GB",{day:"numeric",month:"short",year:"numeric"});return l?`${u} – ${h}`:`${i.toLocaleDateString()} – ${s.toLocaleDateString()}`}render(){if(!this.open)return R``;const e=this._events.filter(n=>!n._alreadyImported),t=e.length>0&&this._selected.size===e.length;return R`
      <div class="backdrop" @click=${this._onCancel}></div>
      <div class="sheet">
        <glass-panel padding="lg" variant="strong" lifted>
          <div class="header">
  ...
  `);customElements.define("import-calendar-modal",ra);class ia extends se{constructor(){super(),this.open=!1,this.user=null,this.pebbleUser=null,this._name="",this._savingName=!1}willUpdate(e){var t;e.has("open")&&this.open&&(this._name=((t=this.user)==null?void 0:t.displayName)??"")}_onCancel(){this.dispatchEvent(new Event("cancel"))}async _saveName(){var t,n;const e=this._name.trim();if(!(!e||e===(((t=this.user)==null?void 0:t.displayName)??""))&&!(!((n=te==null?void 0:te.currentUser)!=null&&n.uid)||!Z)){this._savingName=!0;try{await Xt(Le(Z,"users",te.currentUser.uid),{displayName:e,updatedAt:Ge()}),Q("Display name updated.")}catch(i){console.error(i),Q(`Couldn't save: ${i.code??i.message}`,{duration:5e3})}finally{this._savingName=!1}}}async _signOut(){confirm("Sign out of Cairn?")&&(this.dispatchEvent(new Event("cancel")),await qp())}render(){if(!this.open)return R``;const e=this.user,t=this._name.trim()&&this._name.trim()!==((e==null?void 0:e.displayName)??"");return R`
      <div class="backdrop" @click=${this._onCancel}></div>
      <div class="sheet">
        <glass-panel padding="lg" variant="strong" lifted>
          <div class="header">
  ...
  `);customElements.define("profile-sheet",ia);class Wp extends se{render(){return R`
  ...
  `);customElements.define("join-family-screen",sa);class oa extends se{constructor(){super(),this.error="",this.busy=!1,this.joinCode=""}async _handleSignIn(){if(!this.busy){this.busy=!0,this.error="";try{await jp()}catch(e){this.error=(e==null?void 0:e.message)??"Sign-in failed."}finally{this.busy=!1}}}_renderGoogleIcon(){return R`
  ...
  `);customElements.define("sign-in-screen",oa);const Tw="modulepreload",Iw=function(r){return"/cairn/"+r},rh={},xw=function(e,t,n){let i=Promise.resolve();if(t&&t.length>0){let a=function(h){return Promise.all(h.map(p=>Promise.resolve(p).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),u=(l==null?void 0:l.nonce)||(l==null?void 0:l.getAttribute("nonce"));i=a(t.map(h=>{if(h=Iw(h),h in rh)return;rh[h]=!0;const p=h.endsWith(".css"),m=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${h}"]${m}`))return;const g=document.createElement("link");if(g.rel=p?"stylesheet":Tw,p||(g.as="script"),g.crossOrigin="",g.href=h,u&&g.setAttribute("nonce",u),document.head.appendChild(g),p)return new Promise((I,A)=>{g.addEventListener("load",I),g.addEventListener("error",()=>A(new Error(`Unable to preload CSS for ${h}`)))})}))}function s(a){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=a,window.dispatchEvent(l),!l.defaultPrevented)throw a}return i.then(a=>{for(const l of a||[])l.status==="rejected"&&s(l.reason);return e().catch(s)})},Sn=class Sn extends se{constructor(){super(),this.value="family"}_select(e){e!==this.value&&(this.value=e,this.dispatchEvent(new CustomEvent("circle-change",{detail:{value:e},bubbles:!0,composed:!0})))}render(){return R`
  ...
  `);customElements.define("event-row",la);const Aw={uid:"preview-user",displayName:"Thomas Paris",email:"thomas@example.com",photoURL:null},ih=[{uid:"thomas",displayName:"Thomas",circles:["immediate"],hue:198},{uid:"partner",displayName:"Élise",circles:["immediate"],hue:8},{uid:"kid1",displayName:"Oscar",circles:["immediate"],hue:142},{uid:"kid2",displayName:"Mila",circles:["immediate"],hue:44},{uid:"mum",displayName:"Mum",circles:["extended"],hue:320},{uid:"dad",displayName:"Dad",circles:["extended"],hue:28},{uid:"sister",displayName:"Camille",circles:["extended"],hue:280},{uid:"bro-in-law",displayName:"Sam",circles:["extended"],hue:175},{uid:"niece",displayName:"Léa",circles:["extended"],hue:100}],Sw=[{id:"t1",title:"Côte d’Azur, summer",location:"Antibes, France",start:"2026-07-12",end:"2026-07-21",coverGradient:"linear-gradient(135deg, #6b9ac4 0%, #c98a8a 60%, #d4a843 100%)",lodgingHost:"Airbnb",lodgingTitle:"Villa near Cap d’Antibes",attendees:["thomas","partner","kid1","kid2","mum","dad"],notes:"Mum + Dad arrive day 2. Dinner reservations at La Guérite booked.",visibility:"extended"},{id:"t2",title:"Half-term in the Alps",location:"Chamonix, France",start:"2026-10-24",end:"2026-10-31",coverGradient:"linear-gradient(135deg, #7a9e7e 0%, #4a6754 70%, #2c4439 100%)",lodgingHost:"Booking.com",lodgingTitle:"Chalet Les Drus",attendees:["thomas","partner","kid1","kid2"],notes:"Need ski school for the kids — book by September.",visibility:"immediate"},{id:"t3",title:"Camille’s 40th",location:"Lisbon, Portugal",start:"2026-09-05",end:"2026-09-08",coverGradient:"linear-gradient(135deg, #c67b5c 0%, #d4a843 50%, #c98a8a 100%)",lodgingHost:"Airbnb",lodgingTitle:"Alfama rooftop apartment",attendees:["thomas","partner","sister","bro-in-law"],notes:"Surprise. Don’t mention to Camille.",visibility:"family"}],Cw=[{id:"e1",type:"birthday",date:"2026-05-24",personIds:["mum"],title:"Mum’s birthday"},{id:"e2",type:"anniversary",date:"2026-05-28",personIds:["mum","dad"],title:"Mum & Dad’s anniversary",subtitle:"38 years"},{id:"e3",type:"birthday",date:"2026-06-11",personIds:["kid1"],title:"Oscar turns 7"},{id:"e4",type:"birthday",date:"2026-06-30",personIds:["niece"],title:"Léa’s birthday"}];class ca extends se{constructor(){super(),this.user=Aw,this.pebbleUser=null,this.family=null,this.children=[],this.trips=[],this.events=[],this.preview=!1,this.circle="family",this._formOpen=!1,this._formTrip=null,this._formBusy=!1,this._membersOpen=!1,this._eventFormOpen=!1,this._eventFormEvent=null,this._eventFormBusy=!1,this._allTripsOpen=!1,this._editingFamilyName=!1,this._importOpen=!1,this._profileOpen=!1;const e=new Date;this._displayMonth=new Date(e.getFullYear(),e.getMonth(),1)}async _saveFamilyName(e){var s,a;const n=(e.target.value??"").trim(),i=((s=this.family)==null?void 0:s.name)??"";if(n&&n!==i&&((a=this.family)!=null&&a.id))try{const{db:l,doc:u,updateDoc:h,serverTimestamp:p}=await xw(async()=>{const{db:m,doc:g,updateDoc:I,serverTimestamp:A}=await Promise.resolve().then(()=>dw);return{db:m,doc:g,updateDoc:I,serverTimestamp:A}},void 0);await h(u(l,"families",this.family.id),{name:n,updatedAt:p()}),Q("Family name updated.")}catch(l){console.error("Update family name failed:",l),Q(`Couldn't save: ${l.code??l.message}`,{duration:5e3})}this._editingFamilyName=!1}_liveImmediate(){var e;return this.preview||!((e=this.user)!=null&&e.uid)?ih.filter(t=>t.circles.includes("immediate")):mw(this.user.uid,this.user,this.pebbleUser,this.family,this.children)}_liveExtended(){return this.preview?ih.filter(e=>e.circles.includes("extended")):[]}_liveTrips(){return this.preview?Sw:this.trips??[]}_liveEvents(){if(this.preview)return Cw;const e=gw(this.children),t=(this.events??[]).map(n=>{const{date:i,yearsElapsed:s}=yw(n);return{...n,date:i?i.toISOString().slice(0,10):n.date,_yearsElapsed:s,_originalDate:n.date}});return[...e,...t].sort((n,i)=>String(n.date).localeCompare(String(i.date)))}_filteredMembers(){const e=this._liveImmediate(),t=this._liveExtended();return this.circle==="personal"?e.filter(n=>{var i;return n.uid===((i=this.user)==null?void 0:i.uid)}):this.circle==="family"?e:[...e,...t]}_circleTrips(){var n;const e=this._liveTrips(),t=((n=this.user)==null?void 0:n.uid)??"thomas";return this.circle==="personal"?e.filter(i=>{var s;return(s=i.attendees)==null?void 0:s.includes(t)}):this.circle==="family"?e.filter(i=>i.visibility!=="extended"):e}_filteredTrips(){const e=new Date;return e.setHours(0,0,0,0),this._circleTrips().filter(t=>t.end?new Date(t.end)>=e:!0)}_userCanSeeTrip(e){var n,i,s;const t=(n=this.user)==null?void 0:n.uid;return t?!!((i=e.attendees)!=null&&i.includes(t)||(s=e.viewers)!=null&&s.includes(t)||e.visibility==="family"||e.visibility==="extended"):!1}_filteredEvents(){const e=new Set(this._filteredMembers().map(t=>t.uid));return this._liveEvents().filter(t=>t.personIds.some(n=>e.has(n)))}_smartCallout(){var l,u;const e=new Date,t=new Date(e.getFullYear(),e.getMonth(),e.getDate()),n=1440*60*1e3,i=h=>Math.round((h-t)/n);for(const h of this._circleTrips()){if(!h.start||!h.end)continue;const p=new Date(h.start),m=new Date(h.end);if(p.setHours(0,0,0,0),m.setHours(0,0,0,0),p<=t&&t<=m){const g=i(p)+1,I=i(m)-i(p)+1,A=((l=h.location)==null?void 0:l.trim())||h.title;return`Day ${g} of ${I} in ${A}.`}}let s=null,a=1/0;for(const h of this._circleTrips()){if(!h.start)continue;const p=new Date(h.start);p.setHours(0,0,0,0);const m=i(p);m>0&&m<a&&(s={kind:"trip",item:h},a=m)}for(const h of this._filteredEvents()){if(!h.date)continue;const p=new Date(h.date);p.setHours(0,0,0,0);const m=i(p);m>=0&&m<a&&(s={kind:"event",item:h},a=m)}if(!s)return null;if(s.kind==="trip"){const h=((u=s.item.location)==null?void 0:u.trim())||s.item.title;return a===1?`${h} starts tomorrow.`:a<=14?`${h} in ${a} days.`:a<=60?`Next trip: ${h} in ${a} days.`:null}return a===0?`${s.item.title} — today.`:a===1?`${s.item.title} — tomorrow.`:a<=7?`${s.item.title} in ${a} days.`:null}_tripDensityByDay(e){const t=new Map;for(const n of this._filteredTrips()){if(!n.start||!n.end)continue;const i=new Date(n.start),s=new Date(n.end);if(Number.isNaN(i.getTime())||Number.isNaN(s.getTime())||i.getFullYear()>e||s.getFullYear()<e)continue;const a=new Date(Math.max(i,new Date(e,0,1))),l=new Date(Math.min(s,new Date(e,11,31)));for(;a<=l;){const u=`${String(a.getMonth()+1).padStart(2,"0")}-${String(a.getDate()).padStart(2,"0")}`;t.set(u,Math.min(1,(t.get(u)??0)+.5)),a.setDate(a.getDate()+1)}}return t}_shiftMonth(e){const t=this._displayMonth;this._displayMonth=new Date(t.getFullYear(),t.getMonth()+e,1)}_jumpToMonth(e,t){this._displayMonth=new Date(e,t,1)}_resetToToday(){const e=new Date;this._displayMonth=new Date(e.getFullYear(),e.getMonth(),1)}_renderMonthly(){const e=new Date,t=this._displayMonth??e,n=t.getFullYear(),i=t.getMonth(),a=(new Date(n,i,1).getDay()+6)%7,l=new Date(n,i+1,0).getDate(),u=this._filteredEvents().map(A=>new Date(A.date)).filter(A=>A.getFullYear()===n&&A.getMonth()===i).map(A=>A.getDate()),h=new Set;for(const A of this._filteredTrips()){if(!A.start||!A.end)continue;const D=new Date(A.start),P=new Date(A.end);if(Number.isNaN(D.getTime())||Number.isNaN(P.getTime())||D.getFullYear()>n||P.getFullYear()<n||D.getMonth()>i&&P.getMonth()>i||D.getMonth()<i&&P.getMonth()<i)continue;const z=D.getMonth()===i?D.getDate():1,F=P.getMonth()===i?P.getDate():l;for(let V=z;V<=F;V++)h.add(V)}const p=[];for(let A=0;A<a;A++)p.push(R`<div class="cal-cell empty"></div>`);const m=e.getFullYear()===n&&e.getMonth()===i;for(let A=1;A<=l;A++){const D=m&&A===e.getDate(),P=u.includes(A),z=h.has(A),F=["cal-cell",D?"today":"",P?"has-event":"",z?"has-trip":""].filter(Boolean).join(" ");p.push(R`<div class=${F}>${A}</div>`)}const g=new Date(n,i,1).toLocaleString("en-GB",{month:"long",year:"numeric"});return R`
    ...
    `}_openCreate(){if(this.preview){Q("Sign in to create real trips.");return}if(!le.familyId){Q("You need a PebblePath family first.");return}this._formTrip=null,this._formOpen=!0}_openEdit(e){if(this.preview){Q("Sign in to edit real trips.");return}this._formTrip=e,this._formOpen=!0}async _onSaveTrip(e){const t=e.detail;this._formBusy=!0;try{await le.saveTrip(t),this._formOpen=!1,this._formTrip=null,Q(t.id?"Trip updated.":"Trip created.")}catch(n){console.error("Save trip failed:",n),Q(`Couldn't save: ${n.code??n.message}`,{duration:5e3})}finally{this._formBusy=!1}}async _onDeleteTrip(e){this._formBusy=!0;try{await le.deleteTrip(e.detail.id),this._formOpen=!1,this._formTrip=null,Q("Trip deleted.")}catch(t){console.error("Delete trip failed:",t),Q(`Couldn't delete: ${t.code??t.message}`,{duration:5e3})}finally{this._formBusy=!1}}_openCreateEvent(){if(this.preview){Q("Sign in to add real events.");return}if(!le.familyId){Q("You need a family first.");return}this._eventFormEvent=null,this._eventFormOpen=!0}_openEditEvent(e){if(this.preview){Q("Sign in to edit real events.");return}if(e!=null&&e._childId){const t=prompt(`Edit ${e._childName}'s birthday (YYYY-MM-DD):`,e.date);if(!t)return;if(!/^\d{4}-\d{2}-\d{2}$/.test(t)){Q("Use YYYY-MM-DD format.");return}le.updateChildBirthday(e._childId,new Date(t)).then(()=>Q(`Updated ${e._childName}'s birthday.`)).catch(n=>{console.error("Update child birthday failed:",n),Q(`Couldn't update: ${n.code??n.message}`,{duration:5e3})});return}this._eventFormEvent={...e,date:e._originalDate??e.date},this._eventFormOpen=!0}async _onSaveEvent(e){this._eventFormBusy=!0;try{await le.saveEvent(e.detail),this._eventFormOpen=!1,this._eventFormEvent=null,Q(e.detail.id?"Event updated.":"Event added.")}catch(t){console.error("Save event failed:",t),Q(`Couldn't save: ${t.code??t.message}`,{duration:5e3})}finally{this._eventFormBusy=!1}}async _onDeleteEvent(e){this._eventFormBusy=!0;try{await le.deleteEvent(e.detail.id),this._eventFormOpen=!1,this._eventFormEvent=null,Q("Event deleted.")}catch(t){console.error("Delete event failed:",t),Q(`Couldn't delete: ${t.code??t.message}`,{duration:5e3})}finally{this._eventFormBusy=!1}}render(){var h,p,m,g,I,A,D,P,z,F;const e=this._filteredTrips(),t=this._filteredEvents(),n=this._liveImmediate(),i=this._liveExtended(),s=n.concat(i),a=(((h=this.user)==null?void 0:h.displayName)??"there").split(" ")[0],l=new Date,u=t.filter(V=>{const J=new Date(V.date);return J.getFullYear()===l.getFullYear()&&J.getMonth()===l.getMonth()});return R`
      <div class="topbar">
        <div class="brand">
        ...
        <div class="who">
          ...
          <button
            ...
            title="${((p=this.user)==null?void 0:p.displayName)??"Profile"} — open settings"
      ...
      <main>
        <div class="hello">
          <div>
            <h1>Hi ${a}.</h1>
            ${(()=>{const V=this._smartCallout();return V?R`<div class="smart">${V}</div>`:""})()}
            <div class="stat">
              ...
              `:R`
                <div class="trips-row">
                  ${e.map(V=>R`<trip-card
                      .trip=${V}
                      .members=${s}
                      @edit-trip=${J=>this._openEdit(J.detail)}
                    ></trip-card>`)}
                </div>
              `}
        </section>
        ...
        <section>
          <div class="cal-row">
            ...
            <glass-panel padding="md" variant="strong" stretch>
              ...
              <yearly-view
                .year=${((A=this._displayMonth)==null?void 0:A.getFullYear())??l.getFullYear()}
        ...
        <section>
          ...
          <glass-panel padding="md" variant="strong">
            ${t.length===0?R`<div style="color:var(--text-tertiary);padding:18px 4px;font-size:13.5px;">
                ...
                </div>`:t.map(V=>R`<event-row
                    .event=${V}
                    .members=${s}
                    @edit-event=${J=>this._openEditEvent(J.detail)}
                  ></event-row>`)}
          </glass-panel>
        </section>
  ...
  `);customElements.define("home-screen",ca);const uo="cairn:pendingJoinCode";class Kp extends se{constructor(){super(),this.authUser=null,this.loading=!0;const e=new URLSearchParams(window.location.search);this.preview=e.has("preview");const t=e.get("join");if(t)try{localStorage.setItem(uo,t)}catch{}let n=null;try{n=localStorage.getItem(uo)}catch{}this.joinCode=t??n??null,this.pebbleUser=null,this.family=null,this.children=[],this.trips=[],this.events=[],this._unsubAuth=null,this._onDataChange=()=>{this.pebbleUser=le.state.user,this.family=le.state.family,this.children=le.state.children,this.trips=le.state.trips,this.events=le.state.events}}_clearJoinState(){this.joinCode=null;try{localStorage.removeItem(uo)}catch{}const e=new URL(window.location.href);e.searchParams.delete("join"),window.history.replaceState({},"",e.toString())}connectedCallback(){if(super.connectedCallback(),this.preview){this.loading=!1;return}le.addEventListener("change",this._onDataChange),this._unsubAuth=Hp(e=>{this.authUser=e,this.loading=!1,e?le.start(e.uid):le.stop()})}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._unsubAuth)==null||e.call(this),le.removeEventListener("change",this._onDataChange)}_composeViewer(){var t,n;const e=this.authUser;return{uid:e.uid,displayName:e.displayName??((t=this.pebbleUser)==null?void 0:t.displayName)??"You",email:e.email??((n=this.pebbleUser)==null?void 0:n.email)??"",photoURL:Gp(e,this.pebbleUser)}}render(){return this.loading?R``:this.preview?R`<home-screen preview></home-screen>`:this.authUser?this.joinCode?R`
        <join-family-screen
          .code=${this.joinCode}
...
//# sourceMappingURL=index-DOVtqH1P.js.map
