var st=Object.defineProperty;var ot=(d,e,t)=>e in d?st(d,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):d[e]=t;var b=(d,e,t)=>ot(d,typeof e!="symbol"?e+"":e,t);import{i as C,a as z,b as s}from"./lit-2GpawzfI.js";import{f as nt,h as lt,j as dt,G as Me,s as Ye,k as ct,l as E,m as O,n as S,o as pt,q as J,t as G,v as re,w as le,x as Re,y as He,z as Je,A as de}from"./firebase-core-DVt9Aunh.js";import{g as ht,h as ae}from"./firebase-functions-CfBtnn7v.js";import{g as ut,r as Xe,u as qe,a as We}from"./firebase-storage-C5Nl_r0j.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const a of r)if(a.type==="childList")for(const n of a.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(r){const a={};return r.integrity&&(a.integrity=r.integrity),r.referrerPolicy&&(a.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?a.credentials="include":r.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(r){if(r.ep)return;r.ep=!0;const a=t(r);fetch(r.href,a)}})();class ce extends C{constructor(){super(),this.variant="default",this.lifted=!1,this.padding="md"}render(){const e=["panel",this.variant==="strong"?"strong":"",this.lifted?"lifted":"",`pad-${this.padding}`].filter(Boolean).join(" ");return s`
      <div class=${e}>
        <div class="content"><slot></slot></div>
      </div>
    `}}b(ce,"properties",{variant:{type:String},lifted:{type:Boolean},padding:{type:String}}),b(ce,"styles",z`
    :host {
      display: block;
    }
    :host([stretch]) {
  ...
  `);customElements.define("glass-panel",ce);class pe extends C{constructor(){super(),this.variant="primary",this.size="md",this.full=!1,this.disabled=!1}render(){const e=[this.variant,`size-${this.size}`,this.full?"full":""].filter(Boolean).join(" ");return s`
      <button class=${e} ?disabled=${this.disabled}>
        <slot></slot>
      </button>
    `}}b(pe,"properties",{variant:{type:String},size:{type:String},full:{type:Boolean},disabled:{type:Boolean,reflect:!0}}),b(pe,"styles",z`
    * {
      box-sizing: border-box;
    }
    :host {
  ...
  `);customElements.define("glass-button",pe);class he extends C{constructor(){super(),this.size=44}render(){const e=this.size;return s`
      <svg
        viewBox="0 0 64 64"
        width=${e}
        height=${e}
    ...
    `}}b(he,"properties",{size:{type:Number}}),b(he,"styles",z`
    :host {
      display: inline-block;
      line-height: 0;
    }
  ...
  `);customElements.define("cairn-mark",he);const gt="modulepreload",mt=function(d){return"/cairn/"+d},je={},Ve=function(e,t,i){let r=Promise.resolve();if(t&&t.length>0){let n=function(c){return Promise.all(c.map(h=>Promise.resolve(h).then(p=>({status:"fulfilled",value:p}),p=>({status:"rejected",reason:p}))))};document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),l=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));r=n(t.map(c=>{if(c=mt(c),c in je)return;je[c]=!0;const h=c.endsWith(".css"),p=h?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${p}`))return;const u=document.createElement("link");if(u.rel=h?"stylesheet":gt,h||(u.as="script"),u.crossOrigin="",u.href=c,l&&u.setAttribute("nonce",l),document.head.appendChild(u),h)return new Promise((f,y)=>{u.addEventListener("load",f),u.addEventListener("error",()=>y(new Error(`Unable to preload CSS for ${c}`)))})}))}function a(n){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=n,window.dispatchEvent(o),!o.defaultPrevented)throw n}return r.then(n=>{for(const o of n||[])o.status==="rejected"&&a(o.reason);return e().catch(a)})},ue={apiKey:"AIzaSyA6NKZNLVBeeLrXcLJSXus5M832AxpI2wk",authDomain:"pebblepath-992b6.firebaseapp.com",projectId:"pebblepath-992b6",storageBucket:"pebblepath-992b6.firebasestorage.app",messagingSenderId:"497141667291",appId:"1:497141667291:web:ee84c186db54389d10c3fe"},L=!!(ue.apiKey&&ue.projectId),q=L?nt(ue):null,$=L?lt(q):null,w=L?dt(q):null,H=L?ht(q,"us-central1"):null,ge=L?ut(q):null,me=L?new Me:null;me&&me.setCustomParameters({prompt:"select_account"});const oe=L?new Me:null;oe&&oe.addScope("https://www.googleapis.com/auth/calendar.readonly");let se=null,be=0;async function Ke(){if(!$||!oe)throw new Error("Firebase not configured.");if(se&&Date.now()<be-6e4)return se;const d=await Ye($,oe),e=Me.credentialFromResult(d),t=e==null?void 0:e.accessToken;if(!t)throw new Error("Couldn't get a Calendar access token — try again.");return se=t,be=Date.now()+3600*1e3,t}function bt(){se=null,be=0}function Ze(){if(!$)throw new Error("Firebase not configured — fill in .env first.");return Ye($,me)}function Qe(){return $?ct($):Promise.resolve()}function et(d){return $?pt($,d):(d(null),()=>{})}const ft=Object.freeze(Object.defineProperty({__proto__:null,addDoc:re,app:q,auth:$,clearCalendarToken:bt,collection:G,connectGoogleCalendar:Ke,db:w,deleteDoc:le,doc:E,firebaseApp:q,functions:H,getDocs:Je,getDownloadURL:We,httpsCallable:ae,isConfigured:L,onAuth:et,onSnapshot:J,query:Re,serverTimestamp:S,setDoc:de,signIn:Ze,signOutUser:Qe,storage:ge,storageRef:Xe,updateDoc:O,uploadBytes:qe,where:He},Symbol.toStringTag,{value:"Module"}));class vt extends EventTarget{constructor(){super(),this.state={user:null,family:null,children:[],trips:[],events:[]},this._uid=null,this._unsubUser=null,this._unsubFamily=null,this._unsubChildren=null,this._unsubTrips=null,this._unsubEvents=null,this._currentFamilyId=null,this.userDocResolved=!1}get familyId(){return this._currentFamilyId}start(e){!w||!e||this._uid!==e&&(this.stop(),this._uid=e,this._unsubUser=J(E(w,"users",e),t=>{var r,a,n,o,l,c;this.userDocResolved=!0,this.state.user=t.exists()?{id:t.id,...t.data()}:null;const i=((r=this.state.user)==null?void 0:r.familyId)??((a=this.state.user)==null?void 0:a.cairnFamilyId)??null;i!==this._currentFamilyId&&(this._currentFamilyId=i,(n=this._unsubFamily)==null||n.call(this),(o=this._unsubChildren)==null||o.call(this),(l=this._unsubTrips)==null||l.call(this),(c=this._unsubEvents)==null||c.call(this),this._unsubFamily=null,this._unsubChildren=null,this._unsubTrips=null,this._unsubEvents=null,this.state.family=null,this.state.children=[],this.state.trips=[],this.state.events=[],i&&this._subscribeFamily(i)),this._emit()}))}_subscribeFamily(e){this._unsubFamily=J(E(w,"families",e),t=>{this.state.family=t.exists()?{id:t.id,...t.data()}:null,this._emit()}),this._unsubChildren=J(G(w,"families",e,"children"),t=>{this.state.children=t.docs.map(i=>{var a,n;const r=i.data();return{id:i.id,...r,dateOfBirth:((n=(a=r.dateOfBirth)==null?void 0:a.toDate)==null?void 0:n.call(a))??(r.dateOfBirth?new Date(r.dateOfBirth):null)}}),this._emit()}),this._unsubTrips=J(G(w,"families",e,"trips"),t=>{this.state.trips=t.docs.map(i=>{var a,n,o,l;const r=i.data();return{id:i.id,...r,start:r.start??"",end:r.end??"",createdAt:((n=(a=r.createdAt)==null?void 0:a.toDate)==null?void 0:n.call(a))??null,updatedAt:((l=(o=r.updatedAt)==null?void 0:o.toDate)==null?void 0:l.call(o))??null}}).sort((i,r)=>String(i.start).localeCompare(String(r.start))),this._emit()},t=>{console.warn("[Cairn] trips subscription error:",t.code,t.message)}),this._unsubEvents=J(G(w,"families",e,"familyEvents"),t=>{this.state.events=t.docs.map(i=>{var a,n,o,l;const r=i.data();return{id:i.id,...r,date:r.date??"",createdAt:((n=(a=r.createdAt)==null?void 0:a.toDate)==null?void 0:n.call(a))??null,updatedAt:((l=(o=r.updatedAt)==null?void 0:o.toDate)==null?void 0:l.call(o))??null}}),this._emit()},t=>{console.warn("[Cairn] familyEvents subscription error:",t.code,t.message)})}async saveTrip(e){var c;if(!w||!this._currentFamilyId)throw new Error("No family yet.");const t=(c=$==null?void 0:$.currentUser)==null?void 0:c.uid;if(!t)throw new Error("Not signed in.");const{id:i,createdAt:r,updatedAt:a,...n}=e,o={...n,updatedAt:S()};return i?(await O(E(w,"families",this._currentFamilyId,"trips",i),o),i):(o.createdBy=t,o.createdAt=S(),(await re(G(w,"families",this._currentFamilyId,"trips"),o)).id)}async deleteTrip(e){if(!w||!this._currentFamilyId)throw new Error("No family yet.");await le(E(w,"families",this._currentFamilyId,"trips",e))}async saveEvent(e){var c;if(!w||!this._currentFamilyId)throw new Error("No family yet.");const t=(c=$==null?void 0:$.currentUser)==null?void 0:c.uid;if(!t)throw new Error("Not signed in.");const{id:i,createdAt:r,updatedAt:a,...n}=e,o={...n,updatedAt:S()};return i?(await O(E(w,"families",this._currentFamilyId,"familyEvents",i),o),i):(o.createdBy=t,o.createdAt=S(),(await re(G(w,"families",this._currentFamilyId,"familyEvents"),o)).id)}async deleteEvent(e){if(!w||!this._currentFamilyId)throw new Error("No family yet.");await le(E(w,"families",this._currentFamilyId,"familyEvents",e))}async previewUrl(e){if(!e||typeof e!="string"||!/^https?:\/\//i.test(e.trim()))return null;if(!H)throw new Error("Firebase functions not configured.");return(await ae(H,"previewUrl")({url:e.trim()})).data}async lookupFlight(e,t){if(!e||typeof e!="string")return null;if(!H)throw new Error("Firebase functions not configured.");return(await ae(H,"lookupFlight")({flightNumber:e.trim(),date:typeof t=="string"?t.trim():""})).data}async askPebble(e,t=[]){if(!H)throw new Error("Firebase functions not configured.");if(!this._currentFamilyId)throw new Error("No family yet.");return(await ae(H,"askPebbleAboutActivities")({question:e,familyId:this._currentFamilyId,history:t})).data}async updateChildBirthday(e,t){if(!w||!this._currentFamilyId)throw new Error("No family yet.");await O(E(w,"families",this._currentFamilyId,"children",e),{dateOfBirth:t,updatedAt:S()})}async findFamilyByCairnCode(e){if(!w)throw new Error("Firebase not configured.");const t=Re(G(w,"families"),He("cairnInviteCode","==",e)),i=await Je(t);if(i.empty)return null;const r=i.docs[0];return{id:r.id,...r.data()}}async joinFamilyAsCairn(e){var h,p,u;if(!w)throw new Error("Firebase not configured.");const t=(h=$==null?void 0:$.currentUser)==null?void 0:h.uid;if(!t)throw new Error("Not signed in.");const i=await this.findFamilyByCairnCode(e);if(!i){const f=new Error("Invite code not found.");throw f.code="not-found",f}const r=((u=(p=i.cairnInviteCodeExpiresAt)==null?void 0:p.toDate)==null?void 0:u.call(p))??(i.cairnInviteCodeExpiresAt?new Date(i.cairnInviteCodeExpiresAt):null);if(!r||r<new Date){const f=new Error("This invite code has expired.");throw f.code="expired",f}const a=i.cairnMemberIds??[];if(a.includes(t)||(i.memberIds??[]).includes(t)){const f=new Error("You're already in this family on Cairn.");throw f.code="already-member",f}const n=i.cairnMaxMembers??20;if(a.length>=n){const f=new Error("This family's Cairn ring is full.");throw f.code="full",f}const o=$.currentUser,l=new Date,c={displayName:o.displayName??"",profilePhotoURL:o.photoURL??null,role:"member",joinedAt:l,updatedAt:l};return await O(E(w,"families",i.id),{cairnMemberIds:[...a,t],[`memberProfiles.${t}`]:c,updatedAt:S()}),await de(E(w,"users",t),{email:o.email??"",displayName:o.displayName??"",profilePhotoURL:o.photoURL??null,cairnFamilyId:i.id,role:"member",notificationPreferences:{milestoneReminders:!0,tipNotifications:!0,schoolDeadlines:!0},createdAt:S(),updatedAt:S()},{merge:!0}),i.id}async saveSubGroup({id:e,name:t,memberIds:i}){if(!w||!this._currentFamilyId)throw new Error("No family yet.");const r=e??`g_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,6)}`;return await O(E(w,"families",this._currentFamilyId),{[`subGroups.${r}`]:{name:t.trim(),memberIds:Array.isArray(i)?[...i]:[],updatedAt:S()},updatedAt:S()}),r}async deleteSubGroup(e){if(!w||!this._currentFamilyId)throw new Error("No family yet.");const{deleteField:t}=await Ve(async()=>{const{deleteField:i}=await import("./firebase-core-DVt9Aunh.js").then(r=>r.B);return{deleteField:i}},[]);await O(E(w,"families",this._currentFamilyId),{[`subGroups.${e}`]:t(),updatedAt:S()})}async setCairnMemberSubGroup(e,t){var a;if(!w||!this._currentFamilyId)throw new Error("No family yet.");if(!e)throw new Error("uid is required.");const i=((a=this.state.family)==null?void 0:a.subGroups)??{},r={};for(const[n,o]of Object.entries(i)){const l=Array.isArray(o.memberIds)?o.memberIds:[];n===t?l.includes(e)||(r[`subGroups.${n}.memberIds`]=[...l,e]):l.includes(e)&&(r[`subGroups.${n}.memberIds`]=l.filter(c=>c!==e))}Object.keys(r).length!==0&&(r.updatedAt=S(),await O(E(w,"families",this._currentFamilyId),r))}async createCairnOnlyFamily(e){if(!w)throw new Error("Firebase not configured.");const t=$==null?void 0:$.currentUser,i=t==null?void 0:t.uid;if(!i)throw new Error("Not signed in.");const r=(e??"").trim();if(!r)throw new Error("Family name is required.");const a=new Date,n=Le(),o=new Date(Date.now()+720*60*60*1e3),l={displayName:t.displayName??"",profilePhotoURL:t.photoURL??null,role:"admin",joinedAt:a,updatedAt:a},c={name:r,createdBy:i,createdInApp:"cairn",memberIds:[],cairnMemberIds:[i],cairnMaxMembers:20,cairnInviteCode:n,cairnInviteCodeExpiresAt:o,memberProfiles:{[i]:l},createdAt:S(),updatedAt:S()},h=await re(G(w,"families"),c);return await de(E(w,"users",i),{email:t.email??"",displayName:t.displayName??"",profilePhotoURL:t.photoURL??null,cairnFamilyId:h.id,role:"admin",notificationPreferences:{milestoneReminders:!1,tipNotifications:!1,schoolDeadlines:!1},createdAt:S(),updatedAt:S()},{merge:!0}),h.id}async regenerateCairnInviteCode(){if(!w||!this._currentFamilyId)throw new Error("No family yet.");const e=Le(),t=new Date(Date.now()+720*60*60*1e3);return await O(E(w,"families",this._currentFamilyId),{cairnInviteCode:e,cairnInviteCodeExpiresAt:t,updatedAt:S()}),{code:e,expiresAt:t}}stop(){var e,t,i,r,a;(e=this._unsubUser)==null||e.call(this),(t=this._unsubFamily)==null||t.call(this),(i=this._unsubChildren)==null||i.call(this),(r=this._unsubTrips)==null||r.call(this),(a=this._unsubEvents)==null||a.call(this),this._unsubUser=this._unsubFamily=this._unsubChildren=this._unsubTrips=this._unsubEvents=null,this._uid=null,this._currentFamilyId=null,this.userDocResolved=!1,this.state={user:null,family:null,children:[],trips:[],events:[]}}_emit(){this.dispatchEvent(new Event("change"))}}const k=new vt;function tt(d,e){const t=e==null?void 0:e.profilePhotoURL;return typeof t=="string"&&/^https?:\/\//i.test(t)?t:d!=null&&d.photoURL?d.photoURL:null}function xt(d,e){if(!e)return[];const t=e.cairnMemberIds??e.memberIds??[],i=e.memberIds??[],r=e.memberProfiles??{},a=[];let n=280;for(const o of t){if(i.includes(o)||o===d)continue;const l=r[o],c=l==null?void 0:l.profilePhotoURL;a.push({uid:o,displayName:(l==null?void 0:l.displayName)??"Family",photoURL:typeof c=="string"&&/^https?:\/\//i.test(c)?c:null,role:"extended",circles:["extended"],hue:n}),n=(n+47)%360}return a}function Le(){const d="ABCDEFGHJKLMNPQRSTUVWXYZ23456789";let e="CAIRN-";for(let t=0;t<4;t++)e+=d[Math.floor(Math.random()*d.length)];return e}function yt(d,e,t,i,r){const a=[],n=new Set((i==null?void 0:i.memberIds)??[]),o=n.has(d);a.push({uid:d,displayName:(e==null?void 0:e.displayName)??(t==null?void 0:t.displayName)??"You",photoURL:tt(e,t),role:o?"self":"self-extended",circles:["immediate"],hue:198});const l=(i==null?void 0:i.memberProfiles)??{};for(const[h,p]of Object.entries(l)){if(h===d||!n.has(h))continue;const u=p.profilePhotoURL;a.push({uid:h,displayName:p.displayName??"Co-parent",photoURL:typeof u=="string"&&/^https?:\/\//i.test(u)?u:null,role:"co-parent",circles:["immediate"],hue:8})}let c=142;for(const h of r??[]){const p=h.profilePhotoURL;a.push({uid:`child:${h.id}`,displayName:h.name,photoURL:typeof p=="string"&&/^https?:\/\//i.test(p)?p:null,role:"child",circles:["immediate"],hue:c,dateOfBirth:h.dateOfBirth}),c=(c+58)%360}return a}function wt(d){const e=[];for(const t of d??[]){if(!t.dateOfBirth)continue;const i=t.dateOfBirth,r=i.getUTCFullYear(),a=String(i.getUTCMonth()+1).padStart(2,"0"),n=String(i.getUTCDate()).padStart(2,"0");e.push({id:`bday:${t.id}`,type:"birthday",date:`${r}-${a}-${n}`,personIds:[`child:${t.id}`],title:`${t.name}'s birthday`,_childId:t.id,_childName:t.name,recurring:!0})}return e}function _t(d,e=new Date){if(!(d!=null&&d.date))return{date:null,yearsElapsed:0};const t=D(d.date);if(!t||Number.isNaN(t.getTime()))return{date:null,yearsElapsed:0};if(!d.recurring)return{date:t,yearsElapsed:0};const i=new Date(e.getFullYear(),t.getMonth(),t.getDate()),r=i<new Date(e.getFullYear(),e.getMonth(),e.getDate())?new Date(e.getFullYear()+1,t.getMonth(),t.getDate()):i,a=r.getFullYear()-t.getFullYear();return{date:r,yearsElapsed:a}}const Be=["linear-gradient(135deg, #6b9ac4 0%, #c98a8a 60%, #d4a843 100%)","linear-gradient(135deg, #7a9e7e 0%, #4a6754 70%, #2c4439 100%)","linear-gradient(135deg, #c67b5c 0%, #d4a843 50%, #c98a8a 100%)","linear-gradient(135deg, #3d9b8f 0%, #1f5c54 100%)","linear-gradient(135deg, #d4a843 0%, #c67b5c 55%, #c98a8a 100%)","linear-gradient(135deg, #8b7bb5 0%, #c98a8a 60%, #d4a843 100%)","linear-gradient(135deg, #6b9ac4 0%, #3d9b8f 100%)"];function D(d){if(!d)return null;if(d instanceof Date)return d;const e=String(d).match(/^(\d{4})-(\d{2})-(\d{2})/);return e?new Date(Number(e[1]),Number(e[2])-1,Number(e[3])):new Date(d)}function kt(d){if(!d)return null;const e=d.getFullYear(),t=String(d.getMonth()+1).padStart(2,"0"),i=String(d.getDate()).padStart(2,"0");return`${e}-${t}-${i}`}async function $t(d,e=90,t=100){const i=new Date,r=new Date(i.getTime()+e*24*60*60*1e3),a=new URL("https://www.googleapis.com/calendar/v3/calendars/primary/events");a.searchParams.set("timeMin",i.toISOString()),a.searchParams.set("timeMax",r.toISOString()),a.searchParams.set("maxResults",String(t)),a.searchParams.set("singleEvents","true"),a.searchParams.set("orderBy","startTime");const n=await fetch(a.toString(),{headers:{Authorization:`Bearer ${d}`}});if(!n.ok){const l=await n.text();throw new Error(`Google Calendar: ${n.status} ${l.slice(0,160)}`)}return((await n.json()).items??[]).filter(l=>{var c,h;return l.status!=="cancelled"&&(((c=l.start)==null?void 0:c.date)||((h=l.start)==null?void 0:h.dateTime))})}function Dt(d,e){var r,a,n,o,l,c,h,p;const t=((r=d.start)==null?void 0:r.date)??((n=(a=d.start)==null?void 0:a.dateTime)==null?void 0:n.slice(0,10))??"";let i=((o=d.end)==null?void 0:o.date)??((c=(l=d.end)==null?void 0:l.dateTime)==null?void 0:c.slice(0,10))??t;if((h=d.start)!=null&&h.date&&((p=d.end)!=null&&p.date)){const u=new Date(i);u.setDate(u.getDate()-1),i=u.toISOString().slice(0,10)}return{title:d.summary||"(untitled)",location:d.location??"",start:t,end:i,attendees:e?[e]:[],viewers:[],visibility:"family",notes:(d.description??"").slice(0,1e3),gcalEventId:d.id,gcalEventLink:d.htmlLink??null}}function Ct(d){if(d!=null&&d.coverGradient)return d.coverGradient;const e=((d==null?void 0:d.title)??(d==null?void 0:d.id)??"")+((d==null?void 0:d.location)??"");let t=0;for(let i=0;i<e.length;i++)t=t*31+e.charCodeAt(i)>>>0;return Be[t%Be.length]}class fe extends C{constructor(){super(),this.year=new Date().getFullYear(),this.tripDays=new Map,this.trips=[],this.events=[],this.today=new Date,this._activeDay=null}_isLeap(e){return e%4===0&&e%100!==0||e%400===0}_daysInMonth(e,t){return[31,this._isLeap(e)?29:28,31,30,31,30,31,31,30,31,30,31][t]}_labelsForMonth(e){var a;const t=this.year,i=new Map,r=(n,o)=>{const l=i.get(n);i.set(n,l?`${l} · ${o}`:o)};for(const n of this.trips??[]){if(!n.start||!n.end)continue;const o=D(n.start),l=D(n.end);if(!o||!l||o.getFullYear()>t||l.getFullYear()<t)continue;const c=new Date(t,e,1),h=new Date(t,e+1,0);if(l<c||o>h)continue;const p=o.getMonth()===e&&o.getFullYear()===t?o.getDate():1,u=l.getMonth()===e&&l.getFullYear()===t?l.getDate():h.getDate(),f=(a=n.location)!=null&&a.trim()?`${n.title} (${n.location.trim()})`:n.title;for(let y=p;y<=u;y++)r(y,f)}for(const n of this.events??[]){const o=D(n.date);o&&o.getFullYear()===t&&o.getMonth()===e&&r(o.getDate(),n.title??"Event")}return i}_renderMonth(e){var c,h;const t=this.year,r=(new Date(t,e,1).getDay()+6)%7,a=this._daysInMonth(t,e),n=this._labelsForMonth(e),o=[];for(let p=0;p<r;p++)o.push(s`<div class="cell empty"></div>`);const l=this.today;for(let p=1;p<=a;p++){const u=`${String(e+1).padStart(2,"0")}-${String(p).padStart(2,"0")}`,f=this.tripDays.get(u)??0,y=l.getFullYear()===t&&l.getMonth()===e&&l.getDate()===p,g=n.get(p),m=(this.events??[]).some(N=>{const A=D(N.date);return A&&A.getFullYear()===t&&A.getMonth()===e&&A.getDate()===p}),_=((c=this._activeDay)==null?void 0:c.month)===e&&((h=this._activeDay)==null?void 0:h.day)===p,F=["cell",y?"today":"",f>0?"trip":"",f>.6?"dense":"",m?"event":"",g?"labelled":"",_?"active":""].filter(Boolean).join(" ");o.push(s`<div
        class=${F}
        title=${g?`${p} ${this._monthName(e)} — ${g}`:""}
        @click=${N=>g&&this._onDayTap(N,e,p,g)}
      ...
      ${this._activeDay?s`
          ...
          `:""}
    `}}b(fe,"properties",{year:{type:Number},tripDays:{type:Object},trips:{type:Array},events:{type:Array},today:{type:Object},_activeDay:{state:!0}}),b(fe,"styles",z`
    :host {
      display: block;
    }
    .grid {
  ...
  `);customElements.define("yearly-view",fe);class ve extends C{constructor(){super(),this.name="",this.hue=200,this.photo="",this.size=36,this.showName=!1}_initials(){return this.name.split(/\s+/).map(e=>e[0]).filter(Boolean).slice(0,2).join("").toUpperCase()}render(){const e=`linear-gradient(135deg, hsl(${this.hue}, 55%, 62%) 0%, hsl(${(this.hue+40)%360}, 50%, 42%) 100%)`,t=`width:${this.size}px;height:${this.size}px;background:${e};font-size:${this.size*.38}px;`;return s`
    ...
    `}}b(ve,"properties",{name:{type:String},hue:{type:Number},photo:{type:String},size:{type:Number},showName:{type:Boolean,attribute:"show-name"}}),b(ve,"styles",z`
    :host {
      display: inline-flex;
      align-items: center;
      gap: 8px;
  ...
  `);customElements.define("member-chip",ve);class xe extends C{constructor(){super(),this.start="",this.end="",this._displayMonth=null,this._hoverDate=null}willUpdate(e){if(e.has("start")||this._displayMonth===null){const t=this.start?D(this.start):new Date;this._displayMonth=new Date(t.getFullYear(),t.getMonth(),1)}}_isoFor(e,t,i){return`${e}-${String(t+1).padStart(2,"0")}-${String(i).padStart(2,"0")}`}_emit(e,t){this.start=e,this.end=t,this._hoverDate=null,this.dispatchEvent(new CustomEvent("range-change",{detail:{start:e,end:t},bubbles:!0,composed:!0}))}_onDayClick(e){if(!this.start||this.start&&this.end){this._emit(e,"");return}e<this.start?this._emit(e,this.start):this._emit(this.start,e)}_onDayHover(e){this.start&&!this.end&&(this._hoverDate=e)}_onLeave(){this._hoverDate=null}_shiftMonth(e){const t=this._displayMonth;this._displayMonth=new Date(t.getFullYear(),t.getMonth()+e,1)}_isToday(e,t,i){const r=new Date;return r.getFullYear()===e&&r.getMonth()===t&&r.getDate()===i}_inSelectedRange(e){return!this.start||!this.end?!1:e>this.start&&e<this.end}_inHoverRange(e){if(!this.start||this.end||!this._hoverDate)return!1;const t=this._hoverDate<this.start?this._hoverDate:this.start,i=this._hoverDate<this.start?this.start:this._hoverDate;return e>t&&e<i}_summary(){if(!this.start&&!this.end)return"Pick a start date";const e=t=>{const i=D(t);return i?i.toLocaleString("en-GB",{day:"numeric",month:"short",year:"numeric"}):""};return this.start&&!this.end?`From ${e(this.start)} — pick an end date`:this.start===this.end?e(this.start):`${e(this.start)} – ${e(this.end)}`}_renderGrid(){const e=this._displayMonth.getFullYear(),t=this._displayMonth.getMonth(),r=(new Date(e,t,1).getDay()+6)%7,a=new Date(e,t+1,0).getDate(),n=[];for(let o=0;o<r;o++)n.push(s`<div class="empty"></div>`);for(let o=1;o<=a;o++){const l=this._isoFor(e,t,o),c=l===this.start,h=l===this.end&&l!==this.start,p=this._inSelectedRange(l),u=this._inHoverRange(l),f=this._isToday(e,t,o),y=["day",c?"start":"",h?"end":"",p?"in-range":"",u?"hover-range":"",f&&!c&&!h?"today":""].filter(Boolean).join(" ");n.push(s`
    ...
    `}}b(xe,"properties",{start:{type:String},end:{type:String},_displayMonth:{state:!0},_hoverDate:{state:!0}}),b(xe,"styles",z`
    * { box-sizing: border-box; }
    :host {
      display: block;
    }
  ...
  `);customElements.define("date-range-picker",xe);class ye extends C{constructor(){super(),this.open=!1,this.trip=null,this.members=[],this.currentUid="",this.familyId="",this.busy=!1,this.formMode="trip",this.subGroups={},this._draft=this._blankDraft(),this._error="",this._previewing=!1,this._previewError="",this._previewDebounce=null,this._lastPreviewedUrl="",this._showReturn=!1,this._showOutboundDetails=!1,this._showReturnDetails=!1,this._showFlight=!1,this._outboundLookupState="idle",this._outboundLookupMessage="",this._returnLookupState="idle",this._returnLookupMessage="",this._lastLookedUpOutbound="",this._lastLookedUpReturn=""}async _runFlightLookup(e){var p,u,f,y;const t=e==="return",i=t?"returnFlightNumber":"flightNumber",r=(this._draft[i]??"").trim();if(!r)return;const a=r.toUpperCase().replace(/[^A-Z0-9]/g,"");if(!/^[A-Z]{2,3}\d{1,4}[A-Z]?$/.test(a)){this[t?"_returnLookupState":"_outboundLookupState"]="idle";return}const n=t?"_lastLookedUpReturn":"_lastLookedUpOutbound",o=t?this._draft.end:this._draft.start,l=`${a}|${o??""}`;if(this[n]===l)return;const c=t?"_returnLookupState":"_outboundLookupState",h=t?"_returnLookupMessage":"_outboundLookupMessage";this[c]="loading",this[h]="";try{const g=await k.lookupFlight(a,o);if(!g)return;this[n]=l;const m=t?"returnFlightAirline":"flightAirline",_=t?"returnFlightDepartAirport":"flightDepartAirport",F=t?"returnFlightArriveAirport":"flightArriveAirport",N=t?"returnFlightDepartTime":"flightDepartTime",A=t?"returnFlightArriveTime":"flightArriveTime",M=W=>W?String(W).slice(0,16):"",P={};if(!this._draft[m]&&g.airline&&(P[m]=g.airline),!this._draft[_]&&((p=g.depart)!=null&&p.iata)&&(P[_]=g.depart.iata),!this._draft[F]&&((u=g.arrive)!=null&&u.iata)&&(P[F]=g.arrive.iata),!this._draft[N]&&((f=g.depart)!=null&&f.scheduledTime)&&(P[N]=M(g.depart.scheduledTime)),!this._draft[A]&&((y=g.arrive)!=null&&y.scheduledTime)&&(P[A]=M(g.arrive.scheduledTime)),Object.keys(P).length===0){this[c]="idle";return}this._draft={...this._draft,...P},(P[_]||P[F])&&(t?this._showReturnDetails=!0:this._showOutboundDetails=!0),this[c]="ok",this[h]=`Filled from ${g.airline??"flight record"}.`}catch(g){console.warn("Flight lookup failed:",g),this[c]="error",(g==null?void 0:g.code)==="functions/failed-precondition"?this[h]="Auto-fill not configured — enter details manually.":(g==null?void 0:g.code)==="functions/not-found"?this[h]="Couldn't find that flight — enter details manually.":(g==null?void 0:g.code)==="functions/invalid-argument"?this[h]="That doesn't look like a flight number.":(g==null?void 0:g.code)==="functions/unauthenticated"?this[h]="Sign in to use flight lookup.":this[h]="Flight lookup unavailable — enter details manually."}}willUpdate(e){(e.has("trip")||e.has("open"))&&(this.open&&(this._draft=this._draftFromTrip(this.trip),this._draft.id&&this._draft.lodgingUrl&&!this._draft.coverImage&&requestAnimationFrame(()=>this._autoRefreshPreview()),this._showReturn=!!(this._draft.returnFlightNumber||this._draft.returnFlightDepartTime||this._draft.returnFlightDepartAirport||this._draft.returnFlightArriveAirport),this._showOutboundDetails=!!(this._draft.flightDepartAirport||this._draft.flightArriveAirport),this._showReturnDetails=!!(this._draft.returnFlightDepartAirport||this._draft.returnFlightArriveAirport),this._showFlight=!!(this._draft.flightNumber||this._draft.flightAirline||this._draft.flightDepartTime||this._draft.flightDepartAirport||this._draft.flightArriveAirport||this._showReturn)),this._error="")}async _autoRefreshPreview(){const e=this._draft.lodgingUrl,t=this._draft.id;if(!(!e||!t||this._previewing)){this._previewing=!0,this._previewError="";try{const i=await k.previewUrl(e);if(!(i!=null&&i.image)){this._previewError="No preview image found for this URL.";return}const r={coverImage:i.image,lodgingHost:i.siteName??i.host??this._draft.lodgingHost??"",lodgingTitle:i.title??this._draft.lodgingTitle??""};this._draft={...this._draft,...r},this._lastPreviewedUrl=e;try{await k.saveTrip({id:t,...r})}catch(a){console.warn("Auto-save cover failed:",a)}}catch(i){console.warn("Auto preview failed:",i),this._previewError=(i==null?void 0:i.code)==="functions/unauthenticated"?"Preview needs you to be signed in.":"Preview unavailable — try the Refresh button."}finally{this._previewing=!1}}}_blankDraft(){const e=new Date().toISOString().slice(0,10);return{id:null,title:"",location:"",start:e,end:e,visibility:"family",attendees:this.currentUid?[this.currentUid]:[],viewers:[],targetSubGroups:[],lodgingUrl:"",lodgingHost:"",lodgingTitle:"",flightAirline:"",flightNumber:"",flightDepartAirport:"",flightDepartTime:"",flightArriveAirport:"",flightArriveTime:"",returnFlightAirline:"",returnFlightNumber:"",returnFlightDepartAirport:"",returnFlightDepartTime:"",returnFlightArriveAirport:"",returnFlightArriveTime:"",notes:""}}_draftFromTrip(e){return e?{id:e.id??null,title:e.title??"",location:e.location??"",start:e.start??new Date().toISOString().slice(0,10),end:e.end??e.start??new Date().toISOString().slice(0,10),visibility:e.visibility??"family",attendees:Array.isArray(e.attendees)?[...e.attendees]:[],viewers:Array.isArray(e.viewers)?[...e.viewers]:[],targetSubGroups:Array.isArray(e.targetSubGroups)?[...e.targetSubGroups]:[],lodgingUrl:e.lodgingUrl??"",lodgingHost:e.lodgingHost??"",lodgingTitle:e.lodgingTitle??"",flightAirline:e.flightAirline??"",flightNumber:e.flightNumber??"",flightDepartAirport:e.flightDepartAirport??"",flightDepartTime:e.flightDepartTime??"",flightArriveAirport:e.flightArriveAirport??"",flightArriveTime:e.flightArriveTime??"",returnFlightAirline:e.returnFlightAirline??"",returnFlightNumber:e.returnFlightNumber??"",returnFlightDepartAirport:e.returnFlightDepartAirport??"",returnFlightDepartTime:e.returnFlightDepartTime??"",returnFlightArriveAirport:e.returnFlightArriveAirport??"",returnFlightArriveTime:e.returnFlightArriveTime??"",coverImage:e.coverImage??"",notes:e.notes??""}:this._blankDraft()}_set(e,t){this._draft={...this._draft,[e]:t}}_onLodgingChange(e){this._set("lodgingUrl",e),this._previewError="",this._previewDebounce&&clearTimeout(this._previewDebounce);const t=e.trim();if(!t){this._set("coverImage",""),this._set("lodgingHost",""),this._set("lodgingTitle",""),this._lastPreviewedUrl="";return}/^https?:\/\//i.test(t)&&t!==this._lastPreviewedUrl&&(this._previewDebounce=setTimeout(()=>this._runPreview(t),700))}async _runPreview(e){this._previewing=!0,this._previewError="";try{const t=await k.previewUrl(e);if(!t)return;this._lastPreviewedUrl=e,this._draft={...this._draft,coverImage:t.image??this._draft.coverImage,lodgingHost:t.siteName??t.host??this._draft.lodgingHost,lodgingTitle:t.title??this._draft.lodgingTitle}}catch(t){console.warn("Preview failed:",t),(t==null?void 0:t.code)==="functions/unauthenticated"?this._previewError="Preview unavailable — sign in.":(t==null?void 0:t.code)==="functions/invalid-argument"?this._previewError="That URL doesn’t look right.":this._previewError="Preview unavailable — paste it again or skip."}finally{this._previewing=!1}}_toggleAttendee(e){const t=this._draft.attendees.includes(e),i=t?this._draft.attendees.filter(a=>a!==e):[...this._draft.attendees,e];let r=this._draft.viewers??[];t||(r=r.filter(a=>a!==e)),this._draft={...this._draft,attendees:i,viewers:r}}_toggleViewer(e){if(this._draft.attendees.includes(e))return;const i=(this._draft.viewers??[]).includes(e)?this._draft.viewers.filter(r=>r!==e):[...this._draft.viewers??[],e];this._set("viewers",i)}_toggleSubGroup(e){const i=(this._draft.targetSubGroups??[]).includes(e)?this._draft.targetSubGroups.filter(r=>r!==e):[...this._draft.targetSubGroups??[],e];this._set("targetSubGroups",i)}_renderFlightLookupStatus(e){const t=e==="return",i=t?this._returnLookupState:this._outboundLookupState,r=t?this._returnLookupMessage:this._outboundLookupMessage;return i==="idle"?s`<div class="hint">
    ...
    `}}b(ye,"properties",{open:{type:Boolean,reflect:!0},trip:{type:Object},members:{type:Array},currentUid:{type:String},familyId:{type:String},busy:{type:Boolean},formMode:{type:String},subGroups:{type:Object},_draft:{state:!0},_error:{state:!0},_previewing:{state:!0},_previewError:{state:!0},_showReturn:{state:!0},_showOutboundDetails:{state:!0},_showReturnDetails:{state:!0},_showFlight:{state:!0},_outboundLookupState:{state:!0},_outboundLookupMessage:{state:!0},_returnLookupState:{state:!0},_returnLookupMessage:{state:!0}}),b(ye,"styles",z`
    * {
      box-sizing: border-box;
    }
    :host {
  ...
  `);customElements.define("trip-form",ye);class we extends C{constructor(){super(),this.open=!1,this.event=null,this.members=[],this.familyId="",this.busy=!1,this._draft=this._blankDraft(),this._error=""}willUpdate(e){(e.has("event")||e.has("open"))&&(this.open&&(this._draft=this._draftFromEvent(this.event)),this._error="")}_blankDraft(){return{id:null,type:"birthday",title:"",date:new Date().toISOString().slice(0,10),personIds:[],recurring:!0,subtitle:"",notes:"",visibility:"family"}}_draftFromEvent(e){return e?{id:e.id??null,type:e.type??"birthday",title:e.title??"",date:e.date??new Date().toISOString().slice(0,10),personIds:Array.isArray(e.personIds)?[...e.personIds]:[],recurring:e.recurring??!0,subtitle:e.subtitle??"",notes:e.notes??"",visibility:e.visibility??"family"}:this._blankDraft()}_set(e,t){this._draft={...this._draft,[e]:t}}_toggleType(e){this._set("type",e)}_togglePerson(e){const t=this._draft.personIds.includes(e);this._set("personIds",t?this._draft.personIds.filter(i=>i!==e):[...this._draft.personIds,e])}_onSave(){const e=this._draft;if(!e.title.trim()){this._error="Give it a title.";return}if(!e.date){this._error="Pick a date.";return}if(!this.familyId){this._error="No family yet.";return}this._error="",this.dispatchEvent(new CustomEvent("save",{detail:{...e,title:e.title.trim(),subtitle:e.subtitle.trim(),notes:e.notes.trim()}}))}_onDelete(){this._draft.id&&confirm("Delete this event? This can't be undone.")&&this.dispatchEvent(new CustomEvent("remove",{detail:{id:this._draft.id}}))}_onCancel(){this.dispatchEvent(new Event("cancel"))}render(){if(!this.open)return s``;const e=this._draft,t=!!e.id;return s`
    ...
    `}_monthDay(e){if(!e)return"";const t=new Date(e);return Number.isNaN(t.getTime())?"":t.toLocaleString("en-GB",{day:"numeric",month:"long"})}}b(we,"properties",{open:{type:Boolean,reflect:!0},event:{type:Object},members:{type:Array},familyId:{type:String},busy:{type:Boolean},_draft:{state:!0},_error:{state:!0}}),b(we,"styles",z`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("event-form",we);let R=null,Ue=null;function zt(){return R||(R=document.createElement("div"),R.id="cairn-toast-host",Object.assign(R.style,{position:"fixed",bottom:"24px",left:"50%",transform:"translateX(-50%)",zIndex:9999,pointerEvents:"none"}),document.body.appendChild(R),R)}function x(d,{duration:e=2800}={}){const t=zt();clearTimeout(Ue),t.innerHTML="";const i=document.createElement("div");i.textContent=d,Object.assign(i.style,{padding:"12px 18px",background:"rgba(20, 12, 6, 0.78)",backdropFilter:"blur(24px) saturate(180%)",webkitBackdropFilter:"blur(24px) saturate(180%)",border:"1px solid rgba(255, 248, 235, 0.22)",borderRadius:"999px",color:"rgba(255, 248, 235, 0.96)",fontFamily:"'Inter', system-ui, sans-serif",fontSize:"13.5px",fontWeight:"500",letterSpacing:"0.005em",boxShadow:"0 12px 32px rgba(20, 12, 6, 0.45)",pointerEvents:"auto",transform:"translateY(8px)",opacity:"0",transition:"opacity 200ms ease, transform 240ms ease"}),t.appendChild(i),requestAnimationFrame(()=>{i.style.opacity="1",i.style.transform="translateY(0)"}),Ue=setTimeout(()=>{i.style.opacity="0",i.style.transform="translateY(8px)",setTimeout(()=>i.remove(),260)},e)}class _e extends C{constructor(){super(),this.open=!1,this.family=null,this.immediate=[],this.extended=[],this._busy=!1,this._newGroupName="",this._editingGroupId=null}_onCancel(){this.dispatchEvent(new Event("cancel"))}async _createSubGroup(){const e=this._newGroupName.trim();if(!(!e||this._busy)){this._busy=!0;try{const t=await k.saveSubGroup({name:e,memberIds:[]});this._newGroupName="",this._editingGroupId=t,x(`Sub-group "${e}" created.`)}catch(t){x(`Couldn't create: ${t.code??t.message}`,{duration:5e3})}finally{this._busy=!1}}}async _toggleSubGroupMember(e,t){var n,o;const i=(o=(n=this.family)==null?void 0:n.subGroups)==null?void 0:o[e];if(!i)return;const r=i.memberIds??[],a=r.includes(t)?r.filter(l=>l!==t):[...r,t];try{await k.saveSubGroup({id:e,name:i.name,memberIds:a})}catch(l){x(`Couldn't update: ${l.code??l.message}`,{duration:5e3})}}async _deleteSubGroup(e,t){if(confirm(`Delete the "${t}" sub-group?`))try{await k.deleteSubGroup(e),this._editingGroupId===e&&(this._editingGroupId=null),x("Sub-group deleted.")}catch(i){x(`Couldn't delete: ${i.code??i.message}`,{duration:5e3})}}async _regenerate(){if(!this._busy){this._busy=!0;try{await k.regenerateCairnInviteCode(),x("New invite code generated.")}catch(e){console.error(e),x(`Couldn't generate code: ${e.code??e.message}`,{duration:5e3})}finally{this._busy=!1}}}_inviteLink(e){return`${window.location.origin}/cairn/?join=${e}`}async _copyLink(){var t;const e=(t=this.family)==null?void 0:t.cairnInviteCode;if(e)try{await navigator.clipboard.writeText(this._inviteLink(e)),x("Invite link copied to clipboard.")}catch{x("Could not copy — try long-press the link instead.")}}async _share(){var i,r;const e=(i=this.family)==null?void 0:i.cairnInviteCode;if(!e)return;const t=this._inviteLink(e);if(navigator.share)try{await navigator.share({title:"Join my family on Cairn",text:`Join ${((r=this.family)==null?void 0:r.name)??"our family"} on Cairn — our shared family calendar.`,url:t})}catch{}else this._copyLink()}_expiryText(e){if(!e)return"";const t=e.toDate?e.toDate():new Date(e),r=Math.max(0,Math.round((t-new Date)/(1440*60*1e3)));return r===0?"Expires today":r===1?"Expires tomorrow":`Expires in ${r} days`}render(){var r,a,n,o;if(!this.open)return s``;const e=(r=this.family)==null?void 0:r.cairnInviteCode,t=(a=this.family)==null?void 0:a.cairnInviteCodeExpiresAt,i=t&&(t.toDate?t.toDate():new Date(t))<new Date;return s`
    ...
    `}}b(_e,"properties",{open:{type:Boolean,reflect:!0},family:{type:Object},immediate:{type:Array},extended:{type:Array},_busy:{state:!0},_newGroupName:{state:!0},_editingGroupId:{state:!0}}),b(_e,"styles",z`
    * {
      box-sizing: border-box;
    }
    :host {
...
`)}class ke extends C{constructor(){super(),this.trip=null,this.members=[],this._resizeObs=null}connectedCallback(){super.connectedCallback(),typeof ResizeObserver<"u"&&(this._resizeObs=new ResizeObserver(()=>this._fitTitle()))}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._resizeObs)==null||e.disconnect()}updated(){if(this._resizeObs&&this.renderRoot){const e=this.renderRoot.querySelector("article");e&&!e._observed&&(this._resizeObs.observe(e),e._observed=!0)}this._fitTitle()}_fitTitle(){if(!this.renderRoot)return;const e=this.renderRoot.querySelector("h3");if(!e)return;e.style.fontSize="";let t=19;for(e.style.fontSize=`${t}px`;e.scrollWidth>e.clientWidth+1&&t>13;)t-=.5,e.style.fontSize=`${t}px`}_fmtDates(e,t){const i=D(e),r=D(t);if(!i||!r)return"";const a=i.toLocaleString("en-GB",{month:"short"}),n=r.toLocaleString("en-GB",{month:"short"});return a===n&&i.getFullYear()===r.getFullYear()?`${i.getDate()} – ${r.getDate()} ${a}`:`${i.getDate()} ${a} – ${r.getDate()} ${n}`}async _onShare(e,t,i){i.stopPropagation();const r=St(e,t);if(navigator.share)try{await navigator.share({title:`Cairn — ${e.title??"activity"}`,text:r})}catch{}else try{await navigator.clipboard.writeText(r),x("Itinerary copied to clipboard.")}catch{x("Could not copy — try again from a browser tab.")}}render(){const e=this.trip;if(!e)return s``;const t=e.coverImage?`background-image: url(${e.coverImage});`:`background: ${Ct(e)};`,i=e.coverImage?"cover has-image":"cover",r=new Map(this.members.map(l=>[l.uid,l])),a=(e.attendees??[]).map(l=>r.get(l)).filter(Boolean),n=a.slice(0,4),o=Math.max(0,a.length-n.length);return s`
    ...
    `}}b(ke,"properties",{trip:{type:Object},members:{type:Array}}),b(ke,"styles",z`
    :host {
      display: block;
    }
    article {
  ...
  `);customElements.define("trip-card",ke);class $e extends C{constructor(){super(),this.open=!1,this.trips=[],this.members=[]}_onCancel(){this.dispatchEvent(new Event("cancel"))}_groupByYear(e){const t=[...e].sort((a,n)=>String(a.start).localeCompare(String(n.start))),i=new Date;i.setHours(0,0,0,0);const r=new Map;for(const a of t){if(!a.start)continue;const n=D(a.start),o=D(a.end);if(!n)continue;const l=n.getFullYear();r.has(l)||r.set(l,[]);const c=o?o<i:!1;r.get(l).push({trip:a,isPast:c})}return r}render(){var r;if(!this.open)return s``;const e=this._groupByYear(this.trips??[]),t=((r=this.trips)==null?void 0:r.length)??0,i=new Date().getFullYear();return s`
    ...
    `}}b($e,"properties",{open:{type:Boolean,reflect:!0},trips:{type:Array},members:{type:Array}}),b($e,"styles",z`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("all-trips-modal",$e);class De extends C{constructor(){super(),this.open=!1,this._events=[],this._selected=new Set,this._loading=!1,this._error="",this._importing=!1}willUpdate(e){e.has("open")&&this.open&&this._events.length===0&&!this._loading&&this._load()}async _load(){var e,t,i,r,a,n;this._loading=!0,this._error="";try{const o=await Ke(),l=await $t(o,90),c=new Set((k.state.trips??[]).filter(p=>p.gcalEventId).map(p=>p.gcalEventId));this._events=l.map(p=>({...p,_alreadyImported:c.has(p.id)}));const h=new Set;for(const p of this._events){if(p._alreadyImported)continue;const u=((e=p.start)==null?void 0:e.date)??((i=(t=p.start)==null?void 0:t.dateTime)==null?void 0:i.slice(0,10)),f=((r=p.end)==null?void 0:r.date)??((n=(a=p.end)==null?void 0:a.dateTime)==null?void 0:n.slice(0,10));u&&f&&f!==u&&h.add(p.id)}this._selected=h}catch(o){console.error(o),this._error=(o==null?void 0:o.message)??"Could not load calendar events."}finally{this._loading=!1}}_toggle(e){const t=new Set(this._selected);t.has(e)?t.delete(e):t.add(e),this._selected=t}_toggleAll(){const e=this._events.filter(t=>!t._alreadyImported);this._selected.size===e.length?this._selected=new Set:this._selected=new Set(e.map(t=>t.id))}async _import(){var a;if(this._importing||this._selected.size===0)return;this._importing=!0;const e=(a=$==null?void 0:$.currentUser)==null?void 0:a.uid,t=this._events.filter(n=>this._selected.has(n.id));let i=0,r=0;for(const n of t){const o=Dt(n,e);try{await k.saveTrip(o),i++}catch(l){console.error("Import failed for event",n.id,l),r++}}this._importing=!1,r===0?x(`Imported ${i} ${i===1?"activity":"activities"}.`):x(`Imported ${i}, ${r} failed.`,{duration:5e3}),this._events=[],this._selected=new Set,this.dispatchEvent(new Event("cancel"))}_onCancel(){this.dispatchEvent(new Event("cancel"))}_fmtRange(e){var h,p,u,f,y,g,m,_;const t=((h=e.start)==null?void 0:h.date)??((u=(p=e.start)==null?void 0:p.dateTime)==null?void 0:u.slice(0,10)),i=((f=e.end)==null?void 0:f.date)??((g=(y=e.end)==null?void 0:y.dateTime)==null?void 0:g.slice(0,10));if(!t)return"";const r=new Date(t);if(!i||i===t)return r.toLocaleString("en-GB",{day:"numeric",month:"short",year:"numeric"});let a=new Date(i);(m=e.start)!=null&&m.date&&((_=e.end)!=null&&_.date)&&a.setDate(a.getDate()-1);const n=r.getMonth()===a.getMonth()&&r.getFullYear()===a.getFullYear(),o=r.getFullYear()===a.getFullYear();if(n)return`${r.getDate()}–${a.getDate()} ${r.toLocaleString("en-GB",{month:"short",year:"numeric"})}`;const l=r.toLocaleString("en-GB",{day:"numeric",month:"short"}),c=a.toLocaleString("en-GB",{day:"numeric",month:"short",year:"numeric"});return o?`${l} – ${c}`:`${r.toLocaleDateString()} – ${a.toLocaleDateString()}`}render(){if(!this.open)return s``;const e=this._events.filter(i=>!i._alreadyImported),t=e.length>0&&this._selected.size===e.length;return s`
      <div class="backdrop" @click=${this._onCancel}></div>
      <div class="sheet">
        <glass-panel padding="lg" variant="strong" lifted>
          <div class="header">
    ...
    `}}b(De,"properties",{open:{type:Boolean,reflect:!0},_events:{state:!0},_selected:{state:!0},_loading:{state:!0},_error:{state:!0},_importing:{state:!0}}),b(De,"styles",z`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("import-calendar-modal",De);class Ce extends C{constructor(){super(),this.open=!1,this.user=null,this.pebbleUser=null,this._name="",this._savingName=!1,this._uploadingPhoto=!1}willUpdate(e){var t;e.has("open")&&this.open&&(this._name=((t=this.user)==null?void 0:t.displayName)??"")}_onCancel(){this.dispatchEvent(new Event("cancel"))}async _saveName(){var t,i;const e=this._name.trim();if(!(!e||e===(((t=this.user)==null?void 0:t.displayName)??""))&&!(!((i=$==null?void 0:$.currentUser)!=null&&i.uid)||!w)){this._savingName=!0;try{await O(E(w,"users",$.currentUser.uid),{displayName:e,updatedAt:S()}),x("Display name updated.")}catch(r){console.error(r),x(`Couldn't save: ${r.code??r.message}`,{duration:5e3})}finally{this._savingName=!1}}}async _signOut(){confirm("Sign out of Cairn?")&&(this.dispatchEvent(new Event("cancel")),await Qe())}_triggerPhotoPicker(){var e;(e=this.renderRoot.querySelector("#photo-file"))==null||e.click()}async _onPhotoChosen(e){var a,n;const t=(a=e.target.files)==null?void 0:a[0];if(e.target.value="",!t)return;if(!t.type.startsWith("image/")){x("Pick an image file (JPG, PNG, etc.).");return}if(t.size>5*1024*1024){x("Photo is too big — keep it under 5 MB.");return}const i=(n=$==null?void 0:$.currentUser)==null?void 0:n.uid,r=k.familyId;if(!i||!r||!ge){x("Can't upload yet — you need to be in a family first.");return}this._uploadingPhoto=!0;try{const o=Xe(ge,`families/${r}/avatars/users/${i}`);await qe(o,t,{contentType:t.type});const l=await We(o);await O(E(w,"users",i),{profilePhotoURL:l,updatedAt:S()}),x("Photo updated.")}catch(o){console.error("Photo upload failed",o),x(`Upload failed: ${o.code??o.message}`,{duration:5e3})}finally{this._uploadingPhoto=!1}}render(){if(!this.open)return s``;const e=this.user,t=this._name.trim()&&this._name.trim()!==((e==null?void 0:e.displayName)??"");return s`
    ...
    `}}b(Ce,"properties",{open:{type:Boolean,reflect:!0},user:{type:Object},pebbleUser:{type:Object},_name:{state:!0},_savingName:{state:!0},_uploadingPhoto:{state:!0}}),b(Ce,"styles",z`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("profile-sheet",Ce);const Z=class Z extends C{constructor(){super(),this.open=!1}static get OPTIONS(){return[{type:"activity",tone:"sage",icon:s`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    `:s``}};b(Z,"properties",{open:{type:Boolean,reflect:!0}}),b(Z,"styles",z`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);let ze=Z;customElements.define("activity-type-picker",ze);class Se extends C{constructor(){super(),this.open=!1,this.floating=!1,this.family=null,this.trips=[],this._messages=[],this._input="",this._loading=!1,this._error="",this._followUps=[]}willUpdate(e){var t;e.has("_messages")&&(this.floating=(((t=this._messages)==null?void 0:t.length)??0)>0)}_onCancel(){this.dispatchEvent(new Event("cancel"))}_suggestions(){const e=[],t=(this.trips??[]).filter(i=>i.start&&new Date(i.start)>=new Date).sort((i,r)=>String(i.start).localeCompare(String(r.start)))[0];return t&&(e.push(`What should we do in ${t.location||t.title}?`),e.push(`What should we pack for ${t.title}?`)),e.push("Plan a family activity for this weekend"),e.push("Gift ideas for an upcoming birthday"),e.slice(0,4)}async _send(e){const t=(e??this._input).trim();if(!(!t||this._loading)){this._error="",this._input="",this._followUps=[],this._messages=[...this._messages,{role:"user",content:t}],this._loading=!0,this.updateComplete.then(()=>this._scrollToBottom());try{const i=this._messages.slice(0,-1).map(a=>({role:a.role,content:a.content})),r=await k.askPebble(t,i);this._messages=[...this._messages,{role:"assistant",content:r.answer}],this._followUps=Array.isArray(r.followUps)?r.followUps:[]}catch(i){console.error(i),(i==null?void 0:i.code)==="functions/unauthenticated"?this._error="Pebble needs you to be signed in.":(i==null?void 0:i.code)==="functions/permission-denied"?this._error="You're not in this family yet.":(i==null?void 0:i.code)==="functions/not-found"||(i==null?void 0:i.code)==="functions/internal"?this._error="Pebble isn't available right now — the Cloud Function may not be deployed yet.":this._error=(i==null?void 0:i.message)??"Pebble could not answer right now."}finally{this._loading=!1,this.updateComplete.then(()=>this._scrollToBottom())}}}_scrollToBottom(){const e=this.renderRoot.querySelector(".thread");e&&(e.scrollTop=e.scrollHeight)}_renderPebbleIcon(){return s`
    ...
    `}}b(Se,"properties",{open:{type:Boolean,reflect:!0},floating:{type:Boolean,reflect:!0},family:{type:Object},trips:{type:Array},_messages:{state:!0},_input:{state:!0},_loading:{state:!0},_error:{state:!0},_followUps:{state:!0}}),b(Se,"styles",z`
    * { box-sizing: border-box; }
    :host {
      position: fixed;
      inset: 0;
  ...
  `);customElements.define("pebble-chat",Se);class it extends C{render(){return s`
  ...
  `);customElements.define("discover-pebblepath",it);class Fe extends C{constructor(){super(),this.code="",this._family=null,this._loading=!0,this._joining=!1,this._error=""}willUpdate(e){e.has("code")&&this.code&&this._lookup()}async _lookup(){var e,t;this._loading=!0,this._error="";try{const i=await k.findFamilyByCairnCode(this.code);if(!i)this._error="Invite code not found. Check it was typed correctly.",this._family=null;else{const r=((t=(e=i.cairnInviteCodeExpiresAt)==null?void 0:e.toDate)==null?void 0:t.call(e))??(i.cairnInviteCodeExpiresAt?new Date(i.cairnInviteCodeExpiresAt):null);!r||r<new Date?(this._error="This invite code has expired. Ask the family for a fresh one.",this._family=null):this._family=i}}catch(i){console.error(i),this._error=(i==null?void 0:i.message)??"Couldn't look up the invite."}finally{this._loading=!1}}async _join(){var e;if(!this._joining){this._joining=!0,this._error="";try{const t=await k.joinFamilyAsCairn(this.code);x(`Welcome to ${((e=this._family)==null?void 0:e.name)??"the family"}.`),this.dispatchEvent(new CustomEvent("joined",{detail:{familyId:t}}))}catch(t){console.error(t),this._error=(t==null?void 0:t.message)??"Could not join."}finally{this._joining=!1}}}_cancel(){this.dispatchEvent(new Event("cancel"))}_inviterFromFamily(e){var r;if(!e)return null;const t=(r=e.memberProfiles)==null?void 0:r[e.createdBy];if(!t)return null;const i=t.profilePhotoURL;return{displayName:t.displayName??"A family member",photoURL:typeof i=="string"&&/^https?:\/\//i.test(i)?i:null}}render(){var r,a,n;const e=this._inviterFromFamily(this._family),t=(((r=this._family)==null?void 0:r.cairnMemberIds)??((a=this._family)==null?void 0:a.memberIds)??[]).length,i=(((n=this._family)==null?void 0:n.memberIds)??[]).length;return s`
    ...
    `}}b(Fe,"properties",{code:{type:String},_family:{state:!0},_loading:{state:!0},_joining:{state:!0},_error:{state:!0}}),b(Fe,"styles",z`
    * { box-sizing: border-box; }
    :host {
      display: flex;
      align-items: center;
  ...
  `);customElements.define("join-family-screen",Fe);class Ae extends C{constructor(){super(),this.error="",this.busy=!1,this.joinCode="",this._codeInputOpen=!1,this._code=""}async _handleSignIn(){if(this.busy)return;const e=(this._code??"").trim().toUpperCase();if(this._codeInputOpen&&e){const t=e.startsWith("CAIRN-")?e:`CAIRN-${e.replace(/^CAIRN-?/i,"")}`;try{localStorage.setItem("cairn:pendingJoinCode",t)}catch{}}this.busy=!0,this.error="";try{await Ze()}catch(t){this.error=(t==null?void 0:t.message)??"Sign-in failed."}finally{this.busy=!1}}_toggleCode(){this._codeInputOpen=!this._codeInputOpen,this._codeInputOpen&&requestAnimationFrame(()=>{var e;(e=this.renderRoot.querySelector(".code-input"))==null||e.focus()})}_renderGoogleIcon(){return s`
    ...
    `}}b(Ae,"properties",{error:{state:!0},busy:{state:!0},joinCode:{type:String},_codeInputOpen:{state:!0},_code:{state:!0}}),b(Ae,"styles",z`
    * {
      box-sizing: border-box;
    }
    :host {
  ...
  `);customElements.define("sign-in-screen",Ae);const X=class X extends C{constructor(){super(),this.value="family"}_select(e){e!==this.value&&(this.value=e,this.dispatchEvent(new CustomEvent("circle-change",{detail:{value:e},bubbles:!0,composed:!0})))}render(){return s`
    ...
    `}};b(X,"properties",{value:{type:String,reflect:!0}}),b(X,"OPTIONS",[{value:"personal",label:"Just me"},{value:"family",label:"Family"},{value:"extended",label:"Extended"}]),b(X,"styles",z`
    * {
      box-sizing: border-box;
    }
    :host {
  ...
  `);let Ee=X;customElements.define("circle-switcher",Ee);class Ie extends C{constructor(){super(),this.event=null,this.members=[]}_icon(e){return e==="birthday"?s`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
    ...
    `}}b(Ie,"properties",{event:{type:Object},members:{type:Array}}),b(Ie,"styles",z`
    :host {
      display: block;
    }
    .row {
  ...
  `);customElements.define("event-row",Ie);const Ft={uid:"preview-user",displayName:"Thomas Paris",email:"thomas@example.com",photoURL:null},Ge=[{uid:"thomas",displayName:"Thomas",circles:["immediate"],hue:198},{uid:"partner",displayName:"Élise",circles:["immediate"],hue:8},{uid:"kid1",displayName:"Oscar",circles:["immediate"],hue:142},{uid:"kid2",displayName:"Mila",circles:["immediate"],hue:44},{uid:"mum",displayName:"Mum",circles:["extended"],hue:320},{uid:"dad",displayName:"Dad",circles:["extended"],hue:28},{uid:"sister",displayName:"Camille",circles:["extended"],hue:280},{uid:"bro-in-law",displayName:"Sam",circles:["extended"],hue:175},{uid:"niece",displayName:"Léa",circles:["extended"],hue:100}],At=[{id:"t1",title:"Côte d’Azur, summer",location:"Antibes, France",start:"2026-07-12",end:"2026-07-21",coverGradient:"linear-gradient(135deg, #6b9ac4 0%, #c98a8a 60%, #d4a843 100%)",lodgingHost:"Airbnb",lodgingTitle:"Villa near Cap d’Antibes",attendees:["thomas","partner","kid1","kid2","mum","dad"],notes:"Mum + Dad arrive day 2. Dinner reservations at La Guérite booked.",visibility:"extended"},{id:"t2",title:"Half-term in the Alps",location:"Chamonix, France",start:"2026-10-24",end:"2026-10-31",coverGradient:"linear-gradient(135deg, #7a9e7e 0%, #4a6754 70%, #2c4439 100%)",lodgingHost:"Booking.com",lodgingTitle:"Chalet Les Drus",attendees:["thomas","partner","kid1","kid2"],notes:"Need ski school for the kids — book by September.",visibility:"immediate"},{id:"t3",title:"Camille’s 40th",location:"Lisbon, Portugal",start:"2026-09-05",end:"2026-09-08",coverGradient:"linear-gradient(135deg, #c67b5c 0%, #d4a843 50%, #c98a8a 100%)",lodgingHost:"Airbnb",lodgingTitle:"Alfama rooftop apartment",attendees:["thomas","partner","sister","bro-in-law"],notes:"Surprise. Don’t mention to Camille.",visibility:"family"}],Et=[{id:"e1",type:"birthday",date:"2026-05-24",personIds:["mum"],title:"Mum’s birthday"},{id:"e2",type:"anniversary",date:"2026-05-28",personIds:["mum","dad"],title:"Mum & Dad’s anniversary",subtitle:"38 years"},{id:"e3",type:"birthday",date:"2026-06-11",personIds:["kid1"],title:"Oscar turns 7"},{id:"e4",type:"birthday",date:"2026-06-30",personIds:["niece"],title:"Léa’s birthday"}];class Te extends C{constructor(){super(),this.user=Ft,this.pebbleUser=null,this.family=null,this.children=[],this.trips=[],this.events=[],this.preview=!1,this.circle="extended",this._formOpen=!1,this._formTrip=null,this._formBusy=!1,this._membersOpen=!1,this._eventFormOpen=!1,this._eventFormEvent=null,this._eventFormBusy=!1,this._allTripsOpen=!1,this._editingFamilyName=!1,this._importOpen=!1,this._profileOpen=!1,this._typePickerOpen=!1,this._formMode="trip",this._pebbleOpen=!1,this._dragOverTarget=null;const e=new Date;this._displayMonth=new Date(e.getFullYear(),e.getMonth(),1)}async _saveFamilyName(e){var a,n;const i=(e.target.value??"").trim(),r=((a=this.family)==null?void 0:a.name)??"";if(i&&i!==r&&((n=this.family)!=null&&n.id))try{const{db:o,doc:l,updateDoc:c,serverTimestamp:h}=await Ve(async()=>{const{db:p,doc:u,updateDoc:f,serverTimestamp:y}=await Promise.resolve().then(()=>ft);return{db:p,doc:u,updateDoc:f,serverTimestamp:y}},void 0);await c(l(o,"families",this.family.id),{name:i,updatedAt:h()}),x("Family name updated.")}catch(o){console.error("Update family name failed:",o),x(`Couldn't save: ${o.code??o.message}`,{duration:5e3})}this._editingFamilyName=!1}_liveImmediate(){var e;return this.preview||!((e=this.user)!=null&&e.uid)?Ge.filter(t=>t.circles.includes("immediate")):yt(this.user.uid,this.user,this.pebbleUser,this.family,this.children)}_liveExtended(){var e;return this.preview?Ge.filter(t=>t.circles.includes("extended")):xt((e=this.user)==null?void 0:e.uid,this.family)}_liveTrips(){return this.preview?At:this.trips??[]}_liveEvents(){if(this.preview)return Et;const e=r=>{const{date:a,yearsElapsed:n}=_t(r);return{...r,date:a?kt(a):r.date,_yearsElapsed:n,_originalDate:r.date}},t=wt(this.children).map(e),i=(this.events??[]).map(e);return[...t,...i].sort((r,a)=>String(r.date).localeCompare(String(a.date)))}_filteredMembers(){const e=this._liveImmediate(),t=this._liveExtended();return this.circle==="personal"?e.filter(i=>{var r;return i.uid===((r=this.user)==null?void 0:r.uid)}):this.circle==="family"?e:[...e,...t]}_circleTrips(){var n;const e=this._liveTrips(),t=((n=this.user)==null?void 0:n.uid)??"thomas";let i;this.circle==="personal"?i=e.filter(o=>{var l;return(l=o.attendees)==null?void 0:l.includes(t)}):this.circle==="family"?i=e.filter(o=>o.visibility!=="extended"&&this._userCanSeeTrip(o)):i=e.filter(o=>this._userCanSeeTrip(o));const r=new Set,a=[];for(const o of i){const l=o.id??`${o.title}|${o.start}|${o.end}`;r.has(l)||(r.add(l),a.push(o))}return a}_filteredTrips(){const e=new Date;return e.setHours(0,0,0,0),this._circleTrips().filter(t=>t.end?D(t.end)>=e:!0)}_userCanSeeTrip(e){var l,c,h,p,u,f;const t=(l=this.user)==null?void 0:l.uid;if(!t)return!1;if((c=e.attendees)!=null&&c.includes(t)||(h=e.viewers)!=null&&h.includes(t))return!0;const i=((p=this.family)==null?void 0:p.memberIds)??[],r=((u=this.family)==null?void 0:u.cairnMemberIds)??i,a=i.includes(t),n=r.includes(t);if(a)return!0;if(!n)return!1;const o=e.visibility||"family";if(o==="personal")return!1;if(o==="family")return!0;if(o==="extended"){const y=e.targetSubGroups??[];if(y.length===0)return!0;const g=Object.entries(((f=this.family)==null?void 0:f.subGroups)??{}).filter(([,m])=>(m.memberIds??[]).includes(t)).map(([m])=>m);return y.some(m=>g.includes(m))}return!1}_filteredEvents(){const e=new Set(this._filteredMembers().map(t=>t.uid));return this._liveEvents().filter(t=>t.personIds.some(i=>e.has(i)))}_smartCallout(){var o,l;const e=new Date,t=new Date(e.getFullYear(),e.getMonth(),e.getDate()),i=1440*60*1e3,r=c=>Math.round((c-t)/i);for(const c of this._circleTrips()){if(!c.start||!c.end)continue;const h=D(c.start),p=D(c.end);if(h.setHours(0,0,0,0),p.setHours(0,0,0,0),h<=t&&t<=p){const u=r(h)+1,f=r(p)-r(h)+1,y=((o=c.location)==null?void 0:o.trim())||c.title;return`Day ${u} of ${f} in ${y}.`}}let a=null,n=1/0;for(const c of this._circleTrips()){if(!c.start)continue;const h=D(c.start);if(!h)continue;const p=r(h);p>0&&p<n&&(a={kind:"trip",item:c},n=p)}for(const c of this._filteredEvents()){if(!c.date)continue;const h=D(c.date);if(!h)continue;const p=r(h);p>=0&&p<n&&(a={kind:"event",item:c},n=p)}if(!a)return null;if(a.kind==="trip"){const c=((l=a.item.location)==null?void 0:l.trim())||a.item.title;return n===1?`${c} starts tomorrow.`:n<=14?`${c} in ${n} days.`:n<=60?`Next trip: ${c} in ${n} days.`:null}return n===0?`${a.item.title} — today.`:n===1?`${a.item.title} — tomorrow.`:n<=7?`${a.item.title} in ${n} days.`:null}_tripDensityByDay(e){const t=new Map;for(const i of this._filteredTrips()){if(!i.start||!i.end)continue;const r=D(i.start),a=D(i.end);if(Number.isNaN(r.getTime())||Number.isNaN(a.getTime())||r.getFullYear()>e||a.getFullYear()<e)continue;const n=new Date(Math.max(r,new Date(e,0,1))),o=new Date(Math.min(a,new Date(e,11,31)));for(;n<=o;){const l=`${String(n.getMonth()+1).padStart(2,"0")}-${String(n.getDate()).padStart(2,"0")}`;t.set(l,Math.min(1,(t.get(l)??0)+.5)),n.setDate(n.getDate()+1)}}return t}_shiftMonth(e){const t=this._displayMonth;this._displayMonth=new Date(t.getFullYear(),t.getMonth()+e,1)}_jumpToMonth(e,t){this._displayMonth=new Date(e,t,1)}_resetToToday(){const e=new Date;this._displayMonth=new Date(e.getFullYear(),e.getMonth(),1)}_renderStone({label:e,members:t,pebbleClass:i,emptyLabel:r,onClick:a,maxChips:n=6,dropTargetId:o=null,draggable:l=()=>!1}){const c=o?{dragover:y=>{var g;(g=y.dataTransfer.types)!=null&&g.includes("text/cairn-uid")&&(y.preventDefault(),this._dragOverTarget=o)},dragleave:()=>{this._dragOverTarget===o&&(this._dragOverTarget=null)},drop:async y=>{y.preventDefault(),this._dragOverTarget=null;const g=y.dataTransfer.getData("text/cairn-uid");if(!g)return;const m=o==="extended"?null:o;try{await k.setCairnMemberSubGroup(g,m),x(m?`Moved to ${e}.`:"Moved to extended.")}catch(_){console.error("Move failed:",_),x(`Couldn't move: ${_.code??_.message}`,{duration:4e3})}}}:{},h=o&&this._dragOverTarget===o,p=`pebble ${i}${h?" pebble-drop":""}`;if(!t||t.length===0)return s`
      ...
      `;const u=t.slice(0,n),f=t.length-u.length;return s`
      <button
        class="stone"
        @click=${a}
      ...
      >
        <span class="${p}">
          <span class="stone-chips">
            ${u.map(y=>{const g=l(y);return s`
                <member-chip
                  draggable=${g?"true":"false"}
                  class=${g?"is-draggable":""}
                  @dragstart=${m=>{if(!g){m.preventDefault();return}m.stopPropagation(),m.dataTransfer.setData("text/cairn-uid",y.uid),m.dataTransfer.effectAllowed="move"}}
                  .name=${y.displayName}
                  .photo=${y.photoURL??""}
                  .hue=${y.hue}
                  size="26"
    ...
    `}_renderMonthly(){const e=new Date,t=this._displayMonth??e,i=t.getFullYear(),r=t.getMonth(),n=(new Date(i,r,1).getDay()+6)%7,o=new Date(i,r+1,0).getDate(),l=new Map,c=(m,_)=>{l.has(m)||l.set(m,_)},h=[];for(const m of this._filteredEvents()){const _=D(m.date);_&&_.getFullYear()===i&&_.getMonth()===r&&(h.push(_.getDate()),c(_.getDate(),m.title??""))}const p=new Set;for(const m of this._filteredTrips()){if(!m.start||!m.end)continue;const _=D(m.start),F=D(m.end);if(Number.isNaN(_.getTime())||Number.isNaN(F.getTime())||_.getFullYear()>i||F.getFullYear()<i||_.getMonth()>r&&F.getMonth()>r||_.getMonth()<r&&F.getMonth()<r)continue;const N=_.getMonth()===r?_.getDate():1,A=F.getMonth()===r?F.getDate():o;for(let M=N;M<=A;M++)p.add(M),c(M,m.title??"")}const u=[];for(let m=0;m<n;m++)u.push(s`<div class="cal-cell empty"></div>`);const f=e.getFullYear()===i&&e.getMonth()===r;for(let m=1;m<=o;m++){const _=f&&m===e.getDate(),F=h.includes(m),N=p.has(m),A=_?l.get(m)??"Today":l.get(m),M=["cal-cell",_?"today":"",F?"has-event":"",N?"has-trip":""].filter(Boolean).join(" ");u.push(s`<div class=${M} title=${A?`${m} — ${A}`:""}>
        <span class="cal-cell-day">${m}</span>
        ${A?s`<span class="cal-cell-label">${A}</span>`:""}
      </div>`)}const y=new Date(i,r,1).toLocaleString("en-GB",{month:"long",year:"numeric"});return s`
      <div class="cal-head">
        <h3>${y}</h3>
        <div class="nav">
          ${!f?s`<button
    ...
    `}_openCreate(){if(this.preview){x("Sign in to create real activities.");return}if(!k.familyId){x("You need a PebblePath family first.");return}this._typePickerOpen=!0}_onTypePicked(e){this._typePickerOpen=!1;const t=e.detail.type;if(t==="event"){this._eventFormEvent=null,this._eventFormOpen=!0;return}if(t==="import"){this._importOpen=!0;return}this._formMode=t,this._formTrip=null,this._formOpen=!0}_openEdit(e){if(this.preview){x("Sign in to edit real activities.");return}const t=e.lodgingUrl||e.lodgingHost||e.flightNumber||e.flightDepartAirport;this._formMode=t?"trip":"activity",this._formTrip=e,this._formOpen=!0}async _onSaveTrip(e){const t=e.detail;this._formBusy=!0;try{await k.saveTrip(t),this._formOpen=!1,this._formTrip=null,x(t.id?"Trip updated.":"Trip created.")}catch(i){console.error("Save trip failed:",i),x(`Couldn't save: ${i.code??i.message}`,{duration:5e3})}finally{this._formBusy=!1}}async _onDeleteTrip(e){this._formBusy=!0;try{await k.deleteTrip(e.detail.id),this._formOpen=!1,this._formTrip=null,x("Trip deleted.")}catch(t){console.error("Delete trip failed:",t),x(`Couldn't delete: ${t.code??t.message}`,{duration:5e3})}finally{this._formBusy=!1}}_openCreateEvent(){if(this.preview){x("Sign in to add real events.");return}if(!k.familyId){x("You need a family first.");return}this._eventFormEvent=null,this._eventFormOpen=!0}_openEditEvent(e){if(this.preview){x("Sign in to edit real events.");return}if(e!=null&&e._childId){const t=prompt(`Edit ${e._childName}'s birthday (YYYY-MM-DD):`,e.date);if(!t)return;if(!/^\d{4}-\d{2}-\d{2}$/.test(t)){x("Use YYYY-MM-DD format.");return}k.updateChildBirthday(e._childId,new Date(t)).then(()=>x(`Updated ${e._childName}'s birthday.`)).catch(i=>{console.error("Update child birthday failed:",i),x(`Couldn't update: ${i.code??i.message}`,{duration:5e3})});return}this._eventFormEvent={...e,date:e._originalDate??e.date},this._eventFormOpen=!0}async _onSaveEvent(e){this._eventFormBusy=!0;try{await k.saveEvent(e.detail),this._eventFormOpen=!1,this._eventFormEvent=null,x(e.detail.id?"Event updated.":"Event added.")}catch(t){console.error("Save event failed:",t),x(`Couldn't save: ${t.code??t.message}`,{duration:5e3})}finally{this._eventFormBusy=!1}}async _onDeleteEvent(e){this._eventFormBusy=!0;try{await k.deleteEvent(e.detail.id),this._eventFormOpen=!1,this._eventFormEvent=null,x("Event deleted.")}catch(t){console.error("Delete event failed:",t),x(`Couldn't delete: ${t.code??t.message}`,{duration:5e3})}finally{this._eventFormBusy=!1}}render(){var f,y,g,m,_,F,N,A,M,P,W;const e=this._filteredTrips(),t=this._filteredEvents(),i=this._liveImmediate(),r=this._liveExtended(),a=i.concat(r),n=(((f=this.user)==null?void 0:f.displayName)??"there").split(" ")[0],o=new Date,l=new Date(o.getFullYear(),o.getMonth(),1),c=new Date(o.getFullYear(),o.getMonth()+1,0),h=t.filter(v=>{const T=D(v.date);return T&&T.getFullYear()===o.getFullYear()&&T.getMonth()===o.getMonth()}),u=this._circleTrips().filter(v=>{if(!v.start||!v.end)return!1;const T=D(v.start),Y=D(v.end);return Number.isNaN(T.getTime())||Number.isNaN(Y.getTime())?!1:T<=c&&Y>=l}).length+h.length;return s`
      ...
      <main>
        ...
        <section>
          ...
          ${(()=>{const v=(I,U)=>String(I.date).localeCompare(String(U.date)),T=t.filter(I=>I.type==="birthday").slice().sort(v),Y=t.filter(I=>I.type==="anniversary").slice().sort(v),V=t.filter(I=>I.type!=="birthday"&&I.type!=="anniversary").slice().sort(v),Q=(I,U,ee)=>s`
              <glass-panel padding="sm" variant="strong" class="cel-col">
                <div class="cel-col-head">
                  <span class="cel-col-title">${I}</span>
                </div>
                ${U.length===0?s`<div class="cel-empty">${ee}</div>`:U.map(te=>s`<event-row
                        .event=${te}
                        .members=${a}
            ...
            `;return s`
              <div class="cel-row">
                ...
                ${Q("Anniversaries",Y,"No anniversaries yet.")}
              </div>
              ${V.length>0?s`<glass-panel padding="md" variant="strong" style="margin-top:18px;">
                    <div class="cel-col-head">
        ...
        <section>
          ...
          <glass-panel padding="md" variant="strong">
            ${(()=>{var ee,te,ie,Pe,Oe;const v=i.find(j=>{var B;return j.uid===((B=this.user)==null?void 0:B.uid)}),Y=new Set(((ee=this.family)==null?void 0:ee.memberIds)??[]).has((te=this.user)==null?void 0:te.uid),V=i.filter(j=>{var B;return j.uid!==((B=this.user)==null?void 0:B.uid)}),Q=!Y&&v?[{...v,role:"extended"},...r]:r,I=Object.entries(((ie=this.family)==null?void 0:ie.subGroups)??{}),U=new Map(a.map(j=>[j.uid,j]));return s`
                <div class="cairn-stack">
                  ...
                  ${I.length>0?s`
                        <div class="subgroup-row">
                          ${I.map(([j,B])=>{const at=(B.memberIds??[]).map(ne=>U.get(ne)).filter(Boolean);return this._renderStone({label:B.name??"Group",members:at,pebbleClass:"pebble-subgroup",emptyLabel:`${B.name??"Group"} (empty)`,onClick:()=>this._membersOpen=!0,maxChips:4,dropTargetId:j,draggable:ne=>ne.role==="extended"})})}
                        </div>
                      `:""}
                </div>
                ${V.length===0&&r.length===0?s`
      ...
      <trip-form
        ...
        .subGroups=${((P=this.family)==null?void 0:P.subGroups)??{}}
  ...
  `);customElements.define("home-screen",Te);class Ne extends C{constructor(){super(),this.user=null,this._mode="choose",this._code="",this._familyName="",this._busy=!1,this._error=""}willUpdate(e){if(e.has("user")&&this.user&&!this._familyName){const t=(this.user.displayName??"").trim().split(/\s+/).slice(-1)[0];t&&t.length>1&&(this._familyName=`${t} Family`)}}_go(e){this._mode=e,this._error=""}_submitJoin(){const e=(this._code??"").trim().toUpperCase();if(!e){this._error="Paste the family code you were sent.";return}const t=e.startsWith("CAIRN-")?e:`CAIRN-${e.replace(/^CAIRN-?/i,"")}`;if(!/^CAIRN-[A-Z0-9]{3,6}$/.test(t)){this._error="Codes look like CAIRN-XXXX.";return}this._error="",this.dispatchEvent(new CustomEvent("join-code",{detail:{code:t},bubbles:!0,composed:!0}))}async _submitCreate(){const e=(this._familyName??"").trim();if(!e){this._error="Give your family a name.";return}this._busy=!0,this._error="";try{await k.createCairnOnlyFamily(e),x(`Welcome to ${e}.`)}catch(t){console.error("Create family failed:",t),this._error=(t==null?void 0:t.code)==="permission-denied"?"Couldn't create the family — Firestore rules may not be deployed yet.":`Couldn't create the family: ${(t==null?void 0:t.message)??"try again"}`}finally{this._busy=!1}}_iconJoin(){return s`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    `}}b(Ne,"properties",{user:{type:Object},_mode:{state:!0},_code:{state:!0},_familyName:{state:!0},_busy:{state:!0},_error:{state:!0}}),b(Ne,"styles",z`
    * { box-sizing: border-box; }
    :host {
      display: flex;
      align-items: center;
...
//# sourceMappingURL=index-BFzlwbl8.js.map
